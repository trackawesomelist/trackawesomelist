...
*   [ngx-barcode6 (⭐34)](https://github.com/efgiese/ngx-barcode6) - An Angular component for Angular 9+ for creating 1-D barcodes based on [JsBarcode (⭐5.7k)](https://github.com/lindell/JsBarcode).
...
*   [ngx-tolgee (⭐244)](https://github.com/tolgee/tolgee-js/tree/main/packages/ngx/projects/ngx-tolgee) - Web-based localization tool enabling users to translate directly in the Angular app they develop.
...
*   [angular-nest (⭐21)](https://github.com/mugifly/angular-nest) - Simple web app template with Angular + NestJS + ng-openapi-gen.
...
*   [nx-starter (⭐5)](https://github.com/touhidrahman/nx-starter) - Nx powered starter project for Angular with SpartanUI.
...
*   [Angspire (⭐13)](https://github.com/tbarracha/Angspire) - Angular + .NET (monorepo) project template designed to simplify development with out-of-the-box features like (basic) user authentication and frontend themes, reducing setup time and providing a scalable, maintainable foundation for your applications.
*   [keycloakify-starter-angular-vite (⭐7)](https://github.com/keycloakify/keycloakify-starter-angular-vite) - Angular + Vite Starter for [Keycloakify 11](https://www.keycloakify.dev/).
*   [@rainerhahnekamp/angular-starter (⭐63)](https://github.com/rainerhahnekamp/angular-starter) - A starter project for a modern Angular 19 application.
...
*   [extreme-angular (⭐151)](https://github.com/joematthews/extreme-angular) - A starter template with pre-configured dev tools that enforce best practices for creating clean, maintainable, and accessible web apps.
*   [@wlucha/angular-starter (⭐377)](https://github.com/wlucha/angular-starter) - Angular 19 Starter with Storybook, Transloco, Jest, Cypress, Docker, ESLint, Material, & Prettier.
*   [angular-clean-architecture (⭐15)](https://github.com/carlossalasamper/angular-clean-architecture) - An Angular scaffold with a clean architecture that is easy to understand.
...
*   [cypress-harness (⭐263)](https://github.com/jscutlery/devkit/tree/main/packages/cypress-harness) - This library provides Cypress support to Component Test Harnesses.
...
*   [playwright-ng-schematics (⭐15)](https://github.com/playwright-community/playwright-ng-schematics) - Adds Playwright Test to your Angular project.
*   [playwright-coverage (⭐44)](https://github.com/bgotink/playwright-coverage) - Report coverage on playwright tests using v8 coverage, without requiring any instrumentation.
...
*   [@jscutlery/playwright-ct-angular (⭐263)](https://github.com/jscutlery/devkit/tree/main/packages/playwright-ct-angular) - Playwright Angular component testing.
*   [ngx-speculoos (⭐77)](https://github.com/Ninja-Squad/ngx-speculoos) - Simpler, cleaner Angular unit tests.
...
*   [docker-ng-cli-karma (⭐62)](https://github.com/trion-development/docker-ng-cli-karma) - Angular docker image capable of running Karma with Chrome.
...
*   [jest-preset-angular (⭐913)](https://github.com/thymikee/jest-preset-angular) - Jest configuration preset for Angular projects.
...
*   [swc-angular (⭐263)](https://github.com/jscutlery/devkit/tree/main/packages/swc-angular) - This is a set of Angular presets that enable you to use SWC (Speedy Web Compiler) with Jest or Vitest.
*   [swc-angular-plugin (⭐263)](https://github.com/jscutlery/devkit/tree/main/packages/swc-angular-plugin) - SWC (Speedy Web Compiler) is a lightning-fast JavaScript/TypeScript compiler, but it doesn't support Angular so you need this plugin.
...
*   [ng-mocks-sandbox (⭐6)](https://github.com/help-me-mom/ng-mocks-sandbox) - A repo with guides and examples for unit tests in Angular applications using ng-mocks.
...
*   [spectacular (⭐36)](https://github.com/ngworker/ngworker/tree/main/packages/spectacular) - Spectacular offers test harnesses for Angular applications and libraries.
...
*   [spectator (⭐2.2k)](https://github.com/ngneat/spectator) - A Powerful Tool to Simplify Your Angular Tests.
...
*   [angular-animations-explorer (⭐145)](https://github.com/williamjuan027/angular-animations-explorer) - A resource to showcase the different animations that you could do with Angular.
...
*   [layout-projection (⭐18)](https://github.com/Char2sGu/layout-projection) - Beautify the Web with awesome layout animations.
...
*   [ngx-typed-writer (⭐12)](https://github.com/SkyZeroZx/ngx-typed-writer) - A Native Angular 2+ Typing Animation Library (Angular SSR and Angular Universal Friendly).
*   [ngx-number-ticker (⭐3)](https://github.com/omnedia/ngx-number-ticker) - A simple number ticker effect to animate counting.
...
*   [ngx-typewriter (⭐4)](https://github.com/omnedia/ngx-typewriter) - A lightweight and easy-to-use library for creating typewriter effects. It uses RxJS to manage the typewriting effect, ensuring smooth and customizable animations.
...
*   [ngx-shine-border (⭐4)](https://github.com/omnedia/ngx-shine-border) - An Angular library that provides a dynamic and customizable animated border effect for Angular components.
...
*   [ngx-background-beams (⭐2)](https://github.com/omnedia/ngx-background-beams) - An Angular component that generates dynamic animated background beams with customizable gradients and motion paths.
*   [ngx-aurora (⭐8)](https://github.com/omnedia/ngx-aurora) - An Angular library that creates a mesmerizing aurora background effect. This component provides an animated, gradient-based light effect with customizable inversion and two different animation styles.
*   [ngx-particles (⭐2)](https://github.com/omnedia/ngx-particles) - An Angular library that provides a dynamic and interactive particle animation effect. The particles react to mouse movements, creating a visually engaging and customizable background for your Angular components.
*   [ngx-spotlight (⭐1)](https://github.com/omnedia/ngx-spotlight) - An Angular library that creates a spotlight effect using SVG animations. The component highlights sections of your page when they enter the viewport, with customizable spotlight colors and optional animations.
*   [ngx-starry-sky (⭐1)](https://github.com/omnedia/ngx-starry-sky) - An Angular library that creates a beautiful starry sky background with optional shooting star effects.
...
*   [ngx-countUp (⭐142)](https://github.com/inorganik/ngx-countUp) - Animates a numerical value by counting to it.
...
*   [ngx-turnstile (⭐69)](https://github.com/verto-health/ngx-turnstile) - Cloudflare Turnstile for Angular.
...
*   [go-captcha-angular (⭐7)](https://github.com/wenlng/go-captcha-angular) - A simple, easy-to-use, interactive, and secure behavioral verification code that implements verification modes such as text/graphic clicking, sliding/dragging, and rotation.
*   [ng-recaptcha-2 (⭐21)](https://github.com/LakhveerChahal/ng-recaptcha-2) - Angular 18 fork of [ng-recaptcha (⭐479)](https://github.com/DethAriel/ng-recaptcha). Alternatively, you create your own service that implements Google's reCAPTCHA with the help of this [article](https://ben-5.azurewebsites.net/2024/9/5/google-recaptcha-v3-with-angular/#google_vignette).
...
*   [@semantic-components/re-captcha (⭐6)](https://github.com/khalilou88/semantic-components/tree/main/libs/re-captcha) - Angular 19+ integration of Google's reCAPTCHA using **signal inputs** and **standalone components**.
...
*   [ngx-slider (⭐399)](https://github.com/angular-slider/ngx-slider) - Self-contained, mobile friendly slider component for Angular based on [angularjs-slider (⭐1.2k)](https://github.com/angular-slider/angularjs-slider).
...
*   [ngx-owl-carousel-o (⭐189)](https://github.com/vitalii-andriiovskyi/ngx-owl-carousel-o) - owl-carousel for Angular >=6.
...
*   [carousel-library (⭐17)](https://github.com/GreenFlag31/carousel-library) - A versatile Angular library providing a feature-rich, simple, and performant carousel component.
...
*   [embla-carousel-angular (⭐31)](https://github.com/donaldxdonald/embla-carousel-angular) - Angular wrapper for [Embla Carousel (⭐7.3k)](https://github.com/davidjerleke/embla-carousel).
...
*   [ngx-cookie-service (⭐563)](https://github.com/stevermeister/ngx-cookie-service) - Angular service for cookies. Originally based on the [ng2-cookies (⭐64)](https://github.com/BCJTI/ng2-cookies) library.
...
*   [ngx-cookieconsent (⭐169)](https://github.com/tinesoft/ngx-cookieconsent) - Cookie Consent module for Angular.
*   [cookieconsent (⭐4.8k)](https://github.com/orestbida/cookieconsent) - Simple cross-browser cookie-consent plugin written in vanilla js that can be added to [Angular](https://cookieconsent.orestbida.com/essential/getting-started.html#angular).
...
*   [ng2csv (⭐7)](https://github.com/rars/ng2csv) - Angular service for saving data to CSV file.
...
*   [active-table (⭐282)](https://github.com/OvidijusParsiunas/active-table) - Framework agnostic table component for editable data experience.
*   [jsgrids (⭐200)](https://github.com/statico/jsgrids) - A comparison tool to compare JavaScript data grid and spreadsheet libraries.  Find even more libraries from this repo.
...
*   [ngx-panemu-table (⭐11)](https://github.com/panemu/ngx-panemu-table) - An Angular table component. It is designed to be easy to use. Most work will be in TypeScript file, while the HTML file only needs to have a very simple `panemu-table` tag.
...
*   [ngx-mat-timepicker (⭐131)](https://github.com/tonysamperi/ngx-mat-timepicker) - A true material timepicker.
*   [ngx-datetime-range-picker (⭐28)](https://github.com/BhavinPatel04/ngx-datetime-range-picker) - Angular material datetime range picker with daily, weekly, monthly, quarterly & yearly levels.
...
*   [ngx-multiple-dates (⭐14)](https://github.com/lekhmanrus/ngx-multiple-dates) - Multiple dates picker based on Angular Material.
...
*   [ngx-dynamic-hooks (⭐120)](https://github.com/MTobisch/ngx-dynamic-hooks) - Automatically insert live Angular components into dynamic strings (based on their selector or any pattern of your choice) and render the result in the DOM.
...
*   [ngx-highlightjs (⭐292)](https://github.com/MurhafSousli/ngx-highlightjs) - Instant code highlighting, auto-detect language, super easy to use!
*   [ngx-sharebuttons (⭐536)](https://github.com/MurhafSousli/ngx-sharebuttons) - Angular share buttons.
...
*   [ng-dompurify (⭐10)](https://github.com/taiga-family/ng-dompurify) - This library implements [DOMPurify (⭐16k)](https://github.com/cure53/DOMPurify) as Angular Sanitizer or Pipe. It delegates sanitizing to DOMPurify and supports the same configuration.
...
*   [ngx-signal-pipes (⭐14)](https://github.com/wassim-k/ngx-signal-pipes) - Transform Angular signals with functional pipes.
...
*   [ngx-annotate-text (⭐18)](https://github.com/philenius/ngx-annotate-text) - This Angular component library is perfect for tasks like visualizing named entity recognition, part of speech tagging, or annotating text datasets. It allows for interactively highlighting and annotating parts of text.
...
*   [ngx-drag-drop (⭐322)](https://github.com/reppners/ngx-drag-drop) - Angular directives using the native HTML Drag And Drop API.
...
*   [ng-dnd (⭐127)](https://github.com/ng-dnd/ng-dnd) - Drag and Drop for Angular.
...
*   [ngx-swapy (⭐9)](https://github.com/omnedia/ngx-swapy) - A simple component library to get a drag and drop DOM through the help of [Swapy (⭐8k)](https://github.com/TahaSh/swapy).
...
*   [ngx-drag-resize (⭐10)](https://github.com/dmytro-parfenov/ngx-drag-resize) - This Angular library provides directives that add drag and resize functionality to HTML elements.
...
*   [acrodata/code-editor (⭐41)](https://github.com/acrodata/code-editor) - CodeMirror 6 wrapper for Angular.
...
*   [ngx-editor (⭐481)](https://github.com/sibiraj-s/ngx-editor) - Rich Text Editor for Angular using ProseMirror.
*   [code-editor (⭐132)](https://github.com/ngstack/code-editor) - Code editor component for Angular applications.
*   [ngx-wig (⭐232)](https://github.com/stevermeister/ngx-wig) - Angular(also Angular 17) WYSIWYG HTML Rich Text Editor.
*   [ngx-monaco-editor (⭐5)](https://github.com/jean-merelis/ngx-monaco-editor) - Monaco Code Editor for Angular.
...
*   [ngx-tiptap (⭐159)](https://github.com/sibiraj-s/ngx-tiptap) - Angular bindings for [tiptap v2](https://tiptap.dev/).
*   [tinymce-angular (⭐342)](https://github.com/tinymce/tinymce-angular) - Official [TinyMCE](https://www.tiny.cloud/) Angular Component.
*   [slate-angular (⭐185)](https://github.com/worktile/slate-angular) - Angular view layer for [Slate (⭐31k)](https://github.com/ianstormtaylor/slate).
*   [BlockNoteAngular (⭐8)](https://github.com/dytab/BlockNoteAngular) - Unofficial [BlockNote (⭐8.3k)](https://github.com/TypeCellOS/BlockNote) Angular wrapper.
...
*   [formly-editor (⭐16)](https://github.com/sesan07/formly-editor) - A configurable editor for [ngx-formly (⭐2.9k)](https://github.com/ngx-formly/ngx-formly) forms.
...
*   [ngx-file-drop (⭐299)](https://github.com/georgipeltekov/ngx-file-drop) - Angular module for simple desktop file and folder drag and drop. This library does not need rxjs-compat.
...
*   [ngx-custom-material-file-input (⭐11)](https://github.com/daemons88/ngx-custom-material-file-input) - File input management for Angular Material.
...
*   [ngx-file-preview (⭐5)](https://github.com/wh131462/ngx-file-preview) - A powerful preview tool for many file types.
...
*   [ng-signal-forms (⭐148)](https://github.com/timdeschryver/ng-signal-forms) - Signal powered Angular Forms.
...
*   [ngx-currency (⭐247)](https://github.com/nbfontana/ngx-currency) - Currency mask module for Angular.
...
*   [ngx-focus-entities (⭐2)](https://github.com/klee-contrib/ngx-focus-entities) - Library for generating reactive Angular forms from a Focus4 representation generated with [TopModel (⭐16)](https://github.com/klee-contrib/topmodel).
*   [@TanStack/form (⭐5.6k)](https://github.com/TanStack/form) - Designed with first-class TypeScript support, headless UI components, and a framework-agnostic design, it streamlines form handling and ensures a seamless experience across various front-end frameworks.
...
*   [ngx-color (⭐441)](https://github.com/scttcper/ngx-color) - 🎨 Color Pickers from Sketch, Photoshop, Chrome, Github, X & more.
*   [ngx-color-picker (⭐469)](https://github.com/zefoy/ngx-color-picker) - Color picker widget.
*   [angular-colorful (⭐10)](https://github.com/ngx-eco/angular-colorful) - A tiny color picker component for modern Angular apps.
*   [ng-select (⭐3.4k)](https://github.com/ng-select/ng-select) - All in One UI Select, Multiselect and Autocomplete.
...
*   [ngx-filesaver (⭐88)](https://github.com/cipchk/ngx-filesaver) - Simple file save with [FileSaver.js (⭐22k)](https://github.com/eligrey/FileSaver.js).
*   [ngx-bar-rating (⭐218)](https://github.com/MurhafSousli/ngx-bar-rating) - Angular Bar Rating.
*   [angular-code-input (⭐187)](https://github.com/AlexMiniApps/angular-code-input) - Robust and tested code (number/chars) input component for Angular 7 - 16+ projects. Ionic 4 - 7+ is supported, can be used in iOS and Android. Clipboard events are supported.
...
*   [ngx-show-hide-password (⭐20)](https://github.com/osahner/ngx-show-hide-password) - Add split input button to password or text input. Toggles input type between "text" and "password".
...
*   [ngx-countries-dropdown (⭐7)](https://github.com/kapilkumar0037/ngx-countries-dropdown) - Angular library with customizable countries dropdown component with flags, dial code, language and currency details.
...
*   [ng-select2 (⭐58)](https://github.com/Harvest-Dev/ng-select2) - This Angular CLI module is a fork of [select2-component (⭐23)](https://github.com/plantain-00/select2-component).
...
*   [ng-country-select (⭐19)](https://github.com/wlucha/ng-country-select) - A smart, multilingual country search with flags and codes.
...
*   [formio (⭐681)](https://github.com/formio/angular) - JSON powered forms for Angular.
*   [fluent-form (⭐50)](https://github.com/fluent-form/fluent-form) - Building dynamic form in Angular with Fluent API or JSON.
*   [jsonforms (⭐2.5k)](https://github.com/eclipsesource/jsonforms) - Customizable JSON Schema-based forms with React, Angular and Vue support out of the box.
*   [jsonforms-angular-seed (⭐37)](https://github.com/eclipsesource/jsonforms-angular-seed) - Angular-based JSON Forms seed app.
*   [ng-formworks (⭐5)](https://github.com/zahmo/ng-formworks) - An Angular [JSON Schema](https://json-schema.org/) Form builder, similar to, and mostly API compatible with, [Angular Schema Form](http://schemaform.io/examples/bootstrap-example.html), [React JSON Schema Form](https://rjsf-team.github.io/react-jsonschema-form/), and [JSON Form](https://ulion.github.io/jsonform/playground/).
...
*   [dynamic-forms (⭐24)](https://github.com/dynamic-forms/dynamic-forms) - Angular project for dynamic forms based on JSON.
...
*   [ng-icons (⭐476)](https://github.com/ng-icons/ng-icons) - The ultimate icon library for Angular.
*   [primeicons (⭐310)](https://github.com/primefaces/primeicons) - PrimeIcons is the default icon library of PrimeNG with over 250 open source icons developed by PrimeTek.
...
*   [ionic-angular-collect-icons (⭐6)](https://github.com/rdlabo-team/ionic-angular-collect-icons) - This library is used to uniquely group the ionIcons in a project, and generate for export ionIcons file.
...
*   [angular-tabler-icons (⭐34)](https://github.com/pierreavn/angular-tabler-icons) - This package allows you to use the [Tabler Icons](https://tabler.io/icons) in your Angular applications.
*   [ngx-fast-svg (⭐63)](https://github.com/push-based/ngx-fast-svg) - SVGs, fast and developer friendly in Angular.
...
*   [Semantic icons (⭐15)](https://github.com/khalilou88/semantic-icons) - A collection of free and open source icons ready for use in your angular projects using the component attribute selector and the svg tag.
*   [coolshapes (⭐8)](https://github.com/ngxpert/coolshapes) -  An Angular library aiming at allowing developers to use cool-looking abstract shapes with little grainy gradients from [coolshapes](https://coolshap.es/).
*   [lucide (⭐18k)](https://github.com/lucide-icons/lucide) - An open-source icon library that provides 1000+ vector (svg) files for displaying icons and symbols in digital and non-digital projects. The library aims to make it easier for designers and developers to incorporate icons into their Angular projects by providing an official [package](https://lucide.dev/guide/packages/lucide-angular).
*   [@ngverse/icons (⭐8)](https://github.com/ngverse/icons) - Angular library that allows you to use popular open-source icons as regular components.
...
*   [hotkeys (⭐340)](https://github.com/ngneat/hotkeys) - A declarative library for handling hotkeys in Angular applications.
*   [ngx-contextmenu (⭐43)](https://github.com/PerfectMemory/ngx-contextmenu) - A context menu component for Angular.

#### Layout Components

*   [angular-split (⭐904)](https://github.com/bertrandg/angular-split) - Angular split component.
...
*   [ngx-layout (⭐224)](https://github.com/ngbracket/ngx-layout) - Clone of Angular FlexLayout.
*   [ng-sortgrid (⭐148)](https://github.com/kreuzerk/ng-sortgrid) - A grid that allows you to sort all items via drag & drop.
*   [angular-gridster2 (⭐1.3k)](https://github.com/tiberiuzuld/angular-gridster2) - Angular gridster 2.
*   [angular-grid-layout (⭐489)](https://github.com/katoid/angular-grid-layout) - Responsive grid with draggable and resizable items for Angular applications.
*   [gridstack (⭐8.2k)](https://github.com/gridstack/gridstack.js/tree/master/angular/) - Mobile-friendly modern Typescript library for dashboard layout and creation. Making a drag-and-drop, multi-column responsive dashboard has never been easier. Has multiple bindings and works great with Angular.
*   [ngx-flickering-grid (⭐2)](https://github.com/omnedia/ngx-flickering-grid) - A simple component library to create a container with an animated grid pattern background.
...
*   [ngx-mapbox-gl (⭐352)](https://github.com/Wykks/ngx-mapbox-gl) - Angular binding of mapbox-gl-js.
*   [ng-maps (⭐48)](https://github.com/ng-maps/ng-maps) - Modular map components for Angular.
*   [ngx-leaflet (⭐795)](https://github.com/bluehalo/ngx-leaflet) - Core Leaflet package for Angular.
...
*   [ngx-maplibre-gl (⭐90)](https://github.com/maplibre/ngx-maplibre-gl) - Angular binding of maplibre-gl.
*   [ng-azure-maps (⭐18)](https://github.com/arnaudleclerc/ng-azure-maps) - An Angular library, mostly an HTML-driven wrapper of the azure-maps-controls package, allowing you to easily integrate its functionalities into an Angular application.
...
*   [angular-yandex-maps (⭐64)](https://github.com/ddubrava/angular-yandex-maps) - Yandex.Maps Angular components that implement the Yandex.Maps JavaScript API.
...
*   [ngx-remark (⭐11)](https://github.com/ericleib/ngx-remark) - Render markdown with custom Angular templates.
*   [angular-markdown-editor (⭐172)](https://github.com/ghiscoding/angular-markdown-editor) - Angular Markdown Editor. All-in-one Markdown Editor and Preview.
...
*   [ngx-cam-shoot (⭐3)](https://github.com/RzoDev/ngx-cam-shoot) - A streamlined Angular component that simplifies using your device's camera and accelerates image capture and saving.
...
*   [rx-angular (⭐2k)](https://github.com/rx-angular/rx-angular) - RxAngular offers a toolkit for handling fully reactive apps with the main focus on runtime performance, template rendering, and developer experience.
*   [ng-web-apis (⭐792)](https://github.com/taiga-family/ng-web-apis) - A set of common utils for consuming Web APIs with Angular.
*   [daffodil (⭐161)](https://github.com/graycoreio/daffodil) - Angular Ecommerce PWA Framework.
*   [ngworker (⭐36)](https://github.com/ngworker/ngworker) - Monorepo for the @ngworker NPM organization. Packages for Angular applications and testing.
*   [jscutlery devkit (⭐263)](https://github.com/jscutlery/devkit) - Tools that make Angular developer's life easier.
...
*   [ngspot (⭐31)](https://github.com/DmitryEfimenko/ngspot) - Collection of awesome Angular libraries.
*   [ts-cacheable (⭐343)](https://github.com/angelnikolov/ts-cacheable) - A popular platform-agnostic caching library.
*   [ngxtension-platform (⭐704)](https://github.com/ngxtension/ngxtension-platform) - Utilities for Angular.
*   [spartan (⭐2k)](https://github.com/goetzrobin/spartan) - Cutting-edge tools powering Angular full-stack development.
*   [ngify (⭐146)](https://github.com/ngify/ngify) - Use Angular features outside of Angular.
...
*   [angular-ru-sdk (⭐73)](https://github.com/Angular-RU/angular-ru-sdk) - A set of tool chains that implement common interaction patterns while being unopinionated about their presentation. It represents an abstraction of the core functionalities found in Angular.
...
*   [nxt-components (⭐22)](https://github.com/Liquid-JS/nxt-components) - A collection of various Angular components.
...
*   [ngx-sweetalert2 (⭐672)](https://github.com/sweetalert2/ngx-sweetalert2) - Declarative, reactive, and template-driven SweetAlert2 integration for Angular.
*   [ngx-toastr (⭐2.6k)](https://github.com/scttcper/ngx-toastr) - Notifications/Toastr.
*   [hot-toast (⭐153)](https://github.com/ngxpert/hot-toast) - Smoking hot toast notifications for Angular.
*   [ngx-sonner (⭐136)](https://github.com/tutkli/ngx-sonner) - An opinionated toast component for Angular. A port of @emilkowalski's sonner.
...
*   [ngx-print (⭐0)](https://github.com/selemxmn/ngx-print) - A plug n' play Angulae library to print your stuff.
...
*   [angularx-qrcode (⭐496)](https://github.com/cordobo/angularx-qrcode) - A fast and easy-to-use Ivy compatible Ionic and Angular QR Code Generator library.
...
*   [ngx-scanner (⭐652)](https://github.com/zxing-js/ngx-scanner) - Angular QR code, Barcode, DataMatrix, scanner component using ZXing.
...
*   [Angular-html5qrcode (⭐2)](https://github.com/mohamedfakhreldin/Angular-html5qrcode) - This library provides an Angular wrapper for the [html5-qrcode (⭐5.6k)](https://github.com/mebjas/html5-qrcode) library, allowing developers to easily integrate QR code and barcode scanning functionalities into their applications.
*   [ngx-kjua (⭐94)](https://github.com/werthdavid/ngx-kjua) - Angular QR-Code generator component using [kjua (⭐277)](https://github.com/lrsjng/kjua).
*   [ngx-qrcode (⭐2)](https://github.com/GNURub/ngx-qrcode) - A simple Angular 18+ component to generate QR codes. Based on [react-native-qrcode-skia (⭐258)](https://github.com/enzomanuelmangano/react-native-qrcode-skia) library.
...
*   [ngx-quicklink (⭐754)](https://github.com/mgechev/ngx-quicklink) - Quicklink prefetching strategy for the Angular router.
*   [ngx-hover-preload (⭐177)](https://github.com/mgechev/ngx-hover-preload) - Preload Angular lazy-loaded routes on mouse over.
...
*   [ngx-ui-scroll (⭐229)](https://github.com/dhilt/ngx-ui-scroll) - Virtual/infinite scroll for Angular.
...
*   [angular-fullpage (⭐178)](https://github.com/alvarotrigo/angular-fullpage) - Official component for fullPage.js, a fullscreen scrolling library.
*   [ngx-scrolltop (⭐30)](https://github.com/bartholomej/ngx-scrolltop) - Lightweight, Material Design inspired button for scroll-to-top of the page. No dependencies.
...
*   [ngx-scrollbar (⭐642)](https://github.com/MurhafSousli/ngx-scrollbar) - Custom overlay-scrollbars with native scrolling mechanism.
*   [ngx-tracing-beam (⭐3)](https://github.com/omnedia/ngx-tracing-beam) - A simple component library to add an animated tracing beam to your vertical scrolling.
*   [ngx-marquee (⭐3)](https://github.com/omnedia/ngx-marquee) - A simple component library to create an infinite scrolling marquee with your content.
*   [@omnedia/ngx-scrollbar (⭐2)](https://github.com/omnedia/ngx-scrollbar) - This component offers a custom scrollbar with smooth scrolling functionality and allows for full control over its appearance through styling.
...
*   [ngx-virtual-scroller (⭐54)](https://github.com/iharbeck/ngx-virtual-scroller) - Displays a virtual, "infinite" list. Supports horizontal/vertical, variable heights, and multi-column.
...
*   [ngrx-course (⭐410)](https://github.com/angular-university/ngrx-course) - Angular University Complete Guide.
*   [ngrx-store-localstorage (⭐618)](https://github.com/btroncone/ngrx-store-localstorage) - Simple syncing between `@ngrx/store` and local storage.
*   [ngrx-toolkit (⭐257)](https://github.com/angular-architects/ngrx-toolkit) - Various Extensions for the NgRx Signal Store.
*   [ngrx-traits (⭐94)](https://github.com/gabrielguerrero/ngrx-traits) - NgRx Traits is a library to help you compose and reuse a set NGRX actions, selectors, effects, and reducers across your app.
...
*   [ngrx-immer (⭐123)](https://github.com/timdeschryver/ngrx-immer) - Immer wrappers around NgRx methods createReducer, on, and ComponentStore.
*   [ngrx-rtk-query (⭐63)](https://github.com/SaulMoro/ngrx-rtk-query) - Make RTK Query with Hooks works in Angular Applications.
*   [angular-ngrx-nx-realworld-example-app (⭐990)](https://github.com/stefanoslig/angular-ngrx-nx-realworld-example-app) - Real world application built with Angular 17, NgRx 17, & Nx 17.
...
*   [ngx-signal-store-query (⭐9)](https://github.com/k3nsei/ngx-signal-store-query) - Signal Store feature that bridges with [Angular Query](https://tanstack.com/query/latest/docs/framework/angular/overview).
*   [SmartNgRX (⭐19)](https://github.com/DaveMBush/SmartNgRX) - A library that hides most of NgRx from the developer for CRUD operations while still using NgRx under the hood and allowing you to use it with existing NgRx code.
...
*   [actions-executing (⭐28)](https://github.com/ngxs-labs/actions-executing) - This plugin allows you to easily know if an action is being executed and control UI elements or control flow of your code to execute.
...
*   [elf (⭐1.7k)](https://github.com/ngneat/elf) - A reactive immutable state management solution built on top of RxJS. It uses custom RxJS operators to query the state and pure functions to update it.
...
*   [query (⭐46k)](https://github.com/TanStack/query) - Powerful asynchronous state management, server-state utilities and data fetching for the web.
*   [state-adapt (⭐303)](https://github.com/state-adapt/state-adapt) - Declarative, incremental state management library.
*   [ngx-signal-state (⭐62)](https://github.com/simplifiedcourses/ngx-signal-state) - Opinionated simple state management for Angular.
*   [mini-rx-store (⭐170)](https://github.com/spierala/mini-rx-store) - MiniRx is the reactive state management platform.
*   [ngx-collection (⭐33)](https://github.com/e-oz/ngx-collection) - Collection State Management Service for Angular.
*   [xstate (⭐28k)](https://github.com/statelyai/xstate) - Actor-based state management & orchestration for complex app logic.
*   [signalstory (⭐45)](https://github.com/zuriscript/signalstory) - A state management library based on Angular signals. It offers a range of architectural options, from simple repository-based state management (signal-in-a-service) to orchestrating decoupled commands, handling side effects through encapsulated objects, and facilitating inter-store communication using an event-driven approach.
...
*   [tansu (⭐97)](https://github.com/AmadeusITGroup/tansu) - A lightweight, push-based state management library. It works well with [the Angular ecosystem](https://amadeusitgroup.github.io/tansu/#md:tansu-works-well-with-the-angular-ecosystem).
...
*   [ng-simple-state-management (⭐4)](https://github.com/LionMarc/ng-simple-state-management) - Simple state management implementation for Angular applications. This project provides several libraries for additional functionality.
...
*   [ngx-reactive-storage (⭐52)](https://github.com/e-oz/ngx-reactive-storage) - Wrapper around IndexedDB and localStorage that allows you to create databases and tables using a simple, promise-based API. Changes to the data can be seen with Angular Signals or RxJS Observables.
*   [ng2-webstorage (⭐428)](https://github.com/PillowPillow/ng2-webstorage) - LocalStorage and SessionStorage manager.
*   [ngx-indexed-db (⭐186)](https://github.com/assuncaocharles/ngx-indexed-db) - Wraps IndexedDB in an Angular service.
...
*   [signaldb (⭐523)](https://github.com/maxnowack/signaldb) - A local JavaScript database with a MongoDB-like interface and TypeScript support, enabling optimistic UI with signal-based reactivity. It integrates easily with Angular, Solid.js, Preact, and Vue, simplifying data management with schema-less design, in-memory storage, and fast queries.
...
*   [helipopper (⭐435)](https://github.com/ngneat/helipopper) - A Powerful Tooltip and Popover for Angular Applications.
*   [popover (⭐228)](https://github.com/ncstate-sat/popover) - Popover component for Angular.
*   [ngx-tooltip-directives (⭐7)](https://github.com/mkeller1992/ngx-tooltip-directives) - This library offers three different tooltip directives (string, html and template) and draws inspiration from the no longer maintained [ng2-tooltip-directive (⭐99)](https://github.com/drozhzhin-n-e/ng2-tooltip-directive).
...
*   [ngx-popovers (⭐16)](https://github.com/al-march/ngx-popovers) - An Angular library based on [Floating UI](https://floating-ui.com/) with already ready-made components to use.
...
*   [Syncfusion](https://www.syncfusion.com/angular-components) - Its [Essential UI Kit for Angular (⭐14)](https://github.com/syncfusion/essential-ui-kit-for-angular) is compatible with both Tailwind CSS and Bootstrap.
*   [ej2-angular-ui-components (⭐288)](https://github.com/syncfusion/ej2-angular-ui-components) - Syncfusion Angular UI Components library has been built from the ground up to be lightweight, responsive, modular and touch friendly. It offers 70+ UI components that every applications will ever need.
...
*   [ngx-ui (⭐724)](https://github.com/swimlane/ngx-ui) - Style and Component Library for Angular2 and beyond!
*   [prime-ng (⭐12k)](https://github.com/primefaces/primeng) - The Most Complete Angular UI Component Library.
...
*   [ng-aquila (⭐238)](https://github.com/allianz/ng-aquila) - Aquila is an open-source component library provided by the Allianz Global Digital Factory (GDF). We use this library internally with Allianz branding. Here we provide a white label variant of these components.
*   [enterprise-ng (⭐7)](https://github.com/infor-design/enterprise-ng) - Angular wrappers for IDS Enterprise components.
*   [oblique (⭐64)](https://github.com/oblique-bit/oblique) - An Angular front-end framework Tailored for your swiss branded business web application, Oblique provides a standardized corporate design look and feel as well as a collection of ready-to-use Angular components.
*   [fundamental-ngx (⭐280)](https://github.com/SAP/fundamental-ngx) - Fundamental Library for Angular is SAP Design System Angular component library.
*   [designsystem (⭐89)](https://github.com/kirbydesign/designsystem) - Kirby Design System is a UX Component library implementing the Kirby Design Philosophy.
*   [sbb-angular (⭐115)](https://github.com/sbb-design-systems/sbb-angular) - Angular Library for SBB.
*   [ui (⭐32)](https://github.com/alauda/ui) - Enterprise level Angular UI framework from Alauda Frontend Team.
*   [ngx-tethys (⭐115)](https://github.com/atinc/ngx-tethys) - Fast and reliable Tethys Design components for Angular.
...
*   [ng-clarity (⭐383)](https://github.com/vmware-clarity/ng-clarity) - Clarity Angular is a scalable, accessible, customizable, open-source design system built for Angular.
...
*   [orchestrator (⭐15)](https://github.com/orchestratora/orchestrator) - Extensible orchestrator for UI and forms for Angular.
...
*   [carbon-components-angular (⭐549)](https://github.com/carbon-design-system/carbon-components-angular) - An Angular implementation of the Carbon Design System for IBM.
*   [dyte-io/ui-kit (⭐6)](https://github.com/dyte-io/ui-kit/tree/staging/packages/angular-library) - Dyte's UI Kit is a prebuilt design library of UI components that makes it easy to integrate video and voice calls into any app or website within minutes.
...
*   [po-angular (⭐947)](https://github.com/po-ui/po-angular) - Component library based on Angular. Documentation in Portuguese.
*   [ngx-nighthawk (⭐11)](https://github.com/evenuxjs/ngx-nighthawk) - It offers a comprehensive set of components that are highly configurable and user-friendly. This package integrates the best open-source tools, such as Bootstrip — a streamlined version of Bootstrap that focuses solely on Grid and Utility features.
...
*   [@ng-verse/ui (⭐42)](https://github.com/ngverse/ui) - A collection of feature-rich Angular components, directives, and pipes. Unlike traditional UI libraries, it requires no installation—just copy and paste what you need into your project.  Check the [docs](https://ui.ngverse.dev/) for more.
...
*   [@ng-matero/extensions (⭐479)](https://github.com/ng-matero/extensions) - Angular Material Extensions Library.
*   [angular-material-css-vars (⭐195)](https://github.com/johannesjo/angular-material-css-vars) - Little library to use CSS variables with Angular Material.
...
*   [simui (⭐24)](https://github.com/dofu-lab/simui) - Beautiful Angular UI components built with Tailwind CSS and Spartan.
...
*   [ngx-vflow (⭐329)](https://github.com/artem-mangilev/ngx-vflow) - An open source library to build node-based UI with Angular.

##### Primitives

*   [ng-primitives (⭐386)](https://github.com/ng-primitives/ng-primitives) - A low-level UI component library with a focus on accessibility, customization, and developer experience.
*   [primitives (⭐206)](https://github.com/radix-ng/primitives) - Angular port of [Radix UI](https://www.radix-ui.com/) Primitives. Accessible. Customizable.
...
*   [angular-shepherd (⭐231)](https://github.com/shepherd-pro/angular-shepherd) - Angular Service wrapping the site tour library [Shepherd (⭐13k)](https://github.com/shepherd-pro/shepherd).
*   [skyux (⭐43)](https://github.com/blackbaud/skyux) - SKY UX components for Angular.
*   [ngx-ui-tour (⭐195)](https://github.com/hakimio/ngx-ui-tour) - A UI tour library inspired by [angular-ui-tour (⭐164)](https://github.com/benmarch/angular-ui-tour).
...
*   [ngx-countdown (⭐197)](https://github.com/cipchk/ngx-countdown) - Simple, easy and performant countdown.
...
*   [rx-computed (⭐263)](https://github.com/jscutlery/devkit/tree/main/packages/rx-computed) - The async RxJS-based version of signals' `computed()`.
*   [microwave (⭐263)](https://github.com/jscutlery/devkit/tree/main/packages/microwave) - Optimize Angular change detection effortlessly.
*   [ngx-device-detector (⭐540)](https://github.com/AhsanAyaz/ngx-device-detector) - An Angular v7+ library to detect the device, OS, and browser details.
...
*   [gui (⭐119)](https://github.com/acrodata/gui) - JSON powered GUI for configurable panels.
...
*   [angular-paginator (⭐7)](https://github.com/sibiraj-s/angular-paginator) - Pagination Component for Angular applications.
*   [ngx-flamegraph (⭐68)](https://github.com/mgechev/ngx-flamegraph) - Flame graph for stack trace visualization written in Angular.
...
*   [ng2-idle (⭐334)](https://github.com/moribvndvs/ng2-idle) - A module for responding to idle users in Angular applications.
...
*   [ngx-gauge (⭐221)](https://github.com/ashish-chopra/ngx-gauge) - A highly customizable Gauge component for Angular apps and dashboards.
...
*   [ng-whiteboard (⭐57)](https://github.com/mostafazke/ng-whiteboard) - Lightweight Angular whiteboard component.
...
*   [ionic-angular-library (⭐8)](https://github.com/rdlabo-team/ionic-angular-library) - A collection of components and services that are useful for developing Ionic Angular applications.
*   [ionic-angular-collect-icons (⭐6)](https://github.com/rdlabo-team/ionic-angular-collect-icons) - This library is used to uniquely group the ionIcons in a project, and generate for export ionIcons file. In small projects, it is difficult to manage addIcons() of ionIcons each time, so we automated it.
...
*   [rxjs-course (⭐392)](https://github.com/angular-university/rxjs-course) - RxJS course from Angular University
...
*   [rxjs-challenge (⭐614)](https://github.com/AngularWave/rxjs-challenge) - A set of little RxJS puzzles to practice your Observable skills.
*   [operators (⭐263)](https://github.com/jscutlery/devkit/tree/main/packages/operators) - This package regroups a couple of RxJS operators meant to simplify some common patterns.
*   [until-destroy (⭐1.8k)](https://github.com/ngneat/until-destroy) - RxJS operator that unsubscribe from observables on destroy.
...
*   [ngx-operators (⭐139)](https://github.com/nilsmehlhorn/ngx-operators) - RxJS operators for Angular.
...
*   [observable-webworker (⭐231)](https://github.com/cloudnc/observable-webworker) - Simplified API for working with Web Workers with RxJS.
...
*   [eslint-plugin-rxjs-x (⭐28)](https://github.com/JasonWeinzierl/eslint-plugin-rxjs-x) - A fork of [eslint-plugin-rxjs (⭐316)](https://github.com/cartant/eslint-plugin-rxjs) initially started to support the new ESLint flat config format that has since had numerous breaking changes and further improvements.
...
*   [valibot (⭐7.8k)](https://github.com/fabian-hiller/valibot) - The modular and type safe schema library for validating structural data.
...
*   [type-fest (⭐16k)](https://github.com/sindresorhus/type-fest) - A collection of essential TypeScript types. Either add the package as a dependency or copy-paste the needed types.
...
*   [npm-clang-format-node (⭐22)](https://github.com/lumirlumir/npm-clang-format-node) - Node wrapper for LLVM Clang's clang-format and git-clang-format native binaries inspired by [angular/clang-format (⭐101)](https://github.com/angular/clang-format).
...
*   [reaktiv (⭐294)](https://github.com/buiapp/reaktiv) - Reactive Signals for Python with first-class async support, inspired by Angular's reactivity model.
...
*   [awesome-utils-dev/angular (⭐235)](https://github.com/pegaltier/awesome-utils-dev/blob/master/utils-coding/utils-angular-list.md) - This is an exhaustive list of resources covering the whole Angular ecosystem. This should be your next step if you haven't found what you need here.
*   [awesome-angular (⭐96)](https://github.com/DaanDeSmedt/awesome-angular)
