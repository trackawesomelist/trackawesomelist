...
### Training / Google Developer Experts
...
*   [ngXpress (⭐22)](https://github.com/angularcafe/ngXpress) - The Full-Stack Angular Starter Kit (SSR, Zoneless, Express 5, Prisma, better-auth, Tailwind CSS 4).
...
*   [ngx-animated-paginator (⭐2)](https://github.com/eladbh-stanley/ngx-animated-paginator) - Angular wrapper for [animated-paginator-web-component](https://www.npmjs.com/package/animated-paginator-web-component) that plugs seamlessly into template-driven and reactive forms via `ControlValueAccessor`.
...
*   [amcharts5 (⭐402)](https://github.com/amcharts/amcharts5) - The newest, fastest, and most advanced amCharts charting library for JavaScript and TypeScript apps. Check out the [Angular integration guide](https://www.amcharts.com/docs/v5/getting-started/integrations/angular/) to get started. Additionally, older versions are still being updated to support newer releases of Angular.
...
*   [sonda (⭐571)](https://github.com/filipsobol/sonda) - Universal visualizer and analyzer for JavaScript and CSS.

### Internationalization / Google Developer Experts

*   [angular-intlayer](https://www.npmjs.com/package/angular-intlayer) - This [intlayer (⭐214)](https://github.com/aymericzip/intlayer) package allows you to internationalize your Angular application. It provides context providers and hooks for Angular internationalization.
...
*   [ngx-lite-video-v2 (⭐2)](https://github.com/KSmp/ngx-lite-video) - An updated fork of [ngx-lite-video (⭐4)](https://github.com/karim-mamdouh/ngx-lite-video), an Angular package that provides lazy loading capabilities for embedded iframes from popular video-sharing platforms like YouTube and Vimeo.

### TypeScript / Google Developer Experts

*   [typebuddy (⭐405)](https://github.com/typed-rocks/type-buddy) - Finally make sense of your complex types.
...
*   [@ngneat/svg-icon (⭐266)](https://github.com/ngneat/svg-icon) - A lightweight library that makes it easier to use SVG icons in your Angular Application.
...
*   [ngx-wysicat (⭐3)](https://github.com/michalgrzegorczyk-dev/ngx-wysicat) - Build beautiful, structured documents with ease. `ngx-wysicat` combines block-based editing, advanced formatting, and a flexible plugin system—all powered by `Quill`. Perfect for collaborative apps, note-taking tools, or any project where content quality matters.
...
*   [ozean (⭐4)](https://github.com/ozeanjs/ozean) - A modern, simple, and high-performance web framework built on the Bun runtime. It provides a development experience and architecture that should be familiar to Angular users.
...
*   [tailwind-angular-starter (⭐23)](https://github.com/themesberg/tailwind-angular-starter) - Free and open-source starter project to help you get started with Angular, Tailwind CSS, and the [Flowbite UI components (⭐218)](https://github.com/themesberg/flowbite-angular).
...
*   [ngx-boomer (⭐9)](https://github.com/angular-sanctuary/ngx-boomer) - This project is a straightforward utility designed to enforce rules that preserve Angular's previous naming conventions in Angular 20.
...
*   [angular-interview-questions (⭐17)](https://github.com/Devinterview-io/angular-interview-questions) - Angular interview questions and answers to help you prepare for your next technical interview in 2025.
...
*   [agent-rules-kit (⭐16)](https://github.com/tecnomanu/agent-rules-kit) - A CLI tool that facilitates the installation and configuration of rules for Cursor AI, the AI-powered IDE. The rules help AI agents better understand the structure, patterns, and best practices of different technology stacks.
...
*   [grand-notifications (⭐20)](https://github.com/rishi-rj-s/grand-notifications) - Beautiful, customizable toast notifications with artistic animations.
...
*   [angular-rspack (⭐78)](https://github.com/nrwl/angular-rspack) - [Rspack (⭐12k)](https://github.com/web-infra-dev/rspack) plugin and tooling for Angular applications.
...
*   [wdio-harness (⭐6)](https://github.com/badisi/wdio-harness) - WebdriverIO support for Angular component test harnesses.
...
*   [@angular/examples (⭐249)](https://github.com/angular/examples) - Angular Examples using [GenKit](https://firebase.google.com/docs/genkit) and [Vertex AI](https://cloud.google.com/vertex-ai).

### Analytics / Google Developer Experts

*   [ng-webdatarocks (⭐5)](https://github.com/WebDataRocks/ng-webdatarocks) - This repository contains the source code of the Angular wrapper for [WebDataRocks](https://www.webdatarocks.com/).  Follow this [example (⭐31)](https://github.com/WebDataRocks/pivot-angular) to integrate the WebDataRocks web reporting tool.

### Authentication / Google Developer Experts

*   [frontegg-angular (⭐5)](https://github.com/frontegg/frontegg-angular) - [Frontegg](https://frontegg.com) is a web platform where SaaS companies can set up their fully managed, scalable, and brand-aware SaaS features and integrate them into their SaaS portals in up to 5 lines of code. Quickly integrate Frontegg's login box with this [quickstart guide](https://developers.frontegg.com/sdks/frontend/angular/hosted-login).
...
*   [ng-dynamic-component (⭐563)](https://github.com/gund/ng-dynamic-component) - Dynamic components with full life-cycle support for inputs and outputs for Angular.
...
*   [needle-di (⭐74)](https://github.com/needle-di/needle-di) - A lightweight, type-safe Dependency Injection (DI) library for JavaScript and TypeScript projects.
...
*   [playwright-mcp (⭐16k)](https://github.com/microsoft/playwright-mcp) - A Model Context Protocol (MCP) server that provides browser automation capabilities using Playwright. This server enables LLMs to interact with web pages through structured accessibility snapshots, bypassing the need for screenshots or visually-tuned models.
...
*   [ngxi (⭐5)](https://github.com/adrian-ub/ngxi) - A comprehensive collection of SVG icons for Angular applications that provides seamless integration with thousands of popular icons.

### Mixed Utilities / Google Developer Experts

*   [mmstack (⭐17)](https://github.com/mihajm/mmstack) - A monorepo for mmstack libraries.
...
*   [ngx-oneforall (⭐3)](https://github.com/love1024/ngx-oneforall) - An Angular library with reusable pipes, directives, services, decorators, constants, enums, and more.
...
*   [zed-angular (⭐110)](https://github.com/nathansbradshaw/zed-angular) - This extension integrates the Angular Language Service into [Zed](https://zed.dev/).
...
*   [firebase-framework-tools (⭐340)](https://github.com/FirebaseExtended/firebase-framework-tools) - Experimental addon to the [Firebase CLI (⭐4.2k)](https://github.com/firebase/firebase-tools/) to add web framework support.

### Documentation Tools / Google Developer Experts

*   [easy-template-x-angular-expressions (⭐9)](https://github.com/alonrbar/easy-template-x-angular-expressions) - Angular expressions support for [easy-template-x (⭐453)](https://github.com/alonrbar/easy-template-x).

### HTTP / Google Developer Experts

*   [@connectrpc/connect-web (⭐1.6k)](https://github.com/connectrpc/connect-es/tree/main/packages/connect-web) - [Connect](https://connectrpc.com/) is a family of libraries for building and consuming APIs on different languages and platforms. [@connectrpc/connect](https://www.npmjs.com/package/@connectrpc/connect) brings type-safe APIs with Protobuf to TypeScript. `@connectrpc/connect-web` provides adapters for web browsers.  See this [example (⭐147)](https://github.com/connectrpc/examples-es/tree/main/angular) to integrate Connect with Angular.
...
*   [@configcat/js-sdk (⭐32)](https://github.com/configcat/js-sdk) - ConfigCat SDK for JavaScript provides easy integration for your application to [ConfigCat](https://configcat.com/).
...
*   [angular-tailwind-e-commerce-template (⭐4)](https://github.com/Kei-K23/angular-tailwind-e-commerce-template) - This responsive e-commerce template, built with Angular and TailwindCSS, combines modern aesthetics with functionality. Designed as a foundation for developing robust e-commerce applications, it features a sleek, customizable design, perfect for minimalist online shops.
...
*   [json-forms-zorro-wrapper (⭐5)](https://github.com/wojtek1150/json-forms-zorro-wrapper) - Ng Zorro wrapper for json forms library.
...
*   [zardui (⭐124)](https://github.com/zard-ui/zardui) - A collection of beautiful and accessible components for Angular based in [shadcn-ui (⭐92k)](https://github.com/shadcn-ui/ui) and NG-ZORRO. Fully open source and free.
...
*   [@joanpablo/reactive\_forms (⭐488)](https://github.com/joanpablo/reactive_forms) - This library, written in Dart, employs a model-driven approach to managing form inputs and validations, drawing significant inspiration from Angular's Reactive Forms.

## [Mar 21, 2025](/content/2025/03/21/README.md)

### Desktop / Google Developer Experts

*   [electron (⭐118k)](https://github.com/electron/electron) - Build cross-platform desktop apps with JavaScript, HTML, and CSS.
...
*   [manifest (⭐2.9k)](https://github.com/mnfst/manifest) - A lightweight Backend-as-a-Service (BaaS) that fits into a single YAML file. This [quick start](https://manifest.build/docs/angular) shows how to use it with Angular.

### Feature Flags / Google Developer Experts

*   [ngx-version-view (⭐14)](https://github.com/zenkiet/ngx-version-view) - A powerful Angular library that enables version-aware component rendering for seamless feature toggling based on application versions.

### Carousels / Google Developer Experts

*   [@MurhafSousli/ngx-gallery (⭐626)](https://github.com/MurhafSousli/ngx-gallery) - Angular Gallery, Carousel and Lightbox.
...
*   [sio (⭐10)](https://github.com/silicia-apps/sio) - Silicia Framework: a fresh approach built upon Ionic, designed to streamline the development of hybrid applications and websites.

## [Mar 19, 2025](/content/2025/03/19/README.md)

### HTTP / Google Developer Experts

*   [ngx-sse-client (⭐34)](https://github.com/marcospds/ngx-sse-client) - A simple **SSE** (Server Sent Events) client for Angular applications to replace the use of `EventSource`.
...
*   [ng-mat-select-infinite-scroll (⭐50)](https://github.com/HaidarZ/ng-mat-select-infinite-scroll) - Infinite Scroll directive for Angular Material select component.
...
*   [foblex2D (⭐5)](https://github.com/siarheihuzarevich/foblex2D) - An Angular library for 2D geometric computations, providing classes and utilities for manipulating points, lines, vectors, rectangles, arcs, and transformations. Used in `Foblex Flow` for 2D geometric operations.
...
*   [ngx-kel-agent (⭐1)](https://github.com/k0swe/ngx-kel-agent) - Client library for Angular applications to integrate with [kel-agent (⭐10)](https://github.com/k0swe/kel-agent).
...
*   [css-fx-layout (⭐48)](https://github.com/philmtd/css-fx-layout) - A responsive SCSS flexbox library inspired by Angular Flex-Layout.
...
*   [gapi (⭐27)](https://github.com/Stradivario/gapi) - Inspired by Angular and intended to provide complex Node.js GraphQL Backend applications with minimum effort.
...
*   [reaktiv (⭐307)](https://github.com/buiapp/reaktiv) - Reactive Signals for Python with first-class async support, inspired by Angular's reactivity model.
...
*   [vyuha (⭐5)](https://github.com/RamanSharma100/vyuha) - A Node.js Template Engine Inspired by EJS, Angular, and Laravel Blade.
...
*   [dataclouder-template-angular (⭐2)](https://github.com/dataclouder-dev/dataclouder-template-angular) - A ready-to-use Angular/Ionic template with Firebase Authentication integration.
...
*   [playwright-coverage (⭐45)](https://github.com/bgotink/playwright-coverage) - Report coverage on playwright tests using v8 coverage, without requiring any instrumentation.
...
*   [NG-ZORRO (⭐9.1k)](https://github.com/NG-ZORRO/ng-zorro-antd) - An enterprise-class UI components based on Ant Design and Angular.
...
*   [angular-unleash-proxy-client (⭐9)](https://github.com/Karelics/angular-unleash-proxy-client) - Angular wrapper for [unleash](https://www.getunleash.io/) and [unleash-proxy-client-js (⭐48)](https://github.com/Unleash/unleash-proxy-client-js).
...
*   [easy (⭐2)](https://github.com/richpauly13/easy) - **E**asy **A**ngular **S**tyles with a11**Y**.
...
*   [fusio-sdk-javascript-angular (⭐4)](https://github.com/apioo/fusio-sdk-javascript-angular) - This SDK library provides a flexible way to build Angular apps using [Fusio](https://www.fusio-project.org/) as a backend. It is used by many Fusio related apps, i.e. the [backend (⭐11)](https://github.com/apioo/fusio-apps-backend) and [developer (⭐4)](https://github.com/apioo/fusio-apps-developer) app.
...
*   [tsconfig (⭐12)](https://github.com/smartrecruiters/tsconfig) - SmartRecruiters' tsconfig contains all strict rules and improves your project type-safety.
...
*   [ngx-pocketbase (⭐3)](https://github.com/BerniHC/ngx-pocketbase) - PocketBase Angular SDK for interacting with the [PocketBase API](https://pocketbase.io/docs). Based on the [PocketBase JavaScript SDK (⭐2.6k)](https://github.com/pocketbase/js-sdk).
...
*   [ngx-repository (⭐34)](https://github.com/paddls/ngx-repository) - Easily create a strongly typed data client (HTTP REST or Firestore) in your Angular project.

### Integrations / Google Developer Experts

*   [Otter (⭐56)](https://github.com/AmadeusITGroup/otter) - A highly modular framework whose goal is to provide a common platform to accelerate and facilitate the development on Angular web applications. It is split into several units to cover different aspects of these applications (localization, testing, customization, etc.). Also, to customize an application, metadata can be extracted from the application source code and injected into a CMS to manage dynamic configuration.
*   [ngx-serializer (⭐4)](https://github.com/paddls/ngx-serializer) - Angular wrapper of @paddls/ts-serializer library.

### Free / Google Developer Experts

*   [@wlucha/angular-starter (⭐379)](https://github.com/wlucha/angular-starter) - Angular 19 Starter with Storybook, Transloco, Jest, Cypress, Docker, ESLint, Material, & Prettier.
...
*   [ngx-common (⭐26)](https://github.com/paddls/ngx-common) - A collection of useful features to enhance your Angular apps.
...
*   [primitives (⭐211)](https://github.com/radix-ng/primitives) - Angular port of [Radix UI](https://www.radix-ui.com/) Primitives. Accessible. Customizable.
...
*   [ngx-gist (⭐4)](https://github.com/ProAngular/ngx-gist) - An Angular Material and highlightjs styled display box for GitHub gist and local code snippets.
...
*   [angular-compile (⭐89)](https://github.com/patrikx3/angular-compile) - Angular Dynamic Compile. Convert strings to Angular components.
...
*   [ngx-reactify (⭐8)](https://github.com/knackstedt/ngx-reactify) - Library to make running Angular and React applications together easy.

### Layout Components / Google Developer Experts

*   [ng-simple-sidebar (⭐6)](https://github.com/secanis/ng-simple-sidebar) - A simple Angular component to generate a sidebar with a hamburger menu.
...
*   [ngx-swipe-menu (⭐2)](https://github.com/charlesschaefer/ngx-swipe-menu) - A component to create "swipe left to 'action'" experiences.

## [Jan 21, 2025](/content/2025/01/21/README.md)

### Free / Google Developer Experts

*   [extreme-angular (⭐154)](https://github.com/joematthews/extreme-angular) - A starter template with pre-configured dev tools that enforce best practices for creating clean, maintainable, and accessible web apps.
...
## [Jan 17, 2025](/content/2025/01/17/README.md)
...
*   [ngx-segment-analytics (⭐21)](https://github.com/opendecide/ngx-segment-analytics) - Provides an API for [Segment (⭐447)](https://github.com/segmentio/analytics-next/).

## [Jan 15, 2025](/content/2025/01/15/README.md)

### Free / Google Developer Experts

*   [@rainerhahnekamp/angular-starter (⭐64)](https://github.com/rainerhahnekamp/angular-starter) - A starter project for a modern Angular 19 application.
...
*   [ngx-form-object (⭐6)](https://github.com/infinum/ngx-form-object) - An abstraction on top of Angular's reactive forms. It generates a form from a given model and automatically handles creation of nested forms (HasOne and HasMany model relationships).

## [Jan 13, 2025](/content/2025/01/13/README.md)

### Captcha / Google Developer Experts

*   [@semantic-components/re-captcha (⭐7)](https://github.com/khalilou88/semantic-components/tree/main/libs/re-captcha) - Angular 19+ integration of Google's reCAPTCHA using **signal inputs** and **standalone components**.
...
*   [ngx-virtual-dnd-list (⭐3)](https://github.com/mfuu/ngx-virtual-dnd-list) - A virtual scrolling list component that can be sorted by dragging.
...
*   [embla-carousel-angular (⭐31)](https://github.com/donaldxdonald/embla-carousel-angular) - Angular wrapper for [Embla Carousel (⭐7.4k)](https://github.com/davidjerleke/embla-carousel).
...
*   [keycloakify-starter-angular-vite (⭐9)](https://github.com/keycloakify/keycloakify-starter-angular-vite) - Angular + Vite Starter for [Keycloakify 11](https://www.keycloakify.dev/).
...
## [Jan 02, 2025](/content/2025/01/02/README.md)
...
*   [@ng-matero/extensions (⭐477)](https://github.com/ng-matero/extensions) - Angular Material Extensions Library.
*   [ngx-material-auth (⭐3)](https://github.com/Service-Soft/ngx-material-auth) - A library for Angular which provides functionality around the frontend part of authentication and authorization.
...
*   [ngx-qrcode (⭐2)](https://github.com/GNURub/ngx-qrcode) - A simple Angular 18+ component to generate QR codes. Based on [react-native-qrcode-skia (⭐261)](https://github.com/enzomanuelmangano/react-native-qrcode-skia) library.

### Router / Google Developer Experts

*   [storybook-addon-angular-router (⭐12)](https://github.com/Jakob-em/storybook-addon-angular-router) - A simple plugin to make working with the Angular router in [Storybook](https://storybook.js.org/) easier.
...
*   [@module-federation/core (⭐2.1k)](https://github.com/module-federation/core) - Module Federation is a concept that allows developers to share code and resources across multiple JavaScript applications.
...
*   [backbase-micro-frontends (⭐2)](https://github.com/Backbase/backbase-micro-frontends) - Proof of concept showcasing how legacy apps (widgets) can work together with newer apps (journeys) via Module Federation.

### Editor Components / Google Developer Experts

*   [formly-editor (⭐17)](https://github.com/sesan07/formly-editor) - A configurable editor for `ngx-formly` forms.
...
*   [@TanStack/form (⭐5.7k)](https://github.com/TanStack/form) - Designed with first-class TypeScript support, headless UI components, and a framework-agnostic design, it streamlines form handling and ensures a seamless experience across various front-end frameworks.
...
*   [Angular-html5qrcode (⭐2)](https://github.com/mohamedfakhreldin/Angular-html5qrcode) - This library provides an Angular wrapper for the [html5-qrcode (⭐5.7k)](https://github.com/mebjas/html5-qrcode) library, allowing developers to easily integrate QR code and barcode scanning functionalities into their applications.
...
*   [ngxs-message-plugin (⭐2)](https://github.com/Andreas-Hjortland/ngxs-message-plugin) - An NGXS plugin which allows you to share state between different browser contexts.
...
*   [ngx-tinymce (⭐79)](https://github.com/cipchk/ngx-tinymce) - `TinyMCE` components built with Angular.
...
*   [ngx-piwik-pro (⭐3)](https://github.com/PiwikPRO/ngx-piwik-pro) - Dedicated [Piwik PRO](https://piwik.pro/) library that helps with implementing Piwik PRO Tag Manager and the Piwik PRO tracking client in Angular applications.
...
*   [ngx-if-platform (⭐4)](https://github.com/Celtian/ngx-if-platform) - Directive for conditional display based on platform.
...
*   [ngx-pendo (⭐15)](https://github.com/yociduo/ngx-pendo) - A simple wrapper to load Pendo in Angular.
...
*   [ngx-img-cropper (⭐194)](https://github.com/web-dave/ngx-img-cropper) - Image cropping tool for Angular.
...
*   [ngx-perfect-scrollbar (⭐4)](https://github.com/Harvest-Dev/ngx-perfect-scrollbar) - This fork of [ngx-perfect-scrollbar (⭐522)](https://github.com/zefoy/ngx-perfect-scrollbar) is an Angular wrapper library for [Perfect Scrollbar](https://utatti.github.io/perfect-scrollbar/).
...
*   [oculr-ngx (⭐8)](https://github.com/Progressive-Insurance/oculr-ngx) - An analytics library that makes collecting data in an Angular app simple.
...
*   [ngx-graph (⭐973)](https://github.com/swimlane/ngx-graph) - Graph visualization library for Angular.
...
*   [ngx-enhancy-forms (⭐3)](https://github.com/klippa-app/ngx-enhancy-forms) - Fancy enhanced Angular forms.
...
*   [ng-recaptcha-2 (⭐22)](https://github.com/LakhveerChahal/ng-recaptcha-2) - Angular 18 fork of [ng-recaptcha (⭐479)](https://github.com/DethAriel/ng-recaptcha). Alternatively, you create your own service that implements Google's reCAPTCHA with the help of this [article](https://ben-5.azurewebsites.net/2024/9/5/google-recaptcha-v3-with-angular/#google_vignette).
*   [ngx-turnstile (⭐72)](https://github.com/verto-health/ngx-turnstile) - Cloudflare Turnstile for Angular.

## [Oct 15, 2024](/content/2024/10/15/README.md)

### Integrations / Google Developer Experts

*   [ngx-tagify (⭐26)](https://github.com/Brakebein/ngx-tagify) - Angular library that wraps [Tagify (⭐3.8k)](https://github.com/yaireo/tagify/).
...
*   [cookieconsent (⭐4.9k)](https://github.com/orestbida/cookieconsent) - Simple cross-browser cookie-consent plugin written in vanilla js that can be added to [Angular](https://cookieconsent.orestbida.com/essential/getting-started.html#angular).
...
*   [playwright-ng-schematics (⭐16)](https://github.com/playwright-community/playwright-ng-schematics) - Adds Playwright Test to your Angular project.
...
*   [ngx-currency (⭐249)](https://github.com/nbfontana/ngx-currency) - Currency mask module for Angular.

### Layout Components / Google Developer Experts

*   [ngx-bottom-sheet (⭐6)](https://github.com/ArslanAmeer/ngx-bottom-sheet) - A highly customizable and lightweight Angular service that provides a mobile-friendly bottom sheet component.

## [Oct 03, 2024](/content/2024/10/03/README.md)

### Form Controls / Google Developer Experts

*   [ngx-otp-input (⭐28)](https://github.com/pkovzz/ngx-otp-input) - One time password input library for Angular.
...
*   [ngx-three-globe (⭐1)](https://github.com/omnedia/ngx-three-globe) - An Angular library that provides an interactive, 3D globe visualization built using `Three.js`.
...
*   [ngx-typewriter (⭐5)](https://github.com/omnedia/ngx-typewriter) - A lightweight and easy-to-use library for creating typewriter effects. It uses RxJS to manage the typewriting effect, ensuring smooth and customizable animations.
...
*   [ngx-sentry (⭐4)](https://github.com/DSI-HUG/ngx-sentry) - Angular wrapper for [Sentry JavaScript SDK (⭐8.4k)](https://github.com/getsentry/sentry-javascript).
...
*   [limitless-angular (⭐14)](https://github.com/limitless-angular/limitless-angular) - A collection of powerful Angular libraries designed to enhance the Angular ecosystem and help developers build better applications with a focus on `Sanity.io` integration.
...
*   [ngx-popovers (⭐16)](https://github.com/al-march/ngx-popovers) - An Angular library based on `Floating UI` with already ready-made components to use.
...
*   [mutates (⭐17)](https://github.com/IKatsuba/mutates) - A powerful toolset for mutating the Abstract Syntax Tree (AST) of TypeScript files. It is a fork of `ng-morph`, with a broader focus beyond Angular-specific transformations, allowing for extensive AST modifications in any TypeScript project.
...
*   [signaldb (⭐537)](https://github.com/maxnowack/signaldb) - A local JavaScript database with a MongoDB-like interface and TypeScript support, enabling optimistic UI with signal-based reactivity. It integrates easily with Angular, Solid.js, Preact, and Vue, simplifying data management with schema-less design, in-memory storage, and fast queries.
...
*   [po-angular (⭐952)](https://github.com/po-ui/po-angular) - Component library based on Angular. Documentation in Portuguese.

## [Sep 02, 2024](/content/2024/09/02/README.md)

### Integrations / Google Developer Experts

*   [angular-three (⭐253)](https://github.com/angular-threejs/angular-three) - Angular Renderer for [THREE.js (⭐108k)](https://github.com/mrdoob/three.js).
...
*   [revogrid (⭐3k)](https://github.com/revolist/revogrid) - Powerful virtual data grid smartsheet with advanced customization. Best features from Excel plus incredible performance.
...
*   [transloco-keys-manager (⭐214)](https://github.com/jsverse/transloco-keys-manager) - Tools to help reduce monotonous work.

## [Aug 17, 2024](/content/2024/08/17/README.md)

### Editor Components / Google Developer Experts

*   [BlockNoteAngular (⭐8)](https://github.com/dytab/BlockNoteAngular) - Unofficial [BlockNote (⭐8.4k)](https://github.com/TypeCellOS/BlockNote) Angular wrapper.
...
*   [slate-angular (⭐186)](https://github.com/worktile/slate-angular) - Angular view layer for [Slate (⭐31k)](https://github.com/ianstormtaylor/slate).
...
*   [ngx-socket-io (⭐272)](https://github.com/rodgc/ngx-socket-io) - [Socket.IO](https://socket.io/) module for Angular.

### Payments / Google Developer Experts

*   [ngx-stripe (⭐235)](https://github.com/richnologies/ngx-stripe) - A comprehensive library designed for seamless integration of [`Stripe Elements`](https://stripe.com/docs/stripe-js) and payment processing capabilities into Angular applications. Leveraging the powerful features of [`StripeJS`](https://stripe.com/docs/js), Ngx Stripe simplifies building robust, secure, and scalable payment solutions.
...
*   [store-service (⭐24)](https://github.com/ngxp/store-service) - Adds an abstraction layer / facade between Angular components and the NgRx store.
...
*   [angular-calendar-timeline (⭐17)](https://github.com/oOps1627/angular-calendar-timeline) - A timeline for Angular 13+ that shows tasks or events on a timeline in different modes: days, weeks, and months. This library is pretty small and DOESN'T use big dependencies like JQuery or Moment.js. Library also supports SSR.
...
*   [berry-free-angular-admin-template (⭐20)](https://github.com/codedthemes/berry-free-angular-admin-template) - Berry is a free angular admin dashboard template built with Angular and latest Bootstrap 5. It is meant to provide the best possible User Experience with highly customizable feature-rich pages.
...
*   [VS Code NG Language Service (⭐792)](https://github.com/angular/vscode-ng-language-service) - This extension provides a rich editing experience for Angular templates.
...
*   [ngx-stylesweep (⭐9)](https://github.com/BernardoGiordano/ngx-stylesweep) - A CLI tool that removes empty style files from your Angular components.
...
*   [analog-publish-gh-pages (⭐4)](https://github.com/k9n-dev/analog-publish-gh-pages) - A GitHub Action for the Deployment of an `Analog.js` app on GitHub Pages.
...
*   [ngx-breakpoint-observer (⭐9)](https://github.com/tutkli/ngx-breakpoint-observer) - This library adds reactive breakpoint and media query methods based on Signals.
...
*   [module-federation-plugin (⭐801)](https://github.com/angular-architects/module-federation-plugin) - Module Federation allows loading separately compiled and deployed code (like micro frontends or plugins) into an application. This plugin makes Module Federation work together with Angular and the CLI.
...
*   [angular-authentication (⭐278)](https://github.com/nikosanif/angular-authentication) - An Angular application that demonstrates best practices for user authentication & authorization flows.
...
*   [tailkit-starter-kit-angular (⭐2)](https://github.com/pixelcave/tailkit-starter-kit-angular) - Angular Starter Kit for using `Tailkit UI` components out of the box in your project.
*   [angular-tailwind (⭐471)](https://github.com/lannodev/angular-tailwind) - Angular & Tailwind CSS Admin Dashboard Starter Kit.
...
*   [ng-primitives (⭐400)](https://github.com/ng-primitives/ng-primitives) - A low-level UI component library with a focus on accessibility, customization, and developer experience.
...
*   [awesome-utils-dev/angular (⭐241)](https://github.com/pegaltier/awesome-utils-dev/blob/master/utils-coding/utils-angular-list.md) - This is an exhaustive list of resources covering the whole Angular ecosystem. This should be your next step if you haven't found what you need here.
*   [awesome-angular (⭐97)](https://github.com/DaanDeSmedt/awesome-angular)
...
*   [lumberjack (⭐188)](https://github.com/ngworker/lumberjack) - Lumberjack is a versatile Angular logging library, specifically designed to be extended and customized. It provides a few simple log drivers out-of-the-box. It's easy to enable the built-in log drivers or create and use custom log drivers.
...
*   [ngx-flamegraph (⭐70)](https://github.com/mgechev/ngx-flamegraph) - Flame graph for stack trace visualization written in Angular.
...
*   [@schedule-x/angular (⭐1.9k)](https://github.com/schedule-x/schedule-x) - Material design event calendar.

## [Jun 17, 2024](/content/2024/06/17/README.md)

### CLI / Google Developer Experts

*   [ngx-starter (⭐13)](https://github.com/bluehalo/ngx-starter) - An `@angular/cli` based starter containing common components and services as well as a reference site.
...
*   [angularx-qrcode (⭐497)](https://github.com/cordobo/angularx-qrcode) - A fast and easy-to-use Ivy compatible Ionic and Angular QR Code Generator library.

## [Jun 11, 2024](/content/2024/06/11/README.md)

### Desktop / Google Developer Experts

*   [angular-tauri (⭐117)](https://github.com/maximegris/angular-tauri) - Ultra-fast bootstrapping with Angular and Tauri.
...
*   [acrodata/code-editor (⭐42)](https://github.com/acrodata/code-editor) - CodeMirror 6 wrapper for Angular.
...
*   [gojs-angular (⭐68)](https://github.com/NorthwoodsSoftware/gojs-angular) - A set of Angular components to manage [GoJS](https://gojs.net/latest/index.html) Diagrams, Palettes, and Overviews.
...
*   [layout-projection (⭐19)](https://github.com/Char2sGu/layout-projection) - Beautify the Web with awesome layout animations.
...
*   [zen (⭐210)](https://github.com/ZenSoftware/zen) - Nest + Prisma + Apollo + Angular Full Stack GraphQL Starter Kit.
...
*   [karma-image-snapshot (⭐4)](https://github.com/maksimr/karma-image-snapshot) - Karma jasmine matcher that performs image comparisons based on [jest-image-snapshot (⭐3.9k)](https://github.com/americanexpress/jest-image-snapshot) for visual regression testing.
*   [jest-marbles (⭐114)](https://github.com/just-jeb/jest-marbles) - Helpers library for marbles testing with Jest.
*   [jest-codemods (⭐884)](https://github.com/skovhus/jest-codemods) - Codemods for migrating to Jest.
*   [ts-jest (⭐7.1k)](https://github.com/kulshekhar/ts-jest) - A Jest transformer with source map support that lets you use Jest to test projects written in TypeScript.
...
*   [ngx-diff (⭐35)](https://github.com/rars/ngx-diff) - Angular component library for displaying diffs of text.
...
*   [ngx-sharebuttons (⭐537)](https://github.com/MurhafSousli/ngx-sharebuttons) - Angular share buttons.
...
*   [ngx-scrollbar (⭐643)](https://github.com/MurhafSousli/ngx-scrollbar) - Custom overlay-scrollbars with native scrolling mechanism.
...
*   [keycloak-angular (⭐808)](https://github.com/mauriciovigolo/keycloak-angular) - Easy Keycloak setup for Angular applications.
...
*   [ngx-image-cropper (⭐805)](https://github.com/Mawi137/ngx-image-cropper) - An image cropper for Angular.
...
*   [ngx-cookie-service (⭐556)](https://github.com/stevermeister/ngx-cookie-service) - Angular service for cookies. Originally based on the [ng2-cookies (⭐64)](https://github.com/BCJTI/ng2-cookies) library.
...
*   [ngx-tiptap (⭐163)](https://github.com/sibiraj-s/ngx-tiptap) - Angular bindings for [tiptap v2](https://tiptap.dev/).
...
*   [angular-tabler-icons (⭐33)](https://github.com/pierreavn/angular-tabler-icons) - This package allows you to use the [Tabler Icons](https://tabler.io/icons) in your Angular applications.
*   [ngx-fast-svg (⭐63)](https://github.com/push-based/ngx-fast-svg) - SVGs, fast and developer friendly in Angular.

### Mixed Utilities / Google Developer Experts

*   [ts-cacheable (⭐345)](https://github.com/angelnikolov/ts-cacheable) - A popular platform-agnostic caching library.
*   [ngxtension-platform (⭐705)](https://github.com/ngxtension/ngxtension-platform) - Utilities for Angular.
*   [spartan (⭐2.1k)](https://github.com/goetzrobin/spartan) - Cutting-edge tools powering Angular full-stack development.
...
*   [xstate (⭐29k)](https://github.com/statelyai/xstate) - Actor-based state management & orchestration for complex app logic.
...
*   [orchestrator (⭐14)](https://github.com/orchestratora/orchestrator) - Extensible orchestrator for UI and forms for Angular.
...
*   [ng-signal-forms (⭐150)](https://github.com/timdeschryver/ng-signal-forms) - Signal powered Angular Forms.
...
*   [ngx-mat-timepicker (⭐130)](https://github.com/tonysamperi/ngx-mat-timepicker) - A true material timepicker.
...
*   [angular-grid-layout (⭐490)](https://github.com/katoid/angular-grid-layout) - Responsive grid with draggable and resizable items for Angular applications.
...
*   [ngx-dynamic-hooks (⭐121)](https://github.com/MTobisch/ngx-dynamic-hooks) - Automatically insert live Angular components into dynamic strings (based on their selector or any pattern of your choice) and render the result in the DOM.
...
*   [ng-polymorpheus (⭐399)](https://github.com/taiga-family/ng-polymorpheus) - Polymorpheus is a tiny library for polymorphic templates in Angular.

## [May 10, 2024](/content/2024/05/10/README.md)

### Storage / Google Developer Experts

*   [ngx-reactive-storage (⭐53)](https://github.com/e-oz/ngx-reactive-storage) - Wrapper around IndexedDB and localStorage that allows you to create databases and tables using a simple, promise-based API. Changes to the data can be seen with Angular Signals or RxJS Observables.
...
*   [ngx-matomo-client (⭐84)](https://github.com/EmmanuelRoux/ngx-matomo-client) - Matomo analytics client for Angular applications.
...
*   [seo-analyzer (⭐86)](https://github.com/maddevsio/seo-analyzer) - The library for analyze a HTML file to show all of the SEO defects.
...
*   [ngu-carousel (⭐342)](https://github.com/uiuniversal/ngu-carousel) - Angular Universal carousel.
...
*   [ng-image-slider (⭐104)](https://github.com/sanjayV/ng-image-slider) - Angular Image Slider with Lightbox.
...
*   [ng-clarity (⭐384)](https://github.com/vmware-clarity/ng-clarity) - Clarity Angular is a scalable, accessible, customizable, open-source design system built for Angular.
*   [ngx-semantic (⭐6)](https://github.com/ngx-semantic/ngx-semantic) - A new take on an Angular implementation for Semantic UI.

### Node Based / Google Developer Experts

*   [ngx-vflow (⭐364)](https://github.com/artem-mangilev/ngx-vflow) - An open source library to build node-based UI with Angular.
...
*   [angular-l10n (⭐379)](https://github.com/robisim74/angular-l10n) - Angular library to translate texts, dates and numbers.
...
*   [ng-extract-i18n-merge (⭐195)](https://github.com/daniel-sc/ng-extract-i18n-merge) - Extract and merge i18n xliff translation files for Angular projects.
*   [ngx-tolgee (⭐245)](https://github.com/tolgee/tolgee-js/tree/main/packages/ngx/projects/ngx-tolgee) - Web-based localization tool enabling users to translate directly in the Angular app thezy develop.
...
*   [ngx-translate-multi-http-loader (⭐82)](https://github.com/rbalet/ngx-translate-multi-http-loader) - A loader for ngx-translate that loads translations with http calls.
...
*   [ngx-skeleton-loader (⭐608)](https://github.com/willmendesneto/ngx-skeleton-loader) - Make beautiful, animated loading skeletons that automatically adapt to your Angular apps.
*   [ngx-spinner (⭐855)](https://github.com/napster2210/ngx-spinner) - A library for loading spinner for Angular.
...
*   [ej2-angular-ui-components (⭐289)](https://github.com/syncfusion/ej2-angular-ui-components) - Syncfusion Angular UI Components library has been built from the ground up to be lightweight, responsive, modular and touch friendly. It offers 70+ UI components that every applications will ever need.
*   [ng-devui (⭐1.8k)](https://github.com/DevCloudFE/ng-devui) - Angular UI Component Library based on DevUI Design.
*   [ng-aquila (⭐239)](https://github.com/allianz/ng-aquila) - Aquila is an open-source component library provided by the Allianz Global Digital Factory (GDF). We use this library internally with Allianz branding. Here we provide a white label variant of these components.
*   [enterprise-ng (⭐7)](https://github.com/infor-design/enterprise-ng) - Angular wrappers for IDS Enterprise components.
*   [oblique (⭐63)](https://github.com/oblique-bit/oblique) - An Angular front-end framework Tailored for your swiss branded business web application, Oblique provides a standardized corporate design look and feel as well as a collection of ready-to-use Angular components.
*   [fundamental-ngx (⭐282)](https://github.com/SAP/fundamental-ngx) - Fundamental Library for Angular is SAP Design System Angular component library.
...
*   [antwerp-ui\_angular (⭐12)](https://github.com/digipolisantwerp/antwerp-ui_angular) - Antwerp UI is a component interface library for building user interfaces and responsive web apps.
...
*   [hotkeys (⭐341)](https://github.com/ngneat/hotkeys) - A declarative library for handling hotkeys in Angular applications.
...
*   [helipopper (⭐436)](https://github.com/ngneat/helipopper) - A Powerful Tooltip and Popover for Angular Applications.
...
*   [maskito (⭐1.6k)](https://github.com/taiga-family/maskito) - Collection of libraries to create an input mask which ensures that user types value according to predefined format.
...
*   [ngrx-toolkit (⭐262)](https://github.com/angular-architects/ngrx-toolkit) - Various Extensions for the NgRx Signal Store.
*   [ngrx-traits (⭐93)](https://github.com/gabrielguerrero/ngrx-traits) - NgRx Traits is a library to help you compose and reuse a set NGRX actions, selectors, effects, and reducers across your app.
...
*   [ngx-loading-bar (⭐783)](https://github.com/aitboudad/ngx-loading-bar) - Automatic page loading / progress bar for Angular.
...
*   [dotenv-run (⭐293)](https://github.com/chihab/dotenv-run) - Seamlessly load environment variables. Supports cli, esbuild, rollup, vite, webpack, angular, ESM and Monorepos.
...
*   [Nx (⭐27k)](https://github.com/nrwl/nx) - Nx is a build system with built-in tooling and advanced CI capabilities. It helps you maintain and scale monorepos, both locally and on CI.
...
*   [Netlify](https://docs.netlify.com/frameworks/angular/) - Angular applications on Netlify can benefit from integrations such as automatic framework detection and built-in redirects functionality. The [Angular Runtime (⭐29)](https://github.com/netlify/angular-runtime) plugin implements Angular Support on Netlify.
*   [angular-cli-ghpages (⭐975)](https://github.com/angular-schule/angular-cli-ghpages) - SSR does not work, and there can be some caveats, but you can host your Angular project on GitHub Pages.
...
*   [Sheriff (⭐259)](https://github.com/softarc-consulting/sheriff) - Lightweight Modularity for TypeScript Projects.
...
*   [typescript-challenges (⭐168)](https://github.com/psmyrdek/typescript-challenges) - A set of challenges helping you understand TypeScript.
...
*   [ng-doc (⭐286)](https://github.com/ng-doc/ng-doc) - The documentation engine for Angular projects.
...
*   [sakai-ng (⭐817)](https://github.com/primefaces/sakai-ng) - Free Angular Admin Template by PrimeNG.
...
*   [template-angular (⭐33)](https://github.com/phaserjs/template-angular) - Phaser 3 TypeScript project template that uses the Angular framework and Vite for bundling.
...
*   [webdriverio (⭐9.6k)](https://github.com/webdriverio/webdriverio) - Next-gen browser and mobile automation test framework for Node.js.

### Component / Google Developer Experts

*   [jasmine](https://jasmine.github.io/) - Simple JavaScript testing.
*   [jest](https://jestjs.io/) - Jest is a delightful JavaScript Testing Framework with a focus on simplicity.
*   [jest-preset-angular (⭐914)](https://github.com/thymikee/jest-preset-angular) - Jest configuration preset for Angular projects.
...
*   [ag-charts (⭐350)](https://github.com/ag-grid/ag-charts/tree/latest/packages/ag-charts-angular) - Fully-featured and highly customizable JavaScript charting library.
*   [carbon-charts (⭐969)](https://github.com/carbon-design-system/carbon-charts/tree/master/packages/angular) - Carbon Charts Angular is a thin Angular wrapper around the vanilla JavaScript @carbon/charts component library.
...
*   [ngx-gantt (⭐279)](https://github.com/worktile/ngx-gantt) - A modern and powerful gantt chart component for Angular.
...
*   [active-table (⭐290)](https://github.com/OvidijusParsiunas/active-table) - Framework agnostic table component for editable data experience.
*   [jsgrids (⭐202)](https://github.com/statico/jsgrids) - A comparison tool to compare JavaScript data grid and spreadsheet libraries.  Find even more libraries from this repo.
...
*   [angular-touch-keyboard (⭐58)](https://github.com/mohsen77sk/angular-touch-keyboard) - Virtual Keyboard for Angular applications.

### Maps / Google Developer Experts

*   [ng-maps (⭐48)](https://github.com/ng-maps/ng-maps) - Modular map components for Angular.
*   [ngx-leaflet (⭐798)](https://github.com/bluehalo/ngx-leaflet) - Core Leaflet package for Angular.
*   [ngx-maplibre-gl (⭐89)](https://github.com/maplibre/ngx-maplibre-gl) - Angular binding of maplibre-gl.
...
*   [ngx-awesome-popup (⭐71)](https://github.com/boris-jenicek/ngx-awesome-popup) - Angular dialog modal framework (Confirmation box, Alert box, Toast notification and Cookie banner).
...
*   [hot-toast (⭐158)](https://github.com/ngxpert/hot-toast) - Smoking hot toast notifications for Angular.
*   [ngx-sonner (⭐137)](https://github.com/tutkli/ngx-sonner) - An opinionated toast component for Angular. A port of @emilkowalski's sonner.
...
*   [skyux (⭐44)](https://github.com/blackbaud/skyux) - SKY UX components for Angular.
*   [ngx-ui-tour (⭐199)](https://github.com/hakimio/ngx-ui-tour) - A UI tour library inspired by [angular-ui-tour (⭐164)](https://github.com/benmarch/angular-ui-tour).
...
*   [tsparticles (⭐40)](https://github.com/tsparticles/angular/#readme) - A component to easily add Particles animations to your Angular application.
...
*   [ngx-drag-drop (⭐323)](https://github.com/reppners/ngx-drag-drop) - Angular directives using the native HTML Drag And Drop API.
...
*   [ngx-editor (⭐482)](https://github.com/sibiraj-s/ngx-editor) - Rich Text Editor for Angular using ProseMirror.
...
*   [formio (⭐682)](https://github.com/formio/angular) - JSON powered forms for Angular.
...
*   [state-adapt (⭐304)](https://github.com/state-adapt/state-adapt) - Declarative, incremental state management library.

### Viewers / Google Developer Experts

*   [ng2-pdfjs-viewer (⭐239)](https://github.com/intbot/ng2-pdfjs-viewer) - An Angular component for PDFJS and ViewerJS (Supports all versions of Angular).
*   [ngx-extended-pdf-viewer (⭐538)](https://github.com/stephanrauh/ngx-extended-pdf-viewer) - A full-blown PDF viewer for Angular 16, 17, and beyond.
...
*   [ng-icons (⭐482)](https://github.com/ng-icons/ng-icons) - The ultimate icon library for Angular.
*   [primeicons (⭐312)](https://github.com/primefaces/primeicons) - PrimeIcons is the default icon library of PrimeNG with over 250 open source icons developed by PrimeTek.
*   [angular-svg-icon (⭐263)](https://github.com/czeckd/angular-svg-icon) - Angular component and service for inlining SVGs allowing them to be easily styled with CSS.
...
*   [ngx-permissions (⭐952)](https://github.com/AlexKhymenko/ngx-permissions) - Permission and roles based access control for your angular applications(AOT, lazy modules compatible).
...
*   [ngx-color (⭐440)](https://github.com/scttcper/ngx-color) - Color Pickers from Sketch, Photoshop, Chrome, GitHub, X, and more.
...
*   [angular-split (⭐908)](https://github.com/bertrandg/angular-split) - Angular split component.

### Loaders / Google Developer Experts

*   [ngx-progressbar (⭐1.1k)](https://github.com/MurhafSousli/ngx-progressbar) - Nanoscopic progress bar, featuring realistic trickle animations.

### Maps / Google Developer Experts

*   [angular-cesium (⭐180)](https://github.com/TGFTech/angular-cesium) - Creating map based web apps using Cesium and Angular.
...
*   [ngx-ui (⭐725)](https://github.com/swimlane/ngx-ui) - Style and Component Library for Angular2 and beyond!
...
*   [ckeditor5-angular (⭐210)](https://github.com/ckeditor/ckeditor5-angular) - An official CKEditor 5 rich text editor component for Angular 2+.
