...
### [ZI (⭐366)](https://github.com/z-shell/zi)
...
### [zim (⭐2.8k)](https://github.com/zimfw/zimfw)
...
### [zpm (⭐252)](https://github.com/zpm-zsh/zpm)
...
If you're using [Antigen (⭐7.3k)](https://github.com/zsh-users/antigen), you can test these themes in a running ZSH with `antigen theme githubuser/repo`. If you're using [zgenom (⭐230)](https://github.com/jandamm/zgenom), add them to your `init.zsh` with `zgenom load githubuser/reponame`.
...
Zgen is not being actively maintained. I recommend that you switch to the [Zgenom (⭐230)](https://github.com/jandamm/zgenom) fork, which is.
...
Find other useful awesome-\* lists at the [awesome collection (⭐223k)](https://github.com/sindresorhus/awesome)
