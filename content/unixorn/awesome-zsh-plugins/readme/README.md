...
### [dotzsh (⭐220)](https://github.com/dotphiles/dotzsh)
...
### [sheldon (⭐768)](https://github.com/rossmacarthur/sheldon)
...
### [zap (⭐761)](https://github.com/zap-zsh/zap)
...
### [zcomet (⭐170)](https://github.com/agkozak/zcomet)
...
### [ZI (⭐580)](https://github.com/z-shell/zi)
...
### [zinit-4 (⭐13)](https://github.com/psprint/Zinit-4)
...
### [zpm (⭐305)](https://github.com/zpm-zsh/zpm)
...
Customize your .zshrc with only \~21 lines of code. Based on [zsh-unplugged (⭐246)](https://github.com/mattmc3/zsh_unplugged).

### [zshPlug (⭐0)](https://github.com/Atlas34/zshPlug)

**zshPlug** is a minimalist plugin manager heavily based on [zap (⭐761)](https://github.com/zap-zsh/zap).
...
*   [zsh-quickstart-kit (⭐685)](https://github.com/unixorn/zsh-quickstart-kit) - A simple quickstart for using ZSH with [zgenom (⭐299)](https://github.com/jandamm/zgenom). This automatically configures ZSH to use [zgenom (⭐299)](https://github.com/jandamm/zgenom) to load a curated (but easily customizable) collection of plugins and periodically automatically update itself, the plugins, and the quickstart kit itself.

### zinit

*   [ZPWR (⭐149)](https://github.com/MenkeTechnologies/zpwr) - An extremely powerful custom terminal environment built on top of [Zinit (⭐2.1k)](https://github.com/zdharma-continuum/zinit) for maximum speed.  A full terminal configuration framework including `zsh`, `tmux`, `fzf`, `vim` and spacemacs configurations.  It includes:
...
*   [GH (⭐41)](https://github.com/gustavohellwig/gh-zsh) - Setup ZSH on debian/Ubuntu-based linuxes. Installs [Powerlevel10k (⭐39k)](https://github.com/romkatv/powerlevel10k), [zsh-completions (⭐6.3k)](https://github.com/zsh-users/zsh-completions), [zsh-autosuggestions (⭐28k)](https://github.com/zsh-users/zsh-autosuggestions), [fast-syntax-highlighting (⭐815)](https://github.com/zdharma-continuum/fast-syntax-highlighting/), and more.
...
*   [zephyr (⭐56)](https://github.com/mattmc3/zephyr) - Zephyr uses built-in Zsh features to set up better default options, completions, keybindings, history, and much more.
...
*   [ZSH Unplugged (⭐246)](https://github.com/mattmc3/zsh_unplugged) - Good resource if you want to eliminate using a framework but still easily use plugins.

### Antigen

*   [belak/zsh-utils (⭐92)](https://github.com/belak/zsh-utils) - A minimal set of ZSH plugins designed to be low-friction and low-complexity.
...
*   [zinit-configs (⭐35)](https://github.com/zdharma-continuum/zinit-configs) - Real-world configuration files (basically a collection of `.zshrc` files) holding [zinit (⭐2.1k)](https://github.com/zdharma-continuum/zinit) invocations.
...
*   [abbr (olets) (⭐427)](https://github.com/olets/zsh-abbr) - Manages auto-expanding abbreviations that expand inline when you hit space, inspired by fish shell.
...
*   [actiona (⭐2)](https://github.com/matthieusb/act) - Make it easier to call [actiona (⭐440)](https://github.com/Jmgr/actiona) scripts from your command line. Includes tab completions.
...
*   [alias-tips (⭐735)](https://github.com/djui/alias-tips) - An oh-my-zsh plugin to help remembering those aliases you defined once.
...
*   [artisan (⭐573)](https://github.com/jessarcher/zsh-artisan) - Laravel `artisan` plugin for ZSH to help you to run `artisan` from anywhere in the project tree, with tab completion!
*   [asciidoctor (⭐4)](https://github.com/sparsick/asciidoctor-zsh) - A plugin for AsciiDoctor.
*   [asdf-direnv (⭐7)](https://github.com/redxtech/zsh-asdf-direnv) - Integration and completions for [asdf (⭐19k)](https://github.com/asdf-vm/asdf) and [direnv (⭐474)](https://github.com/asdf-community/asdf-direnv).
...
*   [auto-notify (⭐317)](https://github.com/MichaelAquilina/zsh-auto-notify) - Automatically sends out a notification when a long running task has completed.
...
*   [autocomplete (⭐3.9k)](https://github.com/marlonrichert/zsh-autocomplete) - Automatically lists completions as you type and provides intuitive keybindings for selecting and inserting them.
...
*   [autoenv-extended (⭐163)](https://github.com/zpm-zsh/autoenv) - Extended version of the [zsh-autoenv (⭐655)](https://github.com/Tarrasch/zsh-autoenv) plugin.
*   [autoenv (⭐655)](https://github.com/Tarrasch/zsh-autoenv) - If a directory contains a `.env` file, it will automatically be executed when you `cd` into it.
...
*   [autopair (⭐433)](https://github.com/hlissner/zsh-autopair) - A ZSH plugin for auto-closing, deleting and skipping over matching delimiters. Only tested on ZSH 5.0.2 or later.
...
*   [autoswitch-virtualenv (⭐428)](https://github.com/MichaelAquilina/zsh-autoswitch-virtualenv) - ZSH plugin to automatically switch python virtualenvs and pipenvs when traversing directories. Automatically detects [pipenv](https://pypi.org/project/pipenv/) and [poetry](https://python-poetry.org/) projects.
...
*   [autoupdate-oh-my-zsh-plugins (⭐217)](https://github.com/TamCore/autoupdate-oh-my-zsh-plugins) - [oh-my-zsh](https://ohmyz.sh/) doesn't automatically update non-core plugins, this plugin autoupdates `git` repositories in the `$ZSH_CUSTOM` directory.
...
*   [awsume (⭐1)](https://github.com/Sordie/AWSume) - Plugin that enables showing the current [awsume (⭐451)](https://github.com/trek10inc/awsume) profile.
...
*   [bd (⭐402)](https://github.com/Tarrasch/zsh-bd) - Jump back to a specific directory, without doing `cd ../../..`.
...
*   [bob (⭐1)](https://github.com/wintermi/zsh-bob) - Plugin for [bob (⭐926)](https://github.com/MordechaiHadad/bob) a cross-platform and easy-to-use Neovim version manager.
...
*   [check-deps (⭐1)](https://github.com/zpm-zsh/check-deps) - Helper for ZSH plugins that allows them to show how to install any missing dependencies. Works on Debian (and derivatives like Ubuntu), Arch and its derivatives, Node.js and ZSH plugins if you are using the [zpm (⭐305)](https://github.com/zpm-zsh/zpm) framework.
...
*   [copy-pasta (⭐22)](https://github.com/ChrisPenner/copy-pasta) - Copy and paste files in your terminal like you would in a GUI.
...
*   [defer (⭐260)](https://github.com/romkatv/zsh-defer) - Defers execution of a `zsh` command until `zsh` has nothing else to do and is waiting for user input. Its intended purpose is staged `zsh` startup. It works similarly to Turbo mode in [zinit (⭐2.1k)](https://github.com/zdharma-continuum/zinit).
...
*   [dotbare (⭐608)](https://github.com/kazhala/dotbare) - Interactive dotfile management with the help of [fzf (⭐55k)](https://github.com/junegunn/fzf).
...
*   [drupal (⭐1)](https://github.com/yhaefliger/zsh-drupal) - Adds aliases for common tasks and also tab-completion for `drush`. Inspired by [Artisan (⭐573)](https://github.com/jessarcher/zsh-artisan).
...
*   [evalcache (⭐146)](https://github.com/mroth/evalcache) - Caches the output of a binary initialization command like `eval "$(hub alias -s)"`, to help lower shell startup time by loading from cache instead of re-running every new shell session.
...
*   [exa (zshell) (⭐14)](https://github.com/z-shell/zsh-exa) - replace `ls` with [ogham/exa (⭐23k)](https://github.com/ogham/exa).
...
*   [eza (z-shell) (⭐14)](https://github.com/z-shell/zsh-eza) - Replaces `ls` with [eza-community/eza (⭐3.5k)](https://github.com/eza-community/eza).
...
*   [fast-syntax-highlighting (⭐815)](https://github.com/zdharma-continuum/fast-syntax-highlighting) - Optimized and improved `zsh-users/zsh-syntax-highlighting` – better response times, switchable highlight themes.
...
*   [fz (⭐484)](https://github.com/changyuheng/fz) - Seamlessly adds fuzzy search to [z (⭐16k)](https://github.com/rupa/z)'s tab completion and lets you easily jump around among directories in your history.
...
*   [fzf-history-search (⭐180)](https://github.com/joshskidmore/zsh-fzf-history-search) - Replaces `Ctrl+R` with an [fzf (⭐55k)](https://github.com/junegunn/fzf)-driven history search that includes date/times.
...
*   [geometry-datetime (⭐2)](https://github.com/desyncr/geometry-datetime) - [Geometry (⭐892)](https://github.com/geometry-zsh/geometry) datetime plugin. Shows datetime (`date` unix command) in your prompt.
*   [geometry-hydrate (⭐1)](https://github.com/jedahan/geometry-hydrate) - [Geometry (⭐892)](https://github.com/geometry-zsh/geometry) plugin to remind you to hydrate.
*   [geometry-npm-package-version (⭐1)](https://github.com/drager/geometry-npm-package-version) - [Geometry (⭐892)](https://github.com/geometry-zsh/geometry) plugin to display the current folder's npm package version.
*   [geometry-rust-version (⭐1)](https://github.com/drager/geometry-rust-version) - [Geometry (⭐892)](https://github.com/geometry-zsh/geometry) plugin to display the current folder's Rust version when either a `.rs` or `Cargo.toml` is present.
...
*   [git-extra-commands (⭐924)](https://github.com/unixorn/git-extra-commands) - Extra `git` helper scripts packaged as a plugin.
...
*   [hangul (⭐156)](https://github.com/gomjellie/zsh-hangul) - Auto correct hangul(한글, korean) to English when it was supposed to be typed in English. 영어를 타이핑 해야되는데 한글로 타이핑된경우 자동으로 수정합니다.
...
*   [homeassistant-cli (⭐3)](https://github.com/frosit/zsh-plugin-homeassistant-cli) - Provides completion and (configuration) helpers for the [Home Assistant Command-line interface (hass-cli) (⭐379)](https://github.com/home-assistant/home-assistant-cli). and allows command line interaction with [Home Assistant](https://home-assistant.io/) instances.
...
*   [hooks (⭐47)](https://github.com/willghatch/zsh-hooks) - Add missing hooks - for plugins and personal use.
...
*   [ipip (⭐14)](https://github.com/SukkaW/zsh-ipip) - Plugin for [IPIP](https://en.ipip.net).
*   [iterm-tab-color (⭐45)](https://github.com/bernardop/iterm-tab-color-oh-my-zsh) - Adds function to set the tab color in iTerm2 and can automatically change color based on cwd or command being executed.
...
*   [kube-aliases (⭐100)](https://github.com/Dbz/kube-aliases) - Adds functions and aliases to make working with `kubectl` more pleasant.
...
*   [kubernetes (⭐100)](https://github.com/Dbz/zsh-kubernetes) - Add [kubernetes](https://kubernetes.io) helper functions and aliases.
...
*   [laravel-sail (⭐25)](https://github.com/ariaieboy/laravel-sail) - Adds shortcuts for `sail` commands.
...
*   [lazyload (⭐91)](https://github.com/qoomon/zsh-lazyload) - Lazy load commands and speed up start up time of ZSH.
...
*   [multi-evalcache (⭐0)](https://github.com/rwwiv/multi-evalcache) - Cache multiple eval loads to improve startup time, inspired by [mroth/evalcache (⭐146)](https://github.com/mroth/evalcache).
...
*   [nix-shell (⭐304)](https://github.com/chisui/zsh-nix-shell) - Plugin that lets you use ZSH as the default shell in a `nix-shell` environment.
...
*   [operator (⭐5)](https://github.com/nivv/operator-theme) - Clean and simple theme, works best with [Menlo for Powerline (⭐783)](https://github.com/abertsch/Menlo-for-Powerline).
...
*   [per-directory-history (⭐222)](https://github.com/jimhester/per-directory-history) - Per directory history for ZSH, as well as global history, and the ability to toggle between them with `^G`.
...
*   [pipx (⭐6)](https://github.com/thuandt/zsh-pipx) - Autocompletions for [pipx (⭐7.1k)](https://github.com/pypa/pipx).
...
*   [proxy (⭐348)](https://github.com/SukkaW/zsh-proxy) - Configure proxy settings for some package managers and software.
...
*   [search-directory-history (⭐2)](https://github.com/cmaahs/search-directory-history) - Allows complex search of per-directory history created using the [per-directory-history (⭐222)](https://github.com/jimhester/per-directory-history) plugin.
...
*   [shellfirm (⭐694)](https://github.com/kaplanelad/shellfirm) - Shellfirm is a handy utility to help avoid running dangerous commands without an extra step of approval. When risky patterns is detected you will immediately get a small prompt challenge that will verify your action.
...
*   [sudo (none9632) (⭐5)](https://github.com/none9632/zsh-sudo/) - Adds `sudo` as a prefix to the current command by typing `ESC`-`ESC`.
...
*   [tab-title (⭐43)](https://github.com/trystan2k/zsh-tab-title) - Set the terminal tab title according to current directory or running process. Forked from [termsupport.zsh (⭐164k)](https://github.com/ohmyzsh/ohmyzsh/blob/master/lib/termsupport.zsh)
...
*   [terraform (ptavares) (⭐1)](https://github.com/ptavares/zsh-terraform) - Adds aliases, functions and tab completions. Also installs [terraform-docs (⭐3.7k)](https://github.com/terraform-docs/terraform-docs), [tfsec (⭐6.3k)](https://github.com/aquasecurity/tfsec) and [tflint (⭐4.3k)](https://github.com/terraform-linters/tflint).
...
*   [tgswitch (⭐0)](https://github.com/ptavares/zsh-tgswitch) - Installs and loads [tgswitch (⭐136)](https://github.com/warrensbox/tgswitch).
...
*   [tipz (⭐25)](https://github.com/molovo/tipz) - Displays your alias if you have an alias for the command you just ran, similarly to [alias-tips (⭐735)](https://github.com/djui/alias-tips).
...
*   [tre (⭐0)](https://github.com/redxtech/zsh-tre) - Makes using [tre (⭐569)](https://github.com/dduan/tre#editor-aliasing) easier.
...
*   [undollar (⭐13)](https://github.com/zpm-zsh/undollar) - Strips the dollar sign from the beginning of the terminal prompt.
...
*   [volta (⭐2)](https://github.com/ri7nz/zsh-volta) - Installs and loads [Volta: JS Toolchains as Code (⭐8.8k)](https://github.com/volta-cli/volta).
...
*   [wd (⭐666)](https://github.com/mfaerevaag/wd) - Warp directory lets you jump to custom directories in ZSH, without using `cd`. Why? Because `cd` seems inefficient when the folder is frequently visited or has a long path.
...
*   [zcolors (⭐68)](https://github.com/marlonrichert/zcolors) - Uses your `$LS_COLORS` to generate a coherent theme for Git and your Zsh prompt, completions and [ZSH syntax highlighting (⭐18k)](https://github.com/zsh-users/zsh-syntax-highlighting).
...
*   [zeno (⭐134)](https://github.com/yuki-yano/zeno.zsh) - Fuzzy completion and utility plugin powered by [Deno](https://deno.land/).
...
*   [zsh-in-docker (⭐746)](https://github.com/deluan/zsh-in-docker) - Automates ZSH + [oh-my-zsh](https://ohmyz.sh/) installation into development containers. Works with Alpine, Ubuntu, Debian, CentOS or Amazon Linux.
...
*   [aliyun (⭐0)](https://github.com/thuandt/zsh-aliyun) - Add completions for the [Aliyun CLI (⭐770)](https://github.com/aliyun/aliyun-cli).
...
*   [argc-completions (⭐3)](https://github.com/sigoden/argc-completions) - Uses [argc (⭐501)](https://github.com/sigoden/argc) and [jq (⭐27k)](https://github.com/stedolan/jq) to add ZSH tab completions.
*   [autopkg-zsh-completion (⭐9)](https://github.com/fuzzylogiq/autopkg-zsh-completion) - Completions for autopkg.
*   [autorestic (⭐3)](https://github.com/naegling/zsh-autorestic) - automatically installs [Restic (⭐905)](https://github.com/cupcakearmy/autorestic/)'s completions for you, and keeps them up to date as your autorestic version changes.
...
*   [better-npm-completion (⭐444)](https://github.com/lukechilds/zsh-better-npm-completion) - Better tab completion for `npm`.
...
*   [cod (⭐493)](https://github.com/dim-an/cod) - A completion demon for `bash`/`fish`/`zsh` which creates completion functions on the fly when it sees you run something with `--help`.
...
*   [comonicon (⭐0)](https://github.com/Roger-luo/ComoniconZSHCompletion.jl) - Tab completions for [comonicon (⭐244)](https://github.com/Roger-luo/Comonicon.jl).
...
*   [conda (⭐316)](https://github.com/conda-incubator/conda-zsh-completion) - ZSH tab completion for [conda](http://conda.pydata.org/).
...
*   [ddc (⭐23)](https://github.com/Shougo/ddc-zsh) - Adds tab completions for [ddc (⭐600)](https://github.com/Shougo/ddc.vim).
...
*   [fzf-tab-completion (⭐450)](https://github.com/lincheney/fzf-tab-completion) - Add tab completion for ZSH, `bash` & applications using GNU Readline.
...
*   [git-fzf (⭐19)](https://github.com/alexiszamanidis/zsh-git-fzf) - ZSH plugin that wraps `git` operations for simplicity and productivity. It also contains completions and combines support for [fzf (⭐55k)](https://github.com/junegunn/fzf).
...
*   [nix (⭐188)](https://github.com/spwhitt/nix-zsh-completions) - Completions for [nix](https://nixos.org/nix/), [NixOS](https://nixos.org/), and [NixOps](https://nixos.org/nixops/).
...
*   [pagerduty (⭐0)](https://github.com/jedelson-pagerduty/pagerduty-omz-plugin) - Adds completions for the pagerduty [cli (⭐85)](https://github.com/martindstone/pagerduty-cli)
...
*   [vorpal (⭐1)](https://github.com/VorpalBlade/vorpal-zsh-completions) - Adds completions for some projects whose upstream appears dead, including [duperemove (⭐588)](https://github.com/markfasheh/duperemove), [optimus-manager (⭐2.1k)](https://github.com/Askannz/optimus-manager) and [pacutils (⭐98)](https://github.com/andrewgregory/pacutils).
...
*   [yabai (⭐13)](https://github.com/Amar1729/yabai-zsh-completions) - Add completions for macOS [yabai (⭐19k)](https://github.com/koekeishiya/yabai/) tiling window manager.
...
If you're using [Antigen (⭐7.7k)](https://github.com/zsh-users/antigen), you can test these themes in a running ZSH with `antigen theme githubuser/repo`. If you're using [zgenom (⭐299)](https://github.com/jandamm/zgenom), add them to your `init.zsh` with `zgenom load githubuser/reponame`.
...
*   [agkozak (⭐252)](https://github.com/agkozak/agkozak-zsh-prompt) - Uses three asynchronous methods to keep the ZSH prompt responsive while displaying the `git` status and indicators of SSH connection, exit codes, and `vi` mode, along with an abbreviated, `PROMPT_DIRTRIM`-style path. Very customizable. Asynchronous even on Cygwin and MSYS2.
...
*   [alien (⭐275)](https://github.com/eendroroy/alien) - Powerline-esque ZSH theme that shows `git` decorations and the exit code of the last command. Faster than many other prompts because it determines the `git` decorations asynchronously in a background process.
...
*   [aphrodite (⭐103)](https://github.com/win0err/aphrodite-terminal-theme) - Minimalistic theme without visual noise. Displays only the necessary information: current user, hostname, working directory, `git` branch if one exists. Looks great both with dark and white terminals.
...
*   [astro (⭐98)](https://github.com/iplaces/astro-zsh-theme) - Based on the `ys` and [robbyrussell (⭐164k)](https://github.com/ohmyzsh/ohmyzsh/wiki/Themes#robbyrussell) themes.
...
*   [common (⭐328)](https://github.com/jackharrisonsherlock/common) - A simple, clean and minimal prompt, displays current working directory, hostname, AWS vault role, background jobs, current SHA, exit code of last command, and `git` branch and status.
...
*   [cramin (⭐7)](https://github.com/FelipeCRamos/craminzsh) - Minimal interface with support for GitHub plugins, based on [hyperzsh (⭐522)](https://github.com/tylerreckart/hyperzsh).
...
*   [geometryHostInfo (⭐1)](https://github.com/Fuzen-py/GeometryHostInfo) - Adds host info to the [geometry (⭐892)](https://github.com/geometry-zsh/geometry) theme.
...
*   [guezwhoz (⭐57)](https://github.com/guesswhozzz/guezwhoz-zshell) - Minimalist, includes `git` status decorations.
...
*   [hexagon (⭐2)](https://github.com/diogoazevedos/hexagon) - Minimalist zsh theme based on [geometry (⭐892)](https://github.com/geometry-zsh/geometry).
...
*   [hyperzsh (⭐522)](https://github.com/tylerreckart/hyperzsh) - Gives you a comprehensive overview of the branch you're working on and the status of your repository without cluttering your terminal.
...
*   [jovial (⭐369)](https://github.com/zthxxx/jovial) - Shows decorators for host, user, path, development environment, `git` branch, and which `python` venv is active.
...
*   [kiss (⭐100)](https://github.com/rileytwo/kiss) - Simple theme for oh-my-zsh, VSCode, iTerm2, Neovim, and RStudio. Includes `git` status decorations.
...
*   [lambda (cdimascio) (⭐59)](https://github.com/cdimascio/lambda-zsh-theme) -  Inspired by the [lambda (⭐164k)](https://github.com/ohmyzsh/ohmyzsh/blob/master/themes/lambda.zsh-theme) theme. Includes `git` status decorations.
...
*   [lilith (⭐0)](https://github.com/aknackd/zsh-themes) - Modification of [gallifrey (⭐164k)](https://github.com/ohmyzsh/ohmyzsh/blob/master/themes/gallifrey.zsh-theme) and [hyperzsh (⭐522)](https://github.com/tylerreckart/hyperzsh).
...
*   [ludwigws (⭐0)](https://github.com/LudwigWS/my-zsh-theme) - Variant of [lambda-mod (⭐465)](https://github.com/halfo/lambda-mod-zsh-theme) theme. Has `git` decorations, requires a powerline-compatible terminal font.
...
*   [megaprompt (⭐4)](https://github.com/willghatch/zsh-megaprompt) - A maximalist prompt including keyboard mode, ownership info, and other contextual info, with λ as the prompt character. Requires the [hooks (⭐47)](https://github.com/willghatch/zsh-hooks) plugin.
...
*   [minimal-terminal (⭐42)](https://github.com/Lissy93/minimal-terminal-prompt) - Includes decorators for username\@host, current directory, `git` information and the last command's exit code.
...
*   [ortiz (guezwhoz) (⭐57)](https://github.com/guesswhozzz/guezwhoz-zsh-theme) - Simplified fork of [eriner (⭐16)](https://github.com/zimfw/eriner) with `git` status, `kubectl` context and elapsed time decorations.
...
*   [purs (⭐241)](https://github.com/xcambar/purs) - A fast [pure (⭐12k)](https://github.com/sindresorhus/pure)-inspired prompt written in [Rust](https://www.rust-lang.org/).
...
*   [robbyrussell-fullpath (⭐2)](https://github.com/toytag/robbyrussell-fullpath.zsh-theme) - The original [robbyrussell (⭐164k)](https://github.com/ohmyzsh/ohmyzsh/blob/master/themes/robbyrussell.zsh-theme) with a fullpath in the prompt.
...
*   [slick (⭐21)](https://github.com/nbari/slick) - Inspired by the [pure (⭐12k)](https://github.com/sindresorhus/pure), [purs (⭐241)](https://github.com/xcambar/purs) and [zsh-efgit-prompt (⭐7)](https://github.com/ericfreese/zsh-efgit-prompt). Requires `cargo` for installation.
...
*   [trinity (⭐1)](https://github.com/de-luca/Trinity) - A simple theme based on [geometry (⭐892)](https://github.com/geometry-zsh/geometry). Includes `git` decorations.
...
*   [turs (⭐0)](https://github.com/eikendev/turs) - Fast, minimal [Purs (⭐241)](https://github.com/xcambar/purs)-inspired prompt.
...
*   [typewritten (⭐862)](https://github.com/reobin/typewritten) - Minimal and informative theme that leaves room for what's important. Does asynchronous `git` decoration updates for speed.
...
*   [vercel (⭐174)](https://github.com/vercel/zsh-theme) - Minimalist theme with `git` status decorations.
...
*   [vitesse (⭐1)](https://github.com/rafaeldellaquila/zsh-vitesse-theme/blob/master/img/preview.png) - Inspired by VS Code's [Vitesse (⭐444)](https://github.com/antfu/vscode-theme-vitesse) theme. Includes `git` status decorations.
...
*   [zeit (⭐174)](https://github.com/zeit/zeit.zsh-theme) - Optimized for dark backgrounds, includes `git` status information.
...
*   [zinc](https://gitlab.com/robobenklein/zinc) - A blazing-fast, pure ZSH, mixed asynchronous prompt inspired by [Powerlevel9k (⭐13k)](https://github.com/bhilburn/powerlevel9k) and [Agnoster (⭐3.8k)](https://github.com/agnoster/agnoster-zsh-theme) that's easily extensible and extremely configurable. It supports async segments using [zsh-async (⭐717)](https://github.com/mafredri/zsh-async).
...
Zgen is not being actively maintained. I recommend that you switch to the [Zgenom (⭐299)](https://github.com/jandamm/zgenom) fork, which is.
...
*   [shtab (⭐286)](https://github.com/iterative/shtab) - Automatically generate shell tab completion scripts for Python CLI apps, supports `zsh`, `bash` and `tcsh`.
*   [zsh-bench (⭐398)](https://github.com/romkatv/zsh-bench) - A benchmark for interactive ZSH. It measures user-visible latency of interactive `zsh`: input lag, command lag, etc.
