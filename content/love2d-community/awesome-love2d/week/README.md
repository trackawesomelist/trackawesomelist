...
*   [pathfun (⭐8)](https://github.com/apicici/pathfun) - Pure Lua library for 2D pathfinding using the funnel algorithm.

### UI

*   [cimgui-love (⭐56)](https://github.com/apicici/cimgui-love) - LÖVE module for Dear ImGui obtained by wrapping cimgui (programmatically generated C-api) using LuaJIT FFI, easy to update to the latest Dear Imgui version.
