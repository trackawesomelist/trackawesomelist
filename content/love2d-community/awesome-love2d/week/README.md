...
[🏠 Home](/README.md) · [🔍 Search](https://www.trackawesomelist.com/search/) · [🔥 Feed](https://www.trackawesomelist.com/love2d-community/awesome-love2d/week/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 love2d-community/awesome-love2d](https://github.com/love2d-community/awesome-love2d) · ⭐ 2.6K · 🏷️ Gaming
...
*   [model\_renderer (⭐16)](https://github.com/xiejiangzhi/model_renderer) - A simple 3d model renderer for love2d.
...
*   [anim8 (⭐582)](https://github.com/kikito/anim8) - Animation library.
...
*   [gamera (⭐210)](https://github.com/kikito/gamera) - Camera system.
...
*   [Lovebird (⭐261)](https://github.com/rxi/lovebird) - Browser-based debug console.
*   [LoveDebug (⭐90)](https://github.com/Ranguna/LOVEDEBUG) - Inline console-like debugger utility.
*   [lurker (⭐243)](https://github.com/rxi/lurker) - Auto-swaps changed Lua files in a running game.
*   [LÖVE API (⭐260)](https://github.com/love2d-community/love-api) - The complete API documentation of LÖVE in a Lua table.
*   [LÖVE Build (⭐45)](https://github.com/nhartland/love-build) - GitHub Action for automated cross-platform builds.
*   [LÖVE TypeScript Definitions (⭐89)](https://github.com/hazzard993/love-typescript-definitions) - Write LÖVE games with TypeScript.
...
*   [Autobatch (⭐99)](https://github.com/rxi/autobatch) - Small LÖVE module to automate the use of SpriteBatches.
...
*   [Maid64 (⭐46)](https://github.com/adekto/maid64) - Low resolution scaler for LÖVE.
*   [Push (⭐407)](https://github.com/Ulydev/push) - A simple resolution-handling library for LÖVE.
...
*   [Tove2d (⭐150)](https://github.com/poke1024/tove2d) - Animated vector graphics for LÖVE.
*   [turtle.lua (⭐75)](https://github.com/arthurealike/turtle.lua) - Turtle graphics library for LÖVE.
...
*   [Concord (⭐157)](https://github.com/Tjakka5/Concord) - A feature-complete ECS library.
*   [knife.system (⭐367)](https://github.com/airstruck/knife/blob/master/readme/system.md) - Minimalist functional ECS.
*   [nata (⭐36)](https://github.com/tesselode/nata) - Hybrid OOP/ECS entity management.
*   [tiny-ecs (⭐529)](https://github.com/bakpakin/tiny-ecs) - Entity Component System for Lua that's simple, flexible, and useful.
...
*   [batteries (⭐206)](https://github.com/1bardesign/batteries/) - Fills out lua's sparse standard library and provides implementations of common algorithms and data structures useful for games.
...
*   [knife (⭐367)](https://github.com/airstruck/knife) - Collection of useful micro-modules for Lua (Class, State Machines, Bind, Chain, Coroutines, Event, Memoize, Entity, Tests, Timer).
...
*   [lume (⭐778)](https://github.com/rxi/lume/) - Collection of functions for Lua, geared towards game development.
*   [narrator (⭐75)](https://github.com/astrochili/narrator) - An Ink narrative scripting language parser and runtime implementation.
...
*   [rotLove (⭐230)](https://github.com/paulofmandown/rotLove) - Roguelike Toolkit in LÖVE. A LÖVE/lua port of rot.js.
...
*   [Simple Tiled Implementation (⭐705)](https://github.com/karai17/Simple-Tiled-Implementation) - Tiled map loader and renderer.
...
*   [Light World (⭐208)](https://github.com/tanema/light_world.lua) - A lighting model.
...
*   [brinevector (⭐41)](https://github.com/novemberisms/brinevector) - Standalone lightweight luajit ffi-accelerated 2D vector library for great performance.
*   [Cirno's Perfect Math Library (⭐264)](https://github.com/excessive/cpml) - Math/intersection library designed for games.
...
*   [nvec (⭐24)](https://github.com/MikuAuahDark/NPad93/blob/master/nvec.lua) - Hump.vector-compatible LuaJIT FFI-accelerated 2D vector library.
...
*   [lovebpm (⭐65)](https://github.com/rxi/lovebpm) - A LÖVE library for syncing events to the BPM of an audio track.
...
*   [Sock.lua (⭐151)](https://github.com/camchenry/sock.lua) - A Lua networking library for LÖVE games. (IPv4)
*   [löve-ws (⭐20)](https://github.com/holywyvern/love-ws) - A websocket client and server library.
*   [love2d-lua-websocket (⭐24)](https://github.com/flaribbit/love2d-lua-websocket) - A simple event-driven websocket client library. (IPv4)

### OO

*   [30log (⭐388)](https://github.com/Yonaba/30log) - Minified framework for object-orientation in Lua. It features named (and unnamed) classes, single inheritance and a basic support for mixins.
*   [classic (⭐674)](https://github.com/rxi/classic/) - Tiny class module for Lua. Attempts to stay simple and provide decent performance by avoiding unnecessary over-abstraction.
...
*   [breezefield (⭐35)](https://github.com/HDictus/breezefield) - A lightweight and easy love.physics wrapper (windfield alternative).
*   [Bump (⭐788)](https://github.com/kikito/bump.lua) - Collision detection library for Lua.
...
*   [LoveDos (⭐633)](https://github.com/rxi/lovedos) - A Lua framework for 2D DOS games, implementing a subset of the LÖVE API.
*   [LoveFTW](https://bitbucket.org/T-BoneISS/l-veftw) - Work-in-progress port to Windows phone 8.1.
*   [LovePotion (⭐408)](https://github.com/TurtleP/LovePotion) - Unofficial work-in-progress implementation of the LÖVE API for Nintendo 3DS and Nintendo Switch Homebrew.
*   [LOVE-WrapLua (⭐29)](https://github.com/LukeZGD/LOVE-WrapLua) - A small and simple wrapper for OneLua, lpp-vita, and Lua Player PS3.
*   [Love.js (⭐419)](https://github.com/Davidobot/love.js) - LÖVE ported to the web using Emscripten.
...
*   [AppImageKit (⭐7.7k)](https://github.com/AppImage/AppImageKit) - Using AppImageKit you can package LÖVE games as AppImages that run on common Linux-based operating systems, such as RHEL, CentOS, Ubuntu, Fedora, debian and derivatives; one game = one file.
...
*   [binser (⭐173)](https://github.com/bakpakin/binser) - Customizable Lua Serializer.
...
*   [knife.serialize (⭐367)](https://github.com/airstruck/knife/blob/master/readme/serialize.md) - Serialize data as a Lua script.
...
*   [knife.test (⭐367)](https://github.com/airstruck/knife/blob/master/readme/test.md) - Fixture-free test framework.
*   [Luassert (⭐146)](https://github.com/Olivine-Labs/luassert) - Extends `assert()` with additional, customizable tests.
...
*   [Flux (⭐307)](https://github.com/rxi/flux) - A fast, lightweight tweening library for Lua.
...
*   [tween.lua (⭐493)](https://github.com/kikito/tween.lua) - Tweening/Easing/Interpolating functions for Lua inspired on jQuery's animate method.

### UI

*   [CatUI (⭐88)](https://github.com/wilhantian/catui) - A very light-weight GUI library for LÖVE.
*   [GOOi (⭐192)](https://github.com/tavuntu/gooi) - Android-oriented GUI library.
...
*   [Love Imgui (⭐287)](https://github.com/slages/love-imgui) - Imgui module for the LÖVE game engine.
*   [Löve-Nuklear (⭐308)](https://github.com/keharriso/love-nuklear) - Lightweight immediate mode GUI for LÖVE games.
*   [Patchy (⭐32)](https://github.com/excessive/patchy) - 9patch library.
*   [SafeWord (⭐3)](https://github.com/josefnpat/safeword) - An overscan detection library for LÖVE.
*   [SUIT (⭐420)](https://github.com/vrld/SUIT) - Small immediate mode GUI library.
...
*   [cargo (⭐140)](https://github.com/bjornbytes/cargo) - Asset manager.
...
*   [Ini Parser (⭐13)](https://github.com/FivosM/ini_parser) - General purpose ini configuration parser.
*   [log.lua (⭐263)](https://github.com/rxi/log.lua) - Library for configurable log output.
*   [love-loader (⭐115)](https://github.com/kikito/love-loader) - Threaded resource loading.
*   [love2d-assets-loader (⭐34)](https://github.com/Yonaba/love2d-assets-loader) - Assets Loader.
...
*   [Lily (⭐92)](https://github.com/MikuAuahDark/lily) - Async Asset Loader.
*   [luasteam (⭐78)](https://github.com/uspgamedev/luasteam) - Lua bindings for the Steamworks API.
...
*   [require.lua (⭐5)](https://github.com/premek/require.lua) - Require all files in a folder.
*   [splashy (⭐34)](https://github.com/videah/splashy) - Splash Screen Library.
...
*   [Tutorial on making an Arkanoid-type game (⭐167)](https://github.com/noooway/love2d_arkanoid_tutorial/wiki) - A complete tutorial on how to make a breakout clone by nooowaay.
...
*   [IntelliJ IDEA](https://www.jetbrains.com/idea/) - Capable and Ergonomic Java IDE.
    *   [EmmyLua (⭐535)](https://github.com/EmmyLua/VSCode-EmmyLua) - Lua IDE/Debugger Plugin for VSCode.
...
*   [awesome-love-shaders (⭐67)](https://github.com/karai17/awesome-love-shaders) - A collection of shaders designed to work in LÖVE.
