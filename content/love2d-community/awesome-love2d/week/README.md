...
[🏠 Home](/README.md) · [🔍 Search](https://www.trackawesomelist.com/search/) · [🔥 Feed](https://www.trackawesomelist.com/love2d-community/awesome-love2d/week/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [😺 love2d-community/awesome-love2d](https://github.com/love2d-community/awesome-love2d) · ⭐ 2.5K · 🏷️ Gaming
...
*   [cimgui-love (⭐43)](https://github.com/apicici/cimgui-love) - LÖVE module for Dear ImGui obtained by wrapping cimgui (programmatically generated C-api) using LuaJIT FFI, easy to update to the latest Dear Imgui version.
...
*   [Slicy (⭐6)](https://github.com/wqferr/slicy) - A newer 9patch/9slice library fixing some issues with Patchy.
...
*   [love-fuser (⭐12)](https://github.com/MikuAuahDark/love-fuser) - Packages LÖVE Games using GitHub Actions. Supports Windows, Linux, and Android.

## [Mar 21 - Mar 27, 2022](/content/2022/12/README.md)

### Drawing

*   [grove.draworder (⭐8)](https://github.com/FloatingBanana/Grove/blob/master/grove/draworder.lua) - Similar to deep, but you can set a custom sorting method and create multiple, nestable instances.

### Helpers

*   [grove.color (⭐8)](https://github.com/FloatingBanana/Grove/blob/master/grove/color.lua) - Blend, convert and interpolate colors using 'color objects'.
...
*   [Helium (⭐79)](https://github.com/qeffects/helium) - A modern, customizable, high performance retained UI framework.
...
*   [Plan (⭐14)](https://github.com/zombrodo/plan) - A super simple Rule-based layout library.
...
*   [Jumper (⭐577)](https://github.com/Yonaba/Jumper) - Grid-based pathfinding library.
...
*   [anim8 (⭐562)](https://github.com/kikito/anim8) - Animation library.
...
*   [lovanim (⭐24)](https://github.com/patrixr/love-animation) - A minimal stateful animation library.
...
*   [gamera (⭐207)](https://github.com/kikito/gamera) - Camera system.
...
*   [LÖVE API (⭐255)](https://github.com/love2d-community/love-api) - The complete API documentation of LÖVE in a Lua table.
*   [LÖVE Build (⭐44)](https://github.com/nhartland/love-build) - GitHub Action for automated cross-platform builds.
...
*   [Push (⭐396)](https://github.com/Ulydev/push) - A simple resolution-handling library for LÖVE.
...
*   [knife.system (⭐353)](https://github.com/airstruck/knife/blob/master/readme/system.md) - Minimalist functional ECS.
*   [nata (⭐36)](https://github.com/tesselode/nata) - Hybrid OOP/ECS entity management.
*   [tiny-ecs (⭐519)](https://github.com/bakpakin/tiny-ecs) - Entity Component System for Lua that's simple, flexible, and useful.
...
*   [batteries (⭐194)](https://github.com/1bardesign/batteries/) - Fills out lua's sparse standard library and provides implementations of common algorithms and data structures useful for games.
...
*   [knife (⭐353)](https://github.com/airstruck/knife) - Collection of useful micro-modules for Lua (Class, State Machines, Bind, Chain, Coroutines, Event, Memoize, Entity, Tests, Timer).
...
*   [narrator (⭐69)](https://github.com/astrochili/narrator) - An Ink narrative scripting language parser and runtime implementation.
...
*   [Cirno's Perfect Math Library (⭐262)](https://github.com/excessive/cpml) - Math/intersection library designed for games.
*   [delaunay (⭐98)](https://github.com/Yonaba/delaunay) - Delaunay triangulation for convex polygons.
...
*   [vector.lua (⭐29)](https://github.com/themousery/vector.lua) - A simple vector library based on the PVector class from processing.
...
*   [NoobHub (⭐275)](https://github.com/Overtorment/NoobHub) - OpenSource multiplayer and network messaging. (IPv6)
*   [Sock.lua (⭐149)](https://github.com/camchenry/sock.lua) - A Lua networking library for LÖVE games. (IPv4)
*   [löve-ws (⭐20)](https://github.com/holywyvern/love-ws) - A websocket client and server library.
*   [love2d-lua-websocket (⭐22)](https://github.com/flaribbit/love2d-lua-websocket) - A simple event-driven websocket client library. (IPv4)

### OO

*   [30log (⭐383)](https://github.com/Yonaba/30log) - Minified framework for object-orientation in Lua. It features named (and unnamed) classes, single inheritance and a basic support for mixins.
*   [classic (⭐655)](https://github.com/rxi/classic/) - Tiny class module for Lua. Attempts to stay simple and provide decent performance by avoiding unnecessary over-abstraction.
...
*   [Bump (⭐772)](https://github.com/kikito/bump.lua) - Collision detection library for Lua.
...
*   [LoveDos (⭐616)](https://github.com/rxi/lovedos) - A Lua framework for 2D DOS games, implementing a subset of the LÖVE API.
*   [LoveFTW](https://bitbucket.org/T-BoneISS/l-veftw) - Work-in-progress port to Windows phone 8.1.
*   [LovePotion (⭐398)](https://github.com/TurtleP/LovePotion) - Unofficial work-in-progress implementation of the LÖVE API for Nintendo 3DS and Nintendo Switch Homebrew.
*   [LOVE-WrapLua (⭐29)](https://github.com/LukeZGD/LOVE-WrapLua) - A small and simple wrapper for OneLua, lpp-vita, and Lua Player PS3.
*   [Love.js (⭐393)](https://github.com/Davidobot/love.js) - LÖVE ported to the web using Emscripten.
...
*   [knife.serialize (⭐353)](https://github.com/airstruck/knife/blob/master/readme/serialize.md) - Serialize data as a Lua script.
...
*   [knife.test (⭐353)](https://github.com/airstruck/knife/blob/master/readme/test.md) - Fixture-free test framework.
*   [Luassert (⭐138)](https://github.com/Olivine-Labs/luassert) - Extends `assert()` with additional, customizable tests.
...
*   [Flux (⭐303)](https://github.com/rxi/flux) - A fast, lightweight tweening library for Lua.
*   [hump.timer](https://hump.readthedocs.io/en/latest/timer.html) - Timer and tweening library with flexible tweening methods.
*   [tick (⭐93)](https://github.com/rxi/tick) - Lua module for delaying function calls.
...
*   [cargo (⭐136)](https://github.com/bjornbytes/cargo) - Asset manager.
...
*   [GifCat (⭐37)](https://github.com/WetDesertRock/GifCat) - A simple module for saving gifs from LÖVE.
...
*   [log.lua (⭐252)](https://github.com/rxi/log.lua) - Library for configurable log output.
...
*   [Lily (⭐90)](https://github.com/MikuAuahDark/lily) - Async Asset Loader.
*   [luasteam (⭐75)](https://github.com/uspgamedev/luasteam) - Lua bindings for the Steamworks API.
...
*   [IntelliJ IDEA](https://www.jetbrains.com/idea/) - Capable and Ergonomic Java IDE.
    *   [EmmyLua (⭐525)](https://github.com/EmmyLua/VSCode-EmmyLua) - Lua IDE/Debugger Plugin for VSCode.
...
*   [awesome-love-shaders (⭐64)](https://github.com/karai17/awesome-love-shaders) - A collection of shaders designed to work in LÖVE.
...
*   [Slab (⭐214)](https://github.com/flamendless/Slab) - Slab is an immediate mode GUI toolkit for the LÖVE framework.
...
*   [boon (⭐114)](https://github.com/camchenry/boon) - Multi-platform, easy to use tool supporting Windows, macOS, Linux.
...
*   [makelove (⭐74)](https://github.com/pfirsich/makelove) - Advanced multi-platform tool to fuse your game written in Python 3. Supports Windows and Linux with AppImage.

## [Feb 01 - Feb 07, 2021](/content/2021/5/README.md)

### 3D

*   [g3d (⭐356)](https://github.com/groverburger/g3d) - Simple and easy 3D engine for LÖVE.
...
*   [3DreamEngine (⭐235)](https://github.com/3dreamengine/3DreamEngine) - An awesome 3D engine for LÖVE.
...
*   [cartographer (⭐59)](https://github.com/tesselode/cartographer) - Small Tiled map loader and drawer.
*   [lovely-windows (⭐14)](https://github.com/flamendless/lovely-windows) - A Window/Screen Manager Module for virtual windows.

### OO

*   [knife.base (⭐353)](https://github.com/airstruck/knife/blob/master/readme/base.md) - Extremely minimal base class providing single inheritance and constructors.
...
*   [knife.timer (⭐353)](https://github.com/airstruck/knife/blob/master/readme/timer.md) - Create timers and tweens with ease.
