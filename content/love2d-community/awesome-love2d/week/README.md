...
*   [Luis (⭐16)](https://github.com/SiENcE/luis) - LUIS (Love UI System) - A retained Mode UI Framework for LÖVE with Input processing (mouse, keyboard, touch, gamepad),  Layer-, Grid-, State-, Theming-system, UI Editor, 16+ Widgets (for Desktop & Mobile).
...
*   [Hot particles (⭐52)](https://github.com/ReFreezed/HotParticles) - "Hot Particles is a particle editor for the LÖVE game framework."
...
*   [LÖVE Potion (⭐577)](https://github.com/lovebrew/lovepotion) - Unofficial implementation of the LÖVE for Nintendo (3DS, Switch and Wii U) Homebrew.
...
*   [Menori (⭐201)](https://github.com/rozenmad/Menori) - Library for 3D rendering with LÖVE.

### Helpers

*   [Manami (⭐47)](https://github.com/MikuAuahDark/NPad93/blob/master/manami.lua) - An improved "reflowprint" with UTF-8, multicolor, and justify support.

### UI

*   [Inky (⭐58)](https://github.com/Keyslam/Inky) - Any-purpose GUI framework.

## [Mar 06 - Mar 12, 2023](/content/2023/10/README.md)

### Development

*   [vudu (⭐44)](https://github.com/deltadaedalus/vudu) - Broad in-game debugging gui with a console, variable browser/editor, speed controls, and more.
...
*   [loveprofiler (⭐9)](https://github.com/dknight/loveprofiler) - LoveProfiler is an extremely simple logger and profiler.
...
*   [ecs-lua (⭐183)](https://github.com/nidorx/ecs-lua) - ECS Lua is a fast and easy to use ECS (Entity Component System) engine for game development.

### Helpers

*   [lua-state-machine (⭐370)](https://github.com/kyleconroy/lua-state-machine) - Lua Finite State Machine.
*   [Scenery (⭐30)](https://github.com/paltze/scenery) - A dead simple scene/state management system.
...
*   [NAniTe (⭐47)](https://github.com/MikuAuahDark/NPad93/blob/master/nanite.lua) - Timeline-based animation system that supports forward and backward update.
...
*   [Aseprite loader (⭐44)](https://github.com/elloramir/love-ase) - Complete ase/aseprite file loader (no json).
...
*   [Helium (⭐105)](https://github.com/qeffects/helium) - A modern, customizable, high performance retained UI framework.
...
*   [Jumper (⭐624)](https://github.com/Yonaba/Jumper) - Grid-based pathfinding library.
*   [Lua-star (⭐70)](https://github.com/wesleywerner/lua-star) - Easy and pure Lua A\* path finding.

### Animation

*   [andross (⭐32)](https://github.com/pfirsich/andross) - A Lua library for 2D skeletal/bone animations with a Löve backend.
*   [anim8 (⭐794)](https://github.com/kikito/anim8) - Animation library.
...
*   [lovanim (⭐33)](https://github.com/patrixr/love-animation) - A minimal stateful animation library.
...
*   [gamera (⭐272)](https://github.com/kikito/gamera) - Camera system.
...
*   [Lovebird (⭐301)](https://github.com/rxi/lovebird) - Browser-based debug console.
*   [lurker (⭐306)](https://github.com/rxi/lurker) - Auto-swaps changed Lua files in a running game.
*   [LÖVE API (⭐312)](https://github.com/love2d-community/love-api) - The complete API documentation of LÖVE in a Lua table.
*   [LÖVE Build (⭐57)](https://github.com/nhartland/love-build) - GitHub Action for automated cross-platform builds.
*   [LÖVE TypeScript Definitions (⭐121)](https://github.com/hazzard993/love-typescript-definitions) - Write LÖVE games with TypeScript.
...
*   [Autobatch (⭐110)](https://github.com/rxi/autobatch) - Small LÖVE module to automate the use of SpriteBatches.
*   [center (⭐14)](https://github.com/S-Walrus/center) - A simple module to dynamically align and fit content to screens of any size.
*   [deep (⭐81)](https://github.com/Nikaoto/deep) - Adds Z axis; allows you to queue actions and draw calls.
*   [draft (⭐50)](https://github.com/pelevesque/draft) - A module for drawing complex shapes.
...
*   [Push (⭐529)](https://github.com/Ulydev/push) - A simple resolution-handling library for LÖVE.
...
*   [Tove2d (⭐173)](https://github.com/poke1024/tove2d) - Animated vector graphics for LÖVE.
...
*   [Concord (⭐250)](https://github.com/Tjakka5/Concord) - A feature-complete ECS library.
*   [knife.system (⭐462)](https://github.com/airstruck/knife/blob/master/readme/system.md) - Minimalist functional ECS.
*   [nata (⭐44)](https://github.com/tesselode/nata) - Hybrid OOP/ECS entity management.
*   [tiny-ecs (⭐704)](https://github.com/bakpakin/tiny-ecs) - Entity Component System for Lua that's simple, flexible, and useful.

### Helpers

*   [astray (⭐151)](https://github.com/SiENcE/astray) - Astray is a lua based maze, room and dungeon generation library for dungeon crawlers and roguelike video games.
*   [batteries (⭐374)](https://github.com/1bardesign/batteries/) - Fills out lua's sparse standard library and provides implementations of common algorithms and data structures useful for games.
...
*   [knife (⭐462)](https://github.com/airstruck/knife) - Collection of useful micro-modules for Lua (Class, State Machines, Bind, Chain, Coroutines, Event, Memoize, Entity, Tests, Timer).
*   [shard (⭐19)](https://github.com/MineGame159/shard) - Collection of useful mini modules.
...
*   [narrator (⭐137)](https://github.com/astrochili/narrator) - An Ink narrative scripting language parser and runtime implementation.
...
*   [roomy (⭐52)](https://github.com/tesselode/roomy) - Screen management library for LÖVE.
*   [rotLove (⭐267)](https://github.com/paulofmandown/rotLove) - Roguelike Toolkit in LÖVE. A LÖVE/lua port of rot.js.
...
*   [Simple Tiled Implementation (⭐905)](https://github.com/karai17/Simple-Tiled-Implementation) - Tiled map loader and renderer.
...
*   [baton (⭐227)](https://github.com/tesselode/baton) -  Input library for LÖVE that bridges the gap between keyboard and gamepad controls.
...
*   [Light World (⭐230)](https://github.com/tanema/light_world.lua) - A lighting model.
...
*   [nvec (⭐47)](https://github.com/MikuAuahDark/NPad93/blob/master/nvec.lua) - Hump.vector-compatible LuaJIT FFI-accelerated 2D vector library.
...
*   [ripple (⭐46)](https://github.com/tesselode/ripple) - An audio manager with tagging support.
*   [wave (⭐94)](https://github.com/Ulydev/wave) - A sound manager with audio parsing and rhythm functionalities.
...
*   [NoobHub (⭐333)](https://github.com/Overtorment/NoobHub) - OpenSource multiplayer and network messaging. (IPv6)
...
*   [30log (⭐468)](https://github.com/Yonaba/30log) - Minified framework for object-orientation in Lua. It features named (and unnamed) classes, single inheritance and a basic support for mixins.
*   [classic (⭐920)](https://github.com/rxi/classic/) - Tiny class module for Lua. Attempts to stay simple and provide decent performance by avoiding unnecessary over-abstraction.
...
*   [breezefield (⭐92)](https://github.com/HDictus/breezefield) - A lightweight and easy love.physics wrapper (windfield alternative).
*   [Bump (⭐970)](https://github.com/kikito/bump.lua) - Collision detection library for Lua.
...
*   [LoveDos (⭐681)](https://github.com/rxi/lovedos) - A Lua framework for 2D DOS games, implementing a subset of the LÖVE API.
...
*   [Love.js (⭐671)](https://github.com/Davidobot/love.js) - LÖVE ported to the web using Emscripten.
...
*   [binser (⭐203)](https://github.com/bakpakin/binser) - Customizable Lua Serializer.
...
*   [knife.serialize (⭐462)](https://github.com/airstruck/knife/blob/master/readme/serialize.md) - Serialize data as a Lua script.
...
*   [LoveShaderConverter (⭐79)](https://github.com/tsteinholz/LoveShaderConverter) - Convert Shadertoy Shader files to LÖVE GLSL Files with handy utilities for infinite purposes.
...
*   [knife.test (⭐462)](https://github.com/airstruck/knife/blob/master/readme/test.md) - Fixture-free test framework.
*   [Luassert (⭐217)](https://github.com/Olivine-Labs/luassert) - Extends `assert()` with additional, customizable tests.
*   [Lunatest (⭐85)](https://github.com/silentbicycle/lunatest) - xUnit-style randomized unit testing framework.
*   [lust (⭐117)](https://github.com/bjornbytes/lust) - Minimal test framework.
...
*   [Flux (⭐407)](https://github.com/rxi/flux) - A fast, lightweight tweening library for Lua.
*   [hump.timer](https://hump.readthedocs.io/en/latest/timer.html) - Timer and tweening library with flexible tweening methods.
*   [tick (⭐155)](https://github.com/rxi/tick) - Lua module for delaying function calls.
*   [tween.lua (⭐609)](https://github.com/kikito/tween.lua) - Tweening/Easing/Interpolating functions for Lua inspired on jQuery's animate method.
...
*   [LoveFrames Fork (⭐130)](https://github.com/linux-man/LoveFrames) - 11.2 Fork of a GUI library.
*   [Love Imgui (⭐330)](https://github.com/slages/love-imgui) - Imgui module for the LÖVE game engine.
...
*   [SUIT (⭐478)](https://github.com/vrld/SUIT) - Small immediate mode GUI library.
...
*   [cargo (⭐169)](https://github.com/bjornbytes/cargo) - Asset manager.
...
*   [log.lua (⭐320)](https://github.com/rxi/log.lua) - Library for configurable log output.
...
*   [luasteam (⭐160)](https://github.com/uspgamedev/luasteam) - Lua bindings for the Steamworks API.
...
*   [Tutorial on making an Arkanoid-type game (⭐209)](https://github.com/noooway/love2d_arkanoid_tutorial/wiki) - A complete tutorial on how to make a breakout clone by nooowaay.
...
*   [IntelliJ IDEA](https://www.jetbrains.com/idea/) - Capable and Ergonomic Java IDE.
    *   [EmmyLua (⭐660)](https://github.com/EmmyLua/VSCode-EmmyLua) - Lua IDE/Debugger Plugin for VSCode.
...
*   [Vim](https://vim.sourceforge.io/) - Vim is a highly configurable text editor built to make creating and changing any kind of text very efficient.
    *   [Vim LOVE Docs (⭐53)](https://github.com/davisdude/vim-love-docs) - Syntax highlighting for Vim.
...
*   [hump (⭐81)](https://github.com/HDictus/hump) - Collection of tools for developing games with LÖVE (Gamestates, Timers/Tweens, Vectors, Classes, Signals, Cameras).

## [Aug 16 - Aug 22, 2021](/content/2021/33/README.md)

### UI

*   [Slab (⭐309)](https://github.com/flamendless/Slab) - Slab is an immediate mode GUI toolkit for the LÖVE framework.
...
*   [g3d (⭐593)](https://github.com/groverburger/g3d) - Simple and easy 3D engine for LÖVE.
...
*   [3DreamEngine (⭐415)](https://github.com/3dreamengine/3DreamEngine) - An awesome 3D engine for LÖVE.
