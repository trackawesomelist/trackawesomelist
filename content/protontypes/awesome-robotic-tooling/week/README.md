...
*   [3d-bat (⭐463)](https://github.com/walzimmer/3d-bat) - 3D Bounding Box Annotation Tool for Point cloud and Image Labeling.
...
*   [ntop (⭐5.3k)](https://github.com/ntop/ntopng) - Web-based Traffic and Security Network Traffic Monitoring.
*   [jupyterlab-nvdashboard (⭐499)](https://github.com/rapidsai/jupyterlab-nvdashboard) - A JupyterLab extension for displaying dashboards of GPU usage.

### Operation System / Database and Record

*   [ncdu](https://dev.yorhel.nl/ncdu) - Ncdu is a disk usage analyzer with an ncurses interface.
*   [borg (⭐9.4k)](https://github.com/borgbackup/borg) - Deduplicating archiver with compression and authenticated encryption.
*   [bag-database (⭐281)](https://github.com/swri-robotics/bag-database) - A server that catalogs bag files and provides a web-based UI for accessing them.
...
*   [kitti2bag (⭐611)](https://github.com/tomas789/kitti2bag) - Convert KITTI dataset to ROS bag file the easy way.
*   [pykitti (⭐983)](https://github.com/utiasSTARS/pykitti) - Python tools for working with KITTI data.
*   [rosbag\_editor (⭐329)](https://github.com/facontidavide/rosbag_editor) - Create a rosbag from a given one, using a simple GUI.
...
*   [syncthing (⭐51k)](https://github.com/syncthing/syncthing) - A continuous file synchronization program.
...
*   [xviz (⭐926)](https://github.com/uber/xviz) - A protocol for real-time transfer and visualization of autonomy data.
*   [kitti\_to\_rosbag (⭐221)](https://github.com/ethz-asl/kitti_to_rosbag) - A Dataset tools for working with the KITTI dataset raw data and converting it to a ROS bag. Also allows a library for direct access to poses, velodyne scans, and images.
*   [ros\_numpy (⭐257)](https://github.com/eric-wieser/ros_numpy) - Tools for converting ROS messages to and from numpy arrays.
*   [kitti\_ros (⭐19)](https://github.com/LidarPerception/kitti_ros) - A ROS-based player to replay KiTTI dataset.
*   [DuckDB (⭐9.8k)](https://github.com/cwida/duckdb) - An embeddable SQL OLAP Database Management System.

### Operation System / Network Distributed File System

*   [sshfs (⭐1k)](https://github.com/osxfuse/sshfs) - File system based on the SSH File Transfer Protocol.
*   [moosefs (⭐1.4k)](https://github.com/moosefs/moosefs) -  A scalable distributed storage system.
*   [ceph (⭐12k)](https://github.com/ceph/ceph) - A distributed object, block, and file storage platform.
*   [nfs (⭐415)](https://github.com/sahlberg/libnfs) - A distributed file system protocol originally developed by Sun Microsystems.

### Operation System / Server Infrastructure and High Performance Computing

*   [localstack (⭐47k)](https://github.com/localstack/localstack) - A fully functional local AWS cloud stack. Develop and test your cloud & Serverless apps offline.
*   [nvidia-docker (⭐16k)](https://github.com/NVIDIA/nvidia-docker) - Build and run Docker containers leveraging NVIDIA GPUs.
*   [kubeflow (⭐13k)](https://github.com/kubeflow/kubeflow) - Machine Learning Toolkit for Kubernetes.
*   [log-pilot (⭐1.4k)](https://github.com/AliyunContainerService/log-pilot) - Collect logs for docker containers.
*   [traefik (⭐43k)](https://github.com/containous/traefik) - The Cloud Native Edge Router.
*   [graylog2-server (⭐6.5k)](https://github.com/Graylog2/graylog2-server) - Free and open source log management.
*   [ansible (⭐57k)](https://github.com/ansible/ansible) - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy.
*   [pyinfra (⭐2.3k)](https://github.com/Fizzadar/pyinfra) - It can be used for ad-hoc command execution, service deployment, configuration management and more.
*   [docker-py (⭐6.2k)](https://github.com/docker/docker-py) - A Python library for the Docker Engine API.
*   [noVNC (⭐9.8k)](https://github.com/novnc/noVNC) - VNC client using HTML5.
*   [Slurm (⭐1.8k)](https://github.com/SchedMD/slurm) - Slurm: A Highly Scalable Workload Manager.
*   [jupyterhub (⭐7.2k)](https://github.com/jupyterhub/jupyterhub) - Multi-user server for Jupyter notebooks.
*   [Portainer (⭐25k)](https://github.com/portainer/portainer) - Making Docker management easy.
*   [docker-firefox (⭐855)](https://github.com/jlesage/docker-firefox) - Run a Docker Container with Firefox and noVNC for remote access to headless servers.
*   [luigi (⭐17k)](https://github.com/spotify/luigi) - A Python module that helps you build complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization etc. It also comes with Hadoop support built in.
*   [triton-inference-server (⭐5.2k)](https://github.com/NVIDIA/triton-inference-server) - NVIDIA Triton Inference Server provides a cloud inferencing solution optimized for NVIDIA GPUs.
*   [cudf (⭐5.5k)](https://github.com/rapidsai/cudf) - Provides a pandas-like API that will be familiar to data engineers & data scientists, so they can use it to easily accelerate their workflows without going into the details of CUDA programming.

### Operation System / Embedded Operation System

*   [vxworks7-ros2-build (⭐76)](https://github.com/Wind-River/vxworks7-ros2-build) - Build system to automate the build of VxWorks 7 and ROS2.
...
*   [bitbake (⭐346)](https://github.com/openembedded/bitbake) - A generic task execution engine that allows shell and Python tasks to be run efficiently and in parallel while working within complex inter-task dependency constraints.
...
*   [qemu-xilinx (⭐191)](https://github.com/Xilinx/qemu) - A fork of Quick EMUlator (QEMU) with improved support and modelling for the Xilinx platforms.
*   [rosserial (⭐463)](https://github.com/ros-drivers/rosserial) - A ROS client library for small, embedded devices, such as Arduino.
*   [meta-ros (⭐316)](https://github.com/ros/meta-ros/tree/thud-draft) - OpenEmbedded Layer for ROS Applications.
*   [meta-balena (⭐961)](https://github.com/balena-os/meta-balena) - Run Docker containers on embedded devices.
...
*   [nvidia-container-runtime (⭐983)](https://github.com/NVIDIA/nvidia-container-runtime/) - NVIDIA Container Runtime is a GPU aware container runtime, compatible with the Open Containers Initiative (OCI) specification used by Docker, CRI-O, and other popular container technologie.
*   [fusesoc (⭐958)](https://github.com/olofk/fusesoc) - Package manager and build abstraction tool for FPGA/ASIC development.
*   [jetson\_easy (⭐264)](https://github.com/rbonghi/jetson_easy) - Automatically script to setup and configure your NVIDIA Jetson.
*   [docker-jetpack-sdk (⭐9)](https://github.com/trn84/docker-jetpack-sdk) -  Allows for usage of the NVIDIA JetPack SDK within a docker container for download, flashing, and install.
...
*   [jetson\_stats (⭐1.7k)](https://github.com/rbonghi/jetson_stats) - A package to monitoring and control your NVIDIA Jetson (Xavier NX, Nano, AGX Xavier, TX1, TX2) Works with all NVIDIA Jetson ecosystem.
*   [ros\_jetson\_stats (⭐64)](https://github.com/rbonghi/ros_jetson_stats) - The ROS jetson-stats wrapper. The status of your NVIDIA jetson in diagnostic messages.
*   [OpenCR (⭐347)](https://github.com/ROBOTIS-GIT/OpenCR) - Open-source Control Module for ROS.
*   [acrn-hypervisor (⭐942)](https://github.com/projectacrn/acrn-hypervisor) - Defines a device hypervisor reference stack and an architecture for running multiple software subsystems, managed securely, on a consolidated system by means of a virtual machine manager.
*   [jetson-containers (⭐877)](https://github.com/dusty-nv/jetson-containers) - Machine Learning Containers for Jetson and JetPack 4.4.
...
*   [performance\_test (⭐63)](https://github.com/ApexAI/performance_test) - Tool to test the performance of pub/sub based communication frameworks.
*   [ros1\_bridge (⭐306)](https://github.com/ros2/ros1_bridge) - ROS 2 package that provides bidirectional communication between ROS 1 and ROS 2.
*   [Fast-RTPS (⭐1.6k)](https://github.com/eProsima/Fast-RTPS) - A Protocol, which provides publisher-subscriber communications over unreliable transports such as UDP, as defined and maintained by the Object Management Group (OMG) consortium.
*   [protobuf (⭐59k)](https://github.com/protocolbuffers/protobuf) - Google's data interchange format.
*   [opensplice (⭐239)](https://github.com/ADLINK-IST/opensplice) - Vortex OpenSplice Community Edition.
*   [cyclonedds (⭐587)](https://github.com/eclipse-cyclonedds/cyclonedds) - Eclipse Cyclone DDS is a very performant and robust open-source DDS implementation.
*   [iceoryx (⭐1.2k)](https://github.com/eclipse/iceoryx) - An IPC middleware for POSIX-based systems.
*   [rosbridge\_suite (⭐696)](https://github.com/RobotWebTools/rosbridge_suite) - Provides a JSON interface to ROS, allowing any client to send JSON to publish or subscribe to ROS topics, call ROS services, and more.
...
*   [SOES (⭐426)](https://github.com/OpenEtherCATsociety/SOES) - SOES is an EtherCAT slave stack written in C.
...
*   [rdbox (⭐279)](https://github.com/rdbox-intec/rdbox) - RDBOX is a IT infrastructure for ROS robots.
*   [ros\_ethercat (⭐86)](https://github.com/shadow-robot/ros_ethercat) - This is a reimplementation of the main loop of pr2\_ethercat without dependencies on PR2 software.
*   [wavemon (⭐781)](https://github.com/uoaerg/wavemon) - An ncurses-based monitoring application for wireless network devices.
*   [ptpd (⭐429)](https://github.com/ptpd/ptpd) - PTP daemon (PTPd) is an implementation the Precision Time Protocol (PTP) version 2 as defined by 'IEEE Std 1588-2008'. PTP provides precise time coordination of Ethernet LAN connected computers.
*   [iperf (⭐5.3k)](https://github.com/esnet/iperf) - A TCP, UDP, and SCTP network bandwidth measurement tool.
*   [tcpreplay (⭐993)](https://github.com/appneta/tcpreplay) - Pcap editing and replay tools.
*   [nethogs (⭐2.6k)](https://github.com/raboof/nethogs) - It groups bandwidth by process.
*   [pyshark (⭐1.8k)](https://github.com/KimiNewt/pyshark) - Python wrapper for tshark, allowing python packet parsing using wireshark dissectors.
*   [pingtop (⭐483)](https://github.com/laixintao/pingtop) - Ping multiple servers and show results in a top-like terminal UI.
*   [termshark (⭐7.9k)](https://github.com/gcla/termshark) - A terminal UI for tshark, inspired by Wireshark.
*   [udpreplay (⭐216)](https://github.com/rigtorp/udpreplay) - Replay UDP packets from a pcap file.
*   [openwifi (⭐3k)](https://github.com/open-sdr/openwifi) - Linux mac80211 compatible full-stack IEEE802.11/Wi-Fi design based on Software Defined Radio.

### Network and Middleware / Controller Area Network

*   [AndrOBD (⭐1k)](https://github.com/fr3ts0n/AndrOBD) - Android OBD diagnostics with any ELM327 adapter.
*   [ddt4all (⭐813)](https://github.com/cedricp/ddt4all) - DDT4All is a tool to create your own ECU parameters screens and connect to a CAN network with a cheap ELM327 interface.
*   [cabana (⭐154)](https://github.com/commaai/cabana) - CAN visualizer and DBC maker.
*   [libuavcan (⭐268)](https://github.com/UAVCAN/libuavcan) - An open lightweight protocol designed for reliable communication in aerospace and robotic applications over robust vehicular networks such as CAN bus.
*   [python-can (⭐980)](https://github.com/hardbyte/python-can) - The can package provides controller area network support for Python developers.
*   [CANopenNode (⭐1.1k)](https://github.com/CANopenNode/CANopenNode) - The internationally standardized (EN 50325-4) (CiA301) CAN-based higher-layer protocol for embedded control system.
*   [python-udsoncan (⭐420)](https://github.com/pylessard/python-udsoncan) - Python implementation of UDS (ISO-14229) standard.
*   [uds-c (⭐513)](https://github.com/openxc/uds-c) - Unified Diagnostics Service (UDS) and OBD-II (On Board Diagnostics for Vehicles) C Library.
*   [cantools (⭐1.5k)](https://github.com/eerimoq/cantools) - CAN BUS tools in Python 3.
*   [CANdevStudio (⭐686)](https://github.com/GENIVI/CANdevStudio) -  CANdevStudio aims to be cost-effective replacement for CAN simulation software. It can work with variety of CAN hardware interfaces.
*   [can-utils (⭐1.9k)](https://github.com/linux-can/can-utils) - Linux-CAN / SocketCAN user space applications.
*   [ros\_canopen (⭐288)](https://github.com/ros-industrial/ros_canopen) - CANopen driver framework for ROS.
*   [decanstructor (⭐30)](https://github.com/JWhitleyAStuff/decanstructor) - The definitive ROS CAN analysis tool.
*   [kvaser\_interface (⭐75)](https://github.com/astuff/kvaser_interface) - This package was developed as a standardized way to access Kvaser CAN devices from ROS.
*   [canmatrix (⭐737)](https://github.com/ebroecker/canmatrix) - Converting CAN Database Formats .arxml .dbc .dbf .kcd.
*   [autosar (⭐247)](https://github.com/cogu/autosar) - A set of python modules for working with AUTOSAR XML files.
*   [SavvyCAN (⭐654)](https://github.com/collin80/SavvyCAN) - A Qt5 based cross platform tool which can be used to load, save, and capture canbus frames.

### Network and Middleware / Sensor and Acuator Interfaces

*   [Tesla-API (⭐1.8k)](https://github.com/timdorr/tesla-api) - Provides functionality to monitor and control the Model S (and future Tesla vehicles) remotely.
*   [flirpy (⭐151)](https://github.com/LJMUAstroecology/flirpy) - A Python library to interact with FLIR thermal imaging cameras and images.
*   [nerian\_stereo (⭐7)](https://github.com/nerian-vision/nerian_stereo) - ROS node for Nerian's SceneScan and SP1 stereo vision sensors.
*   [pymmw (⭐196)](https://github.com/m6c7l/pymmw) - This is a toolbox composed of Python scripts to interact with TI's evaluation module (BoosterPack) for the IWR1443 mmWave sensing device.
*   [ti\_mmwave\_rospkg (⭐191)](https://github.com/radar-lab/ti_mmwave_rospkg) - TI mmWave radar ROS driver (with sensor fusion and hybrid).
*   [livox\_ros\_driver (⭐276)](https://github.com/Livox-SDK/livox_ros_driver) - A new ROS package, specially used to connect LiDAR products produced by Livox.
*   [velodyne (⭐561)](https://github.com/ros-drivers/velodyne) - A collection of ROS packages supporting Velodyne high definition 3D LIDARs.
*   [ublox (⭐346)](https://github.com/KumarRobotics/ublox) - Provides support for u-blox GPS receivers.
*   [crazyflie\_ros (⭐180)](https://github.com/whoenig/crazyflie_ros) - ROS Driver for Bitcraze Crazyflie.
*   [pointgrey\_camera\_driver (⭐121)](https://github.com/ros-drivers/pointgrey_camera_driver) - ROS driver for Pt. Grey cameras, based on the official FlyCapture2 SDK.
*   [novatel\_gps\_driver (⭐150)](https://github.com/swri-robotics/novatel_gps_driver) - ROS driver for NovAtel GPS / GNSS receivers.
*   [pylon-ros-camera (⭐111)](https://github.com/basler/pylon-ros-camera) - The official pylon ROS driver for Basler GigE Vision and USB3 Vision cameras.
*   [ethz\_piksi\_ros (⭐78)](https://github.com/ethz-asl/ethz_piksi_ros) -  Contains (python) ROS drivers, tools, launch files, and wikis about how to use Piksi Real Time Kinematic (RTK) GPS device in ROS.
*   [bosch\_imu\_driver (⭐49)](https://github.com/mdrwiega/bosch_imu_driver) - A driver for the sensor IMU Bosch BNO055. It was implemented only the UART communication interface (correct sensor mode should be selected).
...
*   [ifm3d (⭐95)](https://github.com/ifm/ifm3d) - Library and Utilities for working with ifm pmd-based 3D ToF Cameras.
*   [cepton\_sdk\_redist (⭐23)](https://github.com/ceptontech/cepton_sdk_redist/) - Provides ROS support for Cepton LiDAR.
...
*   [ros\_astra\_camera (⭐258)](https://github.com/orbbec/ros_astra_camera) - A ROS driver for Orbbec 3D cameras.
*   [spot\_ros (⭐209)](https://github.com/clearpathrobotics/spot_ros) - ROS Driver for Spot.

### Security / Sensor and Acuator Interfaces

*   [owasp-threat-dragon-desktop (⭐590)](https://github.com/mike-goodwin/owasp-threat-dragon-desktop) - Threat Dragon is a free, open-source, cross-platform threat modeling application including system diagramming and a rule engine to auto-generate threats/mitigations.
...
*   [wolfssl (⭐1.9k)](https://github.com/wolfSSL/wolfssl) - A small, fast, portable implementation of TLS/SSL for embedded devices to the cloud.
*   [CANalyzat0r (⭐670)](https://github.com/schutzwerk/CANalyzat0r) - Security analysis toolkit for proprietary car protocols.
*   [RSF (⭐78)](https://github.com/aliasrobotics/RSF) - Robot Security Framework (RSF) is a standardized methodology to perform security assessments in robotics.
*   [lynis (⭐11k)](https://github.com/CISOfy/lynis) - Security auditing tool for Linux, macOS, and UNIX-based systems. Assists with compliance testing (HIPAA/ISO27001/PCI DSS) and system hardening.
*   [OpenVPN (⭐8.5k)](https://github.com/OpenVPN/openvpn) - An open source VPN daemon.
*   [openfortivpn (⭐2.1k)](https://github.com/adrienverge/openfortivpn) - A client for PPP+SSL VPN tunnel services and compatible with Fortinet VPNs.
*   [WireGuard (⭐2.3k)](https://github.com/WireGuard/WireGuard) - WireGuard is a novel VPN that runs inside the Linux Kernel and utilizes state-of-the-art cryptography.
*   [ssh-auditor (⭐566)](https://github.com/ncsa/ssh-auditor) - Scans for weak ssh passwords on your network.
*   [vulscan (⭐2.9k)](https://github.com/scipag/vulscan) - Advanced vulnerability scanning with Nmap NSE.
*   [nmap-vulners (⭐2.9k)](https://github.com/vulnersCom/nmap-vulners) - NSE script based on Vulners.com API.
*   [fail2ban (⭐8.2k)](https://github.com/fail2ban/fail2ban) - Daemon to ban hosts that cause multiple authentication errors.
*   [DependencyCheck (⭐5k)](https://github.com/jeremylong/DependencyCheck) - A software composition analysis utility that detects publicly disclosed vulnerabilities in application dependencies.
*   [Firejail (⭐4.9k)](https://github.com/netblue30/firejail) - A SUID sandbox program that reduces the risk of security breaches by restricting the running environment of untrusted applications using Linux namespaces, seccomp-bpf and Linux capabilities.
*   [RVD (⭐138)](https://github.com/aliasrobotics/RVD) - Robot Vulnerability Database. Community-contributed archive of robot vulnerabilities and weaknesses.
...
*   [Security-Enhanced Linux (⭐1.1k)](https://github.com/SELinuxProject/selinux) - A Linux kernel security module that provides a mechanism for supporting access control security policies, including mandatory access controls (MAC).
*   [OpenTitan (⭐1.8k)](https://github.com/lowRISC/opentitan) - Will make the silicon Root of Trust design and implementation more transparent, trustworthy, and secure for enterprises, platform providers, and chip manufacturers. OpenTitan is administered by lowRISC CIC as a collaborative project to produce high quality, open IP for instantiation as a full-featured product.
*   [bandit (⭐5.2k)](https://github.com/PyCQA/bandit) - A tool designed to find common security issues in Python code.
*   [Passbolt (⭐703)](https://github.com/passbolt/passbolt_docker) - Passbolt is a free and open source password manager that allows team members to store and share credentials securely.
*   [gopass (⭐5.2k)](https://github.com/gopasspw/gopass) - A password manager for the command line written in Go.
*   [pass](https://www.passwordstore.org/) - The standard unix password manager.
*   [Vault (⭐28k)](https://github.com/hashicorp/vault) - A tool for securely accessing secrets. A secret is anything that you want to tightly control access to, such as API keys, passwords, certificates, and more.
*   [legion (⭐878)](https://github.com/GoVanguard/legion) - An open source, easy-to-use, super-extensible and semi-automated network penetration testing framework that aids in discovery, reconnaissance and exploitation of information systems.

### Datasets / Sensor and Acuator Interfaces

*   [KITTI-360 (⭐295)](https://github.com/autonomousvision/kitti360Scripts) -  This large-scale dataset contains 320k images and 100k laser scans in a driving distance of 73.7km.
*   [waymo\_ros (⭐10)](https://github.com/YonoHub/waymo_ros) - This is a ROS package to connect Waymo open dataset to ROS.
*   [awesome-robotics-datasets (⭐246)](https://github.com/sunglok/awesome-robotics-datasets) - A collection of useful datasets for robotics and computer vision.
*   [nuscenes-devkit (⭐1.7k)](https://github.com/nutonomy/nuscenes-devkit) - The devkit of the nuScenes dataset.
*   [utbm\_robocar\_dataset (⭐175)](https://github.com/epan-utbm/utbm_robocar_dataset) - EU Long-term Dataset with Multiple Sensors for Autonomous Driving.
*   [DBNet (⭐202)](https://github.com/driving-behavior/DBNet) - A Large-Scale Dataset for Driving Behavior Learning.
*   [argoverse-api (⭐715)](https://github.com/argoai/argoverse-api) - Official GitHub repository for Argoverse dataset.
*   [DDAD (⭐429)](https://github.com/TRI-ML/DDAD) - A new autonomous driving benchmark from TRI (Toyota Research Institute) for long range (up to 250m) and dense depth estimation in challenging and diverse urban conditions.
*   [pandaset-devkit (⭐210)](https://github.com/scaleapi/pandaset-devkit) - Public large-scale dataset for autonomous driving provided by Hesai & Scale.
*   [awesome-satellite-imagery-datasets (⭐3.1k)](https://github.com/chrieke/awesome-satellite-imagery-datasets) - List of satellite image training datasets with annotations for computer vision and deep learning.
*   [sentinelsat (⭐875)](https://github.com/sentinelsat/sentinelsat) - Search and download Copernicus Sentinel satellite images.
...
*   [racetrack-database (⭐104)](https://github.com/TUMFTM/racetrack-database) - Contains center lines (x- and y-coordinates), track widths and race lines for over 20 race tracks (mainly F1 and DTM) all over the world.
*   [BlenderProc (⭐2k)](https://github.com/DLR-RM/BlenderProc) - A procedural Blender pipeline for photorealistic training image generation.
...
*   [holicity (⭐80)](https://github.com/zhou13/holicity) - A City-Scale Data Platform for Learning Holistic 3D Structures.
