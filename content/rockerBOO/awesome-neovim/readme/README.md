...
Have a problem a plugin can solve? Add it to the [nvim-lua wishlist (⭐241)](https://github.com/nvim-lua/wishlist).
...
You can find them listed on the [Neovim wiki (⭐87k)](https://github.com/neovim/neovim/wiki/Related-projects#gui)
