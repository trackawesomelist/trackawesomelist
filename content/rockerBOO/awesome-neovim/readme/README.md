...
Have a problem a plugin can solve? Add it to the [nvim-lua wishlist (⭐234)](https://github.com/nvim-lua/wishlist).

## UI

Neovim supports a wide variety of UI's.
You can find them listed on the [Neovim wiki (⭐81k)](https://github.com/neovim/neovim/wiki/Related-projects#gui)
