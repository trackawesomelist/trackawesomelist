...
*   [Hdoc1509/gh-actions.nvim (⭐5)](https://github.com/Hdoc1509/gh-actions.nvim) - Tree-sitter grammar and LSP query configuration for GitHub Actions.

## [Nov 19, 2025](/content/2025/11/19/README.md)

### Syntax / Assembly

*   [calops/hmts.nvim (⭐83)](https://github.com/calops/hmts.nvim) - Tree-sitter queries for Home Manager Nix files.
...
*   [alexmozaidze/tree-comment.nvim (⭐4)](https://github.com/alexmozaidze/tree-comment.nvim) - Highlight and configure TODO comments for [tree-sitter-comment (⭐158)](https://github.com/stsewd/tree-sitter-comment).

### Preconfigured Configuration / Competitive Programming

*   [TheItcor/MoaiVim (⭐1)](https://github.com/TheItcor/MoaiVim) - A minimalist config that emulates a lightweight IDE.
...
*   [wsdjeg/ctags.nvim (⭐6)](https://github.com/wsdjeg/ctags.nvim) - Generate tags files and update tags option automatically.

## [Nov 15, 2025](/content/2025/11/15/README.md)

### Git / GitHub

*   [claydugo/browsher.nvim (⭐12)](https://github.com/claydugo/browsher.nvim) - Create commit pinned links to GitHub hosted files/lines.

### Preconfigured Configuration / Competitive Programming

*   [crivotz/nv-ide (⭐639)](https://github.com/crivotz/nv-ide) - Neovim custom configuration, oriented for full stack developers (Rails, Ruby, PHP, HTML, CSS, SCSS, JavaScript).

## [Nov 14, 2025](/content/2025/11/14/README.md)

### Syntax / Assembly

*   [MeanderingProgrammer/treesitter-modules.nvim (⭐72)](https://github.com/MeanderingProgrammer/treesitter-modules.nvim) - Original modules from nvim-treesitter master branch.
...
*   [EvWilson/slimux.nvim (⭐29)](https://github.com/EvWilson/slimux.nvim) - Send content from the current buffer to a configurable tmux pane.
...
*   [saghen/blink.cmp (⭐5.6k)](https://github.com/saghen/blink.cmp) - Really fast completion with LSP & snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
    *   [saghen/blink.compat (⭐206)](https://github.com/saghen/blink.compat) - Compatibility layer for using `nvim-cmp` sources on `blink.cmp`.
    *   [Kaiser-Yang/blink-cmp-git (⭐78)](https://github.com/Kaiser-Yang/blink-cmp-git) - `blink.cmp` source for Git.
    ...
    *   [mikavilpas/blink-ripgrep.nvim (⭐99)](https://github.com/mikavilpas/blink-ripgrep.nvim) - `blink.cmp` source for `ripgrep` / `git grep`.
    *   [bydlw98/blink-cmp-env (⭐16)](https://github.com/bydlw98/blink-cmp-env) - `blink.cmp` source for environment variables.
...
*   [saghen/filler-begone.nvim (⭐18)](https://github.com/saghen/filler-begone.nvim) - Prevents scrolling past the bottom of the buffer and showing unnecessary filler lines.

### Formatting / Indent

*   [saghen/blink.indent (⭐139)](https://github.com/saghen/blink.indent) - Performant indent guides with scope on every keystroke.
...
*   [gbprod/phpactor.nvim (⭐90)](https://github.com/gbprod/phpactor.nvim) - Lua version of [phpactor (⭐1.8k)](https://github.com/phpactor/phpactor).
...
*   [sakhnik/nvim-gdb (⭐765)](https://github.com/sakhnik/nvim-gdb) - Thin wrapper for GDB, LLDB, PDB/PDB++ and BashDB.
...
*   [ymich9963/mdnotes.nvim (⭐2)](https://github.com/ymich9963/mdnotes.nvim) - Simple and improved Markdown note taking.
...
*   [bassamsdata/namu.nvim (⭐381)](https://github.com/bassamsdata/namu.nvim) - Flexible and sleek fuzzy picker, LSP symbol navigator, and more.

## [Nov 04, 2025](/content/2025/11/04/README.md)

### Plugin Manager

*   [piersolenski/plugin-addict.nvim (⭐9)](https://github.com/piersolenski/plugin-addict.nvim) - A stupidly simple way to quickly install plugins.

### LSP

*   [yarospace/dev-tools.nvim (⭐72)](https://github.com/yarospace/dev-tools.nvim) - In-process LSP server for custom code actions, enhanced actions picker, community actions library and a convenient interface to create your own actions.

### LSP / Diagnostics

*   [piersolenski/wtf.nvim (⭐559)](https://github.com/piersolenski/wtf.nvim) - AI powered diagnostic debugging, helps explain complex errors and offers custom tailored solutions.
...
*   [piersolenski/brewfile.nvim (⭐17)](https://github.com/piersolenski/brewfile.nvim) - Manage your [Homebrew](https://brew.sh/) [Brewfile](https://docs.brew.sh/Brew-Bundle-and-Brewfile).
...
*   [nxhung2304/lastplace.nvim (⭐20)](https://github.com/nxhung2304/lastplace.nvim) - Intelligently restore your cursor position when reopening files.
...
*   [simaxme/java.nvim (⭐29)](https://github.com/simaxme/java.nvim) - Some utilities regarding Java development (e.g. updating symbol usages when renaming or moving a file in `nvim-tree`).
...
*   [josephburgess/nvumi (⭐52)](https://github.com/josephburgess/nvumi) - Natural language calculator in a scratch buffer.
...
*   [XXiaoA/atone.nvim (⭐105)](https://github.com/XXiaoA/atone.nvim) - Undo tree for visualizing and managing undo history.
...
*   [EthanJWright/vs-tasks.nvim (⭐205)](https://github.com/EthanJWright/vs-tasks.nvim) - Run and manage project jobs, supporting VSCode's `tasks.json` spec.
...
*   [stephansama/fzf-nerdfont.nvim (⭐7)](https://github.com/stephansama/fzf-nerdfont.nvim) - A picker for selecting Nerd Font icons using `fzf-lua`.
...
*   [BirdeeHub/lze (⭐86)](https://github.com/BirdeeHub/lze) - A lazy-loading library for Neovim plugins.
*   [lumen-oss/lz.n (⭐226)](https://github.com/lumen-oss/lz.n) - A simple lazy loading library for Neovim plugins.
...
*   [wsdjeg/scrollbar.nvim (⭐20)](https://github.com/wsdjeg/scrollbar.nvim) - Floating scrollbar.

## [Oct 23, 2025](/content/2025/10/23/README.md)

### Programming Languages Support / Web Development

*   [Kenzo-Wada/boundary.nvim (⭐23)](https://github.com/Kenzo-Wada/boundary.nvim) - Display `'use client'` markers inline in your JSX code to visualize client component boundaries.
...
*   [ahkohd/buffer-sticks.nvim (⭐60)](https://github.com/ahkohd/buffer-sticks.nvim) - Cosmetic buffers indicator & picker.
...
*   [leblocks/hopcsharp.nvim (⭐9)](https://github.com/leblocks/hopcsharp.nvim) - Provides LSP-less navigation and type-hierarchy information in C# repositories.

### Colorscheme / Tree-sitter Supported Colorscheme

*   [kuri-sun/yoda.nvim (⭐7)](https://github.com/kuri-sun/yoda.nvim) - Muted green palette for focused, balanced editing.

## [Oct 19, 2025](/content/2025/10/19/README.md)

### Marks / Assembly

*   [ThePrimeagen/harpoon (⭐8.7k)](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) - A per project, auto updating and editable marks utility for fast file navigation.

### Fuzzy Finder / Assembly

*   [dmtrKovalenko/fff.nvim (⭐956)](https://github.com/dmtrKovalenko/fff.nvim) - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, git status bonuses and much more.
...
*   [svermeulen/text-to-colorscheme (⭐316)](https://github.com/svermeulen/text-to-colorscheme) - Dynamically generated colorschemes generated on the fly with a text prompt using ChatGPT.

### Utility / Cursorline

*   [chrisgrieser/nvim-early-retirement (⭐235)](https://github.com/chrisgrieser/nvim-early-retirement) - Send buffers into early retirement by automatically closing them after x minutes of inactivity.
*   [axkirillov/hbac.nvim (⭐218)](https://github.com/axkirillov/hbac.nvim) - Automatically close buffers you are not working on.
...
*   [nvim-neotest/neotest-jest (⭐143)](https://github.com/nvim-neotest/neotest-jest) - Neotest adapter for running jest tests.
...
*   [aileot/nvim-thyme (⭐28)](https://github.com/aileot/nvim-thyme) - Zero-overhead Fennel JIT compiler with safety rollbacks and [parinfer-rust (⭐596)](https://github.com/eraserhd/parinfer-rust) integration.

### Remote Development / Indent

*   [azratul/live-share.nvim (⭐230)](https://github.com/azratul/live-share.nvim) - Provides remote collaboration capabilities from anywhere, making it ideal for pair-programming scenarios.
...
*   [altermo/vim-plugin-list (⭐140)](https://github.com/altermo/vim-plugin-list) - List of Vim and Neovim plugins.

### Resource / OS-specific

*   [Weyaaron/nvim-training (⭐104)](https://github.com/Weyaaron/nvim-training) - A beginner-friendly tool for training your 'muscle memory' using small, repeatable tasks.
...
*   [Flemma-Dev/flemma.nvim (⭐38)](https://github.com/Flemma-Dev/flemma.nvim) - Flemma turns Neovim into a first-class AI workspace.

### Preconfigured Configuration / Competitive Programming

*   [nvim-mini/MiniMax (⭐194)](https://github.com/nvim-mini/MiniMax) - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
...
*   [apdot/doodle (⭐74)](https://github.com/apdot/doodle) - A developer-centric knowledge base with project/branch scoped notes, bi-directional linking, note-tagging, graph-view, telescope integration, and Git synchronization.
...
*   [nvim-telescope/telescope-media-files.nvim (⭐519)](https://github.com/nvim-telescope/telescope-media-files.nvim) - Preview images, pdf, epub, video, and fonts using Telescope.
*   [wsdjeg/picker.nvim (⭐9)](https://github.com/wsdjeg/picker.nvim) - Simple fuzzy finder, including files, ctags outline, and more.

### Git / Quickfix

*   [yus-works/csc.nvim (⭐35)](https://github.com/yus-works/csc.nvim) - Conventional commit scope completion that learns from git history.
...
*   [yelog/i18n.nvim (⭐45)](https://github.com/yelog/i18n.nvim) - Internationalization (i18n) management with LSP support for `Vue`, `React`, `Java` and more.

### Code Runner / Quickfix

*   [ok97465/ipybridge.nvim (⭐6)](https://github.com/ok97465/ipybridge.nvim) - Run Python code, execute Jupyter cells, debug, and explore variables.

## [Oct 08, 2025](/content/2025/10/08/README.md)

### Plugin Manager

*   [alyxshang/nuwa.nvim (⭐6)](https://github.com/alyxshang/nuwa.nvim) - A light Neovim package manager.

### AI / Diagnostics

*   [3ZsForInsomnia/vs-code-companion (⭐5)](https://github.com/3ZsForInsomnia/vs-code-companion) - Tool for importing VS Code's Markdown prompts into CodeCompanion.
...
*   [sontungexpt/witch-line (⭐51)](https://github.com/sontungexpt/witch-line) - A blazing fast statusline based on reference concept.

## [Oct 04, 2025](/content/2025/10/04/README.md)

### File Explorer / Assembly

*   [A7Lavinraj/fyler.nvim (⭐540)](https://github.com/A7Lavinraj/fyler.nvim) - File manager which can edit file system like a buffer with tree view.
...
*   [uhs-robert/oasis.nvim (⭐13)](https://github.com/uhs-robert/oasis.nvim) - Desert theme from Vim ported to Neovim and made modern with 12 variants, a collection of dark themes for every color of the rainbow.
...
*   [ravsii/timers.nvim (⭐12)](https://github.com/ravsii/timers.nvim) - Timer manager, a clean Lua API, supporting multiple timers, persistence, UI, and plugin integrations.

### Neovim Lua Development / Quickfix

*   [DrKJeff16/wezterm-types (⭐123)](https://github.com/DrKJeff16/wezterm-types) - WezTerm config type annotations for Lua Language Server.
...
*   [DrKJeff16/project.nvim (⭐90)](https://github.com/DrKJeff16/project.nvim) - An actively maintained fork of [`ahmedkhalf/project.nvim`](https://github.com/ahmedkhalf/project.nvim) with documented code, `fzf-lua` support and new features.
...
*   [happyeric77/joplin.nvim (⭐4)](https://github.com/happyeric77/joplin.nvim) - Joplin notes utilities: tree browser, search, open, and Telescope integration.

## [Sep 01, 2025](/content/2025/09/01/README.md)

### Marks / Assembly

*   [walkersumida/fusen.nvim (⭐24)](https://github.com/walkersumida/fusen.nvim) - Sticky note bookmarks, per Git branch with hover annotations and Telescope integration.

## [Aug 29, 2025](/content/2025/08/29/README.md)

### Plugin Manager

*   [alex-popov-tech/store.nvim (⭐299)](https://github.com/alex-popov-tech/store.nvim) - Plugins discovery tool with hourly updated database, and one-key installation for `lazy.nvim` and `vim.pack`.
*   [nvim-mini/mini.nvim#mini.deps (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.

### Completion / Diagnostics

*   [nvim-mini/mini.nvim#mini.completion (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.

### Syntax / Assembly

*   [nvim-mini/mini.nvim#mini.surround (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.

### Snippet / Assembly

*   [nvim-mini/mini.nvim#mini.snippets (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.

### Fuzzy Finder / Assembly

*   [nvim-mini/mini.nvim#mini.fuzzy (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
*   [nvim-mini/mini.nvim#mini.pick (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
*   [nvim-mini/mini.nvim#mini.extra (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.

### File Explorer / Assembly

*   [nvim-mini/mini.nvim#mini.files (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.

### Project / Assembly

*   [nvim-mini/mini.nvim#mini.visits (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.

### Color / Assembly

*   [nvim-mini/mini.nvim#mini.hipatterns (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.

### Colorscheme / Tree-sitter Supported Colorscheme

*   [nvim-mini/mini.nvim#colorschemes (⭐8.3k)](https://github.com/nvim-mini/mini.nvim#plugin-colorschemes) - Color schemes included in `mini.nvim` plugin. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.

### Colorscheme / Colorscheme Creation

*   [nvim-mini/mini.nvim#mini.base16 (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
*   [nvim-mini/mini.nvim#mini.colors (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
*   [nvim-mini/mini.nvim#mini.hues (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.

### Bars and Lines / Statusline

*   [nvim-mini/mini.nvim#mini.statusline (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.

### Bars and Lines / Tabline

*   [nvim-mini/mini.nvim#mini.tabline (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.

### Bars and Lines / Cursorline

*   [nvim-mini/mini.nvim#mini.cursorword (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).

### Startup / Cursorline

*   [nvim-mini/mini.nvim#mini.starter (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.

### Icon / Cursorline

*   [nvim-mini/mini.nvim#mini.icons (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-icons.md) - Module of `mini.nvim` meant as a general icon provider. Uses fixed set of highlight groups. Supports various categories, icon and style customizations, caching for performance. Integrates with built-in filetype matching.

### Utility / Cursorline

*   [nvim-mini/mini.nvim#mini.notify (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.

### Animation / CSV Files

*   [nvim-mini/mini.nvim#mini.animate (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).

### Neovim Lua Development / Quickfix

*   [nvim-mini/mini.nvim#mini.doc (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
*   [nvim-mini/mini.nvim#mini.test (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) - Module of `mini.nvim` with framework for writing extensive Neovim plugin tests. Supports hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.

### Git / Quickfix

*   [nvim-mini/mini.nvim#mini.diff (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
*   [nvim-mini/mini.nvim#mini.git (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) - Module of `mini.nvim` for enhanced Git integration with current Neovim process. Implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.

### Motion / GitLab

*   [nvim-mini/mini.nvim#mini.jump (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) - Module of `mini.nvim` for smarter jumping to a single character.
*   [nvim-mini/mini.nvim#mini.jump2d (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
*   [nvim-mini/mini.nvim#mini.bracketed (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) - Module of `mini.nvim` to go forward/backward with square brackets.

### Keybinding / Tree-sitter Based

*   [nvim-mini/mini.nvim#mini.clue (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
*   [nvim-mini/mini.nvim#mini.keymap (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).

### Scrolling / Scrollbar

*   [nvim-mini/mini.nvim#mini.map (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.

### Editing Support / Scrollbar

*   [nvim-mini/mini.nvim#mini.pairs (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
*   [nvim-mini/mini.nvim#mini.trailspace (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
*   [nvim-mini/mini.nvim#mini.operators (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
*   [nvim-mini/mini.nvim#mini.move (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
*   [nvim-mini/mini.nvim#mini.ai (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some builtin textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
*   [nvim-mini/mini.nvim#mini.splitjoin (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
*   [nvim-mini/mini.nvim#mini.basics (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.

### Editing Support / Comment

*   [nvim-mini/mini.nvim#mini.comment (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.

### Formatting / Comment

*   [nvim-mini/mini.nvim#mini.align (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) - Module of `mini.nvim` for aligning text interactively (with or without instant preview).

### Formatting / Indent

*   [nvim-mini/mini.nvim#mini.indentscope (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.

### Session / Indent

*   [nvim-mini/mini.nvim#mini.sessions (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) - Module of `mini.nvim` for session management (read, write, delete).

### Split and Window / Indent

*   [nvim-mini/mini.nvim#mini.bufremove (⭐8.3k)](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.

### Workflow / Competitive Programming

*   [saxon1964/neovim-tips (⭐374)](https://github.com/saxon1964/neovim-tips) - Provides hundreds of built-in Neovim tips, tricks, and shortcuts, with a custom picker interface and the ability to add your own tips.

## [Aug 25, 2025](/content/2025/08/25/README.md)

### Media / Cursorline

*   [iamt4nk/smm.nvim (⭐28)](https://github.com/iamt4nk/smm.nvim) - Small TUI that allows for controlling Spotify playback.

## [Aug 23, 2025](/content/2025/08/23/README.md)

### Utility / Cursorline

*   [Owen-Dechow/videre.nvim (⭐128)](https://github.com/Owen-Dechow/videre.nvim) - Explore JSON, YAML, and TOML files as nested unit/node-based graphical representations.

## [Aug 22, 2025](/content/2025/08/22/README.md)

### Note Taking / Cursorline

*   [jameswolensky/marker-groups.nvim (⭐48)](https://github.com/jameswolensky/marker-groups.nvim) - Take persistent code notes without modifying code.
...
*   [atomicptr/defold.nvim (⭐13)](https://github.com/atomicptr/defold.nvim) - Batteries-included development environment for the Defold game engine.
...
*   [ingur/floatty.nvim (⭐19)](https://github.com/ingur/floatty.nvim) - A tiny (<200 LOC) but highly customizable floating terminal manager.
...
*   [LuxVim/nvim-luxmotion (⭐33)](https://github.com/LuxVim/nvim-luxmotion) - Smooth, high‑performance motion & scrolling animations — 60fps fluid cursor moves, word jumps, and viewport scrolling, all in one.

## [Aug 09, 2025](/content/2025/08/09/README.md)

### Remote Development / Indent

*   [uhs-robert/sshfs.nvim (⭐13)](https://github.com/uhs-robert/sshfs.nvim) - Mount remote systems via SSHFS with smart picker auto-detect (Telescope/Oil/Snacks/Neo-tree/fzf-lua/Yazi/Ranger etc.).

## [Aug 06, 2025](/content/2025/08/06/README.md)

### Syntax / Assembly

*   [fei6409/log-highlight.nvim (⭐132)](https://github.com/fei6409/log-highlight.nvim) - Generic log syntax highlighting and log filetype management support.
...
*   [brianhuster/live-preview.nvim (⭐254)](https://github.com/brianhuster/live-preview.nvim) - Live preview HTML, Markdown and Asciidoc in the browser.

## [Aug 02, 2025](/content/2025/08/02/README.md)

### File Explorer / Assembly

*   [X3eRo0/dired.nvim (⭐166)](https://github.com/X3eRo0/dired.nvim) - A file browser inspired by Emacs Dired.

### Remote Development / Indent

*   [inhesrom/remote-ssh.nvim (⭐62)](https://github.com/inhesrom/remote-ssh.nvim) - Duplicates the basic ground level functionality of VSCode's Remote-SSH plugin, with a focus on a local editing experience to avoid remote "lag". Browse remote files, edit "remote buffers" with a full local editing experience (LSP, Tree-sitter, Telescope integration, and a file watcher).

## [Jul 30, 2025](/content/2025/07/30/README.md)

### Split and Window / Tmux

*   [jkeresman01/tmux-switch.nvim (⭐3)](https://github.com/jkeresman01/tmux-switch.nvim) - Provides fuzzy session switching for Tmux.
...
*   [waiting-for-dev/ergoterm.nvim (⭐51)](https://github.com/waiting-for-dev/ergoterm.nvim) - Seamless terminal workflow integration with smart picker-based terminal selection, flexible text sending and persistent configuration.

### External / Boilerplate

*   [jkeresman01/spring-initializr.nvim (⭐12)](https://github.com/jkeresman01/spring-initializr.nvim) - Scaffold Spring Boot projects with a Telescope-powered UI.

## [Jul 15, 2025](/content/2025/07/15/README.md)

### Dependency Management / Quickfix

*   [piersolenski/import.nvim (⭐260)](https://github.com/piersolenski/import.nvim) - Import modules faster based on what you've already imported in your project.
...
*   [echaya/neowiki.nvim (⭐108)](https://github.com/echaya/neowiki.nvim) - The modern vimwiki successor offering a minimal, intuitive workflow out of the box for note-taking and Getting Things Done (GTD).

### Git / GitLab

*   [harrisoncramer/GitLab.nvim (⭐339)](https://github.com/harrisoncramer/GitLab.nvim) - Review pull requests and manage other GitLab resources.

### Keybinding / Tree-sitter Based

*   [sontungexpt/bim.nvim (⭐8)](https://github.com/sontungexpt/bim.nvim) - Enhances insert mode key mapping by showing typed keys in real time, without waiting for timeoutlen. It provides a responsive and intuitive insert-mode experience, ideal for complex input workflows like ime.
...
*   [brenton-leighton/multiple-cursors.nvim (⭐370)](https://github.com/brenton-leighton/multiple-cursors.nvim) - A multi-cursor plugin that works in normal, insert/replace, or visual modes, and with almost every command.
*   [smoka7/multicursors.nvim (⭐627)](https://github.com/smoka7/multicursors.nvim) - Provides a more intuitive way to edit repetitive text with multiple selections.
...
*   [folke/snacks.nvim#picker (⭐6.5k)](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) - Modern fuzzy-finder to navigate the Neovim universe.
...
*   [SunnyTamang/select-undo.nvim (⭐89)](https://github.com/SunnyTamang/select-undo.nvim) - Allow users to undo specific line/lines or partial selections without affecting the rest of the file.

## [Jun 20, 2025](/content/2025/06/20/README.md)

### File Explorer / Assembly

*   [vodchella/hodur.nvim (⭐19)](https://github.com/vodchella/hodur.nvim) - Allows you to quickly open a file or copy URL located under cursor.

## [Jun 18, 2025](/content/2025/06/18/README.md)

### Git / Quickfix

*   [axkirillov/unified.nvim (⭐113)](https://github.com/axkirillov/unified.nvim) - Displaying inline unified diffs directly in your buffer.

## [Jun 17, 2025](/content/2025/06/17/README.md)

### LSP

*   [romus204/referencer.nvim (⭐22)](https://github.com/romus204/referencer.nvim) - Lightweight, asynchronous that uses the LSP to show references to functions, methods, types and other.
...
*   [azorng/goose.nvim (⭐285)](https://github.com/azorng/goose.nvim) - Seamless Neovim integration with [goose](https://block.github.io/goose) - work with a powerful AI agent without leaving your editor.
*   [mozanunal/sllm.nvim (⭐90)](https://github.com/mozanunal/sllm.nvim) - In-editor chat powered by Simon Willison's LLM CLI: stream replies in a Markdown buffer, manage rich context (files, URLs, selections, diagnostics, shell outputs), switch models interactively, and even see token-usage stats.

### Programming Languages Support / Diagnostics

*   [apyra/nvim-unity.nvim (⭐72)](https://github.com/apyra/nvim-unity) - Use Neovim as your default Unity editor with full LSP support via OmniSharp.
...
*   [TheLeoP/powershell.nvim (⭐71)](https://github.com/TheLeoP/powershell.nvim) - First class powershell editor integration. Includes LSP, debugging (requires nvim-dap) and $psEditor API support.

### Colorscheme / Tree-sitter Supported Colorscheme

*   [datsfilipe/min-theme.nvim (⭐53)](https://github.com/datsfilipe/min-theme.nvim) - It's a port of Min, a minimal theme for VSCode, written in Lua.
*   [github-main-user/lytmode.nvim (⭐17)](https://github.com/github-main-user/lytmode.nvim) - A unique in-between theme inspired by LYT-Mode for Obsidian. Not quite dark, not quite light — just right.
...
*   [attilarepka/header.nvim (⭐30)](https://github.com/attilarepka/header.nvim) - Add or update copyright and license headers in any source file.

### Terminal Integration / CSV Files

*   [benoror/gpg.nvim (⭐16)](https://github.com/benoror/gpg.nvim) - Edit GPG encrypted files symmetrically.
...
*   [Kohei-Wada/yadm-git.nvim (⭐5)](https://github.com/Kohei-Wada/yadm-git.nvim) - Seamless Git plugin support for yadm dotfiles.

### Motion / GitLab

*   [HawkinsT/pathfinder.nvim (⭐55)](https://github.com/HawkinsT/pathfinder.nvim) - Enhances gf/gF/gx with look-ahead and smarter file, line/column number, and link resolution. Also provides visual targets for files/links, new motion commands, and link description retrieval.
...
*   [seandewar/actually-doom.nvim (⭐119)](https://github.com/seandewar/actually-doom.nvim) - Editing text is boring; play DOOM instead!.

## [May 16, 2025](/content/2025/05/16/README.md)

### Colorscheme / Tree-sitter Supported Colorscheme

*   [datsfilipe/vesper.nvim (⭐185)](https://github.com/datsfilipe/vesper.nvim) - It's a port of the popular VS Code theme Vesper, written in Lua.
*   [ntk148v/slack.nvim (⭐5)](https://github.com/ntk148v/slack.nvim) - A ported Slack colorscheme.

### Media / Cursorline

*   [pandasoli/nekovim (⭐34)](https://github.com/pandasoli/nekovim) - Flexible Discord rich presence.

### Note Taking / Cursorline

*   [bngarren/checkmate.nvim (⭐323)](https://github.com/bngarren/checkmate.nvim) - A full-featured Markdown-based todo plugin.

### Utility / Cursorline

*   [athar-qadri/weather.nvim (⭐12)](https://github.com/athar-qadri/weather.nvim) - Realtime Weather and Earthquake alerts with support for lualine integration (no api key required).
...
*   [TheLazyCat00/simple-format (⭐3)](https://github.com/TheLazyCat00/simple-format) - Replace text using custom regex and highlight group rules.

## [Apr 28, 2025](/content/2025/04/28/README.md)

### AI / Diagnostics

*   [julwrites/llm-nvim (⭐7)](https://github.com/julwrites/llm-nvim) - Comprehensive integration with the [LLM (⭐10k)](https://github.com/simonw/llm) tool.

### Utility / Cursorline

*   [y3owk1n/time-machine.nvim (⭐63)](https://github.com/y3owk1n/time-machine.nvim) - Take control of your edit history with an interactive timeline, diff previews, taggings, live reloading trees and cleanup functions.
*   [OXY2DEV/ui.nvim (⭐149)](https://github.com/OXY2DEV/ui.nvim) - A blueprint/template/guide for customizing the UI.
...
*   [GeorgesAlkhouri/nvim-aider (⭐358)](https://github.com/GeorgesAlkhouri/nvim-aider) - Seamlessly integrate Aider for an AI-assisted coding experience.

### Programming Languages Support / Golang

*   [fredrikaverpil/godoc.nvim (⭐167)](https://github.com/fredrikaverpil/godoc.nvim) - Fuzzy search Go packages/symbols and view docs.
...
*   [y3owk1n/dotmd.nvim (⭐20)](https://github.com/y3owk1n/dotmd.nvim) - Managing notes, TODO's, journal entries, and your inbox, all with Markdown.

## [Apr 09, 2025](/content/2025/04/09/README.md)

### LSP

*   [Fildo7525/pretty\_hover (⭐233)](https://github.com/Fildo7525/pretty_hover) - Highly customizable hover formatter, extendable to blink.cmp. As native hover supports multiple LSP servers.
...
*   [obsidian-nvim/obsidian.nvim (⭐1.2k)](https://github.com/obsidian-nvim/obsidian.nvim) - Plugin for Obsidian, written in Lua.
...
*   [BibekBhusal0/nvim-shadcn (⭐9)](https://github.com/BibekBhusal0/nvim-shadcn) - Easily add Shadcn UI components with telescope.

### Search / Assembly

*   [prochri/telescope-all-recent.nvim (⭐147)](https://github.com/prochri/telescope-all-recent.nvim) - Frequency and recency sorter for any Telescope picker.

### Utility / Cursorline

*   [BibekBhusal0/bufstack.nvim (⭐3)](https://github.com/BibekBhusal0/bufstack.nvim) - Track recently visited buffers and reopen recently closed buffers.
...
*   [mohseenrm/marko.nvim (⭐10)](https://github.com/mohseenrm/marko.nvim) - Behind the scenes, global marks management for different projects.

## [Mar 23, 2025](/content/2025/03/23/README.md)

### Programming Languages Support / Diagnostics

*   [kiyoon/python-import.nvim (⭐55)](https://github.com/kiyoon/python-import.nvim) - Add Python import statements with Tree-sitter, LSP, and more.
...
*   [y3owk1n/undo-glow.nvim (⭐65)](https://github.com/y3owk1n/undo-glow.nvim/) - Animated glow/highlight effects for Neovim operations (undo, redo, yank, paste, etc.) with fully customizable animations and appearance.

### Editing Support / Scrollbar

*   [zhisme/copy\_with\_context.nvim (⭐18)](https://github.com/zhisme/copy_with_context.nvim) - Copy lines with file path and line number metadata for sharing code snippets with context.
...
*   [OXY2DEV/bars.nvim (⭐90)](https://github.com/OXY2DEV/bars.nvim) - A starting point/guide for creating custom statusline, statuscolumn, tabline & winbar.

### Utility / Cursorline

*   [kiyoon/jupynium.nvim (⭐703)](https://github.com/kiyoon/jupynium.nvim) - Selenium-automated Jupyter Notebook that is synchronised with Neovim in real-time.

### Motion / Tree-sitter Based

*   [kiyoon/treesitter-indent-object.nvim (⭐66)](https://github.com/kiyoon/treesitter-indent-object.nvim) - Context-aware indent textobject powered by Tree-sitter.
...
*   [kiyoon/tmux-send.nvim (⭐14)](https://github.com/kiyoon/tmux-send.nvim) - Copy and paste buffer content or file path in Nvim-Tree, Neo-Tree, Oil to another tmux pane in Neovim.

## [Mar 10, 2025](/content/2025/03/10/README.md)

### Utility / Cursorline

*   [ovk/endec.nvim (⭐31)](https://github.com/ovk/endec.nvim) - Encode, decode and re-encode text using Base64, Base64URL and URL (percent) encodings.

### External / Version Manager

*   [y3owk1n/nvs (⭐26)](https://github.com/y3owk1n/nvs) - Another Neovim version manager with config switcher.
...
*   [wsdjeg/nvim-plug (⭐21)](https://github.com/wsdjeg/nvim-plug) - Asynchronous Neovim plugin manager written in Lua.
...
*   [wsdjeg/rooter.nvim (⭐16)](https://github.com/wsdjeg/rooter.nvim) - Change working directory to project root.
...
*   [francescarpi/buffon.nvim (⭐28)](https://github.com/francescarpi/buffon.nvim) - Buffers navigation, reorganize and close.

## [Feb 23, 2025](/content/2025/02/23/README.md)

### Colorscheme / Tree-sitter Supported Colorscheme

*   [thesimonho/kanagawa-paper.nvim (⭐326)](https://github.com/thesimonho/kanagawa-paper.nvim) - Remixed light and dark Kanagawa colourschemes with muted colors.
...
*   [rachartier/tiny-glimmer.nvim (⭐383)](https://github.com/rachartier/tiny-glimmer.nvim/) - Adds subtle animations to various operations.
...
*   [Thiago4532/mdmath.nvim (⭐188)](https://github.com/Thiago4532/mdmath.nvim) - A Markdown equation previewer, using Kitty Graphics Protocol.

### Colorscheme / Tree-sitter Supported Colorscheme

*   [neko-night/nvim (⭐56)](https://github.com/neko-night/nvim) - A buffet of colorschemes for every taste and mood.

## [Feb 04, 2025](/content/2025/02/04/README.md)

### Search / Assembly

*   [wsdjeg/flygrep.nvim (⭐13)](https://github.com/wsdjeg/flygrep.nvim) - Search text in a floating window asynchronously.

## [Feb 03, 2025](/content/2025/02/03/README.md)

### Media / Cursorline

*   [vyfor/cord.nvim (⭐504)](https://github.com/vyfor/cord.nvim) - Highly extensible Rich Presence for Discord.

## [Jan 31, 2025](/content/2025/01/31/README.md)

### AI / Diagnostics

*   [Davidyz/VectorCode (⭐720)](https://github.com/davidyz/vectorcode) - Supercharge your LLM experience with repository-level RAG.
*   [dlants/magenta.nvim (⭐410)](https://github.com/dlants/magenta.nvim) - Leverage coding assistants for chat and code generation. Provides tools for the AI/LLM agent to explore and edit your code, like Aider, Cursor and Windsurf.
...
*   [igorlfs/nvim-dap-view (⭐534)](https://github.com/igorlfs/nvim-dap-view) - A modern, minimalistic UI for nvim-dap.

## [Jan 22, 2025](/content/2025/01/22/README.md)

### Utility / Cursorline

*   [mluders/comfy-line-numbers.nvim (⭐101)](https://github.com/mluders/comfy-line-numbers.nvim) - Limits relative numbers to only show left-hand digits on the keyboard.
...
*   [ya2s/nvim-cursorline (⭐447)](https://github.com/ya2s/nvim-cursorline) - A plugin that highlights cursor words and lines.
...
*   [laktak/tome (⭐137)](https://github.com/laktak/tome) - Interactive Script playbooks for your terminal (optionally with Tmux).

## [Jan 16, 2025](/content/2025/01/16/README.md)

### Search / Assembly

*   [wurli/visimatch.nvim (⭐67)](https://github.com/wurli/visimatch.nvim) - Adds highlights to any text matching the current selection in visual mode.
...
*   [mawkler/hml.nvim (⭐30)](https://github.com/mawkler/hml.nvim) - Adds `H`/`M`/`L` indicators to your line numbers.

## [Jan 13, 2025](/content/2025/01/13/README.md)

### Utility / Cursorline

*   [philosofonusus/ecolog.nvim (⭐162)](https://github.com/philosofonusus/ecolog.nvim) - Sophisticated all-in-one toolkit to work with `.env` files and environment variables.
...
*   [folke/persistence.nvim (⭐910)](https://github.com/folke/persistence.nvim) - Simple automated session management.

## [Jan 02, 2025](/content/2025/01/02/README.md)

### Marks / Assembly

*   [zongben/navimark.nvim (⭐19)](https://github.com/zongben/navimark.nvim) - An easy and powerful bookmark manager with telescope.

### Color / Assembly

*   [catgoose/nvim-colorizer.lua (⭐960)](https://github.com/catgoose/nvim-colorizer.lua) - A high-performance color highlighter which has no external dependencies.
...
*   [milanglacier/yarepl.nvim#aider-extensions (⭐236)](https://github.com/milanglacier/yarepl.nvim/blob/main/extensions/README.md) - Integration with [aider-chat](https://aider.chat), a TUI AI coding assistant.

### Utility / Cursorline

*   [MisanthropicBit/decipher.nvim (⭐42)](https://github.com/MisanthropicBit/decipher.nvim) - Encode and decode text using various codecs such as base64.
...
*   [sphamba/smear-cursor.nvim (⭐1.4k)](https://github.com/sphamba/smear-cursor.nvim) - Animate the cursor with a smear effect in all terminals. Inspired by Neovide's animated cursor.

## [Dec 12, 2024](/content/2024/12/12/README.md)

### Motion / GitLab

*   [Aaronik/Treewalker.nvim (⭐567)](https://github.com/aaronik/Treewalker.nvim) - Move seamlessly around the abstract syntax tree.

### Game / Tmux

*   [csessh/aoc.vim (⭐5)](https://github.com/csessh/aoc.nvim) - Simple little elf who fetches Advent of Code puzzle input for you.
...
*   [trevorhauter/gitportal.nvim (⭐82)](https://github.com/trevorhauter/gitportal.nvim) - Generate Git permalinks, open them in your browser, load files locally from permalinks, and more.
...
*   [gregorias/coop.nvim (⭐139)](https://github.com/gregorias/coop.nvim) - Structured concurrency with Lua coroutines.
...
*   [TaDaa/vimade (⭐634)](https://github.com/TaDaa/vimade) - Dim, fade, tint, animate, and customize colors in your windows and buffers.
...
*   [2KAbhishek/octohub.nvim (⭐77)](https://github.com/2KAbhishek/octohub.nvim) - Access all your gihub repos, stats and more in simple keystrokes.

### Game / Competitive Programming

*   [2KAbhishek/exercism.nvim (⭐33)](https://github.com/2KAbhishek/exercism.nvim) - Browse and solve Exercism problems.
...
*   [topaxi/pipeline.nvim (⭐175)](https://github.com/topaxi/pipeline.nvim) - View and dispatch GitHub Actions workflow and GitLab CI pipeline runs.

## [Nov 19, 2024](/content/2024/11/19/README.md)

### Programming Languages Support / Web Development

*   [lima1909/resty.nvim (⭐49)](https://github.com/lima1909/resty.nvim) - Fast and easy-to-use HTTP-Rest-Client.

### Code Runner / Quickfix

*   [chrisgrieser/nvim-justice (⭐33)](https://github.com/chrisgrieser/nvim-justice) - Lightweight integration of the `just` task runner.

## [Nov 17, 2024](/content/2024/11/17/README.md)

### LSP

*   [esmuellert/nvim-eslint (⭐64)](https://github.com/esmuellert/nvim-eslint) - Bundle VSCode ESLint language server and utilize the native LSP client to provide a all-in-one ESLint experience.
...
*   [crispgm/telescope-heading.nvim (⭐137)](https://github.com/crispgm/telescope-heading.nvim) - Telescope extension to switch between headings of AsciiDoc, Markdown, Vimdoc, etc.
...
*   [sschleemilch/slimline.nvim (⭐117)](https://github.com/sschleemilch/slimline.nvim) - A slim, minimal and opinionated Lua statusline.

### Startup / Cursorline

*   [max397574/startup.nvim (⭐491)](https://github.com/max397574/startup.nvim) - The fully customizable greeter for Neovim.

### Utility / CSV Files

*   [hat0uma/csvview.nvim (⭐458)](https://github.com/hat0uma/csvview.nvim) - An asynchronous CSV/TSV table viewer with real-time updates, configurable comments and delimiters, and multiple display modes.

### Neovim Lua Development / Quickfix

*   [YaroSpace/lua-console.nvim (⭐82)](https://github.com/YaroSpace/lua-console.nvim) - A handy scratch pad / REPL / debug console for Lua development and Neovim exploration and configuration.
...
*   [Snikimonkd/cmp-go-pkgs (⭐32)](https://github.com/Snikimonkd/cmp-go-pkgs) - Cmp source for Go packages names.
...
*   [EvWilson/spelunk.nvim (⭐123)](https://github.com/EvWilson/spelunk.nvim) - Create and manage bookmarks as stacks with a friendly UI.

## [Oct 16, 2024](/content/2024/10/16/README.md)

### Media / Cursorline

*   [neo451/feed.nvim (⭐182)](https://github.com/neo451/feed.nvim) - Web feed reader written in Lua (RSS, Atom, JSON feed).
...
*   [bakageddy/alduin.nvim (⭐17)](https://github.com/bakageddy/alduin.nvim) - A port of [alduin (⭐482)](https://github.com/AlessandroYorba/alduin) theme to Lua with Tree-sitter and semantic highlights support.
...
*   [adoyle-h/one.nvim (⭐172)](https://github.com/adoyle-h/one.nvim) - All-in-one config framework in Lua.
...
*   [OXY2DEV/helpview.nvim (⭐376)](https://github.com/OXY2DEV/helpview.nvim) - A hackable & fancy `vimdoc/help` file viewer.

## [Sep 02, 2024](/content/2024/09/02/README.md)

### AI / Diagnostics

*   [Kurama622/llm.nvim (⭐411)](https://github.com/Kurama622/llm.nvim) - Free large language model (LLM) support, provides commands to interact with LLM.

### Programming Languages Support / Markdown and LaTeX

*   [SCJangra/table-nvim (⭐65)](https://github.com/SCJangra/table-nvim) - A Markdown table editor that formats the table as you type.

## [Aug 30, 2024](/content/2024/08/30/README.md)

### LSP

*   [alexpasmantier/pymple.nvim (⭐136)](https://github.com/alexpasmantier/pymple.nvim) - Refactor Python imports on file move/rename.

## [Aug 29, 2024](/content/2024/08/29/README.md)

### LSP

*   [mawkler/refjump.nvim (⭐53)](https://github.com/mawkler/refjump.nvim) - Jump to next/previous LSP reference for item under cursor with `]r`/`[r`.
...
*   [ptdewey/pendulum-nvim (⭐103)](https://github.com/ptdewey/pendulum-nvim) - Track time spent coding and glean insights through on-demand time reports.
...
*   [killitar/obscure.nvim (⭐75)](https://github.com/killitar/obscure.nvim) - A pastel dark colorscheme inspired by the palette Mellow. Support Tree-sitter, LSP *(including semantic tokens)* and lots of plugins.
...
*   [OXY2DEV/foldtext.nvim (⭐109)](https://github.com/OXY2DEV/foldtext.nvim) - Dynamic & stylized foldtext.
...
*   [yetone/avante.nvim (⭐16k)](https://github.com/yetone/avante.nvim) - Chat with your code as if you are in Cursor AI IDE.
...
*   [mawkler/demicolon.nvim (⭐110)](https://github.com/mawkler/demicolon.nvim) - Use `;` and `,` keys to also repeat jumps to diagnostics (e.g. `]d`) and to [nvim-treesitter-textobjects (⭐2.6k)](https://github.com/nvim-treesitter/nvim-treesitter-textobjects?tab=readme-ov-file#text-objects-move) (e.g. `]f`), in addition to repeating `t`/`T`/`f`/`F`.
...
*   [stevearc/quicker.nvim (⭐824)](https://github.com/stevearc/quicker.nvim) - Improved quickfix UI and editable quickfix buffer.

### Preconfigured Configuration / Competitive Programming

*   [dam9000/kickstart-modular.nvim (⭐911)](https://github.com/dam9000/kickstart-modular.nvim) - This is a fork of nvim-lua/kickstart.nvim that moves from a single file to a multi file configuration.
...
*   [milanglacier/minuet-ai.nvim (⭐863)](https://github.com/milanglacier/minuet-ai.nvim) - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
...
*   [rachartier/tiny-code-action.nvim (⭐413)](https://github.com/rachartier/tiny-code-action.nvim) - Provides a simple way to run and visualize code actions with Telescope.

### Programming Languages Support / Web Development

*   [mistweaverco/kulala.nvim (⭐1.7k)](https://github.com/mistweaverco/kulala.nvim) - A minimal HTTP-client interface.

### Media / Cursorline

*   [AntonVanAssche/music-controls.nvim (⭐30)](https://github.com/AntonVanAssche/music-controls.nvim) - Quickly control your favorite music player (Spotify, VLC, and more).
...
*   [0xstepit/flow.nvim (⭐277)](https://github.com/0xstepit/flow.nvim) - Carefully designed colors to help focusing during coding plus fluorescent details. Support many plugins and tools.

## [Jul 18, 2024](/content/2024/07/18/README.md)

### AI / Diagnostics

*   [tzachar/cmp-ai (⭐263)](https://github.com/tzachar/cmp-ai) - This is a general purpose AI source for nvim-cmp, easily adapted to any REST API supporting remote code completion.
...
*   [mong8se/actually.nvim (⭐61)](https://github.com/mong8se/actually.nvim) - Load the file you actually meant to load.
...
*   [chrisgrieser/nvim-lsp-endhints (⭐212)](https://github.com/chrisgrieser/nvim-lsp-endhints) - Display LSP inlay hints at the end of the line, rather than within the line.
...
*   [rachartier/tiny-inline-diagnostic.nvim (⭐1.4k)](https://github.com/rachartier/tiny-inline-diagnostic.nvim) - Display prettier diagnostic messages. Display one line diagnostic messages where the cursor is, with icons and colors.

## [Jun 25, 2024](/content/2024/06/25/README.md)

### Search / Assembly

*   [chrisgrieser/nvim-rip-substitute (⭐286)](https://github.com/chrisgrieser/nvim-rip-substitute) - Search and replace in the current buffer with a modern UI and modern regex flavor. A substitute for Vim's `:substitute` using `ripgrep`.
...
*   [ysmb-wtsg/in-and-out.nvim (⭐82)](https://github.com/ysmb-wtsg/in-and-out.nvim) - Quick navigation in and out of surrounding characters.
...
*   [SuperBo/fugit2.nvim (⭐457)](https://github.com/SuperBo/fugit2.nvim) - Git GUI powered by [libgit2](https://libgit2.org).

## [May 31, 2024](/content/2024/05/31/README.md)

### Search / Assembly

*   [MagicDuck/grug-far.nvim (⭐1.6k)](https://github.com/MagicDuck/grug-far.nvim) - Buffer-based live search and replace with full power of `rg` flags. Grug like!
...
*   [nosduco/remote-sshfs.nvim (⭐349)](https://github.com/nosduco/remote-sshfs.nvim) - Explore, edit, and develop on a remote machine via SSHFS.

## [May 23, 2024](/content/2024/05/23/README.md)

### Colorscheme / Tree-sitter Supported Colorscheme

*   [slugbyte/lackluster.nvim (⭐493)](https://github.com/slugbyte/lackluster.nvim) - A delightful mostly grayscale colorscheme that is soft on the eyes, and supports heaps of plugins.
...
*   [CopilotC-Nvim/CopilotChat.nvim (⭐3.4k)](https://github.com/CopilotC-Nvim/CopilotChat.nvim) - A chat interface for GitHub Copilot that allows you to directly ask and receive answers to coding-related questions.
...
*   [rktjmp/playtime.nvim (⭐83)](https://github.com/rktjmp/playtime.nvim) - A collection of games such as Freecell, Shenzhen Solitaire and The Emissary.
...
*   [nvim-tree/nvim-tree.lua (⭐8.2k)](https://github.com/nvim-tree/nvim-tree.lua) - A simple and fast file explorer tree.
...
*   [comfysage/evergarden (⭐513)](https://github.com/comfysage/evergarden) - A comfy Neovim colorscheme for cozy morning coding.
*   [RRethy/base16-nvim (⭐612)](https://github.com/RRethy/base16-nvim) - Neovim plugin for building base16 colorschemes. Includes support for Tree-sitter and LSP highlight groups.
...
*   [Everblush/nvim (⭐287)](https://github.com/Everblush/nvim) - A dark, vibrant and beautiful colorscheme written in Lua.
*   [mellow-theme/mellow.nvim (⭐390)](https://github.com/mellow-theme/mellow.nvim) - A soothing dark color scheme with Tree-sitter support.
*   [maxmx03/fluoromachine.nvim (⭐286)](https://github.com/maxmx03/fluoromachine.nvim) - Synthwave x Fluoromachine port.
...
*   [Zeioth/heirline-components.nvim (⭐144)](https://github.com/Zeioth/heirline-components.nvim) - 30+ Heirline.nvim components you can use out of the box to create your perfect user interface.

### Icon / Cursorline

*   [nvim-tree/nvim-web-devicons (⭐2.5k)](https://github.com/nvim-tree/nvim-web-devicons) - A Lua fork of [vim-devicons (⭐5.8k)](https://github.com/ryanoasis/vim-devicons).

### Media / Cursorline

*   [HakonHarnes/img-clip.nvim (⭐823)](https://github.com/HakonHarnes/img-clip.nvim) - Effortlessly embed images into any markup language, like LaTeX, Markdown or Typst.

### Note Taking / Cursorline

*   [nfrid/due.nvim (⭐118)](https://github.com/nfrid/due.nvim) - Displays due for a date string as a virtual text.
*   [zk-org/zk-nvim (⭐757)](https://github.com/zk-org/zk-nvim) - Neovim extension for zk, a plain text note-taking assistant.
...
*   [nvim-focus/focus.nvim (⭐792)](https://github.com/nvim-focus/focus.nvim) - Auto-Focusing and Auto-Resizing Splits/Windows written in Lua! Vim splits on steroids.
...
*   [jim-at-jibba/ariake.nvim (⭐22)](https://github.com/jim-at-jibba/ariake.nvim) - A port of the great Atom theme. Beautiful, dark colour scheme.
...
*   [moyiz/command-and-cursor.nvim (⭐21)](https://github.com/moyiz/command-and-cursor.nvim) - Highlight cursor and visual selections when entering command mode.

### Terminal Integration / CSV Files

*   [akinsho/toggleterm.nvim (⭐5.2k)](https://github.com/akinsho/toggleterm.nvim) - Easily manage multiple terminal windows.

### Git / Quickfix

*   [moyiz/git-dev.nvim (⭐103)](https://github.com/moyiz/git-dev.nvim) - Open remote Git repositories in the comfort of Neovim.

## [Apr 14, 2024](/content/2024/04/14/README.md)

### Motion / Tree-sitter Based

*   [mfussenegger/nvim-treehopper (⭐450)](https://github.com/mfussenegger/nvim-treehopper) - Region selection with hints on the AST nodes of a document powered by Tree-sitter.
...
*   [ptdewey/darkearth-nvim (⭐67)](https://github.com/ptdewey/darkearth-nvim) - A dark and earthy colorscheme supporting Tree-sitter and LSP.

### Utility / Cursorline

*   [mistricky/codesnap.nvim (⭐846)](https://github.com/mistricky/codesnap.nvim) - Snapshot plugin with rich features that can make pretty code snapshots.
...
*   [Shaobin-Jiang/IceNvim (⭐268)](https://github.com/Shaobin-Jiang/IceNvim) - A beautiful, powerful and customizable config that is blazingly fast.

## [Mar 30, 2024](/content/2024/03/30/README.md)

### File Explorer / Assembly

*   [prichrd/netrw.nvim (⭐255)](https://github.com/prichrd/netrw.nvim) - Add icons and custom keybindings to netrw.

### Utility / Cursorline

*   [terje/simctl.nvim (⭐38)](https://github.com/terje/simctl.nvim) - Interact with iOS Simulators.

## [Mar 29, 2024](/content/2024/03/29/README.md)

### Git / GitHub

*   [rawnly/gist.nvim (⭐200)](https://github.com/rawnly/gist.nvim) - Create a GitHub Gist from the current file (powered by gh).
...
*   [luckasRanarison/tailwind-tools.nvim (⭐581)](https://github.com/luckasRanarison/tailwind-tools.nvim) - Unofficial TailwindCSS tooling.
...
*   [zeioth/garbage-day.nvim (⭐484)](https://github.com/Zeioth/garbage-day.nvim) - Garbage collector that stops inactive LSP clients to free RAM.
...
*   [olimorris/codecompanion.nvim (⭐5.6k)](https://github.com/olimorris/codecompanion.nvim) - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.

## [Mar 10, 2024](/content/2024/03/10/README.md)

### Marks / Assembly

*   [fnune/recall.nvim (⭐82)](https://github.com/fnune/recall.nvim) - Recall refines the use of marks by focusing on global marks, streamlining their usage and enhancing their visibility and navigability.
...
*   [altermo/iedit.nvim (⭐26)](https://github.com/altermo/iedit.nvim) - Edit one occurrence of text and simultaneously have other selected occurrences edited in the same way.
...
*   [nvimtools/hydra.nvim (⭐254)](https://github.com/nvimtools/hydra.nvim) - Create custom submodes and menus. Port of Emacs Hydra. Maintained fork of anuvyklack/hydra.nvim.

## [Mar 06, 2024](/content/2024/03/06/README.md)

### Programming Languages Support / Golang

*   [yanskun/gotests.nvim (⭐26)](https://github.com/yanskun/gotests.nvim) - Make Go tests easy with [gotests (⭐5.2k)](https://github.com/cweill/gotests).

## [Mar 03, 2024](/content/2024/03/03/README.md)

### Color / Assembly

*   [rasulomaroff/reactive.nvim (⭐236)](https://github.com/rasulomaroff/reactive.nvim) - Set global and window-specific highlights or trigger callbacks when modes/operators change or windows are switched.
...
*   [samharju/yeet.nvim (⭐116)](https://github.com/samharju/yeet.nvim) - Run shell commands in terminal buffers or tmux panes.

## [Mar 02, 2024](/content/2024/03/02/README.md)

### Search / Assembly

*   [polirritmico/telescope-lazy-plugins.nvim (⭐66)](https://github.com/polirritmico/telescope-lazy-plugins.nvim) - A Telescope picker to quickly access plugins configurations from the lazy.nvim spec.

## [Feb 27, 2024](/content/2024/02/27/README.md)

### Programming Languages Support / Diagnostics

*   [dmmulroy/ts-error-translator.nvim (⭐381)](https://github.com/dmmulroy/ts-error-translator.nvim) - A port of Matt Pocock's `ts-error-translator` for VSCode for turning messy and confusing TypeScript errors into plain English.
...
*   [2KAbhishek/tdo.nvim (⭐91)](https://github.com/2KAbhishek/tdo.nvim) - Fast and simple note taking.
...
*   [backdround/global-note.nvim (⭐140)](https://github.com/backdround/global-note.nvim) - One global note in a floating window.

## [Feb 12, 2024](/content/2024/02/12/README.md)

### LSP / Diagnostics

*   [artemave/workspace-diagnostics.nvim (⭐230)](https://github.com/artemave/workspace-diagnostics.nvim) - Populate diagnostics for all projects files, not just the opened ones.

## [Feb 08, 2024](/content/2024/02/08/README.md)

### Programming Languages Support / Diagnostics

*   [iabdelkareem/csharp.nvim (⭐270)](https://github.com/iabdelkareem/csharp.nvim) - Enhances the development experience for .NET developers.
...
*   [LintaoAmons/bookmarks.nvim (⭐271)](https://github.com/LintaoAmons/bookmarks.nvim) - Your new bookmarks option: simple yet powerful.
...
*   [soulis-1256/eagle.nvim (⭐326)](https://github.com/soulis-1256/eagle.nvim) - Mouse-hover LSP hints.

## [Feb 03, 2024](/content/2024/02/03/README.md)

### Colorscheme / Tree-sitter Supported Colorscheme

*   [sontungexpt/witch (⭐69)](https://github.com/sontungexpt/witch) - The primary stinvim distro colorscheme includes the default feature of dimming inactive windows, along with various other customization options for users.
...
*   [kiddos/gemini.nvim (⭐182)](https://github.com/kiddos/gemini.nvim) - Bindings to Google Gemini API.

## [Jan 28, 2024](/content/2024/01/28/README.md)

### AI / Diagnostics

*   [gsuuon/model.nvim (⭐391)](https://github.com/gsuuon/model.nvim) - Integrate LLMs via a prompt builder interface. Multi-providers including OpenAI (+ compatibles), PaLM, HuggingFace and local engines like llamacpp.

## [Jan 27, 2024](/content/2024/01/27/README.md)

### LSP

*   [lopi-py/luau-lsp.nvim (⭐76)](https://github.com/lopi-py/luau-lsp.nvim) - A luau-lsp extension to improve your experience.

## [Jan 25, 2024](/content/2024/01/25/README.md)

### Project / Assembly

*   [LintaoAmons/cd-project.nvim (⭐122)](https://github.com/LintaoAmons/cd-project.nvim) - All you need is just an easier way to `cd` to another project directory.

## [Jan 23, 2024](/content/2024/01/23/README.md)

### Marks / Assembly

*   [otavioschwanck/arrow.nvim (⭐704)](https://github.com/otavioschwanck/arrow.nvim) - Like harpoon, but with a different UX, single keybinding needed and statusline support.
...
*   [theKnightsOfRohan/csvlens.nvim (⭐36)](https://github.com/theKnightsOfRohan/csvlens.nvim) - A port of [YS-L/csvlens (⭐3.2k)](https://github.com/YS-L/csvlens), for easy previewing of tabular data.

### Code Runner / Quickfix

*   [pianocomposer321/officer.nvim (⭐21)](https://github.com/pianocomposer321/officer.nvim) - Like dispatch.vim but using overseer.nvim.

## [Jan 14, 2024](/content/2024/01/14/README.md)

### Startup / Cursorline

*   [CWood-sdf/spaceport.nvim (⭐135)](https://github.com/CWood-sdf/spaceport.nvim) - The start screen that gets you to your projects blazingly fast.
...
*   [chrisgrieser/nvim-scissors (⭐547)](https://github.com/chrisgrieser/nvim-scissors) - Automagical editing and creation of snippets.

### Debugging / CSV Files

*   [chrisgrieser/nvim-chainsaw (⭐129)](https://github.com/chrisgrieser/nvim-chainsaw) - Speed up log creation. Creates various kinds of language-specific log statements, like logs of variables, assertions, or time-measuring.

### Preconfigured Configuration / Competitive Programming

*   [pgosar/CyberNvim (⭐370)](https://github.com/pgosar/CyberNvim) - The world's simplest and most extensible Neovim distribution.
...
*   [atusy/treemonkey.nvim (⭐30)](https://github.com/atusy/treemonkey.nvim) - Region selection with Tree-sitter nodes.

## [Dec 29, 2023](/content/2023/12/29/README.md)

### Keybinding / Tree-sitter Based

*   [tris203/hawtkeys.nvim (⭐237)](https://github.com/tris203/hawtkeys.nvim) - Suggest new easy-to-hit keymaps and find issues with your current keymap configurations.
...
*   [nvim-neorocks/rocks.nvim (⭐981)](https://github.com/nvim-neorocks/rocks.nvim) - A modern approach to plugin management using Luarocks, inspired by Cargo.

### LSP

*   [jmbuhr/otter.nvim (⭐777)](https://github.com/jmbuhr/otter.nvim) - Provides LSP features and a nvim-cmp completion source for languages embedded in other documents.

### Programming Languages Support / Diagnostics

*   [quarto-dev/quarto-nvim (⭐477)](https://github.com/quarto-dev/quarto-nvim) - Tools for working with [Quarto](https://quarto.org/) documents.
...
*   [FabianWirth/search.nvim (⭐185)](https://github.com/FabianWirth/search.nvim) - Tabs for different Telescope pickers.
*   [backdround/improved-search.nvim (⭐60)](https://github.com/backdround/improved-search.nvim) - Add search abilities.

### File Explorer / Assembly

*   [rolv-apneseth/tfm.nvim (⭐96)](https://github.com/Rolv-Apneseth/tfm.nvim) - Similar to `fm-nvim`, this provides Neovim integration for several popular terminal file managers (including [yazi (⭐30k)](https://github.com/sxyazi/yazi)).

### Icon / Cursorline

*   [2KAbhishek/nerdy.nvim (⭐345)](https://github.com/2KAbhishek/nerdy.nvim/) - Find and insert the latest nerd font glyphs.
...
*   [2KAbhishek/co-author.nvim (⭐35)](https://github.com/2KAbhishek/co-author.nvim) - Quickly add co-authors to commits.
...
*   [mrjones2014/smart-splits.nvim (⭐1.4k)](https://github.com/mrjones2014/smart-splits.nvim) - Smart, seamless, directional navigation and resizing of splits.

## [Dec 02, 2023](/content/2023/12/02/README.md)

### Programming Languages Support / Diagnostics

*   [chomosuke/typst-preview.nvim (⭐671)](https://github.com/chomosuke/typst-preview.nvim) - Preview Typst documents in the browser, instant update on each keystroke, and cross jump between code and preview.
...
*   [yutkat/confirm-quit.nvim (⭐33)](https://github.com/yutkat/confirm-quit.nvim) - Confirm before quitting Neovim.
...
*   [fdschmidt93/telescope-egrepify.nvim (⭐136)](https://github.com/fdschmidt93/telescope-egrepify.nvim) - Telescope plugin for better `rg` flags in `live_grep`.

### Colorscheme / Colorscheme Switchers

*   [linrongbin16/colorbox.nvim (⭐45)](https://github.com/linrongbin16/colorbox.nvim) - Load all the ultra colorschemes into your Neovim player!

### Utility / Cursorline

*   [ellisonleao/dotenv.nvim (⭐52)](https://github.com/ellisonleao/dotenv.nvim) - Minimalist .env support.

### Motion / GitLab

*   [ggandor/flit.nvim (⭐404)](https://github.com/ggandor/flit.nvim) - Enhanced f/t motions for Leap.
*   [ggandor/leap-spooky.nvim (⭐280)](https://github.com/ggandor/leap-spooky.nvim) - Spooky (Leap) actions at a distance.

### Editing Support / Scrollbar

*   [cshuaimin/ssr.nvim (⭐981)](https://github.com/cshuaimin/ssr.nvim) - Tree-sitter based structural search and replace.
...
*   [IndianBoy42/tree-sitter-just (⭐170)](https://github.com/IndianBoy42/tree-sitter-just) - Tree-sitter grammar for [Justfiles (⭐29k)](https://github.com/casey/just).
...
*   [nat-418/boole.nvim (⭐184)](https://github.com/nat-418/boole.nvim) - Toggle booleans and common string values.
...
*   [hedyhli/outline.nvim (⭐902)](https://github.com/hedyhli/outline.nvim) - A significantly enhanced and refactored fork of `symbols-outline.nvim`.

## [Nov 13, 2023](/content/2023/11/13/README.md)

### LSP

*   [stevanmilic/nvim-lspimport (⭐77)](https://github.com/stevanmilic/nvim-lspimport) - Automatically resolves imports for undefined terms. Useful with `pyright` language server.
...
*   [TobinPalmer/Tip.nvim (⭐79)](https://github.com/TobinPalmer/Tip.nvim) - Get a simple tip when you launch Neovim.
...
*   [miversen33/sunglasses.nvim (⭐156)](https://github.com/miversen33/sunglasses.nvim) - Dynamic Colorscheme/highlight adjuster on window switching.
...
*   [mangelozzi/rgflow.nvim (⭐104)](https://github.com/mangelozzi/rgflow.nvim) - Quickly get RipGrep results into an editable Quickfix list, while learning RipGrep's CLI.

### Colorscheme / Tree-sitter Supported Colorscheme

*   [miikanissi/modus-themes.nvim (⭐376)](https://github.com/miikanissi/modus-themes.nvim) - Accessible theme, conforming with the highest standard for color contrast (WCAG AAA).

## [Oct 30, 2023](/content/2023/10/30/README.md)

### LSP

*   [mrcjkb/haskell-tools.nvim (⭐554)](https://github.com/mrcjkb/haskell-tools.nvim) - Seamless integration of Neovim with Haskell development tools like haskell-language-server and Hoogle.
...
*   [smoka7/hop.nvim (⭐728)](https://github.com/smoka7/hop.nvim) - Hop is an EasyMotion-like plugin allowing you to jump anywhere in a document with as few keystrokes as possible.
...
*   [mrcjkb/kickstart-nix.nvim (⭐371)](https://github.com/mrcjkb/kickstart-nix.nvim) - A simple [Nix flake](https://wiki.nixos.org/wiki/Flakes) template repo for Neovim derivations, with the goal of simplifying the migration from existing Neovim configurations.
...
*   [dense-analysis/neural (⭐507)](https://github.com/dense-analysis/neural) - Integrate LLMs for generating code, interacting with chat bots, and more.

### Colorscheme / Tree-sitter Supported Colorscheme

*   [polirritmico/monokai-nightasty.nvim (⭐156)](https://github.com/polirritmico/monokai-nightasty.nvim) - A dark/light theme based on the Monokai color palette written in Lua, support for LSP, Tree-sitter and lots of plugins.
...
*   [hinell/move.nvim (⭐13)](https://github.com/hinell/move.nvim) - Move chunks of text around; fork of [fedepujol/move.nvim (⭐362)](https://github.com/fedepujol/move.nvim).
...
*   [cryptomilk/nightcity.nvim (⭐70)](https://github.com/cryptomilk/nightcity.nvim) - A dark colorscheme inspired by Inkpot, Jellybeans, Gruvbox and Tokyonight with LSP support.

### Bars and Lines / Tabline

*   [willothy/nvim-cokeline (⭐613)](https://github.com/willothy/nvim-cokeline) - A bufferline for people with addictive personalities.

### Terminal Integration / CSV Files

*   [mikesmithgh/kitty-scrollback.nvim (⭐761)](https://github.com/mikesmithgh/kitty-scrollback.nvim) - Open your Kitty scrollback buffer. Ameowzing.
...
*   [sontungexpt/url-open (⭐102)](https://github.com/sontungexpt/url-open) - Open URLs under the cursor and create highlight effects for them.

## [Sep 19, 2023](/content/2023/09/19/README.md)

### LSP

*   [Wansmer/symbol-usage.nvim (⭐452)](https://github.com/Wansmer/symbol-usage.nvim) - Display references, definitions and implementations of document symbols.
...
*   [coffebar/neovim-project (⭐264)](https://github.com/coffebar/neovim-project) - Declarative project management, automatic saving of sessions, uses Telescope.

### Split and Window / Indent

*   [yorickpeterse/nvim-window (⭐163)](https://github.com/yorickpeterse/nvim-window) - Easily jump between Neovim windows.

## [Sep 17, 2023](/content/2023/09/17/README.md)

### Utility / Cursorline

*   [LintaoAmons/scratch.nvim (⭐268)](https://github.com/LintaoAmons/scratch.nvim) - Create and manage scratch files.

## [Sep 13, 2023](/content/2023/09/13/README.md)

### Colorscheme / Tree-sitter Supported Colorscheme

*   [ribru17/bamboo.nvim (⭐425)](https://github.com/ribru17/bamboo.nvim) - A warm green theme.
...
*   [subnut/nvim-ghost.nvim (⭐189)](https://github.com/subnut/nvim-ghost.nvim) - GhostText support with zero dependencies.
...
*   [stevearc/conform.nvim (⭐4.7k)](https://github.com/stevearc/conform.nvim) - A lightweight formatting engine that plays nice with LSP.

## [Aug 24, 2023](/content/2023/08/24/README.md)

### Colorscheme / Tree-sitter Supported Colorscheme

*   [askfiy/visual\_studio\_code (⭐209)](https://github.com/askfiy/visual_studio_code) - A Neovim theme that highly restores vscode, so that your friends will no longer be surprised that you use Neovim, because they will think you are using vscode.
...
*   [aznhe21/actions-preview.nvim (⭐494)](https://github.com/aznhe21/actions-preview.nvim) - Fully customizable previewer for LSP code actions.

## [Jul 29, 2023](/content/2023/07/29/README.md)

### Utility / Cursorline

*   [chrisgrieser/nvim-origami (⭐410)](https://github.com/chrisgrieser/nvim-origami) - Fold with relentless elegance.

### Code Runner / Quickfix

*   [Zeioth/compiler.nvim (⭐633)](https://github.com/Zeioth/compiler.nvim) - Compiler for building and running your code without having to configure anything.

### Preconfigured Configuration / Competitive Programming

*   [NormalNvim/NormalNvim (⭐676)](https://github.com/NormalNvim/NormalNvim) - Focused on stability for your daily work. From the creator of Compiler.nvim.

## [Jul 28, 2023](/content/2023/07/28/README.md)

### Utility / Cursorline

*   [malbertzard/inline-fold.nvim (⭐87)](https://github.com/malbertzard/inline-fold.nvim) - Hide certain elements inline like long CSS classes or `href` content.

## [Jul 26, 2023](/content/2023/07/26/README.md)

### Note Taking / Cursorline

*   [serenevoid/kiwi.nvim (⭐236)](https://github.com/serenevoid/kiwi.nvim) - A stripped down VimWiki with necessary features.
...
*   [okuuva/auto-save.nvim (⭐284)](https://github.com/okuuva/auto-save.nvim) - Automatically saves your work as often as needed and as seldom as possible. Customizable with smart defaults. Maintained fork of Pocco81/auto-save.nvim.

## [Jul 21, 2023](/content/2023/07/21/README.md)

### Editing Support / Scrollbar

*   [HiPhish/rainbow-delimiters.nvim (⭐796)](https://github.com/HiPhish/rainbow-delimiters.nvim) - Rainbow delimiters with Tree-sitter.
...
*   [nvimdev/zephyr-nvim (⭐370)](https://github.com/nvimdev/zephyr-nvim) - A dark colorscheme with Tree-sitter support.
...
*   [AlexvZyl/nordic.nvim (⭐943)](https://github.com/AlexvZyl/nordic.nvim) - Nord for Neovim, but warmer and darker. Supports a variety of plugins and other platforms.
...
*   [creativenull/efmls-configs-nvim (⭐304)](https://github.com/creativenull/efmls-configs-nvim) - An unofficial collection of linters and formatters configured for efm-langserver to work with builtin LSP.

## [Jul 11, 2023](/content/2023/07/11/README.md)

### Colorscheme / Tree-sitter Supported Colorscheme

*   [xero/miasma.nvim (⭐456)](https://github.com/xero/miasma.nvim) - A dark pastel color scheme inspired by the woods. Built using lush and supports Tree-sitter, diagnostics, CMP, Git-Signs, Telescope, Which-key, Lazy, and more.

### Bars and Lines / Tabline

*   [tomiis4/BufferTabs.nvim (⭐90)](https://github.com/tomiis4/BufferTabs.nvim) - Simple and Fancy tabline.

### Fennel / Quickfix

*   [Olical/nfnl (⭐325)](https://github.com/Olical/nfnl) - Streamlined successor to Aniseed, compiling Fennel to Lua on file write.
...
*   [zootedb0t/citruszest.nvim (⭐240)](https://github.com/zootedb0t/citruszest.nvim) - A colorscheme that features a combination of bright and juicy colors reminiscent of various citrus fruits, with LSP and Tree-sitter support.

## [Jun 29, 2023](/content/2023/06/29/README.md)

### Colorscheme / Colorscheme Switchers

*   [zaldih/themery.nvim (⭐335)](https://github.com/zaldih/themery.nvim) - A new way to change the colorscheme on the fly like in vscode.

### Motion / GitLab

*   [folke/flash.nvim (⭐3.7k)](https://github.com/folke/flash.nvim) - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
*   [linrongbin16/gitlinker.nvim (⭐246)](https://github.com/linrongbin16/gitlinker.nvim) - Maintained fork of "ruifm's gitlinker", refactored with bug fixes, ssh aliases, blame support and other improvements.

## [Jun 13, 2023](/content/2023/06/13/README.md)

### Snippet / Assembly

*   [TobinPalmer/rayso.nvim (⭐83)](https://github.com/TobinPalmer/rayso.nvim) - Create code snippets in Neovim using [ray.so](https://ray.so).

### Colorscheme / Tree-sitter Supported Colorscheme

*   [dasupradyumna/midnight.nvim (⭐231)](https://github.com/dasupradyumna/midnight.nvim) - A modern black Neovim theme with comfortable color contrast for a pleasant visual experience, with LSP and Tree-sitter support.

## [Jun 05, 2023](/content/2023/06/05/README.md)

### Code Runner / Quickfix

*   [milanglacier/yarepl.nvim (⭐236)](https://github.com/milanglacier/yarepl.nvim) - Yet Another REPL, flexible, supporting multiple paradigms to interact with REPLs, and native dot repeat without other dependencies.
...
*   [google/executor.nvim (⭐153)](https://github.com/google/executor.nvim) - Allows you to run command line tasks in the background and be notified of results.

## [May 25, 2023](/content/2023/05/25/README.md)

### Preconfigured Configuration / Competitive Programming

*   [doctorfree/nvim-lazyman (⭐406)](https://github.com/doctorfree/nvim-lazyman) - Neovim configuration manager and modular configuration, supports over 40 preconfigured configurations.

## [May 22, 2023](/content/2023/05/22/README.md)

### Deployment / Quickfix

*   [OscarCreator/rsync.nvim (⭐97)](https://github.com/OscarCreator/rsync.nvim) - Automatically sync up/down project to a remote with rsync.
...
*   [dmmulroy/tsc.nvim (⭐503)](https://github.com/dmmulroy/tsc.nvim) - Asynchronous project-wide TypeScript type-checking using the TypeScript compiler (`tsc`) with results loaded into a quickfix list.
...
*   [nvimdev/indentmini.nvim (⭐266)](https://github.com/nvimdev/indentmini.nvim) - A minimal and blazing fast indentline plugin by using the `nvim_set_decoration_provide` API function.

### Workflow / Competitive Programming

*   [m4xshen/hardtime.nvim (⭐3.5k)](https://github.com/m4xshen/hardtime.nvim) - Helping you establish good command workflow and habit.

## [May 02, 2023](/content/2023/05/02/README.md)

### Starter Templates / OS-specific

*   [tokiory/neovim-boilerplate (⭐115)](https://github.com/tokiory/neovim-boilerplate) - Starter boilerplate for making new configurations.
...
*   [kelly-lin/ranger.nvim (⭐179)](https://github.com/kelly-lin/ranger.nvim) - [Ranger (⭐17k)](https://github.com/ranger/ranger) integration for Neovim.

## [Apr 28, 2023](/content/2023/04/28/README.md)

### LSP

*   [VidocqH/lsp-lens.nvim (⭐304)](https://github.com/VidocqH/lsp-lens.nvim) - Display function references above function definition like IDEA codelens.
...
*   [nyngwang/nvimgelion (⭐129)](https://github.com/nyngwang/nvimgelion) - Neon Genesis Evangelion but for Vimmers.

## [Apr 24, 2023](/content/2023/04/24/README.md)

### Utility / Cursorline

*   [LukasPietzschmann/telescope-tabs (⭐278)](https://github.com/LukasPietzschmann/telescope-tabs) - Quickly navigate between tabs using telescope.

## [Apr 23, 2023](/content/2023/04/23/README.md)

### Utility / Cursorline

*   [ecthelionvi/NeoComposer.nvim (⭐424)](https://github.com/ecthelionvi/NeoComposer.nvim) - Simplify macro management, enhance productivity, and create harmonious workflows.

## [Apr 22, 2023](/content/2023/04/22/README.md)

### Bars and Lines / Colorscheme Switchers

*   [luukvbaal/statuscol.nvim (⭐591)](https://github.com/luukvbaal/statuscol.nvim) - Configurable 'statuscolumn' with builtin segments and click handlers.

## [Apr 18, 2023](/content/2023/04/18/README.md)

### Color / Assembly

*   [Mr-LLLLL/interestingwords.nvim (⭐50)](https://github.com/Mr-LLLLL/interestingwords.nvim) - Highlight multiple word same time and navigate word under cursor with scrolling smoothly, display search count in virualtext.

## [Apr 17, 2023](/content/2023/04/17/README.md)

### Formatting / Comment

*   [tenxsoydev/tabs-vs-spaces.nvim (⭐25)](https://github.com/tenxsoydev/tabs-vs-spaces.nvim) - Hint and fix deviating indentation.

## [Apr 16, 2023](/content/2023/04/16/README.md)

### Marks / Assembly

*   [tomasky/bookmarks.nvim (⭐180)](https://github.com/tomasky/bookmarks.nvim) - Bookmarks with global file storage, written in Lua.
...
*   [chomosuke/term-edit.nvim (⭐209)](https://github.com/chomosuke/term-edit.nvim) - Allowing you to edit your command in the terminal just like any other buffer.

## [Apr 13, 2023](/content/2023/04/13/README.md)

### Git / Quickfix

*   [aaronhallaert/advanced-git-search.nvim (⭐385)](https://github.com/aaronhallaert/advanced-git-search.nvim) - Search your Git history by commit content, message and author with Telescope.

## [Apr 09, 2023](/content/2023/04/09/README.md)

### Debugging / CSV Files

*   [t-troebst/perfanno.nvim (⭐333)](https://github.com/t-troebst/perfanno.nvim) - Annotate your code with callgraph profiling data. Native support for perf, flamegraph and the LuaJit profiler.

## [Apr 05, 2023](/content/2023/04/05/README.md)

### Scrolling / Scrollbar

*   [lewis6991/satellite.nvim (⭐674)](https://github.com/lewis6991/satellite.nvim) - Decorate scrollbar.

## [Apr 02, 2023](/content/2023/04/02/README.md)

### LSP

*   [SmiteshP/nvim-navbuddy (⭐876)](https://github.com/SmiteshP/nvim-navbuddy) - A simple popup display that provides breadcrumbs like navigation features using LSP.
...
*   [chrisgrieser/nvim-spider (⭐811)](https://github.com/chrisgrieser/nvim-spider) - Use the w, e, b motions like a spider. Considers camelCase and skips insignificant punctuation.

## [Mar 24, 2023](/content/2023/03/24/README.md)

### Syntax / Assembly

*   [desdic/agrolens.nvim (⭐66)](https://github.com/desdic/agrolens.nvim) - Navigate via Tree-sitter nodes using Telescope or FZF.

### Keybinding / Tree-sitter Based

*   [Wansmer/langmapper.nvim (⭐218)](https://github.com/Wansmer/langmapper.nvim) - Auto translating your mappings for non-English input methods.

## [Mar 21, 2023](/content/2023/03/21/README.md)

### Game / Tmux

*   [alanfortlink/blackjack.nvim (⭐66)](https://github.com/alanfortlink/blackjack.nvim) - Classic Black Jack game.
...
*   [zdcthomas/yop.nvim (⭐82)](https://github.com/zdcthomas/yop.nvim) - Easily create your own operators (like `d` and `y`).

## [Mar 12, 2023](/content/2023/03/12/README.md)

### Colorscheme / Tree-sitter Supported Colorscheme

*   [neanias/everforest-nvim (⭐390)](https://github.com/neanias/everforest-nvim) - A Lua port of the Everforest colour scheme.

### Terminal Integration / CSV Files

*   [willothy/flatten.nvim (⭐676)](https://github.com/willothy/flatten.nvim) - Open files from terminal buffers in your current Neovim instance instead of launching a nested instance.
...
*   [shellRaining/hlchunk.nvim (⭐867)](https://github.com/shellRaining/hlchunk.nvim) - A Lua implementation of `nvim-hlchunk`, contains more features, such as highlight `{}` chunk, indent line, space blank etc.
...
*   [iamcco/markdown-preview.nvim (⭐7.5k)](https://github.com/iamcco/markdown-preview.nvim) - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
...
*   [LeonHeidelbach/trailblazer.nvim (⭐278)](https://github.com/LeonHeidelbach/trailblazer.nvim) - TrailBlazer introduces a stack based mark system that enables a completely new dynamic and super fast workflow using project wide marks.
...
*   [embark-theme/vim (⭐709)](https://github.com/embark-theme/vim) - A deep inky purple theme leveraging bright colors.

### Bars and Lines / Colorscheme Switchers

*   [m4xshen/smartcolumn.nvim (⭐349)](https://github.com/m4xshen/smartcolumn.nvim) - Hide your colorcolumn when unneeded.
...
*   [miversen33/netman.nvim (⭐361)](https://github.com/miversen33/netman.nvim) - Lua powered Network Resource Manager.
...
*   [figsoda/nix-develop.nvim (⭐62)](https://github.com/figsoda/nix-develop.nvim) - Run `nix develop` without restarting Neovim.
...
*   [jinzhongjia/LspUI.nvim (⭐256)](https://github.com/jinzhongjia/LspUI.nvim) - A modern and useful UI that wraps LSP operations.

### Colorscheme / Tree-sitter Supported Colorscheme

*   [savq/melange-nvim (⭐896)](https://github.com/savq/melange-nvim) - Warm colorscheme written in Lua with support for various terminal emulators.
...
*   [svrana/neosolarized.nvim (⭐164)](https://github.com/svrana/neosolarized.nvim) - Dark solarized colorscheme using colorbuddy for easy customization.
...
*   [mawkler/modicator.nvim (⭐355)](https://github.com/mawkler/modicator.nvim) - Cursor line number mode indicator. Changes the `CursorLineNr` highlight based on Vim mode.
...
*   [DNLHC/glance.nvim (⭐846)](https://github.com/DNLHC/glance.nvim) - A pretty window for previewing, navigating and editing your LSP locations.
...
*   [j-morano/buffer\_manager.nvim (⭐364)](https://github.com/j-morano/buffer_manager.nvim) - Add one or more buffers, reorder them, save them inside a file or just delete them very easily from a small floating window.
...
*   [LhKipp/nvim-nu (⭐157)](https://github.com/LhKipp/nvim-nu) - Basic editor support for the nushell language.
...
*   [stevearc/oil.nvim (⭐5.9k)](https://github.com/stevearc/oil.nvim) - Edit your filesystem like a buffer.
...
*   [zbirenbaum/copilot.lua (⭐3.8k)](https://github.com/zbirenbaum/copilot.lua) - Fully featured Lua replacement for [GitHub/copilot.vim (⭐11k)](https://github.com/github/copilot.vim).
...
*   [natecraddock/workspaces.nvim (⭐364)](https://github.com/natecraddock/workspaces.nvim) - Manage workspace directories.

## [Dec 27, 2022](/content/2022/12/27/README.md)

### Plugin Manager

*   [folke/lazy.nvim (⭐19k)](https://github.com/folke/lazy.nvim) - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.

### Editing Support / Scrollbar

*   [chrisgrieser/nvim-various-textobjs (⭐737)](https://github.com/chrisgrieser/nvim-various-textobjs) - Bundle of more than 30 new text objects.

## [Dec 20, 2022](/content/2022/12/20/README.md)

### Editing Support / Scrollbar

*   [debugloop/telescope-undo.nvim (⭐776)](https://github.com/debugloop/telescope-undo.nvim) - A telescope extension to visualize your undo tree and fuzzy-search changes in it.

## [Dec 18, 2022](/content/2022/12/18/README.md)

### Formatting / Comment

*   [emileferreira/nvim-strict (⭐37)](https://github.com/emileferreira/nvim-strict) - Strict, native code style formatting which exposes deep nesting, overlong lines, trailing whitespace, trailing empty lines, todos and inconsistent indentation.

## [Dec 17, 2022](/content/2022/12/17/README.md)

### Editing Support / Scrollbar

*   [shortcuts/no-neck-pain.nvim (⭐870)](https://github.com/shortcuts/no-neck-pain.nvim) - Center the currently focused buffer to the middle of your terminal.
...
*   [ramojus/mellifluous.nvim (⭐405)](https://github.com/ramojus/mellifluous.nvim) - Pleasant and productive colorscheme.

### Utility / Cursorline

*   [chrisgrieser/nvim-genghis (⭐214)](https://github.com/chrisgrieser/nvim-genghis) - Convenience file operations, written in Lua.
...
*   [cbochs/portal.nvim (⭐363)](https://github.com/cbochs/portal.nvim) - Build upon and enhance existing jumplist motions (i.e. `<c-i>` and `<c-o>`).

## [Dec 12, 2022](/content/2022/12/12/README.md)

### Marks / Assembly

*   [cbochs/grapple.nvim (⭐667)](https://github.com/cbochs/grapple.nvim) - Provides tagging, cursor tracking, and immediate navigation to important project files.
...
*   [gbprod/nord.nvim (⭐283)](https://github.com/gbprod/nord.nvim) - An arctic, north-bluish clean and elegant Neovim theme, based on Nord Palette.

### Code Runner / Quickfix

*   [Civitasv/cmake-tools.nvim (⭐504)](https://github.com/Civitasv/cmake-tools.nvim) - CMake integration.
...
*   [toppair/peek.nvim (⭐814)](https://github.com/toppair/peek.nvim) - Preview Markdown in a webview window.
...
*   [nvim-zh/colorful-winsep.nvim (⭐612)](https://github.com/nvim-zh/colorful-winsep.nvim) - A configurable color split line.

## [Nov 10, 2022](/content/2022/11/10/README.md)

### Programming Languages Support / Diagnostics

*   [Julian/lean.nvim (⭐436)](https://github.com/Julian/lean.nvim) - Neovim support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
*   [utilyre/barbecue.nvim (⭐882)](https://github.com/utilyre/barbecue.nvim) - A VS Code like winbar.

## [Nov 08, 2022](/content/2022/11/08/README.md)

### LSP

*   [ranjithshegde/ccls.nvim (⭐76)](https://github.com/ranjithshegde/ccls.nvim) - Use off-spec extensions of ccls LSP and browse AST.
...
*   [woosaaahh/sj.nvim (⭐126)](https://github.com/woosaaahh/sj.nvim) - Search based navigation combined with quick jump features.
...
*   [zbirenbaum/neodim (⭐335)](https://github.com/zbirenbaum/neodim) - Dimming the highlights of unused functions, variables, parameters, and more.
...
*   [gorbit99/codewindow.nvim (⭐472)](https://github.com/gorbit99/codewindow.nvim) - Minimap plugin, that is closely integrated with Tree-sitter and the builtin LSP to display more information to the user.

## [Oct 17, 2022](/content/2022/10/17/README.md)

### Terminal Integration / CSV Files

*   [samjwill/nvim-unception (⭐233)](https://github.com/samjwill/nvim-unception) - Automatic unnesting of Neovim sessions started from terminal buffers.

## [Oct 16, 2022](/content/2022/10/16/README.md)

### Utility / Cursorline

*   [folke/noice.nvim (⭐5.4k)](https://github.com/folke/noice.nvim) - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.

## [Oct 14, 2022](/content/2022/10/14/README.md)

### Media / Cursorline

*   [adelarsq/image\_preview.nvim (⭐187)](https://github.com/adelarsq/image_preview.nvim) - Image preview based on terminal's Image Protocol support.

## [Oct 11, 2022](/content/2022/10/11/README.md)

### Editing Support / Scrollbar

*   [smjonas/live-command.nvim (⭐536)](https://github.com/smjonas/live-command.nvim) - Text editing with immediate visual feedback: preview commands such as `:norm`, `:g`, macros and more.
...
*   [Shatur/neovim-tasks (⭐122)](https://github.com/Shatur/neovim-tasks) - A stateful task manager focused on integration with build systems.

## [Oct 04, 2022](/content/2022/10/04/README.md)

### Note Taking / Cursorline

*   [jghauser/papis.nvim (⭐177)](https://github.com/jghauser/papis.nvim) - Manage your bibliography from within your favourite editor.
...
*   [folke/trouble.nvim (⭐6.5k)](https://github.com/folke/trouble.nvim) - A pretty diagnostics list to help you solve all the trouble your code is causing.
...
*   [gennaro-tedesco/nvim-jqx (⭐334)](https://github.com/gennaro-tedesco/nvim-jqx) - Interactive interface for JSON files.
...
*   [crispgm/nvim-go (⭐151)](https://github.com/crispgm/nvim-go) - A minimal implementation of Golang development plugin.
*   [olexsmir/gopher.nvim (⭐376)](https://github.com/olexsmir/gopher.nvim/) - Plugin for making Golang development easiest.
...
*   [someone-stole-my-name/yaml-companion.nvim (⭐266)](https://github.com/someone-stole-my-name/yaml-companion.nvim) - Get, set and autodetect YAML schemas in your buffers.
*   [cuducos/yaml.nvim (⭐233)](https://github.com/cuducos/yaml.nvim) - Utils to work with YAML files.
...
*   [kevinhwang91/nvim-hlslens (⭐877)](https://github.com/kevinhwang91/nvim-hlslens) - Helps you better glance searched information, seamlessly jump matched instances.
...
*   [tamago324/lir.nvim (⭐371)](https://github.com/tamago324/lir.nvim) - Simple file explorer.
...
*   [nvim-neo-tree/neo-tree.nvim (⭐5k)](https://github.com/nvim-neo-tree/neo-tree.nvim) - Neo-tree is a Neovim plugin to browse the file system and other tree like structures in whatever style suits you, including sidebars, floating windows, netrw split style, or all of them at once.
...
*   [klen/nvim-config-local (⭐172)](https://github.com/klen/nvim-config-local) - Secure load local config files from working directories.

### Colorscheme / Colorscheme Creation

*   [tjdevries/colorbuddy.nvim (⭐747)](https://github.com/tjdevries/colorbuddy.nvim) - A colorscheme helper. Written in Lua! Quick & Easy Color Schemes.
*   [norcalli/nvim-base16.lua (⭐78)](https://github.com/norcalli/nvim-base16.lua) - Programmatic Lua library for setting base16 themes.
...
*   [nvim-lualine/lualine.nvim (⭐7.5k)](https://github.com/nvim-lualine/lualine.nvim) - A blazing fast and easy to configure Neovim statusline.
*   [adelarsq/neoline.vim (⭐257)](https://github.com/adelarsq/neoline.vim) - A light statusline/tabline plugin using Lua.
*   [ojroques/nvim-hardline (⭐198)](https://github.com/ojroques/nvim-hardline) - A statusline / bufferline inspired by [vim-airline (⭐18k)](https://github.com/vim-airline/vim-airline) that aims to be as light and simple as possible.
...
*   [tamton-aquib/staline.nvim (⭐391)](https://github.com/tamton-aquib/staline.nvim) - A modern lightweight statusline in Lua. Mainly uses unicode symbols for showing info.
*   [windwp/windline.nvim (⭐509)](https://github.com/windwp/windline.nvim) - The next generation statusline. Animation statusline.
*   [konapun/vacuumline.nvim (⭐30)](https://github.com/konapun/vacuumline.nvim) - A galaxyline configuration inspired by airline.
*   [b0o/incline.nvim (⭐956)](https://github.com/b0o/incline.nvim) - Lightweight floating statuslines, intended for use with Neovim's new global statusline.
...
*   [akinsho/bufferline.nvim (⭐4.1k)](https://github.com/akinsho/bufferline.nvim) - A snazzy buffer line built using Lua.
*   [crispgm/nvim-tabline (⭐91)](https://github.com/crispgm/nvim-tabline) - Neovim port of tabline.vim with Lua.
...
*   [nanozuki/tabby.nvim (⭐708)](https://github.com/nanozuki/tabby.nvim) - A minimal, configurable, Neovim style tabline. Use your Neovim tabs as workspace multiplexer.
...
*   [askfiy/nvim-picgo (⭐63)](https://github.com/askfiy/nvim-picgo) - A picgo-core-based Neovim plugin, written in Lua, that allows you to upload images to the image bed, which means you can view your images from anywhere on the internet.
*   [davidgranstrom/scnvim (⭐252)](https://github.com/davidgranstrom/scnvim) - Neovim frontend for SuperCollider.
*   [Chaitanyabsrip/present.nvim (⭐155)](https://github.com/Chaitanyabsprip/present.nvim) - A Presentation plugin written in Lua.

### Note Taking / Cursorline

*   [0styx0/abbreinder.nvim (⭐90)](https://github.com/0styx0/abbreinder.nvim) - Abbreviation reminders (Neovim >= 0.5).
*   [jakewvincent/mkdnflow.nvim (⭐768)](https://github.com/jakewvincent/mkdnflow.nvim) - Fluent Markdown notebook navigation & management (create links, follow links, create and manage to-do lists, reference bib files, and more).
*   [jbyuki/nabla.nvim (⭐728)](https://github.com/jbyuki/nabla.nvim) - Take your scientific notes.
...
*   [nikvdp/neomux (⭐368)](https://github.com/nikvdp/neomux) - Control Neovim from shells running inside Neovim.
*   [norcalli/nvim-terminal.lua (⭐265)](https://github.com/norcalli/nvim-terminal.lua) - A high performance filetype mode which leverages conceal and highlights your buffer with the correct color codes.
*   [numToStr/FTerm.nvim (⭐795)](https://github.com/numToStr/FTerm.nvim) - No nonsense floating terminal written in Lua.
...
*   [klen/nvim-test (⭐196)](https://github.com/klen/nvim-test) - A Neovim wrapper for running tests.
...
*   [andythigpen/nvim-coverage (⭐409)](https://github.com/andythigpen/nvim-coverage) - Displays coverage information in the sign column.

### Code Runner / Quickfix

*   [michaelb/sniprun (⭐1.6k)](https://github.com/michaelb/sniprun) - Run parts of code of any language directly from Neovim.
*   [CRAG666/code\_runner.nvim (⭐658)](https://github.com/CRAG666/code_runner.nvim) - The best code runner you could have, with super powers.
...
*   [stevearc/overseer.nvim (⭐1.7k)](https://github.com/stevearc/overseer.nvim) - A task runner and job management plugin.
*   [krady21/compiler-explorer.nvim (⭐173)](https://github.com/krady21/compiler-explorer.nvim) - Asynchronous compilation using the [compiler-explorer](https://godbolt.org/) REST API.
...
*   [ldelossa/gh.nvim (⭐627)](https://github.com/ldelossa/gh.nvim) - A fully featured GitHub integration for performing code reviews.

### Keybinding / Tree-sitter Based

*   [folke/which-key.nvim (⭐6.7k)](https://github.com/folke/which-key.nvim) - Neovim plugin that shows a popup with possible keybindings of the command you started typing.
...
*   [max397574/better-escape.nvim (⭐760)](https://github.com/max397574/better-escape.nvim) - Create shortcuts to escape insert mode without getting delay.

### Mouse / Tree-sitter Based

*   [notomo/gesture.nvim (⭐534)](https://github.com/notomo/gesture.nvim) - Mouse gesture plugin.

### Scrolling / Scrollbar

*   [Xuyuanp/scrollbar.nvim (⭐281)](https://github.com/Xuyuanp/scrollbar.nvim) - Scrollbar.
*   [dstein64/nvim-scrollview (⭐667)](https://github.com/dstein64/nvim-scrollview) - Display interactive scrollbars.
*   [petertriho/nvim-scrollbar (⭐997)](https://github.com/petertriho/nvim-scrollbar) - Extensible scrollbar that shows diagnostics and search results.
...
*   [folke/todo-comments.nvim (⭐3.9k)](https://github.com/folke/todo-comments.nvim) - Highlight, list and search todo comments in your projects.
*   [terrortylor/nvim-comment (⭐488)](https://github.com/terrortylor/nvim-comment) - Toggle comments using the built-in commentstring option.
...
*   [LudoPinelli/comment-box.nvim (⭐468)](https://github.com/LudoPinelli/comment-box.nvim) - Clarify and beautify your comments using boxes and lines.
...
*   [NMAC427/guess-indent.nvim (⭐585)](https://github.com/NMAC427/guess-indent.nvim) - Automatic indentation style detection.
*   [Darazaki/indent-o-matic (⭐198)](https://github.com/Darazaki/indent-o-matic) - Dumb automatic fast indentation detection written in Lua.
...
*   [jamestthompson3/nvim-remote-containers (⭐920)](https://github.com/jamestthompson3/nvim-remote-containers) - Develop inside docker containers, just like VSCode.
*   [esensar/nvim-dev-container (⭐678)](https://github.com/esensar/nvim-dev-container) - Neovim devcontainer.json and general development container support.

### Split and Window / Indent

*   [\~henriquehbr/ataraxis.lua](https://sr.ht/~henriquehbr/ataraxis.lua) - A zen mode for improving code readability on Neovim.
*   [sindrets/winshift.nvim (⭐522)](https://github.com/sindrets/winshift.nvim) - Rearrange your windows with ease.
*   [anuvyklack/windows.nvim (⭐620)](https://github.com/anuvyklack/windows.nvim) - Automatically expand width of the current window. Maximizes and restore it. And all this with nice animations!
...
*   [aserowy/tmux.nvim (⭐762)](https://github.com/aserowy/tmux.nvim) - Tmux integration features pane movement and resizing.
...
*   [numToStr/Navigator.nvim (⭐432)](https://github.com/numToStr/Navigator.nvim) - Smoothly navigate between Neovim splits and Tmux panes.
...
*   [seandewar/nvimesweeper (⭐106)](https://github.com/seandewar/nvimesweeper) - Play Minesweeper in your favourite text editor.
*   [seandewar/killersheep.nvim (⭐75)](https://github.com/seandewar/killersheep.nvim) - Neovim port of killersheep.
...
*   [ellisonleao/nvim-plugin-template (⭐416)](https://github.com/ellisonleao/nvim-plugin-template) - Another Neovim plugin template, using GitHub's template feature.
...
*   [uga-rosa/ccc.nvim (⭐944)](https://github.com/uga-rosa/ccc.nvim) - Super powerful color picker / colorizer plugin.
...
*   [gennaro-tedesco/nvim-peekup (⭐324)](https://github.com/gennaro-tedesco/nvim-peekup) - Dynamically interact with Vim registers.
...
*   [nvim-lua/kickstart.nvim (⭐28k)](https://github.com/nvim-lua/kickstart.nvim) - A launch point for your personal Neovim configuration.

## [Aug 23, 2022](/content/2022/08/23/README.md)

### Editing Support / Scrollbar

*   [m4xshen/autoclose.nvim (⭐621)](https://github.com/m4xshen/autoclose.nvim) - A minimalist autoclose plugin written in Lua.
...
*   [Mofiqul/adwaita.nvim (⭐272)](https://github.com/Mofiqul/adwaita.nvim) - Colorscheme based on GNOME Adwaita syntax with support for popular plugins.

### Debugging / CSV Files

*   [andrewferrier/debugprint.nvim (⭐500)](https://github.com/andrewferrier/debugprint.nvim) - Debugging the print() way.
...
*   [gbprod/stay-in-place.nvim (⭐99)](https://github.com/gbprod/stay-in-place.nvim) - Neovim plugin that prevent cursor from moving when using shift and filter actions.
...
*   [rebelot/kanagawa.nvim (⭐5.6k)](https://github.com/rebelot/kanagawa.nvim) - Neovim dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
...
*   [Abstract-IDE/Abstract (⭐206)](https://github.com/Abstract-IDE/Abstract) - Abstract, The Neovim configuration to achieve the power of Modern IDE.
...
*   [keaising/im-select.nvim (⭐298)](https://github.com/keaising/im-select.nvim) - Switching and restoring input method automatically depends on Neovim's edit mode.

## [Jul 25, 2022](/content/2022/07/25/README.md)

### LSP / LSP Installer

*   [williamboman/mason.nvim (⭐9.7k)](https://github.com/williamboman/mason.nvim) - Portable package manager that runs everywhere Neovim runs. Easily install and manage LSP servers, DAP servers, linters, and formatters.
...
*   [Weissle/persistent-breakpoints.nvim (⭐243)](https://github.com/Weissle/persistent-breakpoints.nvim) - Persistent breakpoints for nvim-dap.

## [Jul 05, 2022](/content/2022/07/05/README.md)

### Utility / Cursorline

*   [sitiom/nvim-numbertoggle (⭐208)](https://github.com/sitiom/nvim-numbertoggle) - Neovim plugin to automatically toggle between relative and absolute line numbers.

### Neovim Lua Development / Quickfix

*   [kkharji/sqlite.lua (⭐559)](https://github.com/kkharji/sqlite.lua) - SQLite/LuaJIT binding for Lua and Neovim.

### Session / Indent

*   [olimorris/persisted.nvim (⭐514)](https://github.com/olimorris/persisted.nvim) - Simple session management with Git branching, autosave/autoload and Telescope support.
...
*   [abecodes/tabout.nvim (⭐832)](https://github.com/abecodes/tabout.nvim) - Jump out of brackets, quotes, objects, etc.

## [Jun 22, 2022](/content/2022/06/22/README.md)

### Formatting / Comment

*   [cappyzawa/trim.nvim (⭐150)](https://github.com/cappyzawa/trim.nvim) - Trims trailing whitespace and lines.

## [Jun 17, 2022](/content/2022/06/17/README.md)

### Utility / Cursorline

*   [m-demare/attempt.nvim (⭐91)](https://github.com/m-demare/attempt.nvim) - Manage and run temporary buffers.
...
*   [h-hg/fcitx.nvim (⭐96)](https://github.com/h-hg/fcitx.nvim) - Switching and restoring fcitx state for each buffer separately.
*   [filipdutescu/renamer.nvim (⭐314)](https://github.com/filipdutescu/renamer.nvim) - VS Code-like renaming UI, written in Lua.

## [Jun 06, 2022](/content/2022/06/06/README.md)

### LSP

*   [smjonas/inc-rename.nvim (⭐798)](https://github.com/smjonas/inc-rename.nvim) - Provides an incremental LSP rename command based on Neovim's command-preview feature.
...
*   [crusj/bookmarks.nvim (⭐241)](https://github.com/crusj/bookmarks.nvim) - Remember file locations and sort by time and frequency.
...
*   [ghillb/cybu.nvim (⭐322)](https://github.com/ghillb/cybu.nvim) - Displays a notification window with context when cycling buffers.

## [May 19, 2022](/content/2022/05/19/README.md)

### LSP

*   [amrbashir/nvim-docs-view (⭐169)](https://github.com/amrbashir/nvim-docs-view) - Display LSP hover documentation in a side panel.
...
*   [hrsh7th/nvim-cmp (⭐9.2k)](https://github.com/hrsh7th/nvim-cmp) - Completion engine written in Lua, successor of `nvim-compe`.
    *   [hrsh7th/cmp-cmdline (⭐607)](https://github.com/hrsh7th/cmp-cmdline) - `nvim-cmp` source for cmdline completion.
    *   [saadparwaiz1/cmp\_luasnip (⭐776)](https://github.com/saadparwaiz1/cmp_luasnip) - `nvim-cmp` source for `LuaSnip`.
    *   [hrsh7th/cmp-buffer (⭐663)](https://github.com/hrsh7th/cmp-buffer) - `nvim-cmp` source for buffer words.
    *   [hrsh7th/cmp-path (⭐678)](https://github.com/hrsh7th/cmp-path) - `nvim-cmp` source for filesystem paths.
...
*   [Shatur/neovim-session-manager (⭐601)](https://github.com/Shatur/neovim-session-manager) - A simple wrapper around :mksession.
...
*   [udayvir-singh/hibiscus.nvim (⭐105)](https://github.com/udayvir-singh/hibiscus.nvim) - Highly opinionated macros to elegantly write your config.
...
*   [frabjous/knap (⭐378)](https://github.com/frabjous/knap) - Plugin for creating automatic updating-as-you-type previews for Markdown, LaTeX and other documents.

## [Apr 21, 2022](/content/2022/04/21/README.md)

### Motion / GitLab

*   [ggandor/leap.nvim (⭐4.9k)](https://github.com/ggandor/leap.nvim) - A refined successor of Lightspeed, aiming to establish a widely accepted standard interface extension for moving around in Vim-like editors.
...
*   [scalameta/nvim-metals (⭐537)](https://github.com/scalameta/nvim-metals) - Neovim plugin for Metals, the Scala language server, using Neovim's builtin LSP.
...
*   [gbprod/substitute.nvim (⭐710)](https://github.com/gbprod/substitute.nvim) - Neovim plugin introducing a new operator motions to quickly replace and exchange text.
...
*   [axieax/urlview.nvim (⭐269)](https://github.com/axieax/urlview.nvim) - Browse all URLs in the current buffer.
...
*   [m-demare/hlargs.nvim (⭐550)](https://github.com/m-demare/hlargs.nvim) - Highlight arguments' definitions and usages, using Tree-sitter.
...
*   [rgroli/other.nvim (⭐476)](https://github.com/rgroli/other.nvim) - Open alternative files for the current buffer.

## [Mar 12, 2022](/content/2022/03/12/README.md)

### Utility / Cursorline

*   [jghauser/fold-cycle.nvim (⭐90)](https://github.com/jghauser/fold-cycle.nvim) - Cycle folds open or closed.

## [Mar 11, 2022](/content/2022/03/11/README.md)

### Colorscheme / Tree-sitter Supported Colorscheme

*   [cpea2506/one\_monokai.nvim (⭐189)](https://github.com/cpea2506/one_monokai.nvim) - One Monokai theme written in Lua.

## [Feb 28, 2022](/content/2022/02/28/README.md)

### Colorscheme / Lua Colorscheme

*   [lalitmee/cobalt2.nvim (⭐113)](https://github.com/lalitmee/cobalt2.nvim) - A port of cobalt2 colorscheme using colorbuddy.

### Git / Quickfix

*   [AckslD/nvim-gfold.lua (⭐32)](https://github.com/AckslD/nvim-gfold.lua) - Plugin using [gfold (⭐369)](https://github.com/nickgerace/gfold) to switch repo and have statusline component.

## [Feb 22, 2022](/content/2022/02/22/README.md)

### Snippet / Assembly

*   [ellisonleao/carbon-now.nvim (⭐188)](https://github.com/ellisonleao/carbon-now.nvim) - Create beautiful code snippets directly from Neovim.
...
*   [p00f/cphelper.nvim (⭐144)](https://github.com/p00f/cphelper.nvim) - Neovim helper for competitive programming written in Lua.
*   [xeluxee/competitest.nvim (⭐543)](https://github.com/xeluxee/competitest.nvim) - A plugin to automate testcases management and checking for Competitive Programming contests.
...
*   [Mofiqul/dracula.nvim (⭐740)](https://github.com/Mofiqul/dracula.nvim) - Dracula colorscheme for Neovim written in Lua.
...
*   [luisiacc/gruvbox-baby (⭐439)](https://github.com/luisiacc/gruvbox-baby) - A modern gruvbox theme with full Tree-sitter support.

## [Dec 10, 2021](/content/2021/12/10/README.md)

### Editing Support / Scrollbar

*   [sQVe/sort.nvim (⭐196)](https://github.com/sQVe/sort.nvim) - Sorting plugin that intelligently supports line-wise and delimiter sorting.
...
*   [gbprod/cutlass.nvim (⭐218)](https://github.com/gbprod/cutlass.nvim) - Plugin that adds a 'cut' operation separate from 'delete'.
...
*   [rmagatti/goto-preview (⭐999)](https://github.com/rmagatti/goto-preview) - Previewing native LSP's goto definition calls in floating windows.
...
*   [shaeinst/roshnivim (⭐206)](https://github.com/shaeinst/roshnivim) - Roshnivim, can be called Neovim's distro, is a predefined configs so that you don't need 1000hr to setup Neovim as an IDE.
...
*   [nanotee/sqls.nvim (⭐239)](https://github.com/nanotee/sqls.nvim) - SQL database connection plugin + LSP client.
...
*   [Mofiqul/vscode.nvim (⭐906)](https://github.com/Mofiqul/vscode.nvim) - A Lua port of vim-code-dark colorscheme with vscode light and dark theme.
...
*   [Th3Whit3Wolf/one-nvim (⭐114)](https://github.com/Th3Whit3Wolf/one-nvim) - An Atom One inspired dark and light colorscheme.
*   [Th3Whit3Wolf/space-nvim (⭐48)](https://github.com/Th3Whit3Wolf/space-nvim) - A spacemacs inspired dark and light colorscheme.
*   [ishan9299/nvim-solarized-lua (⭐199)](https://github.com/ishan9299/nvim-solarized-lua) - Solarized colorscheme in Lua (Neovim >= 0.5).
...
*   [FrenzyExists/aquarium-vim (⭐309)](https://github.com/FrenzyExists/aquarium-vim) - A dark, yet vibrant colorscheme.
*   [adisen99/apprentice.nvim (⭐45)](https://github.com/adisen99/apprentice.nvim) - Colorscheme written in Lua based on the [Apprentice (⭐911)](https://github.com/romainl/Apprentice) color palette with Tree-sitter and built-in LSP support.

### Colorscheme / Lua Colorscheme

*   [metalelf0/jellybeans-nvim (⭐122)](https://github.com/metalelf0/jellybeans-nvim) - A port of jellybeans colorscheme.

### Utility / Cursorline

*   [code-biscuits/nvim-biscuits (⭐313)](https://github.com/code-biscuits/nvim-biscuits) - A Neovim port of Assorted Biscuits. Ends up with more supported languages too.
...
*   [jbyuki/one-small-step-for-vimkind (⭐525)](https://github.com/jbyuki/one-small-step-for-vimkind) - An adapter for the Neovim Lua language. It allows you to debug any Lua code running in a Neovim instance (A Lua plugin that can debug Neovim Lua plugins).
...
*   [b0o/SchemaStore.nvim (⭐934)](https://github.com/b0o/SchemaStore.nvim) - Provide access to the [SchemaStore (⭐3.6k)](https://github.com/SchemaStore/schemastore) catalog.

## [Oct 22, 2021](/content/2021/10/22/README.md)

### LSP

*   [mfussenegger/nvim-lint (⭐2.5k)](https://github.com/mfussenegger/nvim-lint) - An asynchronous linter plugin, complementary to the built-in Language Server Protocol support.
...
*   [olimorris/onedarkpro.nvim (⭐991)](https://github.com/olimorris/onedarkpro.nvim) - Atom's iconic One Dark theme. Cacheable, fully customisable, Tree-sitter and LSP semantic token support. Comes with light and dark variants.

## [Oct 10, 2021](/content/2021/10/10/README.md)

### Fuzzy Finder / Assembly

*   [jvgrootveld/telescope-zoxide (⭐361)](https://github.com/jvgrootveld/telescope-zoxide) - Telescope integration for [zoxide (⭐31k)](https://github.com/ajeetdsouza/zoxide), a smart directory picker that tracks your usage.

## [Oct 03, 2021](/content/2021/10/03/README.md)

### Snippet / Assembly

*   [dcampos/nvim-snippy (⭐337)](https://github.com/dcampos/nvim-snippy) - Snippet plugin written in Lua with support for [vim-snippets (⭐4.9k)](https://github.com/honza/vim-snippets).
...
*   [rafamadriz/neon (⭐198)](https://github.com/rafamadriz/neon) - Customizable colorscheme with excellent italic and bold support, dark and light variants. Made to work and look good with Tree-sitter.
...
*   [kdheepak/monochrome.nvim (⭐153)](https://github.com/kdheepak/monochrome.nvim) - A 16 bit monochrome colorscheme that uses hsluv for perceptually distinct gray colors, with support for Tree-sitter and other commonly used plugins.
...
*   [rose-pine/neovim (⭐2.8k)](https://github.com/rose-pine/neovim) - All natural pine, faux fur and a bit of soho vibes for the classy minimalist.

### Utility / Cursorline

*   [rktjmp/paperplanes.nvim (⭐97)](https://github.com/rktjmp/paperplanes.nvim) - Post selections or buffers to online paste bins.
...
*   [kdheepak/panvimdoc (⭐307)](https://github.com/kdheepak/panvimdoc) - A pandoc to vimdoc GitHub action.
...
*   [vuki656/package-info.nvim (⭐580)](https://github.com/vuki656/package-info.nvim) - Display latest package version as virtual text in package.json.
...
*   [camspiers/snap (⭐502)](https://github.com/camspiers/snap) - An extensible fuzzy finder. Similar to Telescope, and optimized for performance, especially when grepping in large codebases.
...
*   [shaunsingh/nord.nvim (⭐953)](https://github.com/shaunsingh/nord.nvim) - Neovim theme based off of the Nord Color Palette.
...
*   [stevearc/aerial.nvim (⭐2.1k)](https://github.com/stevearc/aerial.nvim) - A code outline window for skimming and quick navigation.
...
*   [jubnzv/mdeval.nvim (⭐215)](https://github.com/jubnzv/mdeval.nvim) - Evaluate code blocks inside Markdown documents.
...
*   [NTBBloodbath/cheovim (⭐343)](https://github.com/NTBBloodbath/cheovim) - Neovim configuration switcher written in Lua. Inspired by chemacs.
...
*   [nacro90/numb.nvim (⭐792)](https://github.com/nacro90/numb.nvim) - Peek lines in a non-obtrusive way.
...
*   [sindrets/diffview.nvim (⭐5.1k)](https://github.com/sindrets/diffview.nvim) - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev.

## [Jun 07, 2021](/content/2021/06/07/README.md)

### Programming Languages Support / Markdown and LaTeX

*   [jghauser/auto-pandoc.nvim (⭐39)](https://github.com/jghauser/auto-pandoc.nvim) - Easy pandoc conversion leveraging YAML blocks.
*   [jghauser/follow-md-links.nvim (⭐164)](https://github.com/jghauser/follow-md-links.nvim) - Press enter to follow internal Markdown links.
...
*   [tanvirtin/monokai.nvim (⭐379)](https://github.com/tanvirtin/monokai.nvim) - Monokai theme written in Lua.

### Git / Quickfix

*   [tanvirtin/vgit.nvim (⭐817)](https://github.com/tanvirtin/vgit.nvim) - Visual Git Plugin to enhance your Git experience.
...
*   [jubnzv/virtual-types.nvim (⭐413)](https://github.com/jubnzv/virtual-types.nvim) - Show type annotations as virtual text.
...
*   [tomasiser/vim-code-dark (⭐991)](https://github.com/tomasiser/vim-code-dark) - A dark color scheme heavily inspired by the look of the Dark+ scheme of Visual Studio Code.
*   [sainnhe/sonokai (⭐1.9k)](https://github.com/sainnhe/sonokai) - High Contrast & Vivid Color Scheme based on Monokai Pro.
*   [sainnhe/edge (⭐980)](https://github.com/sainnhe/edge) - Clean & Elegant Color Scheme inspired by Atom One and Material.
...
*   [Olical/aniseed (⭐643)](https://github.com/Olical/aniseed) - Configure and extend Neovim with Fennel (Lisp to Lua).

### Git / Quickfix

*   [f-person/git-blame.nvim (⭐1k)](https://github.com/f-person/git-blame.nvim) - Show Git blame info.
*   [lewis6991/gitsigns.nvim (⭐6.3k)](https://github.com/lewis6991/gitsigns.nvim) - Git integration: signs, hunk actions, blame, etc.
...
*   [notomo/cmdbuf.nvim (⭐130)](https://github.com/notomo/cmdbuf.nvim) - Alternative command-line-window plugin.
...
*   [fenetikm/falcon (⭐817)](https://github.com/fenetikm/falcon) - A colour scheme for terminals, Vim and friends.

## [Mar 05, 2021](/content/2021/03/05/README.md)

### Plugin Manager

*   [savq/paq-nvim (⭐705)](https://github.com/savq/paq-nvim) - Neovim package manager written in Lua.
...
*   [ishan9299/modus-theme-vim (⭐175)](https://github.com/ishan9299/modus-theme-vim) - This is a color scheme developed by Protesilaos Stavrou for emacs.