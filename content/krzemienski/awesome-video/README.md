...
*   [huzhenjie/m3u8\_downloader (⭐53)](https://github.com/huzhenjie/m3u8_downloader)  - 基于Python的m3u8下载器.
...
*   [rclone/rclone (⭐38k)](https://github.com/rclone/rclone)  - rsync for cloud storage - Google Drive, Amazon Drive, S3, Dropbox, Backblaze B2, One Drive, Swift, Hubic, Cloudfiles, Google Cloud Storage, Yandex Files - rclone/rclone
...
*   [googlecast/CastReceiver (⭐278)](https://github.com/googlecast/CastReceiver)  - Reference Receiver: CastReceiver shows how to develop a fully Cast Design Checklist compliant receiver with additional features. - googlecast/CastReceiver
...
*   [DeviLeo/DLGPlayer (⭐165)](https://github.com/DeviLeo/DLGPlayer)  - A media player for iOS based on FFmpeg 4.0.
...
*   [kodlian/TVVLCPlayer (⭐62)](https://github.com/kodlian/TVVLCPlayer)  - TVVLCPlayer lets you integrate easily a powerfull video player with playback control views to your tvOS apps. - kodlian/TVVLCPlayer
...
*   [noreasonprojects/ModernAVPlayer (⭐266)](https://github.com/noreasonprojects/ModernAVPlayer)  - ModernAVPlayer is a persistence AVPlayer wrapper.
...
*   [vitoziv/VIMediaCache (⭐871)](https://github.com/vitoziv/VIMediaCache)  - Cache media file while play media using AVPlayer.
...
*   [Eyevinn/ott-multiview (⭐58)](https://github.com/Eyevinn/ott-multiview)  - This is a web based multiview screen for HLS and MPEG-DASH streams based on hls.js and Shaka Player. - Eyevinn/ott-multiview
...
*   [bbc/bigscreen-player (⭐64)](https://github.com/bbc/bigscreen-player)  - Simplified media playback for bigscreen devices.
*   [bytedance/xgplayer (⭐6k)](https://github.com/bytedance/xgplayer)  - A HTML5 video player with a parser that saves traffic - bytedance/xgplayer
...
*   [vimond/replay (⭐202)](https://github.com/vimond/replay)  - A React video player facilitating adaptive stream playback with custom UI and a React-friendly API. - vimond/replay
...
*   [smacke/subsync (⭐5.9k)](https://github.com/smacke/subsync)  - Automagically synchronize subtitles with video.
*   [wargarblgarbl/libgosubs (⭐22)](https://github.com/wargarblgarbl/libgosubs)  -
...
*   [ant-media/Ant-Media-Server (⭐3.6k)](https://github.com/ant-media/Ant-Media-Server)  - Ant Media Server supports RTMP, RTSP, WebRTC and Adaptive Bitrate. It can also record videos in MP4, HLS and FLV - ant-media/Ant-Media-Server
*   [ossrs/srs (⭐21k)](https://github.com/ossrs/srs)  - SRS is a simple live streaming cluster, a simple joy. - ossrs/srs
...
*   [peak3d/inputstream.adaptive (⭐403)](https://github.com/peak3d/inputstream.adaptive)  - kodi inputstream addon for several manifest types.
...
*   [vitalets/awesome-smart-tv (⭐886)](https://github.com/vitalets/awesome-smart-tv)  - :zap:A curated list of awesome resources for building Smart TV apps - vitalets/awesome-smart-tv
...
*   [georgejecook/rooibos (⭐64)](https://github.com/georgejecook/rooibos)  - simple, flexible, fun brightscript test framework for roku scenegraph apps - georgejecook/rooibos
*   [juliomalves/roku-libs (⭐50)](https://github.com/juliomalves/roku-libs)  - BrightScript Utility Libraries.
...
*   [rokucommunity/brighterscript-formatter (⭐9)](https://github.com/RokuCommunity/brighterscript-formatter)  - A code formatter for BrighterScript (and BrightScript) - rokucommunity/brighterscript-formatter
*   [rokucommunity/vscode-brightscript-language (⭐84)](https://github.com/rokucommunity/vscode-brightscript-language)  - A Visual Studio Code extension for Roku's BrightScript language - rokucommunity/vscode-brightscript-language
...
*   [rokudev/SceneGraphDeveloperExtensions (⭐97)](https://github.com/rokudev/SceneGraphDeveloperExtensions)  - Contribute to rokudev/SceneGraphDeveloperExtensions development by creating an account on GitHub.
*   [rokudev/automated-channel-testing (⭐54)](https://github.com/rokudev/automated-channel-testing)  - Roku Automated Channel Testing: Selenium-based WebDriver + Robot Framework + Samples - rokudev/automated-channel-testing
...
*   [rokudev/samples (⭐368)](https://github.com/rokudev/samples)  - Collection of sample channels for side-loading on your Roku device - rokudev/samples
*   [rokudev/unit-testing-framework (⭐70)](https://github.com/rokudev/unit-testing-framework)  - Tool for automating and testing Roku channels.
...
*   [Ch00k/ffmpy (⭐432)](https://github.com/Ch00k/ffmpy)  -
*   [ElderByte-/docker-java-media (⭐1)](https://github.com/ElderByte-/docker-java-media)  - JRE 10 (Java 10) and media tools (ffmpeg).
*   [FFmpeg/FFmpeg (⭐35k)](https://github.com/FFmpeg/FFmpeg)  - Mirror of git://source.ffmpeg.org/ffmpeg.git.
...
*   [Kagami/ffmpeg.js (⭐2.9k)](https://github.com/Kagami/ffmpeg.js)  - Port of FFmpeg with Emscripten.
...
*   [bcoudurier/FFmbc (⭐181)](https://github.com/bcoudurier/FFmbc)  - FFmpeg customized for broadcast and professional usage - bcoudurier/FFmbc
...
*   [kkroening/ffmpeg-python (⭐8.2k)](https://github.com/kkroening/ffmpeg-python)  -
*   [kokorin/Jaffree (⭐372)](https://github.com/kokorin/Jaffree)  - Java ffmpeg and ffprobe command-line wrapper.
*   [markus-perl/ffmpeg-build-script (⭐737)](https://github.com/markus-perl/ffmpeg-build-script)  - The FFmpeg build script provides an easy way to build a static FFmpeg on OSX and Linux with non-free codecs included. - markus-perl/ffmpeg-build-script
...
*   [slhck/ffmpeg-encoding-course (⭐85)](https://github.com/slhck/ffmpeg-encoding-course)  - An introduction to FFmpeg and its tools.
*   [transitive-bullshit/awesome-ffmpeg (⭐847)](https://github.com/transitive-bullshit/awesome-ffmpeg)  - 👻 A curated list of awesome FFmpeg resources.
...
*   [hybrik/hybrik-samples (⭐14)](https://github.com/hybrik/hybrik-samples/blob/master/Feature%20Examples/Filters/ebu_r128_audio_normalization.json)  - Hybrik Samples.
*   [normalizing Audio](https://www.learndigitalaudio.com/normalize-audio)  -
*   [slhck/ffmpeg-normalize (⭐976)](https://github.com/slhck/ffmpeg-normalize#examples)  - Audio Normalization for Python/ffmpeg.
...
*   [Comcast/caption-inspector (⭐50)](https://github.com/Comcast/caption-inspector)  - Caption Inspector is a reference decoder for Closed Captions (CEA-608 and CEA-708). - Comcast/caption-inspector
...
*   [apm1467/videocr (⭐462)](https://github.com/apm1467/videocr)  - Extract hardcoded subtitles from videos using machine learning - apm1467/videocr
*   [awslabs/serverless-subtitles (⭐123)](https://github.com/awslabs/serverless-subtitles)  - Serverless Subtitles can handle a video input, extract the sound, transcript it and generate different subtitle files for your video. - awslabs/serverless-subtitles
...
*   [Eyevinn/vast-info (⭐6)](https://github.com/Eyevinn/vast-info)  - Parse a VAST or VMAP to show valuable information in a readable format - Eyevinn/vast-info
...
*   [hybrik/hybrik-samples (⭐14)](https://github.com/hybrik/hybrik-samples)  - Hybrik Samples.

### QoE / Dolby

*   [JNoDuq/videobench (⭐186)](https://github.com/JNoDuq/videobench)  - VMAF PSNR Bitrate Analyzer.
*   [Netflix/vmaf (⭐3.5k)](https://github.com/Netflix/vmaf/)  - Perceptual video quality assessment based on multi-method fusion. - Netflix/vmaf
...
*   [bavc/qctools (⭐274)](https://github.com/bavc/qctools)  -
*   [crunchyroll/objective\_perceptual\_analysis (⭐20)](https://github.com/crunchyroll/objective_perceptual_analysis)  -
...
*   [Eyevinn/channel-engine (⭐80)](https://github.com/Eyevinn/channel-engine)  - OTT TV Channel Engine.
...
*   [Eyevinn/toolbox (⭐210)](https://github.com/Eyevinn/toolbox)  - A set of Docker containers with Streaming tools.
...
*   [bcpierce00/unison (⭐2.9k)](https://github.com/bcpierce00/unison)  - Unison file synchronizer.
...
*   [liwf616/awesome-live-stream (⭐417)](https://github.com/liwf616/awesome-live-stream)  - Webrtc && Nginx && DASH && Quic 学习资料收集，持续更新中.
*   [mar10/wsgidav (⭐670)](https://github.com/mar10/wsgidav)  - A generic and extendable WebDAV server based on WSGI - mar10/wsgidav
*   [mifi/lossless-cut (⭐16k)](https://github.com/mifi/lossless-cut)  -
*   [minio/minio (⭐38k)](https://github.com/minio/minio)  - MinIO is a high performance object storage server compatible with Amazon S3 APIs - minio/minio
*   [obsproject/obs-studio (⭐47k)](https://github.com/obsproject/obs-studio)  - OBS Studio - Free and open source software for live streaming and screen recording - obsproject/obs-studio
...
*   [watson-developer-cloud/text-to-speech-nodejs (⭐342)](https://github.com/watson-developer-cloud/text-to-speech-nodejs)  - :speaker: Sample Node.js Application for the IBM Watson Text to Speech Service - watson-developer-cloud/text-to-speech-nodejs

### DRM / Dolby

*   [CrackerCat/video\_decrypter (⭐289)](https://github.com/CrackerCat/video_decrypter)  - Decrypt video from a streaming site with MPEG-DASH Widevine DRM encryption. - CrackerCat/video\_decrypter
...
*   [videojs/aes-decrypter (⭐29)](https://github.com/videojs/aes-decrypter)  - Contribute to videojs/aes-decrypter development by creating an account on GitHub.
...
*   [artilleryio/artillery-plugin-hls (⭐22)](https://github.com/artilleryio/artillery-plugin-hls)  - Load test HTTP Live Streaming (HLS) servers with Artillery 🎥 - artilleryio/artillery-plugin-hls
