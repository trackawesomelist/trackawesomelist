...
*   C: Scripting
    ...
    *   🎉 [Lua (⭐7.7k)](https://github.com/lua/lua) - Powerful, efficient, lightweight, embeddable scripting language.
    *   🎉 [QuickJS (⭐7k)](https://github.com/bellard/quickjs) - Small and embeddable JavaScript engine.

### C++

*   📚 [Awesome C++ (⭐53k)](https://github.com/fffaraz/awesome-cpp#readme) - List of awesome C++ frameworks, libraries, and resources.
*   📚 [Awesome C++ Game Dev (⭐1.4k)](https://github.com/Caerind/AwesomeCppGameDev#readme) - List of awesome C++ things for Game Development.
*   📚 [Awesome Hpp (⭐3k)](https://github.com/p-ranav/awesome-hpp) - List of awesome header-only C++ libraries.
