...
*   Python: - Awesome Collections -
    *   📚 [Awesome Python (⭐153k)](https://github.com/vinta/awesome-python) - List of awesome Python frameworks, libraries, software and more.
...
*   Python: Game Framework
    ...
    *   🔒 [Pygame (⭐5.6k)](https://github.com/pygame/pygame) - Multimedia library, built on top of the excellent SDL library.
...
*   Rust: Gui
    *   🎉 [Druid](https://linebender.org/druid/) [:octocat: (⭐8.3k)](https://github.com/linebender/druid) - Data-first Rust-native UI design toolkit.
    ...
    *   🔒 [Slint](https://slint-ui.com/) [:octocat: (⭐5.5k)](https://github.com/slint-ui/slint) - (formerly SixtyFPS) Gui toolkit for embedded devices / desktop apps.
*   Rust: Physics
...
*   Sound
    ...
    *   🆓 [Sonic Pi (⭐9.7k)](https://github.com/sonic-pi-net/sonic-pi) - Kind of musical instrument where you code music.
