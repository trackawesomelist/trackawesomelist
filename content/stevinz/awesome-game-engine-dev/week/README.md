...
*   C++: Animation
    ...
    *   🎉 [Tweeny (⭐712)](https://github.com/mobius3/tweeny) - Inbetweening library for complex animations for games / apps.
*   C++: Cross-Platform
...
*   C++: Graphics - 2D
    ...
    *   🎉 [C++ Bitmap Library (⭐163)](https://github.com/ArashPartow/bitmap) - Featured bitmap loading and manipulation library.
...
*   C++: Reflection
    ...
    *   🎉 [Ponder (⭐632)](https://github.com/billyquith/ponder) - Expose C++17 classes and objects so they can used as data.
...
*   C#: Gui
    ...
    *   🎉 [Myra (⭐701)](https://github.com/rds1983/Myra) - Gui library for *MonoGame*, *FNA*, and *Stride*.
...
*   JavaScript: Gui
    ...
    *   🎉 [PCUI (⭐658)](https://github.com/playcanvas/pcui) - UI component library for the web by *PlayCanvas*.
...
*   C: Scripting
    ...
    *   🎉 [JerryScript (⭐6.9k)](https://github.com/jerryscript-project/jerryscript) - Ultra-lightweight JavaScript engine for the Internet of Things.
...
*   C++: Game Framework
    ...
    *   🎉 [Solar2D (⭐2.5k)](https://github.com/coronalabs/corona) - Focus on ease of iterations and usage. Formerly *Corona*.
...
*   C++: Graphics - 3D
    ...
    *   🎉 [Intermediate Graphics Library (IGL) (⭐2.8k)](https://github.com/facebook/igl) - Cross-platform abstraction layer by *Facebook*.
    ...
    *   🎉 [OSRE (⭐181)](https://github.com/kimkulling/osre) - Just another "Open Source Render Engine".
    *   🔒 [StratusGFX (⭐634)](https://github.com/KTStephano/StratusGFX) - Realtime 3D rendering engine implementing modern graphics techniques.
    *   🎉 [Threepp (⭐575)](https://github.com/markaren/threepp) - Cross-platform C++17 port of the popular 3D JavaScript library *Three.js* (r129).
    *   🎉 [Tungsten (⭐1.7k)](https://github.com/tunabrain/tungsten) - High-performance physically-based renderer in C++11.
    *   🎉 [Wicked Engine (⭐5.5k)](https://github.com/turanszkij/WickedEngine) - Engine focusing on performance & modern rendering techniques.
*   C++: Gui
    *   🎉 [Crazy Eddie's GUI (⭐431)](https://github.com/cegui/cegui) - Versatile, multi-platform gui library.
    *   🎉 [Dear ImGui (⭐57k)](https://github.com/ocornut/imgui) 🔥 - Bloat-free immediate mode gui library. Ported to many other languages.
    *   🔒 [FLTK (⭐1.6k)](https://github.com/fltk/fltk) - Fast Light Toolkit, cross-platform gui. \[[Website](https://www.fltk.org/)]
    ...
    *   ⭐ [Portable File Dialogs (⭐1k)](https://github.com/samhocevar/portable-file-dialogs) - Single-header C++11 native dialogs on Windows, macOS, and Linux.
    *   🔒 [Qt](https://github.com/qt) - Industry standard gui library. \[[Awesome (⭐87)](https://github.com/mikeroyal/Qt-Guide) | [Website](https://www.qt.io)]
    *   ⭐ [RmlUi (⭐2.6k)](https://github.com/mikke89/RmlUi) - Turns HTML / CSS source files into vertices and draw commands. \[[Docs](https://mikke89.github.io/RmlUiDoc/)]
    *   ⭐ [Turbo Badger (⭐578)](https://github.com/fruxo/turbobadger) - Gui library for hardware accelerated apps & games. \[[Oryol Example](https://floooh.github.io/oryol-samples/wasm/TurboBadgerDemo.html)]
    *   🔒 [Wt (⭐1.7k)](https://github.com/emweb/wt) - Web gui library in modern C++. \[[Website](https://www.webtoolkit.eu/wt)]
    *   🔒 [wxWidgets (⭐5.9k)](https://github.com/wxWidgets/wxWidgets) - Cross-platform gui using native controls. \[[Website](https://wxwidgets.org)]
*   C++: Lighting
    *   🎉 [Thekla Atlas (⭐447)](https://github.com/Thekla/thekla_atlas) - Atlas generation tool.
    *   🎉 [UVAtlas (⭐815)](https://github.com/Microsoft/UVAtlas) - DirectX library for creating and packing texture atlases.
*   C++: Network
...
*   C++: Scripting
    ...
    *   🔒 [ArkScript (⭐572)](https://github.com/ArkScript-lang/Ark) - Small, fast, functional and scripting language.
...
*   C++: Utility
    *   🎉 [Any-Lite (⭐133)](https://github.com/martinmoene/any-lite) - Header-only 'any' type for C++98 and above.
    *   🎉 [EASTL (⭐7.8k)](https://github.com/electronicarts/EASTL/) - Electronic Arts STL replacement, emphasis on performance.
    *   🎉 [faker-cxx (⭐220)](https://github.com/cieslarmichal/faker-cxx) - C++20 Faker library for generating fake (but realistic) data for testing and development.
    *   🎉 [Parallel Hashmap (⭐2.4k)](https://github.com/greg7mdp/parallel-hashmap) - Header-only, fast and memory-friendly hashmap and binary tree containers.
    *   🎉 [Spdlog (⭐23k)](https://github.com/gabime/spdlog) - Fast logging library.
    *   🎉 [Tiny-Process-Library](https://gitlab.com/eidheim/tiny-process-library) - Making it simple to create and stop new processes.
    *   🎉 [TinyXML-2 (⭐4.9k)](https://github.com/leethomason/tinyxml2) - XML parser that can be easily integrated into other programs.
*   C++: Visual Programming / Nodes
    *   🎉 [NodeEditor (⭐2.9k)](https://github.com/paceholder/nodeeditor) - Graph-controlled data processing, built with *Qt*.
    ...
    *   🎉 [Visual Script Engine (⭐179)](https://github.com/kovacsv/VisualScriptEngine) - Visual scripting engine designed for embedding.
...
*   C#: Audio
    *   🎉 [NAudio (⭐5.4k)](https://github.com/naudio/NAudio) - Audio and MIDI library for .NET.
*   C#: Physics
    *   🎉 [Aether Physics (⭐367)](https://github.com/tainicom/Aether.Physics2D) - 2D physics library with continuous collision detection.
    *   🎉 [Velcro Physics (⭐664)](https://github.com/Genbox/VelcroPhysics) - C# port of Box2D. Formerly *Farseer Physics*.
*   C#: Utility
    *   🎉 [Facepunch.Steamworks (⭐2.8k)](https://github.com/Facepunch/Facepunch.Steamworks) - Steamworks implementation.
...
*   📚 [Awesome Go (⭐124k)](https://github.com/avelino/awesome-go) - Awesome Go frameworks, libraries and software.
*   Go: Audio
    *   🎉 [Beep (⭐2k)](https://github.com/faiface/beep) - Playback and audio-processing.
*   Go: Geometry
    *   🎉 [3D Mesh Simplification (⭐244)](https://github.com/fogleman/simplify) - 3D mesh simplification.
*   Go: Graphics
...
*   Haxe: Game Framework
    *   🎉 [Ceramic (⭐247)](https://github.com/ceramic-engine/ceramic) - Cross-platform 2D framework. \[[Examples](https://ceramic-engine.com/examples/)]
    ...
    *   🎉 [gameBase (⭐582)](https://github.com/deepnight/gameBase) - Base structure for Haxe games, using *Heaps* graphics framework. \[[Tutorial](https://deepnight.net/tutorial/using-my-gamebase-to-create-a-heaps-game/)]
...
*   Haxe: Serialization / Storage
    *   🎉 [CastleDB (⭐546)](https://github.com/ncannasse/castle) - Structured database with a local web service to edit it.
    *   🎉 [Format (⭐127)](https://github.com/HaxeFoundation/format) - Various files formats support for Haxe.
    *   🎉 [HxBit (⭐151)](https://github.com/HeapsIO/hxbit) - Binary serialization and network synchronization library.
...
*   Lua: Game Framework
    *   🎉 [3DreamEngine (⭐367)](https://github.com/3dreamengine/3DreamEngine) - 3D engine on top of *LÖVE*.
    *   🎉 [Gideros (⭐556)](https://github.com/gideros/gideros) - 2D/3D cross-platform games with Lua. \[[Website](http://giderosmobile.com/)]
    *   🎉 [INSTEAD (⭐216)](https://github.com/instead-hub/instead) - Simple Text Adventure Interpreter.
    *   🎉 [LÖVE (⭐4.6k)](https://github.com/love2d/love) - 2D framework for writing game code with Lua. \[[Awesome (⭐3.1k)](https://github.com/love2d-community/awesome-love2d) | [Website](https://love2d.org)]

### Libraries / Java

*   📚 [Awesome Java (⭐41k)](https://github.com/akullpp/awesome-java) - Awesome frameworks, libraries and software for Java.

### Libraries / JavaScript

*   JavaScript: Cross-Platform
    *   🎉 [Apache Cordova](https://cordova.apache.org) - Mobile apps (iOS / Android) with with JavaScript, HTML, and CSS.
    *   🎉 [Electron (⭐113k)](https://github.com/electron/electron) - Cross-platform desktop apps with JavaScript, HTML, and CSS. \[[Website](https://www.electronjs.org/)]
    ...
    *   🎉 [React Native (⭐117k)](https://github.com/facebook/react-native) - Framework for building native apps using React. \[[Website](https://reactnative.dev/)]
    *   🎉 [Tauri (⭐79k)](https://github.com/tauri-apps/tauri) - Smaller, faster, and more secure desktop applications. \[[Website](https://tauri.app/)]
...
*   JavaScript: Entity Component System
    *   🎉 [Becsy (⭐183)](https://github.com/LastOliveGames/becsy) - Multithreaded ECS for TypeScript and JavaScript.
    *   🔒 [bitECS (⭐867)](https://github.com/NateTheGreatt/bitECS) - Functional, minimal, data-oriented, ultra-high performance ECS library.
    *   🎉 [Ecsy (⭐1.1k)](https://github.com/ecsyjs/ecsy) - Experimental ECS aiming to be lightweight, easy to use.
    *   🎉 [Miniplex (⭐792)](https://github.com/hmans/miniplex) - Entity management system for games.
...
*   JavaScript: Geometry
    *   🎉 [Convexhull.js (⭐26)](https://github.com/indy256/convexhull-js) - High-performance JavaScript 2D convex hull library.
    ...
    *   🎉 [Poly-Decomp.js (⭐422)](https://github.com/schteppe/poly-decomp.js) - Decompose 2D polygons into convex pieces.
*   JavaScript: Graphics - Three.js
    ...
    *   🎉 [Sketchbook (⭐1.4k)](https://github.com/swift502/Sketchbook) - 3D playground built on Three.js and Cannon.js.
...
*   JavaScript: Graphics - Three.js - React
    *   🎉 [drei (⭐7.8k)](https://github.com/pmndrs/drei) - Useful helpers for react-three-fiber.
    *   🎉 [gltfjsx (⭐4.4k)](https://github.com/pmndrs/gltfjsx) - Turns GLTFs into JSX components.
    *   🎉 [react-three-fiber (⭐27k)](https://github.com/pmndrs/react-three-fiber) - React renderer for Three.js.
*   JavaScript: Layout
...
*   JavaScript: Physics
    *   🎉 [Ammo.js (⭐4.1k)](https://github.com/kripken/ammo.js) - *Bullet 3D* Physics engine ported as WebAssembly.
    ...
    *   🎉 [Goblin Physics (⭐147)](https://github.com/chandlerprall/GoblinPhysics) - 3D physics engine written from the ground up in JavaScript. \[[Demos](http://www.goblinphysics.com/)]
    *   🎉 [JoltPhysics.js (⭐212)](https://github.com/jrouwe/JoltPhysics.js) - Port of *Jolt Physics* to JavaScript (as WebAssembly). \[[Demos](https://jrouwe.github.io/JoltPhysics.js/)]
    ...
    *   🎉 [Particulate.js (⭐337)](https://github.com/jpweeks/particulate-js) - Particle physics library designed to be simple, fast and stable.
    ...
    *   🎉 [Verly.js (⭐649)](https://github.com/anuraghazra/Verly.js) - Easy to integrate verlet physics engine. \[[Demos](https://anuraghazra.dev/Verly.js/)]

### Libraries / Kotlin

*   Kotlin: Game Framework
    *   🎉 [FXGL (⭐4.2k)](https://github.com/AlmasB/FXGL) - Game library for 2D, experimental 3D.
    *   🎉 [Kool (⭐272)](https://github.com/fabmax/kool) - Multi-platform 3D Vulkan / OpenGL graphics engine. \[[Examples](https://fabmax.github.io/kool/kool-js/)]
    *   🎉 [KTX (⭐1.3k)](https://github.com/libktx/ktx) - Kotlin extensions for the *libGDX* game framework.

### Libraries / Pascal

*   📚 [Awesome Pascal (⭐1.8k)](https://github.com/Fr0sT-Brutal/awesome-pascal) - Curated list of Delphi / Pascal resources.
*   Pascal: Game Framework
    *   🎉 [Apus (⭐167)](https://github.com/Cooler2/ApusGameEngine) - Cross-platform library for making 2D games.
*   Pascal: Physics
    *   🎉 [Kraft (⭐102)](https://github.com/BeRo1985/kraft) - Object Pascal 3D physics engine.

### Libraries / Python

*   📚 [Awesome Python (⭐211k)](https://github.com/vinta/awesome-python) - List of awesome Python frameworks, libraries, software and more.
...
*   Ruby: Graphics - 3D
    *   🎉 [Mittsu (⭐504)](https://github.com/danini-the-panini/mittsu) - 3D graphics library based heavily on *Three.js*.
*   Ruby: Gui
    *   🎉 [Glimmer (⭐525)](https://github.com/andyobtiva/glimmer) - Gui library and DSL (domain specific language) framework.
    *   🎉 [Shoes (⭐1.6k)](https://github.com/shoes/shoes4) - Cross-platform gui library. \[[Website](http://shoesrb.com/)]

### Libraries / Rust

*   📚 [Awesome Rust (⭐44k)](https://github.com/rust-unofficial/awesome-rust) - Curated list of Rust code and resources.
...
*   Zig: File System
    *   🎉 [Known Folders (⭐210)](https://github.com/ziglibs/known-folders) - Provides access to well-known folders across several operating systems.
*   Zig: Game Framework
    *   🎉 [Zig-Gamedev Project (⭐2.1k)](https://github.com/michal-z/zig-gamedev) - Sample apps and libraries using DirectX 12.
*   Zig: Scripting
...
*   📚 [Red, Yellow, and Blue](https://daveeddy.com/2014/07/01/red-yellow-and-blue/) - Convert colors from the paint color wheel to RGB space. \[[Source (⭐74)](https://github.com/bahamas10/ryb)]
...
*   📚 [Nomad Game Engine](https://savas.ca/nomad) - Articles building an ECS from the ground up in C++. \[[Source (⭐184)](https://github.com/taurheim/NomadECS)]
...
*   🔒 [Fluids-2D](https://www.csc.kth.se/~mathar/fluids-2d/) - Real-time fluid dynamics on the GPU with the help of WebGL and Three.js. \[[Source (⭐401)](https://github.com/mharrys/fluids-2d)]
...
*   CSG (Constructive Solid Geometry)
    ...
    *   🎉 [three-bvh-csg (⭐546)](https://github.com/gkjohnson/three-bvh-csg) - Fast and dynamic CSG on top of three-mesh-bvh.
    *   🎉 [three-csgmesh (⭐441)](https://github.com/manthrax/THREE-CSGMesh) - Conversion of the csg.js library for use with Three.js.
*   Smoothing
...
*   Soft Body
    ...
    *   🌎 [Three.js: Ammo Volume](https://threejs.org/examples/?q=physics#physics_ammo_volume) - 3D soft body volumes using *Ammo.js* and *Three.js*. \[[Source (⭐100k)](https://github.com/mrdoob/three.js/blob/master/examples/physics_ammo_volume.html)]
*   Water / Buoyancy
...
*   📚 [Scriptorium (⭐494)](https://github.com/r-lyeh-archived/scriptorium) - Game scripting languages benchmarked.
...
*   Bloom
    ...
    *   🌎 [Three.js: Bloom Example](https://threejs.org/examples/?q=bloom#webgl_postprocessing_unreal_bloom) - WebGL bloom postprocessing using *Three.js*. \[[Source (⭐100k)](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_unreal_bloom.html)]
...
*   Noise
    ...
    *   🎉 [Psrdnoise (⭐219)](https://github.com/stegu/psrdnoise/) - Tiling simplex flow noise in 2D/3D.
    ...
    *   🎉 [WebGL Noise (⭐465)](https://github.com/stegu/webgl-noise/) - Maintained branch of the original *Ashima Arts* 2D, 3D and 4D noise functions.
*   Outlines
    ...
    *   🎉 [Outline Shader](https://www.reddit.com/r/godot/comments/8g067a/the_perfect_outline_shader_atleast_close/) - Nice outline shader. \[[Source (⭐87)](https://github.com/steincodes/godot-shader-tutorials)]
    *   📚 [Outlines w/Surface IDs](https://omar-shehata.medium.com/better-outline-rendering-using-surface-ids-with-webgl-e13cdab1fd94) - Technique combining depth, normals and surface IDs. \[[Source (⭐360)](https://github.com/OmarShehata/webgl-outlines)]
...
*   Pixelation
    ...
    *   🌎 [Three.js: Pixelation Example](https://threejs.org/examples/?q=pixel#webgl_postprocessing_pixel) - WebGL pixelation postprocessing using *Three.js*. \[[Source (⭐100k)](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_pixel.html)]
*   Postprocessing
    *   📚 [Image Editor Effects](https://alain.xyz/blog/image-editor-effects) - WebGL image filters / effects shaders. \[[Source (⭐89)](https://github.com/alaingalvan/image-editor-effects)]
*   Upscaling
...
*   📚 [Signed Distance Field Resources (⭐620)](https://github.com/CedricGuillemet/SDF) - Tutorials, papers, software, demos, discussions, etc.
...
*   Sound Effects
    *   🆓 [Bfxr](https://www.bfxr.net) - Classic. For making simple sound effects for games. \[[Source (⭐955)](https://github.com/increpare/bfxr)]
    ...
    *   🆓 [ZzFX](https://killedbyapixel.github.io/ZzFX/) - Tiny JavaScript sound FX system / Zuper Zmall Zound Zynth. \[[Source (⭐525)](https://github.com/KilledByAPixel/ZzFX)]
...
*   Modeling
    ...
    *   📚 [NeRF](https://www.matthewtancik.com/nerf) - View synthesis of scenes as neural radiance fields. \[[Source (⭐9.6k)](https://github.com/bmild/nerf)]
...
*   🆓 [TrenchBroom](https://trenchbroom.github.io) - Level editor for *Quake-Engine* games. \[[Source](https://github.com/TrenchBroom/TrenchBroom)]
...
*   🆓 [Material Maker](https://www.materialmaker.org) - Procedural [physically-based rendering](https://en.wikipedia.org/wiki/Physically_based_rendering) material maker. \[[Source (⭐3.3k)](https://github.com/RodZill4/material-maker)]
...
*   🆓 [Krita](https://krita.org/en/) - Professional quality, open source painting. \[[Source (⭐6.9k)](https://github.com/KDE/krita)]
*   💰 [Vec Maker](https://kronbits.itch.io/vecmaker) - Easy to use vector design.

### Tools / Software / Voxel

*   🎉 [IsoVoxel (⭐346)](https://github.com/tommyettinger/IsoVoxel) - Generates isometric pixel art from *MagicaVoxel* .vox files.
...
*   🔒 [Doom 3 (⭐3k)](https://github.com/id-Software/DOOM-3) - Doom 3 GPL source release.
...
*   🌎 [Kotlin](https://kotlinlang.org/) - General-purpose language, interoperates with Java. \[[GitHub (⭐48k)](https://github.com/JetBrains/kotlin)]
...
*   🆓 [Radiant](https://icculus.org/gtkradiant/) - Cross-platform level editor for [idTech](https://en.wikipedia.org/wiki/Id_Tech) games. \[[Source (⭐580)](https://github.com/TTimo/GtkRadiant)]
...
*   🌎 [Haxe](https://haxe.org) - Produce cross-platform native code. \[[GitHub (⭐6k)](https://github.com/HaxeFoundation/haxe)]
...
*   🌎 [Ruby](https://www.ruby-lang.org/en/) - Dynamic programming language, focused on simplicity / productivity. \[[GitHub (⭐22k)](https://github.com/ruby/ruby)]
...
*   Music
    *   🆓 [Ardour](https://ardour.org) - Record, edit, and mix. \[[Source (⭐3.7k)](https://github.com/Ardour/ardour)]
    *   🆓 [Audacity](https://www.audacityteam.org) - Multi-track audio editor and recorder. \[[Source (⭐12k)](https://github.com/audacity/audacity)]
    ...
    *   🆓 [LMMS](https://lmms.io) 🔥 - Cross-platform music production software. \[[Source (⭐7.8k)](https://github.com/lmms/lmms)]
    *   🆓 [PixiTracker](https://warmplace.ru/soft/pixitracker/) - Quickly create musical sketches, chiptunes and sound experiments.
    *   🆓 [Sound Box](https://sb.bitsnbites.eu) - Compose synthetic music in your browser, good for small demos. \[[Source (⭐427)](https://github.com/mbitsnbites/soundbox)]
    ...
    *   🆓 [ZzFXM](https://keithclark.github.io/ZzFXM/tracker/) - Music generator for use in tiny JavaScript apps. \[[Source (⭐414)](https://github.com/keithclark/ZzFXM)]
...
*   🆓 [GIMP](https://www.gimp.org) - GNU Image Manipulation Program, open source image editor. \[[Source (⭐4.6k)](https://github.com/GNOME/gimp)]

### Tools / Software / Materials / Textures

*   🆓 [ArmorLab](https://armorlab.org) - Generate PBR materials by drag & dropping your photos. \[[Source (⭐167)](https://github.com/armory3d/armorlab)]
...
*   💸 [Aseprite](https://www.aseprite.org) - Animated sprite editor and pixel art tool. \[[Source (⭐27k)](https://github.com/aseprite/aseprite)]

### Tools / Software / Vector Editors

*   🆓 [Inkscape](https://inkscape.org) - Cross-platform, open source vector graphics editor. \[[Source (⭐2k)](https://github.com/inkscape/inkscape)]
