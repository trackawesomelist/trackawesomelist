...
*   Rust: Game Framework
    ...
    *   🎉 [Macroquad (⭐2.9k)](https://github.com/not-fl3/macroquad) - Easy to use game library, heavily inspired by *RayLib*.
...
*   🔒 [HARFANG 3D (⭐510)](https://github.com/harfang3d/harfang3d) - 3D visualization library for industry professionals, usable in C++, Python, Lua, Go.
...
*   🆓 [Radiant](https://icculus.org/gtkradiant/) - Cross-platform level editor for [idTech](https://en.wikipedia.org/wiki/Id_Tech) games. \[[Source (⭐578)](https://github.com/TTimo/GtkRadiant)]
...
*   Music
    ...
    *   🆓 [LMMS](https://lmms.io) 🔥 - Cross-platform music production software. \[[Source (⭐7.6k)](https://github.com/lmms/lmms)]
    ...
    *   🆓 [ZzFXM](https://keithclark.github.io/ZzFXM/tracker/) - Music generator for use in tiny JavaScript apps. \[[Source (⭐408)](https://github.com/keithclark/ZzFXM)]
