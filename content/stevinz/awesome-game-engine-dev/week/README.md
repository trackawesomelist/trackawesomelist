...
*   🆓 [Pmndrs Market (⭐244)](https://github.com/pmndrs/market) - Collection of public domain models.
...
*   🎉 [Ren'Py (⭐4.4k)](https://github.com/renpy/renpy) - Visual novel engine. \[[Website](https://www.renpy.org/)]
...
*   Rust: Graphics - 3D
    ...
    *   🎉 [Vulkano (⭐4.2k)](https://github.com/vulkano-rs/vulkano) - Safe and rich wrapper around the Vulkan API.
...
*   C++: Graphics - 2D
    ...
    *   🎉 [Skia (⭐8.3k)](https://github.com/google/skia) - Complete 2D graphics library used in Chrome by *Google*. \[[Website](https://skia.org)]
...
*   JavaScript: Docking
    *   🎉 [Dock Spawn TS (⭐111)](https://github.com/node-projects/dock-spawn-ts) - Maintained, TypeScript version of [Dock Spawn (⭐255)](https://github.com/coderespawn/dock-spawn), a JavaScript docking framework.
...
*   📚 [CoolEngines (⭐49)](https://github.com/JohnClarking/CoolEngines) - List of open source graphic & game engines.
...
*   💸 [Unity](https://unity.com) - Biggest name in game engines, industry standard. \[[Awesome (⭐6.2k)](https://github.com/RyanNielson/awesome-unity)]
*   💸 [Unreal Engine](https://www.unrealengine.com) - AAA quality, insane feature set, photoreal visuals. \[[Awesome (⭐955)](https://github.com/insthync/awesome-ue4#readme)]
...
*   🆓 [Evergine](https://evergine.com) - High-quality 3D and 2D solutions. Formerly *Wave Engine*. \[[Samples (⭐115)](https://github.com/EvergineTeam/Samples)]
...
*   💸 [Construct](https://www.construct.net/) - Drag and drop game builder. \[[Awesome (⭐67)](https://github.com/ConstructCommunity/awesome-construct#readme)]
...
*   💰 [Phaser Editor 2D](https://phasereditor2d.com) - Commercial, web-based editor for *Phaser*. \[[GitHub (⭐382)](https://github.com/PhaserEditor2D/PhaserEditor2D-v3)]
*   💸 [PlayCanvas](https://playcanvas.com) - Popular (Flappy Bird), WebGL game engine. \[[Awesome (⭐229)](https://github.com/playcanvas/awesome-playcanvas#readme) | [GitHub (⭐8.9k)](https://github.com/playcanvas/engine)]
...
*   💸 [Stencyl](https://www.stencyl.com/) - Quick and easy game making with visual scripting. \[[GitHub (⭐185)](https://github.com/Stencyl/stencyl-engine)]

### Game Engines / Specialty

*   💸 [DopeFish](https://subpixel-studios.itch.io/dopefish) - Doom / Heretic map loading system for *GameMaker*.
*   🔒 [HARFANG 3D (⭐442)](https://github.com/harfang3d/harfang3d) - 3D visualization library for industry professionals, usable in C++, Python, Lua, Go.
...
*   Graphics API: DirectX
    *   🌎 [DirectX](https://docs.microsoft.com/en-us/windows/win32/directx) - Microsoft API used to create 2D/3D games and apps. \[[Blog](https://devblogs.microsoft.com/directx/) | [Samples (⭐5.6k)](https://github.com/microsoft/DirectX-Graphics-Samples)]
...
*   Graphics API: Vulkan
    *   🌎 [Vulkan](https://www.vulkan.org) - Modern cross-platform graphics API. \[[Samples (⭐3.7k)](https://github.com/khronosGroup/Vulkan-samples)]
...
*   Graphics API: WebGL
    ...
    *   📚 [WebGL 2 Samples (⭐995)](https://github.com/WebGLSamples/WebGL2Samples) - Short and easy to understand samples demonstrating WebGL 2 features.
...
*   Graphics API: WebGPU
    ...
    *   🌎 [WebGPU (⭐4.4k)](https://github.com/gpuweb/gpuweb/wiki/Implementation-Status) - Next generation web 3D graphics API. \[[GitHub (⭐4.4k)](https://github.com/gpuweb/gpuweb)]
...
*   Platform: XNA
    ...
    *   📚 [Riemer's MonoGame Tutorials (⭐634)](https://github.com/SimonDarksideJ/XNAGameStudio/wiki/RiemersArchiveOverview) - Everything you need to start programming with MonoGame.
    *   📚 [XNA Game Studio Archive (⭐634)](https://github.com/SimonDarksideJ/XNAGameStudio) 🔥 - Required visit for [MonoGame](https://en.wikipedia.org/wiki/MonoGame) / [FNA](https://fna-xna.github.io/) / [XNA](https://en.wikipedia.org/wiki/Microsoft_XNA) developers.
...
*   📚 [Every Programmer Should Know (⭐75k)](https://github.com/mtdvio/every-programmer-should-know) - Technical things every developer should know.
...
*   BASIC: App Framework
    ...
    *   🎉 [QB64 (⭐641)](https://github.com/QB64Team/qb64) - Modern BASIC+OpenGL language, retains QBasic/QB4.5 compatibility.
...
*   C: Entity Component System
    *   🎉 [Flecs (⭐5.2k)](https://github.com/SanderMertens/flecs) - Fast and lightweight entity component system in C99.
*   C: File System
    *   🎉 [HexEmbed (⭐42)](https://github.com/codeplea/hexembed) - Small utility to help embed files in C/C++ programs in an easy, cross-platform way.
    *   ⭐ [Incbin (⭐887)](https://github.com/graphitemaster/incbin) - Include binary and text files in your C/C++ apps with ease.
    *   🎉 [PhysicsFS (⭐457)](https://github.com/icculus/physfs) - Portable, flexible file I/O abstraction. Provides access to various archives.
    *   ⭐ [Where Am I (⭐429)](https://github.com/gpakosz/whereami) - Locates the current path on the local file system.
*   C: Fonts
    *   🎉 [Font Stash (⭐635)](https://github.com/memononen/fontstash) - Lightweight library that uses stb\_truetype to render fonts to a texture atlas.
    *   🎉 [IconFontCppHeaders (⭐1.1k)](https://github.com/juliettef/IconFontCppHeaders) - C/C++ headers and C# classes for icon fonts.
    *   🎉 [msdf-c (⭐108)](https://github.com/solenum/msdf-c) - Multi-channel signed distance field generator.
...
*   C: Game Engine w/Editor
    ...
    *   🎉 [TIC-80 (⭐4.6k)](https://github.com/nesbox/TIC-80) - Virtual computer for making & sharing tiny games. \[[Website](https://tic80.com/)]
*   C: Game Framework
    *   🎉 [CGL (⭐383)](https://github.com/Jaysmito101/cgl) - Single-header file, lots of graphics & utility functions.
    *   🎉 [DOME (⭐453)](https://github.com/domeengine/dome) - Melds SDL2 and the Wren scripting language. \[[Website](https://domeengine.com/)]
    *   🎉 [Entrypoint (⭐70)](https://github.com/jimon/entrypoint) - Lightweight entry point for games.
    *   ⭐ [FWK (⭐104)](https://github.com/r-lyeh/FWK) - 3D game framework.
...
*   C: Geometry
    ...
    *   🎉 [Marching Squares (⭐843)](https://github.com/prideout/par/blob/master/par_msquares.h) - Convert images into triangles. \[[Info](https://prideout.net/marching-squares)]
    *   🎉 [Octasphere (⭐843)](https://github.com/prideout/par/blob/master/par_octasphere.h) - Generates triangle meshes for spheres, boxes, and capsules. \[[Info](https://prideout.net/blog/octasphere/)]
    *   🎉 [Par\_Shapes (⭐843)](https://github.com/prideout/par/blob/master/par_shapes.h) - Triangle meshes including solids, spheres and more. \[[Info](https://prideout.net/shapes)]
    *   🎉 [Par\_Streamlines (⭐843)](https://github.com/prideout/par/blob/master/par_streamlines.h) - Triangulating thick lines, béziers, streamlines. \[[Demo (⭐27)](https://github.com/prideout/streamlines_demo) | [Info](https://prideout.net/blog/par_streamlines/)]
*   C: Graphics - 2D
    *   🎉 [NanoVG (⭐4.9k)](https://github.com/memononen/nanovg) - OpenGL-based 2D vector drawing library for UI and visualizations.
    *   🎉 [Tilengine (⭐753)](https://github.com/megamarc/Tilengine) - 2D graphics with raster effects for retro style game development.
*   C: Graphics - 3D
    *   🎉 [Sokol Gfx (⭐5.5k)](https://github.com/floooh/sokol/blob/master/sokol_gfx.h) - Cross-platform, single-file graphics. \[[Examples](https://floooh.github.io/sokol-html5/)]
    *   🎉 [Sokol Graphics Painter (⭐367)](https://github.com/edubart/sokol_gp) - 2D graphics painter implemented with Sokol.
*   C: Gui
    *   🎉 [cImgui (⭐1.3k)](https://github.com/cimgui/cimgui) - Thin C wrapper generated for Dear ImGui.
    *   🎉 [lvgl (⭐14k)](https://github.com/lvgl/lvgl) 🔥 - Embedded gui library, many widgets and advanced visual effects.
    *   🎉 [NAppGUI (⭐389)](https://github.com/frang75/nappgui_src) - Professional, well documented SDK to build desktop apps.
    *   🎉 [Native File Dialog (⭐1.7k)](https://github.com/mlabbe/nativefiledialog) - Portably invoke native file open / save dialogs.
    *   🎉 [Nuklear (⭐8.2k)](https://github.com/Immediate-Mode-UI/Nuklear) - Single-header immediate mode cross-platform gui library.
*   C: Input
    *   🎉 [libGamepad (⭐22)](https://github.com/mtwilliams/libgamepad) - Cross-platform library for gamepad input.
    *   🎉 [Sokol Gamepad (⭐5.5k)](https://github.com/floooh/sokol/pull/393/commits/26a9da9dafd4adb22a1ace0de0d2569da31ae427) - Branch with addon support for gamepads in Sokol.
*   C: Libraries
    ...
    *   ⭐ [Pico Headers (⭐167)](https://github.com/empyreanx/pico_headers) - Single-file, cross-platform libraries for game development.
    *   📚 [Single-file Libs (⭐8.5k)](https://github.com/nothings/single_file_libs) - Amazing collection of single-file C/C++ libraries compiled from many authors.
...
*   C: Math
    ...
    *   🎉 [Kazmath (⭐515)](https://github.com/Kazade/kazmath) - Math library targeted at games.
...
*   C++: Entity Component System
    ...
    *   🎉 [Entt (⭐9.2k)](https://github.com/skypjack/entt) - Gaming meets modern C++, a fast and reliable entity component system.
*   C++: File Formats
    *   ⭐ [Jpeg-Compressor (⭐195)](https://github.com/richgel999/jpeg-compressor) - Single-file library that writes baseline JPEG compressed images.
    *   🎉 [TinyDNG (⭐136)](https://github.com/syoyo/tinydng) - Header-only DNG / TIFF loader and writer.
    *   🎉 [TinyEXR (⭐647)](https://github.com/syoyo/tinyexr) - Tiny OpenEXR image loader / saver library.
    *   🎉 [TinyGLTF (⭐1.8k)](https://github.com/syoyo/tinygltf) - Header-only C++11 tiny glTF 2.0 library.
    *   🎉 [TinyOBJLoader (⭐3.1k)](https://github.com/tinyobjloader/tinyobjloader) - Tiny but powerful single-file wavefront obj loader.
*   C++: File System
    *   🎉 [Imgui-Filebrowser (⭐565)](https://github.com/AirGuanZ/imgui-filebrowser) - Header-only file browser implementation for Dear ImGui in C++17.
*   C++: Game Framework
    *   🎉 [Acid (⭐1.6k)](https://github.com/EQMG/Acid) - Modern C++17 and structured to be fast, simple, and modular.
    *   🎉 [blah (⭐525)](https://github.com/NoelFB/blah) - Small 2D game framework.
    *   🎉 [Cocos2d-x (⭐18k)](https://github.com/cocos2d/cocos2d-x) - Widely used in indie game dev community.
    *   🎉 [Cute Framework (⭐464)](https://github.com/RandyGaul/cute_framework) - Simple and consise framework for making 2D games.
    ...
    *   🎉 [is::Engine (⭐191)](https://github.com/Is-Daouda/is-Engine) - 2D framework built on SDL2 and SFML.
    *   🎉 [JNGL (⭐201)](https://github.com/jhasse/jngl) - 2D framework. Develop anywhere, deploy everywhere.
    *   🔒 [KlayGE (⭐2k)](https://github.com/gongminmin/KlayGE) - Cross-platform game framework with plugin-based architecture.
    *   🎉 [Koala Engine (⭐584)](https://github.com/phisko/kengine) - Framework with an ECS architecture, aka *Kengine*.
    *   🎉 [Lumino (⭐198)](https://github.com/LuminoEngine/Lumino) - Framework for building real-time graphics apps.
    *   🎉 [Nazara Engine (⭐625)](https://github.com/NazaraEngine/NazaraEngine) - Custom shaders, ECS, 2D/3D, networking and more.
    *   🎉 [nCine (⭐951)](https://github.com/nCine/nCine) - Cross-platform 2D game framework.
    ...
    *   🎉 [Supernova (⭐210)](https://github.com/supernovaengine/supernova) - Cross-platform for 2D/3D projects.
    *   🎉 [Thunder (⭐472)](https://github.com/thunder-engine/thunder) - Cross-platform 2D/3D with module architecture.
...
*   C++: Geometry
    *   🎉 [CinoLib (⭐788)](https://github.com/mlivesu/cinolib) - Header-only library for processing polygonal and polyhedral meshes.
    *   🎉 [Delabella (⭐205)](https://github.com/msokalski/delabella) - Super stable 2D delaunay triangulation.
    ...
    *   🔒 [Generator (⭐200)](https://github.com/ilmola/generator) - Procedural geometry generation library for C++11.
    *   🎉 [Geometric Tools](https://www.geometrictools.com/index.html) - Mathematics, geometry, graphics, image analysis and physics in C++14.
    *   🎉 [GeometronLib (⭐84)](https://github.com/LukasBanana/GeometronLib) - Meshes for 3D shapes (cube, sphere, etc.) and ray / geometry intersection.
    *   🔒 [Libigl (⭐4.3k)](https://github.com/libigl/libigl) - Simple geometry processing library.
    *   🎉 [MeshOptimizer (⭐4.8k)](https://github.com/zeux/meshoptimizer) - Mesh optimization library that makes meshes smaller and faster to render.
    ...
    *   🎉 [PolyPartition (⭐592)](https://github.com/ivanfratric/polypartition) - 2D polygon partitioning and triangulation.
    ...
    *   🎉 [Recast & Detour (⭐6k)](https://github.com/recastnavigation/recastnavigation) - Navigation-mesh toolset for games.
    *   🎉 [Seam-aware Decimater (⭐466)](https://github.com/songrun/SeamAwareDecimater) - Simplifies mesh while preserving UVs, based on [Seamless](https://cragl.cs.gmu.edu/seamless/).
    *   🎉 [Spheres (⭐249)](https://github.com/caosdoar/spheres) - Four methods to create a sphere mesh.
...
*   C++: Graphics - 3D
    ...
    *   🎉 [Diligent Engine (⭐3.2k)](https://github.com/DiligentGraphics/DiligentEngine) - Modern cross-platform graphics API abstraction library.
    ...
    *   🎉 [Forge (⭐4.3k)](https://github.com/ConfettiFX/The-Forge) 🔥 - Cross-platform rendering framework supporting all major platforms and consoles.
    ...
    *   🎉 [Ogre (⭐3.6k)](https://github.com/OGRECave/ogre) - Scene-oriented, flexible 3D engine.
    *   🎉 [OSRE (⭐176)](https://github.com/kimkulling/osre) - Just another "Open Source Render Engine".
    *   🔒 [StratusGFX (⭐570)](https://github.com/KTStephano/StratusGFX) - Realtime 3D rendering engine implementing modern graphics techniques.
    *   🎉 [Threepp (⭐523)](https://github.com/markaren/threepp) - Cross-platform C++17 port of the popular 3D JavaScript library Three.js (r129).
    *   🎉 [Tungsten (⭐1.7k)](https://github.com/tunabrain/tungsten) - High-performance physically-based renderer in C++11.
    *   🎉 [Wicked Engine (⭐5.1k)](https://github.com/turanszkij/WickedEngine) - Engine focusing on performance & modern rendering techniques.
*   C++: Gui
    *   🎉 [Crazy Eddie's GUI (⭐412)](https://github.com/cegui/cegui) - Versatile, multi-platform gui library.
    *   🎉 [Dear ImGui (⭐54k)](https://github.com/ocornut/imgui) 🔥 - Bloat-free immediate mode gui library. Ported to many other languages.
    *   🔒 [FLTK (⭐1.4k)](https://github.com/fltk/fltk) - Fast Light Toolkit, cross-platform gui. \[[Website](https://www.fltk.org/)]
    ...
    *   ⭐ [Portable File Dialogs (⭐957)](https://github.com/samhocevar/portable-file-dialogs) - Single-header C++11 native dialogs on Windows, macOS, and Linux.
    *   🔒 [Qt](https://github.com/qt) - Industry standard gui library. \[[Awesome (⭐66)](https://github.com/mikeroyal/Qt-Guide) | [Website](https://www.qt.io)]
    *   ⭐ [RmlUi (⭐2.3k)](https://github.com/mikke89/RmlUi) - Turns HTML / CSS source files into vertices and draw commands. \[[Docs](https://mikke89.github.io/RmlUiDoc/)]
    ...
    *   🔒 [wxWidgets (⭐5.6k)](https://github.com/wxWidgets/wxWidgets) - Cross-platform gui using native controls. \[[Website](https://wxwidgets.org)]
*   C++: Lighting
    *   🎉 [Thekla Atlas (⭐431)](https://github.com/Thekla/thekla_atlas) - Atlas generation tool.
    *   🎉 [UVAtlas (⭐772)](https://github.com/Microsoft/UVAtlas) - DirectX library for creating and packing texture atlases.
*   C++: Network
...
*   C++: Scripting
    ...
    *   🔒 [ArkScript (⭐528)](https://github.com/ArkScript-lang/Ark) - Small, fast, functional and scripting language.
...
*   C++: Utility
    *   🎉 [Any-Lite (⭐130)](https://github.com/martinmoene/any-lite) - Header-only 'any' type for C++98 and above.
    *   🎉 [EASTL (⭐7.5k)](https://github.com/electronicarts/EASTL/) - Electronic Arts STL replacement, emphasis on performance.
    *   🎉 [faker-cxx (⭐165)](https://github.com/cieslarmichal/faker-cxx) - C++20 Faker library for generating fake (but realistic) data for testing and development.
    *   🎉 [Parallel Hashmap (⭐2.2k)](https://github.com/greg7mdp/parallel-hashmap) - Header-only, fast and memory-friendly hashmap and binary tree containers.
    *   🎉 [Spdlog (⭐21k)](https://github.com/gabime/spdlog) - Fast logging library.
...
*   C++: Visual Programming / Nodes
    *   🎉 [NodeEditor (⭐2.7k)](https://github.com/paceholder/nodeeditor) - Graph-controlled data processing, built with *Qt*.
    *   🎉 [QuickQanava (⭐1k)](https://github.com/cneben/QuickQanava) - Display graphs and relational content in a QtQuick-based app, in C++14.
    *   🎉 [Visual Script Engine (⭐156)](https://github.com/kovacsv/VisualScriptEngine) - Visual scripting engine designed for embedding.
...
*   C#: Audio
    *   🎉 [NAudio (⭐5.1k)](https://github.com/naudio/NAudio) - Audio and MIDI library for .NET.
*   C#: Physics
    *   🎉 [Aether Physics (⭐355)](https://github.com/tainicom/Aether.Physics2D) - 2D physics library with continuous collision detection.
    *   🎉 [Velcro Physics (⭐649)](https://github.com/Genbox/VelcroPhysics) - C# port of Box2D. Formerly *Farseer Physics*.
*   C#: Utility
    *   🎉 [Facepunch.Steamworks (⭐2.6k)](https://github.com/Facepunch/Facepunch.Steamworks) - Steamworks implementation.

### Libraries / Dart

*   📚 [Awesome Dart (⭐2.2k)](https://github.com/yissachar/awesome-dart) - Curated list of awesome Dart frameworks, libraries, and software.
*   Dart: App Framework
    *   🎉 [Flutter](https://flutter.dev) - Open source app framework by *Google*. \[[Awesome (⭐50k)](https://github.com/Solido/awesome-flutter) | [GitHub](https://github.com/flutter)]
*   Dart: File Formats
    *   🎉 [image (⭐1.1k)](https://github.com/brendan-duncan/image) - Library for decoding / encoding image formats and image processing.

### Libraries / Go

*   📚 [Awesome Go (⭐116k)](https://github.com/avelino/awesome-go) - Awesome Go frameworks, libraries and software.
*   Go: Audio
    *   🎉 [Beep (⭐2k)](https://github.com/faiface/beep) - Playback and audio-processing.
*   Go: Geometry
    *   🎉 [3D Mesh Simplification (⭐235)](https://github.com/fogleman/simplify) - 3D mesh simplification.
*   Go: Graphics
...
*   📚 [Awesome Haxe (⭐85)](https://github.com/nadako/awesome-haxe#readme) - Awesome curated list of useful Haxe links.
*   Haxe: Animation
    *   🎉 [Actuate (⭐155)](https://github.com/jgranick/actuate) - Flexible, fast "tween" library.
...
*   Haxe: Entity Component System
    *   🎉 [Ecx (⭐53)](https://github.com/eliasku/ecx) - Entity component system framework for Haxe.
    *   🎉 [GASM (⭐20)](https://github.com/HacksawStudios/GASM) - Framework agnostic entity component system for Haxe.
*   Haxe: Game Framework
    *   🎉 [Ceramic (⭐234)](https://github.com/ceramic-engine/ceramic) - Cross-platform 2D framework. \[[Examples](https://ceramic-engine.com/examples/)]
    ...
    *   🎉 [gameBase (⭐541)](https://github.com/deepnight/gameBase) - Base structure for Haxe games, using Heaps graphics framework. \[[Tutorial](https://deepnight.net/tutorial/using-my-gamebase-to-create-a-heaps-game/)]
...
*   Haxe: Physics
    ...
    *   🎉 [Nape (⭐45)](https://github.com/HaxeFlixel/nape-haxe4) - Fast, friendly 2D rigid body physics engine. \[[Demos](https://joecreates.github.io/napephys/)]
*   Haxe: Serialization / Storage
    *   🎉 [CastleDB (⭐531)](https://github.com/ncannasse/castle) - Structured database with a local web service to edit it.
    *   🎉 [Format (⭐126)](https://github.com/HaxeFoundation/format) - Various files formats support for Haxe.
    *   🎉 [HxBit (⭐145)](https://github.com/HeapsIO/hxbit) - Binary serialization and network synchronization library.
...
*   Lua: Game Framework
    *   🎉 [3DreamEngine (⭐335)](https://github.com/3dreamengine/3DreamEngine) - 3D engine on top of *LÖVE*.
    *   🎉 [Gideros (⭐536)](https://github.com/gideros/gideros) - 2D/3D cross-platform games with Lua. \[[Website](http://giderosmobile.com/)]
    *   🎉 [INSTEAD (⭐208)](https://github.com/instead-hub/instead) - Simple Text Adventure Interpreter.
    *   🎉 [LÖVE (⭐4k)](https://github.com/love2d/love) - 2D framework for writing game code with Lua. \[[Awesome (⭐2.9k)](https://github.com/love2d-community/awesome-love2d) | [Website](https://love2d.org)]

### Libraries / Java

*   📚 [Awesome Java (⭐39k)](https://github.com/akullpp/awesome-java) - Awesome frameworks, libraries and software for Java.

### Libraries / JavaScript

*   JavaScript: Cross-Platform
    *   🎉 [Apache Cordova](https://cordova.apache.org) - Mobile apps (iOS / Android) with with JavaScript, HTML, and CSS.
    *   🎉 [Electron (⭐110k)](https://github.com/electron/electron) - Cross-platform desktop apps with JavaScript, HTML, and CSS. \[[Website](https://www.electronjs.org/)]
    *   📚 [Electron Alternatives (⭐1.3k)](https://github.com/sudhakar3697/electron-alternatives) - Cross-platform gui app development options.
    ...
    *   🎉 [React Native (⭐114k)](https://github.com/facebook/react-native) - Framework for building native apps using React. \[[Website](https://reactnative.dev/)]
    *   🎉 [Tauri (⭐73k)](https://github.com/tauri-apps/tauri) - Smaller, faster, and more secure desktop applications. \[[Website](https://tauri.app/)]
...
*   JavaScript: Entity Component System
    *   🎉 [Becsy (⭐169)](https://github.com/LastOliveGames/becsy) - Multithreaded ECS for TypeScript and JavaScript.
    *   🔒 [bitECS (⭐785)](https://github.com/NateTheGreatt/bitECS) - Functional, minimal, data-oriented, ultra-high performance ECS library.
    *   🎉 [Ecsy (⭐1.1k)](https://github.com/ecsyjs/ecsy) - Experimental ECS aiming to be lightweight, easy to use.
    *   🎉 [Miniplex (⭐636)](https://github.com/hmans/miniplex) - Entity management system for games.
...
*   JavaScript: Geometry
    *   🎉 [Convexhull.js (⭐24)](https://github.com/indy256/convexhull-js) - High-performance JavaScript 2D convex hull library.
    ...
    *   🎉 [Poly-Decomp.js (⭐401)](https://github.com/schteppe/poly-decomp.js) - Decompose 2D polygons into convex pieces.
...
*   JavaScript: Graphics - Three.js - React
    *   🎉 [drei (⭐6.9k)](https://github.com/pmndrs/drei) - Useful helpers for react-three-fiber.
    *   🎉 [gltfjsx (⭐3.9k)](https://github.com/pmndrs/gltfjsx) - Turns GLTFs into JSX components.
    *   🎉 [react-three-fiber (⭐25k)](https://github.com/pmndrs/react-three-fiber) - React renderer for Three.js.
*   JavaScript: Layout
...
*   JavaScript: Physics
    ...
    *   🎉 [Cannon-es (⭐1.6k)](https://github.com/pmndrs/cannon-es) - Maintained fork of [Cannon.js (⭐4.5k)](https://github.com/schteppe/cannon.js) 3D physics engine. \[[Demos](https://pmndrs.github.io/cannon-es/)]
    *   🎉 [Goblin Physics (⭐145)](https://github.com/chandlerprall/GoblinPhysics) - 3D physics engine written from the ground up in JavaScript. \[[Demos](http://www.goblinphysics.com/)]
    ...
    *   🎉 [Verly.js (⭐631)](https://github.com/anuraghazra/Verly.js) - Easy to integrate verlet physics engine. \[[Demos](https://anuraghazra.dev/Verly.js/)]

### Libraries / Kotlin

*   Kotlin: Game Framework
    *   🎉 [FXGL (⭐4k)](https://github.com/AlmasB/FXGL) - Game library for 2D, experimental 3D.
    *   🎉 [Kool (⭐231)](https://github.com/fabmax/kool) - Multi-platform 3D Vulkan / OpenGL graphics engine. \[[Examples](https://fabmax.github.io/kool/kool-js/)]
...
*   Pascal: Physics
    *   🎉 [Kraft (⭐100)](https://github.com/BeRo1985/kraft) - Object Pascal 3D physics engine.

### Libraries / Python

*   📚 [Awesome Python (⭐196k)](https://github.com/vinta/awesome-python) - List of awesome Python frameworks, libraries, software and more.
...
*   Ruby: Gui
    *   🎉 [Glimmer (⭐470)](https://github.com/andyobtiva/glimmer) - Gui library and DSL (domain specific language) framework.
    *   🎉 [Shoes (⭐1.6k)](https://github.com/shoes/shoes4) - Cross-platform gui library. \[[Website](http://shoesrb.com/)]

### Libraries / Rust

*   📚 [Awesome Rust (⭐41k)](https://github.com/rust-unofficial/awesome-rust) - Curated list of Rust code and resources.

### Libraries / Zig

*   📚 [Awesome Zig (⭐1k)](https://github.com/nrdmn/awesome-zig) - Curated list of Zig code and resources.
*   Zig: App Framework
    *   🎉 [Upaya (⭐126)](https://github.com/prime31/zig-upaya) - Framework for creating game tools and helper apps.
*   Zig: File System
    *   🎉 [Known Folders (⭐188)](https://github.com/ziglibs/known-folders) - Provides access to well-known folders across several operating systems.
*   Zig: Game Framework
    *   🎉 [Zig-Gamedev Project (⭐1.8k)](https://github.com/michal-z/zig-gamedev) - Sample apps and libraries using DirectX 12.
*   Zig: Scripting
...
*   📚 [Nomad Game Engine](https://savas.ca/nomad) - Articles building an ECS from the ground up in C++. \[[Source (⭐176)](https://github.com/taurheim/NomadECS)]
...
*   🔒 [Fluids-2D](https://www.csc.kth.se/~mathar/fluids-2d/) - Real-time fluid dynamics on the GPU with the help of WebGL and Three.js. \[[Source (⭐381)](https://github.com/mharrys/fluids-2d)]
...
*   CSG (Constructive Solid Geometry)
    ...
    *   🎉 [three-bvh-csg (⭐462)](https://github.com/gkjohnson/three-bvh-csg) - Fast and dynamic CSG on top of three-mesh-bvh.
    *   🎉 [three-csgmesh (⭐403)](https://github.com/manthrax/THREE-CSGMesh) - Conversion of the csg.js library for use with Three.js.
*   Smoothing
...
*   Volumetric
    *   🌎 [Threex Volumetric Spotlight](http://jeromeetienne.github.io/threex.volumetricspotlight/examples/basic.html) - Great example of volumetric lighting with Three.js. \[[Source (⭐118)](https://github.com/jeromeetienne/threex.volumetricspotlight)]
...
*   Soft Body
    ...
    *   🌎 [Three.js: Ammo Volume](https://threejs.org/examples/?q=physics#physics_ammo_volume) - 3D soft body volumes using Ammo.js and Three.js. \[[Source (⭐97k)](https://github.com/mrdoob/three.js/blob/master/examples/physics_ammo_volume.html)]
*   Water / Buoyancy
...
*   Bloom
    ...
    *   🌎 [Three.js: Bloom Example](https://threejs.org/examples/?q=bloom#webgl_postprocessing_unreal_bloom) - WebGL bloom postprocessing using Three.js. \[[Source (⭐97k)](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_unreal_bloom.html)]
...
*   Noise
    ...
    *   🎉 [Psrdnoise (⭐199)](https://github.com/stegu/psrdnoise/) - Tiling simplex flow noise in 2D/3D.
    ...
    *   🎉 [WebGL Noise (⭐437)](https://github.com/stegu/webgl-noise/) - Maintained branch of the original Ashima Arts 2D, 3D and 4D noise functions.
*   Outlines
    ...
    *   📚 [Outlines w/Surface IDs](https://omar-shehata.medium.com/better-outline-rendering-using-surface-ids-with-webgl-e13cdab1fd94) - Technique combining depth, normals and surface IDs. \[[Source (⭐319)](https://github.com/OmarShehata/webgl-outlines)]
...
*   Pixelation
    ...
    *   🌎 [Three.js: Pixelation Example](https://threejs.org/examples/?q=pixel#webgl_postprocessing_pixel) - WebGL pixelation postprocessing using Three.js. \[[Source (⭐97k)](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_pixel.html)]
*   Postprocessing
    *   📚 [Image Editor Effects](https://alain.xyz/blog/image-editor-effects) - WebGL image filters / effects shaders. \[[Source (⭐84)](https://github.com/alaingalvan/image-editor-effects)]
*   Upscaling
...
*   📚 [Signed Distance Field Resources (⭐577)](https://github.com/CedricGuillemet/SDF) - Tutorials, papers, software, demos, discussions, etc.
...
*   Sound Effects
    *   🆓 [Bfxr](https://www.bfxr.net) - Classic. For making simple sound effects for games. \[[Source (⭐932)](https://github.com/increpare/bfxr)]
    ...
    *   🆓 [ZzFX](https://killedbyapixel.github.io/ZzFX/) - Tiny JavaScript sound FX system / Zuper Zmall Zound Zynth. \[[Source (⭐492)](https://github.com/KilledByAPixel/ZzFX)]
...
*   Modeling
    ...
    *   📚 [GET3D](https://nv-tlabs.github.io/GET3D/) - Generative model of 3D shapes from images by *NVIDIA*. \[[Source (⭐4k)](https://github.com/nv-tlabs/GET3D)]
    *   📚 [Magic3D](https://research.nvidia.com/labs/dir/magic3d/) - High-resolution text-to-3D content creation.
    *   📚 [NeRF](https://www.matthewtancik.com/nerf) - View synthesis of scenes as neural radiance fields. \[[Source (⭐9k)](https://github.com/bmild/nerf)]
...
*   🆓 [TrenchBroom](https://trenchbroom.github.io) - Level editor for Quake-engine games. \[[Source (⭐1.6k)](https://github.com/TrenchBroom/TrenchBroom)]
...
*   🆓 [Material Maker](https://www.materialmaker.org) - Procedural [physically-based rendering](https://en.wikipedia.org/wiki/Physically_based_rendering) material maker. \[[Source (⭐3k)](https://github.com/RodZill4/material-maker)]
...
*   🆓 [Krita](https://krita.org/en/) - Professional quality, open source painting. \[[Source (⭐6.2k)](https://github.com/KDE/krita)]
*   💰 [Vec Maker](https://kronbits.itch.io/vecmaker) - Easy to use vector design.

### Tools / Software / Voxel

*   🎉 [IsoVoxel (⭐343)](https://github.com/tommyettinger/IsoVoxel) - Generates isometric pixel art from MagicaVoxel .vox files.
...
*   Awesome Collections
    ...
    *   📚 [GameDev-Resources (⭐3.6k)](https://github.com/Kavex/GameDev-Resources) - Wonderful list of game development resources.
