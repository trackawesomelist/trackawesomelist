...
*   🆓 [Pmndrs Materials (⭐18)](https://github.com/pmndrs/market-assets/tree/main/files/materials) - Collection of public domain materials.
...
*   Rust: Graphics - 3D
    *   🎉 [Ash (⭐1.6k)](https://github.com/ash-rs/ash) - Vulkan bindgins for Rust.
...
*   Awesome Collections
    *   📚 [Awesome Demoscene (⭐217)](https://github.com/psykon/awesome-demoscene) - Underground computer art culture exploring computer graphics and sound.
    *   📚 [Awesome Graphics Libraries (⭐335)](https://github.com/jslee02/awesome-graphics-libraries#readme) - Curated list of 3D graphics libraries and resources.
...
*   Rust: Audio
    *   🎉 [Kira (⭐713)](https://github.com/tesselode/kira) - Create expressive audio for games.
*   Rust: Gui
...
*   Rust: Game Framework
    ...
    *   🎉 [Macroquad (⭐2.5k)](https://github.com/not-fl3/macroquad) - Easy to use game library, heavily inspired by RayLib.
...
*   🎉 [Amazon Lumberyard](https://github.com/aws/lumberyard) - AAA engine integrated with AWS and Twitch. Forked from *CRYENGINE*.
...
*   💸 [NeoAxis (⭐144)](https://github.com/NeoAxis/NeoAxisEngine) - Versatile real-time platform for making games and apps. \[[Website](https://www.neoaxis.com)]

### Game Engines / Specialty

*   🎉 [GB Studio (⭐7.6k)](https://github.com/chrismaltby/gb-studio) - Retro adventure game creator for *Game Boy*.
...
*   C: App Framework
    ...
    *   🎉 [MiniFB (⭐880)](https://github.com/emoon/minifb) - Creates a cross-platform frame buffer for drawing pixels.
    *   🎉 [SDL (⭐7k)](https://github.com/libsdl-org/SDL) 🔥 - Low level access to audio, keyboard, mouse, joystick, and graphics hardware.
    *   🎉 [Sokol (⭐5.4k)](https://github.com/floooh/sokol) 🔥 - Single-file libraries for graphics, windowing, file handling, audio and more.
*   C: Audio
    *   ⭐ [Miniaudio (⭐3.3k)](https://github.com/mackron/miniaudio) - Single-file audio playback and capture library.
    *   🎉 [SDL\_mixer (⭐322)](https://github.com/libsdl-org/SDL_mixer) - Audio mixer that supports various file formats for SDL.
...
*   C: File Formats
    ...
    *   🎉 [Libspng (⭐645)](https://github.com/randy408/libspng) - Simple, modern libpng alternative.
    ...
    *   🎉 [PL\_MPEG (⭐672)](https://github.com/phoboslab/pl_mpeg) - Single-file library for decoding MPEG1 Video and MP2 Audio.
...
*   C++: Game Engine w/Editor
    ...
    *   🎉 [Lumix Engine](https://github.com/nem0/LumixEngine) - A 3D game engine with Dear ImGui based editor.
    ...
    *   🎉 [ÖbEngine](https://github.com/ObEngine/ObEngine) - 2D engine with Lua scripting built with *SFML*.
    ...
    *   🎉 [Skylicht](https://github.com/skylicht-lab/skylicht-engine) - Upgraded features including audio, physics and particles. Built on *Irrlicht*.
    ...
    *   🎉 [Torque 3D](https://github.com/GarageGames/Torque3D) - High-performance 3D engine built on *The Forge*.
...
*   C++: Graphics - 2D
    ...
    *   🎉 [QNanoPainter](https://github.com/QUItCoding/qnanopainter) - OpenGL accelerated vector drawing library for Qt, powered by NanoVG.
    *   🎉 [Skia (⭐8k)](https://github.com/google/skia) - Complete 2D graphics library used in Chrome by *Google*. \[[Website](https://skia.org)]
    *   🎉 [vg-renderer](https://github.com/jdryg/vg-renderer) - 2D vector graphics renderer for Bgfx, based on ideas from NanoVG.
*   C++: Input
...
*   C++: Layout
    *   🎉 [Yoga](https://github.com/facebook/yoga) - Cross-platform [flexbox](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout/Basic_Concepts_of_Flexbox) layout engine by *Facebook*. \[[Website](https://yogalayout.com/)]
*   C++: Libraries
...
*   C#: Game Engine w/Editor
    ...
    *   🎉 [Flat Red Ball](https://github.com/vchelaru/FlatRedBall) - 2D game engine & design tools, built with *MonoGame*. \[[Gui Editor](http://vchelaru.github.io/Gum/) | [Website](https://flatredball.com/)]
    *   🎉 [Murder](https://github.com/isadorasophia/murder) - Pixel-art, ECS game engine built on *MonoGame*. \[[Docs](https://isadorasophia.com/murder/)]
    *   🎉 [Stride](https://github.com/stride3d/stride) - Game engine for realistic rendering and VR. Formerly *Xenko*. \[[Website](https://www.stride3d.net/)]
...
*   C#: Game Framework
    ...
    *   🎉 [Monofoxe](https://github.com/Martenfur/Monofoxe) - Game engine designed to simplify working with MonoGame.
    ...
    *   🎉 [Protogame](https://github.com/RedpointGames/Protogame) - Cross-platform 2D/3D game engine built on *MonoGame*.
*   C#: Graphics - 3D
    *   🎉 [OpenTK (⭐3k)](https://github.com/opentk/opentk) - Open Toolkit, C# bindings for OpenGL. \[[LearnOpenGL](https://github.com/opentk/LearnOpenTK)]
...
*   C#: Gui
    ...
    *   🎉 [GeonBit.UI](https://github.com/RonenNess/GeonBit.UI) - Gui for MonoGame projects.
    *   🎉 [MonoGame.Forms](https://github.com/BlizzCrafter/MonoGame.Forms) - MonoGame render window for Windows Forms.
    *   🎉 [Myra](https://github.com/rds1983/Myra) - Gui library for MonoGame, FNA, and Stride.
    *   🎉 [Uno](https://github.com/unoplatform/uno) - Mobile, desktop and WebAssembly gui library. \[[Website](https://platform.uno/)]

### Libraries / Dart

*   Dart: Game Framework
    *   🎉 [Flame (⭐8.3k)](https://github.com/flame-engine/flame) - Minimalist Flutter based 2D game engine. \[[Awesome (⭐803)](https://github.com/flame-engine/awesome-flame#readme) | [Examples](https://examples.flame-engine.org/#/) | [Tutorials](https://tutorials.flame-engine.org/#/) | [Website](https://flame-engine.org/)]
...
*   Go: Game Framework
    ...
    *   🎉 [Pixel (⭐4.3k)](https://github.com/faiface/pixel) - Hand-crafted 2D game library. \[[Examples](https://github.com/faiface/pixel-examples)]

### Libraries / Haxe

*   📚 [Awesome Haxe Game Dev (⭐355)](https://github.com/Dvergar/awesome-haxe-gamedev#readme) - Awesome list of game dev resources for Haxe.
*   Haxe: App Framework
...
*   Haxe: Game Engine w/Editor
    *   🎉 [Armory](https://github.com/armory3d/armory) - 3D game engine with full Blender integration.
    ...
    *   🎉 [Starling](https://github.com/openfl/starling) - Popular (Angry Birds) 2D game engine built on *OpenFL*. \[[Editor](http://starlingbuilder.github.io) | [Website](https://gamua.com/starling/)]
*   Haxe: Graphics
...
*   📚 [OpenGL & GLSL Tutorials](https://github.com/mattdesl/lwjgl-basics/wiki) - OpenGL / GLSL tutorials for LWJGL and libGDX.
*   Java: Game Framework
    *   🎉 [jMonkeyEngine](https://github.com/jMonkeyEngine/jmonkeyengine) - Modern 3D game development suite.
    *   🎉 [libGDX](https://github.com/libgdx/libgdx) - Game framework built on, and adds to *LWJGL*. \[[Awesome (⭐844)](https://github.com/rafaskb/awesome-libgdx#readme) | [Website](https://libgdx.com/)]
...
*   JavaScript: Animation
    ...
    *   🎉 [TweenJS](https://github.com/CreateJS/TweenJS) - Tweening / animation library, part of the CreateJS suite.
*   JavaScript: Audio
    *   🎉 [Howler.js (⭐22k)](https://github.com/goldfire/howler.js) - Audio made easy and reliable across all platforms.
    *   🎉 [PixiJS Sound](https://github.com/pixijs/sound) - Audio library with filters, built on *PixiJS*. \[[Examples](https://pixijs.io/sound/examples/)]
    *   🎉 [SoundJS](https://github.com/CreateJS/SoundJS) - Simple API and powerful features, part of the CreateJS suite.
...
*   JavaScript: Framework
    ...
    *   🎉 [Svelte (⭐74k)](https://github.com/sveltejs/svelte) - Takes your declarative components and converts them into efficient JavaScript.
...
*   JavaScript: Game Engine w/Editor
    ...
    *   🎉 [Cocos Creator (⭐4.8k)](https://github.com/cocos-creator/engine) - Cross-Platform 2D/3D game creation. \[[Website](https://www.cocos.com/en/creator)]
    ...
    *   🎉 [Isogenic (⭐498)](https://github.com/irrelon/ige) - Engine with advanced multiplayer, based on *Valve*'s multiplayer system.
    ...
    *   🎉 [microStudio (⭐824)](https://github.com/pmgl/microstudio/) - Online game engine. Learn and practice programming. \[[Website](https://microstudio.dev/)]
    *   🎉 [Pixelbox.js (⭐455)](https://github.com/cstoquer/pixelbox) - Sandbox to fast-prototype 2D tile-based games. \[[Download](https://pixwlk.itch.io/pixelbox)]
    *   🎉 [QICI Engine (⭐849)](https://github.com/qiciengine/qiciengine) - Toolset for making games.
    ...
    *   🎉 [Taro (⭐290)](https://github.com/moddio/taro) - Multiplayer engine with Box2D physics, aka *Moddio*. \[[Website](https://www.modd.io)]
*   JavaScript: Game Framework
    ...
    *   🎉 [Meep (⭐218)](https://github.com/Usnul/meep) - ECS game framework.
...
*   JavaScript: Graphics - 2D
    ...
    *   🎉 [Pencil.js (⭐256)](https://github.com/pencil-js/pencil.js) - Modular interactive 2D drawing library. \[[Examples](https://pencil.js.org/)]
    *   🎉 [PixiJS (⭐41k)](https://github.com/pixijs/pixijs) 🔥 - Fast, lightweight 2D library. \[[Awesome (⭐692)](https://github.com/cursedcoder/awesome-pixijs) | [Editor (⭐217)](https://github.com/Megabyteceer/thing-editor) | [Essentials (⭐244)](https://github.com/ShukantPal/pixi-essentials) | [Website](https://pixijs.com/)]
    ...
    *   🎉 [ZIM (⭐427)](https://github.com/danzen/zimjs) - Creative canvas framework. \[[Website](https://zimjs.com/)]
*   JavaScript: Graphics - 3D
    *   🎉 [Babylon.js (⭐22k)](https://github.com/BabylonJS/Babylon.js) 🔥 - Powerful web rendering engine. \[[Extensions (⭐166)](https://github.com/BabylonJS/Extensions) | [Website](https://www.babylonjs.com/)]
    ...
    *   🎉 [Four (⭐220)](https://github.com/CodyJasonBennett/four) - Minimal three.js alternative.
    *   🎉 [Hilo3d (⭐625)](https://github.com/hiloteam/Hilo3d) - WebGL 3D rendering engine by *Alibaba*.
    *   🎉 [Litescene.js (⭐343)](https://github.com/jagenjo/litescene.js) - WebGL 3D engine library, used by [WebGLStudio](https://webglstudio.org).
    ...
    *   🎉 [Pixi3D (⭐689)](https://github.com/jnsmalm/pixi3d) - 3D renderer for PixiJS, seamless integration with 2D apps. \[[Examples](https://pixi3d.org/)]
...
*   JavaScript: Gui
    ...
    *   🎉 [PCUI](https://github.com/playcanvas/pcui) - UI component library for the web by *PlayCanvas*.
...
*   JavaScript: Utility
    ...
    *   🎉 [i18next (⭐7.1k)](https://github.com/i18next/i18next) - Popular internationalization framework.
...
*   JavaScript: Timeline
    *   🎉 [Frame.js (⭐989)](https://github.com/mrdoob/frame.js/) - JavaScript sequence editor. \[[Examples](https://framejs.app/)]
    *   🎉 [Neo (⭐273)](https://github.com/lo-th/neo) - Timeline for JavaScript. \[[Demo](http://lo-th.github.io/neo/)]
*   JavaScript: Video
...
*   JavaScript: Visual Programming / Nodes
    *   🎉 [Butterfly (⭐4k)](https://github.com/alibaba/butterfly) - Diagramming library concentrated on flow and field layout by *Alibaba*.
    *   🎉 [Drawflow (⭐3.7k)](https://github.com/jerosoler/Drawflow) - Simple JavaScript flow library. \[[Demo](https://jerosoler.github.io/Drawflow/)]
    *   🎉 [Flow (⭐78)](https://github.com/sunag/flow) - Node-graph library.
    *   🎉 [Litegraph.js (⭐4.3k)](https://github.com/jagenjo/litegraph.js) - Create graphs in the browser similar to Unreal Blueprints. \[[Demo](https://tamats.com/projects/litegraph/editor/)]
...
*   Pascal: Game Engine w/Editor
    *   🎉 [Castle (⭐798)](https://github.com/castle-engine/castle-engine) - Cross-platform 2D/3D game engine and editor. \[[Website](https://castle-engine.io/)]
...
*   Python: Game Framework
    ...
    *   🔒 [Pygame (⭐6.5k)](https://github.com/pygame/pygame) - Game & multimedia app framework, built on *SDL*.
...
*   Ruby: Game Framework
    *   🎉 [Ruby 2D (⭐615)](https://github.com/ruby2d/ruby2d) - Make cross-platform 2D apps.

### Libraries / Rust

*   Rust: App Framework
    *   🎉 [Makepad (⭐4.3k)](https://github.com/makepad/makepad) - Software development platform and native-rendering gui framework. \[[Editor](https://makepad.dev/)]
...
*   Rust: Physics
    *   🎉 [Rapier (⭐3k)](https://github.com/dimforge/rapier) - 2D/3D physics engines focused on performance. \[[Docs](https://rapier.rs)]
...
*   Zig: Graphics - 2D
    *   🎉 [Mini Pixel (⭐155)](https://github.com/fabioarnold/MiniPixel) - Tiny pixel art editor. \[[Download](https://fabioarnold.itch.io/mini-pixel)]
    *   🔒 [Pixi (⭐347)](https://github.com/foxnne/pixi) - Pixel art editor.

### Open Source Games / C

*   🔒 [Gish (⭐312)](https://github.com/blinry/gish) - Open Source version of the award-winning physics platformer. \[[Steam](https://store.steampowered.com/app/9500/Gish/)]

### Open Source Games / C++

*   🔒 [Dungeon Crawl: Stone Soup (⭐2.1k)](https://github.com/crawl/crawl) - Classic roguelike adventure. \[[Play](https://crawl.develz.org/)]
*   🎉 [Etheral Legends (⭐226)](https://github.com/Soverance/EtherealLegends) - Indie Action RPG built with *Unreal Engine 4*. \[[Steam](https://store.steampowered.com/app/428980/Ethereal_Legends/)]
...
*   📚 [Book of Shaders](https://thebookofshaders.com) 🔥 - Step-by-step guide through [Fragment Shaders](https://www.khronos.org/opengl/wiki/Fragment_Shader). \[[Source (⭐5.5k)](https://github.com/patriciogonzalezvivo/thebookofshaders)]
*   🎉 [CrossShader (⭐245)](https://github.com/alaingalvan/CrossShader) - Cross-compiling shaders between GLSL, HLSL, Metal, and more. \[[Online Tool](https://alain.xyz/libraries/crossshader)]
...
*   🌎 [Shader Park (⭐630)](https://github.com/shader-park/shader-park-core) - Shader programming in JavaScript.
...
*   📚 [CoolEngines (⭐39)](https://github.com/JohnClarking/CoolEngines) - List of open source graphic & game engines.
...
*   🆓 [Evergine](https://evergine.com) - High-quality 3D and 2D solutions. Formerly *Wave Engine*. \[[Samples (⭐110)](https://github.com/EvergineTeam/Samples)]
...
*   💰 [Phaser Editor 2D](https://phasereditor2d.com) - Commercial, web-based editor for *Phaser*. \[[GitHub (⭐345)](https://github.com/PhaserEditor2D/PhaserEditor2D-v3)]
...
*   💸 [Stencyl](https://www.stencyl.com/) - Quick and easy game making with visual scripting. \[[GitHub (⭐181)](https://github.com/Stencyl/stencyl-engine)]
...
*   Graphics API: WebGL
    ...
    *   📚 [WebGL 2 Samples (⭐984)](https://github.com/WebGLSamples/WebGL2Samples) - Short and easy to understand samples demonstrating WebGL 2 features.
...
*   📚 [Learn to Program (⭐3.6k)](https://github.com/karlhorky/learn-to-program#readme) - Educational resources to learn to program.
...
*   C: Cross-Platform
    *   🎉 [Cosmopolitan (⭐13k)](https://github.com/jart/cosmopolitan) - Build-once run-anywhere C library.
*   C: Entity Component System
...
*   C: File System
    ...
    *   ⭐ [Incbin (⭐863)](https://github.com/graphitemaster/incbin) - Include binary and text files in your C/C++ apps with ease.
    *   🎉 [PhysicsFS (⭐431)](https://github.com/icculus/physfs) - Portable, flexible file I/O abstraction. Provides access to various archives.
    *   ⭐ [Where Am I (⭐415)](https://github.com/gpakosz/whereami) - Locates the current path on the local file system.
*   C: Fonts
    *   🎉 [Font Stash (⭐628)](https://github.com/memononen/fontstash) - Lightweight library that uses stb\_truetype to render fonts to a texture atlas.
    *   🎉 [IconFontCppHeaders (⭐1k)](https://github.com/juliettef/IconFontCppHeaders) - C/C++ headers and C# classes for icon fonts.
    *   🎉 [msdf-c (⭐107)](https://github.com/solenum/msdf-c) - Multi-channel signed distance field generator.
...
*   C: Game Engine w/Editor
    ...
    *   🎉 [TIC-80 (⭐4.5k)](https://github.com/nesbox/TIC-80) - Virtual computer for making & sharing tiny games. \[[Website](https://tic80.com/)]
*   C: Game Framework
    *   🎉 [CGL (⭐376)](https://github.com/Jaysmito101/cgl) - Single-header file, lots of graphics & utility functions.
    *   🎉 [DOME (⭐448)](https://github.com/domeengine/dome) - Melds SDL2 and the Wren scripting language. \[[Website](https://domeengine.com/)]
    *   🎉 [Entrypoint (⭐68)](https://github.com/jimon/entrypoint) - Lightweight entry point for games.
    *   ⭐ [FWK (⭐66)](https://github.com/r-lyeh/FWK) - 3D game framework.
...
*   C: Geometry
    ...
    *   🎉 [Marching Squares (⭐830)](https://github.com/prideout/par/blob/master/par_msquares.h) - Convert images into triangles. \[[Info](https://prideout.net/marching-squares)]
    ...
    *   🎉 [Par\_Shapes (⭐830)](https://github.com/prideout/par/blob/master/par_shapes.h) - Triangle meshes including solids, spheres and more. \[[Info](https://prideout.net/shapes)]
    *   🎉 [Par\_Streamlines (⭐830)](https://github.com/prideout/par/blob/master/par_streamlines.h) - Triangulating thick lines, béziers, streamlines. \[[Demo (⭐27)](https://github.com/prideout/streamlines_demo) | [Info](https://prideout.net/blog/par_streamlines/)]
*   C: Graphics - 2D
    *   🎉 [NanoVG (⭐4.8k)](https://github.com/memononen/nanovg) - OpenGL-based 2D vector drawing library for UI and visualizations.
    *   🎉 [Tilengine (⭐747)](https://github.com/megamarc/Tilengine) - 2D graphics with raster effects for retro style game development.
*   C: Graphics - 3D
    *   🎉 [Sokol Gfx (⭐5.4k)](https://github.com/floooh/sokol/blob/master/sokol_gfx.h) - Cross-platform, single-file graphics. \[[Examples](https://floooh.github.io/sokol-html5/) | [LearnOpenGL](https://www.geertarien.com/learnopengl-examples-html5/)]
    *   🎉 [Sokol Graphics Painter (⭐346)](https://github.com/edubart/sokol_gp) - 2D graphics painter implemented with Sokol.
*   C: Gui
    ...
    *   🎉 [NAppGUI (⭐349)](https://github.com/frang75/nappgui_src) - Professional, well documented SDK to build desktop apps.
...
*   C: Input
    ...
    *   🎉 [Sokol Gamepad (⭐5.4k)](https://github.com/floooh/sokol/pull/393/commits/26a9da9dafd4adb22a1ace0de0d2569da31ae427) - Branch with addon support for gamepads in Sokol.
*   C: Libraries
    *   ⭐ [Cute Headers (⭐4k)](https://github.com/RandyGaul/cute_headers) - Single-file libraries primarily used for games, by [Randy Gaul](https://github.com/RandyGaul).
...
*   C++: File System
    *   🎉 [Imgui-Filebrowser](https://github.com/AirGuanZ/imgui-filebrowser) - Header-only file browser implementation for Dear ImGui in C++17.
*   C++: Game Framework
    ...
    *   🎉 [Koala Engine](https://github.com/phisko/kengine) - Framework with an ECS architecture, aka *Kengine*.
    ...
    *   🎉 [Solar2D](https://github.com/coronalabs/corona) - Focus on ease of iterations and usage. Formerly *Corona*.
...
*   C++: Graphics - 3D
    ...
    *   🎉 [Filament](https://github.com/google/filament) - Mobile-first, real-time physically-based renderer by *Google*.
    ...
    *   🎉 [Intermediate Graphics Library (IGL)](https://github.com/facebook/igl) - Cross-platform abstraction layer by *Facebook*.
...
*   C++: Scripting
    ...
    *   🎉 [v8](https://github.com/v8/v8) - High-performance JavaScript and WebAssembly engine by *Google*.
*   C++: Utility
    ...
    *   🎉 [faker-cxx (⭐117)](https://github.com/cieslarmichal/faker-cxx) - C++20 Faker library for generating fake (but realistic) data for testing and development.
...
*   C++: Visual Programming / Nodes
    *   🎉 [NodeEditor](https://github.com/paceholder/nodeeditor) - Graph-controlled data processing, built with *Qt*.
    *   🎉 [QuickQanava](https://github.com/cneben/QuickQanava) - Display graphs and relational content in a QtQuick-based app, in C++14.
...
*   C#: Physics
    ...
    *   🎉 [Velcro Physics](https://github.com/Genbox/VelcroPhysics) - C# port of Box2D. Formerly *Farseer Physics*.
*   C#: Utility
...
*   Haxe: Game Framework
    ...
    *   🎉 [HaxeFlixel](https://github.com/HaxeFlixel/flixel) - Cross-platform 2D game framework powered by OpenFL. \[[Website](https://haxeflixel.com/)]
...
*   Lua: Game Framework
    *   🎉 [3DreamEngine](https://github.com/3dreamengine/3DreamEngine) - 3D engine on top of *LÖVE*.
    ...
    *   🎉 [LÖVE](https://github.com/love2d/love) - 2D framework for writing game code with Lua. \[[Awesome (⭐2.8k)](https://github.com/love2d-community/awesome-love2d) | [Website](https://love2d.org)]
...
*   JavaScript: Cross-Platform
    ...
    *   🎉 [NW.js](https://github.com/nwjs/nw.js) - Desktop apps with JavaScript. Formerly *Node-Webkit*. \[[Website](https://nwjs.io)]
...
*   JavaScript: Geometry
    ...
    *   🎉 [Poly-Decomp.js (⭐392)](https://github.com/schteppe/poly-decomp.js) - Decompose 2D polygons into convex pieces.
...
*   JavaScript: Physics
    *   🎉 [Ammo.js (⭐3.9k)](https://github.com/kripken/ammo.js) - 3D Bullet Physics engine ported as WebAssembly.
    ...
    *   🎉 [Particulate.js (⭐334)](https://github.com/jpweeks/particulate-js) - Particle physics library designed to be simple, fast and stable.
    ...
    *   🎉 [Verly.js (⭐626)](https://github.com/anuraghazra/Verly.js) - Easy to integrate verlet physics engine. \[[Demos](https://anuraghazra.dev/Verly.js/)]

### Libraries / Kotlin

*   Kotlin: Game Framework
    *   🎉 [FXGL (⭐3.9k)](https://github.com/AlmasB/FXGL) - Game library for 2D, experimental 3D.
    *   🎉 [Kool (⭐212)](https://github.com/fabmax/kool) - Multi-platform 3D Vulkan / OpenGL graphics engine. \[[Examples](https://fabmax.github.io/kool/kool-js/)]
...
*   Pascal: Game Framework
    *   🎉 [Apus (⭐159)](https://github.com/Cooler2/ApusGameEngine) - Cross-platform library for making 2D games.
*   Pascal: Physics
...
*   Ruby: Gui
    *   🎉 [Glimmer (⭐436)](https://github.com/andyobtiva/glimmer) - Gui library and DSL (domain specific language) framework.
    *   🎉 [Shoes (⭐1.6k)](https://github.com/shoes/shoes4) - Cross-platform gui library. \[[Website](http://shoesrb.com/)]

### Libraries / Rust

*   📚 [Awesome Rust (⭐39k)](https://github.com/rust-unofficial/awesome-rust) - Curated list of Rust code and resources.

### Libraries / Zig

*   📚 [Awesome Zig (⭐973)](https://github.com/nrdmn/awesome-zig) - Curated list of Zig code and resources.
*   Zig: App Framework
    *   🎉 [Upaya (⭐126)](https://github.com/prime31/zig-upaya) - Framework for creating game tools and helper apps.
*   Zig: File System
    *   🎉 [Known Folders (⭐180)](https://github.com/ziglibs/known-folders) - Provides access to well-known folders across several operating systems.
*   Zig: Game Framework
    *   🎉 [Zig-Gamedev Project (⭐1.7k)](https://github.com/michal-z/zig-gamedev) - Sample apps and libraries using DirectX 12.
*   Zig: Scripting
    *   🎉 [Cyber (⭐874)](https://github.com/fubark/cyber) - Fast, efficient, and concurrent scripting language.
...
*   🔒 [Fluids-2D](https://www.csc.kth.se/~mathar/fluids-2d/) - Real-time fluid dynamics on the GPU with the help of WebGL and Three.js. \[[Source (⭐370)](https://github.com/mharrys/fluids-2d)]
...
*   CSG (Constructive Solid Geometry)
    ...
    *   🎉 [three-bvh-csg (⭐429)](https://github.com/gkjohnson/three-bvh-csg) - Fast and dynamic CSG on top of three-mesh-bvh.
    *   🎉 [three-csgmesh (⭐378)](https://github.com/manthrax/THREE-CSGMesh) - Conversion of the csg.js library for use with Three.js.
*   Smoothing
...
*   Soft Body
    ...
    *   🌎 [Three.js: Ammo Volume](https://threejs.org/examples/?q=physics#physics_ammo_volume) - 3D soft body volumes using Ammo.js and Three.js. \[[Source (⭐96k)](https://github.com/mrdoob/three.js/blob/master/examples/physics_ammo_volume.html)]
*   Water / Buoyancy
...
*   📚 [Scriptorium (⭐487)](https://github.com/r-lyeh-archived/scriptorium) - Game scripting languages benchmarked.
...
*   Bloom
    ...
    *   🌎 [Three.js: Bloom Example](https://threejs.org/examples/?q=bloom#webgl_postprocessing_unreal_bloom) - WebGL bloom postprocessing using Three.js. \[[Source (⭐96k)](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_unreal_bloom.html)]
...
*   Noise
    ...
    *   🎉 [Psrdnoise (⭐187)](https://github.com/stegu/psrdnoise/) - Tiling simplex flow noise in 2D/3D.
    ...
    *   🎉 [WebGL Noise (⭐420)](https://github.com/stegu/webgl-noise/) - Maintained branch of the original Ashima Arts 2D, 3D and 4D noise functions.
*   Outlines
    ...
    *   📚 [Outlines w/Surface IDs](https://omar-shehata.medium.com/better-outline-rendering-using-surface-ids-with-webgl-e13cdab1fd94) - Technique combining depth, normals and surface IDs. \[[Source (⭐306)](https://github.com/OmarShehata/webgl-outlines)]
...
*   Pixelation
    ...
    *   🌎 [Three.js: Pixelation Example](https://threejs.org/examples/?q=pixel#webgl_postprocessing_pixel) - WebGL pixelation postprocessing using Three.js. \[[Source (⭐96k)](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_pixel.html)]
*   Postprocessing
...
*   📚 [Signed Distance Field Resources (⭐558)](https://github.com/CedricGuillemet/SDF) - Tutorials, papers, software, demos, discussions, etc.
...
*   Sound Effects
    *   🆓 [Bfxr](https://www.bfxr.net) - Classic. For making simple sound effects for games. \[[Source (⭐926)](https://github.com/increpare/bfxr)]
    ...
    *   🆓 [ZzFX](https://killedbyapixel.github.io/ZzFX/) - Tiny JavaScript sound FX system / Zuper Zmall Zound Zynth. \[[Source (⭐478)](https://github.com/KilledByAPixel/ZzFX)]
...
*   Modeling
    ...
    *   📚 [NeRF](https://www.matthewtancik.com/nerf) - View synthesis of scenes as neural radiance fields. \[[Source (⭐8.6k)](https://github.com/bmild/nerf)]
...
*   🆓 [Blender](https://www.blender.org) 🔥 - Standard for open source 3D modeling. \[[Source (⭐10k)](https://github.com/blender/blender)]
*   🆓 [Meshroom](https://alicevision.org/#meshroom) - 3D reconstruction, built with the [AliceVision (⭐2.7k)](https://github.com/alicevision/AliceVision) framework. \[[Source (⭐10k)](https://github.com/alicevision/meshroom)]
...
*   🆓 [Krita](https://krita.org/en/) - Professional quality, open source painting. \[[Source (⭐5.9k)](https://github.com/KDE/krita)]
*   💰 [Vec Maker](https://kronbits.itch.io/vecmaker) - Easy to use vector design.

### Tools / Software / Voxel

*   🎉 [IsoVoxel (⭐338)](https://github.com/tommyettinger/IsoVoxel) - Generates isometric pixel art from MagicaVoxel .vox files.
...
*   🆓 [Radiant](https://icculus.org/gtkradiant/) - Cross-platform level editor for [idTech](https://en.wikipedia.org/wiki/Id_Tech) games. \[[Source (⭐556)](https://github.com/TTimo/GtkRadiant)]
...
*   Music
    *   🆓 [Ardour](https://ardour.org) - Record, edit, and mix. \[[Source (⭐3.4k)](https://github.com/Ardour/ardour)]
    ...
    *   🆓 [LMMS](https://lmms.io) 🔥 - Cross-platform music production software. \[[Source (⭐7.2k)](https://github.com/lmms/lmms)]
    ...
    *   🆓 [ZzFXM](https://keithclark.github.io/ZzFXM/tracker/) - Music generator for use in tiny JavaScript apps. \[[Source (⭐394)](https://github.com/keithclark/ZzFXM)]
...
*   🆓 [GIMP](https://www.gimp.org) - GNU Image Manipulation Program, open source image editor. \[[Source (⭐4.3k)](https://github.com/GNOME/gimp)]
