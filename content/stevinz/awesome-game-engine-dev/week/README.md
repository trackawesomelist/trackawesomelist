...
*   ### Color Manipulation
    ...
    *   📚 [Red, Yellow, and Blue](https://daveeddy.com/2014/07/01/red-yellow-and-blue/) [:octocat: (⭐64)](https://github.com/bahamas10/ryb) - Convert colors from the paint color wheel to RGB space.
*   ### Entity Component Systems
    ...
    *   📚 [Nomad Game Engine](https://savas.ca/nomad) [:octocat: (⭐158)](https://github.com/taurheim/NomadECS) - Articles building a basic ECS from the ground up in C++.
...
*   ### Lighting / Shadows
    ...
    *   #### Volumetric
        *   🌎 [Threex Volumetric Spotlight](http://jeromeetienne.github.io/threex.volumetricspotlight/examples/basic.html) [:octocat: (⭐103)](https://github.com/jeromeetienne/threex.volumetricspotlight) - Great example of volumetric lighting with Three.js.
...
*   ### Shaders
    *   #### - General -
        ...
        *   🌎 [CrossShader](https://alain.xyz/libraries/crossshader) [:octocat: (⭐183)](https://github.com/alaingalvan/CrossShader) - Cross compiling shaders. Convert between GLSL, HLSL, Metal and more.
        ...
        *   🌎 [Shader Park](https://shaderpark.com/) [:octocat: (⭐490)](https://github.com/shader-park/shader-park-core) - Shader programming in JavaScript.
    ...
    *   #### Bloom
        ...
        *   🌎 [Three.js: Bloom Example](https://threejs.org/examples/?q=bloom#webgl_postprocessing_unreal_bloom) [:octocat: (⭐87k)](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_unreal_bloom.html) - WebGL bloom effect postprocessing example using Three.js.
    ...
    *   #### Noise
        ...
        *   🎉 [Psrdnoise (⭐128)](https://github.com/stegu/psrdnoise/) - Tiling simplex flow noise in 2D and 3D.
        ...
        *   🎉 [WebGL Noise (⭐353)](https://github.com/stegu/webgl-noise/) - Maintained branch of the original Ashima Arts 2D, 3D and 4D noise functions.
    *   #### Outlines
        ...
        *   📚 [Outlines w/ Surface IDs](https://omar-shehata.medium.com/better-outline-rendering-using-surface-ids-with-webgl-e13cdab1fd94) [:octocat: (⭐234)](https://github.com/OmarShehata/webgl-outlines) - Technique combining depth, normals and surface IDs.
    ...
    *   #### Pixelation
        ...
        *   🌎 [Three.js: Pixelation Example](https://threejs.org/examples/?q=pixel#webgl_postprocessing_pixel) [:octocat: (⭐87k)](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_pixel.html) - WebGL pixelation postprocessing example using Three.js.
    *   #### Postprocessing
        *   📚 [Image Editor Effects](https://alain.xyz/blog/image-editor-effects) [:octocat: (⭐78)](https://github.com/alaingalvan/image-editor-effects) - Image filters / adjustmenta / effects shaders.
    *   #### Upscaling
...
*   ### Signed Distance Fields
    ...
    *   📚 [CSG w/ SDFs](https://jasmcole.com/2019/10/03/signed-distance-fields/) [:octocat: (⭐71)](https://github.com/jasmcole/Blog/tree/master/CSG) - Using circular SDFs to build 3D objects with Constructive Solid Geometry.
    ...
    *   📚 [Signed Distance Field Resources (⭐471)](https://github.com/CedricGuillemet/SDF) - Tutorials, papers, software, demos, discussions, etc.
...
*   ### AAA
    ...
    *   🎉 [O3DE](https://www.o3de.org/) [:octocat: (⭐5.7k)](https://github.com/o3de/o3de/) - (successor to Lumberyard) Multi-platform AAA engine. Cinema-quality 3D.
...
*   ### Specialty
    ...
    *   🔒 [HARFANG 3D (⭐265)](https://github.com/harfang3d/harfang3d) - 3D visualization library for industry professionals, usable in C++, Python, Lua, Go.
...
*   ### Computer Graphics
    *   #### Awesome Collections
        *   📚 [Awesome Graphics Libraries (⭐230)](https://github.com/jslee02/awesome-graphics-libraries#readme) - Awesome curated list of 3D graphics libraries and resources.
    *   #### Blog Articles
    ...
    *   #### Platform: XNA
        ...
        *   📚 [XNA Game Studio Archive (⭐511)](https://github.com/SimonDarksideJ/XNAGameStudio) - 🔥 Required visit for MonoGame / FNA / [XNA](https://en.wikipedia.org/wiki/Microsoft_XNA) developers.
    *   #### Shader
...
*   ### C
    ...
    *   #### C: App Framework
        *   🎉 [glfw](https://www.glfw.org) [:octocat: (⭐9.9k)](https://github.com/glfw/glfw) - Cross-platform, simple API for windowing, graphics contexts, input and events.
        *   🎉 [SDL](https://libsdl.org) [:octocat: (⭐4.5k)](https://github.com/libsdl-org/SDL) - 🔥 Low level access to audio, keyboard, mouse, joystick, and graphics hardware.
    ...
    *   #### C: Audio
        ...
        *   🎉 [SDL\_mixer](https://libsdl.org/projects/SDL_mixer/) [:octocat: (⭐196)](https://github.com/libsdl-org/SDL_mixer) - Audio mixer that supports various file formats for SDL.
    ...
    *   #### C: File Formats
        ...
        *   ⭐ [dr\_libs (⭐893)](https://github.com/mackron/dr_libs) - Single file audio decoding libraries for C/C++.
        *   🎉 [Libspng (⭐564)](https://github.com/randy408/libspng) - Simple, modern libpng alternative.
        ...
        *   🎉 [PL\_MPEG (⭐601)](https://github.com/phoboslab/pl_mpeg) - Single file C library for decoding MPEG1 Video and MP2 Audio.
        *   🎉 [QOI (⭐5.9k)](https://github.com/phoboslab/qoi) - The “Quite OK Image Format” for fast, lossless image compression.
    ...
    *   #### C: File System
        ...
        *   ⭐ [Incbin (⭐742)](https://github.com/graphitemaster/incbin) - Include binary and text files in your C/C++ applications with ease.
        *   🎉 [PhysicsFS](http://icculus.org/physfs/) [:octocat: (⭐286)](https://github.com/icculus/physfs) - Portable, flexible file i/o abstraction, provides access to various archives.
        *   ⭐ [Where Am I (⭐381)](https://github.com/gpakosz/whereami) - Locates the current path on the local file system.
    *   #### C: Fonts
        *   🎉 [Font Stash (⭐561)](https://github.com/memononen/fontstash) - Light-weight library that uses stb\_truetype to render fonts to a texture atlas.
        *   🎉 [IconFontCppHeaders (⭐800)](https://github.com/juliettef/IconFontCppHeaders) - C, C++ headers and C# classes for icon fonts.
    ...
    *   #### C: Game Framework
        *   🎉 [CGL (⭐181)](https://github.com/Jaysmito101/cgl) - Single header file, lots of graphics & utility functions.
        *   🎉 [Entrypoint (⭐64)](https://github.com/jimon/entrypoint) - Lightweight entry point for games.
        *   ⭐ [FWK (⭐423)](https://github.com/r-lyeh/FWK) - 3D game framework in C.
        *   🎉 [Gunslinger (⭐895)](https://github.com/MrFrenik/gunslinger) - Header-only c99 framework for multimedia apps.
    ...
    *   #### C: Geometry
        *   🎉 [Blob (⭐43)](https://github.com/BlockoS/blob) - Single header implementation of a contour tracing algorithm
        *   🎉 [Marching Squares](https://prideout.net/marching-squares) [:octocat: (⭐784)](https://github.com/prideout/par/blob/master/par_msquares.h) - Converts grayscale images, or 8-bit color images, into triangles.
        *   🎉 [Octasphere](https://prideout.net/blog/octasphere/) [:octocat: (⭐784)](https://github.com/prideout/par/blob/master/par_octasphere.h) - Generates triangle meshes for spheres, rounded boxes, and capsules.
        *   🎉 [Par\_Shapes](https://prideout.net/shapes) [:octocat: (⭐784)](https://github.com/prideout/par/blob/master/par_shapes.h) - Create and manipulate of triangle meshes, including solids, spheres and more.
        *   🎉 [Par\_Streamlines](https://prideout.net/blog/par_streamlines/) [:octocat: (⭐784)](https://github.com/prideout/par/blob/master/par_streamlines.h) - Library for triangulating wide/thick lines, Béziers, streamlines. \[[Demo (⭐26)](https://github.com/prideout/streamlines_demo)]
    *   #### C: Graphics - 2D
    ...
    *   #### C: Graphics - 3D
        ...
        *   🎉 [Sokol Graphics Painter (⭐260)](https://github.com/edubart/sokol_gp) - 2D graphics painter implemented using Sokol.
    *   #### C: Gui
        ...
        *   🎉 [NAppGUI](https://nappgui.com/en/home/web/home.html) [:octocat: (⭐239)](https://github.com/frang75/nappgui_src) - Professional, well documented SDK to build desktop applications using C.
        *   🎉 [Native File Dialog (⭐1.5k)](https://github.com/mlabbe/nativefiledialog) - Portably invoke native file open/save dialogs.
        *   🎉 [Nuklear](https://immediate-mode-ui.github.io/Nuklear/doc/index.html) [:octocat: (⭐6.3k)](https://github.com/Immediate-Mode-UI/Nuklear) - Single-header ANSI C immediate mode cross-platform GUI library.
    *   #### C: Input
    ...
    *   #### C: Math
        ...
        *   ⭐ [Handmade Math (⭐812)](https://github.com/HandmadeMath/Handmade-Math) - 🔥 Simple, public domain math library for games and computer graphics.
        *   🎉 [Kazmath (⭐504)](https://github.com/Kazade/kazmath) - Math library targeted at games.
    ...
    *   #### C: Scripting
        ...
        *   🎉 [Lua](https://www.lua.org) [:octocat: (⭐6.3k)](https://github.com/lua/lua) - Powerful, efficient, lightweight, embeddable scripting language.
...
*   ### C++
    ...
    *   #### Awesome Collections
        *   📚 [Awesome C++ (⭐42k)](https://github.com/fffaraz/awesome-cpp#readme) - List of awesome C++ frameworks, libraries, and resources.
    ...
    *   #### C++: App Framework
        ...
        *   🎉 [Cross Window](https://alain.xyz/libraries/crosswindow) [:octocat: (⭐384)](https://github.com/alaingalvan/CrossWindow) - For managing windows and performing OS tasks.
        *   🎉 [SFML](https://www.sfml-dev.org/index.php) [:octocat: (⭐8.2k)](https://github.com/SFML/SFML) - 🔥 Cross-platform access to windowing, graphics, audio and networking.
    *   #### C++: Animation
    ...
    *   #### C++: Audio
        ...
        *   🎉 [PortAudio](http://www.portaudio.com) [:octocat: (⭐774)](https://github.com/PortAudio/portaudio) - Free, cross-platform, open-source, audio I/O library.
    *   #### C++: Cross-Platform
    ...
    *   #### C++: Entity Component System
        ...
        *   🎉 [Entt (⭐7.5k)](https://github.com/skypjack/entt) - Gaming meets modern C++, a fast and reliable entity component system.
    *   #### C++: Fonts
    ...
    *   #### C++: File Formats
        *   ⭐ [Jpeg-Compressor (⭐165)](https://github.com/richgel999/jpeg-compressor) - Single file library that writes baseline JPEG compressed images.
        *   🎉 [TinyDNG (⭐108)](https://github.com/syoyo/tinydng) - Header only DNG / TIFF loader and writer.
        *   🎉 [TinyEXR (⭐549)](https://github.com/syoyo/tinyexr) - Tiny OpenEXR image loader/saver library.
    ...
    *   #### C++: File System
        *   🎉 [Imgui-Filebrowser (⭐423)](https://github.com/AirGuanZ/imgui-filebrowser) - Header only file browser implementation for Dear ImGui. C++17 is required.
    *   #### C++: Game Engine w/Editor
        ...
        *   🔒 [Enigma](https://enigma-dev.org/) [:octocat: (⭐259)](https://github.com/enigma-dev/enigma-dev) - Open source Game Maker compatible 2D engine.
        *   🎉 [Esoterica Engine (⭐586)](https://github.com/BobbyAnguelov/Esoterica) - High performance game engine with editor and AAA quality animation graph.
        *   🎉 [Ethereal Engine (⭐789)](https://github.com/volcoma/EtherealEngine) - Cross-platform C++ game engine and editor.
        *   🎉 [ezEngine](http://ezengine.net/index.html) [:octocat: (⭐811)](https://github.com/ezEngine/ezEngine) - Open source game engine in active development. \[[Editor Info](http://ezengine.net/pages/getting-started/editor-overview.html)]
        *   🎉 [FIFE](http://www.fifengine.net/) [:octocat: (⭐522)](https://github.com/fifengine/fifengine) - Multi-platform isometric game engine.
        ...
        *   🎉 [Lina Engine (⭐446)](https://github.com/inanevin/LinaEngine) - Modular C++ game engine, aimed to develop 3D desktop games.
        *   🎉 [Lumos (⭐783)](https://github.com/jmorton06/Lumos) - Cross-platform 2D and 3D Game Engine, supports both OpenGL and Vulkan.
        ...
        *   🔒 [neoGFX](https://neogfx.org) [:octocat: (⭐468)](https://github.com/i42output/neogfx) - Cross-platform GPU-oriented C++ application / game framework.
        *   🎉 [ÖbEngine (⭐661)](https://github.com/ObEngine/ObEngine) - 2D Engine with Lua Scripting built on SFML.
        *   🎉 [Overload](http://overloadengine.org/) [:octocat: (⭐995)](https://github.com/adriengivry/Overload) - Highly documented 3D game engine, inspired by industry standards.
        ...
        *   🎉 [Skylicht (⭐380)](https://github.com/skylicht-lab/skylicht-engine) - Based on Irrlicht, with upgraded features including audio, physics and particles.
        *   🎉 [Titan Engine](https://esenthel.com/) [:octocat: (⭐489)](https://github.com/Esenthel/EsenthelEngine) - (formerly Esenthel Engine) Cross-platform engine started in the year 2000.
    ...
    *   #### C++: Game Framework
        ...
        *   🎉 [Cute Framework (⭐312)](https://github.com/RandyGaul/cute_framework) - Simple and consise framework for making 2D games in C++.
        *   🔒 [Fireworks Engine (⭐28)](https://github.com/Pikachuxxxx/Fireworks-Engine) - Lightweight OpenGL engine for quick prototyping.
        *   🎉 [Halley (⭐3.2k)](https://github.com/amzeratul/halley) - Written in C++17. Used for Wargroove, a strategy game on desktop and consoles.
        *   🎉 [is::Engine (⭐92)](https://github.com/jhasse/jngl) - 2D engine built on SDL2 and SFML.
        *   🎉 [JNGL (⭐92)](https://github.com/jhasse/jngl) - 2D engine. Develop anywhere, deploy everywhere.
        *   🎉 [Lumino (⭐175)](https://github.com/LuminoEngine/Lumino) - Framework for building real-time graphics applications.
        *   🎉 [Nazara Engine (⭐465)](https://github.com/NazaraEngine/NazaraEngine) - Custom shaders, ECS, 2D/3D, networking and more.
        *   🎉 [ORX (⭐1k)](https://github.com/orx/orx) - Orx is a 2.5D data-driven game development engine.
        ...
        *   ⭐ [Ouzel (⭐903)](https://github.com/elnormous/ouzel) - Public domain C++ game engine mainly targeted for development of 2D games.
        ...
        *   🎉 [Supernova (⭐42)](https://github.com/supernovaengine/supernova) - Game engine cross-platform for 2D and 3D projects.
        *   🎉 [Two (⭐1.5k)](https://github.com/hugoam/two) - C++ toolkit for rapid development of live graphical apps and games.
        *   🎉 [Urho3D](https://urho3d.io) [:octocat: (⭐4.2k)](https://github.com/urho3d/Urho3D) - Cross-platform 2D and 3D game engine.
    ...
    *   #### C++: Geometry
        *   🎉 [CinoLib (⭐611)](https://github.com/mlivesu/cinolib) - Header only C++ library for processing polygonal and polyhedral meshes.
        ...
        *   🔒 [Easy3D (⭐884)](https://github.com/LiangliangNan/Easy3D) - Easy-to-use library for 3D modeling, geometry processing, and rendering.
        ...
        *   🎉 [MeshOptimizer (⭐3.8k)](https://github.com/zeux/meshoptimizer) - Mesh optimization library that makes meshes smaller and faster to render.
        *   🎉 [Polygon Mesh Processing Library](http://www.pmp-library.org) [:octocat: (⭐883)](https://github.com/pmp-library/pmp-library) - Processing / visualizing polygon surface meshes.
        *   🎉 [PolyPartition (⭐500)](https://github.com/ivanfratric/polypartition) - Lightweight C++ library for 2D polygon partition and triangulation.
        ...
        *   🎉 [Seam-aware Decimater (⭐413)](https://github.com/songrun/SeamAwareDecimater) - Simplifies mesh while preserving UVs, based on [Seamless](https://cragl.cs.gmu.edu/seamless/).
        *   🎉 [Spheres (⭐226)](https://github.com/caosdoar/spheres) - Four methods to create a sphere mesh.
    ...
    *   #### C++: Graphics - 2D
        ...
        *   🎉 [Skia](https://skia.org) [:octocat: (⭐7k)](https://github.com/google/skia) - Complete 2D graphic library by Google for drawing Text / Geometries / Images.
        *   🎉 [vg-renderer (⭐424)](https://github.com/jdryg/vg-renderer) - Vector graphics renderer for Bgfx, based on ideas from NanoVG.
    *   #### C++: Graphics - 3D
        ...
        *   🎉 [Threepp (⭐388)](https://github.com/markaren/threepp) - Cross-platform C++17 port of the popular JavaScript 3D library  Three.js (r129).
        *   🎉 [Tungsten (⭐1.6k)](https://github.com/tunabrain/tungsten) - High performance physically based renderer in C++11.
        *   🎉 [Wicked Engine](https://wickedengine.net) [:octocat: (⭐4.1k)](https://github.com/turanszkij/WickedEngine) - Engine focusing on modern rendering techniques and performance.
    *   #### C++: Gui
        *   🎉 [Crazy Eddie's GUI](http://cegui.org.uk) [:octocat: (⭐312)](https://github.com/cegui/cegui) - Versatile, multi-platform gui library.
        *   🎉 [Dear ImGui (⭐44k)](https://github.com/ocornut/imgui) - 🔥 Bloat-free immediate mode gui library. Ported to many other languages.
        ...
        *   ⭐ [Portable File Dialogs (⭐772)](https://github.com/samhocevar/portable-file-dialogs) - C++11, single-header native dialogs on Windows, macOS or Linux.
    ...
    *   #### C++: Input
        *   🎉 [Gainput](http://gainput.johanneskuhlmann.de) [:octocat: (⭐763)](https://github.com/jkuhlmann/gainput) - Awesome, easy to use input library.
        *   🎉 [OIS (⭐225)](https://github.com/wgois/OIS) - Object oriented input system. Compatiable with many systems and operating systems.
    ...
    *   #### C++: Lighting
        *   🎉 [Thekla Atlas (⭐393)](https://github.com/Thekla/thekla_atlas) - Atlas generation tool.
        *   🎉 [UVAtlas (⭐682)](https://github.com/Microsoft/UVAtlas) - DirectX library for creating and packing texture atlases.
    *   #### C++: Math
        *   🎉 [OpenGL Mathematics](https://glm.g-truc.net/0.9.9/index.html) [:octocat: (⭐7k)](https://github.com/g-truc/glm) - Header only C++ mathematics library for graphics software.
    *   #### C++: Network
        *   🎉 [Cpp-HttpLib (⭐8.2k)](https://github.com/yhirose/cpp-httplib) - Single header file HTTP / HTTPS server and client library in C++11.
    *   #### C++: Physics
        ...
        *   🎉 [Edyn (⭐370)](https://github.com/xissburg/edyn) - Multi-threaded, networked physics engine, supports large dynamic worlds. \[[Testbed (⭐27)](https://github.com/xissburg/edyn-testbed)]
        ...
        *   🎉 [Newton Dynamics](http://www.newtondynamics.com/) [:octocat: (⭐827)](https://github.com/MADEAPPS/newton-dynamics/) - Real time simulation of 3D environments.
        ...
        *   🎉 [Qu3e (⭐842)](https://github.com/RandyGaul/qu3e) - Fast 3D physics engine, created to be used in games.
    *   #### C++: Reflection
        ...
        *   🎉 [Meta (⭐447)](https://github.com/skypjack/meta) - Header-only, non-intrusive and macro-free runtime reflection system in C++17.
        *   🎉 [Nameof (⭐1.5k)](https://github.com/Neargye/nameof) - Header-only C++17, provides nameof macros to obtain name of a variable.
        *   🎉 [Ponder](https://billyquith.github.io/ponder/) [:octocat: (⭐570)](https://github.com/billyquith/ponder) - Expose C++17 classes and objects so they can used as data.
    ...
    *   #### C++: Scripting
        ...
        *   🎉 [GameMonkey Script](http://www.gmscript.com) [:octocat: (⭐126)](https://github.com/publicrepo/gmscript) - Embedded scripting language for C++ apps, tools and games.
    ...
    *   #### C++: Terrain
        *   🎉 [Terra Forge 3D](https://jaysmito101.github.io/TerraForge3D/) [:octocat: (⭐667)](https://github.com/Jaysmito101/TerraForge3D) - Procedural 3D terrain generation and texturing tool.
    *   #### C++: Utility
        *   🎉 [Any-Lite (⭐116)](https://github.com/martinmoene/any-lite) - Header only C++17-like any type for C++98 and above.
        *   🎉 [EASTL (⭐6.8k)](https://github.com/electronicarts/EASTL/) - Electronic Arts STL replacement, emphasis on performance.
    ...
    *   #### C++: Visual Programming / Nodes
        ...
        *   🎉 [QuickQanava](http://cneben.github.io/QuickQanava/index.html) [:octocat: (⭐870)](https://github.com/cneben/QuickQanava) - C++14, display graphs and relational content in a QtQuick application.
        *   🎉 [Visual Script Engine (⭐114)](https://github.com/kovacsv/VisualScriptEngine) - Visual scripting engine designed for embedding.
*   ### C\#
    *   #### - General -
    ...
    *   #### C#: Entity Component System
        *   🎉 [DefaultEcs (⭐494)](https://github.com/Doraku/DefaultEcs) - Framework with as much performance as possible for game development.
        *   🎉 [LeoECS (⭐104)](https://github.com/Leopotam/ecs) - Fast ECS Framework powered by C# with optional integration to Unity.
    *   #### C#: Game Engine w/Editor
        ...
        *   🎉 [Flat Red Ball](https://flatredball.com) [:octocat: (⭐114)](https://github.com/vchelaru/FlatRedBall) - 2D engine built on MonoGame & tools to help with game design. \[[Gui Editor](http://vchelaru.github.io/Gum/)]
    ...
    *   #### C#: Game Framework
        ...
        *   🎉 [Monofoxe (⭐296)](https://github.com/Martenfur/Monofoxe) - Game engine designed to simplify working with, and built on MonoGame.
        *   🎉 [MonoGame](https://www.monogame.net) [:octocat: (⭐9k)](https://github.com/MonoGame/MonoGame) - 🔥 Framework for creating powerful cross-platform games in C#.
        *   🎉 [Nez (⭐1.5k)](https://github.com/prime31/Nez) - Feature-rich 2D framework that sits on top of MonoGame.
        *   🎉 [Protogame (⭐172)](https://github.com/RedpointGames/Protogame) - Cross-platform 2D / 3D game engine for C#, built on top of MonoGame.
    *   #### C#: Graphics - 3D
        *   🎉 [OpenTK](https://opentk.net) [:octocat: (⭐2.6k)](https://github.com/opentk/opentk) - C# bindings for OpenGL. \[[LearnOpenGL Examples, ported to OpenTK (⭐341)](https://github.com/opentk/LearnOpenTK)]
    ...
    *   #### C#: Gui
        ...
        *   🎉 [GeonBit.UI (⭐386)](https://github.com/RonenNess/GeonBit.UI) - UI system for MonoGame projects.
        ...
        *   🎉 [Uno](https://platform.uno/) [:octocat: (⭐7.2k)](https://github.com/unoplatform/uno) - Mobile, desktop and WebAssembly gui library.
    *   #### C#: Physics
        *   🎉 [Aether Physics (⭐301)](https://github.com/tainicom/Aether.Physics2D) - Great 2D physics library with continuous collision detection.
        *   🎉 [Velcro Physics (⭐589)](https://github.com/Genbox/VelcroPhysics) - (formerly Farseer Physics) Original C# port of Box2D.
    *   #### C#: Utility
...
*   ### Dart
    ...
    *   #### Dart: File Formats
        *   🎉 [image (⭐896)](https://github.com/brendan-duncan/image) - Library for decoding / encoding image formats, and image processing.
    *   #### Dart: Game Framework
        *   🎉 [Flame](https://flame-engine.org) [:octocat: (⭐7.2k)](https://github.com/flame-engine/flame) - Minimalist Flutter based 2D game engine. \[[Awesome Flame (⭐634)](https://github.com/flame-engine/awesome-flame#readme) | [Examples](https://examples.flame-engine.org/#/) | [Tutorials](https://tutorials.flame-engine.org/#/)]
*   ### Haxe
    *   #### - General -
    ...
    *   #### Awesome Collections
        ...
        *   📚 [Awesome Haxe Game Dev (⭐320)](https://github.com/Dvergar/awesome-haxe-gamedev#readme) - Awesome list of game dev resources for Haxe.
    ...
    *   #### Haxe: App Framework
        *   🎉 [Lime](https://lime.openfl.org/) [:octocat: (⭐682)](https://github.com/haxelime/lime) - Flexible, lightweight layer for Haxe cross-platform developers.
        *   🎉 [nme (⭐457)](https://github.com/haxenme/nme) - Cross-platform native backend for Haxe projects.
    *   #### Haxe: Cross-Platform
        *   🎉 [HashLink](https://hashlink.haxe.org) [:octocat: (⭐711)](https://github.com/HaxeFoundation/hashlink/) - Virtual machine for Haxe.
    ...
    *   #### Haxe: Game Engine w/Editor
        ...
        *   🎉 [Away3D](http://away3d.com) [:octocat: (⭐163)](https://github.com/openfl/away3d) - Real-time 3D engine for OpenFL.
        *   🎉 [Flixel-Studio (⭐87)](https://github.com/Dovyski/flixel-studio) - Embeddable, in-game editor for HaxeFlixel.
        *   🎉 [Hide (⭐415)](https://github.com/heapsio/hide) - Extensible IDE for the Heaps 3D graphic engine.
    ...
    *   #### Haxe: Game Framework
        *   🎉 [Citrus](http://citrusengine.com) [:octocat: (⭐551)](https://github.com/DaVikingCode/Citrus-Engine) - 2D and 3D ActionScript 3 based engine.
        *   🎉 [Clay (⭐39)](https://github.com/clay2d/clay) - Cross-platform 2D game framework.
        *   🎉 [gameBase (⭐429)](https://github.com/deepnight/gameBase) - Base structure for Haxe games, using Heaps graphics framework. \[[Tutorial](https://deepnight.net/tutorial/using-my-gamebase-to-create-a-heaps-game/)]
    ...
    *   #### Haxe: Gui
        *   🎉 [HaxeUI](http://haxeui.org) [:octocat: (⭐289)](https://github.com/haxeui/haxeui-core) - Cross-platform set of styleable application centric, rich UI components.
    ...
    *   #### Haxe: Physics
        ...
        *   🎉 [Nape](https://joecreates.github.io/napephys/) [:octocat: (⭐39)](https://github.com/HaxeFlixel/nape-haxe4) - Very impressive powerful, fast, and friendly 2D rigid body physics engine.
    *   #### Haxe: Serialization / Storage
        *   🎉 [CastleDB (⭐474)](https://github.com/ncannasse/castle) - Structured database with a local web service to edit it.
    ...
    *   #### Haxe: Utility
        ...
        *   🎉 [SteamWrap (⭐88)](https://github.com/larsiusprime/SteamWrap) - Haxe native extension for the Steam API.
...
*   ### JavaScript
    ...
    *   #### JavaScript: Animation
        ...
        *   🎉 [Ossos (⭐242)](https://github.com/sketchpunklabs/ossos) - Web-based character animation system.
        ...
        *   🎉 [Theatre](https://www.theatrejs.com/) [:octocat: (⭐8.5k)](https://github.com/theatre-js/theatre) - Motion design editor for the web.
    ...
    *   #### JavaScript: Audio
        ...
        *   🎉 [Sonant-X (⭐210)](https://github.com/nicolas-van/sonant-x) - Very small JavaScript synthesizer library. \[[Online Composer](https://nicolas-van.github.io/sonant-x-live/)]
    ...
    *   #### JavaScript: Cross-Platform
        ...
        *   📚 [Electron Alternatives (⭐882)](https://github.com/sudhakar3697/electron-alternatives) - Cross platform gui app development options.
        ...
        *   🎉 [React Native](https://reactnative.dev) [:octocat: (⭐106k)](https://github.com/facebook/react-native) - Framework for building native applications using React.
        *   🎉 [Tauri](https://tauri.studio/) [:octocat: (⭐55k)](https://github.com/tauri-apps/tauri) - Smaller, faster, and more secure desktop applications.
    ...
    *   #### JavaScript: Entity Component System
        *   🎉 [Becsy (⭐115)](https://github.com/LastOliveGames/becsy) - Multithreaded Entity Component System (ECS) for TypeScript and JavaScript.
        *   🔒 [bitECS (⭐544)](https://github.com/NateTheGreatt/bitECS) - Functional, minimal, data-oriented, ultra-high performance ECS library.
        *   🎉 [Ecsy](https://ecsy.io) [:octocat: (⭐1.1k)](https://github.com/ecsyjs/ecsy) - Experimental ECS aiming to be lightweight, easy to use.
    *   #### JavaScript: Docking
        *   🎉 [Dock Spawn TS](https://node-projects.github.io/dock-spawn-ts/) [:octocat: (⭐86)](https://github.com/node-projects/dock-spawn-ts) - Maintained, TypeScript version of [Dock Spawn (⭐255)](https://github.com/coderespawn/dock-spawn), a html docking framework.
        *   🎉 [FlexLayout (⭐630)](https://github.com/caplin/FlexLayout) - Multi-tab layout manager.
        ...
        *   🎉 [RC-Dock](https://ticlo.github.io/rc-dock/examples/) [:octocat: (⭐411)](https://github.com/ticlo/rc-dock) - Dock Layout for React Component.
    ...
    *   #### JavaScript: Framework
        ...
        *   🎉 [Angular](https://angular.io) [:octocat: (⭐85k)](https://github.com/angular/angular) - The modern web developer's platform.
        ...
        *   🎉 [React](https://reactjs.org) [:octocat: (⭐199k)](https://github.com/facebook/react/) - Declarative, efficient, and flexible JavaScript library for building user interfaces.
    ...
    *   #### JavaScript: Game Engine w/Editor
        ...
        *   🎉 [Cocos Creator](https://www.cocos.com/en/creator) [:octocat: (⭐3.4k)](https://github.com/cocos-creator/engine) - Cross-Platform 2D / 3D game creation tool.
        ...
        *   🎉 [melonJS](https://melonjs.org) [:octocat: (⭐4.3k)](https://github.com/melonjs/melonJS) - Modern 2D game engine. Uses Tiled for level editing. \[[Examples](https://melonjs.github.io/examples/)]
        *   🎉 [microStudio](https://microstudio.dev/) [:octocat: (⭐711)](https://github.com/pmgl/microstudio/) - Free online game engine, learn and practice programming.
        ...
        *   🎉 [Taro](https://www.modd.io) [:octocat: (⭐261)](https://github.com/moddio/taro) - Multiplayer game engine with Box2D physics.
    *   #### JavaScript: Game Framework
        ...
        *   🎉 [Meep (⭐188)](https://github.com/Usnul/meep) - Entity component system game engine framework.
        *   🎉 [Oasis](https://oasisengine.cn/) [:octocat: (⭐3.2k)](https://github.com/ant-galaxy/oasis-engine) - (by AntGroup) WebGL engine, 2D, 3D, animation, physics.
    ...
    *   #### JavaScript: Geometry
        ...
        *   🎉 [Poly-Decomp.js](http://schteppe.github.io/poly-decomp.js/) [:octocat: (⭐344)](https://github.com/schteppe/poly-decomp.js) - Decompose 2D polygons into convex pieces.
        *   🎉 [Three-CSGMesh (⭐314)](https://github.com/manthrax/THREE-CSGMesh) - Conversion of the csg.js library for use with modern Three.js.
    *   #### JavaScript: Graphics - 2D
        *   🎉 [CanvasKit](https://skia.org/docs/user/modules/canvaskit/) [:octocat: (⭐7k)](https://github.com/google/skia/tree/main/modules/canvaskit) - WebAssembly build of Google's Skia, a mobile-first 2D graphics library.
        ...
        *   🎉 [Konva](https://konvajs.org) [:octocat: (⭐8.5k)](https://github.com/konvajs/konva) - Canvas framework enabling interactivity for desktop and mobile applications.
        ...
        *   🎉 [Pencil.js](https://pencil.js.org) [:octocat: (⭐243)](https://github.com/pencil-js/pencil.js) - Nice modular interactive 2D drawing library.
        *   🎉 [PixiJS](https://pixijs.com/) [:octocat: (⭐38k)](https://github.com/pixijs/pixijs) - 🔥 Fast, lightweight 2D library. \[[Awesome PixiJS (⭐634)](https://github.com/cursedcoder/awesome-pixijs) | [Editor (⭐180)](https://github.com/Megabyteceer/thing-editor)]
        *   🎉 [Pts](https://ptsjs.org) [:octocat: (⭐4.9k)](https://github.com/williamngan/pts) - Library for visualization and creative-coding.
        *   🎉 [Scrawl-canvas](https://scrawl-v8.rikweb.org.uk) [:octocat: (⭐224)](https://github.com/KaliedaRik/Scrawl-canvas) - Library for working with the HTML5 Canvas element.
        ...
        *   🎉 [ZIM](https://zimjs.com/index.html) [:octocat: (⭐351)](https://github.com/danzen/zimjs) - Canvas framework for code creativity.
    *   #### JavaScript: Graphics - 3D
        ...
        *   🎉 [Hilo3d](https://hilo3d.js.org/docs/index.html) [:octocat: (⭐548)](https://github.com/hiloteam/Hilo3d) - (by Alibaba) WebGL 3D rendering engine.
        *   🎉 [Litescene.js (⭐326)](https://github.com/jagenjo/litescene.js) - WebGL 3D engine library, used by [WebGLStudio](https://webglstudio.org).
        *   🎉 [LUME (⭐881)](https://github.com/lume/lume) - Toolkit that simplifies the creation of interactive 2D / 3D experiences.
        ...
        *   🎉 [PicoGL.js](https://tsherif.github.io/picogl.js/) [:octocat: (⭐757)](https://github.com/tsherif/picogl.js) - Minimal WebGL 2 rendering library.
        *   🎉 [Pixi3D](https://pixi3d.org/) [:octocat: (⭐291)](https://github.com/jnsmalm/pixi3d#getting-started) - The 3D renderer for PixiJS. Seamless integration with 2D applications.
        *   🎉 [Regl (⭐4.8k)](https://github.com/regl-project/regl) - Fast functional WebGL.
        *   🎉 [Three.js](https://threejs.org) [:octocat: (⭐87k)](https://github.com/mrdoob/three.js/) - 🔥 General purpose 3D library. \[[Editor](https://threejs.org/editor/) | [Examples](https://threejs.org/examples/) | [Awesome Three.js (⭐321)](https://github.com/0xAxiome/awesome-threejs)]
        *   🎉 [TWGL](https://twgljs.org/) [:octocat: (⭐2.2k)](https://github.com/greggman/twgl.js) - Tiny WebGL helper Library.
        *   🎉 [x3dom (⭐753)](https://github.com/x3dom/x3dom) - Integrate 3D content seamlessly into your webpage.
    *   #### JavaScript: Graphics - Three.js Reference
        ...
        *   🎉 [Sketchbook](https://jblaha.art/sketchbook/0.4/) [:octocat: (⭐1k)](https://github.com/swift502/Sketchbook) - 3D playground built on Three.js and Cannon.js.
    ...
    *   #### JavaScript: Gui
        *   🎉 [Bootstrap](https://getbootstrap.com) [:octocat: (⭐161k)](https://github.com/twbs/bootstrap) - Framework for developing responsive, mobile first projects.
        *   🎉 [dat.GUI (⭐6.6k)](https://github.com/dataarts/dat.gui) - Lightweight graphical user interface for changing variables in JavaScript.
        *   🎉 [Dojo](https://widgets.dojo.io/) [:octocat: (⭐83)](https://github.com/dojo/widgets) - UI widgets for modern web applications.
        *   🎉 [Guify (⭐231)](https://github.com/colejd/guify) - Simple GUI for inspecting and changing JavaScript variables. \[[Demo](https://jons.website/projects/guify/)]
        ...
        *   🎉 [Leva](https://leva.pmnd.rs/) [:octocat: (⭐3.3k)](https://github.com/pmndrs/leva) - React-first components GUI.
        *   🎉 [Magic Circle](https://magic-circle.dev/) [:octocat: (⭐26)](https://github.com/dpwoert/magic-circle) - Multi-functional gui inspired by dat.GUI, Unity and Framer.
        *   🎉 [PCUI](https://playcanvas.github.io/pcui) [:octocat: (⭐547)](https://github.com/playcanvas/pcui) - UI component library for the web, made for PlayCanvas.
        *   🎉 [Tweakpane](https://cocopon.github.io/tweakpane/) [:octocat: (⭐2.4k)](https://github.com/cocopon/tweakpane) - Compact GUI for fine-tuning values.
        *   🎉 [uil](https://lo-th.github.io/uil/) [:octocat: (⭐499)](https://github.com/lo-th/uil) - Simple JavaScript UI.
        *   🎉 [w2ui](https://w2ui.com/web/) [:octocat: (⭐2.4k)](https://github.com/vitmalina/w2ui) - UI widgets for modern apps.
        *   🎉 [Zebkit](https://zebkit.org/dark/about.html) [:octocat: (⭐921)](https://github.com/barmalei/zebkit) - Canvas rendered UI component libary, very cool.
    *   #### JavaScript: Input
        *   🎉 [Joycon.js](https://joycon.js.org/) [:octocat: (⭐83)](https://github.com/barhatsor/joycon.js) - JavaScript controller functionality.
    *   #### JavaScript: Layout
    ...
    *   #### JavaScript: Materials
        *   🎉 [three-projected-material](https://marcofugaro.github.io/three-projected-material/) [:octocat: (⭐446)](https://github.com/marcofugaro/three-projected-material) - Texture projection in Three.js.
        *   🎉 [Troika JS - Derived Material](https://protectwise.github.io/troika/troika-three-utils/createDerivedMaterial/) [:octocat: (⭐1k)](https://github.com/protectwise/troika/blob/master/packages/troika-three-utils/src/DerivedMaterial.js) - Extend existing Three.js materials.
    ...
    *   #### JavaScript: Physics
        *   🎉 [Ammo.js (⭐3.4k)](https://github.com/kripken/ammo.js) - 3D Bullet Physics engine ported as WebAssembly.
        *   🎉 [Box2d.js (⭐1.2k)](https://github.com/kripken/box2d.js/) - Box2D to ported as WebAssembly.
        *   🎉 [Cannon-es](https://pmndrs.github.io/cannon-es/) [:octocat: (⭐1.2k)](https://github.com/pmndrs/cannon-es) - Maintained fork of [Cannon.js (⭐4.1k)](https://github.com/schteppe/cannon.js), a 3D physics engine written in JavaScript.
        *   🎉 [Goblin Physics](http://www.goblinphysics.com) [:octocat: (⭐139)](https://github.com/chandlerprall/GoblinPhysics) - Open source 3D physics engine written from the ground up in JavaScript.
        ...
        *   🎉 [Verly.js](https://anuraghazra.dev/Verly.js/) [:octocat: (⭐536)](https://github.com/anuraghazra/Verly.js) - Easy to integrate verlet physics engine.
    *   #### JavaScript: Utility
        ...
        *   🎉 [i18next](https://www.i18next.com/) [:octocat: (⭐6.5k)](https://github.com/i18next/i18next) - Popular internationalization framework.
    ...
    *   #### JavaScript: Timeline
        *   🎉 [Frame.js](https://framejs.app/) [:octocat: (⭐953)](https://github.com/mrdoob/frame.js/) - JavaScript sequence editor.
    ...
    *   #### JavaScript: Visual Programming / Nodes
        *   🎉 [Butterfly](https://butterfly-dag.gitee.io/butterfly-dag/home) [:octocat: (⭐3.3k)](https://github.com/alibaba/butterfly) - (by [Alibaba](https://www.alibabagroup.com/en/global/home)) Diagramming library concentrated on flow and field layout.
        *   🎉 [Drawflow](https://jerosoler.github.io/Drawflow/) [:octocat: (⭐2.8k)](https://github.com/jerosoler/Drawflow) - Simple JavaScript flow library.
        *   🎉 [Flow (⭐56)](https://github.com/sunag/flow) - Node-Graph, lightweight, cross-browser UI library.
        ...
        *   🎉 [Rete.js](https://rete.js.org/) [:octocat: (⭐7.9k)](https://github.com/retejs/rete) - Framework for visual programming and creating a node editor.
*   ### Ruby
    *   #### - General -
    ...
    *   #### Ruby: Game Framework
        *   🎉 [Ruby 2D](https://www.ruby2d.com/) [:octocat: (⭐577)](https://github.com/ruby2d/ruby2d) - Make cross-platform 2D applications in Ruby.
    *   #### Ruby: Graphics - 3D
        *   🎉 [Mittsu (⭐479)](https://github.com/danini-the-panini/mittsu) - 3D Graphics Library for Ruby based heavily on Three.js.
    *   #### Ruby: Gui
        *   🎉 [Glimmer (⭐313)](https://github.com/andyobtiva/glimmer) - GUI library and DSL (domain specific language) framework.
...
*   ### Rust
    ...
    *   #### Awesome Collections
        *   📚 [Awesome Rust (⭐31k)](https://github.com/rust-unofficial/awesome-rust) - Curated list of Rust code and resources.
    *   #### Rust: App Framework
        *   🎉 [Makepad](https://makepad.dev) [:octocat: (⭐2.3k)](https://github.com/makepad/makepad) - Software development platform and native-rendering gui framework.
        *   🎉 [Tao](https://docs.rs/tao/latest/tao/) [:octocat: (⭐872)](https://github.com/tauri-apps/tao) - Cross-platform windowing.
    *   #### Rust: Game Engine w/Editor
        *   🎉 [Fyrox](https://fyrox.rs/) [:octocat: (⭐5.3k)](https://github.com/FyroxEngine/Fyrox) - (formerly rg3d) 2D / 3D game engine with a scene editor.
    *   #### Rust: Game Framework
        ...
        *   🎉 [Bevy](https://bevyengine.org) [:octocat: (⭐21k)](https://github.com/bevyengine/bevy) - 🔥 Refreshingly simple data-driven 2D / 3D game engine built in Rust.
        *   🎉 [Macroquad (⭐1.8k)](https://github.com/not-fl3/macroquad) - Easy to use game library, heavily inspired by RayLib.
    *   #### Rust: Graphics - 3D
        *   🎉 [Kiss3D](http://kiss3d.org) [:octocat: (⭐1.2k)](https://github.com/sebcrozet/kiss3d) - Keep it simple, stupid 3D graphics engine for Rust.
    *   #### Rust: Gui
        *   🎉 [Druid](https://linebender.org/druid/) [:octocat: (⭐8.1k)](https://github.com/linebender/druid) - Data-first Rust-native UI design toolkit.
        *   🎉 [egui (⭐12k)](https://github.com/emilk/egui) - Awesome, easy to use, immediate mode GUI, runs on both web and native. \[[Demo](https://www.egui.rs/)]
        *   🔒 [Slint](https://slint-ui.com/) [:octocat: (⭐5.4k)](https://github.com/slint-ui/slint) - (formerly SixtyFPS) Gui toolkit for embedded devices / desktop apps.
    *   #### Rust: Physics
        *   🎉 [Rapier](https://rapier.rs) [:octocat: (⭐2.1k)](https://github.com/dimforge/rapier) - 2D and 3D physics engines focused on performance.
*   ### Zig
    *   #### - General -
    ...
    *   #### Awesome Collections
        *   📚 [Awesome Zig (⭐682)](https://github.com/nrdmn/awesome-zig) - Curated list of Zig code and resources.
    *   #### Zig: App Framework
        *   🎉 [Upaya (⭐120)](https://github.com/prime31/zig-upaya) - Zig-based framework for creating game tools and helper apps.
    *   #### Zig: File System
        *   🎉 [Known Folders (⭐136)](https://github.com/ziglibs/known-folders) - Provides access to well-known folders across several operating systems.
    *   #### Zig: Game Engine w/Editor
        *   🎉 [Mach](https://hexops.com/mach/) [:octocat: (⭐1.4k)](https://github.com/hexops/mach) - Game engine & graphics toolkit, still in early developemnt.
    *   #### Zig: Game Framework
        *   🎉 [Zig-Gamedev Project (⭐1.2k)](https://github.com/michal-z/zig-gamedev) - Sample apps and libraries written in Zig using DirectX 12.
    *   #### Zig: Graphics - 2D
        *   🎉 [Mini Pixel](https://fabioarnold.itch.io/mini-pixel) [:octocat: (⭐109)](https://github.com/fabioarnold/MiniPixel) - Tiny pixel art editor.
        *   🔒 [Pixi (⭐129)](https://github.com/foxnne/pixi) - Pixel art editor made with Zig.
...
*   ### Fluid / Smoke
    ...
    *   🔒 [Fluids-2D](https://www.csc.kth.se/\~mathar/fluids-2d/) [:octocat: (⭐326)](https://github.com/mharrys/fluids-2d) - Real-time fluid dynamics running on the GPU with the help of WebGL and Three.js.
...
*   ### Physics
    ...
    *   #### Soft Body
        ...
        *   🌎 [Three.js: Ammo Volume](https://threejs.org/examples/?q=physics#physics_ammo_volume) [:octocat: (⭐87k)](https://github.com/mrdoob/three.js/blob/master/examples/physics_ammo_volume.html) - Demo of 3D soft body volumes using Ammo.js and Three.js.
    *   #### Verlet Physics
...
*   ### Scripting
    ...
    *   📚 [List of Embedded Scripting Languages (⭐979)](https://github.com/dbohdan/embedded-scripting-languages) - Scripting languages to use in your app / game.
    *   📚 [Scriptorium (⭐479)](https://github.com/r-lyeh-archived/scriptorium) - Game scripting languages benchmarked.
...
*   ### Audio Tools
    *   #### Music
        ...
        *   🆓 [Audacity](https://www.audacityteam.org) [:octocat: (⭐8.5k)](https://github.com/audacity/audacity) - Cross-platform, multi-track audio editor and recorder.
        ...
        *   🆓 [Sound Box](https://sb.bitsnbites.eu) [:octocat: (⭐400)](https://github.com/mbitsnbites/soundbox) - Compose synthetic music in your browser. Great for small JavaScript demos.
        ...
        *   🆓 [ZzFXM](https://keithclark.github.io/ZzFXM/tracker/) [:octocat: (⭐359)](https://github.com/keithclark/ZzFXM) - Music generator for use in tiny JavaScript productions.
    *   #### Sound Effects
        *   🆓 [Bfxr](https://www.bfxr.net) [:octocat: (⭐880)](https://github.com/increpare/bfxr) - Program of choice for many people looking to make sound effects for games.
        ...
        *   🆓 [ZzFX](https://killedbyapixel.github.io/ZzFX/) [:octocat: (⭐428)](https://github.com/KilledByAPixel/ZzFX) - Tiny JavaScript Sound FX System / Zuper Zmall Zound Zynth.
*   ### Color / Palettes
...
*   ### Materials / Textures
    *   🆓 [ArmorLab](https://armorlab.org) [:octocat: (⭐154)](https://github.com/armory3d/armorlab) - Generate PBR materials by drag & dropping your photos.
...
*   ### Modeling Tools
    ...
    *   🆓 [Blender](https://www.blender.org) [:octocat: (⭐7.2k)](https://github.com/blender/blender) - 🔥 Free and open source, supports the entirety of the 3D pipeline.
    *   🆓 [Meshroom](https://alicevision.org/#meshroom) [:octocat: (⭐8.6k)](https://github.com/alicevision/meshroom) - Free, open-source 3D reconstruction software based on the AliceVision framework.
...
*   ### Pixel Art
    ...
    *   🆓 [Piskel](https://www.piskelapp.com) [:octocat: (⭐9.2k)](https://github.com/piskelapp/piskel) - Free online editor for animated sprites & pixel art.
...
*   ### Vector Editors
    ...
    *   🆓 [Krita](https://krita.org/en/) [:octocat: (⭐4.4k)](https://github.com/KDE/krita) - Professional free and open source painting program.
...
*   ### Model Assets
    ...
    *   📚 [Retro3DGraphicsCollection (⭐788)](https://github.com/Miziziziz/Retro3DGraphicsCollection) - No attribution, retro style 3D graphic assets (think PS1).
