...
*   💸 [Unreal Engine](https://www.unrealengine.com) - AAA quality, insane feature set, photoreal visuals. \[[Awesome UE4 (⭐630)](https://github.com/insthync/awesome-ue4#readme)]
...
*   💸 [Flax Engine](https://flaxengine.com) [:octocat: (⭐3.8k)](https://github.com/FlaxEngine/FlaxEngine) - Modern 3D game engine written in C++ and C#.
...
*   🎉 [O3DE](https://www.o3de.org/) [:octocat: (⭐5.9k)](https://github.com/o3de/o3de/) - (successor to Lumberyard) Multi-platform AAA engine. Cinema-quality 3D.
...
*   💸 [Construct](https://www.construct.net/) - Browser based drag and drop game builder. \[[Awesome Construct (⭐52)](https://github.com/ConstructCommunity/awesome-construct#readme)]
...
*   💸 [NeoAxis](https://www.neoaxis.com) [:octocat: (⭐84)](https://github.com/NeoAxis/NeoAxisEngine) - Versatile real-time platform for making 2D / 3D games and apps.
*   💰 [Phaser Editor 2D](https://phasereditor2d.com) [:octocat: (⭐259)](https://github.com/PhaserEditor2D/PhaserEditor2D-v3) - Commercial, web based editor for Phaser.
*   💸 [PlayCanvas](https://playcanvas.com) [:octocat: (⭐8.1k)](https://github.com/playcanvas/engine) - Popular (Flappy Bird), game engine built on WebGL. \[[Awesome PlayCanvas (⭐190)](https://github.com/playcanvas/awesome-playcanvas#readme)]
...
*   💸 [Stencyl](https://www.stencyl.com/) [:octocat: (⭐174)](https://github.com/Stencyl/stencyl-engine) - Quick and easy game making. Visual scripting similar to [Scratch](https://scratch.mit.edu).
...
*   🎉 [GB Studio](https://www.gbstudio.dev) [:octocat: (⭐6.9k)](https://github.com/chrismaltby/gb-studio) - Retro adventure game creator for Game Boy available for Mac, Linux and Windows.
...
*   Graphics API: DirectX
    *   🌎 [DirectX](https://docs.microsoft.com/en-us/windows/win32/directx) - Microsoft API used to create 2D / 3D games and apps. \[[Sample Code (⭐5k)](https://github.com/microsoft/DirectX-Graphics-Samples) | [Blog](https://devblogs.microsoft.com/directx/)]
...
*   Graphics API: Vulkan
    *   🌎 [Vulkan](https://www.vulkan.org) - Modern cross-platform graphics API. \[[Sample Code (⭐2.9k)](https://github.com/khronosGroup/Vulkan-samples)]
...
*   Platform: XNA
    ...
    *   📚 [XNA Game Studio Archive (⭐527)](https://github.com/SimonDarksideJ/XNAGameStudio) - 🔥 Required visit for MonoGame / FNA / [XNA](https://en.wikipedia.org/wiki/Microsoft_XNA) developers.
...
*   BASIC: App Framework
    ...
    *   🎉 [QB64](https://qb64.com/) [:octocat: (⭐604)](https://github.com/QB64Team/qb64) - Modern BASIC + OpenGL language, retains QB4.5 / QBasic compatibility.
    *   📚 [Visual Basic](https://docs.microsoft.com/en-us/dotnet/visual-basic/) - Object-oriented language developed by Microsoft.
*   BASIC: Game Framework
    *   🎉 [Dark Basic](https://www.thegamecreators.com/product/dark-basic-pro-open-source) [:octocat: (⭐389)](https://github.com/TheGameCreators/Dark-Basic-Pro) - BASIC programming language for creating Windows apps and games.
...
*   C: App Framework
    ...
    *   🎉 [SDL](https://libsdl.org) [:octocat: (⭐4.9k)](https://github.com/libsdl-org/SDL) - 🔥 Low level access to audio, keyboard, mouse, joystick, and graphics hardware.
    *   🎉 [Sokol (⭐4.2k)](https://github.com/floooh/sokol) - 🔥 Single-file libraries for graphics, windowing, file handling, audio and more. Excellent!
*   C: Audio
    ...
    *   🎉 [SDL\_mixer](https://libsdl.org/projects/SDL_mixer/) [:octocat: (⭐212)](https://github.com/libsdl-org/SDL_mixer) - Audio mixer that supports various file formats for SDL.
...
*   C: File Formats
    *   🎉 [Assimp](https://www.assimp.org) [:octocat: (⭐8.6k)](https://github.com/assimp/assimp) - The Open Asset Importer Library. Loads 40+ 3D file formats.
    *   🎉 [cgltf (⭐1.1k)](https://github.com/jkuhlmann/cgltf) - Single-file glTF 2.0 loader and writer written in C99.
    *   ⭐ [dr\_libs (⭐914)](https://github.com/mackron/dr_libs) - Single file audio decoding libraries for C/C++.
    *   🎉 [Libspng (⭐581)](https://github.com/randy408/libspng) - Simple, modern libpng alternative.
    *   🎉 [Miniz (⭐1.7k)](https://github.com/richgel999/miniz) - Single C source file drop-in replacement for zlib's most used APIs (libpng and libzip).
    *   🎉 [OBJ GL Loader v2 (⭐9)](https://github.com/karolek471/objgl) - Quite fast wavefront OBJ loader for OpenGL.
    *   🎉 [PL\_MPEG (⭐606)](https://github.com/phoboslab/pl_mpeg) - Single file C library for decoding MPEG1 Video and MP2 Audio.
...
*   C: File System
    ...
    *   ⭐ [Incbin (⭐766)](https://github.com/graphitemaster/incbin) - Include binary and text files in your C/C++ applications with ease.
    *   🎉 [PhysicsFS](http://icculus.org/physfs/) [:octocat: (⭐312)](https://github.com/icculus/physfs) - Portable, flexible file i/o abstraction, provides access to various archives.
    *   ⭐ [Where Am I (⭐388)](https://github.com/gpakosz/whereami) - Locates the current path on the local file system.
*   C: Fonts
    *   🎉 [Font Stash (⭐567)](https://github.com/memononen/fontstash) - Light-weight library that uses stb\_truetype to render fonts to a texture atlas.
...
*   C: Game Framework
    ...
    *   ⭐ [FWK (⭐454)](https://github.com/r-lyeh/FWK) - 3D game framework in C.
    *   🎉 [Gunslinger (⭐910)](https://github.com/MrFrenik/gunslinger) - Header-only c99 framework for multimedia apps.
    *   🎉 [RayLib](https://www.raylib.com) [:octocat: (⭐12k)](https://github.com/raysan5/raylib) - 🔥 Simple and easy-to-use library to enjoy 2D / 3D videogame programming.
*   C: Geometry
    *   🎉 [Blob (⭐46)](https://github.com/BlockoS/blob) - Single header implementation of a contour tracing algorithm
    *   🎉 [Marching Squares](https://prideout.net/marching-squares) [:octocat: (⭐791)](https://github.com/prideout/par/blob/master/par_msquares.h) - Converts grayscale images, or 8-bit color images, into triangles.
    *   🎉 [Octasphere](https://prideout.net/blog/octasphere/) [:octocat: (⭐791)](https://github.com/prideout/par/blob/master/par_octasphere.h) - Generates triangle meshes for spheres, rounded boxes, and capsules.
    *   🎉 [Par\_Shapes](https://prideout.net/shapes) [:octocat: (⭐791)](https://github.com/prideout/par/blob/master/par_shapes.h) - Create and manipulate of triangle meshes, including solids, spheres and more.
    *   🎉 [Par\_Streamlines](https://prideout.net/blog/par_streamlines/) [:octocat: (⭐791)](https://github.com/prideout/par/blob/master/par_streamlines.h) - Library for triangulating wide/thick lines, Béziers, streamlines. \[[Demo (⭐26)](https://github.com/prideout/streamlines_demo)]
*   C: Graphics - 2D
    ...
    *   🎉 [Tilengine (⭐689)](https://github.com/megamarc/Tilengine) - 2D graphics with raster effects for retro style game dev.
*   C: Graphics - 3D
    *   🎉 [Sokol Gfx (⭐4.2k)](https://github.com/floooh/sokol/blob/master/sokol_gfx.h) - Cross-platform, single-file graphics. \[[Examples](https://floooh.github.io/sokol-html5/) | [LearnOpenGL Examples](https://www.geertarien.com/learnopengl-examples-html5/)]
    *   🎉 [Sokol Graphics Painter (⭐277)](https://github.com/edubart/sokol_gp) - 2D graphics painter implemented using Sokol.
*   C: Gui
    ...
    *   🎉 [NAppGUI](https://nappgui.com/en/home/web/home.html) [:octocat: (⭐255)](https://github.com/frang75/nappgui_src) - Professional, well documented SDK to build desktop applications using C.
...
*   C: Input
    ...
    *   🎉 [Sokol Gamepad (⭐4.2k)](https://github.com/floooh/sokol/pull/393/commits/26a9da9dafd4adb22a1ace0de0d2569da31ae427) - Branch with add on support for game pads in Sokol.
*   C: Lighting
...
*   C: Scripting
    ...
    *   🎉 [Lua](https://www.lua.org) [:octocat: (⭐6.5k)](https://github.com/lua/lua) - Powerful, efficient, lightweight, embeddable scripting language.
    *   🎉 [QuickJS](https://bellard.org/quickjs/) [:octocat: (⭐5.6k)](https://github.com/bellard/quickjs) - Small and embeddable JavaScript engine.
...
*   C++: App Framework
    ...
    *   🎉 [Cross Window](https://alain.xyz/libraries/crosswindow) [:octocat: (⭐404)](https://github.com/alaingalvan/CrossWindow) - For managing windows and performing OS tasks.
    *   🎉 [SFML](https://www.sfml-dev.org/index.php) [:octocat: (⭐8.4k)](https://github.com/SFML/SFML) - 🔥 Cross-platform access to windowing, graphics, audio and networking.
*   C++: Animation
    *   🎉 [Ozz-Animation](http://guillaumeblanc.github.io/ozz-animation/) [:octocat: (⭐1.9k)](https://github.com/guillaumeblanc/ozz-animation) - Open source skeletal animation library and toolset.
    *   🎉 [Tweeny](https://mobius3.github.io/tweeny/) [:octocat: (⭐583)](https://github.com/mobius3/tweeny) - Inbetweening library for complex animations for games / apps.
*   C++: Audio
    *   💰 [irrKlang](https://www.ambiera.com/irrklang/) - High level 2D and 3D cross-platform desktop sound engine and audio library.
    *   💰 [Juce (⭐4.8k)](https://github.com/juce-framework/JUCE) - The leading framework for multi-platform audio applications.
    *   🔒 [OpenAL Soft (⭐1.7k)](https://github.com/kcat/openal-soft) - Software implementation of the OpenAL 3D audio API.
    *   🎉 [PortAudio](http://www.portaudio.com) [:octocat: (⭐814)](https://github.com/PortAudio/portaudio) - Free, cross-platform, open-source, audio I/O library.
*   C++: Cross-Platform
...
*   C++: File System
    *   🎉 [Imgui-Filebrowser (⭐438)](https://github.com/AirGuanZ/imgui-filebrowser) - Header only file browser implementation for Dear ImGui. C++17 is required.
*   C++: Game Engine w/Editor
    ...
    *   🔒 [Enigma](https://enigma-dev.org/) [:octocat: (⭐265)](https://github.com/enigma-dev/enigma-dev) - Open source Game Maker compatible 2D engine.
    ...
    *   🎉 [Ethereal Engine (⭐796)](https://github.com/volcoma/EtherealEngine) - Cross-platform C++ game engine and editor.
    *   🎉 [ezEngine](http://ezengine.net/index.html) [:octocat: (⭐844)](https://github.com/ezEngine/ezEngine) - Open source game engine in active development. \[[Editor Info](http://ezengine.net/pages/getting-started/editor-overview.html)]
    *   🎉 [FIFE](http://www.fifengine.net/) [:octocat: (⭐528)](https://github.com/fifengine/fifengine) - Multi-platform isometric game engine.
    ...
    *   🎉 [Lina Engine (⭐485)](https://github.com/inanevin/LinaEngine) - Modular C++ game engine, aimed to develop 3D desktop games.
    *   🎉 [Lumos (⭐821)](https://github.com/jmorton06/Lumos) - Cross-platform 2D and 3D Game Engine, supports both OpenGL and Vulkan.
    ...
    *   🔒 [neoGFX](https://neogfx.org) [:octocat: (⭐473)](https://github.com/i42output/neogfx) - Cross-platform GPU-oriented C++ application / game framework.
    *   🎉 [ÖbEngine (⭐672)](https://github.com/ObEngine/ObEngine) - 2D Engine with Lua Scripting built on SFML.
    ...
    *   🎉 [Polycode (⭐2.4k)](https://github.com/ivansafrin/Polycode) - Cross-platform framework for creative code. Nice editor.
    *   🎉 [Razix Engine (⭐160)](https://github.com/Pikachuxxxx/Razix) - High performance research engine for production pipeline.
    *   🎉 [Rootex](https://rootex.readthedocs.io/en/latest/) [:octocat: (⭐181)](https://github.com/sdslabs/rootex) - Advanced C++ 3D game engine powering an in-production game.
    *   🎉 [SGEEngine (⭐73)](https://github.com/ongamex/SGEEngine) - Game engine with an editor usable as a sandbox.
    *   🎉 [Skylicht (⭐385)](https://github.com/skylicht-lab/skylicht-engine) - Based on Irrlicht, with upgraded features including audio, physics and particles.
    *   🎉 [Spartan Engine (⭐1.6k)](https://github.com/PanosK92/SpartanEngine) - Emphasis on quality and performance.
    *   🎉 [Titan Engine](https://esenthel.com/) [:octocat: (⭐514)](https://github.com/Esenthel/EsenthelEngine) - (formerly Esenthel Engine) Cross-platform engine started in the year 2000.
...
*   C++: Game Framework
    ...
    *   🎉 [Cute Framework (⭐316)](https://github.com/RandyGaul/cute_framework) - Simple and consise framework for making 2D games in C++.
    ...
    *   🎉 [Koala Engine (⭐479)](https://github.com/phisko/kengine) - (aka Kengine) Framework with an entity component system architecture.
    *   🎉 [Lumino (⭐179)](https://github.com/LuminoEngine/Lumino) - Framework for building real-time graphics applications.
    *   🎉 [Nazara Engine (⭐490)](https://github.com/NazaraEngine/NazaraEngine) - Custom shaders, ECS, 2D/3D, networking and more.
    *   🎉 [ORX (⭐1.1k)](https://github.com/orx/orx) - Orx is a 2.5D data-driven game dev framework.
    ...
    *   🎉 [Supernova (⭐70)](https://github.com/supernovaengine/supernova) - Cross-platform for 2D and 3D projects.
    *   🎉 [Thunder (⭐395)](https://github.com/thunder-engine/thunder) - Cross-platform 2D and 3D with module architecture.
    *   🎉 [Two (⭐1.5k)](https://github.com/hugoam/two) - C++ toolkit for rapid development of live graphical apps and games.
    *   🎉 [Urho3D (⭐4.3k)](https://github.com/urho3d/Urho3D) - Cross-platform 2D and 3D game framework.
...
*   C++: Geometry
    *   🎉 [CinoLib (⭐634)](https://github.com/mlivesu/cinolib) - Header only C++ library for processing polygonal and polyhedral meshes.
    ...
    *   🔒 [Libigl](https://libigl.github.io) [:octocat: (⭐3.8k)](https://github.com/libigl/libigl) - Simple C++ geometry processing library.
    ...
    *   🎉 [Polygon Mesh Processing Library](http://www.pmp-library.org) [:octocat: (⭐907)](https://github.com/pmp-library/pmp-library) - Processing / visualizing polygon surface meshes.
    *   🎉 [PolyPartition (⭐509)](https://github.com/ivanfratric/polypartition) - Lightweight C++ library for 2D polygon partition and triangulation.
...
*   C++: Graphics - 2D
    ...
    *   🎉 [QNanoPainter (⭐317)](https://github.com/QUItCoding/qnanopainter) - OpenGL accelerated C++ vector drawing library for Qt, powered by NanoVG.
    *   🎉 [Skia](https://skia.org) [:octocat: (⭐7.2k)](https://github.com/google/skia) - Complete 2D graphic library by Google for drawing Text / Geometries / Images.
    *   🎉 [vg-renderer (⭐427)](https://github.com/jdryg/vg-renderer) - Vector graphics renderer for Bgfx, based on ideas from NanoVG.
*   C++: Graphics - 3D
    *   🎉 [Bgfx (⭐13k)](https://github.com/bkaradzic/bgfx) - Cross-platform, graphics API agnostic, rendering library.
    *   🎉 [Diligent Engine](http://diligentgraphics.com/diligent-engine/) [:octocat: (⭐2.7k)](https://github.com/DiligentGraphics/DiligentEngine) - Modern, lightweight cross-platform graphics API abstraction library.
    ...
    *   🎉 [Threepp (⭐400)](https://github.com/markaren/threepp) - Cross-platform C++17 port of the popular JavaScript 3D library  Three.js (r129).
...
*   C++: Gui
    ...
    *   ⭐ [Portable File Dialogs (⭐801)](https://github.com/samhocevar/portable-file-dialogs) - C++11, single-header native dialogs on Windows, macOS or Linux.
    *   🔒 [Qt](https://www.qt.io) - Industry standard cross-platform gui library. \[[Awesome Qt Guide (⭐33)](https://github.com/mikeroyal/Qt-Guide)]
    ...
    *   🔒 [wxWidgets](https://wxwidgets.org) [:octocat: (⭐4.9k)](https://github.com/wxWidgets/wxWidgets) - Cross-platform gui apps using native controls.
*   C++: Input
    *   🎉 [Gainput](http://gainput.johanneskuhlmann.de) [:octocat: (⭐768)](https://github.com/jkuhlmann/gainput) - Awesome, easy to use input library.
    *   🎉 [OIS (⭐230)](https://github.com/wgois/OIS) - Object oriented input system. Compatiable with many systems and operating systems.
...
*   C++: Network
    *   🎉 [Cpp-HttpLib (⭐8.6k)](https://github.com/yhirose/cpp-httplib) - Single header file HTTP / HTTPS server and client library in C++11.
*   C++: Physics
    *   🎉 [Box2D](https://box2d.org) [:octocat: (⭐6.2k)](https://github.com/erincatto/box2d) - Battle tested 2D physics for games. \[[Docs](https://box2d.org/documentation/) | [Tutorials](http://www.iforce2d.net/b2dtut/introduction) | [Fixed Time-Step](https://www.unagames.com/blog/daniele/2010/06/fixed-time-step-implementation-box2d)]
    ...
    *   🎉 [Jolt Physics (⭐2.6k)](https://github.com/jrouwe/JoltPhysics) - Multi core friendly rigid body 3D physics and collision detection library.
    ...
    *   🎉 [ReactPhysics3D](https://www.reactphysics3d.com) [:octocat: (⭐1.2k)](https://github.com/DanielChappuis/reactphysics3d) - 3D physics engine.
...
*   C++: Reflection
    ...
    *   🎉 [Ponder](https://billyquith.github.io/ponder/) [:octocat: (⭐582)](https://github.com/billyquith/ponder) - Expose C++17 classes and objects so they can used as data.
...
*   C++: Scripting
    ...
    *   🔒 [ArkScript](https://arkscript-lang.dev) [:octocat: (⭐486)](https://github.com/ArkScript-lang/Ark) - Small, fast, functional and scripting language for C++ projects.
    ...
    *   🎉 [GameMonkey Script](http://www.gmscript.com) [:octocat: (⭐128)](https://github.com/publicrepo/gmscript) - Embedded scripting language for C++ apps, tools and games.
...
*   C++: Serialization
    *   🎉 [Cap'n Proto](https://capnproto.org/capnp-tool.html) [:octocat: (⭐9.6k)](https://github.com/capnproto/capnproto) - Fast data interchange format and capability-based RPC system.
...
*   C++: Terrain
    *   🎉 [Terra Forge 3D](https://jaysmito101.github.io/TerraForge3D/) [:octocat: (⭐707)](https://github.com/Jaysmito101/TerraForge3D) - Procedural 3D terrain generation and texturing tool.
*   C++: Utility
    *   🎉 [Any-Lite (⭐121)](https://github.com/martinmoene/any-lite) - Header only C++17-like any type for C++98 and above.
    ...
    *   🎉 [Tiny-Process-Library](https://gitlab.com/eidheim/tiny-process-library) [:octocat: (⭐310)](https://github.com/eidheim/tiny-process-library) - Making it simple to create and stop new processes in C++.
...
*   C++: Visual Programming / Nodes
    ...
    *   🎉 [QuickQanava](http://cneben.github.io/QuickQanava/index.html) [:octocat: (⭐897)](https://github.com/cneben/QuickQanava) - C++14, display graphs and relational content in a QtQuick application.
...
*   C#: Cross-Platform
    *   🌎 [Blazor](https://dotnet.microsoft.com/en-us/apps/aspnet/web-apps/blazor) [:octocat: (⭐31k)](https://github.com/dotnet/aspnetcore/blob/main/src/Components/README.md) - Microsoft's C# to JavaScript (as WebAssembly) technology.
...
*   C#: Entity Component System
    *   🎉 [DefaultEcs (⭐501)](https://github.com/Doraku/DefaultEcs) - Framework with as much performance as possible for game development.
    *   🎉 [LeoECS (⭐117)](https://github.com/Leopotam/ecs) - Fast ECS Framework powered by C# with optional integration to Unity.
*   C#: Game Engine w/Editor
    ...
    *   🎉 [Flat Red Ball](https://flatredball.com) [:octocat: (⭐123)](https://github.com/vchelaru/FlatRedBall) - 2D engine built on MonoGame & tools to help with game design. \[[Gui Editor](http://vchelaru.github.io/Gum/)]
...
*   C#: Game Framework
    ...
    *   🎉 [Monofoxe (⭐302)](https://github.com/Martenfur/Monofoxe) - Game engine designed to simplify working with, and built on MonoGame.
...
*   C#: Graphics - 3D
    *   🎉 [OpenTK](https://opentk.net) [:octocat: (⭐2.7k)](https://github.com/opentk/opentk) - C# bindings for OpenGL. \[[LearnOpenGL Examples, ported to OpenTK (⭐351)](https://github.com/opentk/LearnOpenTK)]
...
*   C#: Gui
    *   🎉 [Avalonia](https://avaloniaui.net/) [:octocat: (⭐17k)](https://github.com/AvaloniaUI/Avalonia) - Cross-platform UI framework for .NET.
    *   🎉 [GeonBit.UI (⭐391)](https://github.com/RonenNess/GeonBit.UI) - UI system for MonoGame projects.
    *   🎉 [MonoGame.Forms (⭐217)](https://github.com/BlizzCrafter/MonoGame.Forms) - MonoGame render window for Windows Forms.
    *   🎉 [Myra (⭐544)](https://github.com/rds1983/Myra) - UI Library for MonoGame, FNA, and Stride.
    *   🎉 [Uno](https://platform.uno/) [:octocat: (⭐7.4k)](https://github.com/unoplatform/uno) - Mobile, desktop and WebAssembly gui library.
*   C#: Physics
    *   🎉 [Aether Physics (⭐310)](https://github.com/tainicom/Aether.Physics2D) - Great 2D physics library with continuous collision detection.
    *   🎉 [Velcro Physics (⭐597)](https://github.com/Genbox/VelcroPhysics) - (formerly Farseer Physics) Original C# port of Box2D.
*   C#: Utility
...
*   Dart: Game Framework
    *   🎉 [Flame](https://flame-engine.org) [:octocat: (⭐7.4k)](https://github.com/flame-engine/flame) - Minimalist Flutter based 2D game engine. \[[Awesome Flame (⭐664)](https://github.com/flame-engine/awesome-flame#readme) | [Examples](https://examples.flame-engine.org/#/) | [Tutorials](https://tutorials.flame-engine.org/#/)]

### Libraries / Go

*   Go: - Awesome Collections -
    *   📚 [Awesome Go (⭐95k)](https://github.com/avelino/awesome-go) - Curated list of awesome Go frameworks, libraries and software.
*   Go: Audio
    *   🎉 [Beep (⭐1.8k)](https://github.com/faiface/beep) - Bring sound to any Go application. Suitable for playback and audio-processing.
*   Go: Game Engine w/Editor
    *   🎉 [G3N](http://g3n.rocks/) [:octocat: (⭐2.2k)](https://github.com/g3n/engine) - OpenGL 3D Game Engine written in Go.
*   Go: Game Framework
    *   🎉 [Ebitengine](https://ebiten.org/) [:octocat: (⭐7.8k)](https://github.com/hajimehoshi/ebiten) - A dead simple 2D game library.
    ...
    *   🎉 [Pixel (⭐4.2k)](https://github.com/faiface/pixel) - Hand-crafted 2D game library in Go. \[[Examples (⭐105)](https://github.com/faiface/pixel-examples)]
*   Go: Geometry
    *   🎉 [3D Mesh Simplification (⭐216)](https://github.com/fogleman/simplify) - 3D mesh simplification in Go.
*   Go: Graphics
...
*   Haxe: App Framework
    *   🎉 [Lime](https://lime.openfl.org/) [:octocat: (⭐690)](https://github.com/haxelime/lime) - Flexible, lightweight layer for Haxe cross-platform developers.
    *   🎉 [nme (⭐458)](https://github.com/haxenme/nme) - Cross-platform native backend for Haxe projects.
*   Haxe: Cross-Platform
    *   🎉 [HashLink](https://hashlink.haxe.org) [:octocat: (⭐721)](https://github.com/HaxeFoundation/hashlink/) - Virtual machine for Haxe.
...
*   Haxe: Game Engine w/Editor
    *   🎉 [Armory](https://armory3d.org) [:octocat: (⭐2.7k)](https://github.com/armory3d/armory) - 3D game engine with full Blender integration.
    *   🎉 [Away3D](http://away3d.com) [:octocat: (⭐174)](https://github.com/openfl/away3d) - Real-time 3D engine for OpenFL.
    ...
    *   🎉 [LDtk](https://ldtk.io) [:octocat: (⭐2.4k)](https://github.com/deepnight/ldtk) - 🔥 Very cool modern, lightweight and efficient 2D level editor.
    *   🎉 [Starling](https://gamua.com/starling/) [:octocat: (⭐215)](https://github.com/openfl/starling) - Popular (used for Angry Birds) 2D game engine built on OpenFL. \[[Editor](http://starlingbuilder.github.io)]
*   Haxe: Game Framework
...
*   Haxe: Physics
    ...
    *   🎉 [Nape](https://joecreates.github.io/napephys/) [:octocat: (⭐41)](https://github.com/HaxeFlixel/nape-haxe4) - Very impressive powerful, fast, and friendly 2D rigid body physics engine.
...
*   Lua: Game Framework
    *   🎉 [3DreamEngine (⭐255)](https://github.com/3dreamengine/3DreamEngine) - 3D engine on top of LÖVE written in Lua.
    *   🎉 [Gideros](http://giderosmobile.com/) [:octocat: (⭐512)](https://github.com/gideros/gideros) - 2D / 3D cross-platform development for creating games with Lua.
    *   🎉 [INSTEAD](http://instead.hugeping.ru/en/) [:octocat: (⭐202)](https://github.com/instead-hub/instead) - Simple Text Adventure Interpreter.
    *   🎉 [LÖVE](https://love2d.org) [:octocat: (⭐3k)](https://github.com/love2d/love) - 2D framework for writing game code with Lua. \[[Awesome Löve (⭐2.6k)](https://github.com/love2d-community/awesome-love2d)]
...
*   Java: Game Framework
    *   🎉 [jMonkeyEngine](https://jmonkeyengine.org/) [:octocat: (⭐3.3k)](https://github.com/jMonkeyEngine/jmonkeyengine) - Modern 3D game development suite for Java.
    *   🎉 [libGDX](https://libgdx.com) [:octocat: (⭐21k)](https://github.com/libgdx/libgdx) - Game framework built on, and adds to LWJGL. \[[Awesome libGDX (⭐686)](https://github.com/rafaskb/awesome-libgdx#readme)]
    *   🎉 [LWJGL](https://www.lwjgl.org) [:octocat: (⭐4.1k)](https://github.com/LWJGL/lwjgl3) - Library for graphics, audio, parallel computing, XR and more.
...
*   JavaScript: Animation
    ...
    *   💸 [GreenSock](https://greensock.com) [:octocat: (⭐16k)](https://github.com/greensock/GSAP) - Robust animation toolset.
    ...
    *   🎉 [Scene.js](https://daybrush.com/scenejs/) [:octocat: (⭐2.4k)](https://github.com/daybrush/scenejs) - JavaScript & CSS timeline-based animation library.
    *   🎉 [Theatre](https://www.theatrejs.com/) [:octocat: (⭐8.7k)](https://github.com/theatre-js/theatre) - Motion design editor for the web.
...
*   JavaScript: Audio
    ...
    *   🎉 [PixiJS Sound](https://pixijs.io/sound/examples/) [:octocat: (⭐290)](https://github.com/pixijs/sound) - WebAudio API playback library, with filters. Built on, and requires PixiJS.
    ...
    *   🎉 [Sonant-X (⭐213)](https://github.com/nicolas-van/sonant-x) - Very small JavaScript synthesizer library. \[[Online Composer](https://nicolas-van.github.io/sonant-x-live/)]
...
*   JavaScript: Cross-Platform
    ...
    *   🎉 [Electron](https://www.electronjs.org) [:octocat: (⭐106k)](https://github.com/electron/electron) - Build cross-platform desktop apps with JavaScript, HTML, and CSS.
    ...
    *   🎉 [Tauri](https://tauri.studio/) [:octocat: (⭐58k)](https://github.com/tauri-apps/tauri) - Smaller, faster, and more secure desktop applications.
...
*   JavaScript: Docking
    *   🎉 [Dock Spawn TS](https://node-projects.github.io/dock-spawn-ts/) [:octocat: (⭐95)](https://github.com/node-projects/dock-spawn-ts) - Maintained, TypeScript version of [Dock Spawn (⭐255)](https://github.com/coderespawn/dock-spawn), a html docking framework.
    ...
    *   🎉 [RC-Dock](https://ticlo.github.io/rc-dock/examples/) [:octocat: (⭐437)](https://github.com/ticlo/rc-dock) - Dock Layout for React Component.
...
*   JavaScript: Entity Component System
    *   🎉 [Becsy (⭐120)](https://github.com/LastOliveGames/becsy) - Multithreaded Entity Component System (ECS) for TypeScript and JavaScript.
...
*   JavaScript: Framework
    *   🎉 [Alpine](https://alpinejs.dev) [:octocat: (⭐23k)](https://github.com/alpinejs/alpine) - Rugged, minimal framework for composing JavaScript behavior in your markup.
    ...
    *   🎉 [React](https://reactjs.org) [:octocat: (⭐201k)](https://github.com/facebook/react/) - Declarative, efficient, and flexible JavaScript library for building user interfaces.
    *   🎉 [Svelte](https://svelte.dev) [:octocat: (⭐65k)](https://github.com/sveltejs/svelte) - Takes your declarative components and converts them into efficient JavaScript.
    *   🎉 [Vue](https://vuejs.org/) [:octocat: (⭐202k)](https://github.com/vuejs/vue) - Progressive, incrementally-adoptable JavaScript framework for building UI on the web.
*   JavaScript: Game Engine w/Editor
    ...
    *   🎉 [ct.js](https://ctjs.rocks) [:octocat: (⭐1.3k)](https://github.com/ct-js/ct-js) - Desktop 2D game engine, built on PixiJS.
    ...
    *   🎉 [GDevelop](https://gdevelop.io/) [:octocat: (⭐4.5k)](https://github.com/4ian/GDevelop) - Full-featured, open source 2D game development software platform.
    ...
    *   🎉 [melonJS](https://melonjs.org) [:octocat: (⭐5.2k)](https://github.com/melonjs/melonJS) - Modern 2D game engine. Uses Tiled for level editing. \[[Examples](https://melonjs.github.io/examples/)]
    *   🎉 [microStudio](https://microstudio.dev/) [:octocat: (⭐736)](https://github.com/pmgl/microstudio/) - Free online game engine, learn and practice programming.
    *   🎉 [Pixelbox.js](https://pixwlk.itch.io/pixelbox) [:octocat: (⭐434)](https://github.com/cstoquer/pixelbox) - Sandbox to fast-prototype 2D tile-based games.
    *   🎉 [QICI Engine (⭐814)](https://github.com/qiciengine/qiciengine) - Toolset for making HTML5 games.
    ...
    *   🎉 [Taro](https://www.modd.io) [:octocat: (⭐267)](https://github.com/moddio/taro) - Multiplayer game engine with Box2D physics.
*   JavaScript: Game Framework
    ...
    *   🎉 [Kaboom](https://kaboomjs.com) [:octocat: (⭐2k)](https://github.com/replit/kaboom) - Simple 2D engine.
    *   🎉 [LittleJS (⭐2.4k)](https://github.com/KilledByAPixel/LittleJS) - Lightweight 2D game engine with WebGL rendering.
    *   🎉 [Meep (⭐197)](https://github.com/Usnul/meep) - Entity component system game engine framework.
    ...
    *   🎉 [Phaser](https://phaser.io) [:octocat: (⭐34k)](https://github.com/photonstorm/phaser) - Fast 2D game framework, supports Canvas and WebGL.
...
*   JavaScript: Geometry
    *   🎉 [Convexhull.js (⭐22)](https://github.com/indy256/convexhull-js) - Tiny high-performance JavaScript 2D convex hull library.
    ...
    *   🎉 [Poly-Decomp.js](http://schteppe.github.io/poly-decomp.js/) [:octocat: (⭐349)](https://github.com/schteppe/poly-decomp.js) - Decompose 2D polygons into convex pieces.
    *   🎉 [Three-CSGMesh (⭐327)](https://github.com/manthrax/THREE-CSGMesh) - Conversion of the csg.js library for use with modern Three.js.
*   JavaScript: Graphics - 2D
    *   🎉 [CanvasKit](https://skia.org/docs/user/modules/canvaskit/) [:octocat: (⭐7.2k)](https://github.com/google/skia/tree/main/modules/canvaskit) - WebAssembly build of Google's Skia, a mobile-first 2D graphics library.
    ...
    *   🎉 [Konva](https://konvajs.org) [:octocat: (⭐8.7k)](https://github.com/konvajs/konva) - Canvas framework enabling interactivity for desktop and mobile applications.
    *   🎉 [p5.js](https://p5js.org) [:octocat: (⭐19k)](https://github.com/processing/p5.js) - Library for creative coding.
    *   🎉 [Paper.js](http://paperjs.org/) [:octocat: (⭐14k)](https://github.com/paperjs/paper.js) - The swiss army knife of vector graphics.
    ...
    *   🎉 [PixiJS](https://pixijs.com/) [:octocat: (⭐39k)](https://github.com/pixijs/pixijs) - 🔥 Fast, lightweight 2D library. \[[Awesome PixiJS (⭐642)](https://github.com/cursedcoder/awesome-pixijs) | [Editor (⭐183)](https://github.com/Megabyteceer/thing-editor)]
    *   🎉 [Pts](https://ptsjs.org) [:octocat: (⭐4.9k)](https://github.com/williamngan/pts) - Library for visualization and creative-coding.
    *   🎉 [Scrawl-canvas](https://scrawl-v8.rikweb.org.uk) [:octocat: (⭐236)](https://github.com/KaliedaRik/Scrawl-canvas) - Library for working with the HTML5 Canvas element.
    *   🎉 [Stage.js](https://piqnt.com/stage.js/) [:octocat: (⭐2.3k)](https://github.com/shakiba/stage.js) - 2D HTML5 rendering and layout engine for game development.
    *   🎉 [Two.js](https://two.js.org/) [:octocat: (⭐7.9k)](https://github.com/jonobr1/two.js) - Renderer agnostic 2D drawing api for the web.
    *   🎉 [ZIM](https://zimjs.com/index.html) [:octocat: (⭐366)](https://github.com/danzen/zimjs) - Canvas framework for code creativity.
*   JavaScript: Graphics - 3D
    ...
    *   🎉 [Hilo3d](https://hilo3d.js.org/docs/index.html) [:octocat: (⭐556)](https://github.com/hiloteam/Hilo3d) - (by Alibaba) WebGL 3D rendering engine.
    *   🎉 [Litescene.js (⭐327)](https://github.com/jagenjo/litescene.js) - WebGL 3D engine library, used by [WebGLStudio](https://webglstudio.org).
    *   🎉 [LUME (⭐918)](https://github.com/lume/lume) - Toolkit that simplifies the creation of interactive 2D / 3D experiences.
    *   ⭐ [OGL](https://oframe.github.io/ogl/examples) [:octocat: (⭐3k)](https://github.com/oframe/ogl) - Very fast and powerful minimal WebGL library.
    *   🎉 [PicoGL.js](https://tsherif.github.io/picogl.js/) [:octocat: (⭐760)](https://github.com/tsherif/picogl.js) - Minimal WebGL 2 rendering library.
    *   🎉 [Pixi3D](https://pixi3d.org/) [:octocat: (⭐606)](https://github.com/jnsmalm/pixi3d#getting-started) - The 3D renderer for PixiJS. Seamless integration with 2D applications.
    ...
    *   🎉 [Three.js](https://threejs.org) [:octocat: (⭐88k)](https://github.com/mrdoob/three.js/) - 🔥 General purpose 3D library. \[[Editor](https://threejs.org/editor/) | [Examples](https://threejs.org/examples/) | [Awesome Three.js (⭐352)](https://github.com/0xAxiome/awesome-threejs)]
    *   🎉 [TWGL](https://twgljs.org/) [:octocat: (⭐2.3k)](https://github.com/greggman/twgl.js) - Tiny WebGL helper Library.
...
*   JavaScript: Graphics - Three.js - Reference
    ...
    *   🎉 [Sketch Three.js](https://ykob.github.io/sketch-threejs/) [:octocat: (⭐1.9k)](https://github.com/ykob/sketch-threejs) - Interactive sketches made with Three.js.
    *   🎉 [Sketchbook](https://jblaha.art/sketchbook/0.4/) [:octocat: (⭐1.1k)](https://github.com/swift502/Sketchbook) - 3D playground built on Three.js and Cannon.js.
    ...
    *   📚 [THREEx (⭐328)](https://github.com/jeromeetienne/threex) - Nice collection of open source game extensions for Three.js.
*   JavaScript: Gui
    *   🎉 [Bootstrap](https://getbootstrap.com) [:octocat: (⭐162k)](https://github.com/twbs/bootstrap) - Framework for developing responsive, mobile first projects.
    *   🎉 [dat.GUI (⭐6.7k)](https://github.com/dataarts/dat.gui) - Lightweight graphical user interface for changing variables in JavaScript.
    *   🎉 [Dojo](https://widgets.dojo.io/) [:octocat: (⭐85)](https://github.com/dojo/widgets) - UI widgets for modern web applications.
    *   🎉 [Guify (⭐242)](https://github.com/colejd/guify) - Simple GUI for inspecting and changing JavaScript variables. \[[Demo](https://jons.website/projects/guify/)]
    ...
    *   🎉 [Leva](https://leva.pmnd.rs/) [:octocat: (⭐3.5k)](https://github.com/pmndrs/leva) - React-first components GUI.
    *   🎉 [Magic Circle](https://magic-circle.dev/) [:octocat: (⭐28)](https://github.com/dpwoert/magic-circle) - Multi-functional gui inspired by dat.GUI, Unity and Framer.
    *   🎉 [PCUI](https://playcanvas.github.io/pcui) [:octocat: (⭐571)](https://github.com/playcanvas/pcui) - UI component library for the web, made for PlayCanvas.
    *   🎉 [Tweakpane](https://cocopon.github.io/tweakpane/) [:octocat: (⭐2.5k)](https://github.com/cocopon/tweakpane) - Compact GUI for fine-tuning values.
    *   🎉 [uil](https://lo-th.github.io/uil/) [:octocat: (⭐504)](https://github.com/lo-th/uil) - Simple JavaScript UI.
    *   🎉 [w2ui](https://w2ui.com/web/) [:octocat: (⭐2.4k)](https://github.com/vitmalina/w2ui) - UI widgets for modern apps.
    *   🎉 [Zebkit](https://zebkit.org/dark/about.html) [:octocat: (⭐922)](https://github.com/barmalei/zebkit) - Canvas rendered UI component libary, very cool.
*   JavaScript: Input
    *   🎉 [Joycon.js](https://joycon.js.org/) [:octocat: (⭐86)](https://github.com/barhatsor/joycon.js) - JavaScript controller functionality.
*   JavaScript: Layout
...
*   JavaScript: Physics
    ...
    *   🎉 [Cannon-es](https://pmndrs.github.io/cannon-es/) [:octocat: (⭐1.2k)](https://github.com/pmndrs/cannon-es) - Maintained fork of [Cannon.js (⭐4.2k)](https://github.com/schteppe/cannon.js), a 3D physics engine written in JavaScript.
    *   🎉 [Goblin Physics](http://www.goblinphysics.com) [:octocat: (⭐140)](https://github.com/chandlerprall/GoblinPhysics) - Open source 3D physics engine written from the ground up in JavaScript.
    ...
    *   🎉 [Oimo.js](http://lo-th.github.io/Oimo.js) [:octocat: (⭐2.8k)](https://github.com/lo-th/Oimo.js) - Lightweight 3D physics engine for JavaScript.
    ...
    *   🎉 [Planck.js](https://piqnt.com/planck.js/) [:octocat: (⭐4.5k)](https://github.com/shakiba/planck.js) - JavaScript rewrite of the Box2D physics engine.
    ...
    *   🎉 [Verly.js](https://anuraghazra.dev/Verly.js/) [:octocat: (⭐556)](https://github.com/anuraghazra/Verly.js) - Easy to integrate verlet physics engine.
*   JavaScript: Utility
    ...
    *   🎉 [Day.js](https://day.js.org/) [:octocat: (⭐42k)](https://github.com/iamkun/dayjs) - Fast 2kB alternative to [Moment.js (⭐47k)](https://github.com/moment/moment) with the same modern API.
    *   🎉 [i18next](https://www.i18next.com/) [:octocat: (⭐6.6k)](https://github.com/i18next/i18next) - Popular internationalization framework.
...
*   JavaScript: Timeline
    *   🎉 [Frame.js](https://framejs.app/) [:octocat: (⭐960)](https://github.com/mrdoob/frame.js/) - JavaScript sequence editor.
    *   🎉 [Neo](http://lo-th.github.io/neo) [:octocat: (⭐257)](https://github.com/lo-th/neo) - Lightweight timeline for JavaScript.
*   JavaScript: Video
    *   💸 [Remotion](https://www.remotion.dev/) [:octocat: (⭐15k)](https://github.com/remotion-dev/remotion) - Create videos programmatically in React.
*   JavaScript: Visual Programming / Nodes
    *   🎉 [Butterfly](https://butterfly-dag.gitee.io/butterfly-dag/home) [:octocat: (⭐3.4k)](https://github.com/alibaba/butterfly) - (by [Alibaba](https://www.alibabagroup.com/en/global/home)) Diagramming library concentrated on flow and field layout.
    *   🎉 [Drawflow](https://jerosoler.github.io/Drawflow/) [:octocat: (⭐3k)](https://github.com/jerosoler/Drawflow) - Simple JavaScript flow library.
    *   🎉 [Flow (⭐59)](https://github.com/sunag/flow) - Node-Graph, lightweight, cross-browser UI library.
    ...
    *   🎉 [Node-RED](https://nodered.org/) [:octocat: (⭐16k)](https://github.com/node-red/node-red) - Low-code programming for event-driven applications.
    *   🎉 [Rete.js](https://rete.js.org/) [:octocat: (⭐8.1k)](https://github.com/retejs/rete) - Framework for visual programming and creating a node editor.

### Libraries / Kotlin

*   Kotlin: Game Engine w/Editor
    *   🎉 [KorGE](https://korge.org/) [:octocat: (⭐1.6k)](https://github.com/korlibs/korge) - Multi-platform 2D game engine for Kotlin.
*   Kotlin: Game Framework
    *   🎉 [FXGL (⭐3k)](https://github.com/AlmasB/FXGL) - Game library for 2D, experimental 3D.
    *   🎉 [Kool (⭐156)](https://github.com/fabmax/kool) - Multi-platform 3D Vulkan/OpenGL graphics engine. \[[Demos](https://fabmax.github.io/kool/kool-js/)]
    *   🎉 [KTW](https://libktx.github.io/) [:octocat: (⭐1.2k)](https://github.com/libktx/ktx) - Kotlin extensions for the libGDX game framework.

### Libraries / Pascal

*   Pascal: - Awesome Collections -
...
*   Pascal: Game Engine w/Editor
    *   🎉 [Castle](https://castle-engine.io/) [:octocat: (⭐688)](https://github.com/castle-engine/castle-engine) - Cross-platform 3D/2D game engine and visual editor.
...
*   Python: App Framework
    *   🎉 [Pyglet](http://pyglet.org/) [:octocat: (⭐1.4k)](https://github.com/pyglet/pyglet) - Windowing and multimedia library, intended for game dev.
...
*   Python: Game Framework
    *   🎉 [Arcade](https://api.arcade.academy/en/latest/) [:octocat: (⭐1.4k)](https://github.com/pythonarcade/arcade) - Easy to use Python library for creating 2D arcade games.
    *   🎉 [Panda3D](https://www.panda3d.org) [:octocat: (⭐3.7k)](https://github.com/panda3d/panda3d) - Powerful, mature game engine, developed by Disney and CMU.
    *   🔒 [Pygame (⭐5.7k)](https://github.com/pygame/pygame) - Multimedia library, built on top of the excellent SDL library.
...
*   Ruby: Game Framework
    *   🎉 [Ruby 2D](https://www.ruby2d.com/) [:octocat: (⭐586)](https://github.com/ruby2d/ruby2d) - Make cross-platform 2D applications in Ruby.
*   Ruby: Graphics - 3D
    *   🎉 [Mittsu (⭐481)](https://github.com/danini-the-panini/mittsu) - 3D Graphics Library for Ruby based heavily on Three.js.
*   Ruby: Gui
...
*   Rust: - Awesome Collections -
    *   📚 [Awesome Rust (⭐32k)](https://github.com/rust-unofficial/awesome-rust) - Curated list of Rust code and resources.
*   Rust: App Framework
    *   🎉 [Makepad](https://makepad.dev) [:octocat: (⭐2.4k)](https://github.com/makepad/makepad) - Software development platform and native-rendering gui framework.
    *   🎉 [Tao](https://docs.rs/tao/latest/tao/) [:octocat: (⭐946)](https://github.com/tauri-apps/tao) - Cross-platform windowing.
*   Rust: Game Engine w/Editor
    *   🎉 [Fyrox](https://fyrox.rs/) [:octocat: (⭐5.8k)](https://github.com/FyroxEngine/Fyrox) - (formerly rg3d) 2D / 3D game engine with a scene editor.
*   Rust: Game Framework
    *   🎉 [Amethyst](https://amethyst.rs) [:octocat: (⭐7.9k)](https://github.com/amethyst/amethyst) - Data-driven 2D / 3D game engine aiming to be fast and configurable.
    *   🎉 [Bevy](https://bevyengine.org) [:octocat: (⭐22k)](https://github.com/bevyengine/bevy) - 🔥 Refreshingly simple data-driven 2D / 3D game engine built in Rust.
...
*   Rust: Gui
    *   🎉 [Druid](https://linebender.org/druid/) [:octocat: (⭐8.4k)](https://github.com/linebender/druid) - Data-first Rust-native UI design toolkit.
    *   🎉 [egui (⭐13k)](https://github.com/emilk/egui) - Awesome, easy to use, immediate mode GUI, runs on both web and native. \[[Demo](https://www.egui.rs/)]
    *   🔒 [Slint](https://slint-ui.com/) [:octocat: (⭐5.6k)](https://github.com/slint-ui/slint) - (formerly SixtyFPS) Gui toolkit for embedded devices / desktop apps.
*   Rust: Physics
    *   🎉 [Rapier](https://rapier.rs) [:octocat: (⭐2.2k)](https://github.com/dimforge/rapier) - 2D and 3D physics engines focused on performance.

### Libraries / Zig

*   Zig: - Awesome Collections -
    *   📚 [Awesome Zig (⭐706)](https://github.com/nrdmn/awesome-zig) - Curated list of Zig code and resources.
*   Zig: App Framework
    *   🎉 [Upaya (⭐119)](https://github.com/prime31/zig-upaya) - Zig-based framework for creating game tools and helper apps.
*   Zig: File System
...
*   Zig: Game Engine w/Editor
    *   🎉 [Mach](https://hexops.com/mach/) [:octocat: (⭐1.5k)](https://github.com/hexops/mach) - Game engine & graphics toolkit, still in early developemnt.
*   Zig: Game Framework
    *   🎉 [Zig-Gamedev Project (⭐1.3k)](https://github.com/michal-z/zig-gamedev) - Sample apps and libraries written in Zig using DirectX 12.
*   Zig: Graphics - 2D
    *   🎉 [Mini Pixel](https://fabioarnold.itch.io/mini-pixel) [:octocat: (⭐114)](https://github.com/fabioarnold/MiniPixel) - Tiny pixel art editor.
    *   🔒 [Pixi (⭐135)](https://github.com/foxnne/pixi) - Pixel art editor made with Zig.
*   Zig: Scripting
    *   🎉 [Cyber (⭐530)](https://github.com/fubark/cyber) - Cyber is a fast, efficient, and concurrent scripting language.

### Open Source Games / C

*   🔒 [Gish](https://store.steampowered.com/app/9500/Gish/) [:octocat: (⭐304)](https://github.com/blinry/gish) - Open Source version of the award-winning physics platformer.
...
*   🎉 [Etheral Legends](https://store.steampowered.com/app/428980/Ethereal_Legends/) [:octocat: (⭐212)](https://github.com/Soverance/EtherealLegends) - Indie Action RPG built with Unreal Engine 4 for Steam, PS4, and Xbox One.
...
*   🎉 [TeeWorlds](https://teeworlds.com/) [:octocat: (⭐2.1k)](https://github.com/teeworlds/teeworlds) - Retro multiplayer shooter.
...
*   📚 [Red, Yellow, and Blue](https://daveeddy.com/2014/07/01/red-yellow-and-blue/) [:octocat: (⭐65)](https://github.com/bahamas10/ryb) - Convert colors from the paint color wheel to RGB space.
...
*   📚 [Nomad Game Engine](https://savas.ca/nomad) [:octocat: (⭐160)](https://github.com/taurheim/NomadECS) - Articles building a basic ECS from the ground up in C++.
...
*   🔒 [Fluids-2D](https://www.csc.kth.se/\~mathar/fluids-2d/) [:octocat: (⭐335)](https://github.com/mharrys/fluids-2d) - Real-time fluid dynamics running on the GPU with the help of WebGL and Three.js.
...
*   CSG (Constructive Solid Geometry)
    ...
    *   🎉 [csg.js](https://evanw.github.io/csg.js/) [:octocat: (⭐1.7k)](https://github.com/evanw/csg.js/) - Javacsript library implementing CSG (Constructive Solid Geometry).
*   Meshes
    *   📚 [Mesh Transforms](https://ciechanow.ski/mesh-transforms/) [:octocat: (⭐4)](https://github.com/olegtyshcneko/CAMeshTransform) - Apples private API that allows manipulation of the mesh of any UIView.
*   Smoothing
...
*   Volumetric
    *   🌎 [Threex Volumetric Spotlight](http://jeromeetienne.github.io/threex.volumetricspotlight/examples/basic.html) [:octocat: (⭐111)](https://github.com/jeromeetienne/threex.volumetricspotlight) - Great example of volumetric lighting with Three.js.
...
*   Soft Body
    ...
    *   🌎 [Three.js: Ammo Volume](https://threejs.org/examples/?q=physics#physics_ammo_volume) [:octocat: (⭐88k)](https://github.com/mrdoob/three.js/blob/master/examples/physics_ammo_volume.html) - Demo of 3D soft body volumes using Ammo.js and Three.js.
*   Verlet Physics
...
*   Bloom
    ...
    *   🌎 [Three.js: Bloom Example](https://threejs.org/examples/?q=bloom#webgl_postprocessing_unreal_bloom) [:octocat: (⭐88k)](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_unreal_bloom.html) - WebGL bloom effect postprocessing example using Three.js.
...
*   Noise
    ...
    *   🎉 [Direct Computational Noise](https://weber.itn.liu.se/\~stegu/jgt2011/supplement.pdf) [:octocat: (⭐2.5k)](https://github.com/ashima/webgl-noise/) - The GLSL 2D simplex noise function many games use.
    *   🎉 [Psrdnoise (⭐136)](https://github.com/stegu/psrdnoise/) - Tiling simplex flow noise in 2D and 3D.
...
*   Outlines
    ...
    *   🎉 [Outline Shader](https://www.reddit.com/r/godot/comments/8g067a/the_perfect_outline_shader_atleast_close/) [:octocat: (⭐85)](https://github.com/steincodes/godot-shader-tutorials) - Reddit post and GitHub repo of nice outline shader.
    *   📚 [Outlines w/ Surface IDs](https://omar-shehata.medium.com/better-outline-rendering-using-surface-ids-with-webgl-e13cdab1fd94) [:octocat: (⭐251)](https://github.com/OmarShehata/webgl-outlines) - Technique combining depth, normals and surface IDs.
...
*   Pixelation
    ...
    *   🌎 [Three.js: Pixelation Example](https://threejs.org/examples/?q=pixel#webgl_postprocessing_pixel) [:octocat: (⭐88k)](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_pixel.html) - WebGL pixelation postprocessing example using Three.js.
*   Postprocessing
    *   📚 [Image Editor Effects](https://alain.xyz/blog/image-editor-effects) [:octocat: (⭐80)](https://github.com/alaingalvan/image-editor-effects) - Image filters / adjustmenta / effects shaders.
*   Upscaling
...
*   📚 [CSG w/ SDFs](https://jasmcole.com/2019/10/03/signed-distance-fields/) [:octocat: (⭐73)](https://github.com/jasmcole/Blog/tree/master/CSG) - Using circular SDFs to build 3D objects with Constructive Solid Geometry.
...
*   🆓 [Tiled](https://www.mapeditor.org) [:octocat: (⭐9.4k)](https://github.com/mapeditor/tiled) - General purpose tile map editor for all tile-based games.
...
*   Sound Effects
    *   🆓 [Bfxr](https://www.bfxr.net) [:octocat: (⭐882)](https://github.com/increpare/bfxr) - Program of choice for many people looking to make sound effects for games.
    ...
    *   🆓 [ZzFX](https://killedbyapixel.github.io/ZzFX/) [:octocat: (⭐432)](https://github.com/KilledByAPixel/ZzFX) - Tiny JavaScript Sound FX System / Zuper Zmall Zound Zynth.
...
*   Modeling
    ...
    *   📚 [GET3D](https://nv-tlabs.github.io/GET3D/) [:octocat: (⭐2.8k)](https://github.com/nv-tlabs/GET3D) - (by NVIDIA) Generative model of 3D shapes from images.
    *   📚 [Magic3D](https://deepimagination.cc/Magic3D/) - High-resolution text-to-3D content creation.
    *   📚 [NeRF](https://www.matthewtancik.com/nerf) [:octocat: (⭐6.7k)](https://github.com/bmild/nerf) - View synthesis of scenes as neural radiance fields.
*   Sound
...
*   🆓 [Material Maker](https://www.materialmaker.org) [:octocat: (⭐2.2k)](https://github.com/RodZill4/material-maker) - Procedural PBR ([Physically Based Rendering](https://en.wikipedia.org/wiki/Physically_based_rendering)) materials authoring tool.
*   🆓 [Materialize](http://boundingboxsoftware.com/materialize/) [:octocat: (⭐1.2k)](https://github.com/BoundingBoxSoftware/Materialize) - Stand alone tool for creating materials from images to be used in games.
...
*   🆓 [ArmorPaint](https://armorpaint.org) [:octocat: (⭐2.5k)](https://github.com/armory3d/armorpaint) - Physically-based texture painting, drop in your 3D models and start painting.
*   💰 [Asset Forge](https://assetforge.io) - Allows anyone to create 3D models and 2D sprites using building blocks.
*   🆓 [Blender](https://www.blender.org) [:octocat: (⭐7.6k)](https://github.com/blender/blender) - 🔥 Free and open source, supports the entirety of the 3D pipeline.
*   🆓 [Meshroom](https://alicevision.org/#meshroom) [:octocat: (⭐8.8k)](https://github.com/alicevision/meshroom) - Free, open-source 3D reconstruction software based on the AliceVision framework.
...
*   🆓 [Piskel](https://www.piskelapp.com) [:octocat: (⭐9.4k)](https://github.com/piskelapp/piskel) - Free online editor for animated sprites & pixel art.
...
*   🆓 [Krita](https://krita.org/en/) [:octocat: (⭐4.6k)](https://github.com/KDE/krita) - Professional free and open source painting program.
...
*   📚 [Retro3DGraphicsCollection (⭐829)](https://github.com/Miziziziz/Retro3DGraphicsCollection) - No attribution, retro style 3D graphic assets (think PS1).
...
*   Imaging
    ...
    *   🆓 [Disco Diffusion](http://discodiffusion.com/) [:octocat: (⭐6.5k)](https://github.com/alembics/disco-diffusion) - Notebooks, models and techniques for AI art and animations.
    ...
    *   💸 [Stable Diffusion (⭐40k)](https://github.com/CompVis/stable-diffusion) - A latent text-to-image diffusion model.
...
*   Shaders: - General -
    ...
    *   📚 [Book of Shaders](https://thebookofshaders.com) [:octocat: (⭐4.9k)](https://github.com/patriciogonzalezvivo/thebookofshaders) - 🔥 Step-by-step guide through [Fragment Shaders](https://www.khronos.org/opengl/wiki/Fragment_Shader).
    *   🌎 [CrossShader](https://alain.xyz/libraries/crossshader) [:octocat: (⭐218)](https://github.com/alaingalvan/CrossShader) - Cross compiling shaders. Convert between GLSL, HLSL, Metal and more.
    ...
    *   🌎 [Shader Park](https://shaderpark.com/) [:octocat: (⭐517)](https://github.com/shader-park/shader-park-core) - Shader programming in JavaScript.
    *   🌎 [SHADERed](https://shadered.org/) [:octocat: (⭐3.8k)](https://github.com/dfranx/SHADERed) - Shader IDE, written in C++, open source (MIT). \[[Online Editor](https://shadered.org/app)]
...
*   🆓 [Radiant](https://icculus.org/gtkradiant/) [:octocat: (⭐524)](https://github.com/TTimo/GtkRadiant) - Open source, cross platform level editor for [idTech](https://en.wikipedia.org/wiki/Id_Tech) games.
...
*   Awesome Collections
    *   📚 [Awesome Gamedev (⭐1.9k)](https://github.com/Calinou/awesome-gamedev#readme) - Collection of free software and free resources for making games.
...
*   🎉 [Godot](https://godotengine.org) [:octocat: (⭐57k)](https://github.com/godotengine/godot#readme) - 🔥 Feature-packed, open source engine. Excellent! \[[Awesome Godot (⭐4.1k)](https://github.com/godotengine/awesome-godot#readme)]
...
*   Awesome Collections
    *   📚 [Awesome Graphics Libraries (⭐248)](https://github.com/jslee02/awesome-graphics-libraries#readme) - Awesome curated list of 3D graphics libraries and resources.
...
*   Music
    *   🆓 [Ardour](https://ardour.org) [:octocat: (⭐2.9k)](https://github.com/Ardour/ardour) - Free, open source, very capable. Record, edit, and mix.
    *   🆓 [Audacity](https://www.audacityteam.org) [:octocat: (⭐8.8k)](https://github.com/audacity/audacity) - Cross-platform, multi-track audio editor and recorder.
    ...
    *   🆓 [FamiStudio](https://famistudio.org) [:octocat: (⭐1.2k)](https://github.com/BleuBleu/FamiStudio) - Music editor targeted at chiptune artists and NES homebrewers.
    *   💸 [fmod](https://www.fmod.com) - (used for Hades, Celeste, Untitled Goose Game) Popular audio software for games.
    *   🆓 [LMMS](https://lmms.io) [:octocat: (⭐6.4k)](https://github.com/lmms/lmms) - 🔥 Free, cross-platform music production software.
    *   🆓 [PixiTracker](https://warmplace.ru/soft/pixitracker/) - Quickly create musical sketches, chiptunes and sound experiments.
    *   🆓 [Sound Box](https://sb.bitsnbites.eu) [:octocat: (⭐405)](https://github.com/mbitsnbites/soundbox) - Compose synthetic music in your browser. Great for small JavaScript demos.
...
*   🆓 [GIMP](https://www.gimp.org) [:octocat: (⭐3.8k)](https://github.com/GNOME/gimp) - GNU Image Manipulation Program, free and open-source cross-platform image editor.

### Tools / Software / Materials / Textures

*   🆓 [ArmorLab](https://armorlab.org) [:octocat: (⭐171)](https://github.com/armory3d/armorlab) - Generate PBR materials by drag & dropping your photos.
...
*   🆓 [Inkscape](https://inkscape.org) [:octocat: (⭐1.5k)](https://github.com/inkscape/inkscape) - Free and open source vector graphics editor for Linux, Windows and macOS.
