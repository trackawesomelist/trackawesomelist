...
*   🆓 [Pmndrs Market (⭐248)](https://github.com/pmndrs/market) - Collection of public domain models.
...
*   C#: Geometry
    *   🎉 [DotRecast (⭐364)](https://github.com/ikpil/DotRecast) - A port of *Recast & Detour*, navigation mesh toolset for games, Unity3D, servers, C#.
...
*   Rust: Graphics - 3D
    ...
    *   🎉 [Miniquad (⭐1.3k)](https://github.com/not-fl3/miniquad) - Cross platform rendering.
...
*   C#: Entity Component System
    *   🎉 [Arch (⭐707)](https://github.com/genaray/Arch) - High-performance ECS with optional multithreading.
    *   🎉 [DefaultEcs (⭐627)](https://github.com/Doraku/DefaultEcs) - ECS framework designed for game development.
    *   🔒 [Friflo.Engine.ECS (⭐94)](https://github.com/friflo/Friflo.Json.Fliox/blob/main/Engine/README.md) - Archetype based ECS with focus on performance, cache locality and DX.
    *   🎉 [LeoECS (⭐172)](https://github.com/Leopotam/ecs) - ECS framework powered by C# with optional integration to *Unity*.
...
*   Awesome Collections
    *   📚 [Awesome Demoscene (⭐250)](https://github.com/psykon/awesome-demoscene) - Underground computer art culture exploring computer graphics and sound.
    *   📚 [Awesome Graphics Libraries (⭐360)](https://github.com/jslee02/awesome-graphics-libraries#readme) - Curated list of 3D graphics libraries and resources.
...
*   Rust: Audio
    *   🎉 [Kira (⭐777)](https://github.com/tesselode/kira) - Create expressive audio for games.
*   Rust: Gui
    ...
    *   🔒 [Slint (⭐14k)](https://github.com/slint-ui/slint) - Gui toolkit for embedded / desktop. Formerly *SixtyFPS*. \[[Website](https://slint-ui.com/)]
...
*   🎉 [Godot (⭐82k)](https://github.com/godotengine/godot#readme) 🔥 - Feature-packed, open source engine. Excellent! \[[Awesome (⭐5.7k)](https://github.com/godotengine/awesome-godot#readme) | [Website](https://godotengine.org)]
...
*   🎉 [Defold (⭐3.6k)](https://github.com/defold/defold) - Open sourced game engine by *King*. \[[Website](https://defold.com)]
*   💸 [NeoAxis (⭐172)](https://github.com/NeoAxis/NeoAxisEngine) - Versatile real-time platform for making games and apps. \[[Website](https://www.neoaxis.com)]

### Game Engines / Specialty

*   🎉 [GB Studio (⭐8k)](https://github.com/chrismaltby/gb-studio) - Retro adventure game creator for *Game Boy*.
...
*   BASIC: Game Framework
    *   🎉 [Dark Basic (⭐441)](https://github.com/TheGameCreators/Dark-Basic-Pro) - BASIC programming language for creating apps and games. \[[Website](https://www.thegamecreators.com/product/dark-basic-pro-open-source)]

### Libraries / C

*   C: App Framework
    *   🎉 [glfw (⭐12k)](https://github.com/glfw/glfw) - Cross-platform API for windowing, graphics contexts, input and events.
    *   🎉 [MiniFB (⭐918)](https://github.com/emoon/minifb) - Creates a cross-platform frame buffer for drawing pixels.
    *   🎉 [SDL (⭐8k)](https://github.com/libsdl-org/SDL) 🔥 - Low level access to audio, keyboard, mouse, joystick, and graphics hardware.
    *   🎉 [Sokol (⭐5.7k)](https://github.com/floooh/sokol) 🔥 - Single-file libraries for graphics, windowing, file handling, audio and more.
*   C: Audio
    *   ⭐ [Miniaudio (⭐3.6k)](https://github.com/mackron/miniaudio) - Single-file audio playback and capture library.
    *   🎉 [SDL\_mixer (⭐343)](https://github.com/libsdl-org/SDL_mixer) - Audio mixer that supports various file formats for SDL.
...
*   C: File Formats
    ...
    *   🎉 [Libspng (⭐678)](https://github.com/randy408/libspng) - Simple, modern libpng alternative.
    ...
    *   🎉 [PL\_MPEG (⭐705)](https://github.com/phoboslab/pl_mpeg) - Single-file library for decoding MPEG1 Video and MP2 Audio.
...
*   📚 [Awesome Hpp (⭐3.1k)](https://github.com/p-ranav/awesome-hpp) - List of awesome header-only C++ libraries.
...
*   C++: App Framework
    ...
    *   🎉 [Cross Window (⭐524)](https://github.com/alaingalvan/CrossWindow) - Platform library for managing windows and other OS tasks.
    *   🎉 [SFML (⭐9.5k)](https://github.com/SFML/SFML) 🔥 - Cross-platform access to windowing, graphics, audio and networking.
*   C++: Animation
    *   🎉 [Ozz-Animation (⭐2.2k)](https://github.com/guillaumeblanc/ozz-animation) - Skeletal animation library and toolset.
    *   🎉 [Tweeny (⭐688)](https://github.com/mobius3/tweeny) - Inbetweening library for complex animations for games / apps.
*   C++: Cross-Platform
...
*   C++: Fonts
    *   🎉 [HarfBuzz (⭐3.5k)](https://github.com/harfbuzz/harfbuzz) - Text shaping library. Formatted and positioned glyph output.
...
*   C++: Game Engine w/Editor
    ...
    *   🔒 [Enigma (⭐323)](https://github.com/enigma-dev/enigma-dev) - GameMaker compatible 2D engine.
    *   🎉 [Esoterica Engine (⭐816)](https://github.com/BobbyAnguelov/Esoterica) - High-performance game engine with editor and AAA quality animation graph.
    *   🎉 [Ethereal Engine (⭐932)](https://github.com/volcoma/EtherealEngine) - Cross-platform game engine and editor.
    ...
    *   🎉 [Lina Engine (⭐733)](https://github.com/inanevin/LinaEngine) - Modular game engine, aimed to develop 3D desktop games.
    ...
    *   🔒 [neoGFX (⭐524)](https://github.com/i42output/neogfx) - Cross-platform app and game engine.
    *   🎉 [ÖbEngine (⭐784)](https://github.com/ObEngine/ObEngine) - 2D engine with Lua scripting built with *SFML*.
    *   🎉 [Overload (⭐1.6k)](https://github.com/adriengivry/Overload) - Well documented 3D game engine inspired by industry standards.
    *   🎉 [Razix Engine (⭐363)](https://github.com/Pikachuxxxx/Razix) - High-performance research engine for production pipeline.
    *   🎉 [Rootex (⭐207)](https://github.com/sdslabs/rootex) - Advanced C++ 3D game engine powering an in-production game.
    *   🎉 [Skylicht (⭐581)](https://github.com/skylicht-lab/skylicht-engine) - Upgraded features including audio, physics and particles. Built on *Irrlicht*.
    *   🎉 [Spartan Engine (⭐2k)](https://github.com/PanosK92/SpartanEngine) - Emphasis on quality and performance.
    *   🎉 [Toolkit (⭐116)](https://github.com/Oyun-Teknolojileri/ToolKit) - Simple 2D/3D game and app develepment kit.
...
*   C++: Graphics - 2D
    ...
    *   🎉 [C++ Bitmap Library (⭐160)](https://github.com/ArashPartow/bitmap) - Featured bitmap loading and manipulation library.
    *   🎉 [QNanoPainter (⭐371)](https://github.com/QUItCoding/qnanopainter) - OpenGL accelerated vector drawing library for *Qt*, powered by *NanoVG*.
    *   🎉 [Skia (⭐8.5k)](https://github.com/google/skia) - Complete 2D graphics library used in Chrome by *Google*. \[[Website](https://skia.org)]
    *   🎉 [vg-renderer (⭐470)](https://github.com/jdryg/vg-renderer) - 2D vector graphics renderer for *Bgfx*, based on ideas from *NanoVG*.
*   C++: Input
    *   🎉 [Gainput (⭐828)](https://github.com/jkuhlmann/gainput) - Easy to use input library.
...
*   C++: Physics
    ...
    *   🎉 [Edyn (⭐501)](https://github.com/xissburg/edyn) - Multi-threaded, networked physics engine. Supports large dynamic worlds. \[[Testbed (⭐31)](https://github.com/xissburg/edyn-testbed)]
    *   🎉 [Jolt Physics (⭐5.2k)](https://github.com/jrouwe/JoltPhysics) - Multi-core friendly rigid body 3D physics and collision detection.
    ...
    *   🎉 [Newton Dynamics (⭐895)](https://github.com/MADEAPPS/newton-dynamics/) - Real-time simulation of 3D environments.
    *   🎉 [ODE](http://www.ode.org/) - Open Dynamics Engine, 3D rigid body physics.
    *   🎉 [Qu3e (⭐904)](https://github.com/RandyGaul/qu3e) - Fast 3D physics engine, created to be used in games.
    *   🎉 [ReactPhysics3D (⭐1.4k)](https://github.com/DanielChappuis/reactphysics3d) - 3D physics engine.
    *   🎉 [Slingshot (⭐25)](https://github.com/Slingshot-Physics/slingshot-community) - Constraint-based physics engine for 3D rigid body dynamics.
*   C++: Reflection
    *   🎉 [Boost.PFR (⭐1.3k)](https://github.com/boostorg/pfr) - Basic reflection C++14 library, part of the Boost Libraries.
    *   🎉 [Magic Enum (⭐4.3k)](https://github.com/Neargye/magic_enum) - Header-only C++17, provides static reflection for enums.
    *   🎉 [Meta (⭐541)](https://github.com/skypjack/meta) - Header-only, non-intrusive and macro-free runtime reflection system in C++17.
    *   🎉 [Nameof (⭐1.9k)](https://github.com/Neargye/nameof) - Header-only C++17, provides nameof macros to obtain name of a variable.
    *   🎉 [Ponder (⭐625)](https://github.com/billyquith/ponder) - Expose C++17 classes and objects so they can used as data.
    ...
    *   🎉 [RTTR (⭐2.9k)](https://github.com/rttrorg/rttr) - Reflection for C++11.
*   C++: Serialization
...
*   C++: Terrain
    *   🎉 [Terra Forge 3D (⭐891)](https://github.com/Jaysmito101/TerraForge3D) - Procedural 3D terrain generation and texturing tool.
...
*   C#: Game Engine w/Editor
    ...
    *   🎉 [Flat Red Ball (⭐303)](https://github.com/vchelaru/FlatRedBall) - 2D game engine & design tools, built with *MonoGame*. \[[Gui Editor](http://vchelaru.github.io/Gum/) | [Website](https://flatredball.com/)]
    ...
    *   🎉 [Stride (⭐6.1k)](https://github.com/stride3d/stride) - Game engine for realistic rendering and VR. Formerly *Xenko*. \[[Website](https://www.stride3d.net/)]
...
*   C#: Game Framework
    ...
    *   🎉 [Monofoxe (⭐379)](https://github.com/Martenfur/Monofoxe) - Game engine designed to simplify working with *MonoGame*.
    ...
    *   🎉 [Protogame (⭐179)](https://github.com/RedpointGames/Protogame) - Cross-platform 2D/3D game engine built on *MonoGame*.
*   C#: Graphics - 3D
    *   🎉 [OpenTK (⭐3.1k)](https://github.com/opentk/opentk) - Open Toolkit, C# bindings for OpenGL. \[[LearnOpenGL (⭐421)](https://github.com/opentk/LearnOpenTK)]
...
*   C#: Gui
    ...
    *   🎉 [Myra (⭐675)](https://github.com/rds1983/Myra) - Gui library for *MonoGame*, *FNA*, and *Stride*.
    *   🎉 [Uno (⭐8.3k)](https://github.com/unoplatform/uno) - Mobile, desktop and WebAssembly gui library. \[[Website](https://platform.uno/)]

### Libraries / Dart

*   Dart: Game Framework
    *   🎉 [Flame (⭐8.7k)](https://github.com/flame-engine/flame) - Minimalist *Flutter* based 2D game engine. \[[Awesome (⭐927)](https://github.com/flame-engine/awesome-flame#readme) | [Examples](https://examples.flame-engine.org/#/) | [Tutorials](https://tutorials.flame-engine.org/#/) | [Website](https://flame-engine.org/)]
...
*   Go: Game Framework
    *   🎉 [Ebitengine (⭐9.7k)](https://github.com/hajimehoshi/ebiten) - Dead simple 2D game library.
...
*   Haxe: App Framework
    *   🎉 [Lime (⭐735)](https://github.com/haxelime/lime) - Flexible, lightweight layer for Haxe cross-platform developers.
    *   🎉 [nme (⭐474)](https://github.com/haxenme/nme) - Cross-platform native backend for Haxe projects.
*   Haxe: Cross-Platform
    *   🎉 [HashLink (⭐781)](https://github.com/HaxeFoundation/hashlink/) - Virtual machine for Haxe.
*   Haxe: Game Engine w/Editor
    *   🎉 [Armory (⭐3k)](https://github.com/armory3d/armory) - 3D game engine with full *Blender* integration.
    *   🎉 [Away3D (⭐193)](https://github.com/openfl/away3d) - Real-time 3D engine for OpenFL. \[[Website](http://away3d.com)]
    *   🎉 [Flixel-Studio (⭐98)](https://github.com/Dovyski/flixel-studio) - Embeddable, in-game editor for *HaxeFlixel*.
    *   🎉 [Hide (⭐494)](https://github.com/heapsio/hide) - Extensible IDE for the *Heaps* 3D graphic engine.
...
*   Haxe: Gui
    *   🎉 [HaxeUI (⭐330)](https://github.com/haxeui/haxeui-core) - Cross-platform set of styleable gui components.
    *   🎉 [Zui (⭐311)](https://github.com/armory3d/zui) - Immediate mode user interface, used in *ArmorPaint*.
*   Haxe: Libraries
...
*   Java: Game Framework
    ...
    *   🎉 [libGDX (⭐23k)](https://github.com/libgdx/libgdx) - Game framework built on, and adds to *LWJGL*. \[[Awesome (⭐911)](https://github.com/rafaskb/awesome-libgdx#readme) | [Website](https://libgdx.com/)]
...
*   JavaScript: Animation
    ...
    *   🎉 [Ossos (⭐351)](https://github.com/sketchpunklabs/ossos) - Web-based character animation system.
...
*   JavaScript: Audio
    ...
    *   🎉 [PixiJS Sound (⭐369)](https://github.com/pixijs/sound) - Audio library with filters, built on *PixiJS*. \[[Examples](https://pixijs.io/sound/examples/)]
...
*   JavaScript: Docking
    *   🎉 [Dock Spawn TS (⭐114)](https://github.com/node-projects/dock-spawn-ts) - Maintained, TypeScript version of [Dock Spawn (⭐254)](https://github.com/coderespawn/dock-spawn), a JavaScript docking framework.
    *   🎉 [FlexLayout (⭐852)](https://github.com/caplin/FlexLayout) - Multi-tab layout manager.
    ...
    *   🎉 [RC-Dock (⭐621)](https://github.com/ticlo/rc-dock) - Dock layout component for React.
...
*   JavaScript: Game Engine w/Editor
    ...
    *   🎉 [Cocos Creator (⭐5.2k)](https://github.com/cocos-creator/engine) - Cross-Platform 2D/3D game creation. \[[Website](https://www.cocos.com/en/creator)]
    ...
    *   🎉 [Isogenic (⭐505)](https://github.com/irrelon/ige) - Engine with advanced multiplayer, based on *Valve*'s multiplayer system.
    ...
    *   🎉 [microStudio (⭐860)](https://github.com/pmgl/microstudio/) - Online game engine. Learn and practice programming. \[[Website](https://microstudio.dev/)]
    *   🎉 [Pixelbox.js (⭐461)](https://github.com/cstoquer/pixelbox) - Sandbox to fast-prototype 2D tile-based games. \[[Download](https://pixwlk.itch.io/pixelbox)]
...
*   JavaScript: Graphics - 2D
    *   🎉 [CanvasKit (⭐8.5k)](https://github.com/google/skia/tree/main/modules/canvaskit) - WebAssembly build of *Google*'s 2D graphics library, Skia. \[[Samples](https://skia.org/docs/user/modules/canvaskit/)]
    ...
    *   🎉 [PixiJS (⭐42k)](https://github.com/pixijs/pixijs) 🔥 - Fast, lightweight 2D library. \[[Awesome (⭐708)](https://github.com/cursedcoder/awesome-pixijs) | [Editor (⭐234)](https://github.com/Megabyteceer/thing-editor) | [Essentials (⭐262)](https://github.com/ShukantPal/pixi-essentials) | [Website](https://pixijs.com/)]
    *   🎉 [Pts (⭐5.1k)](https://github.com/williamngan/pts) - Library for visualization and creative coding. \[[Examples](https://ptsjs.org)]
    *   🎉 [Scrawl-canvas (⭐302)](https://github.com/KaliedaRik/Scrawl-canvas) - Library for working with the canvas element.
    ...
    *   🎉 [ZIM (⭐456)](https://github.com/danzen/zimjs) - Creative canvas framework. \[[Website](https://zimjs.com/)]
*   JavaScript: Graphics - 3D
    ...
    *   🎉 [Four (⭐255)](https://github.com/CodyJasonBennett/four) - Minimal three.js alternative.
    *   🎉 [Hilo3d (⭐632)](https://github.com/hiloteam/Hilo3d) - WebGL 3D rendering engine by *Alibaba*.
    ...
    *   🎉 [PicoGL.js (⭐781)](https://github.com/tsherif/picogl.js) - Minimal WebGL 2 rendering library. \[[Examples](https://tsherif.github.io/picogl.js/)]
    *   🎉 [Pixi3D (⭐715)](https://github.com/jnsmalm/pixi3d) - 3D renderer for *PixiJS*, seamless integration with 2D apps. \[[Examples](https://pixi3d.org/)]
    ...
    *   🎉 [Three.js (⭐98k)](https://github.com/mrdoob/three.js/) 🔥 - General-purpose 3D library. \[[Awesome (⭐533)](https://github.com/0xAxiome/awesome-threejs) | [Docs](https://threejs.org) | [Editor](https://threejs.org/editor/) | [Examples](https://threejs.org/examples/)]
    ...
    *   🎉 [x3dom (⭐806)](https://github.com/x3dom/x3dom) - Integrate 3D content seamlessly into your webpage.
*   JavaScript: Graphics - Three.js - Addon
    *   🎉 [Custom Shader Material (⭐680)](https://github.com/FarazzShaikh/THREE-CustomShaderMaterial) - Extend Three.js materials with your own shaders.
    ...
    *   🎉 [Lamina (⭐982)](https://github.com/pmndrs/lamina) - Extensible, layered shader material for Three.js.
    *   ❓ [screen-space-reflections (⭐541)](https://github.com/0beqz/screen-space-reflections) - Screen space reflections in Three.js.
    ...
    *   🎉 [three-nebula (⭐877)](https://github.com/creativelifeform/three-nebula) - WebGL particle system for Three.js. \[[Examples](https://three-nebula.org/examples/custom-renderer)]
    *   🎉 [three-projected-material (⭐625)](https://github.com/marcofugaro/three-projected-material) - Texture projection in Three.js.
    *   🎉 [three.ik (⭐436)](https://github.com/jsantell/THREE.IK) - Inverse kinematics for Three.js.
...
*   JavaScript: Gui
    ...
    *   🎉 [Guify (⭐276)](https://github.com/colejd/guify) - Simple gui for changing JavaScript variables. \[[Demo](https://jons.website/projects/guify/)]
    ...
    *   🎉 [PCUI (⭐640)](https://github.com/playcanvas/pcui) - UI component library for the web by *PlayCanvas*.
    *   🎉 [Tweakpane (⭐3.2k)](https://github.com/cocopon/tweakpane) - Compact gui for fine-tuning values.
    *   🎉 [uil (⭐550)](https://github.com/lo-th/uil) - Simple JavaScript gui.
...
*   JavaScript: Utility
    ...
    *   🎉 [i18next (⭐7.3k)](https://github.com/i18next/i18next) - Popular internationalization framework.
...
*   JavaScript: Timeline
    ...
    *   🎉 [Neo (⭐275)](https://github.com/lo-th/neo) - Timeline for JavaScript. \[[Demo](http://lo-th.github.io/neo/)]
*   JavaScript: Video
...
*   JavaScript: Visual Programming / Nodes
    ...
    *   🎉 [Litegraph.js (⭐5k)](https://github.com/jagenjo/litegraph.js) - Create graphs in the browser similar to Unreal Blueprints. \[[Demo](https://tamats.com/projects/litegraph/editor/)]
    ...
    *   🎉 [Rete.js (⭐9.5k)](https://github.com/retejs/rete) - Framework for visual programming and node editors. \[[Demo](https://rete.js.org/#/examples/basic)]
...
*   Pascal: Game Engine w/Editor
    *   🎉 [Castle (⭐865)](https://github.com/castle-engine/castle-engine) - Cross-platform 2D/3D game engine and editor. \[[Website](https://castle-engine.io/)]
...
*   Ruby: Game Framework
    *   🎉 [Ruby 2D (⭐627)](https://github.com/ruby2d/ruby2d) - Make cross-platform 2D apps.

### Libraries / Rust

*   Rust: App Framework
    *   🎉 [Makepad (⭐4.6k)](https://github.com/makepad/makepad) - Software development platform and native-rendering gui framework. \[[Editor](https://makepad.dev/)]
...
*   Rust: Physics
    *   🎉 [Rapier (⭐3.4k)](https://github.com/dimforge/rapier) - 2D/3D physics engines focused on performance. \[[Docs](https://rapier.rs)]

### Libraries / Zig

*   🌎 [Zig Learn](https://ziglearn.org/) - Excellent Zig language resource.
*   📚 [Ziglings (⭐4k)](https://github.com/ratfactor/ziglings) - Learn the Zig programming language by fixing tiny broken programs.
*   Zig: Game Engine w/Editor
    *   🎉 [Mach (⭐2.7k)](https://github.com/hexops/mach) - Game engine & graphics toolkit. \[[Examples](https://machengine.org/gpu/)]
*   Zig: Graphics - 2D
    *   🎉 [Mini Pixel (⭐161)](https://github.com/fabioarnold/MiniPixel) - Tiny pixel art editor. \[[Download](https://fabioarnold.itch.io/mini-pixel)]
    *   🔒 [Pixi (⭐508)](https://github.com/foxnne/pixi) - Pixel art editor.

### Open Source Games / C

*   🔒 [Gish (⭐319)](https://github.com/blinry/gish) - Open Source version of the award-winning physics platformer. \[[Steam](https://store.steampowered.com/app/9500/Gish/)]

### Open Source Games / C++

*   🔒 [Dungeon Crawl: Stone Soup (⭐2.2k)](https://github.com/crawl/crawl) - Classic roguelike adventure. \[[Play](https://crawl.develz.org/)]
*   🎉 [Etheral Legends (⭐234)](https://github.com/Soverance/EtherealLegends) - Indie Action RPG built with *Unreal Engine 4*. \[[Steam](https://store.steampowered.com/app/428980/Ethereal_Legends/)]
...
*   🎉 [CrossShader (⭐261)](https://github.com/alaingalvan/CrossShader) - Cross-compiling shaders between GLSL, HLSL, Metal, and more. \[[Online Tool](https://alain.xyz/libraries/crossshader)]
...
*   🌎 [Shader Park (⭐693)](https://github.com/shader-park/shader-park-core) - Shader programming in JavaScript.
...
*   📚 [CoolEngines (⭐55)](https://github.com/JohnClarking/CoolEngines) - List of open source graphic & game engines.
...
*   💸 [Unity](https://unity.com) - Biggest name in game engines, industry standard. \[[Awesome (⭐6.3k)](https://github.com/RyanNielson/awesome-unity)]
*   💸 [Unreal Engine](https://www.unrealengine.com) - AAA quality, insane feature set, photoreal visuals. \[[Awesome (⭐995)](https://github.com/insthync/awesome-ue4#readme)]
...
*   💰 [Phaser Editor 2D](https://phasereditor2d.com) - Commercial, web-based editor for *Phaser*. \[[GitHub (⭐404)](https://github.com/PhaserEditor2D/PhaserEditor2D-v3)]
*   💸 [PlayCanvas](https://playcanvas.com) - Popular (*Flappy Bird*) WebGL game engine. \[[Awesome (⭐234)](https://github.com/playcanvas/awesome-playcanvas#readme) | [GitHub (⭐9k)](https://github.com/playcanvas/engine)]
...
*   🔒 [HARFANG 3D (⭐451)](https://github.com/harfang3d/harfang3d) - 3D visualization library for industry professionals, usable in C++, Python, Lua, Go.
...
*   Graphics API: WebGL
    ...
    *   📚 [WebGL 2 Samples (⭐997)](https://github.com/WebGLSamples/WebGL2Samples) - Short and easy to understand samples demonstrating WebGL 2 features.
...
*   Platform: XNA
    ...
    *   📚 [Riemer's MonoGame Tutorials (⭐648)](https://github.com/SimonDarksideJ/XNAGameStudio/wiki/RiemersArchiveOverview) - Everything you need to start programming with MonoGame.
    *   📚 [XNA Game Studio Archive (⭐648)](https://github.com/SimonDarksideJ/XNAGameStudio) 🔥 - Required visit for [MonoGame](https://en.wikipedia.org/wiki/MonoGame) / [FNA](https://fna-xna.github.io/) / [XNA](https://en.wikipedia.org/wiki/Microsoft_XNA) developers.
...
*   📚 [Every Programmer Should Know (⭐76k)](https://github.com/mtdvio/every-programmer-should-know) - Technical things every developer should know.
...
*   📚 [Learn to Program (⭐3.7k)](https://github.com/karlhorky/learn-to-program#readme) - Educational resources to learn to program.
...
*   BASIC: App Framework
    ...
    *   🎉 [QB64 (⭐649)](https://github.com/QB64Team/qb64) - Modern BASIC+OpenGL language, retains *QBasic* / *QB4.5* compatibility.
    *   📚 [Visual Basic](https://docs.microsoft.com/en-us/dotnet/visual-basic/) - Object-oriented language for Windows by *Microsoft*.

### Libraries / C

*   C: Cross-Platform
    *   🎉 [Cosmopolitan (⭐14k)](https://github.com/jart/cosmopolitan) - Build-once run-anywhere C library.
*   C: Entity Component System
    *   🎉 [Flecs (⭐5.4k)](https://github.com/SanderMertens/flecs) - Fast and lightweight entity component system in C99.
*   C: File System
    ...
    *   ⭐ [Incbin (⭐905)](https://github.com/graphitemaster/incbin) - Include binary and text files in your C/C++ apps with ease.
    *   🎉 [PhysicsFS (⭐481)](https://github.com/icculus/physfs) - Portable, flexible file I/O abstraction. Provides access to various archives.
    *   ⭐ [Where Am I (⭐438)](https://github.com/gpakosz/whereami) - Locates the current path on the local file system.
*   C: Fonts
    *   🎉 [Font Stash (⭐649)](https://github.com/memononen/fontstash) - Lightweight library that uses stb\_truetype to render fonts to a texture atlas.
...
*   C: Game Engine w/Editor
    *   ⭐ [AVA (⭐332)](https://github.com/r-lyeh/AVA) - Tiny, minimalistic 3D game engine.
    *   🎉 [TIC-80 (⭐4.7k)](https://github.com/nesbox/TIC-80) - Virtual computer for making & sharing tiny games. \[[Website](https://tic80.com/)]
*   C: Game Framework
    *   🎉 [CGL (⭐385)](https://github.com/Jaysmito101/cgl) - Single-header file, lots of graphics & utility functions.
    *   🎉 [DOME (⭐460)](https://github.com/domeengine/dome) - Melds SDL2 and the Wren scripting language. \[[Website](https://domeengine.com/)]
    *   🎉 [Entrypoint (⭐70)](https://github.com/jimon/entrypoint) - Lightweight entry point for games.
    *   ⭐ [FWK (⭐117)](https://github.com/r-lyeh/FWK) - 3D game framework.
    *   🎉 [Gunslinger (⭐1.1k)](https://github.com/MrFrenik/gunslinger) - Header-only C99 framework for multimedia apps.
    *   🎉 [RayLib (⭐18k)](https://github.com/raysan5/raylib) 🔥 - Simple and easy-to-use library to enjoy 2D/3D videogame programming.
*   C: Geometry
...
*   C: Graphics - 2D
    ...
    *   🎉 [Tilengine (⭐760)](https://github.com/megamarc/Tilengine) - 2D graphics with raster effects for retro style game development.
*   C: Graphics - 3D
    *   🎉 [Sokol Gfx (⭐5.7k)](https://github.com/floooh/sokol/blob/master/sokol_gfx.h) - Cross-platform, single-file graphics. \[[Examples](https://floooh.github.io/sokol-html5/)]
    *   🎉 [Sokol Graphics Painter (⭐374)](https://github.com/edubart/sokol_gp) - 2D graphics painter implemented with *Sokol*.
*   C: Gui
    *   🎉 [cImgui (⭐1.3k)](https://github.com/cimgui/cimgui) - Thin C wrapper generated for Dear ImGui.
    *   🎉 [lvgl (⭐15k)](https://github.com/lvgl/lvgl) 🔥 - Embedded gui library, many widgets and advanced visual effects.
    *   🎉 [NAppGUI (⭐416)](https://github.com/frang75/nappgui_src) - Professional, well documented SDK to build desktop apps.
    *   🎉 [Native File Dialog (⭐1.7k)](https://github.com/mlabbe/nativefiledialog) - Portably invoke native file open / save dialogs.
    *   🎉 [Nuklear (⭐8.4k)](https://github.com/Immediate-Mode-UI/Nuklear) - Single-header immediate mode cross-platform gui library.
*   C: Input
    *   🎉 [libGamepad (⭐22)](https://github.com/mtwilliams/libgamepad) - Cross-platform library for gamepad input.
    *   🎉 [Sokol Gamepad (⭐5.7k)](https://github.com/floooh/sokol/pull/393/commits/26a9da9dafd4adb22a1ace0de0d2569da31ae427) - Branch with addon support for gamepads in *Sokol*.
*   C: Libraries
    ...
    *   ⭐ [Pico Headers (⭐195)](https://github.com/empyreanx/pico_headers) - Single-file, cross-platform libraries for game development.
...
*   C: Math
    ...
    *   🎉 [Raymath (⭐18k)](https://github.com/raysan5/raylib/blob/master/src/raymath.h) - Math library included in the *RayLib* game framework.
*   C: Network
...
*   C: Scripting
    ...
    *   🎉 [QuickJS (⭐7.5k)](https://github.com/bellard/quickjs) - Small and embeddable JavaScript engine.
...
*   C++: File Formats
    *   ⭐ [Jpeg-Compressor (⭐204)](https://github.com/richgel999/jpeg-compressor) - Single-file library that writes baseline JPEG compressed images.
    *   🎉 [TinyDNG (⭐137)](https://github.com/syoyo/tinydng) - Header-only DNG / TIFF loader and writer.
    *   🎉 [TinyEXR (⭐659)](https://github.com/syoyo/tinyexr) - Tiny OpenEXR image loader / saver library.
...
*   C++: File System
    *   🎉 [Imgui-Filebrowser (⭐592)](https://github.com/AirGuanZ/imgui-filebrowser) - Header-only file browser implementation for *Dear ImGui* in C++17.
*   C++: Game Framework
    *   🎉 [Acid (⭐1.7k)](https://github.com/EQMG/Acid) - Modern C++17 and structured to be fast, simple, and modular.
    *   🎉 [blah (⭐535)](https://github.com/NoelFB/blah) - Small 2D game framework.
    *   🎉 [Cocos2d-x (⭐18k)](https://github.com/cocos2d/cocos2d-x) - Widely used in indie game dev community.
    *   🎉 [Cute Framework (⭐476)](https://github.com/RandyGaul/cute_framework) - Simple and consise framework for making 2D games.
    *   🔒 [Fireworks Engine (⭐35)](https://github.com/Pikachuxxxx/Fireworks-Engine) - Lightweight OpenGL framework for quick prototyping.
    ...
    *   🎉 [JNGL (⭐210)](https://github.com/jhasse/jngl) - 2D framework. Develop anywhere, deploy everywhere.
    *   🔒 [KlayGE (⭐2k)](https://github.com/gongminmin/KlayGE) - Cross-platform game framework with plugin-based architecture.
    *   🎉 [Koala Engine (⭐588)](https://github.com/phisko/kengine) - Framework with an ECS architecture, aka *Kengine*.
    *   🎉 [Lumino (⭐198)](https://github.com/LuminoEngine/Lumino) - Framework for building real-time graphics apps.
    *   🎉 [Nazara Engine (⭐651)](https://github.com/NazaraEngine/NazaraEngine) - Custom shaders, ECS, 2D/3D, networking and more.
    *   🎉 [nCine (⭐957)](https://github.com/nCine/nCine) - Cross-platform 2D game framework.
    ...
    *   🎉 [Supernova (⭐217)](https://github.com/supernovaengine/supernova) - Cross-platform for 2D/3D projects.
    *   🎉 [Thunder (⭐476)](https://github.com/thunder-engine/thunder) - Cross-platform 2D/3D with module architecture.
...
*   C++: Geometry
    *   🎉 [CinoLib (⭐803)](https://github.com/mlivesu/cinolib) - Header-only library for processing polygonal and polyhedral meshes.
    *   🎉 [Delabella (⭐210)](https://github.com/msokalski/delabella) - Super stable 2D delaunay triangulation.
    *   🎉 [Delaunator-Cpp (⭐0)](https://github.com/soerendd/delaunator-cpp) - Really fast library for Delaunay triangulation of 2D points.
    *   🔒 [Easy3D (⭐1.2k)](https://github.com/LiangliangNan/Easy3D) - Easy-to-use library for 3D modeling, geometry processing, and rendering.
    *   🎉 [Extrude (⭐17)](https://github.com/stevinz/extrude) - Converts 2D images into 3D extruded meshes.
    *   🔒 [Generator (⭐202)](https://github.com/ilmola/generator) - Procedural geometry generation library for C++11.
    ...
    *   🎉 [PolyPartition (⭐597)](https://github.com/ivanfratric/polypartition) - 2D polygon partitioning and triangulation.
    ...
    *   🎉 [Recast & Detour (⭐6.1k)](https://github.com/recastnavigation/recastnavigation) - Navigation-mesh toolset for games.
    *   🎉 [Seam-aware Decimater (⭐474)](https://github.com/songrun/SeamAwareDecimater) - Simplifies mesh while preserving UVs, based on [Seamless](https://cragl.cs.gmu.edu/seamless/).
...
*   C++: Graphics - 3D
    ...
    *   🎉 [OSRE (⭐178)](https://github.com/kimkulling/osre) - Just another "Open Source Render Engine".
    *   🔒 [StratusGFX (⭐586)](https://github.com/KTStephano/StratusGFX) - Realtime 3D rendering engine implementing modern graphics techniques.
    *   🎉 [Threepp (⭐545)](https://github.com/markaren/threepp) - Cross-platform C++17 port of the popular 3D JavaScript library *Three.js* (r129).
...
*   C++: Gui
    *   🎉 [Crazy Eddie's GUI (⭐423)](https://github.com/cegui/cegui) - Versatile, multi-platform gui library.
    ...
    *   🎉 [GuiLite (⭐7.1k)](https://github.com/idea4good/GuiLite) - Header-only, cross-platform gui library.
    ...
    *   ⭐ [Portable File Dialogs (⭐971)](https://github.com/samhocevar/portable-file-dialogs) - Single-header C++11 native dialogs on Windows, macOS, and Linux.
    *   🔒 [Qt](https://github.com/qt) - Industry standard gui library. \[[Awesome (⭐72)](https://github.com/mikeroyal/Qt-Guide) | [Website](https://www.qt.io)]
    *   ⭐ [RmlUi (⭐2.4k)](https://github.com/mikke89/RmlUi) - Turns HTML / CSS source files into vertices and draw commands. \[[Docs](https://mikke89.github.io/RmlUiDoc/)]
    *   ⭐ [Turbo Badger (⭐577)](https://github.com/fruxo/turbobadger) - Gui library for hardware accelerated apps & games. \[[Oryol Example](https://floooh.github.io/oryol-samples/wasm/TurboBadgerDemo.html)]
    *   🔒 [Wt (⭐1.6k)](https://github.com/emweb/wt) - Web gui library in modern C++. \[[Website](https://www.webtoolkit.eu/wt)]
    *   🔒 [wxWidgets (⭐5.7k)](https://github.com/wxWidgets/wxWidgets) - Cross-platform gui using native controls. \[[Website](https://wxwidgets.org)]
*   C++: Lighting
    *   🎉 [Thekla Atlas (⭐434)](https://github.com/Thekla/thekla_atlas) - Atlas generation tool.
    *   🎉 [UVAtlas (⭐787)](https://github.com/Microsoft/UVAtlas) - DirectX library for creating and packing texture atlases.
*   C++: Network
...
*   C++: Scripting
    ...
    *   🔒 [ArkScript (⭐535)](https://github.com/ArkScript-lang/Ark) - Small, fast, functional and scripting language.
    *   🎉 [ChaiScript (⭐2.9k)](https://github.com/ChaiScript/ChaiScript) - Embedded scripting language designed from to directly target C++17.
    *   🎉 [GameMonkey Script (⭐141)](https://github.com/publicrepo/gmscript) - Embedded scripting language for apps, tools and games.
    *   🎉 [v8 (⭐23k)](https://github.com/v8/v8) - High-performance JavaScript and WebAssembly engine by *Google*.
*   C++: Utility
    *   🎉 [Any-Lite (⭐131)](https://github.com/martinmoene/any-lite) - Header-only 'any' type for C++98 and above.
    *   🎉 [EASTL (⭐7.6k)](https://github.com/electronicarts/EASTL/) - Electronic Arts STL replacement, emphasis on performance.
    *   🎉 [faker-cxx (⭐184)](https://github.com/cieslarmichal/faker-cxx) - C++20 Faker library for generating fake (but realistic) data for testing and development.
    ...
    *   🎉 [TinyXML-2 (⭐4.8k)](https://github.com/leethomason/tinyxml2) - XML parser that can be easily integrated into other programs.
*   C++: Visual Programming / Nodes
    ...
    *   🎉 [Visual Script Engine (⭐169)](https://github.com/kovacsv/VisualScriptEngine) - Visual scripting engine designed for embedding.
...
*   C#: Audio
    *   🎉 [NAudio (⭐5.2k)](https://github.com/naudio/NAudio) - Audio and MIDI library for .NET.
*   C#: Physics
    *   🎉 [Aether Physics (⭐359)](https://github.com/tainicom/Aether.Physics2D) - 2D physics library with continuous collision detection.
    *   🎉 [Velcro Physics (⭐655)](https://github.com/Genbox/VelcroPhysics) - C# port of Box2D. Formerly *Farseer Physics*.
*   C#: Utility
...
*   Dart: App Framework
    *   🎉 [Flutter](https://flutter.dev) - Open source app framework by *Google*. \[[Awesome (⭐51k)](https://github.com/Solido/awesome-flutter) | [GitHub](https://github.com/flutter)]
*   Dart: File Formats
    *   🎉 [image (⭐1.1k)](https://github.com/brendan-duncan/image) - Library for decoding / encoding image formats and image processing.

### Libraries / Go

*   📚 [Awesome Go (⭐119k)](https://github.com/avelino/awesome-go) - Awesome Go frameworks, libraries and software.
*   Go: Audio
...
*   Haxe: Animation
    *   🎉 [Actuate (⭐154)](https://github.com/jgranick/actuate) - Flexible, fast tween library.
    *   🎉 [DragonBones (⭐37)](https://github.com/openfl/dragonbones) - Runtime support for *DragonBones* skeletal animation.
    *   🎉 [Spine-Hx (⭐55)](https://github.com/jeremyfa/spine-hx) - *Spine* runtime for Haxe.
...
*   Haxe: Game Framework
    *   🎉 [Ceramic (⭐239)](https://github.com/ceramic-engine/ceramic) - Cross-platform 2D framework. \[[Examples](https://ceramic-engine.com/examples/)]
    ...
    *   🎉 [gameBase (⭐551)](https://github.com/deepnight/gameBase) - Base structure for Haxe games, using *Heaps* graphics framework. \[[Tutorial](https://deepnight.net/tutorial/using-my-gamebase-to-create-a-heaps-game/)]
...
*   Haxe: Physics
    ...
    *   🎉 [Nape (⭐46)](https://github.com/HaxeFlixel/nape-haxe4) - Fast, friendly 2D rigid body physics engine. \[[Demos](https://joecreates.github.io/napephys/)]
*   Haxe: Serialization / Storage
    *   🎉 [CastleDB (⭐536)](https://github.com/ncannasse/castle) - Structured database with a local web service to edit it.
    *   🎉 [Format (⭐125)](https://github.com/HaxeFoundation/format) - Various files formats support for Haxe.
    *   🎉 [HxBit (⭐148)](https://github.com/HeapsIO/hxbit) - Binary serialization and network synchronization library.
...
*   Lua: Game Framework
    *   🎉 [3DreamEngine (⭐340)](https://github.com/3dreamengine/3DreamEngine) - 3D engine on top of *LÖVE*.
    *   🎉 [Gideros (⭐542)](https://github.com/gideros/gideros) - 2D/3D cross-platform games with Lua. \[[Website](http://giderosmobile.com/)]
    *   🎉 [INSTEAD (⭐211)](https://github.com/instead-hub/instead) - Simple Text Adventure Interpreter.
    *   🎉 [LÖVE (⭐4.2k)](https://github.com/love2d/love) - 2D framework for writing game code with Lua. \[[Awesome (⭐3k)](https://github.com/love2d-community/awesome-love2d) | [Website](https://love2d.org)]
...
*   JavaScript: Cross-Platform
    ...
    *   📚 [Electron Alternatives (⭐1.4k)](https://github.com/sudhakar3697/electron-alternatives) - Cross-platform gui app development options.
    ...
    *   🎉 [React Native (⭐115k)](https://github.com/facebook/react-native) - Framework for building native apps using React. \[[Website](https://reactnative.dev/)]
    *   🎉 [Tauri (⭐76k)](https://github.com/tauri-apps/tauri) - Smaller, faster, and more secure desktop applications. \[[Website](https://tauri.app/)]
...
*   JavaScript: Entity Component System
    *   🎉 [Becsy (⭐178)](https://github.com/LastOliveGames/becsy) - Multithreaded ECS for TypeScript and JavaScript.
    *   🔒 [bitECS (⭐813)](https://github.com/NateTheGreatt/bitECS) - Functional, minimal, data-oriented, ultra-high performance ECS library.
    *   🎉 [Ecsy (⭐1.1k)](https://github.com/ecsyjs/ecsy) - Experimental ECS aiming to be lightweight, easy to use.
    *   🎉 [Miniplex (⭐731)](https://github.com/hmans/miniplex) - Entity management system for games.
...
*   JavaScript: Geometry
    ...
    *   🎉 [Poly-Decomp.js (⭐410)](https://github.com/schteppe/poly-decomp.js) - Decompose 2D polygons into convex pieces.
*   JavaScript: Graphics - Three.js
    ...
    *   📚 [THREEx (⭐331)](https://github.com/jeromeetienne/threex) - Nice collection of open source game extensions.
*   JavaScript: Graphics - Three.js - React
    *   🎉 [drei (⭐7.2k)](https://github.com/pmndrs/drei) - Useful helpers for react-three-fiber.
    *   🎉 [gltfjsx (⭐4.1k)](https://github.com/pmndrs/gltfjsx) - Turns GLTFs into JSX components.
...
*   JavaScript: Physics
    ...
    *   🎉 [Particulate.js (⭐335)](https://github.com/jpweeks/particulate-js) - Particle physics library designed to be simple, fast and stable.
    ...
    *   🎉 [Verly.js (⭐637)](https://github.com/anuraghazra/Verly.js) - Easy to integrate verlet physics engine. \[[Demos](https://anuraghazra.dev/Verly.js/)]

### Libraries / Kotlin

*   Kotlin: Game Framework
    *   🎉 [FXGL (⭐4.1k)](https://github.com/AlmasB/FXGL) - Game library for 2D, experimental 3D.
    *   🎉 [Kool (⭐245)](https://github.com/fabmax/kool) - Multi-platform 3D Vulkan / OpenGL graphics engine. \[[Examples](https://fabmax.github.io/kool/kool-js/)]
...
*   Pascal: Game Framework
    *   🎉 [Apus (⭐160)](https://github.com/Cooler2/ApusGameEngine) - Cross-platform library for making 2D games.
*   Pascal: Physics
    *   🎉 [Kraft (⭐101)](https://github.com/BeRo1985/kraft) - Object Pascal 3D physics engine.

### Libraries / Python

*   📚 [Awesome Python (⭐201k)](https://github.com/vinta/awesome-python) - List of awesome Python frameworks, libraries, software and more.
*   Python: Cross-Platform
    *   💸 [Anvil](https://anvil.works) - Full stack web apps with nothing but Python.
    *   🎉 [Brython (⭐6.2k)](https://github.com/brython-dev/brython) - Python 3 running in the browser.
...
*   Ruby: Graphics - 3D
    *   🎉 [Mittsu (⭐501)](https://github.com/danini-the-panini/mittsu) - 3D graphics library based heavily on *Three.js*.
*   Ruby: Gui
    *   🎉 [Glimmer (⭐488)](https://github.com/andyobtiva/glimmer) - Gui library and DSL (domain specific language) framework.
    *   🎉 [Shoes (⭐1.6k)](https://github.com/shoes/shoes4) - Cross-platform gui library. \[[Website](http://shoesrb.com/)]

### Libraries / Rust

*   📚 [Awesome Rust (⭐42k)](https://github.com/rust-unofficial/awesome-rust) - Curated list of Rust code and resources.
...
*   Zig: File System
    *   🎉 [Known Folders (⭐198)](https://github.com/ziglibs/known-folders) - Provides access to well-known folders across several operating systems.
*   Zig: Game Framework
    *   🎉 [Zig-Gamedev Project (⭐1.9k)](https://github.com/michal-z/zig-gamedev) - Sample apps and libraries using DirectX 12.
*   Zig: Scripting
    *   🎉 [Cyber (⭐1k)](https://github.com/fubark/cyber) - Fast, efficient, and concurrent scripting language.
...
*   📚 [Nomad Game Engine](https://savas.ca/nomad) - Articles building an ECS from the ground up in C++. \[[Source (⭐180)](https://github.com/taurheim/NomadECS)]
...
*   🔒 [Fluids-2D](https://www.csc.kth.se/~mathar/fluids-2d/) - Real-time fluid dynamics on the GPU with the help of WebGL and Three.js. \[[Source (⭐389)](https://github.com/mharrys/fluids-2d)]
...
*   CSG (Constructive Solid Geometry)
    ...
    *   🎉 [three-bvh-csg (⭐490)](https://github.com/gkjohnson/three-bvh-csg) - Fast and dynamic CSG on top of three-mesh-bvh.
    *   🎉 [three-csgmesh (⭐425)](https://github.com/manthrax/THREE-CSGMesh) - Conversion of the csg.js library for use with Three.js.
*   Smoothing
...
*   Volumetric
    *   🌎 [Threex Volumetric Spotlight](http://jeromeetienne.github.io/threex.volumetricspotlight/examples/basic.html) - Great example of volumetric lighting with Three.js. \[[Source (⭐120)](https://github.com/jeromeetienne/threex.volumetricspotlight)]
...
*   Soft Body
    ...
    *   🌎 [Three.js: Ammo Volume](https://threejs.org/examples/?q=physics#physics_ammo_volume) - 3D soft body volumes using *Ammo.js* and *Three.js*. \[[Source (⭐98k)](https://github.com/mrdoob/three.js/blob/master/examples/physics_ammo_volume.html)]
*   Water / Buoyancy
...
*   📚 [Scriptorium (⭐489)](https://github.com/r-lyeh-archived/scriptorium) - Game scripting languages benchmarked.
...
*   Bloom
    ...
    *   🌎 [Three.js: Bloom Example](https://threejs.org/examples/?q=bloom#webgl_postprocessing_unreal_bloom) - WebGL bloom postprocessing using *Three.js*. \[[Source (⭐98k)](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_unreal_bloom.html)]
...
*   Noise
    ...
    *   🎉 [Psrdnoise (⭐207)](https://github.com/stegu/psrdnoise/) - Tiling simplex flow noise in 2D/3D.
    ...
    *   🎉 [WebGL Noise (⭐447)](https://github.com/stegu/webgl-noise/) - Maintained branch of the original *Ashima Arts* 2D, 3D and 4D noise functions.
*   Outlines
    ...
    *   📚 [Outlines w/Surface IDs](https://omar-shehata.medium.com/better-outline-rendering-using-surface-ids-with-webgl-e13cdab1fd94) - Technique combining depth, normals and surface IDs. \[[Source (⭐333)](https://github.com/OmarShehata/webgl-outlines)]
...
*   Pixelation
    ...
    *   🌎 [Three.js: Pixelation Example](https://threejs.org/examples/?q=pixel#webgl_postprocessing_pixel) - WebGL pixelation postprocessing using *Three.js*. \[[Source (⭐98k)](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_pixel.html)]
*   Postprocessing
    *   📚 [Image Editor Effects](https://alain.xyz/blog/image-editor-effects) - WebGL image filters / effects shaders. \[[Source (⭐86)](https://github.com/alaingalvan/image-editor-effects)]
*   Upscaling
...
*   📚 [Signed Distance Field Resources (⭐588)](https://github.com/CedricGuillemet/SDF) - Tutorials, papers, software, demos, discussions, etc.
...
*   Sound Effects
    *   🆓 [Bfxr](https://www.bfxr.net) - Classic. For making simple sound effects for games. \[[Source (⭐939)](https://github.com/increpare/bfxr)]
    ...
    *   🆓 [ZzFX](https://killedbyapixel.github.io/ZzFX/) - Tiny JavaScript sound FX system / Zuper Zmall Zound Zynth. \[[Source (⭐498)](https://github.com/KilledByAPixel/ZzFX)]
...
*   Modeling
    ...
    *   📚 [NeRF](https://www.matthewtancik.com/nerf) - View synthesis of scenes as neural radiance fields. \[[Source (⭐9.3k)](https://github.com/bmild/nerf)]
...
*   🆓 [Material Maker](https://www.materialmaker.org) - Procedural [physically-based rendering](https://en.wikipedia.org/wiki/Physically_based_rendering) material maker. \[[Source (⭐3.1k)](https://github.com/RodZill4/material-maker)]
...
*   🆓 [ArmorPaint](https://armorpaint.org) - Physically-based texture painting, drop in your 3D models and paint. \[[Source (⭐3k)](https://github.com/armory3d/armorpaint)]
*   💰 [Asset Forge](https://assetforge.io) - Create 3D models and 2D sprites using building blocks.
*   🆓 [Blender](https://www.blender.org) 🔥 - Standard for open source 3D modeling. \[[Source (⭐11k)](https://github.com/blender/blender)]
*   🆓 [Meshroom](https://alicevision.org/#meshroom) - 3D reconstruction, built with the [AliceVision (⭐2.8k)](https://github.com/alicevision/AliceVision) framework. \[[Source (⭐10k)](https://github.com/alicevision/meshroom)]
...
*   🆓 [Krita](https://krita.org/en/) - Professional quality, open source painting. \[[Source (⭐6.5k)](https://github.com/KDE/krita)]
*   💰 [Vec Maker](https://kronbits.itch.io/vecmaker) - Easy to use vector design.

### Tools / Software / Voxel

*   🎉 [IsoVoxel (⭐344)](https://github.com/tommyettinger/IsoVoxel) - Generates isometric pixel art from *MagicaVoxel* .vox files.
...
*   📚 [Retro3DGraphicsCollection (⭐1.2k)](https://github.com/Miziziziz/Retro3DGraphicsCollection) - No attribution, retro (*PS1* style) 3D graphics assets.
...
*   🆓 [Radiant](https://icculus.org/gtkradiant/) - Cross-platform level editor for [idTech](https://en.wikipedia.org/wiki/Id_Tech) games. \[[Source (⭐574)](https://github.com/TTimo/GtkRadiant)]
...
*   Music
    *   🆓 [Ardour](https://ardour.org) - Record, edit, and mix. \[[Source (⭐3.6k)](https://github.com/Ardour/ardour)]
    ...
    *   🆓 [FamiStudio](https://famistudio.org) - Music editor targeted at chiptune artists and NES homebrewers. \[[Source (⭐1.5k)](https://github.com/BleuBleu/FamiStudio)]
    *   💸 [fmod](https://www.fmod.com) - Popular (*Hades*, *Celeste*, *Untitled Goose Game*) audio software for games.
    *   🆓 [LMMS](https://lmms.io) 🔥 - Cross-platform music production software. \[[Source (⭐7.5k)](https://github.com/lmms/lmms)]
    *   🆓 [PixiTracker](https://warmplace.ru/soft/pixitracker/) - Quickly create musical sketches, chiptunes and sound experiments.
    *   🆓 [Sound Box](https://sb.bitsnbites.eu) - Compose synthetic music in your browser, good for small demos. \[[Source (⭐425)](https://github.com/mbitsnbites/soundbox)]
    ...
    *   🆓 [ZzFXM](https://keithclark.github.io/ZzFXM/tracker/) - Music generator for use in tiny JavaScript apps. \[[Source (⭐405)](https://github.com/keithclark/ZzFXM)]
...
*   🆓 [GIMP](https://www.gimp.org) - GNU Image Manipulation Program, open source image editor. \[[Source (⭐4.5k)](https://github.com/GNOME/gimp)]

### Tools / Software / Materials / Textures

*   🆓 [ArmorLab](https://armorlab.org) - Generate PBR materials by drag & dropping your photos. \[[Source (⭐169)](https://github.com/armory3d/armorlab)]
...
*   💸 [Aseprite](https://www.aseprite.org) - Animated sprite editor and pixel art tool. \[[Source (⭐26k)](https://github.com/aseprite/aseprite)]

### Tools / Software / Vector Editors

*   🆓 [Inkscape](https://inkscape.org) - Cross-platform, open source vector graphics editor. \[[Source (⭐1.9k)](https://github.com/inkscape/inkscape)]
