...
A curated list of awesome Game Boy (Color) Development resources, tools, docs, related projects and open-source ROMs. Inspired by the [awesome (⭐266k)](https://github.com/sindresorhus/awesome) list thing.
...
> #### Game Boy Advance
>
> Game Boy Advance development is covered by another project, the [awesome-gbadev (⭐747)](https://github.com/gbdev/awesome-gbadev) list.
