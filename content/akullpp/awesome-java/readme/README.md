...
*   [Datadog ![c] (⭐500)](https://github.com/DataDog/dd-trace-java) - Modern monitoring & analytics.
...
Please have a look at the [CONTRIBUTING (⭐39k)](https://github.com/akullpp/awesome-java/blob/master/CONTRIBUTING.md) guidelines and [the validation tools (⭐5)](https://github.com/akullpp/awesome-java-lint).
