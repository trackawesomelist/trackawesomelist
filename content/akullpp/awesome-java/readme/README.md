...
*   [ArcGIS Maps SDK for Java ![c] (⭐111)](https://github.com/Esri/arcgis-maps-sdk-java-samples/) - JavaFX library for adding mapping and GIS functionality to desktop apps.
...
*   [Datadog ![c] (⭐553)](https://github.com/DataDog/dd-trace-java) - Modern monitoring & analytics.
...
*   [Sentry ![c] (⭐1.1k)](https://github.com/getsentry/sentry-java) - Integration with [Sentry (⭐38k)](https://github.com/getsentry/sentry), an application error tracking and performance analysis platform.
