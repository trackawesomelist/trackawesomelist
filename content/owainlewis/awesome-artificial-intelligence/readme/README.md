...
The list is reviewed weekly by an evidence-backed automation that proposes small changes for human review. See [how resources are evaluated](https://github.com/owainlewis/awesome-artificial-intelligence/blob/master/README.md/CURATION.md).
