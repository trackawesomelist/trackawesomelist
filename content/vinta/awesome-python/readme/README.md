...
*   [uvloop (⭐9.2k)](https://github.com/MagicStack/uvloop) - Ultra fast asyncio event loop.
...
*Libraries for concurrent and parallel execution. Also see [awesome-asyncio (⭐3.9k)](https://github.com/timofurrer/awesome-asyncio).*
...
*   [moment (⭐714)](https://github.com/zachwill/moment) - A Python library for dealing with dates/times. Inspired by [Moment.js](http://momentjs.com/).
...
*Libraries for Machine Learning. Also see [awesome-machine-learning (⭐58k)](https://github.com/josephmisiti/awesome-machine-learning#python).*
...
*Libraries for scientific computing. Also see [Python-for-Scientists (⭐220)](https://github.com/TomNicholas/Python-for-Scientists).*
...
*Traditional full stack web frameworks. Also see [RESTful API (⭐160k)](https://github.com/vinta/awesome-python#restful-api).*
...
Your contributions are always welcome! Please take a look at the [contribution guidelines (⭐160k)](https://github.com/vinta/awesome-python/blob/master/CONTRIBUTING.md) first.

I will keep some pull requests open if I'm not sure whether those libraries are awesome, you could [vote for them (⭐160k)](https://github.com/vinta/awesome-python/pulls) by adding :+1: to them. Pull requests will be merged when their votes reach **20**.
