...
[🏠 Home](/README.md) · [🔥 Feed](https://www.trackawesomelist.com/vinta/awesome-python/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [😺 vinta/awesome-python](https://github.com/vinta/awesome-python) · ⭐ 145K · 🏷️ Programming Languages
...
*   [uvloop (⭐8.9k)](https://github.com/MagicStack/uvloop) - Ultra fast asyncio event loop.
...
*Tools of static analysis, linters and code quality checkers. Also see [awesome-static-analysis (⭐10k)](https://github.com/mre/awesome-static-analysis).*
...
*Libraries for concurrent and parallel execution. Also see [awesome-asyncio (⭐3.7k)](https://github.com/timofurrer/awesome-asyncio).*
...
*Libraries for Machine Learning. Also see [awesome-machine-learning (⭐56k)](https://github.com/josephmisiti/awesome-machine-learning#python).*
...
*Libraries for scientific computing. Also see [Python-for-Scientists (⭐202)](https://github.com/TomNicholas/Python-for-Scientists).*
...
*Traditional full stack web frameworks. Also see [RESTful API (⭐145k)](https://github.com/vinta/awesome-python#restful-api).*
...
Your contributions are always welcome! Please take a look at the [contribution guidelines (⭐145k)](https://github.com/vinta/awesome-python/blob/master/CONTRIBUTING.md) first.

I will keep some pull requests open if I'm not sure whether those libraries are awesome, you could [vote for them (⭐145k)](https://github.com/vinta/awesome-python/pulls) by adding :+1: to them. Pull requests will be merged when their votes reach **20**.
