...
Inspired by [awesome-php (⭐31k)](https://github.com/ziadoz/awesome-php).
...
*Python implementation of data structures, algorithms and design patterns. Also see [awesome-algorithms (⭐19k)](https://github.com/tayllan/awesome-algorithms).*
...
*Libraries for asynchronous, concurrent and parallel execution. Also see [awesome-asyncio (⭐4.5k)](https://github.com/timofurrer/awesome-asyncio).*
...
*   [bqplot (⭐3.6k)](https://github.com/bloomberg/bqplot) - Interactive Plotting Library for the Jupyter Notebook.
...
*   PostgreSQL - [awesome-postgres (⭐9.7k)](https://github.com/dhamaniasad/awesome-postgres)
    *   [psycopg (⭐1.6k)](https://github.com/psycopg/psycopg) - The most popular PostgreSQL adapter for Python.
*   SQlite - [awesome-sqlite (⭐303)](https://github.com/planetopendata/awesome-sqlite)
    *   [sqlite3](https://docs.python.org/3/library/sqlite3.html) - (Python standard library) SQlite interface compliant with DB-API 2.0.
    *   [sqlite-utils (⭐1.6k)](https://github.com/simonw/sqlite-utils) - Python CLI utility and library for manipulating SQLite databases.
...
*   Mail Servers
    *   [modoboa (⭐3k)](https://github.com/modoboa/modoboa) - A mail hosting and management platform including a modern Web UI.
    *   [salmon (⭐639)](https://github.com/moggers87/salmon) - A Python Mail Server.
*   Clients
...
*   Others
    ...
    *   [mailer (⭐279)](https://github.com/marrow/mailer) - High-performance extensible mail delivery framework.
...
*   [returns (⭐3.4k)](https://github.com/dry-python/returns) - A set of type-safe monads, transformers, and composition utilities.
...
*   [requests (⭐52k)](https://github.com/psf/requests) - HTTP Requests for Humans.
...
*   [python-barcode (⭐542)](https://github.com/WhyNotHugo/python-barcode) - Create barcodes in Python with no extra dependencies.
...
*   [pywal (⭐8.2k)](https://github.com/dylanaraps/pywal) - A tool that generates color schemes from images.
...
*Libraries for Machine Learning. Also see [awesome-machine-learning (⭐64k)](https://github.com/josephmisiti/awesome-machine-learning#python).*
...
*Libraries for scientific computing. Also see [Python-for-Scientists (⭐279)](https://github.com/TomNicholas/Python-for-Scientists).*
...
*   [Zappa (⭐3.2k)](https://github.com/zappa/Zappa) - A tool for deploying WSGI applications on AWS Lambda and API Gateway.
...
*   General
    *   [tablib (⭐4.6k)](https://github.com/jazzband/tablib) - A module for Tabular Datasets in XLS, CSV, JSON, YAML.
*   Office
...
*   [dramatiq (⭐4.2k)](https://github.com/Bogdanp/dramatiq) - A fast and reliable background task processing library for Python 3.
...
*Libraries for accessing third party services APIs. Also see [List of Python API Wrappers and Libraries (⭐2.1k)](https://github.com/realpython/list-of-python-api-wrappers).*

*   [apache-libcloud](https://libcloud.apache.org/) - One Python library for all clouds.
*   [boto3 (⭐8.8k)](https://github.com/boto/boto3) - Python interface to Amazon Web Services.
