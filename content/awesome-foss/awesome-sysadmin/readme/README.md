...
*See also: [Restic's list of Linux backup software (⭐751)](https://github.com/restic/others)*
...
Contributing guidelines can be found [here (⭐3)](https://github.com/awesome-foss/awesome-sysadmin-data/blob/master/CONTRIBUTING.md).
