...
*See also: [Restic's list of Linux backup software (⭐756)](https://github.com/restic/others)*
...
Contributing guidelines can be found [here (⭐9)](https://github.com/awesome-foss/awesome-sysadmin-data/blob/master/CONTRIBUTING.md).
