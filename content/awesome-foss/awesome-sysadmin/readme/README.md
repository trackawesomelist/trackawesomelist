...
*See also: [Restic's list of Linux backup software (⭐757)](https://github.com/restic/others)*
...
Contributing guidelines can be found [here (⭐10)](https://github.com/awesome-foss/awesome-sysadmin-data/blob/master/CONTRIBUTING.md).

## License

This list is under the [Creative Commons Attribution-ShareAlike 4.0 International](https://github.com/awesome-foss/awesome-sysadmin/blob/master/README.md/LICENSE).
Terms of the license are summarized [here](https://creativecommons.org/licenses/by-sa/4.0).
The list of authors can be found in the [AUTHORS](https://github.com/awesome-foss/awesome-sysadmin/blob/master/README.md/AUTHORS) file.
