...
*See also: [Restic's list of Linux backup software (⭐750)](https://github.com/restic/others)*
...
Contributing guidelines can be found [here (⭐1)](https://github.com/awesome-foss/awesome-sysadmin-data/blob/master/CONTRIBUTING.md).
