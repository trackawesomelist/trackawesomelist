...
*   [CheckCle](https://docs.checkcle.io) - Seamless, real-time monitoring of full-stack systems, applications, and infrastructure. ([Source Code (⭐3.3k)](https://github.com/operacle/checkcle)) `MIT` `Docker`
...
*   [Gluetun VPN client (⭐16k)](https://github.com/passteque/gluetun) - VPN client in a thin Docker container for multiple VPN providers, written in Go, and using OpenVPN or Wireguard, DNS over TLS, with a few proxy servers built-in. `MIT` `Docker`
...
*   [Shield (⭐402)](https://github.com/shieldproject/shield) - A pluggable architecture for backup and restore of database systems. `MIT` `Go`
...
*   [Portabase](https://portabase.io/) - Server dashboard tool that simplifies the backup and restoration of your database instances. ([Source Code (⭐1.8k)](https://github.com/Portabase/portabase)) `Apache-2.0` `Docker`
...
*   [FaynoSync](https://faynosync.com) - Self-hosted Dynamic Update Server with statistics, supporting multiple updaters. Flexible features for seamless app updates and insights. ([Source Code (⭐157)](https://github.com/ku9nov/faynoSync), [Clients (⭐5)](https://github.com/ku9nov/faynoSync-dashboard)) `Apache-2.0` `Docker/Go`
...
*   [Firezone](https://www.firezone.dev/) - WireGuard based VPN Server and Firewall. ([Source Code (⭐9.1k)](https://github.com/firezone/firezone)) `Apache-2.0` `Docker`
...
*   [EasyBuild](https://easybuild.io/) - EasyBuild builds software and modulefiles for High Performance Computing (HPC) systems in an efficient way. ([Source Code (⭐449)](https://github.com/easybuilders/easybuild-easyconfigs)) `GPL-2.0` `Python`
...
*   [netbox](https://netbox.dev/) - IP address management (IPAM) and data center infrastructure management (DCIM) tool. ([Demo](https://demo.netbox.dev/), [Source Code (⭐22k)](https://github.com/netbox-community/netbox)) `Apache-2.0` `Python`
...
*   [Webmin](https://www.webmin.com/) - Web-based interface for system administration for Unix. ([Source Code (⭐6.1k)](https://github.com/webmin/webmin)) `BSD-3-Clause` `Perl`
...
*   [CloudStack](https://cloudstack.apache.org/) - Cloud computing software for creating, managing, and deploying infrastructure cloud services. ([Source Code (⭐3.1k)](https://github.com/apache/cloudstack)) `Apache-2.0` `Java/Python`
...
*   [Fabric](https://www.fabfile.org/) - Python library and cli tool for streamlining the use of SSH for application deployment or systems administration tasks. ([Source Code (⭐16k)](https://github.com/fabric/fabric)) `BSD-2-Clause` `Python`
...
*   [Authentik](https://goauthentik.io/) - Flexible identity provider with support for different protocols. (OAuth 2.0, SAML, LDAP and Radius). ([Source Code (⭐26k)](https://github.com/goauthentik/authentik)) `MIT` `Python`
...
*   [Portainer Community Edition](https://www.portainer.io/) - Simple management UI for Docker. ([Source Code (⭐39k)](https://github.com/portainer/portainer)) `Zlib` `Go`
...
*   [fpm](https://fpm.readthedocs.io/en/latest/) - Versatile multi format package creator. ([Source Code (⭐12k)](https://github.com/jordansissel/fpm)) `MIT` `Ruby`
...
*   [Tiger VNC](https://tigervnc.org/) - High-performance, multi-platform VNC client and server. ([Source Code (⭐7.5k)](https://github.com/TigerVNC/tigervnc)) `GPL-2.0` `C++`
...
*   [389 Directory Server](https://www.port389.org/) - Enterprise-class Open Source LDAP server for Linux. ([Source Code (⭐294)](https://github.com/389ds/389-ds-base)) `GPL-3.0` `C`
...
*   [Woodpecker](https://woodpecker-ci.org/) - Community fork of Drone that uses Docker containers. ([Source Code (⭐7.9k)](https://github.com/woodpecker-ci/woodpecker)) `Apache-2.0` `Go`
...
*   [Docker Swarm](https://docs.docker.com/engine/swarm/) - Manage cluster of Docker Engines. ([Source Code (⭐3.7k)](https://github.com/moby/swarmkit)) `Apache-2.0` `Go`

## [Oct 31 - Nov 06, 2022](/content/2022/44/README.md)

### Software / Identity Management - Single Sign-On (SSO)

*   [KeyCloak](https://www.keycloak.org) - Open Source Identity and Access Management. ([Source Code (⭐37k)](https://github.com/keycloak/keycloak)) `Apache-2.0` `Java`
...
*   [Headscale (⭐44k)](https://github.com/juanfont/headscale) - Self-hostable fork of [Tailscale](https://tailscale.com), cross-platform clients, simple to use, built-in (currently experimental) monitoring tools. `BSD-3-Clause` `Go`
...
*   [GLPI](https://www.glpi-project.org/) - Information Resource-Manager with an additional Administration Interface. ([Source Code (⭐6.4k)](https://github.com/glpi-project/glpi)) `GPL-3.0` `PHP`
...
*   [Smallstep Certificates](https://smallstep.com/certificates/) - A private certificate authority (X.509 & SSH) and related tools for secure automated certificate management. ([Source Code (⭐8.9k)](https://github.com/smallstep/certificates)) `Apache-2.0` `Go`
...
*   [ImapSync](http://imapsync.lamiral.info/) - Simple IMAP migration tool for copying mailboxes to other servers. ([Source Code (⭐4.2k)](https://github.com/imapsync/imapsync)) `NLPL` `Perl`
...
*   [Chocolatey](https://chocolatey.org/) - The package manager for Windows. ([Source Code (⭐12k)](https://github.com/chocolatey/choco)) `Apache-2.0` `C#/PowerShell`
...
*   [Oxidized (⭐3.6k)](https://github.com/ytti/oxidized) - Network device configuration backup tool. `Apache-2.0` `Ruby`
...
*   [OpenVPN](https://community.openvpn.net) - Uses a custom security protocol that utilizes SSL/TLS for key exchange. ([Source Code (⭐15k)](https://github.com/OpenVPN/openvpn)) `GPL-2.0` `C`
