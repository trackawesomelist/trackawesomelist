...
*   [cloud-init](https://cloud-init.io/) - Initialization tool to automate the configuration of VMs, cloud instances, or machines on a network. ([Source Code (⭐3.3k)](https://github.com/canonical/cloud-init)) `GPL-3.0/Apache-2.0` `Python`

### Software / Monitoring

*   [Beszel](https://beszel.dev/) - Lightweight server monitoring platform that includes Docker statistics, historical data, and alert functions. ([Source Code (⭐13k)](https://github.com/henrygd/beszel)) `MIT` `Go`

## [Apr 07 - Apr 13, 2025](/content/2025/14/README.md)

### Software / Backups

*   [Backrest](https://garethgeorge.github.io/backrest/) - Backrest is a web UI and orchestrator for restic backup. ([Source Code (⭐3.3k)](https://github.com/garethgeorge/backrest)) `GPL-3.0` `Docker/Go`

### Software / Continuous Integration & Continuous Deployment

*   [Terrateam](https://terrateam.io) - GitOps-first automation platform for Terraform and OpenTofu workflows with support for self-hosted runners. ([Source Code (⭐810)](https://github.com/terrateamio/terrateam)) `MPL-2.0` `OCaml/Docker`

## [Aug 19 - Aug 25, 2024](/content/2024/34/README.md)

### Software / VPN

*   [Gluetun VPN client (⭐10k)](https://github.com/qdm12/gluetun) -  VPN client in a thin Docker container for multiple VPN providers, written in Go, and using OpenVPN or Wireguard, DNS over TLS, with a few proxy servers built-in.  `MIT` `docker`

## [Aug 05 - Aug 11, 2024](/content/2024/32/README.md)

### Software / VPN

*   [Firezone](https://www.firezone.dev/) - WireGuard based VPN Server and Firewall. ([Source Code (⭐7.4k)](https://github.com/firezone/firezone)) `Apache-2.0` `Docker`
...
*   [Wazuh](https://wazuh.com/) - Unified XDR and SIEM protection for endpoints and cloud workloads. ([Source Code (⭐13k)](https://github.com/wazuh/wazuh)) `GPL-2.0` `C`
...
*   [Coolify](https://coolify.io/) - An open-source & self-hostable Heroku / Netlify alternative (and even more). ([Source Code (⭐43k)](https://github.com/coollabsio/coolify)) `Apache-2.0` `Docker`
...
*   [Kubero](https://www.kubero.dev/) - A self-hosted Heroku PaaS alternative for Kubernetes that implements GitOps. ([Demo](https://demo.kubero.dev/), [Source Code (⭐3.6k)](https://github.com/kubero-dev/kubero)) `GPL-3.0` `K8S/Nodejs/Go`
*   [LocalStack](https://localstack.cloud/) - LocalStack is a fully functional local AWS cloud stack. This includes Lambda for serverless computation. ([Source Code (⭐60k)](https://github.com/localstack/localstack)) `Apache-2.0` `Python/Docker/K8S`
*   [Nhost](https://nhost.io/) - Firebase Alternative with GraphQL. Get a database and backend configured and ready in minutes. ([Source Code (⭐8.6k)](https://github.com/nhost/nhost)) `MIT` `Docker/Nodejs/Go`
...
*   [Tau](https://taubyte.com) - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging. ([Source Code (⭐4.1k)](https://github.com/taubyte/tau)) `BSD-3-Clause` `Go/Rust/Docker`
*   [Trusted-CGI (⭐240)](https://github.com/reddec/trusted-cgi) - Lightweight self-hosted lambda/applications/cgi/serverless-functions platform. `MIT` `Go/deb/Docker`

## [Mar 11 - Mar 17, 2024](/content/2024/11/README.md)

### Software / Configuration Management

*   [Rudder](https://www.rudder.io/) - Scalable and dynamic configuration management system for patching, security & compliance, based on CFEngine. ([Source Code (⭐568)](https://github.com/Normation/rudder)) `GPL-3.0` `Scala`
...
*   [openITCOCKPIT Community Edition](https://openitcockpit.io/) - Monitoring Suite featuring seamless integrations with Naemon, Checkmk, Grafana and more. ([Demo](https://demo.openitcockpit.io/), [Source Code (⭐297)](https://github.com/openITCOCKPIT/openITCOCKPIT)) `GPL-3.0` `deb/Docker`

## [Oct 30 - Nov 05, 2023](/content/2023/44/README.md)

### Software / Control Panels

*   [HestiaCP](https://hestiacp.com/) - Web server control panel (fork of VestaCP). ([Demo](https://demo.hestiacp.com:8083/login/), [Source Code (⭐3.9k)](https://github.com/hestiacp/hestiacp)) `GPL-3.0` `PHP/Shell/Other`

## [Sep 25 - Oct 01, 2023](/content/2023/39/README.md)

### Software / Automation

*   [Bolt](https://www.puppet.com/community/open-source/bolt) - You can use Bolt to run one-off tasks, scripts to automate the provisioning and management of some nodes, you can use Bolt to move a step beyond scripts, and make them shareable. ([Source Code (⭐528)](https://github.com/puppetlabs/bolt)) `Apache-2.0` `Ruby`

### Software / Build and software organization tools

*   [Environment Modules](https://cea-hpc.github.io/modules/) - Environment Modules provides for the dynamic modification of a user's environment via modulefiles. ([Source Code (⭐779)](https://github.com/cea-hpc/modules)) `GPL-2.0` `Tcl`
*   [Lmod](https://www.tacc.utexas.edu/research-development/tacc-projects/lmod) - Lmod is a Lua based module system that easily handles the MODULEPATH Hierarchical problem. ([Source Code (⭐546)](https://github.com/TACC/Lmod)) `MIT` `Lua`
...
*   [Ceph](https://ceph.com/en/) - Distributed object, block, and file storage platform. ([Source Code (⭐15k)](https://github.com/ceph/ceph)) `LGPL-3.0` `C++`
...
*   [glances](https://nicolargo.github.io/glances/) - Open-source, cross-platform real-time monitoring tool with CLI and web dashboard interfaces and many exporting options. ([Source Code (⭐29k)](https://github.com/nicolargo/glances)) `GPL-3.0` `Python`

## [Sep 04 - Sep 10, 2023](/content/2023/36/README.md)

### Software / Automation

*   [Apache Maven](https://maven.apache.org/) - Build automation tool mainly for Java. A software project management and comprehension tool. Based on the concept of a project object model (POM), Maven can manage a project's build, reporting and documentation from a central piece of information. ([Source Code (⭐4.7k)](https://github.com/apache/maven)) `Apache-2.0` `Java`
...
*   [EasyBuild](https://easybuild.io/) - EasyBuild builds software and modulefiles for High Performance Computing (HPC) systems in an efficient way. ([Source Code (⭐415)](https://github.com/easybuilders/easybuild-easyconfigs)) `GPL-2.0` `Python`

### Software / ChatOps

*   [Eggdrop](https://www.eggheads.org/) - The oldest Internet Relay Chat (IRC) bot still in active development. ([Source Code (⭐537)](https://github.com/eggheads/eggdrop)) `GPL-2.0` `C`
...
*   [Collins](https://tumblr.github.io/collins/) - At Tumblr, it's the infrastructure source of truth and knowledge. ([Source Code (⭐573)](https://github.com/tumblr/collins)) `Apache-2.0` `Docker/Scala`
...
*   [netbox](https://netbox.dev/) - IP address management (IPAM) and data center infrastructure management (DCIM) tool. ([Demo](https://demo.netbox.dev/), [Source Code (⭐18k)](https://github.com/netbox-community/netbox)) `Apache-2.0` `Python`
...
*   [Laminar](https://laminar.ohwg.net) - Fast, lightweight, simple and flexible Continuous Integration. ([Source Code (⭐323)](https://github.com/ohwgiles/laminar)) `GPL-3.0` `C++`
...
*   [Sentora](https://sentora.org/) - Open-Source Web hosting control panel for Linux, BSD (fork of ZPanel). ([Source Code (⭐670)](https://github.com/sentora/sentora-core)) `GPL-3.0` `PHP`
...
*   [Webmin](https://www.webmin.com/) - Web-based interface for system administration for Unix. ([Source Code (⭐5.1k)](https://github.com/webmin/webmin)) `BSD-3-Clause` `Perl`
...
*   [CloudStack](https://cloudstack.apache.org/) - Cloud computing software for creating, managing, and deploying infrastructure cloud services. ([Source Code (⭐2.5k)](https://github.com/apache/cloudstack)) `Apache-2.0` `Java/Python`
...
*   [Geany](https://www.geany.org/) - GTK2 text editor. ([Source Code (⭐3.3k)](https://github.com/geany/geany)) `GPL-2.0` `C/C++`
*   [GNU Emacs](https://www.gnu.org/software/emacs/) - An extensible, customizable text editor-and more. ([Source Code (⭐4.7k)](https://github.com/emacs-mirror/emacs)) `GPL-3.0` `C`
...
*   [VSCodium](https://vscodium.com/) - An open source cross-platform extensible code editor based on [VS Code by Microsoft](https://code.visualstudio.com/) removing their non-free additions. ([Source Code (⭐28k)](https://github.com/VSCodium/vscodium)) `MIT` `TypeScript`

### Software / Identity Management - Tools and web interfaces

*   [ZITADEL](https://zitadel.com/) - Cloud-native Identity & Access Management solution providing a platform for secure authentication, authorization and identity management. ([Source Code (⭐11k)](https://github.com/zitadel/zitadel)) `Apache-2.0` `Go/Docker/K8S`
...
*   [RackTables](https://racktables.org/) - Datacenter and server room asset management like document hardware assets, network addresses, space in racks, networks configuration. ([Demo](https://www.racktables.org/demo.php), [Source Code (⭐778)](https://github.com/RackTables/racktables)) `GPL-2.0` `PHP`

### Software / Mail Clients

*   [Sylpheed](https://sylpheed.sraoss.jp/en/) - Still developed predecessor to Claws Mail, lightweight mail client. ([Source Code (⭐150)](https://github.com/sylpheed-mail/sylpheed)) `GPL-2.0` `C`
...
*   [phpList](https://www.phplist.org/) - Newsletter and email marketing software. ([Source Code (⭐798)](https://github.com/phpList/phplist3)) `AGPL-3.0` `PHP`
...
*   [LibreNMS](https://www.librenms.org) - Fully featured network monitoring system that provides a wealth of features and device support. ([Source Code (⭐4.3k)](https://github.com/librenms/librenms)) `GPL-3.0` `PHP`
...
*   [Naemon](https://www.naemon.org/) - Network monitoring tool based on the Nagios 4 core with performance enhancements and new features. ([Source Code (⭐161)](https://github.com/naemon/naemon-core)) `GPL-2.0` `C`
...
*   [Thruk](https://www.thruk.org/) - Multibackend monitoring web interface with support for Naemon, Nagios, Icinga and Shinken. ([Source Code (⭐422)](https://github.com/sni/Thruk)) `GPL-1.0` `Perl`
...
*   [phpIPAM](https://phpipam.net/) - Open source IP address management with PowerDNS integration. ([Source Code (⭐2.5k)](https://github.com/phpipam/phpipam)) `GPL-3.0` `PHP`
*   [RANCID](https://www.shrubbery.net/rancid/) - Monitor network devices configuration and maintain history of changes. ([Source Code (⭐126)](https://github.com/haussli/rancid)) `BSD-3-Clause` `Perl/Shell`
*   [rConfig](https://www.rconfig.com/) - Network device configuration management tool. ([Source Code (⭐138)](https://github.com/rconfig/rconfig)) `GPL-3.0` `PHP`
...
*   [mitmproxy](https://mitmproxy.org/) - A Python tool used for intercepting, viewing and modifying network traffic. Invaluable in troubleshooting certain problems. ([Source Code (⭐40k)](https://github.com/mitmproxy/mitmproxy)) `MIT` `Python`
...
*   [Git](https://git-scm.com/) - Distributed revision control and source code management (SCM) with an emphasis on speed. ([Source Code (⭐56k)](https://github.com/git/git)) `GPL-2.0` `C`
...
*   [Ganeti](https://www.ganeti.org/) - Cluster virtual server management software tool built on top of KVM and Xen. ([Source Code (⭐545)](https://github.com/ganeti/ganeti)) `BSD-2-Clause` `Python/Haskell`
...
*   [Ansible](https://www.ansible.com/) - Provisioning, configuration management, and application-deployment tool. ([Source Code (⭐66k)](https://github.com/ansible/ansible)) `GPL-3.0` `Python`
*   [Chef](https://www.chef.io/products/chef-infra) - Configuration management tool using a pure-Ruby, domain-specific language (DSL) for writing system configuration "recipes". ([Source Code (⭐7.9k)](https://github.com/chef/chef)) `Apache-2.0` `Ruby`
...
*   [Kroki](https://kroki.io) - API for generating diagrams from textual descriptions. ([Source Code (⭐3.3k)](https://github.com/yuzutech/kroki)) `MIT` `Java`

## [Jul 10 - Jul 16, 2023](/content/2023/28/README.md)

### Software / Identity Management - Single Sign-On (SSO)

*   [Authentik](https://goauthentik.io/) - Flexible identity provider with support for different protocols. (OAuth 2.0, SAML, LDAP and Radius). ([Source Code (⭐17k)](https://github.com/goauthentik/authentik)) `MIT` `Python`

## [Jul 03 - Jul 09, 2023](/content/2023/27/README.md)

### Software / Service Discovery

*   [etcd](https://etcd.io/) - Distributed K/V-Store, authenticating via SSL PKI and a REST HTTP Api for shared configuration and service discovery. ([Source Code (⭐50k)](https://github.com/coreos/etcd)) `Apache-2.0` `Go`
...
*   [Portainer Community Edition](https://www.portainer.io/) - Simple management UI for Docker. ([Source Code (⭐34k)](https://github.com/portainer/portainer)) `Zlib` `Go`
...
*   [Barman](https://pgbarman.org) - Backup and Recovery Manager for PostgreSQL. ([Source Code (⭐2.4k)](https://github.com/EnterpriseDB/barman)) `GPL-3.0` `Python`
...
*   [UrBackup](https://www.urbackup.org/) - Client/Server Open Source Network Backup for Windows, MacOS and Linux. ([Source Code (⭐744)](https://github.com/uroni/urbackup_backend)) `AGPL-3.0` `C/C++`
...
*   [SPF Toolbox](https://spftoolbox.com) - Application to look up DNS records such as SPF, MX, Whois, and more. ([Source Code (⭐283)](https://github.com/charlesabarnes/SPFtoolbox)) `MIT` `PHP`

### Software / Monitoring

*   [ruptime (⭐173)](https://github.com/alexmyczko/ruptime) - Classic system status server. `AGPL-3.0` `Shell`
...
*   [Tiger VNC](https://tigervnc.org/) - High-performance, multi-platform VNC client and server. ([Source Code (⭐6.2k)](https://github.com/TigerVNC/tigervnc)) `GPL-2.0` `C++`
...
*   [pfSense CE](https://www.pfsense.org/) - Free network firewall distribution, based on the FreeBSD operating system with a custom kernel and including third party free software packages for additional functionality. ([Source Code (⭐5.3k)](https://github.com/pfsense/pfsense)) `Apache-2.0` `Shell/PHP/Other`

## [Jun 12 - Jun 18, 2023](/content/2023/24/README.md)

### Software / Distributed Filesystems

*   [DRBD](https://linbit.com/drbd/) - Distributed replicated storage system, implemented as a Linux kernel driver. ([Source Code (⭐622)](https://github.com/LINBIT/drbd)) `GPL-2.0` `C`
*   [GlusterFS](https://www.gluster.org/) - Software-defined distributed storage that can scale to several petabytes, with interfaces for object, block and file storage. ([Source Code (⭐5k)](https://github.com/gluster/glusterfs)) `GPL-2.0/LGPL-3.0` `C`
...
*   [Minio](https://min.io/) - High-performance, S3 compatible object store built for large scale AI/ML, data lake and database workloads. ([Source Code (⭐54k)](https://github.com/minio/minio)) `AGPL-3.0` `Go`
...
*   [XtreemFS](https://www.xtreemfs.org/) - Distributed, replicated and fault-tolerant file system for federated IT infrastructures.. ([Source Code (⭐341)](https://github.com/xtreemfs/xtreemfs)) `BSD-3-Clause` `Java`
...
*   [Grafana](https://grafana.com/) - A Graphite & InfluxDB Dashboard and Graph Editor. ([Source Code (⭐69k)](https://github.com/grafana/grafana)) `AGPL-3.0` `Go`
...
*   [Prometheus](https://prometheus.io/) - Service monitoring system and time series database. ([Source Code (⭐60k)](https://github.com/prometheus/prometheus)) `Apache-2.0` `Go`

## [May 01 - May 07, 2023](/content/2023/18/README.md)

### Software / DNS - Control Panels & Domain Management

*   [Poweradmin](https://www.poweradmin.org/) - Web-based DNS control panel for PowerDNS server. ([Source Code (⭐711)](https://github.com/poweradmin/poweradmin)) `GPL-3.0` `PHP`
...
*   [NSD](https://www.nlnetlabs.nl/projects/nsd/about/) - Authoritative DNS name server developed speed, reliability, stability and security. ([Source Code (⭐496)](https://github.com/NLnetLabs/nsd)) `BSD-3-Clause` `C`
*   [PowerDNS Authoritative Server](https://doc.powerdns.com/authoritative/) - Versatile nameserver which supports a large number of backends. ([Source Code (⭐4k)](https://github.com/PowerDNS/pdns)) `GPL-2.0` `C++`
*   [Unbound](https://nlnetlabs.nl/projects/unbound/about/) - Validating, recursive, and caching DNS resolver. ([Source Code (⭐3.7k)](https://github.com/NLnetLabs/unbound)) `BSD-3-Clause` `C`
...
*   [dashdot (⭐3k)](https://github.com/MauriceNino/dashdot) - A simple, modern server dashboard for smaller private servers. ([Demo](https://dash.mauz.dev/)) `MIT` `Nodejs/Docker`
...
*   [389 Directory Server](https://www.port389.org/) - Enterprise-class Open Source LDAP server for Linux. ([Source Code (⭐243)](https://github.com/389ds/389-ds-base)) `GPL-3.0` `C`
*   [Apache Directory Server](https://directory.apache.org/apacheds/) - Extensible and embeddable directory server, certified LDAPv3 compatible, with Kerberos 5 and Change Password Protocol support, triggers, stored procedures, queues and views. ([Source Code (⭐161)](https://github.com/apache/directory-server)) `Apache-2.0` `Java`
...
*   [FreeRADIUS](https://freeradius.org/) - Multi-protocol policy server (radiusd) that implements RADIUS, DHCP, BFD, and ARP and associated client/PAM library/Apache module. ([Source Code (⭐2.3k)](https://github.com/FreeRADIUS/freeradius-server)) `GPL-2.0` `C`
*   [lldap (⭐5.2k)](https://github.com/nitnelave/lldap) - Light (simplified) LDAP implementation with a simple, intuitive web interface and GraphQL support. `GPL-3.0` `Rust`
...
*   [Dar](http://dar.linux.free.fr/) - Which stands for Disk ARchive, is a robust and rich featured archiving and backup software of the tar style. ([Source Code (⭐154)](https://github.com/Edrusb/DAR)) `GPL-2.0` `C++`

### Software / Identity Management - Single Sign-On (SSO)

*   [Authelia](https://www.authelia.com/) - The Single Sign-On Multi-Factor portal for web apps. ([Source Code (⭐25k)](https://github.com/authelia/authelia)) `Apache-2.0` `Go`

### Software / Monitoring

*   [Status (⭐259)](https://github.com/dani3l0/Status) - Simple and lightweight system monitoring tool for small homeservers with a pleasant web interface. ([Demo](https://status.enshittification.social/) `MIT` `Python`

### Software / Software Containers

*   [Podman](https://podman.io) - Daemonless container engine for developing, managing, and running OCI Containers on your Linux System. Containers can either be run as root or in rootless mode. Simply put: `alias docker=podman`. ([Source Code (⭐28k)](https://github.com/containers/podman)) `Apache-2.0` `Go`
...
*   [Healthchecks](https://healthchecks.io/docs/self_hosted/) - Monitoring for cron jobs, background services and scheduled tasks. ([Source Code (⭐9.2k)](https://github.com/healthchecks/healthchecks)) `BSD-3-Clause` `Python`
...
*   [Woodpecker](https://woodpecker-ci.org/) - Community fork of Drone that uses Docker containers. ([Source Code (⭐5.2k)](https://github.com/woodpecker-ci/woodpecker)) `Apache-2.0` `Go`
...
*   [DNSControl](https://stackexchange.github.io/dnscontrol/) - Synchronize your DNS to multiple providers from a simple DSL. ([Source Code (⭐3.4k)](https://github.com/StackExchange/dnscontrol)) `MIT` `Go/Docker`
...
*   [LXD](https://linuxcontainers.org/lxd/) - Container "hypervisor" and a better UX for LXC. ([Source Code (⭐3.8k)](https://github.com/lxc/lxd)) `Apache-2.0` `Go`

## [Oct 31 - Nov 06, 2022](/content/2022/44/README.md)

### Software / Identity Management - Single Sign-On (SSO)

*   [KeyCloak](https://www.keycloak.org) - Open Source Identity and Access Management. ([Source Code (⭐28k)](https://github.com/keycloak/keycloak)) `Apache-2.0` `Java`

## [Oct 03 - Oct 09, 2022](/content/2022/40/README.md)

### Software / Editors

*   [Atom Community (⭐757)](https://github.com/atom-community/atom) - A fork of [atom (⭐61k)](https://github.com/atom/atom) A hackable text editor from Github. `MIT` `JavaScript`
...
*   [checkmk](https://checkmk.com/) - Comprehensive solution for monitoring of applications, servers, and networks. ([Source Code (⭐1.9k)](https://github.com/Checkmk/checkmk)) `GPL-2.0` `Python/PHP`
...
*   [Snipe IT](https://snipeitapp.com/) - Asset & license management software. ([Source Code (⭐12k)](https://github.com/snipe/snipe-it)) `AGPL-3.0` `PHP`

## [Jul 11 - Jul 17, 2022](/content/2022/28/README.md)

### Software / Monitoring

*   [Scrutiny (⭐6.4k)](https://github.com/AnalogJ/scrutiny) - Web UI for hard drive S.M.A.R.T monitoring, historical trends & real-world failure thresholds. `MIT` `Go`

## [May 23 - May 29, 2022](/content/2022/21/README.md)

### Software / VPN

*   [Headscale (⭐30k)](https://github.com/juanfont/headscale) - Self-hostable fork of [Tailscale](https://tailscale.com), cross-platform clients, simple to use, built-in (currently experimental) monitoring tools. `BSD-3-Clause` `Go`
...
*   [Loki](https://grafana.com/oss/loki/) - Log aggregation system designed to store and query logs from all your applications and infrastructure. ([Source Code (⭐26k)](https://github.com/grafana/loki)) `AGPL-3.0` `Go`
...
*   [Diagrams.net](https://app.diagrams.net/) - A.K.A. [Draw.io](https://app.diagrams.net/). Easy to use Diagram UI with a plethora of templates. ([Source Code (⭐1.9k)](https://github.com/jgraph/drawio)) `Apache-2.0` `JavaScript/Docker`

## [May 11 - May 17, 2020](/content/2020/19/README.md)

### Software / Diagramming

*   [Mermaid](https://mermaid-js.github.io/mermaid-live-editor/) - Javascript module with a unique, easy, shorthand syntax. Integrates into several other tools like Grafana. ([Source Code (⭐5.2k)](https://github.com/mermaid-js/mermaid-live-editor)) `MIT` `Nodejs/Docker`
...
*   [octoDNS (⭐3.4k)](https://github.com/github/octodns) - DNS as code - Tools for managing DNS across multiple providers. `MIT` `Python`

### Software / IT Asset Management

*   [GLPI](https://www.glpi-project.org/) - Information Resource-Manager with an additional Administration Interface. ([Source Code (⭐5k)](https://github.com/glpi-project/glpi)) `GPL-3.0` `PHP`

## [Nov 11 - Nov 17, 2019](/content/2019/45/README.md)

### Software / Build and software organization tools

*   [Spack](https://spack.io/) - A flexible package manager that supports multiple versions, configurations, platforms, and compilers. ([Source Code (⭐4.7k)](https://github.com/spack/spack)) `MIT/Apache-2.0` `Python`

## [Nov 04 - Nov 10, 2019](/content/2019/44/README.md)

### Software / Monitoring

*   [Netdata](https://www.netdata.cloud/) - Distributed, real-time, performance and health monitoring for systems and applications. Runs on Linux, FreeBSD, and MacOS. ([Source Code (⭐75k)](https://github.com/netdata/netdata)) `GPL-3.0` `C`

## [Sep 23 - Sep 29, 2019](/content/2019/38/README.md)

### Software / Identity Management - Tools and web interfaces

*   [Smallstep Certificates](https://smallstep.com/certificates/) - A private certificate authority (X.509 & SSH) and related tools for secure automated certificate management. ([Source Code (⭐7.4k)](https://github.com/smallstep/certificates)) `Apache-2.0` `Go`
...
*   [Pomerium](https://www.pomerium.io/) - An identity and context aware access-proxy inspired by BeyondCorp. ([Source Code (⭐4.3k)](https://github.com/pomerium/pomerium)) `Apache-2.0` `Docker/Go`
...
*   [PHP Censor (⭐684)](https://github.com/php-censor/php-censor) - Open source self-hosted continuous integration server for PHP projects. `BSD-2-Clause` `PHP`

## [Feb 18 - Feb 24, 2019](/content/2019/7/README.md)

### Software / Monitoring

*   [NetXMS](https://www.netxms.org/) - Open Source network and infrastructure monitoring and management. ([Source Code (⭐282)](https://github.com/netxms/netxms)) `LGPL-3.0/GPL-3.0` `Java/C++/C`
...
*   [Restic](https://restic.net/) - Easy, fast, verifiable, secure and efficient remote backup tool. ([Source Code (⭐29k)](https://github.com/restic/restic)) `BSD-2-Clause` `Go`
...
*   [rclone](https://rclone.org/) - Command-line program to sync files and directories to and from different cloud storage providers.. ([Source Code (⭐51k)](https://github.com/rclone/rclone)) `MIT` `Go`
...
*   [Apache Ant](https://ant.apache.org/) - Automation build tool, similar to make, a library and command-line tool whose mission is to drive processes described in build files as targets and extension points dependent upon each other. ([Source Code (⭐440)](https://github.com/apache/ant)) `Apache-2.0` `Java`

### Software / Backups

*   [Shield (⭐386)](https://github.com/starkandwayne/shield) - A pluggable architecture for backup and restore of database systems. `MIT` `Go`
...
*   [CFEngine](https://cfengine.com/) - Configuration management system for automated configuration and maintenance of large-scale computer systems. ([Source Code (⭐504)](https://github.com/cfengine/core)) `GPL-3.0` `C`
...
*   [Genesis (⭐60)](https://github.com/starkandwayne/genesis) - A template framework for multi-environment BOSH deployments. `MIT` `Perl`
...
*   [DomainMOD](https://domainmod.org) - Manage your domains and other internet assets in a central location. ([Source Code (⭐534)](https://github.com/domainmod/domainmod)) `GPL-3.0` `PHP`
...
*   [Notepad++](https://notepad-plus-plus.org/) - GPLv2 multi-language editor with syntax highlighting for Windows. ([Source Code (⭐25k)](https://github.com/notepad-plus-plus/notepad-plus-plus)) `GPL-2.0` `C++`
...
*   [Fusion Directory](https://www.fusiondirectory.org) - Improve the Management of the services and the company directory based on OpenLDAP. ([Source Code (⭐178)](https://github.com/fusiondirectory/fusiondirectory)) `GPL-2.0` `PHP`
*   [LDAP Account Manager (LAM)](https://www.ldap-account-manager.org/lamcms/) - Web frontend for managing entries (e.g. users, groups, DHCP settings) stored in an LDAP directory. ([Source Code (⭐453)](https://github.com/LDAPAccountManager/lam/)) `GPL-3.0` `PHP`
...
*   [ImapSync](http://imapsync.lamiral.info/) - Simple IMAP migration tool for copying mailboxes to other servers. ([Source Code (⭐3.7k)](https://github.com/imapsync/imapsync)) `NLPL` `Perl`
...
*   [Fog](https://www.fogproject.org/) - Cloning/imaging solution/rescue suite. ([Source Code (⭐1.3k)](https://github.com/FOGProject/fogproject)) `GPL-3.0` `PHP/Shell`
...
*   [Nagios](https://www.nagios.org/) - Computer system, network and infrastructure monitoring software application. ([Source Code (⭐1.7k)](https://github.com/NagiosEnterprises/nagioscore)) `GPL-2.0` `C`
...
*   [GNS3](https://www.gns3.com/) - Graphical network simulator that provides a variety of virtual appliances. ([Source Code (⭐2.4k)](https://github.com/GNS3/gns3-gui/)) `GPL-3.0` `Python`
*   [Oxidized (⭐3k)](https://github.com/ytti/oxidized) - Network device configuration backup tool. `Apache-2.0` `Ruby`
...
*   [tito (⭐391)](https://github.com/dgoodwin/tito) - Builds RPMs for git-based projects. `GPL-2.0` `Python`

### Software / Queuing

*   [ActiveMQ](https://activemq.apache.org/) - Java message broker. ([Source Code (⭐2.4k)](https://github.com/apache/activemq)) `Apache-2.0` `Java`
*   [Gearman](http://gearman.org/) - Fast multi-language queuing/job processing platform. ([Source Code (⭐749)](https://github.com/gearman/gearmand)) `BSD-3-Clause` `C++`
...
*   [LXC](https://linuxcontainers.org/lxc/) - Userspace interface for the Linux kernel containment features. ([Source Code (⭐4.9k)](https://github.com/lxc/lxc)) `GPL-2.0` `C`
...
*   [strongSwan](https://www.strongswan.org/) - Complete IPsec implementation for Linux. ([Source Code (⭐2.6k)](https://github.com/strongswan/strongswan)) `GPL-2.0` `C`
