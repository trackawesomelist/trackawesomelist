...
*   [Vitesse Starter (⭐7.4k)](https://github.com/antfu/vitesse) ⛺️ Vue 3 starter inclode ( Layouts | i18n | UnoCSS | pinia | Markdown | Dark Mode | PWA | SSG | Component Auto-Importing | File-Based Router | Composition API | TypeScript)
*   [Vitesse-lite Starter (⭐833)](https://github.com/antfu/vitesse-lite) ⛺️ Lightweight version of Vitesse (Vue 3 Starter)
...
*   [Vutron (⭐78)](https://github.com/jooy2/vutron) - Quick start templates for Vite + Electron + Vue 3 + Vuetify + TypeScript.
...
*   [vue-facing-decorator (⭐183)](https://github.com/facing-dev/vue-facing-decorator) - Vue 3 typescript class component decorators, like `vue-property-decorator` in Vue 2.
...
*   [Snippets.Ninja (⭐87)](https://github.com/dd3v/snippets.ninja) - Progressive web application for code snippet management. Offline first. Open Source. App uses IndexedDB for local storage.
...
*   [AnySniper (⭐26)](https://github.com/anysniper/Frontend) - Sniping DApp on Decentralized Exchanges. A proven blockchain sniping bot with 500 active users.
...
*   [vorms (⭐156)](https://github.com/Mini-ghost/vorms) - Vue Form Validate with Composition API.
...
*   [Anu (⭐742)](https://github.com/jd-solanki/anu) - Build better interfaces faster. DX focused utility based vue component library ⚛️
...
*   [vue-input-facade (⭐156)](https://github.com/RonaldJerez/vue-input-facade) - A lightweight and dependency free input masking library created specific for Vue, originally a fork of the famous *vue-text-mask* but actively maintained and with lots of improvements after there.
...
*   [sortablejs-vue3 (⭐230)](https://github.com/MaxLeiter/sortablejs-vue3) - A Vue 3 component acting as a thin wrapper around SortableJS
...
*   [vue3-easy-data-table (⭐341)](https://github.com/HC200ok/vue3-easy-data-table) - A easy-to-use data table component made with Vue.js 3.x, referring to the API and UI of data table component in Vuetify 2.
...
*   [vue3-dnd (⭐208)](https://github.com/hcg1023/vue3-dnd) - React DnD in Composition API implementation, Use the Composition API for sortable and free draggable, Supported Vue2, Vue3.
...
*   [Bagisto (⭐6k)](https://github.com/bagisto/bagisto) - A Free and Opensource Laravel eCommerce framework built for all to build and scale your business.
...
*   [vue-material-design-icons (⭐130)](https://github.com/robcresswell/vue-material-design-icons "vue-material-design-icons on GitHub") - A collection of SVG Material Design icons as single file components.
...
*   [simple-vue-camera (⭐37)](https://github.com/BastiaanJansen/simple-vue-camera) - A simple to use, but extensive, camera component for Vue 3 with Typescript support to create great camera experiences.
...
*   [awesome-image (⭐63)](https://github.com/newbeea/awesome-image) - An universal image component for Vue2 / Vue3 / Nuxt with Lazyload / Responsive / Progressive / Auto-WebP / WebGL Filter / WebGL Transition supported.
...
*   [vue-icons (⭐23)](https://github.com/kalimah-apps/vue-icons) - More than 11,000 icons from most popular icon libraries (bootstrap, fontawesome, feather .. etc)
...
*   [vue-json-viewer (⭐481)](https://github.com/chenfengjw163/vue-json-viewer) - A JSON Tree View Support for incremental update components, base on Vue2 and Vue3.

### Components & Libraries / Utilities

*   [tolgee/vue (⭐187)](https://github.com/tolgee/tolgee-js/tree/main/packages/vue) - Web-based localization tool enabling users to translate directly in the Vue 3 app they develop.
...
*   [vue-request (⭐909)](https://github.com/Attojs/vue-request) - ⚡️ Vue 3 Composable for data fetching, supports SWR, polling, error retry, cache request, pagination, and other cool features.
...
*   [vue-stripe-js (⭐98)](https://github.com/ectoflow/vue-stripe-js) - Vue 3 components for Stripe.js
...
*   [vue-dapp (⭐152)](https://github.com/chnejohnson/vue-dapp) - Vue 3 library for building Dapps with ethers.js.
...
*   [Interface X (⭐64)](https://github.com/empathyco/x) - UI Search\&Discovery components to rapidly build beautiful search experiences
...
*   [v-network-graph (⭐318)](https://github.com/dash14/v-network-graph) - An interactive SVG based network-graph visualization component for Vue 3.

## [Aug 07, 2021](/content/2021/08/07/README.md)

### Components & Libraries / UI Components

*   [vue-word-highlighter (⭐149)](https://github.com/kawamataryo/vue-word-highlighter) - The word highlighter library for Vue 2 and Vue 3.
...
*   [vue-datepicker-ui (⭐417)](https://github.com/edisdev/vue-datepicker-ui) - A datepicker component for vue.js
...
*   [vue3-circle-progress (⭐23)](https://github.com/delowardev/vue3-circle-progress) - Highly customizable Vue.js 3 circular progressbar component.

## [Aug 02, 2021](/content/2021/08/02/README.md)

### Components & Libraries / UI Components

*   [pdfvuer (⭐826)](https://github.com/arkokoley/pdfvuer) - A PDF viewer for Vue using Mozilla's PDF.js with text support for Vue2 and Vue3. [Demo](https://arkokoley.github.io/pdfvuer/)
...
*   [GrandNode 2.0 (⭐753)](https://github.com/grandnode/grandnode2/) - Open Source Cross Platform E-Commerce Solution based on .NET Core 5.0 and MongoDB / Azure CosmosDB / Amazon DocumentDB / VueJS

## [Jun 05, 2021](/content/2021/06/05/README.md)

### Components & Libraries / UI Components

*   [vue-pdf-embed (⭐301)](https://github.com/hrynko/vue-pdf-embed) - PDF embed component for Vue 2 and Vue 3
...
*   [@kyvg/vue3-notification (⭐248)](https://github.com/kyvg/vue3-notification) - Vue 3 notification library
...
*   [vue3-tabs-chrome (⭐76)](https://github.com/viewweiwu/vue3-tabs-chrome) - A Vue3 component for Chrome-like tabs.
...
*   [vite-svg-loader (⭐371)](https://github.com/jpkleemans/vite-svg-loader) - Vite plugin to load SVG files as Vue components
...
*   [vue-notion (⭐769)](https://github.com/janniks/vue-notion) - An unofficial Notion renderer – Use Notion as a CMS for Vue (e.g. Nuxt)
...
*   [Shopify Theme Lab (⭐655)](https://github.com/uicrooks/shopify-theme-lab) - Shopify theme development starter using Vue, Vuex and Tailwind CSS
...
*   [vue-datasource (⭐424)](https://github.com/coderdiaz/vue-datasource) - A vue.js server-side component to create dynamic tables.
...
*   [vue-file-agent (⭐713)](https://github.com/safrazik/vue-file-agent) - Full-featured drag & drop enabled Vue file upload component with previews and upload progress
...
*   [Wave UI (⭐464)](https://github.com/antoniandre/wave-ui) - An emerging UI framework for Vue.js with only the bright side. ☀️

## [Sep 08, 2020](/content/2020/09/08/README.md)

### Components & Libraries / UI Components

*   [vue-router-tab (⭐437)](https://github.com/bhuh12/vue-router-tab) - Vue.js tab components, based on Vue Router.
...
*   [vue-concurrency (⭐282)](https://github.com/MartinMalinda/vue-concurrency) - library for encapsulating asynchronous operations and managing concurrency for Vue and Composition API.
...
*   [vue.js 与 laravel 结合的前后端分离开发模板 (⭐909)](https://github.com/wmhello/laravel_template_with_vue)- A template website to laravel passport / Vue.JS & Element UI.
...
*   [brain bits (⭐165)](https://github.com/dashersw/brain-bits) - A P300 online spelling mechanism for Emotiv headsets
...
*   [HappyPlants (⭐254)](https://github.com/morkro/happy-plants) - A progressive web app for organizing your plants 🌱.
...
*   [vue-crud-x (⭐446)](https://github.com/ais-one/vue-crud-x) - Extensible crud component using Vuetify layout, other than the usual page, sort, filter, it is able to do nested CRUD, custom forms, filters, operations.
*   [Vue Datatable (⭐625)](https://github.com/laravel-enso/vuedatatable) - VueJS powered Datatable with Laravel server-side loading and JSON template setup
...
*   [el-data-table (⭐469)](https://github.com/FEMessage/el-data-table) - base on element-ui, makes crud easily
...
*   [@marketconnect/vue-pivot-table (⭐216)](https://github.com/MarketConnect/vue-pivot-table) - A vue component for pivot table
...
*   [vue-jd-table (⭐77)](https://github.com/jamesdruhan/vue-jd-table) - Advanced and flexible data table component for Vue 2. Feature Rich: search, filtering, exporting, pagination (traditional and virtual scroll) and so much more!
...
*   [vue-toast-notification (⭐483)](https://github.com/ankurk91/vue-toast-notification) - Yet another Vue.js Toast notification plugin.
*   [VueToastify (⭐190)](https://github.com/nandi95/vue-toastify) - A fuss free notification component.
...
*   [vue-radial-progress (⭐482)](https://github.com/wyzant-dev/vue-radial-progress) - Radial progress bar component for Vue.js.
*   [vue-simple-spinner (⭐423)](https://github.com/dzwillia/vue-simple-spinner) - A simple, flexible spinner for Vue.js
...
*   [vue-ellipse-progress (⭐275)](https://github.com/setaman/vue-ellipse-progress) - A flexible Vue.js component to create beautiful animated circular progress bars and loaders
...
*   [vue-country-flag (⭐144)](https://github.com/P3trur0/vue-country-flag) - Vue component for country flag icons
...
*   [vue-eva-icons (⭐195)](https://github.com/antonreshetov/vue-eva-icons) - Simply beautiful open source eva icons as Vue components.
...
*   [vue-cryptoicon (⭐95)](https://github.com/man15h/vue-cryptoicon) - Beautiful pixel perfect 400+ cryptocurrency and 10+ Fiat currency icon.
...
*   [vue-drawer-layout (⭐407)](https://github.com/hjl19911127/vue-drawer-layout) - A simple DrawerLayout component like Android has for Vue.js.
...
*   [vue-stripe-menu (⭐502)](https://github.com/Alexeykhr/vue-stripe-menu) - Creating a navigation menu with animations like on Stripe
...
*   [vue-carousel-3d (⭐926)](https://github.com/wlada/vue-carousel-3d) - Vue Carousel 3D - Beautiful, flexible and touch supported 3D Carousel for Vue.js.
...
*   [vue-slick-carousel (⭐750)](https://github.com/gs-shop/vue-slick-carousel) - A carousel with slick features & SSR support written for faster Luxstay
...
*   [vue-d3-network (⭐488)](https://github.com/emiliorizzo/vue-d3-network) - Vue component to graph networks using d3-force
...
*   [vue-chartkick (⭐745)](https://github.com/ankane/vue-chartkick) - Create beautiful JavaScript charts with one line of Vue
...
*   [vue-google-charts (⭐434)](https://github.com/devstark-com/vue-google-charts) - Reactive Vue.js wrapper for Google Charts lib
...
*   [vue-functional-calendar (⭐434)](https://github.com/ManukMinasyan/vue-functional-calendar) - Lightweight, high performance calendar component(Date Picker, Date Range) based on Vue.
*   [vue-cal (⭐1k)](https://github.com/antoniandre/vue-cal) - A Vue JS full calendar, no dependency, no BS. 🤘.
*   [vue-material-year-calendar (⭐119)](https://github.com/nono1526/vue-material-year-calendar) - A full year (12 months on a page) calendar for Vue2. Uses dayjs.
...
*   [vuelayers (⭐673)](https://github.com/ghettovoice/vuelayers) - Vue 2 components to work with OpenLayers.
...
*   [vue-mapbox (⭐433)](https://github.com/soal/vue-mapbox) - Vue 2.x wrapper around Mapbox GL JS library that provides vueish-way to interact with the map.
...
*   [vue-dplayer (⭐611)](https://github.com/sinchang/vue-dplayer) - A Vue 2.x video player component based on DPlayer.
...
*   [vue-audio-visual (⭐585)](https://github.com/staskobzar/vue-audio-visual) - Vue HTML5 audio visualization components.
*   [vue-plyr (⭐718)](https://github.com/redxtech/vue-plyr) - A set of Vue components for the plyr video & audio player.
...
*   [vue-responsive-video-background-player (⭐246)](https://github.com/avidofood/vue-responsive-video-background-player) - Play your own videos in background responsively in different resolutions.
...
*   [vue-core-video-player (⭐400)](https://github.com/core-player/vue-core-video-player) - A Lightweight Video Player For Vue.js
*   [vue-player (⭐22)](https://github.com/algoz098/vue-player) - A simple html5 video player with img placeholder for Vue 2.x.
*   [vue-audio-better (⭐110)](https://github.com/forijk/vue-audio-better) - Easy to create custom audio player components for Vue 2.x. A progress bar with soul.
...
*   [vue-simplemde (⭐765)](https://github.com/F-loat/vue-simplemde) - A wrapper around [simplemde (⭐9.4k)](https://github.com/sparksuite/simplemde-markdown-editor). Delightful editing for beginners and experts alike. Features built-in autosaving and spell checking.
*   [vue-pdf (⭐2k)](https://github.com/FranckFreiburger/vue-pdf) - A pdf viewer based on mozilla's PDF.js
*   [Vue.D3.tree (⭐835)](https://github.com/David-Desmaisons/Vue.D3.tree) - A Tree View based on [D3.js](https://d3js.org/)
*   [vue-json-tree-view (⭐462)](https://github.com/arvidkahl/vue-json-tree-view) - A JSON Tree View Component for Vue.js.
*   [vue-tree (⭐929)](https://github.com/halower/vue2-tree) - A Tree Component for Vue.js 2.X.
*   [liquor-tree (⭐385)](https://github.com/amsik/liquor-tree) - Amazing Vue Tree component
...
*   [vuejs-tree (⭐314)](https://github.com/scalia/vuejs-tree) - A highly customizable VueJs tree viewer
*   [vue-jstree (⭐583)](https://github.com/zdy1988/vue-jstree) - A Tree Plugin For Vue2 with beautiful icons and drag\&drop
...
*   [vue-tree-list (⭐466)](https://github.com/ParadeTo/vue-tree-list) - A vue component for tree structure
*   [vue-finder (⭐154)](https://github.com/jledentu/vue-finder) - A component to display hierarchical data, with selection, filtering and drag & drop
*   [vue-pipeline (⭐310)](https://github.com/jinfang134/vue-pipeline) - A easy-to-use component to show beautiful responsive pipeline like jenkins blue ocean plugin.
...
*   [vue-kanban (⭐748)](https://github.com/BrockReece/vue-kanban) - A flexible drag and drop kanban board component
...
*   [v-clipboard (⭐502)](https://github.com/euvl/v-clipboard) - Simple, tiny and easy to use directive to save your models to clipboard (less than 2kb minified, no dependencies)
...
*   [vue-query-builder (⭐621)](https://github.com/dabernathy89/vue-query-builder) - A UI component for building complex queries with nested conditionals.
...
*   [vue-page-designer (⭐842)](https://github.com/fireyy/vue-page-designer) - Vue component for drag-and-drop to design and build mobile website.
...
*   [vue-mindmap (⭐563)](https://github.com/anteriovieira/vue-mindmap) - Vue component for mindnode maps.
*   [v-currency (⭐24)](https://github.com/ignoreintuition/v-currency) - Vue component for formatting currency.
*   [vue-emoji-picker (⭐312)](https://github.com/DCzajkowski/vue-emoji-picker) - Highly customizable unicode emoji picker 🔥🚀
...
*   [vue-cookie-accept-decline (⭐133)](https://github.com/promosis/vue-cookie-accept-decline) - Show a banner with text, a decline button, and an accept button on your page. Remembers selection using cookies. Emits an event with current selection on creation. Good for GDPR requirements.
...
*   [vue-baberrage (⭐370)](https://github.com/superhos/vue-baberrage) - A simple Barrage plugin Base on Vue.js😎
...
*   [vue-twemoji-picker (⭐210)](https://github.com/kevinfaguiar/vue-twemoji-picker) - A fast plug-n-play Twemoji Picker (+textarea for Twemoji rendering) for Vue.
...
*   [query-builder-vue (⭐86)](https://github.com/rtucek/vue-query-builder) - A query-builder library for building complex and nested queries with draggable re-ordering.
*   [vue-meeting-selector (⭐81)](https://github.com/IneoO/vue-meeting-selector) - A meeting selector inspired by doctolib, fast and fully custom made with Typescript.
*   [cool-emoji-picker (⭐210)](https://github.com/kevinfaguiar/cool-emoji-picker) - A fast plug-n-play \[Tw]emoji Picker (+textarea for Twemoji rendering) component for Vue.
...
*   [v-emoji-picker (⭐342)](https://github.com/joaoeudes7/v-emoji-picker) - :star2: A Lightweight and customizable package of Emoji Picker in Vue using emojis natives (unicode).
...
*   [vue-tabs-component (⭐628)](https://github.com/spatie/vue-tabs-component) - An easy way to display tabs with Vue.
...
*   [vue-phone-number-input (⭐569)](https://github.com/LouisMazel/vue-phone-number-input) - A beautiful input to format & valid phone number with country code :fire:
*   [vue-tel-input (⭐625)](https://github.com/EducationLink/vue-tel-input) - International Telephone Input with Vue.
...
*   [vue-scroll-picker (⭐185)](https://github.com/wan2land/vue-scroll-picker) - A scroll picker component for Vue 2.x. Support all gestures of mouse(also wheel) and touch.
...
*   [Laraform (⭐350)](https://github.com/laraform/laraform) - Advanced form builder for Vue.js with Laravel support
*   [vue-ele-form (⭐851)](https://github.com/dream2023/vue-ele-form) - Vue DataForm, based on element-ui
...
*   [v-region (⭐860)](https://github.com/TerryZ/v-region) - A simple region selector, provide Chinese administrative division data.
...
*   [vue-search-select (⭐365)](https://github.com/moreta/vue-search-select) - Searchable select components and semantic-ui's dropdown compatible.
...
*   [vue-autosuggest (⭐604)](https://github.com/Educents/vue-autosuggest) - WAI-ARIA complete Autosuggest component with full customization over rendering and styling.
...
*   [vue-img-inputer (⭐570)](https://github.com/waynecz/vue-img-inputer) A graceful, highly customizable img type input for Vue 2
...
*   [vue-swatches (⭐554)](https://github.com/saintplay/vue-swatches) - Help the user picking beautiful colors!
...
*   [vue-js-toggle-button (⭐923)](https://github.com/euvl/vue-js-toggle-button) - Vue.js 2.0+ toggle / switch button - simple, pretty, customizable.
...
*   [vue-at (⭐516)](https://github.com/fritx/vue-at) - At.js for Vue.
...
*   [vue-trix (⭐218)](https://github.com/hanhdt/vue-trix) - Simple and lightweight Trix rich-text editor for Vue.js
...
*   [ckeditor5-vue (⭐300)](https://github.com/ckeditor/ckeditor5-vue) - An official CKEditor 5 rich text editor component for Vue.js.
...
*   [vue-editor-js (⭐311)](https://github.com/ChangJoo-Park/vue-editor-js) Next generation block styled editor. for Vue.js
...
*   [vue-advanced-cropper (⭐739)](https://github.com/Norserium/vue-advanced-cropper) - An advanced cropper that gives you opportunity to create almost any cropper that you desire
...
*   [vuep (⭐880)](https://github.com/QingWei-Li/vuep) - A component for rendering Vue components with live editor and preview.
...
*   [vue-interactive-paycard (⭐143)](https://github.com/muhammederdem/vue-interactive-paycard) - A fantastic credit card form with smooth and sweet micro-interactions.
...
*   [vue-konva (⭐956)](https://github.com/rafaesc/vue-konva) - Vue & Canvas - JavaScript library for drawing complex canvas graphics using Vue.
...
*   [vue-signature-pad (⭐423)](https://github.com/neighborhood999/vue-signature-pad) - 🖋 A Vue Signature Pad Component
...
*   [vue-masonry (⭐631)](https://github.com/shershen08/vue-masonry) - Vue.js directive for masonry blocks layouting.
...
*   [vue-smart-widget (⭐159)](https://github.com/xiaoluoboding/vue-smart-widget) - Smart widget is a flexible and extensible content container component for Vue.js 2.x.
...
*   [vue-masonry-wall (⭐194)](https://github.com/fuxingloh/vue-masonry-wall) - A pure vue responsive masonry layout without direct dom manipulation, ssr friendly and lazy loading.
...
*   [zircle-ui (⭐918)](https://github.com/zircleUI/zircleUI) - A frontend library to develop zoomable user interfaces.
...
*   [@Carbon/vue (⭐531)](https://github.com/carbon-design-system/carbon-components-vue) - Carbon Design System components from the @carbon team.
*   [vue-awesome-mui (⭐312)](https://github.com/Wscats/vue-awesome-mui) - A Vue.js 2.0 MUI Component for Web
*   [MDBootstrap (⭐921)](https://github.com/mdbootstrap/Vue-Bootstrap-with-Material-Design) - Powerful UI toolkit based on the latest Bootstrap 4 and Vue 2.6.10, providing a set of slick, responsive page templates, layouts, components and widgets to rapidly build responsive, mobile-first websites and apps.
...
*   [CoreUI for Vue.js (⭐564)](https://github.com/coreui/coreui-vue) - CoreUI for Vue.js is a UI Component Library that offers a bunch of cross-browser, responsive, and lightweight Vue.js UI components.
...
*   [Semantic UI Vue (⭐941)](https://github.com/Semantic-UI-Vue/Semantic-UI-Vue) - Semantic UI integration for Vue
...
*   [vue-atlas (⭐183)](https://github.com/nvms/vue-atlas) - A library of beautiful Vue components.
...
*   [Equal UI (⭐935)](https://github.com/quatrochan/Equal) - Vue UI kit based on TypeScript 🧬
...
*   [rest-admin (⭐612)](https://github.com/wxs77577/rest-admin) - Restful Admin Panel Based on Vue and Bootstrap 4 [Online Demo](http://rest-admin.genyii.com)
...
*   [Ream (⭐604)](https://github.com/ream/ream) - A minimalistic framework for building server-rendered and static websites.
...
*   [vue-shortkey (⭐841)](https://github.com/iFgR/vue-shortkey) - Vue-ShortKey - plugin for Vue.js.
*   [vue-throttle-event (⭐20)](https://github.com/scaccogatto/vue-throttle-event) - Throttle events based on requestAnimationFrame.
*   [vue-waypoint (⭐456)](https://github.com/scaccogatto/vue-waypoint) - Waypoint component for Vue, this is the easiest way to trigger a function when you scroll.
...
*   [v-hotkey (⭐718)](https://github.com/Dafrok/v-hotkey) - Vue 2.x directive for binding hotkeys to components.
...
*   [laravel-vue-pagination (⭐705)](https://github.com/gilbitron/laravel-vue-pagination) - A Vue.js pagination component for Laravel paginators that works with Bootstrap.
...
*   [animated-number-vue (⭐199)](https://github.com/Leocardoso94/animated-number-vue) Super easy way to animate numbers.
...
*   [vue2-filters (⭐938)](https://github.com/freearhey/vue2-filters) - A collection of standard filters Vue 1.\_ adapted for use in Vue 2.\_.
...
*   [vue-vr (⭐462)](https://github.com/imudin/vue-vr) - A framework for building VR applications with Vue
...
*   [vue-jsonp (⭐144)](https://github.com/LancerComet/vue-jsonp) - A tiny library for handling JSONP request.
...
*   [vue-i18n-extract (⭐237)](https://github.com/pixari/vue-i18n-extract) - Manage vue-i18n localization with static analysis. Make reports about missing and unused i18n entries.
...
*   [vue-warehouse (⭐172)](https://github.com/bazzite/vue-warehouse) A Cross-browser storage for Vue.js and Nuxt.js, with plugins support and easy extensibility based on Store.js.
...
*   [vue-google-signin-button (⭐287)](https://github.com/phanan/vue-google-signin-button) - A simple Vue plugin to include a Google sign-in button into your web app
...
*   [jsonapi-vuex (⭐150)](https://github.com/mrichar1/jsonapi-vuex) - Use a JSONAPI api with a Vuex store, with client-side restructuring/normalization of records.
...
*   [vue-css-doodle (⭐11)](https://github.com/LuXDAmore/vue-css-doodle) - Porting of css-doodle, a web component for drawing patterns with CSS.
*   [vue-script2 (⭐175)](https://github.com/taoeffect/vue-script2) - Standardized, designer-friendly script tag behavior for your Single Page App.
...
*   [vue-svg-loader (⭐623)](https://github.com/visualfanatic/vue-svg-loader) - webpack loader that lets you use SVG files as Vue components
...
*   [vue-page-stack (⭐595)](https://github.com/hezhongfeng/vue-page-stack) - Routing and navigation for your Vue SPA. Vue 单页应用导航管理器
...
*   [vue-native-websocket (⭐930)](https://github.com/nathantsoi/vue-native-websocket) - Native websocket implementation for Vuejs 2 and Vuex
...
*   [vue-recaptcha (⭐785)](https://github.com/DanSnow/vue-recaptcha) - Google reCAPTCHA component for Vue.js
...
*   [vue-gtag (⭐775)](https://github.com/MatteoGabriele/vue-gtag) - Global Site Tag plugin for Vue
...
*   [Vue Testing Library (⭐980)](https://github.com/testing-library/vue-testing-library) - Simple and complete testing utilities that encourage good testing practices. Based on DOM Testing Library and built upon the official Vue Test Utils.
...
*   [SPA Starter Kit (⭐917)](https://github.com/codecasts/spa-starter-kit) - A highly opinionated starter kit for building Single Page Applications with Laravel and Vue.js.
...
*   [@kouts/vue-modal (⭐101)](https://github.com/kouts/vue-modal) - A customizable, stackable and lightweight modal component that adheres to the guidelines set in WAI-ARIA Dialog (Modal) section of W3C.
...
*   [Akaunting (⭐6.2k)](https://github.com/akaunting/akaunting) - A free and online accounting software for small businesses and freelancers based on Laravel and VueJS.
...
*   [Vue Pivottable (⭐113)](https://github.com/Seungwoo321/vue-pivottable) - Vue port of the jQuery-based PivotTable.js
...
*   [ETCD Manager (⭐378)](https://github.com/icellmobilsoft/etcdmanager) - A modern, efficient and free multi-platform ETCD GUI app based on Electron and VueJS.
...
*   [Vuejs Shopping Cart (⭐328)](https://github.com/ittus/vuejs-firebase-shopping-cart) - Shopping cart example using Vuejs and Firebase
...
*   [Web Learn (⭐191)](https://github.com/freearhey/web-learn) - A service which provides simple access to thousands of video tutorials on web developing and programming.
...
*   [vue-wordpress-pwa (⭐692)](https://github.com/bstavroulakis/vue-wordpress-pwa)
...
*   [app-framework (⭐648)](https://github.com/scriptPilot/app-framework) - IOS and Android Apps with HTML & JavaScript - develop, build and deploy - free and open source.
...
*   [Modular Genealogy (⭐4)](https://github.com/modularsoftware/genealogy) - Genealogy / family tree management system using Laravel 5.7, Vue.js 2.5 and various components. Work in progress.
...
*   [vue-flatpickr-component (⭐923)](https://github.com/ankurk91/vue-flatpickr-component) Vue.js component for [flatpickr (⭐16k)](https://github.com/chmln/flatpickr) datetime picker
