...
*   [vue-to-print (⭐6)](https://github.com/siaikin/vue-to-print) - Print Vue 3 components in the browser. Supports Chrome, Safari, Firefox and EDGE.
...
*   [@tato30/vue-pdf (⭐205)](https://github.com/TaTo30/VuePDF) - A PDF viewer for Vue 3. [Demo](https://tato30.github.io/VuePDF/)
...
*   [vue-skia (⭐183)](https://github.com/rustq/vue-skia) - Skia based 2d graphics vue3 rendering library. It is based on Rust to implement software rasterization to perform rendering.
*   [@kolirt/vue-web3-auth (⭐24)](https://github.com/kolirt/vue-web3-auth) - 💎 Web3 authentication for Vue3 apps based on WalletConnect v2 and wagmi
...
*   [notivue (⭐485)](https://github.com/smastrom/notivue) - Fully-featured notification system for Vue 3 and Nuxt 3.
*   [vue-collapsed (⭐105)](https://github.com/smastrom/vue-collapsed) - Vue 3 CSS height transition from any to auto and vice versa. Accordion ready.

### Components & Libraries / UI Utilities

*   [vue-use-active-scroll (⭐49)](https://github.com/smastrom/vue-use-active-scroll) - Highlight Vue 3 menu/sidebar links without compromises.
...
*   [vite-vue-ultimate-starter (⭐9)](https://github.com/kaandesu/vite-vue-ultimate-starter) - Open source Vue3 template built with Vite that out of the box provides PWA mode, ts, Vue Router, Tailwind CSS, DaisyUI, Playwright, vitest, github pages workflow and many more.
...
*   [vue-paho-mqtt (⭐13)](https://github.com/kaandesu/vue-paho-mqtt) - Easy-to-use Paho MQTT client library for Vue 3 with centralized subscription management, type support, and built-in optional alert notification library.
*   [VueFinder File Library (⭐136)](https://github.com/n1crack/vuefinder) - Web File Manager Library.

### Components & Libraries / UI Components

*   [vue-maplibre-gl (⭐56)](https://github.com/razorness/vue-maplibre-gl) - Vue 3.x wrapper around Maplibre GL JS library written in TS. Including style switch and frame rate control.
*   [1llest-waveform-vue (⭐23)](https://github.com/codeacme17/1llest-waveform-vue) - A lightweight and controllable audio visualization vue3 plugin.
*   [vue3-calendar-heatmap (⭐70)](https://github.com/razorness/vue3-calendar-heatmap) - A lightweight calendar heatmap Vue 3 component built on SVG
*   [Everright-formEditor (⭐344)](https://github.com/Liberty-liu/Everright-formEditor) - A visual drag-and-drop low-code form editor

### Components & Libraries / UI Layout

*   [fit-screen (⭐42)](https://github.com/jp-liu/fit-screen) - A vue component based on the scale large screen adaptive solution.
...
*   [Insurance-system (⭐38)](https://github.com/DaZuiZui/Insurance-system) - Insurance system made by springboot and vue.
...
*   [vuetify-resize-drawer (⭐9)](https://github.com/webdevnerdstuff/vuetify-resize-drawer) - The vuetify-resize-drawer component extends the functionality of the v-navigation-drawer so that it is resizable by the user.
...
*   [TwicPics (⭐50)](https://github.com/TwicPics/components) - Components replacing img and video tags with lazy loading, CLS optimization, and progressive loading out-of-the-box and enabling media optimization and manipulation.
...
*   [vuejs-confirm-dialog (⭐52)](https://github.com/harmyderoman/vuejs-confirm-dialog) - :speech\_balloon: a simple way to create, reuse, promisify and build chains of modal dialogs in Vue.js.
...
*   [Vue E-Store Templet (⭐159)](https://github.com/rash0/Vue-Ecom) - An e-commerce template build with vue/vuex/vue-router and bootstrap4.
...
*   [vue-simple-calendar (⭐843)](https://github.com/richardtallent/vue-simple-calendar) - Flexbox-based Vue month calendar component; supports multi-day events, localization, holiday emoji, drag/drop. No dependencies.
...
*   [vue-star-rating (⭐650)](https://github.com/craigh411/vue-star-rating) - A simple, highly customizable star rating component ⭐️ ⭐️ ⭐️
...
*   [vue-typed-js (⭐437)](https://github.com/Orlandster1998/vue-typed-js) Typed.js integration to easily create typing animations.
...
*   [vue-cli-plugin-chrome-extension-cli (⭐276)](https://github.com/sanyu1225/vue-cli-plugin-chrome-extension-cli) - Vue CLI Plugin generate chrome extension template

### Components & Libraries / Dev Tools

*   [bruit-io (⭐63)](https://github.com/Moventes/bruit.io) - Collect feedback with screenshot and technical data and post them to an API like [bruit.io](https://bruit.io).
...
*   [vue3-recaptcha2 (⭐29)](https://github.com/bbonch/vue3-recaptcha2) - Google reCAPTCHA 2 for Vue 3.
...
*   [simple-vue-camera (⭐55)](https://github.com/BastiaanJansen/simple-vue-camera) - A simple to use, but extensive, camera component for Vue 3 with Typescript support to create great camera experiences.
...
*   [petite-vue (⭐8.6k)](https://github.com/vuejs/petite-vue) - 6kb subset of Vue optimized for progressive enhancement.

### Components & Libraries / Scaffold

*   [electron-vite-template (⭐344)](https://github.com/umbrella22/electron-vite-template) - A modern desktop application project template with Vue 3, Vite & Electron. **It's fast!**

## [Feb 16, 2022](/content/2022/02/16/README.md)

### Components & Libraries / Utilities

*   [pinia-orm (⭐380)](https://github.com/CodeDredd/pinia-orm) - The Pinia plugin to enable Object-Relational Mapping access to the Pinia Store. 🍍
...
*   [vue3-side-panel (⭐42)](https://github.com/headmandev/vue3-side-panel) - 🔥 Easy to use and flexible modal sidebar component for Vue3.
...
*   [vue3-flip-countdown (⭐81)](https://github.com/coskuncayemre/vue3-flip-countdown) Customize Countdown timer with Flip Animation for Vue 3.x
...
*   [vue-timer-hook (⭐163)](https://github.com/riderx/vue-timer-hook) - Vue 3 Timer module inspired by react-timer-hook
...
*   [fluent-vue (⭐222)](https://github.com/Demivan/fluent-vue) - Internationalization plugin for Vue.js (2 and 3). Vue.js integration for Fluent.js - JavaScript implementation of Project Fluent
...
*   [vue-word-highlighter (⭐239)](https://github.com/kawamataryo/vue-word-highlighter) - The word highlighter library for Vue 2 and Vue 3.
...
*   [vue-datepicker-ui (⭐423)](https://github.com/edisdev/vue-datepicker-ui) - A datepicker component for vue.js
...
*   [pdfvuer (⭐888)](https://github.com/arkokoley/pdfvuer) - A PDF viewer for Vue using Mozilla's PDF.js with text support for Vue2 and Vue3. [Demo](https://arkokoley.github.io/pdfvuer/)
...
*   [Learning Vue 3.0 (⭐915)](https://github.com/chengpeiquan/learning-vue3)
...
*   [vue-feather (⭐144)](https://github.com/fengyuanchen/vue-feather) - Feather icons component for Vue 3.
...
*   [vue-tweet (⭐34)](https://github.com/DannyFeliz/vue-tweet) - Vue 3 component that let you embed tweets in your App by only giving the tweet id

## [Jun 23, 2021](/content/2021/06/23/README.md)

### Components & Libraries / UI Components

*   [vue3-openlayers (⭐564)](https://github.com/MelihAltintas/vue3-openlayers) - Vue 3 components to work with OpenLayers.
...
*   [GrandNode 2.0 (⭐918)](https://github.com/grandnode/grandnode2/) - Open Source Cross Platform E-Commerce Solution based on .NET Core 5.0 and MongoDB / Azure CosmosDB / Amazon DocumentDB / VueJS
...
*   [v-viewer (⭐2.3k)](https://github.com/mirari/v-viewer) - Image viewer component for vue2 and vue3, supports rotation, scale, zoom and so on, based on [viewer.js (⭐7.5k)](https://github.com/fengyuanchen/viewerjs)
...
*   [vue-sse (⭐136)](https://github.com/tserkov/vue-sse) - A Vue plugin for using Server-Sent Events (EventSource).
...
*   [vue3-signature (⭐57)](https://github.com/WangShayne/vue3-signature) - A electronic signature component for Vue 3
*   [vue-signature (⭐197)](https://github.com/WangShayne/vue-signature) - A electronic signature component for Vue2.x
...
*   [vue-typical (⭐166)](https://github.com/Turkyden/vue-typical) 🐡 Vue Animated typing in \~400 bytes of JavaScript.
...
*   [vue-socials (⭐42)](https://github.com/webistomin/vue-socials) - 💬 Social media share buttons and counts for Vue.js.
...
*   [eslint-plugin-vuejs-accessibility (⭐227)](https://github.com/vue-a11y/eslint-plugin-vuejs-accessibility) - Vue.js accessibility eslint-plugin managed by @vue-a11y .
...
*   [vue-bottom-sheet (⭐176)](https://github.com/webzlodimir/vue-bottom-sheet) - A swipeable bottom sheet component for Vue.js created with Hammer.js
...
*   [vue-safe-html (⭐23)](https://github.com/ecosia/vue-safe-html) - Vue.js directive which renders sanitised HTML dynamically.
...
*   [Building a realtime quiz with VueJS using a starter kit (⭐67)](https://github.com/ably-labs/realtime-quiz-framework/blob/main/TUTORIAL.md) by Srushtika Neelakantam (October 2020)

### Resources / Examples

*   [Shopify Theme Lab (⭐700)](https://github.com/uicrooks/shopify-theme-lab) - Shopify theme development starter using Vue, Vuex and Tailwind CSS

### Projects Using Vue.js / Open Source

*   [Realtime quiz framework (⭐67)](https://github.com/ably-labs/realtime-quiz-framework) - A starter kit built with NodeJS, VueJS and Ably providing the scalable base networking framework to host a live quiz
...
*   [uiv (⭐939)](https://github.com/uiv-lib/uiv) - Bootstrap3 components implemented by Vue2.
...
*   [echarts-for-vue (⭐78)](https://github.com/ambit-tsai/echarts-for-vue) - ECharts Wrapper Component For Vue 3 and 2
...
*   [Pathfinding Visualizer ThreeJS (⭐417)](https://github.com/dhruvmisra/Pathfinding-Visualizer-ThreeJS) - A visualizer for pathfinding algorithms in 3D with maze generation and first-person view
...
*   [@geospoc/v-mapbox (⭐173)](https://github.com/geospoc/v-mapbox) - Combine powers of Vue.js and Mapbox GL JS (Maintained fork of soal's vue-mapbox)
...
*   [vue-concurrency (⭐339)](https://github.com/MartinMalinda/vue-concurrency) - library for encapsulating asynchronous operations and managing concurrency for Vue and Composition API.
...
*   [X-WebDesktop-Vue (⭐403)](https://github.com/OXOYO/X-WebDesktop-Vue) - The WebDesktop system based on Vue
...
*   [Cookiecutter-Django-Vue (⭐581)](https://github.com/vchaptsev/cookiecutter-django-vue) - Django+VueJS+Docker customizable project generator with a large number of settings/integrations
...
*   [vue.js 与 laravel 结合的前后端分离开发模板 (⭐951)](https://github.com/wmhello/laravel_template_with_vue)- A template website to laravel passport / Vue.JS & Element UI.
...
*   [HappyPlants (⭐278)](https://github.com/morkro/happy-plants) - A progressive web app for organizing your plants 🌱.
...
*   [web-riimote](https://web-riimote.herokuapp.com) - Turn your smartphone into a 3D controller ([source code (⭐478)](https://github.com/konaraddio/web-riimote))
...
*   [vue-js-grid (⭐950)](https://github.com/euvl/vue-js-grid) - Vue.js 2.x responsive grid system with smooth sorting, drag-n-drop and reordering
...
*   [Vue Datatable (⭐629)](https://github.com/laravel-enso/vuedatatable) - VueJS powered Datatable with Laravel server-side loading and JSON template setup
...
*   [@marketconnect/vue-pivot-table (⭐226)](https://github.com/MarketConnect/vue-pivot-table) - A vue component for pivot table
...
*   [vue-table-dynamic (⭐168)](https://github.com/TheoXiong/vue-table-dynamic) - A dynamic table with sorting, filtering, editing, pagination, multiple select, etc.
*   [vue-notifications (⭐693)](https://github.com/se-panfilov/vue-notifications) - Vue.js agnostic non-blocking notifications library.
...
*   [vue-snotify (⭐789)](https://github.com/artemsky/vue-snotify) - Vue.js 2 Notification Center
...
*   [vue-m-message (⭐170)](https://github.com/mengdu/m-message) - A message plugin for vue.
...
*   [vue-toast-notification (⭐569)](https://github.com/ankurk91/vue-toast-notification) - Yet another Vue.js Toast notification plugin.
*   [VueToastify (⭐215)](https://github.com/nandi95/vue-toastify) - A fuss free notification component.
...
*   [vue-loaders (⭐168)](https://github.com/Hokid/vue-loaders) - vue wrappers for [loaders.css (⭐10k)](https://github.com/ConnorAtherton/loaders.css)
...
*   [vue-ellipse-progress (⭐329)](https://github.com/setaman/vue-ellipse-progress) - A flexible Vue.js component to create beautiful animated circular progress bars and loaders
...
*   [vue-parallaxy (⭐636)](https://github.com/apertureless/vue-parallax) - Vue.js component for parallax image scroll effects.
...
*   [vue-unicons (⭐986)](https://github.com/antonreshetov/vue-unicons) - 1000+ Pixel-perfect svg unicons for your next project as Vue components.
...
*   [vue-hero-icons (⭐98)](https://github.com/matschik/vue-hero-icons) - A set of high-quality SVG icons, sourced from [@refactoringui/heroicons (⭐20k)](https://github.com/refactoringui/heroicons), as Vue functional components.
...
*   [vue-navigation-bar (⭐177)](https://github.com/johndatserakis/vue-navigation-bar) - A simple, pretty navbar for your Vue projects.
...
*   [vue-stripe-menu (⭐524)](https://github.com/Alexeykhr/vue-stripe-menu) - Creating a navigation menu with animations like on Stripe
...
*   [vue-carousel-3d (⭐950)](https://github.com/wlada/vue-carousel-3d) - Vue Carousel 3D - Beautiful, flexible and touch supported 3D Carousel for Vue.js.
...
*   [vue-flux (⭐478)](https://github.com/deulos/vue-flux) - Image slider which comes with 20 cool transitions.
...
*   [vueper-slides (⭐553)](https://github.com/antoniandre/vueper-slides) - A touch ready and responsive slideshow / carousel for Vue JS.
...
*   [vue-slick-carousel (⭐779)](https://github.com/gs-shop/vue-slick-carousel) - A carousel with slick features & SSR support written for faster Luxstay
...
*   [vue-echarts (⭐9k)](https://github.com/Justineo/vue-echarts) - ECharts component for Vue.js.
...
*   [vue-d3-network (⭐506)](https://github.com/emiliorizzo/vue-d3-network) - Vue component to graph networks using d3-force
...
*   [vue-google-charts (⭐442)](https://github.com/devstark-com/vue-google-charts) - Reactive Vue.js wrapper for Google Charts lib
...
*   [flowchart-vue (⭐324)](https://github.com/joyceworks/flowchart-vue) - Flowchart & Flowchart designer component for Vue.js.
...
*   [vue-clock2 (⭐86)](https://github.com/bestvist/vue-clock2) - Display clock component for Vue.
...
*   [quasar-calendar (⭐268)](https://github.com/stormseed/quasar-calendar) - A vue.js calendar using the Quasar framework that implements monthly, multi-day and agenda views.
...
*   [vue-functional-calendar (⭐458)](https://github.com/ManukMinasyan/vue-functional-calendar) - Lightweight, high performance calendar component(Date Picker, Date Range) based on Vue.
...
*   [vue-mapbox (⭐457)](https://github.com/soal/vue-mapbox) - Vue 2.x wrapper around Mapbox GL JS library that provides vueish-way to interact with the map.
...
*   [vue-audio-visual (⭐649)](https://github.com/staskobzar/vue-audio-visual) - Vue HTML5 audio visualization components.
*   [vue-plyr (⭐749)](https://github.com/redxtech/vue-plyr) - A set of Vue components for the plyr video & audio player.
*   [v-playback (⭐18)](https://github.com/TerryZ/v-playback) - A Vue2 plugin to make video play easier.
*   [vue-audio-recorder (⭐481)](https://github.com/grishkovelli/vue-audio-recorder) - Audio recorder for Vue.js. It allows to create, play, download and store records on a server
...
*   [vue-responsive-video-background-player (⭐275)](https://github.com/avidofood/vue-responsive-video-background-player) - Play your own videos in background responsively in different resolutions.
...
*   [vue-core-video-player (⭐446)](https://github.com/core-player/vue-core-video-player) - A Lightweight Video Player For Vue.js
*   [vue-player (⭐22)](https://github.com/algoz098/vue-player) - A simple html5 video player with img placeholder for Vue 2.x.
*   [vue-audio-better (⭐126)](https://github.com/forijk/vue-audio-better) - Easy to create custom audio player components for Vue 2.x. A progress bar with soul.
...
*   [vue-loop (⭐823)](https://github.com/lookstudios/vue-loop) - An infinite content loop component for Vue.js 2.
...
*   [vue-simplemde (⭐768)](https://github.com/F-loat/vue-simplemde) - A wrapper around [simplemde (⭐9.6k)](https://github.com/sparksuite/simplemde-markdown-editor). Delightful editing for beginners and experts alike. Features built-in autosaving and spell checking.
*   [vue-pdf (⭐2.1k)](https://github.com/FranckFreiburger/vue-pdf) - A pdf viewer based on mozilla's PDF.js
*   [Vue.D3.tree (⭐857)](https://github.com/David-Desmaisons/Vue.D3.tree) - A Tree View based on [D3.js](https://d3js.org/)
...
*   [vuejs-tree (⭐329)](https://github.com/scalia/vuejs-tree) - A highly customizable VueJs tree viewer
*   [vue-jstree (⭐613)](https://github.com/zdy1988/vue-jstree) - A Tree Plugin For Vue2 with beautiful icons and drag\&drop
...
*   [vue-tree-list (⭐561)](https://github.com/ParadeTo/vue-tree-list) - A vue component for tree structure
...
*   [vue-pipeline (⭐324)](https://github.com/jinfang134/vue-pipeline) - A easy-to-use component to show beautiful responsive pipeline like jenkins blue ocean plugin.
...
*   [vue-goodshare (⭐445)](https://github.com/koddr/vue-goodshare) - Vue.js component for social share with beautiful button design. Simple install, extensive documentation, developer support, SEO friendly, clean code without scripts tracking user activity on the page, high speed. Work with Vue.js 2.x.
...
*   [vue-touch-ripple (⭐477)](https://github.com/surmon-china/vue-touch-ripple) - Touch ripple component for Vue.js(1.x \~ 2.x).
*   [vue-typer (⭐787)](https://github.com/cngu/vue-typer) - Vue component that simulates a user typing, selecting, and erasing text.
...
*   [vue-kanban (⭐776)](https://github.com/BrockReece/vue-kanban) - A flexible drag and drop kanban board component
...
*   [vue-query-builder (⭐637)](https://github.com/dabernathy89/vue-query-builder) - A UI component for building complex queries with nested conditionals.
...
*   [v-offline (⭐367)](https://github.com/vinayakkulkarni/v-offline) - Simple, tiny and easy to use detection of offline & online events for your Vue app (less than 390b minified)
*   [vue-word-cloud (⭐361)](https://github.com/SeregPie/VueWordCloud) - A word cloud generator.
...
*   [vue-heatmapjs (⭐203)](https://github.com/BrockReece/vue-heatmapjs) - A Vue directive for tracking and visualising mouse activity
*   [vue-maze (⭐65)](https://github.com/meganetaaan/vue-maze) - An itty-bitty maze game made as Vue.js component
*   [vue-drag-verify (⭐201)](https://github.com/AshleyLv/vue-drag-verify) - This is a vue component, which is sliding to unlock for login or sign up.
...
*   [vue-page-designer (⭐868)](https://github.com/fireyy/vue-page-designer) - Vue component for drag-and-drop to design and build mobile website.
...
*   [vue-chessboard (⭐160)](https://github.com/vitogit/vue-chessboard) - Chessboard vue component to load positions, create positions and see threats.
*   [vue-mindmap (⭐577)](https://github.com/anteriovieira/vue-mindmap) - Vue component for mindnode maps.
...
*   [vue-text-highlight (⭐320)](https://github.com/AlbertLucianto/vue-text-highlight) - Text highlighter library for Vue.js 💄
...
*   [vue-highlight-words (⭐68)](https://github.com/Astray-git/vue-highlight-words) - Vue component to highlight words within a larger body of text. Ported from [react-highlight-words (⭐2.1k)](https://github.com/bvaughn/react-highlight-words)
...
*   [basic-vue-chat (⭐71)](https://github.com/jmaczan/basic-vue-chat) - Easy to use Vue.js chat
...
*   [vue-katex (⭐120)](https://github.com/lucpotage/vue-katex) - Simple plugin for math typsetting using KaTeX in Vue.js
*   [vue-baberrage (⭐387)](https://github.com/superhos/vue-baberrage) - A simple Barrage plugin Base on Vue.js😎
*   [vue-terminal-ui (⭐55)](https://github.com/shershen08/vue-terminal-ui) - 🖥Terminal UI emulator Vue: custom and basic commands
*   [vue-command (⭐280)](https://github.com/ndabAP/vue-command) - A fully working Vue.js terminal emulator
...
*   [query-builder-vue (⭐93)](https://github.com/rtucek/vue-query-builder) - A query-builder library for building complex and nested queries with draggable re-ordering.
...
*   [vue-cursor-fx (⭐63)](https://github.com/LuXDAmore/vue-cursor-fx) - An animated custom cursor effects for interactive elements like navigation, galleries and carousels.
*   [vuetimeline (⭐340)](https://github.com/growthbunker/vuetimeline) - One easy-to-use component to build beautiful responsive timelines.
...
*   [vue-tabs-chrome (⭐225)](https://github.com/viewweiwu/vue-tabs-chrome) - A Vue component for Chrome-like tabs.
...
*   [vue-phone-number-input (⭐595)](https://github.com/LouisMazel/vue-phone-number-input) - A beautiful input to format & valid phone number with country code :fire:
*   [vue-tel-input (⭐691)](https://github.com/EducationLink/vue-tel-input) - International Telephone Input with Vue.
...
*   [vue-scroll-picker (⭐229)](https://github.com/wan2land/vue-scroll-picker) - A scroll picker component for Vue 2.x. Support all gestures of mouse(also wheel) and touch.
...
*   [FormSchema Native (⭐478)](https://github.com/formschema/native) - Generate a form using JSON Schema and Vue.js
...
*   [element-form-builder (⭐382)](https://github.com/codetrial/element-form-builder) - Build element-ui forms with JSON Schema.
*   [ncform (⭐1.2k)](https://github.com/ncform/ncform) - a very nice configuration generation way to develop form
*   [Laraform (⭐363)](https://github.com/laraform/laraform) - Advanced form builder for Vue.js with Laravel support
*   [vue-ele-form (⭐868)](https://github.com/dream2023/vue-ele-form) - Vue DataForm, based on element-ui
...
*   [v-region (⭐875)](https://github.com/TerryZ/v-region) - A simple region selector, provide Chinese administrative division data.
...
*   [vue-search-select (⭐398)](https://github.com/moreta/vue-search-select) - Searchable select components and semantic-ui's dropdown compatible.
...
*   [vue-nestable (⭐317)](https://github.com/rhwilr/vue-nestable) - A simple drag & drop hierarchical list made as a vue component.
...
*   [vue-autosuggest (⭐617)](https://github.com/Educents/vue-autosuggest) - WAI-ARIA complete Autosuggest component with full customization over rendering and styling.
...
*   [vue-input-tag (⭐538)](https://github.com/matiastucci/vue-input-tag) - Vue.js 2.0 Input Tag Component.
...
*   [vue-swatches (⭐563)](https://github.com/saintplay/vue-swatches) - Help the user picking beautiful colors!
...
*   [vue-froala-wysiwyg (⭐623)](https://github.com/froala/vue-froala-wysiwyg) - Official VueJS plugin for Froala WYSIWIG HTML Editor.
*   [vue-at (⭐525)](https://github.com/fritx/vue-at) - At.js for Vue.
*   [vue-wysiwyg (⭐549)](https://github.com/chmln/vue-wysiwyg) Lightweight, fast & extensible WYSIWYG editor
...
*   [vue-trix (⭐225)](https://github.com/hanhdt/vue-trix) - Simple and lightweight Trix rich-text editor for Vue.js
*   [tiptap (⭐23k)](https://github.com/heyscrumpy/tiptap) - A renderless and extendable rich-text editor for Vue.js
...
*   [ckeditor5-vue (⭐325)](https://github.com/ckeditor/ckeditor5-vue) - An official CKEditor 5 rich text editor component for Vue.js.
...
*   [vue-editor-js (⭐338)](https://github.com/ChangJoo-Park/vue-editor-js) Next generation block styled editor. for Vue.js
...
*   [vue-croppie (⭐257)](https://github.com/jofftiquez/vue-croppie) - Yet another image cropper
...
*   [vue-advanced-cropper (⭐861)](https://github.com/Norserium/vue-advanced-cropper) - An advanced cropper that gives you opportunity to create almost any cropper that you desire
...
*   [vue-ui-predicate (⭐148)](https://github.com/FGRibreau/ui-predicate/tree/master/packages/ui-predicate-vue) - A rules editor, generic filtering UI, predicates component for Vue JS.
...
*   [vue-interactive-paycard (⭐253)](https://github.com/muhammederdem/vue-interactive-paycard) - A fantastic credit card form with smooth and sweet micro-interactions.
...
*   [vue-signature-pad (⭐479)](https://github.com/neighborhood999/vue-signature-pad) - 🖋 A Vue Signature Pad Component
...
*   [link-prevue (⭐231)](https://github.com/nivaldomartinez/link-prevue) - Flexible component for generate a link preview.
...
*   [vue-grid-layout (⭐6.8k)](https://github.com/jbaysolutions/vue-grid-layout) - A draggable and resizable grid layout, for Vue.js.
*   [vue-drag-zone (⭐130)](https://github.com/surmon-china/vue-drag-zone) - Drag Zone component for Vue.js(2.x).
*   [vue-masonry (⭐654)](https://github.com/shershen08/vue-masonry) - Vue.js directive for masonry blocks layouting.
...
*   [vue-virtual-scroller (⭐8.9k)](https://github.com/Akryum/vue-virtual-scroller) - Component to scroll a large amount of elements efficiently (Vue 2.x).
...
*   [vue-masonry-css (⭐455)](https://github.com/paulcollett/vue-masonry-css) - Vue.js Masonry layout component powered by CSS, dependency free.
...
*   [vue-masonry-wall (⭐208)](https://github.com/fuxingloh/vue-masonry-wall) - A pure vue responsive masonry layout without direct dom manipulation, ssr friendly and lazy loading.
...
*   [vue-bulma-components (⭐162)](https://github.com/vouill/vue-bulma-components) - Easily use bulma class syntax with vue components.
...
*   [zircle-ui (⭐927)](https://github.com/zircleUI/zircleUI) - A frontend library to develop zoomable user interfaces.
...
*   [MDBootstrap (⭐946)](https://github.com/mdbootstrap/Vue-Bootstrap-with-Material-Design) - Powerful UI toolkit based on the latest Bootstrap 4 and Vue 2.6.10, providing a set of slick, responsive page templates, layouts, components and widgets to rapidly build responsive, mobile-first websites and apps.
...
*   [CoreUI for Vue.js (⭐587)](https://github.com/coreui/coreui-vue) - CoreUI for Vue.js is a UI Component Library that offers a bunch of cross-browser, responsive, and lightweight Vue.js UI components.
...
*   [Nuxt.js (⭐50k)](https://github.com/nuxt/nuxt.js) - Versatile Vue.js Framework.
...
*   [vue-shortkey (⭐854)](https://github.com/iFgR/vue-shortkey) - Vue-ShortKey - plugin for Vue.js.
...
*   [v-click-outside (⭐961)](https://github.com/ndelvalle/v-click-outside) - Vue directive to react on clicks outside of an element without stopping the event propagation.
...
*   [vue-resize (⭐493)](https://github.com/Akryum/vue-resize) - Vue 2.x component to detect DOM elements resizing (event based/no window\.onresize)
...
*   [vue-router-sitemap (⭐114)](https://github.com/40818419/vue-router-sitemap) - Generate sitemap.xml by vue-router configuration
...
*   [vue-lazy-youtube-video (⭐99)](https://github.com/3vilArthas/vue-lazy-youtube-video) - A simple Vue.js component for lazy loading YouTube videos.
...
*   [laravel-vue-pagination (⭐739)](https://github.com/gilbitron/laravel-vue-pagination) - A Vue.js pagination component for Laravel paginators that works with Bootstrap.
*   [vue-lpage (⭐5)](https://github.com/Botre/vue-lpage) - Low-level Vue pagination component.
*   [v-page (⭐96)](https://github.com/TerryZ/v-page) - A simple pagination bar, including length Menu, i18n support, based on Vue2.x.
...
*   [vue-overdrive (⭐686)](https://github.com/mattrothenberg/vue-overdrive) Super easy magic-move transitions for Vue apps 🎩
...
*   [vue-slide-up-down (⭐198)](https://github.com/danieldiekmeier/vue-slide-up-down) Like jQuery's `slideUp` / `slideDown`, but for Vue!
...
*   [vue-sequential-entrance (⭐85)](https://github.com/deivthings/vue-sequential-entrance) Plugin for creating elegant sequential animation entrances with a list of elements of your page. Zero effort. Simple and lightweight
...
*   [vue2-filters (⭐932)](https://github.com/freearhey/vue2-filters) - A collection of standard filters Vue 1.\_ adapted for use in Vue 2.\_.
*   [vue-morphling (⭐190)](https://github.com/jofftiquez/vue-morphling) - A collection of standard and custom filters for Vue 2.
...
*   [vue-content-loading (⭐760)](https://github.com/LucasLeandro1204/vue-content-loading) - Vue component to easily build (or use presets) SVG loading cards Facebook like.
...
*   [vue-jsonp (⭐148)](https://github.com/LancerComet/vue-jsonp) - A tiny library for handling JSONP request.
...
*   [vue-i18n-extract (⭐279)](https://github.com/pixari/vue-i18n-extract) - Manage vue-i18n localization with static analysis. Make reports about missing and unused i18n entries.
*   [vscode-vue-i18n-ally (⭐3.4k)](https://github.com/antfu/vue-i18n-ally) - VSCode extension for better Vue-i18n experiences.
...
*   [casl-vue (⭐5.4k)](https://github.com/stalniy/casl/tree/master/packages/casl-vue) - Restricts what resources a given user is allowed to access
...
*   [vue-types (⭐545)](https://github.com/dwightjack/vue-types) - Vue Prop Types definitions.
...
*   [vue-svg-loader (⭐638)](https://github.com/visualfanatic/vue-svg-loader) - webpack loader that lets you use SVG files as Vue components
...
*   [vue-page-stack (⭐652)](https://github.com/hezhongfeng/vue-page-stack) - Routing and navigation for your Vue SPA. Vue 单页应用导航管理器
...
*   [vue-native-websocket (⭐945)](https://github.com/nathantsoi/vue-native-websocket) - Native websocket implementation for Vuejs 2 and Vuex
...
*   [vue-recaptcha (⭐839)](https://github.com/DanSnow/vue-recaptcha) - Google reCAPTCHA component for Vue.js
...
*   [vue-gtag (⭐830)](https://github.com/MatteoGabriele/vue-gtag) - Global Site Tag plugin for Vue
...
*   [vue-storybook (⭐148)](https://github.com/mattrothenberg/vue-storybook) – Add `<story>` blocks to your Vue single file components for tighter integration of Vue + [Storybook (⭐82k)](https://github.com/storybooks/storybook)
...
*   [Vue Mode (⭐319)](https://github.com/CodeFalling/vue-mode) - Emacs major mode for vue.js.
...
*   [Mevn-CLI (⭐817)](https://github.com/madlabsinc/mevn-cli) - Light speed setup for MEVN stack based apps.
...
*   [Sheiley Shop (⭐49)](https://github.com/itsalb3rt/sheiley_shop_app) - PWA to track personal purchases, No more paper and pencil to go to the supermarket 🏬 Vue and Vuetify
...
*   [ETCD Manager (⭐442)](https://github.com/icellmobilsoft/etcdmanager) - A modern, efficient and free multi-platform ETCD GUI app based on Electron and VueJS.
...
*   [Vue Crossword (⭐63)](https://github.com/Piterden/vue-crossword) - A Vue.js based crossword puzzle builder and filler front-end application. Built with [CodeSandbox](https://codesandbox.io/s/github/Piterden/vue-crossword/tree/master/).
...
*   [Modular Genealogy (⭐200)](https://github.com/modularsoftware/genealogy) - Genealogy / family tree management system using Laravel 5.7, Vue.js 2.5 and various components. Work in progress.
