...
*   [vue-use-sound (⭐509)](https://github.com/vueuse/sound) - A Vue Hook for playing sound effects.
...
*   [Vue Mess Detector (⭐277)](https://github.com/rrd108/vue-mess-detector) - A static code analysis tool for 👉 detecting code smells and best practice violations in Vue.js and Nuxt.js projects
...
*   [vue3-select-component (⭐65)](https://github.com/TotomInc/vue3-select-component) - Vue 3 Select Component, single & multi-select, best-in-class DX support with TypeScript end-to-end typesafe, easy styling, slots and more \~4.4KB
...
*   [vue-countup-v3 (⭐167)](https://github.com/jizai1125/vue-countup-v3) A Vue 3 Component for animation counting.
...
*   [vite-plugin-vue-inspector (⭐717)](https://github.com/webfansplz/vite-plugin-vue-inspector) - jump to editor source code while click the element of browser automatically.
...
*   [Shadcn UI (⭐5.9k)](https://github.com/radix-vue/shadcn-vue) - An unofficial, community-led Vue port of [shadcn/ui (⭐79k)](https://github.com/shadcn-ui/ui) (re-usable components built with [Radix Vue (⭐4.1k)](https://github.com/radix-vue/radix-vue) and [Tailwind CSS (⭐85k)](https://github.com/tailwindlabs/tailwindcss)).
...
*   [vue-fluid-dnd (⭐267)](https://github.com/carlosjorger/vue-fluid-dnd) - A Vue 3 drag and drop, sortable, dependency-free library with cool animations, a easy to use api using vue composables.
...
*   [virtua (⭐2.2k)](https://github.com/inokawa/virtua) - A zero-config, fast and small (\~3kB) virtual list component for React and Vue
...
*   [vue-virtual-waterfall (⭐150)](https://github.com/lhlyu/vue-virtual-waterfall) - A virtual waterfall component for Vue 3.x.
...
*   [notivue (⭐783)](https://github.com/smastrom/notivue) - Fully-featured notification system for Vue 3 and Nuxt 3.
...
*   [Cientos (⭐306)](https://github.com/Tresjs/cientos) - Collection of useful helpers and fully functional, ready-made abstractions for TresJs
...
*   [sortablejs-vue3 (⭐386)](https://github.com/MaxLeiter/sortablejs-vue3) - A Vue 3 component acting as a thin wrapper around SortableJS

## [May 27, 2022](/content/2022/05/27/README.md)

### Components & Libraries / UI Components

*   [vue3-easy-data-table (⭐544)](https://github.com/HC200ok/vue3-easy-data-table) - A easy-to-use data table component made with Vue.js 3.x, referring to the API and UI of data table component in Vuetify 2.
...
*   [electron-vite-template (⭐436)](https://github.com/umbrella22/electron-vite-template) - A modern desktop application project template with Vue 3, Vite & Electron. **It's fast!**
...
*   [Mosaic - Vue Admin TailwindCSS template (⭐267)](https://github.com/cruip/vuejs-admin-dashboard-template) - The All-in-one Tailwind CSS Admin Dashboard Template.
...
*   [vue-word-highlighter (⭐309)](https://github.com/kawamataryo/vue-word-highlighter) - The word highlighter library for Vue 2 and Vue 3.
...
*   [vue3-openlayers (⭐733)](https://github.com/MelihAltintas/vue3-openlayers) - Vue 3 components to work with OpenLayers.
...
*   [vue-pdf-embed (⭐788)](https://github.com/hrynko/vue-pdf-embed) - PDF embed component for Vue 2 and Vue 3
...
*   [vue3-tabs-chrome (⭐103)](https://github.com/viewweiwu/vue3-tabs-chrome) - A Vue3 component for Chrome-like tabs.
...
*   [eslint-plugin-vuejs-accessibility (⭐261)](https://github.com/vue-a11y/eslint-plugin-vuejs-accessibility) - Vue.js accessibility eslint-plugin managed by @vue-a11y .

## [Feb 02, 2021](/content/2021/02/02/README.md)

### Components & Libraries / Utilities

*   [vite-svg-loader (⭐617)](https://github.com/jpkleemans/vite-svg-loader) - Vite plugin to load SVG files as Vue components
...
*   [vue-bottom-sheet (⭐217)](https://github.com/webzlodimir/vue-bottom-sheet) - A swipeable bottom sheet component for Vue.js created with Hammer.js
...
*   [vue-country-flag (⭐173)](https://github.com/P3trur0/vue-country-flag) - Vue component for country flag icons
...
*   [vue-navigation-bar (⭐189)](https://github.com/johndatserakis/vue-navigation-bar) - A simple, pretty navbar for your Vue projects.
*   [vue-easy-slider (⭐356)](https://github.com/shhdgit/vue-easy-slider) - Slider Component of Vue.js.
*   [vue-flux (⭐548)](https://github.com/deulos/vue-flux) - Image slider which comes with 20 cool transitions.
...
*   [vue-audio-visual (⭐733)](https://github.com/staskobzar/vue-audio-visual) - Vue HTML5 audio visualization components.
...
*   [vue-kanban (⭐809)](https://github.com/BrockReece/vue-kanban) - A flexible drag and drop kanban board component
...
*   [vue-highlight-words (⭐74)](https://github.com/Astray-git/vue-highlight-words) - Vue component to highlight words within a larger body of text. Ported from [react-highlight-words (⭐2.2k)](https://github.com/bvaughn/react-highlight-words)
*   [vue-command (⭐309)](https://github.com/ndabAP/vue-command) - A fully working Vue.js terminal emulator
...
*   [v-region (⭐919)](https://github.com/TerryZ/v-region) - A simple region selector, provide Chinese administrative division data.
...
*   [radial-color-picker (⭐100)](https://github.com/radial-color-picker/vue-color-picker) - Minimalistic color picker with a focus on size, accessibility and performance.
*   [vue-froala-wysiwyg (⭐636)](https://github.com/froala/vue-froala-wysiwyg) - Official VueJS plugin for Froala WYSIWIG HTML Editor.
*   [vue-trix (⭐245)](https://github.com/hanhdt/vue-trix) - Simple and lightweight Trix rich-text editor for Vue.js
...
*   [vue-diagrams (⭐290)](https://github.com/gwenaelp/vue-diagrams) - Diagram component for vue.js, inspired by react-diagrams
*   [vue-simple-password-meter (⭐99)](https://github.com/miladd3/vue-simple-password-meter) - Lightweight password strength meter with no dependency
...
*   [vue-page-stack (⭐727)](https://github.com/hezhongfeng/vue-page-stack) - Routing and navigation for your Vue SPA. Vue 单页应用导航管理器
*   [vue-socket.io-extended (⭐625)](https://github.com/probil/vue-socket.io-extended) - Socket.io bindings for Vue.js and Vuex

### Components & Libraries / Integrations

*   [vue-recaptcha (⭐879)](https://github.com/DanSnow/vue-recaptcha) - Google reCAPTCHA component for Vue.js
...
*   [LeagueStats (⭐436)](https://github.com/vkaelin/LeagueStats) - Statistics website for players of the online game League of Legends.
...
*   [vue-currency-input (⭐661)](https://github.com/dm4t2/vue-currency-input) - Easy input of currency formatted numbers for Vue.js.
