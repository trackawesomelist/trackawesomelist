...
*   [vue3-map-chart (⭐10)](https://github.com/noeGnh/vue3-map-chart) - Vue 3 components for displaying dynamic data on a world, continents, countries and custom maps.
...
*   [vite-plugin-vue-middleware (⭐11)](https://github.com/awdr74100/vite-plugin-vue-middleware) - File-based navigation guards for Vue Router
*   [vue-router-citadel (⭐11)](https://github.com/Kassaila/vue-router-citadel) - A middleware-driven navigation control system for Vue Router.
*   [lucide-motion-vue (⭐3)](https://github.com/respeak-io/lucide-motion-vue) - 516 animated Lucide icons for Vue 3 with ergonomic hover/tap/viewport triggers and a composable `<AnimateIcon>` wrapper. Tree-shakable, one chunk per icon, TypeScript-first. (vue 3.x)
...
*   [@rollgate/sdk-vue (⭐1)](https://github.com/rollgate/sdks/tree/main/packages/sdk-vue) - Vue 3 feature flag SDK with composables, gradual rollouts, A/B testing and real-time updates. Backend: [Rollgate](https://rollgate.io)
...
*   [Jordium Gantt Vue3 (⭐87)](https://github.com/nelson820125/jordium-gantt-vue3) - Vue3 Gantt chart component with Resource View, task dependencies, and project scheduling capabilities.

## [Mar 10, 2026](/content/2026/03/10/README.md)

### Components & Libraries / Frameworks

*   [@oneflowui/ui (⭐3)](https://github.com/qixi54/oneui) - Vue 3 + TypeScript component library for task management views, featuring Table, Kanban, Gantt timeline, Gallery, AI Chat, Dashboard charts, Rich Text Editor, MermaidChart and more. 75+ components out of the box.
...
*   [JARVIS (⭐5)](https://github.com/hyhmrright/JARVIS) - Self-hosted AI assistant platform with Vue 3 frontend, Pinia state management, TypeScript, and real-time SSE streaming chat. FastAPI backend with LangGraph ReAct agents, RAG knowledge base, multi-LLM support (DeepSeek/OpenAI/Anthropic), and plugin SDK.

### Components & Libraries / UI Components

*   [@witqq/spreadsheet (⭐9)](https://github.com/witqq/spreadsheet) - A canvas-based spreadsheet engine with zero dependencies, rendering 100K+ rows at 60fps with sorting, filtering, formulas, and collaboration.
...
*   [vue-superselect (⭐33)](https://github.com/nemanjamalesija/vue-superselect) - Headless, accessible, TypeScript-first select/combobox for Vue 3 with dual compound component and composable APIs.
...
*   [virtual-scroll (⭐7)](https://github.com/pdanpdan/virtual-scroll) - High-performance Vue 3 virtual scroll library designed to handle massive lists with ease. Supports vertical, horizontal, and bidirectional (grid) scrolling, dynamic item sizes using ResizeObserver, full support for Right-to-Left (RTL) layouts, build in a11y.

### Components & Libraries / UI Components

*   [@vue-leaflet/vue-leaflet (⭐858)](https://github.com/vue-leaflet/vue-leaflet) - Vue 3 components for Leaflet (1.x) maps.
*   [@maxel01/vue-leaflet (⭐45)](https://github.com/maxel01/vue-leaflet) - Vue 3 components for Leaflet (2.x) maps.
*   [markdown-design (⭐4)](https://github.com/ZeroOneJs/markdown-design) - An out-of-the-box Vue 3 Markdown component with real-time rendering, featuring TOC generation, full-text search, and more.
...
*   [Heroshot (⭐41)](https://github.com/omachala/heroshot) - Automate documentation screenshots with Vue component integration and theme-aware output.
...
*   [Toastflow (⭐184)](https://github.com/adrianjanocko/toastflow) - 💡 Headless toast (notification) engine + Vue 3 renderer (TS-first, CSS-first theming, highly customizable).

### Components & Libraries / UI Utilities

*   [ssgoi (⭐873)](https://github.com/meursyphus/ssgoi) - Native app-like page transitions with spring physics, 60fps on mobile, SSR-ready, and all modern browser support

### Components & Libraries / Dev Tools

*   [PocketMocker (⭐538)](https://github.com/tianchangNorth/pocket-mocker) - Visual, browser-based HTTP mocking tool for front-end apps. Intercepts fetch/XHR, supports SmartMock rules, delay/error simulation and works great when developing Vue apps.

## [Nov 18, 2025](/content/2025/11/18/README.md)

### Components & Libraries / Frameworks

*   [Maz-UI (⭐559)](https://github.com/LouisMazel/maz-ui) - Lightweight and efficient library for Vue 3 & Nuxt 3 & 4 with 50+ components, theming, i18n and useful plugins and composables.
...
*   [Roundtable (⭐103)](https://github.com/askbudi/roundtable) - Zero-configuration MCP server that unifies multiple AI assistants (Claude Code, Cursor, GPT-4, etc.) into a single development workflow for Vue.js projects.
...
*   [GridSheet (⭐192)](https://github.com/walkframe/gridsheet) - Highly customizable spreadsheet engine with formula support, multi-sheet references, and a Vue3 wrapper built on a Preact core.
...
*   [vue-calendar (⭐18)](https://github.com/Kodeglot/vue-calendar) - A fully-featured, customizable calendar date picker component for Vue 3 with built-in Tailwind CSS support. Perfect for building scheduling applications, event calendars, and date pickers.
*   [hevue-img-preview (⭐247)](https://github.com/heyongsheng/hevue-img-preview) - Image preview for Vue 2 & 3, supports mobile and desktop. [(demo)](https://heyongsheng.github.io/en/guide/profile.html)

## [Jun 27, 2025](/content/2025/06/27/README.md)

### Components & Libraries / Frameworks

*   [YummyAdmin (⭐65)](https://github.com/doroudi/YummyAdmin) - 📈 Free Vue Admin Panel based on Naive UI and TailwindCSS. fairly completed with beautiful design, RTL support, and multilingual. (MSW, Pinia, TS, UnoCss, Vite)
...
*   [monorepo-template (⭐6)](https://github.com/Nagell/monorepo_template) - 🗂️ Vue 3 monorepo template with pnpm, Nx, Vite, Tailwind CSS, Storybook, TypeScript, and ready-to-use shared libraries.
...
*   [VueFormify (⭐61)](https://github.com/mateenagy/vue-formify) - Build powerful, type-safe forms in Vue 3.
...
*   [vue-infinity (⭐148)](https://github.com/isaact/vue-infinity) - An easy-to-use virtual list component for Vue 3. Supports configurable grid layout, horizontal/vertical scroll, scroll snapping, seeking, ssr
...
*   [Vue3 Pivottable (⭐12)](https://github.com/vue-pivottable/vue3-pivottable) – A Vue 3 port of the jQuery-based PivotTable.js.
*   [Vue DnD Kit (⭐230)](https://github.com/zizigy/vue-dnd-kit) - A lightweight, performant drag and drop toolkit for Vue 3 with composable API, keyboard navigation, accessibility support, and advanced customization options. Supports any cases, and touch devices. Inspired by React DnD Kit

### Components & Libraries / UI Utilities

*   [regle (⭐443)](https://github.com/victorgarciaesgi/regle) - ✅ Headless form validation library for Vue.js.

### Components & Libraries / Utilities

*   [vue-intlayer (⭐705)](https://github.com/aymericzip/intlayer) - Intlayer i18n solution for vue 3.
...
*   [@tauri-store/pinia (⭐129)](https://github.com/ferreira-tb/tauri-store/tree/main/packages/plugin-pinia) - Persistent Pinia stores for Tauri.

## [Mar 11, 2025](/content/2025/03/11/README.md)

### Components & Libraries / Utilities

*   [pinia-plugin-unstorage (⭐13)](https://github.com/litingyes/pinia-plugin-unstorage) - The best persistence plugin with unjs/unstorage for pinia.
...
*   [fylepad (⭐296)](https://github.com/imrofayel/fylepad) - a notepad with powerful rich-text editing, built with Vue.
...
*   [vue-enhanced-check (⭐15)](https://github.com/keiwen/vue-enhancedCheck) - Enhanced checkboxes / radio input + toggle, components for vue 3
...
*   [flowbite-vue (⭐940)](https://github.com/themesberg/flowbite-vue) - Vue component library based on Tailwind CSS
...
*   [Savycart (⭐56)](https://github.com/itsalb3rt/savycart-app) - PWA to track personal purchases, No more paper and pencil to go to the supermarket 🏬 Vue and Vuetify
...
*   [vue-use-sound (⭐558)](https://github.com/vueuse/sound) - A Vue Hook for playing sound effects.

### Components & Libraries / UI Utilities

*   [Unhead (⭐1.3k)](https://github.com/unjs/unhead)
...
*   [Vue Language Tools (Volar) (⭐6.7k)](https://github.com/vuejs/language-tools) - ⚡The Fastest Vue Language Support Extension
...
*   [vue-quilly (⭐116)](https://github.com/alekswebnet/vue-quilly) - 🪶 Tiny Vue 3 component, that helps to create Quill v2 based WYSIWYG editors.

## [Sep 18, 2024](/content/2024/09/18/README.md)

### Components & Libraries / Dev Tools

*   [Vue Mess Detector (⭐358)](https://github.com/rrd108/vue-mess-detector) - A static code analysis tool for 👉 detecting code smells and best practice violations in Vue.js and Nuxt.js projects
...
*   [umo editor (⭐1.5k)](https://github.com/umodoc/editor) - Umo Editor is an open-source document editor, based on Vue3 and Tiptap. Visit [Playground](https://demo.umodoc.com/editor?lang=en-US) for a fast experience.
...
*   [vue3-select-component (⭐116)](https://github.com/TotomInc/vue3-select-component) - Vue 3 Select Component, single & multi-select, best-in-class DX support with TypeScript end-to-end typesafe, easy styling, slots and more \~4.4KB

### Components & Libraries / Scaffold

*   [mevn-boilerplate (⭐242)](https://github.com/mustafacagri/mevn-boilerplate) - ⭐️ the most comprehensive mevn stack boilerplate. ⭐️ mongodb - express - vue 3 (admin dashboard) - nodejs - nuxt 3 (client) boilerplate (pinia, tiptap, slug, vuetify and vuexy and more...) 🎉
...
*   [Release Notes (⭐54k)](https://github.com/vuejs/core/releases)
*   [IDE Language Support (⭐6.7k)](https://github.com/vuejs/language-tools?tab=readme-ov-file#vue-language-tools)
...
*   [slidev (⭐46k)](https://github.com/slidevjs/slidev) - Presentation Slides for Developers
...
*   [qrcode.vue (⭐815)](https://github.com/scopewu/qrcode.vue) - A Vue.js component to generate qrcode. Supports both Vue 2 and Vue 3.
*   [vue-picture-cropper (⭐155)](https://github.com/chengpeiquan/vue-picture-cropper) - A simple and easy-to-use picture cropping component for Vue 3.

### Components & Libraries / UI Utilities

*   [vue-countup-v3 (⭐186)](https://github.com/jizai1125/vue-countup-v3) A Vue 3 Component for animation counting.
...
*   [vite-plugin-vue-inspector (⭐801)](https://github.com/webfansplz/vite-plugin-vue-inspector) - jump to editor source code while click the element of browser automatically.
*   [vitest (⭐16k)](https://github.com/vitest-dev/vitest) - Next generation testing framework powered by Vite.

### Components & Libraries / Scaffold

*   [Vite (⭐81k)](https://github.com/vitejs/vite) - Next generation frontend tooling. It's fast!
...
*   [Shadcn UI (⭐9.8k)](https://github.com/radix-vue/shadcn-vue) - An unofficial, community-led Vue port of [shadcn/ui (⭐113k)](https://github.com/shadcn-ui/ui) (re-usable components built with [Radix Vue (⭐6.4k)](https://github.com/radix-vue/radix-vue) and [Tailwind CSS (⭐95k)](https://github.com/tailwindlabs/tailwindcss)).
...
*   [kitbag/router (⭐251)](https://github.com/kitbagjs/router) - A type safe router for vuejs
...
*   [vue-stack-grid (⭐13)](https://github.com/chiribuc/vue-stack-grid) - A Vue 3 component designed to make creating dynamic, responsive grid layouts easy and efficient.
...
*   [schedule-x (⭐2.3k)](https://github.com/schedule-x/schedule-x) - A material design event calendar. Customizable, light- and dark modes & multilingual.
...
*   [vue-to-print (⭐76)](https://github.com/siaikin/vue-to-print) - Print Vue 3 components in the browser. Supports Chrome, Safari, Firefox and EDGE.
...
*   [@tato30/vue-pdf (⭐686)](https://github.com/TaTo30/VuePDF) - A PDF viewer for Vue 3. [Demo](https://tato30.github.io/VuePDF/)
...
*   [notivue (⭐866)](https://github.com/smastrom/notivue) - Fully-featured notification system for Vue 3 and Nuxt 3.
...
*   [vue-paho-mqtt (⭐29)](https://github.com/kaandesu/vue-paho-mqtt) - Easy-to-use Paho MQTT client library for Vue 3 with centralized subscription management, type support, and built-in optional alert notification library.
*   [VueFinder File Library (⭐576)](https://github.com/n1crack/vuefinder) - Web File Manager Library.
...
*   [vue-maplibre-gl (⭐129)](https://github.com/razorness/vue-maplibre-gl) - Vue 3.x wrapper around Maplibre GL JS library written in TS. Including style switch and frame rate control.
...
*   [ZuiOJ (⭐142)](https://github.com/DaZuiZui/ZuiOJ) - ZuiOJ system developed using Vue2's UI and Java.
...
*   [Vutron (⭐331)](https://github.com/jooy2/vutron) - Quick start templates for Vite + Electron + Vue 3 + Vuetify + TypeScript.
...
*   [vue-web-terminal (⭐348)](https://github.com/tzfun/vue-web-terminal) - 💻 A feature-rich and powerful web terminal plugin for vue2 & vue3.(功能强大的网页命令行终端插件)
...
*   [vue-facing-decorator (⭐402)](https://github.com/facing-dev/vue-facing-decorator) - Vue 3 typescript class component decorators, like `vue-property-decorator` in Vue 2.
...
*   [vorms (⭐725)](https://github.com/Mini-ghost/vorms) - Vue Form Validate with Composition API.
...
*   [Vue E-Store Templet (⭐190)](https://github.com/rash0/Vue-Ecom) - An e-commerce template build with vue/vuex/vue-router and bootstrap4.
...
*   [tolgee/vue (⭐258)](https://github.com/tolgee/tolgee-js/tree/main/packages/vue) - Web-based localization tool enabling users to translate directly in the Vue 3 app they develop.
...
*   [electron-vite-template (⭐507)](https://github.com/umbrella22/electron-vite-template) - A modern desktop application project template with Vue 3, Vite & Electron. **It's fast!**

## [Feb 16, 2022](/content/2022/02/16/README.md)

### Components & Libraries / Utilities

*   [pinia-orm (⭐524)](https://github.com/CodeDredd/pinia-orm) - The Pinia plugin to enable Object-Relational Mapping access to the Pinia Store. 🍍

## [Feb 13, 2022](/content/2022/02/13/README.md)

### Components & Libraries / UI Components

*   [vue-search-input (⭐36)](https://github.com/kouts/vue-search-input) - A Vue 3 search input component, inspired by the global search input of Storybook and GitHub.
...
*   [Mosaic - Vue Admin TailwindCSS template (⭐304)](https://github.com/cruip/vuejs-admin-dashboard-template) - The All-in-one Tailwind CSS Admin Dashboard Template.

### Components & Libraries / UI Components

*   [coya (⭐74)](https://github.com/AlexanderMykulych/coya) - Diagram drawing library (vue3 only)
...
*   [vue-pro-sidebar (⭐82)](https://github.com/boussadjra/vue-pro-sidebar) : A responsive template starter with the ecosystem configuration (vue-router, vuex), this boilerplate allows you to choose your preferred colors. [Live demo](https://boussadjra.github.io/vue-pro-sidebar)
...
*   [vue3-otp-input (⭐124)](https://github.com/ejirocodes/vue3-otp-input) - A fully customizable, OTP (one-time-password) input component built with Vue 3.x and Vue Composition API.
...
*   [vue-stripe-js (⭐180)](https://github.com/ectoflow/vue-stripe-js) - Vue 3 components for Stripe.js

## [Nov 09, 2021](/content/2021/11/09/README.md)

### Projects Using Vue.js / Open Source

*   [Materio Free Vuetify VueJS Laravel Admin Template (⭐230)](https://github.com/themeselection/materio-vuetify-vuejs-laravel-admin-template-free) - Open-source & easy to use Vuetify Vuejs Laravel Admin Template with Elegant Design & Unique Layout.

### Components & Libraries / UI Components

*   [jz-gantt (⭐338)](https://github.com/jeremyjone/jz-gantt) - A high-performance Vue gantt component, which includes highly customizable table columns, dynamic update data, freely drag the progress bar, switch header, etc.
...
*   [vue3-marquee (⭐780)](https://github.com/megasanjay/vue3-marquee) - A simple and responsive marquee component for Vue 3 applications with 0 dependencies.
...
*   [v-use-places-autocomplete (⭐45)](https://github.com/wobsoriano/v-use-places-autocomplete) - 📍 Vue composable for Google Maps Places Autocomplete.
...
*   [element-pro-components (⭐323)](https://github.com/tolking/element-pro-components) A component library for Vue 3 base on element-plus
...
*   [fluent-vue (⭐276)](https://github.com/Demivan/fluent-vue) - Internationalization plugin for Vue.js (2 and 3). Vue.js integration for Fluent.js - JavaScript implementation of Project Fluent

## [Aug 08, 2021](/content/2021/08/08/README.md)

### Components & Libraries / UI Components

*   [v-network-graph (⭐637)](https://github.com/dash14/v-network-graph) - An interactive SVG based network-graph visualization component for Vue 3.

## [Aug 07, 2021](/content/2021/08/07/README.md)

### Components & Libraries / UI Components

*   [vue-word-highlighter (⭐339)](https://github.com/kawamataryo/vue-word-highlighter) - The word highlighter library for Vue 2 and Vue 3.
...
*   [v-google-translate (⭐304)](https://github.com/i7eo/v-google-translate) - A component that use google translate to internationalize your Vue.js app.

## [Jun 24, 2021](/content/2021/06/24/README.md)

### Components & Libraries / Integrations

*   [vue-tweet (⭐44)](https://github.com/DannyFeliz/vue-tweet) - Vue 3 component that let you embed tweets in your App by only giving the tweet id
...
*   [Aimeos (⭐5.4k)](https://github.com/aimeos/aimeos) - Leading Laravel eCommerce framework to build ultra fast online shops, marketplaces and complex B2B applications scalable from 1 to 1,000,000,000+ items
...
*   [vue-fullscreen (⭐435)](https://github.com/mirari/vue-fullscreen) - A simple Vue component for fullscreen, support Vue2 and Vue3.
...
*   [vue3-signature (⭐123)](https://github.com/WangShayne/vue3-signature) - A electronic signature component for Vue 3
...
*   [Yacht (⭐51)](https://github.com/Selfhostedpro/Yacht) - A Docker container management webui using Vuetify for a hassle free way of managing docker containers and projects.
...
*   [eslint-plugin-vuejs-accessibility (⭐309)](https://github.com/vue-a11y/eslint-plugin-vuejs-accessibility) - Vue.js accessibility eslint-plugin managed by @vue-a11y .

## [Feb 02, 2021](/content/2021/02/02/README.md)

### Components & Libraries / Utilities

*   [vite-svg-loader (⭐688)](https://github.com/jpkleemans/vite-svg-loader) - Vite plugin to load SVG files as Vue components
...
*   [@vueform/multiselect (⭐828)](https://github.com/vueform/multiselect) - Vue 3 multiselect component with single select, multiselect and tagging options.
...
*   [uiv (⭐938)](https://github.com/uiv-lib/uiv) - Bootstrap3 components implemented by Vue2.
...
*   [v-selectpage (⭐247)](https://github.com/TerryZ/v-selectpage) - A powerful selector for Vue2, list or table view of pagination, use tags for multiple selection, i18n and server-side resources supports.
...
*   [Wave UI (⭐562)](https://github.com/antoniandre/wave-ui) - An emerging UI framework for Vue.js with only the bright side. ☀️
...
*   [vue-ins-progress-bar (⭐328)](https://github.com/meloalright/vue-ins-progress-bar) - A Vue component of ins-style progress bar 一款 ins 风格的 vue 进度条组件
...
*   [vue-img-cutter (⭐553)](https://github.com/acccccccb/vue-img-cutter) - A vue plugin for image cutting tool,it's very convenient to use.

## [Jul 03, 2020](/content/2020/07/03/README.md)

### Components & Libraries / Utilities

*   [vue-concurrency (⭐356)](https://github.com/MartinMalinda/vue-concurrency) - library for encapsulating asynchronous operations and managing concurrency for Vue and Composition API.
...
*   [Todoist Tribute (⭐229)](https://github.com/rohitpaulk/todoist-tribute/) - Todoist clone, written in Rails + Vue
...
*   [zircle-ui (⭐964)](https://github.com/zircleUI/zircleUI) - A frontend library to develop zoomable user interfaces.
...
*   [@Carbon/vue (⭐643)](https://github.com/carbon-design-system/carbon-components-vue) - Carbon Design System components from the @carbon team.
...
*   [vue-masonry (⭐692)](https://github.com/shershen08/vue-masonry) - Vue.js directive for masonry blocks layouting.
...
*   [vue-scroll-progress (⭐99)](https://github.com/spemer/vue-scroll-progress) - Simple Vue.js plugin for page scroll progress bar
...
*   [vue-css-donut-chart (⭐126)](https://github.com/dumptyd/vue-css-donut-chart) - Lightweight Vue component for drawing pure CSS donut charts.
...
*   [vue-cal (⭐288)](https://github.com/antoniandre/vue-cal) - A Vue JS full calendar, no dependency, no BS. 🤘.
*   [vue-audio-visual (⭐797)](https://github.com/staskobzar/vue-audio-visual) - Vue HTML5 audio visualization components.
...
*   [vue-scroll-picker (⭐293)](https://github.com/wan2land/vue-scroll-picker) - A scroll picker component for Vue 2.x. Support all gestures of mouse(also wheel) and touch.
...
*   [v-region (⭐937)](https://github.com/TerryZ/v-region) - A simple region selector, provide Chinese administrative division data.
...
*   [vue-select-sides (⭐68)](https://github.com/juliorosseti/vue-select-sides) - A component for Vue.js to select double-sided data (2-sides).
...
*   [radial-color-picker (⭐103)](https://github.com/radial-color-picker/vue-color-picker) - Minimalistic color picker with a focus on size, accessibility and performance.
...
*   [tiptap (⭐37k)](https://github.com/heyscrumpy/tiptap) - A renderless and extendable rich-text editor for Vue.js
*   [ckeditor5-vue (⭐386)](https://github.com/ckeditor/ckeditor5-vue) - An official CKEditor 5 rich text editor component for Vue.js.
...
*   [vue-paginate-al (⭐48)](https://github.com/alziqziq/vue-paginate-al) - Vue paginate with return your data.
...
*   [vscode-vue-i18n-ally (⭐4.9k)](https://github.com/antfu/vue-i18n-ally) - VSCode extension for better Vue-i18n experiences.
...
*   [vue-page-stack (⭐762)](https://github.com/hezhongfeng/vue-page-stack) - Routing and navigation for your Vue SPA. Vue 单页应用导航管理器

### Components & Libraries / Integrations

*   [vue-recaptcha (⭐896)](https://github.com/DanSnow/vue-recaptcha) - Google reCAPTCHA component for Vue.js
*   [vue-gtag (⭐932)](https://github.com/MatteoGabriele/vue-gtag) - Global Site Tag plugin for Vue
...
*   [@kouts/vue-modal (⭐123)](https://github.com/kouts/vue-modal) - A customizable, stackable and lightweight modal component that adheres to the guidelines set in WAI-ARIA Dialog (Modal) section of W3C.

## [Apr 22, 2020](/content/2020/04/22/README.md)

### Components & Libraries / Utilities

*   [vue-live (⭐267)](https://github.com/vue-styleguidist/vue-live) - A component to demo components, inspired by react-live.
...
*   [Akaunting (⭐9.8k)](https://github.com/akaunting/akaunting) - A free and online accounting software for small businesses and freelancers based on Laravel and VueJS.
...
*   [Pychat (⭐244)](https://github.com/akoidan/pychat) - Self-hosted webrtc video chat (an alternative to Slack)
...
*   [Vue Crypto Dashboard (⭐243)](https://github.com/JayeshLab/vue-crypto-dashboard) - Cryptocurrency Dashboard made with Vue.js
...
*   [QMK Configurator (⭐831)](https://github.com/qmk/qmk_configurator) - QMK Firmware Keyboard Configuration UI in Vue.js.
...
*   [Laravel + Nuxt.js boilerplate (⭐693)](https://github.com/acidjazz/laranuxt) - by [@acidjazz](https://github.com/acidjazz)
...
*   [vue-currency-input (⭐696)](https://github.com/dm4t2/vue-currency-input) - Easy input of currency formatted numbers for Vue.js.
...
*   [Vue Org Chart (⭐350)](https://github.com/Hoogkamer/vue-org-chart) - Manage and publish your interactive organization chart (orgchart), free and no webserver required.
...
*   [vue-announcer (⭐238)](https://github.com/vue-a11y/vue-announcer) - A simple way with Vue to announce any useful information for screen readers.
...
*   [Socialhome (⭐382)](https://github.com/jaywink/socialhome) - A federated rich profile builder with social networking features

## [Apr 28, 2018](/content/2018/04/28/README.md)

### Components & Libraries / UI Components

*   [v-dialogs (⭐133)](https://github.com/TerryZ/v-dialogs) - A simple and powerful dialog, including Modal, Alert, Mask and Toast modes, based on Vue2.x
