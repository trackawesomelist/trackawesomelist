...
A curated list of awesome Hacking. Inspired by [awesome-machine-learning (⭐62k)](https://github.com/josephmisiti/awesome-machine-learning/)

If you want to contribute to this list (please do), send me a pull request!

For a list of free hacking books available for download, go [here (⭐4k)](https://github.com/Hack-with-Github/Free-Security-eBooks)
