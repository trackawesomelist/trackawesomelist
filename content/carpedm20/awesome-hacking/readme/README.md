...
A curated list of awesome Hacking. Inspired by [awesome-machine-learning (⭐56k)](https://github.com/josephmisiti/awesome-machine-learning/)
...
For a list of free hacking books available for download, go [here (⭐3.5k)](https://github.com/Hack-with-Github/Free-Security-eBooks)
