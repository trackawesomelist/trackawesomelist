...
*   [Circe (⭐376)](https://github.com/emacs-circe/circe) - For use in Emacs, sane defaults. `Emacs`
...
*   [BitBot (⭐128)](https://github.com/bitbot-irc/bitbot) - Modular, event-driven bot featuring a REST API, individual user settings and much more. ([bitbot.dev](https://bitbot.dev)) `Python`
...
*   [Convos](https://convos.chat) - Always online web IRC client. ([source (⭐932)](https://github.com/convos-chat/convos)) `Perl` `JavaScript` `Web`
...
*   [Iridium](https://appcenter.elementary.io/com.github.avojak.iridium/) - Friendly IRC client built in Vala and GTK, designed for elementary OS. ([source (⭐50)](https://github.com/avojak/iridium)) `Linux`
...
*   [Kiwi IRC](https://kiwiirc.com) - Powerful modern IRC messenger for the web. ([source (⭐737)](https://github.com/kiwiirc/kiwiirc), [demo](https://kiwiirc.com/nextclient/)) `Web`
...
*   [Quassel](https://quassel-irc.org) - Distributed (clients can attach to and detach from a central core that stays permanently online. ([source (⭐685)](https://github.com/quassel/quassel)) `Linux` `macOS` `Windows`
...
*   [Revolution IRC (⭐469)](https://github.com/MCMrARM/revolution-irc) - Feature-full, actively maintained Android IRC client. `Android`
...
*   [IRCCloud](https://www.irccloud.com) - Group chat for teams, friends, and communities. stay connected, chat from anywhere, and never miss a message (+client) (£0-£3.50/month).
    ...
    *   [Android App (⭐276)](https://github.com/irccloud/android) - Official. `Java`
...
*   [miniircd (⭐390)](https://github.com/jrosdahl/miniircd) - Very simple and limited.
*   [ngIRCd](https://ngircd.barton.de) - Portable and lightweight for small or private networks. ([source (⭐360)](https://github.com/ngircd/ngircd))

### Services / Self-hosted

*   [Atheme](https://atheme.github.io) - Designed for large networks with high scalability requirements. ([source (⭐360)](https://github.com/atheme/atheme))
*   [anope](https://anope.org) - Designed for flexibility and ease of use. ([source (⭐282)](https://github.com/anope/anope))

### Bots / Self-hosted

*   [Sopel](https://sopel.chat) - Tonnes of ready made features, tutorial, fully documented. ([source (⭐927)](https://github.com/sopel-irc/sopel)) `Python`
*   [Limnoria (⭐589)](https://github.com/ProgVal/Limnoria) - Robust, user friendly, developer friendly. `Python`
...
*   [Skybot (⭐241)](https://github.com/rmmh/skybot) - Main goals are simplicity and power. `Python`
...
*   [go-ircevent (⭐447)](https://github.com/thoj/go-ircevent) - Event-based. `Go`
...
*   [irc-slack (⭐170)](https://github.com/insomniacslk/irc-slack) - Slack ↔ IRC. `Go`
...
*   [Modern IRC Documents](https://modern.ircdocs.horse) - An attempt to write an update to the original IRC protocol. documentation ([source (⭐166)](https://github.com/ircdocs/modern-irc))
...
*   [matterbridge (⭐5.6k)](https://github.com/42wim/matterbridge) - IRC ↔ Mattermost ↔ Discord ↔ XMPP ↔ Gitter ↔ Slack ↔ Discord ↔ Telegram ↔ etc. `Go`
