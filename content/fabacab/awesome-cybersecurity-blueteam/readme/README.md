...
See also [awesome-devsecops (⭐3.4k)](https://github.com/devsecops/awesome-devsecops).
...
See also [awesome-honeypots (⭐6.5k)](https://github.com/paralax/awesome-honeypots).
...
See also [awesome-incident-response (⭐5.7k)](https://github.com/meirwah/awesome-incident-response).
...
See also [awesome-pentest § Social Engineering Tools (⭐160)](https://github.com/fabacab/awesome-pentest#social-engineering-tools).
...
See also [awesome-pcaptools (⭐2.6k)](https://github.com/caesar0301/awesome-pcaptools).
...
See also [awesome-sysadmin#monitoring (⭐16k)](https://github.com/n1trux/awesome-sysadmin#monitoring).
...
See also [awesome-threat-detection (⭐2.4k)](https://github.com/0x4D31/awesome-threat-detection).
...
See also [awesome-threat-intelligence (⭐5.6k)](https://github.com/hslatman/awesome-threat-intelligence).
...
See also [awesome-tor (⭐316)](https://github.com/ajvb/awesome-tor).
...
See also [awesome-windows#security (⭐21k)](https://github.com/Awesome-Windows/Awesome#security) and [awesome-windows-domain-hardening (⭐1.5k)](https://github.com/PaulSec/awesome-windows-domain-hardening).
