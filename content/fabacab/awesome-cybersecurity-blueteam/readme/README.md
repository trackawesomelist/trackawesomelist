...
See also [awesome-devsecops (⭐4.1k)](https://github.com/devsecops/awesome-devsecops).
...
See also [Awesome-Fuzzing (⭐4.8k)](https://github.com/secfigo/Awesome-Fuzzing).
...
See also [awesome-honeypots (⭐7.5k)](https://github.com/paralax/awesome-honeypots).
...
*   [Bubblewrap (⭐3.4k)](https://github.com/containers/bubblewrap) - Sandboxing tool for use by unprivileged Linux users capable of restricting access to parts of the operating system or user data.
...
See also [awesome-incident-response (⭐6.6k)](https://github.com/meirwah/awesome-incident-response).
...
See also [awesome-pentest § Social Engineering Tools (⭐202)](https://github.com/fabacab/awesome-pentest#social-engineering-tools).
...
See also [awesome-pcaptools (⭐2.9k)](https://github.com/caesar0301/awesome-pcaptools).
...
See also [awesome-sysadmin#monitoring (⭐20k)](https://github.com/n1trux/awesome-sysadmin#monitoring).
...
See also [awesome-threat-detection (⭐3k)](https://github.com/0x4D31/awesome-threat-detection).
...
See also [awesome-threat-intelligence (⭐6.6k)](https://github.com/hslatman/awesome-threat-intelligence).
...
See also [awesome-tor (⭐371)](https://github.com/ajvb/awesome-tor).
...
See also [awesome-windows#security (⭐24k)](https://github.com/Awesome-Windows/Awesome#security) and [awesome-windows-domain-hardening (⭐1.7k)](https://github.com/PaulSec/awesome-windows-domain-hardening).
