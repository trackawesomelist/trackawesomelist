...
See also [awesome-devsecops (⭐4k)](https://github.com/devsecops/awesome-devsecops).
...
*   [snync (⭐30)](https://github.com/snyk-labs/snync) - Prevent and detect if you're vulnerable to dependency confusion supply chain security attacks.

### Fuzzing

See also [Awesome-Fuzzing (⭐4.7k)](https://github.com/secfigo/Awesome-Fuzzing).
...
*   [Notary (⭐3.1k)](https://github.com/theupdateframework/notary) - Aims to make the internet more secure by making it easy for people to publish and verify content.
*   [in-toto](https://in-toto.io/) - Framework to secure the integrity of software supply chains.

## Honeypots

See also [awesome-honeypots (⭐7.2k)](https://github.com/paralax/awesome-honeypots).
...
See also [awesome-incident-response (⭐6.4k)](https://github.com/meirwah/awesome-incident-response).
...
See also [awesome-pentest § Social Engineering Tools (⭐197)](https://github.com/fabacab/awesome-pentest#social-engineering-tools).
...
See also [awesome-pcaptools (⭐2.8k)](https://github.com/caesar0301/awesome-pcaptools).
...
See also [awesome-sysadmin#monitoring (⭐19k)](https://github.com/n1trux/awesome-sysadmin#monitoring).
...
See also [awesome-threat-detection (⭐2.9k)](https://github.com/0x4D31/awesome-threat-detection).
...
See also [awesome-threat-intelligence (⭐6.4k)](https://github.com/hslatman/awesome-threat-intelligence).
...
See also [awesome-tor (⭐352)](https://github.com/ajvb/awesome-tor).
...
See also [awesome-windows#security (⭐23k)](https://github.com/Awesome-Windows/Awesome#security) and [awesome-windows-domain-hardening (⭐1.7k)](https://github.com/PaulSec/awesome-windows-domain-hardening).
