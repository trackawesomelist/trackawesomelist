...
See also [awesome-devsecops (⭐3.9k)](https://github.com/devsecops/awesome-devsecops).
...
See also [awesome-honeypots (⭐7.1k)](https://github.com/paralax/awesome-honeypots).
...
See also [awesome-pentest § Social Engineering Tools (⭐195)](https://github.com/fabacab/awesome-pentest#social-engineering-tools).
...
See also [awesome-threat-detection (⭐2.8k)](https://github.com/0x4D31/awesome-threat-detection).
...
See also [awesome-threat-intelligence (⭐6.3k)](https://github.com/hslatman/awesome-threat-intelligence).
