...
See also [awesome-devsecops (⭐3.3k)](https://github.com/devsecops/awesome-devsecops).
...
See also [Awesome-Fuzzing (⭐4.4k)](https://github.com/secfigo/Awesome-Fuzzing).
...
See also [awesome-honeypots (⭐6.4k)](https://github.com/paralax/awesome-honeypots).
...
See also [awesome-incident-response (⭐5.6k)](https://github.com/meirwah/awesome-incident-response).
...
See also [awesome-pentest § Social Engineering Tools (⭐152)](https://github.com/fabacab/awesome-pentest#social-engineering-tools).
...
See also [awesome-sysadmin#monitoring (⭐15k)](https://github.com/n1trux/awesome-sysadmin#monitoring).
...
See also [awesome-threat-intelligence (⭐5.5k)](https://github.com/hslatman/awesome-threat-intelligence).
...
See also [awesome-tor (⭐305)](https://github.com/ajvb/awesome-tor).
...
See also [awesome-windows#security (⭐20k)](https://github.com/Awesome-Windows/Awesome#security) and [awesome-windows-domain-hardening (⭐1.5k)](https://github.com/PaulSec/awesome-windows-domain-hardening).
