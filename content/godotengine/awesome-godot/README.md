...
*   [Health, HitBoxes, HurtBoxes, and HitScans (⭐36)](https://github.com/cluttered-code/godot-health-hitbox-hurtbox) - 2D and 3D Components to manage health, damage, and healing.
...
*   [A Dark Forest (⭐79)](https://github.com/TinyTakinTeller/GodotProjectZero) - Minimalistic incremental game inspired by "A Dark Room".
...
*   [System Bar Color Changer (⭐23)](https://github.com/syntaxerror247/godot-android-system-bar-color-changer) - An Android plugin that enables you to dynamically change the colors of the status bar and navigation bar, and also supports enabling translucent system bars for a modern, immersive UI experience.
...
*   [Starship Olympics (⭐516)](https://github.com/notapixelstudio/starship-olympics) - Fast-paced local party game with starships that battle in a top-down arena.

## [Aug 08, 2024](/content/2024/08/08/README.md)

### Plugins and scripts / Godot 4

*   [Dialogue Engine (⭐193)](https://github.com/Rubonnek/dialogue-engine) - Minimalistic dialogue engine that fits into your GUI nodes and automatically graphs the branching dialogues for easy debugging.
...
*   [PixelPen (⭐116)](https://github.com/pixelpen-dev/pixelpen) - Pixel art drawing and animation: Common drawing tools such as selection, shape creation, mirroring, tiling, and animation features within the Godot editor.
...
*   [Godot Google Play Game Services (⭐181)](https://github.com/Iakobs/godot-play-game-services) - Integrate Google Play Games Services in your Godot game.

### Plugins and scripts / Godot 3

*   [Godot Google Play Games Services (⭐26)](https://github.com/Iakobs/godot-google-play-game-services-android-plugin) - Integrate Google Play Games Services in your Godot game.
...
*   [AnimatedShape2D (⭐149)](https://github.com/Goutte/godot-addon-animated-shape-2d) - Animate a CollisionShape2D along with the frames of an AnimatedSprite2D.
...
*   [SimpleGodotCRTShader (⭐364)](https://github.com/henriquelalves/SimpleGodotCRTShader) - A simple Godot shader that simulates CRT Displays. *(Godot 2 and 3)*
...
*   [obs-websocket-gd (⭐94)](https://github.com/you-win/obs-websocket-gd) - Script and editor plugin to control Open Broadcaster Software from Godot via obs-websocket.
...
*   [Godot Demo Projects (⭐6.5k)](https://github.com/godotengine/godot-demo-projects) - Official Godot demo projects (everything except the TPS demo).
...
*   [godot-ink (⭐650)](https://github.com/paulloz/godot-ink) - A C# (Mono) plugin to integrate stories writen in [ink (⭐4.3k)](https://github.com/inkle/ink), a scripting language for writing interactive narrative.
...
*   [Crystal Bit Godot Game Template (⭐679)](https://github.com/crystal-bit/godot-game-template) - Opinionated game template. It includes continuous integration, scene loading with graphic transitions and game pause handling.
...
*   [Godot experiments (⭐802)](https://github.com/MrEliptik/godot_experiments) - Several 2D, 3D and VR experiments.
...
*   [2D Destructible Objects (⭐406)](https://github.com/hiulit/Godot-3-2D-Destructible-Objects) - A script that takes a sprite, divides it into blocks and makes them explode💥.
...
*   [RetroPie Godot Game Engine "Emulator" (⭐98)](https://github.com/hiulit/RetroPie-Godot-Game-Engine-Emulator) - A scriptmodule to install a Godot "emulator" for RetroPie.
