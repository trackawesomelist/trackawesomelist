...
*   [Fast Fourier Transform (FFT) (⭐9)](https://github.com/tavurth/godot-fft) - Fast Fourier Transform in GDScript (Godot 4.x).
...
*   [SimpleGodotCRTShader (⭐308)](https://github.com/henriquelalves/SimpleGodotCRTShader) - A simple Godot shader that simulates CRT Displays (Godot 2.x, 3.x).
...
*   [Godot Demo Projects (⭐3.2k)](https://github.com/godotengine/godot-demo-projects) - Official Godot demo projects (everything except the TPS demo).
*   [TPS Demo (⭐743)](https://github.com/godotengine/tps-demo) - Official Godot third person shooter (TPS) demo with high quality graphics.
...
*   [Voxel-Core (⭐382)](https://github.com/ClarkThyLord/Voxel-Core) - GDScript voxel plugin for creating, importing and editing voxel content in-engine and in-game.
...
*   [godot-ink (⭐311)](https://github.com/paulloz/godot-ink) - A C# (Mono) plugin to integrate stories writen in [ink (⭐3.5k)](https://github.com/inkle/ink), a scripting language for writing interactive narrative.
...
*   [Raspberry Pi 4 builds (⭐247)](https://github.com/hiulit/Unofficial-Godot-Engine-Raspberry-Pi) - ARM builds of Godot Engine for the Raspberry Pi 4.
...
*   [godot-ci (⭐422)](https://github.com/aBARICHELLO/godot-ci) - Docker image to export Godot games through CI. Includes GitLab CI script example.
