...
*   [Godot Google Play Game Services (⭐78)](https://github.com/Iakobs/godot-play-game-services) - Integrate Google Play Games Services in your Godot game.

### Plugins and scripts / Godot 3.2+

*   [Godot Google Play Games Services (⭐18)](https://github.com/Iakobs/godot-google-play-game-services-android-plugin) - Integrate Google Play Games Services in your Godot game.
...
*   [GdUnit4 (⭐457)](https://github.com/MikeSchulze/gdUnit4) - Godot Unit Testing Framework (Godot 4.x).
...
*   [AnimatedShape2D (⭐86)](https://github.com/Goutte/godot-addon-animated-shape-2d) - Animate a CollisionShape2D along with the frames of an AnimatedSprite2D.
...
*   [Fast Fourier Transform (FFT) (⭐28)](https://github.com/tavurth/godot-fft) - Fast Fourier Transform in GDScript (Godot 4.x).

## [Jan 27, 2023](/content/2023/01/27/README.md)

### Plugins and scripts / Godot 3.2+

*   [Wwise (⭐261)](https://github.com/alessandrofama/wwise-godot-integration) - Wwise audio middleware integration.
...
*   [vpuppr (⭐714)](https://github.com/virtual-puppet-project/vpuppr) - A cross-platform VTuber application with mulitple tracking backends.

### Modules / Godot 3.2+

*   [spout-gd (⭐32)](https://github.com/you-win/spout-gd) - Share OpenGL textures across Windows applications through your GPU using [Spout (⭐718)](https://github.com/leadedge/Spout2).
...
*   [SimpleGodotCRTShader (⭐341)](https://github.com/henriquelalves/SimpleGodotCRTShader) - A simple Godot shader that simulates CRT Displays (Godot 2.x, 3.x).
...
*   [Aseprite Wizard (⭐725)](https://github.com/viniciusgerevini/godot-aseprite-wizard) - Plugin for importing animations from Aseprite as SpriteFrames (Godot 3.x).
...
*   [godot-ink (⭐539)](https://github.com/paulloz/godot-ink) - A C# (Mono) plugin to integrate stories writen in [ink (⭐3.9k)](https://github.com/inkle/ink), a scripting language for writing interactive narrative.
...
*   [Crystal Bit Godot Game Template (⭐587)](https://github.com/crystal-bit/godot-game-template) - Opinionated game template. It includes continuous integration, scene loading with graphic transitions and game pause handling.

## [May 20, 2021](/content/2021/05/20/README.md)

### Plugins and scripts / Godot 3.2+

*   [NativeLib (⭐89)](https://github.com/DrMoriarty/nativelib) - Plugin management system designed to easily operate with native libraries for iOS/Android. It also takes care about plugin dependencies and provides hassle-free native libs updating. Attribution and analytics: Adjust, Amplitude, AppsFlyer, Flurry, GameAnalytics, Tenjin. Ads networks and mediation: AdColony, AppLovin, TapDaq. GDPR and privacy: App Tracking Transparency, Ogury. Social: Facebook. Universal backend solution: Firebase.
...
*   [Arrow (⭐818)](https://github.com/mhgolkar/Arrow) - A tool to design game narratives with nodes.
...
*   [Tree generator (⭐158)](https://github.com/Zylann/godot_tree_generator_plugin) - Tool for generating trees.

### Modules / Godot 3.2+

*   [Speech to Text (⭐32)](https://github.com/menip/godot_speech_to_text) - Captures the user's microphone input and converts it to text.
...
*   [Godot experiments (⭐641)](https://github.com/MrEliptik/godot_experiments) - Several 2D, 3D and VR experiments.
