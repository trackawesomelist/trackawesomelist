...
*   [Beep Saber VR (⭐103)](https://github.com/NeoSpark314/BeepSaber) - Beat Saber clone in Godot.
*   [Friday Night Funkin\` (⭐42)](https://github.com/this-is-bennyk/Funkin-VR) - VR port of the popular rhythm game.

### Templates / Godot 4.2+

*   [Godot XR Template (⭐131)](https://github.com/godotVR/godot-xr-template) - Template for a multi-level XR game.

### Plugins and scripts / Godot 4.2+

*   [Godot XR Tools (⭐500)](https://github.com/godotvr/godot-xr-tools) - Basic components for XR development.
*   [TerraBrush (⭐663)](https://github.com/spimort/TerraBrush) - Minimal Terrain heightmap editor that features sculpting, painting textures, LOD, and MultiZones.

## [Aug 20, 2024](/content/2024/08/20/README.md)

### 3D / Godot 4.3

*   [OpenLiberty (⭐143)](https://github.com/FOSS-Supremacy/OpenLiberty) - An open-source reimplementation of Grand Theft Auto III on the Godot Engine.

## [Aug 10, 2024](/content/2024/08/10/README.md)

### 2D / Godot 3.2+

*   [Starship Olympics (⭐510)](https://github.com/notapixelstudio/starship-olympics) - Fast-paced local party game with starships that battle in a top-down arena.

## [Aug 08, 2024](/content/2024/08/08/README.md)

### Plugins and scripts / Godot 4.2+

*   [Dialogue Engine (⭐44)](https://github.com/Rubonnek/dialogue-engine) - Minimalistic dialogue engine that fits into your GUI nodes and automatically graphs the branching dialogues for easy debugging.
...
*   [PixelPen (⭐87)](https://github.com/pixelpen-dev/pixelpen) - Pixel art drawing and animation: Common drawing tools such as selection, shape creation, mirroring, tiling, and animation features within the Godot editor.
...
*   [Godot Google Play Game Services (⭐113)](https://github.com/Iakobs/godot-play-game-services) - Integrate Google Play Games Services in your Godot game.

### Plugins and scripts / Godot 3.2+

*   [Godot Google Play Games Services (⭐22)](https://github.com/Iakobs/godot-google-play-game-services-android-plugin) - Integrate Google Play Games Services in your Godot game.

## [Jun 13, 2024](/content/2024/06/13/README.md)

### Plugins and scripts / Various Godot versions

*   [Friflo.Engine.ECS (⭐164)](https://github.com/friflo/Friflo.Json.Fliox/blob/main/Engine/README.md) - High-performance C# ECS with simple API. Supports .NET, WASM/WebAssembly, Native AOT, Godot, Unity, MonoGame, ... (Godot 3.x, 4.x).

## [May 29, 2024](/content/2024/05/29/README.md)

### 3D / Godot 4.3

*   [LibreAim (⭐104)](https://github.com/Nokorpo/LibreAim) - Libre FPS aim trainer made with Godot.

## [May 14, 2024](/content/2024/05/14/README.md)

### Templates / Godot 4.2+

*   [Maaack's Game Template (⭐422)](https://github.com/Maaack/Godot-Game-Template) - Template with a main menu, options menus, pause menu, credits, scene loader, extra tools, and an example game scene.

### Plugins and scripts / Godot 4.2+

*   [Maaack's Game Template Plugin (⭐422)](https://github.com/Maaack/Godot-Game-Template) - Template with a main menu, options menus, pause menu, credits, scene loader, extra tools, and an example game scene.
*   [Maaack's Menus Template (⭐121)](https://github.com/Maaack/Godot-Menus-Template) - Template with a main menu, options menus, credits, and a scene loader.
*   [Maaack's Scene Loader (⭐22)](https://github.com/Maaack/Godot-Scene-Loader) - Scene loader that includes a loading screen, progress bar, and error handling.

## [Apr 27, 2024](/content/2024/04/27/README.md)

### 3D / Godot 4.2

*   [Reia (⭐126)](https://github.com/Quaint-Studios/Reia) - A free game that's an action adventure RPG for Desktop and Mobile with multiplayer, MMO, and offline support.

## [Mar 24, 2024](/content/2024/03/24/README.md)

### 2D / Godot 3.2+

*   [Flappy Race (⭐26)](https://github.com/Jibby-Games/Flappy-Race) - A 2D online multiplayer game inspired by Flappy Bird and Mario Kart for desktop and HTML5.

## [Mar 12, 2024](/content/2024/03/12/README.md)

### Plugins and scripts / Various Godot versions

*   [Virtual Joystick (⭐695)](https://github.com/MarcoFazioRandom/Virtual-Joystick-Godot) - A virtual joystick for touchscreens. Simple to use and with useful options (Godot 3.x, 4.x).

## [Mar 06, 2024](/content/2024/03/06/README.md)

### Plugins and scripts / Various Godot versions

*   [3D Auto Collision Generator (⭐30)](https://github.com/ThGnommy/godot_3d_auto_collision_generator) - Generate collision for multiple 3D objects in one click (Godot 4.x).

## [Mar 05, 2024](/content/2024/03/05/README.md)

### Plugins and scripts / Godot 4.2+

*   [LimboAI (⭐1.1k)](https://github.com/limbonaut/limboai) - Behavior trees and state machines. Comes with editor, visual debugger, comprehensive demo and tutorial.

## [Feb 19, 2024](/content/2024/02/19/README.md)

### Plugins and scripts / Various Godot versions

*   [GdUnit4 (⭐562)](https://github.com/MikeSchulze/gdUnit4) - Godot Unit Testing Framework (Godot 4.x).
...
*   [Godot Spin Button (⭐62)](https://github.com/yudinikita/godot-spin-button) - Horizontal Selector with extended options (Godot 4.x).

## [Jan 29, 2024](/content/2024/01/29/README.md)

### Plugins and scripts / Various Godot versions

*   [QuestSystem (⭐236)](https://github.com/ShomyKohai/quest-system) - A simple and extensible quest manager and creator (Godot 4.x).

## [Jan 13, 2024](/content/2024/01/13/README.md)

### Plugins and scripts / Godot 4.2+

*   [AnimatedShape2D (⭐118)](https://github.com/Goutte/godot-addon-animated-shape-2d) - Animate a CollisionShape2D along with the frames of an AnimatedSprite2D.

## [Jan 06, 2024](/content/2024/01/06/README.md)

### Modules / Various Godot versions

*   [godot-box2d (⭐325)](https://github.com/appsinacup/godot-box2d) - A [Box2D (⭐8.1k)](https://github.com/erincatto/box2d) physics server for Godot (Godot 4.2).
*   [godot-jolt (⭐2.1k)](https://github.com/godot-jolt/godot-jolt) - Allows you to use the [Jolt Physics Engine (⭐6.5k)](https://github.com/jrouwe/JoltPhysics) (Godot 4.2).
*   [godot-rapier-2d (⭐337)](https://github.com/appsinacup/godot-rapier-2d) - A 2D [Rapier (⭐3.9k)](https://github.com/dimforge/rapier) physics server for Godot (Godot 4.2).
...
*   [Simplified Flight Simulation library (⭐182)](https://github.com/fbcosentino/godot-simplified-flightsim) - A library that helps you create a simple airplane/helicopter/spaceship flight simulator (Godot 3.x, 4.x).

## [Sep 15, 2023](/content/2023/09/15/README.md)

### Plugins and scripts / Various Godot versions

*   [Orchestrator (⭐938)](https://github.com/Vahera/godot-orchestrator) - Dialog and visual-scripting subsystem for 2D and 3D games (Godot 4.x).

## [Aug 28, 2023](/content/2023/08/28/README.md)

### Plugins and scripts / Various Godot versions

*   [SignalVisualizer (⭐357)](https://github.com/Ericdowney/SignalVisualizer) - Displays the current scene's signals and connections in a easy to read graph and tree dock (Godot 4.x).

## [Aug 10, 2023](/content/2023/08/10/README.md)

### Plugins and scripts / Various Godot versions

*   [Importality (⭐341)](https://github.com/nklbdev/godot-4-importality) - raster graphics and animations importers: Aseprite, Krita, Pencil2D, Piskel, Pixelorama and others (Godot 4.x).
...
*   [Cyclops Level Builder (⭐1k)](https://github.com/blackears/cyclopsLevelBuilder) - A level builder for quick prototypes and proof-of-concepts (Godot 4.x).
...
*   [godot-luaAPI (⭐377)](https://github.com/WeaselGames/godot_luaAPI) - Module for creating sandboxed modding APIs with Lua (Godot 3.2+, 4.0).
...
*   [Fast Fourier Transform (FFT) (⭐35)](https://github.com/tavurth/godot-fft) - Fast Fourier Transform in GDScript (Godot 4.x).

## [Jan 27, 2023](/content/2023/01/27/README.md)

### Plugins and scripts / Godot 3.2+

*   [Wwise (⭐282)](https://github.com/alessandrofama/wwise-godot-integration) - Wwise audio middleware integration.

## [Jan 13, 2023](/content/2023/01/13/README.md)

### Projects / Godot 3.5+

*   [GATT - Godot Autotile Texture Templater (⭐30)](https://github.com/sesopenko/gatt) - A tool for generating 2x2 and 3x3 autotile tilesets in whichever size and colour needed.
...
*   [vpuppr (⭐738)](https://github.com/virtual-puppet-project/vpuppr) - A cross-platform VTuber application with mulitple tracking backends.

### Modules / Godot 3.2+

*   [spout-gd (⭐36)](https://github.com/you-win/spout-gd) - Share OpenGL textures across Windows applications through your GPU using [Spout (⭐753)](https://github.com/leadedge/Spout2).

## [Aug 31, 2022](/content/2022/08/31/README.md)

### Plugins and scripts / Various Godot versions

*   [Dialogue Manager (⭐2.1k)](https://github.com/nathanhoad/godot_dialogue_manager) - A simple but powerful text based branching dialogue editor and runtime (Godot 3.x, 4.x).
*   [Input Helper (⭐752)](https://github.com/nathanhoad/godot_input_helper) - A helper for detecting input devices and remapping controls (Godot 3.x, 4.x).

## [Aug 07, 2022](/content/2022/08/07/README.md)

### Plugins and scripts / Various Godot versions

*   [Scene Manager (⭐334)](https://github.com/glass-brick/Scene-Manager) - Make nice and customizable scene transitions in one line of code (Godot 3.x, 4.0.alpha).

## [Aug 06, 2022](/content/2022/08/06/README.md)

### Plugins and scripts / Godot 3.2+

*   [godot-ply (⭐350)](https://github.com/jarneson/godot-ply) - In-editor box modelling for gray boxing or prototyping 3D levels.
...
*   [Godot FPS Template (⭐63)](https://github.com/MilkAndBanana01/godot-fps-template) - A free first person game template for the Godot Engine.
...
*   [Scrolling Background (⭐29)](https://github.com/dploeger/godot-scrollingbackground) - A scrolling background node (Godot 2.1,3.x).
*   [SimpleGodotCRTShader (⭐348)](https://github.com/henriquelalves/SimpleGodotCRTShader) - A simple Godot shader that simulates CRT Displays (Godot 2.x, 3.x).
...
*   [Godot First Person Camera (⭐57)](https://github.com/tavurth/godot-simple-fps-camera) - A simple FPS starter with jumping, movement, flashlight and a player character with animations.
...
*   [obs-websocket-gd (⭐87)](https://github.com/you-win/obs-websocket-gd) - Script and editor plugin to control Open Broadcaster Software from Godot via obs-websocket (Godot 3.x).
...
*   [Aseprite Wizard (⭐835)](https://github.com/viniciusgerevini/godot-aseprite-wizard) - Plugin for importing animations from Aseprite as SpriteFrames (Godot 3.x).

## [Aug 15, 2021](/content/2021/08/15/README.md)

### Demos / Godot 3.2+

*   [Godot Demo Projects (⭐5.8k)](https://github.com/godotengine/godot-demo-projects) - Official Godot demo projects (everything except the TPS demo).
...
*   [godot-ink (⭐583)](https://github.com/paulloz/godot-ink) - A C# (Mono) plugin to integrate stories writen in [ink (⭐4.1k)](https://github.com/inkle/ink), a scripting language for writing interactive narrative.

## [Jul 19, 2021](/content/2021/07/19/README.md)

### Plugins and scripts / Various Godot versions

*   [Godot SQLite (⭐920)](https://github.com/2shady4u/godot-sqlite) - GDNative wrapper for SQLite, making it possible to use SQLite databases as data storage in your project (Godot 3.2+).

## [Jul 16, 2021](/content/2021/07/16/README.md)

### Plugins and scripts / Various Godot versions

*   [AgonesSDK (⭐60)](https://github.com/AndreMicheletti/godot-agones-sdk) - Plugin to add [Agones (⭐6k)](https://github.com/googleforgames/agones) SDK functionality to Godot (Godot 3.x).

## [Jul 14, 2021](/content/2021/07/14/README.md)

### Plugins and scripts / Various Godot versions

*   [StoryTeller Engine (⭐31)](https://github.com/HeavenMercy/StoryTeller-Engine) - Dialog and interactive fiction engine (Godot 3.x).

## [Jun 27, 2021](/content/2021/06/27/README.md)

### Plugins and scripts / Godot 3.2+

*   [Godot Polygon 2D Fracture (⭐326)](https://github.com/SoloByte/godot-polygon2d-fracture) - Two simple scripts for fracturing and cutting polygons.
...
*   [build-godot (⭐58)](https://github.com/aaronfranke/Linux-tools/blob/master/all-distros/build-godot) - (and [build-godot-mono (⭐58)](https://github.com/aaronfranke/Linux-tools/blob/master/all-distros/build-godot-mono)) Scripts that compile and run Godot, attempting to install dependencies if needed.

## [May 21, 2021](/content/2021/05/21/README.md)

### Templates / Godot 3.2+

*   [Crystal Bit Godot Game Template (⭐627)](https://github.com/crystal-bit/godot-game-template) - Opinionated game template. It includes continuous integration, scene loading with graphic transitions and game pause handling.
...
*   [Escoria (⭐786)](https://github.com/godotengine/escoria) - Point & click adventure game framework (Godot 2.1, 3.2+).
...
*   [Texture Packer (⭐62)](https://github.com/Relintai/texture_packer) - Tools to layer, pack, and merge textures at runtime (Godot 3.2+, 4.0).
*   [Voxelman (⭐94)](https://github.com/Relintai/voxelman) - A voxel engine with more focus on editor integration, gameplay-related features, and extendability (Godot 3.2+, 4.0).
...
*   [Arrow (⭐860)](https://github.com/mhgolkar/Arrow) - A tool to design game narratives with nodes.

## [Mar 13, 2021](/content/2021/03/13/README.md)

### Plugins and scripts / Various Godot versions

*   [EffekseerForGodot3 (⭐133)](https://github.com/effekseer/EffekseerForGodot3) - Import [Effekseer](https://effekseer.github.io/en/) particle effects (Godot 3.x).
...
*   [Flash Module (⭐38)](https://github.com/funexpected/godot-flash-module) - Use Adobe Animate (Flash) projects in Godot.

## [Feb 23, 2021](/content/2021/02/23/README.md)

### Plugins and scripts / Various Godot versions

*   [Ridiculous Coding (⭐838)](https://github.com/jotson/ridiculous_coding) - Makes your coding experience in Godot 1000× more ridiculous (Godot 3.x).
...
*   [Shell Fur (⭐301)](https://github.com/Arnklit/ShellFurGodot) - 3D fur node for Godot.

## [Feb 21, 2021](/content/2021/02/21/README.md)

### Plugins and scripts / Various Godot versions

*   [Anima (⭐672)](https://github.com/ceceppa/anima) - Run sequential and parallel animations with less code compared to Tween (Godot 3.x).
*   [SmartShape2D (⭐1.3k)](https://github.com/SirRamEsq/SmartShape2D) - A 2D terrain tool (Godot 3.x, 4.x).
...
*   [Godot experiments (⭐670)](https://github.com/MrEliptik/godot_experiments) - Several 2D, 3D and VR experiments.
...
*   [Kehom's Godot Addon Pack (⭐190)](https://github.com/Kehom/GodotAddonPack) - A collection of addons for debugging, networking, UI, and more.

## [Feb 03, 2021](/content/2021/02/03/README.md)

### Plugins and scripts / Various Godot versions

*   [2D Destructible Objects (⭐394)](https://github.com/hiulit/Godot-3-2D-Destructible-Objects) - A script that takes a sprite, divides it into blocks and makes them explode💥 (Godot 3.x).
*   [CRT Shader (⭐299)](https://github.com/hiulit/Godot-3-2D-CRT-Shader) - A Godot shader that simulates CRT Displays with many shader parameters (Godot 3.x).
...
*   [2D Day/Night Cycle (⭐334)](https://github.com/hiulit/Godot-3-2D-Day-Night-Cycle) - A ☀️ Day / 🌔 Night cycle for 2D (Godot 3.x).

### Plugins and scripts / Godot version unknown

*   [GDSerCommPlugin (⭐77)](https://github.com/NangiDev/GDSerCommPlugin) - A plugin to read Arduino serial input (needs custom engine modules).
...
*   [Entity Spell System (⭐155)](https://github.com/Relintai/entity_spell_system) - An entity and spell system for complex (optionally multiplayer) RPGs (Godot 3.2, 4.0).
...
*   [Goost (⭐473)](https://github.com/goostengine/goost) - A general-purpose, extensible and customizable extension.
...
*   [DynaDungeons (⭐216)](https://github.com/akien-mga/dynadungeons) - Bomberman clone in a fantasy universe.
...
*   [First Person Starter (⭐616)](https://github.com/Whimfoome/godot-FirstPersonStarter) - Template with First Person Controller, easily adjustable from the Inspector.
...
*   [Realistic Water Shader (⭐712)](https://github.com/godot-extended-libraries/godot-realistic-water) - Realistic 3D water shader with foam and caustics.
*   [OpenRPG (⭐1.9k)](https://github.com/GDquest/godot-open-rpg) - JRPG-style game demo and template.
*   [voxelgame (⭐549)](https://github.com/Zylann/voxelgame) - Minecraft-like voxel terrain demo, utilising the godot\_voxel module.
...
*   [GodotPhoenixChannels (⭐275)](https://github.com/alfredbaudisch/GodotPhoenixChannels) - A GDScript and Godot Engine implementation for the Channels API of the Phoenix Framework (Godot 3.\*).
*   [GodotTIE (⭐287)](https://github.com/henriquelalves/GodotTIE) - Text Interface Engine to control text output (like in a RPG dialogue) (Godot 2.x, 3.x).
*   [gterm (⭐99)](https://github.com/TeddyDD/gterm) - GUI control that draws something similar to \*nix terminal emulators (Godot >= 2.1).
*   [GUT (⭐1.8k)](https://github.com/bitwes/Gut) - Utility for writing unit tests in GDScript (Godot 3.x).
*   [InGrid (⭐106)](https://github.com/Larpon/ingrid) - Infinite scrolling grid (Godot 3.x).
*   [Tiled importer (⭐834)](https://github.com/vnen/godot-tiled-importer) - Import maps from [Tiled](https://www.mapeditor.org/) (Godot 3.x).
...
*   [GDGIFExporter (⭐119)](https://github.com/jegor377/godot-gdgifexporter) - GIF exporter made entirely in GDScript.
...
*   [Godot NExt (⭐964)](https://github.com/godot-extended-libraries/godot-next) - A set of basic node extensions.
...
*   [Qodot (⭐974)](https://github.com/Shfty/qodot-plugin) - Quake `.map` file support for Godot. Lets you use [TrenchBroom](https://kristianduske.com/trenchbroom/) for level design.
*   [UI Design Tool (⭐359)](https://github.com/imjp94/UIDesignTool) - Intuitive design workflow for UIs in the editor.
*   [Volumetrics (⭐326)](https://github.com/SIsilicon/Godot-Volumetrics-Plugin) - Voxel-based volumetric lighting and fog plugin.
...
*   [FMOD GDNative (⭐432)](https://github.com/utopia-rise/fmod-gdnative) - Plugin to use the FMOD audio engine in GDScript.
...
*   [Raspberry Pi 4 builds (⭐284)](https://github.com/hiulit/Unofficial-Godot-Engine-Raspberry-Pi) - ARM builds of Godot Engine for the Raspberry Pi 4.
...
*   [JetBrains Rider (C#) (⭐380)](https://github.com/JetBrains/godot-support) - Syntax highlighting, autocompletion and run configurations.

## [Aug 28, 2020](/content/2020/08/28/README.md)

### GDScript/C# editor support / Godot version unknown

*   [Emacs (⭐307)](https://github.com/godotengine/emacs-gdscript-mode) - Syntax highlighting, code folding, indentation and autocompletion.
*   [Vim (⭐482)](https://github.com/habamax/vim-godot) - Syntax highlighting, autocompletion and linting using the LSP server provided by the Godot editor. Also supports the Godot shader language.

## [Jun 23, 2020](/content/2020/06/23/README.md)

### Godot script editor syntax themes / Godot version unknown

*   [Godot syntax themes (⭐391)](https://github.com/godotengine/godot-syntax-themes) - 13 syntax themes including Ayu Mirage, Darcula, Gruvbox Dark, Monokai, One Dark, Solarized, and more.
...
*   [godot-gdscript-toolkit (⭐967)](https://github.com/Scony/godot-gdscript-toolkit) - Independent set of command line tools for working with GDScript - parser, linter and formatter (Godot 3.x).
...
*   [base16-godot (⭐32)](https://github.com/Calinou/base16-godot) - All [base16 (⭐582)](https://github.com/chriskempson/base16) themes.
...
*   [godot-ci (⭐726)](https://github.com/aBARICHELLO/godot-ci) - Docker image to export Godot games through CI. Includes GitLab CI script example.
