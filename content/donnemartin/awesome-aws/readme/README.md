...
*   [minio/mc :fire::fire::fire::fire: (⭐2.4k)](https://github.com/minio/mc) -  Minio Client for filesystem and cloud storage.
...
Other awesome lists can be found in [awesome (⭐240k)](https://github.com/sindresorhus/awesome) and [awesome-awesomeness (⭐30k)](https://github.com/bayandin/awesome-awesomeness).
