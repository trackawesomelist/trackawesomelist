...
*   [SoCMake (⭐35)](https://github.com/HEP-SoC/SoCMake) - CMake based build system for hardware (ASIC, FPGA) and System-on-Chip build automation. [`[LGPL]`](https://www.gnu.org/licenses/lgpl-3.0.en.html)

## [Aug 26 - Sep 01, 2024](/content/2024/35/README.md)

### Examples / Templates

*   [SeeMake (⭐12)](https://github.com/MhmRhm/SeeMake) - A feature-packed, ready-to-use CMake template with testing, static and dynamic checks, coverage reports, and more. [`[MIT]`](https://opensource.org/licenses/MIT)
...
*   [cmake-language-server (⭐390)](https://github.com/regen100/cmake-language-server) - CMake Language Server Protocol Implementation. [`[MIT]`](https://opensource.org/licenses/MIT)
...
*   [Modern CMake (⭐242)](https://github.com/toeb/moderncmake) - Modern CMake **PDF** and samples by the creator of [cmakepp (⭐441)](https://github.com/toeb/cmakepp). [`[MIT]`](https://opensource.org/licenses/MIT)
...
*   [fips (⭐497)](https://github.com/floooh/fips) - High-level build system/dependency management for distributed, multi-platform C/C++ projects. [`[MIT]`](https://opensource.org/licenses/MIT)
...
*   [cmake-modules (⭐584)](https://github.com/bilke/cmake-modules) - This is a collection of additional CMake modules. Most of them are from Ryan Pavlik. [`[BOOST]`](http://www.boost.org/LICENSE_1_0.txt)
...
*   [extra-cmake-modules (⭐150)](https://github.com/KDE/extra-cmake-modules) - [KDE](https://github.com/KDE)'s extra modules and scripts for CMake. [`[BSD3]`](https://opensource.org/licenses/BSD-3-Clause)
...
*   [cmakepp (⭐441)](https://github.com/toeb/cmakepp) - Enhancement Suite for the CMake Build System. [`[MIT]`](https://opensource.org/licenses/MIT)
