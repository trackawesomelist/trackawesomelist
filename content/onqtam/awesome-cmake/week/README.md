...
*   [FetchDependency (⭐4)](https://github.com/jpetrie/fetch-dependency) - Configuration-time retrieval, configuration and building of dependencies. [`[MIT]`](https://opensource.org/licenses/MIT)
...
*   [SeeMake (⭐13)](https://github.com/MhmRhm/SeeMake) - A feature-packed, ready-to-use CMake template with testing, static and dynamic checks, coverage reports, and more. [`[MIT]`](https://opensource.org/licenses/MIT)

## [May 16 - May 22, 2022](/content/2022/20/README.md)

### Other

*   [version-from-git (⭐7)](https://github.com/MhmRhm/version-from-git) - Bake git information into your binary. [`[MIT]`](https://opensource.org/licenses/MIT)
...
*   [toolchains (⭐96)](https://github.com/mosra/toolchains) - For cross-compiling with CMake. They are meant to be mainly used on ArchLinux. `[NO LICENSE]`
...
*   [Lecture](https://www.youtube.com/watch?v=y9kSr5enrSk) - Oh No! More Modern CMake ([slides (⭐171)](https://github.com/Bagira80/More-Modern-CMake/raw/master/OhNoMoreModernCMake.pdf))- by Deniz Bahadir, Meeting C++ 2019.
...
*   [pmm (⭐17)](https://github.com/AnotherFoxGuy/pmm) - PMM is a module for CMake that manages... package managers. [`[MIT]`](https://opensource.org/licenses/MIT)
...
*   [Lecture](https://www.youtube.com/watch?v=y7ndUhdQuU8) - More Modern CMake ([slides & examples (⭐171)](https://github.com/Bagira80/More-Modern-CMake))- by Deniz Bahadir, Meeting C++ 2018.
...
*   [cmake\_check (⭐24)](https://github.com/DaelDe/cmake_check) - Static analysis (linter) for the CMake language (e.g. to enforce modern CMake rules). [`[MIT]`](https://opensource.org/licenses/MIT)
...
*   [cpp-template (⭐54)](https://github.com/joshpeterson/cpp-template) - A template C++ repository, using CMake and Catch. `[NO LICENSE]`
...
*   [vcpkg (⭐27k)](https://github.com/Microsoft/vcpkg) - A tool to acquire and build C++ open source libraries. Uses CMake internally as a build script language. [`[MIT]`](https://opensource.org/licenses/MIT)
...
*   [GreatCMakeCookOff (⭐44)](https://github.com/UCL/GreatCMakeCookOff) - This is a repository of useful and less than useful CMake recipes. [`[MIT]`](https://opensource.org/licenses/MIT)
...
*   [cmake-unit (⭐39)](https://github.com/polysquare/cmake-unit) - Unit testing framework for CMake. [`[MIT]`](https://opensource.org/licenses/MIT)
...
*   [configure-cmake (⭐88)](https://github.com/nemequ/configure-cmake) - configure-cmake is an autotools-style configure script for CMake-based projects. [`[CC0-1.0]`](https://creativecommons.org/publicdomain/zero/1.0/)
*   [cmake-ast (⭐31)](https://github.com/polysquare/cmake-ast) - Python module to reduce a CMake file to an AST. [`[MIT]`](https://opensource.org/licenses/MIT)