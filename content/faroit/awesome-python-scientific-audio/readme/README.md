...
*   [pyfar](https://pyfar.readthedocs.io) [:octocat: (⭐136)](https://github.com/pyfar/pyfar) [:package:](https://pypi.org/project/pyfar/) - Read audio files, SOFA files, and COMSOL data with the [pyfar.io](https://pyfar.readthedocs.io/en/stable/modules/pyfar.io.html) module.
