...
| Link                                                                                                                                   | Preview                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| -------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Data Science For Beginners (⭐32k)](https://github.com/microsoft/Data-Science-For-Beginners)                                           | Microsoft are pleased to offer a 10-week, 20-lesson curriculum all about Data Science.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
*   [#tidytuesday (⭐7.9k)](https://github.com/rfordatascience/tidytuesday) A weekly data project aimed at the R ecosystem.
...
*   [PySpark Cheatsheet (⭐636)](https://github.com/kevinschaich/pyspark-cheatsheet)
...
*   [MLSys-NYU-2022 (⭐534)](https://github.com/jacopotagliabue/MLSys-NYU-2022/tree/main) - Slides, scripts and materials for the Machine Learning in Finance course at NYU Tandon, 2022.

*   [Hands-on Train and Deploy ML (⭐872)](https://github.com/Paulescu/hands-on-train-and-deploy-ml) - A hands-on course to train and deploy a serverless API that predicts crypto prices.
...
*   [datacompy (⭐620)](https://github.com/capitalone/datacompy) - DataComPy is a package to compare two Pandas DataFrames.
...
*   [seqlearn (⭐701)](https://github.com/larsmans/seqlearn)
*   [sklearn-bayes (⭐521)](https://github.com/AmazaspShumik/sklearn-bayes)
*   [sklearn-crfsuite (⭐432)](https://github.com/TeamHG-Memex/sklearn-crfsuite)
...
*   [scikit-opt (⭐6.3k)](https://github.com/guofei9987/scikit-opt)
*   [scikit-posthocs (⭐377)](https://github.com/maximtrp/scikit-posthocs)
...
*   [RuleFit (⭐431)](https://github.com/christophM/rulefit)
*   [pyGAM (⭐936)](https://github.com/dswah/pyGAM)
...
*   [CatBoost (⭐8.7k)](https://github.com/catboost/catboost)
*   [PerpetualBooster (⭐561)](https://github.com/perpetual-ml/perpetual)
...
*   [PyTorch (⭐96k)](https://github.com/pytorch/pytorch)
...
*   [Yolov8 (⭐50k)](https://github.com/ultralytics/ultralytics)

#### TensorFlow Ecosystem

*   [TensorFlow (⭐193k)](https://github.com/tensorflow/tensorflow)
...
| Link                                                                                                    | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [The Data Science Lifecycle Process (⭐522)](https://github.com/dslp/dslp)                               | The Data Science Lifecycle Process is a process for taking data science teams from Idea to Value repeatedly and sustainably. The process is documented in this repo                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| [ChemicalX (⭐759)](https://github.com/AstraZeneca/chemicalx)                                            | A PyTorch based deep learning library for drug pair scoring.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| [Trains (⭐6.4k)](https://github.com/allegroai/clearml)                                                  | Auto-Magical Experiment Manager, Version Control & DevOps for AI                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| [MindsDB (⭐38k)](https://github.com/mindsdb/mindsdb)                                                    | MindsDB is an Explainable AutoML framework for developers. With MindsDB you can build, train and use state of the art ML models in as simple as one line of code.                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| [Lightwood (⭐494)](https://github.com/mindsdb/lightwood)                                                | A Pytorch based framework that breaks down machine learning problems into smaller blocks that can be glued together seamlessly with an objective to build predictive models with one line of code.                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| [LineaPy (⭐671)](https://github.com/LineaLabs/lineapy)                                                  | Ever been frustrated with cleaning up long, messy Jupyter notebooks? With LineaPy, an open source Python library, it takes as little as two lines of code to transform messy development code into production pipelines.                                                                                                                                                                                                                                                                                                                                                                                       |
...
| [AutoGluon (⭐9.7k)](https://github.com/awslabs/autogluon)                                               | AutoML to easily produce accurate predictions for image, text, tabular, time-series, and multi-modal data                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| [Comet (⭐168)](https://github.com/comet-ml/comet-examples)                                              | An MLOps platform with experiment tracking, model production management, a model registry, and full data lineage to support your ML workflow from training straight through to production.                                                                                                                                                                                                                                                                                                                                                                                                                     |
| [Opik (⭐17k)](https://github.com/comet-ml/opik)                                                         | Evaluate, test, and ship LLM applications across your dev and production lifecycles.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| [Streamlit (⭐43k)](https://github.com/streamlit/streamlit)                                              | App framework for Machine Learning and Data Science projects                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [Gradio (⭐41k)](https://github.com/gradio-app/gradio)                                                   | Create customizable UI components around machine learning models                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| [Chinese-Elite (⭐57)](https://github.com/anonym-g/Chinese-Elite)                                        | An open-source project that automatically maps relationship networks by parsing public data using LLMs and visualizes it as an interactive graph.                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| [Desbordante (⭐439)](https://github.com/desbordante/desbordante-core/)                                  | An open-source data profiler specifically focused on discovery and validation of complex patterns,  such as [numerical association rules](https://colab.research.google.com/github/Desbordante/desbordante-core/blob/main/examples/notebooks/Numerical_Association_Rules.ipynb), [differential dependencies](https://colab.research.google.com/github/Desbordante/desbordante-core/blob/main/examples/notebooks/Differential_Dependencies.ipynb), [denial constraints](https://colab.research.google.com/github/Desbordante/desbordante-core/blob/main/examples/notebooks/Denial_Constraints.ipynb), and more. |
| [RunMat (⭐102)](https://github.com/runmat-org/runmat)                                                   | Fast MATLAB-syntax runtime with automatic CPU/GPU execution and fused array kernels.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
*   [Public Git Archive (⭐341)](https://github.com/src-d/datasets/tree/master/PublicGitArchive)
...
*   [5000 Images of Clothes (⭐114)](https://github.com/alexeygrigorev/clothing-dataset)
...
*   [awesome-python (⭐274k)](https://github.com/vinta/awesome-python)
...
*   [awesome-datasets (⭐71k)](https://github.com/awesomedata/awesome-public-datasets)
...
*   [Awesome Data Science Ideas (⭐691)](https://github.com/JosPolfliet/awesome-ai-usecases)
...
*   [Awesome Monte Carlo Tree Search (⭐689)](https://github.com/benedekrozemberczki/awesome-monte-carlo-tree-search-papers)
...
*   [Awesome Game Datasets (⭐977)](https://github.com/leomaurodesenv/game-datasets#readme)
*   [Data Science Interviews Questions (⭐9.7k)](https://github.com/alexeygrigorev/data-science-interviews)
...
*   [Awesome Data Analysis (⭐533)](https://github.com/PavelGrigoryevDS/awesome-data-analysis) -  A curated list of data analysis tools, libraries and resources.
