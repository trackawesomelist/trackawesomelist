...
[🏠 Home](/README.md) · [🔥 Feed](https://www.trackawesomelist.com/academic/awesome-datascience/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 academic/awesome-datascience](https://github.com/academic/awesome-datascience) · ⭐ 23K · 🏷️ Computer Science
...
*   [#tidytuesday (⭐6.3k)](https://github.com/rfordatascience/tidytuesday) A weekly data project aimed at the R ecosystem.
*   [Data science your way (⭐585)](https://github.com/jadianes/data-science-your-way)
*   [PySpark Cheatsheet (⭐326)](https://github.com/kevinschaich/pyspark-cheatsheet)
...
*   [Tutorials to get started on signal processing for machine learning (⭐46)](https://github.com/jinglescode/python-signal-processing)
...
*   [Minimum Viable Study Plan for Machine Learning Interviews (⭐7.9k)](https://github.com/khangich/machine-learning-interview)
...
*   [MLSys-NYU-2022 (⭐246)](https://github.com/jacopotagliabue/MLSys-NYU-2022/tree/main) - Slides, scripts and materials for the Machine Learning in Finance course at NYU Tandon, 2022.

*   [Hands-on Train and Deploy ML (⭐626)](https://github.com/Paulescu/hands-on-train-and-deploy-ml) - A hands-on course to train and deploy a serverless API that predicts crypto prices.
...
*   [scikit-multilearn (⭐896)](https://github.com/scikit-multilearn/scikit-multilearn)
...
*   [scikit-rebate (⭐394)](https://github.com/EpistasisLab/scikit-rebate)
*   [seqlearn (⭐677)](https://github.com/larsmans/seqlearn)
...
*   [sklearn-deap (⭐756)](https://github.com/rsteca/sklearn-deap)
...
*   [scikit-image (⭐5.8k)](https://github.com/scikit-image/scikit-image)
*   [scikit-opt (⭐4.8k)](https://github.com/guofei9987/scikit-opt)
*   [scikit-posthocs (⭐319)](https://github.com/maximtrp/scikit-posthocs)
...
*   [causalml (⭐4.7k)](https://github.com/uber/causalml)
...
*   [imodels (⭐1.3k)](https://github.com/csinva/imodels)
*   [RuleFit (⭐394)](https://github.com/christophM/rulefit)
*   [pyGAM (⭐830)](https://github.com/dswah/pyGAM)
*   [Deepchecks (⭐3.3k)](https://github.com/deepchecks/deepchecks)
...
*   [PyTorch (⭐76k)](https://github.com/pytorch/pytorch)
...
*   [PyToune (⭐556)](https://github.com/GRAAL-Research/poutyne)
*   [skorch (⭐5.6k)](https://github.com/skorch-dev/skorch)
*   [PyVarInf (⭐353)](https://github.com/ctallec/pyvarinf)
...
*   [Yolov5 (⭐46k)](https://github.com/ultralytics/yolov5)
*   [Yolov8 (⭐21k)](https://github.com/ultralytics/ultralytics)

#### TensorFlow Ecosystem

*   [TensorFlow (⭐181k)](https://github.com/tensorflow/tensorflow)
...
*   [tensorflow-upstream (⭐674)](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream)
...
*   [qkeras (⭐516)](https://github.com/google/qkeras)
...
*   [Resseract Lite (⭐3)](https://github.com/abistarun/resseract-lite)
...
| Link                                                                                                    | Description                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [The Data Science Lifecycle Process (⭐384)](https://github.com/dslp/dslp)                               | The Data Science Lifecycle Process is a process for taking data science teams from Idea to Value repeatedly and sustainably. The process is documented in this repo                                                                                                                                                           |
| [Data Science Lifecycle Template Repo (⭐157)](https://github.com/dslp/dslp-repo-template)               | Template repository for data science lifecycle project                                                                                                                                                                                                                                                                        |
...
| [PyTorch Geometric Temporal (⭐2.4k)](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) | Representation learning on dynamic graphs.                                                                                                                                                                                                                                                                                    |
| [Little Ball of Fur (⭐690)](https://github.com/benedekrozemberczki/littleballoffur)                     | A graph sampling library for NetworkX with a Scikit-Learn like API.                                                                                                                                                                                                                                                           |
...
| [Featuretools (⭐7k)](https://github.com/alteryx/featuretools)                                           | An open source framework for automated feature engineering written in python                                                                                                                                                                                                                                                  |
...
| [Lambdo (⭐22)](https://github.com/asavinov/lambdo)                                                      | is a workflow engine that significantly simplifies data analysis by combining in one analysis pipeline (i) feature engineering and machine learning (ii) model training and prediction (iii) table population and column evaluation.                                                                                          |
| [Feast (⭐5.2k)](https://github.com/feast-dev/feast)                                                     | A feature store for the management, discovery, and access of machine learning features. Feast provides a consistent view of feature data for both model training and model serving.                                                                                                                                           |
...
| [Trains (⭐5.2k)](https://github.com/allegroai/clearml)                                                  | Auto-Magical Experiment Manager, Version Control & DevOps for AI                                                                                                                                                                                                                                                              |
...
| [MindsDB (⭐20k)](https://github.com/mindsdb/mindsdb)                                                    | MindsDB is an Explainable AutoML framework for developers. With MindsDB you can build, train and use state of the art ML models in as simple as one line of code.                                                                                                                                                             |
| [Lightwood (⭐413)](https://github.com/mindsdb/lightwood)                                                | A Pytorch based framework that breaks down machine learning problems into smaller blocks that can be glued together seamlessly with an objective to build predictive models with one line of code.                                                                                                                            |
| [AWS Data Wrangler (⭐3.8k)](https://github.com/awslabs/aws-data-wrangler)                               | An open-source Python package that extends the power of Pandas library to AWS connecting DataFrames and AWS data related services (Amazon Redshift, AWS Glue, Amazon Athena, Amazon EMR, etc).                                                                                                                                |
...
| [Python Data Science Handbook (⭐41k)](https://github.com/jakevdp/PythonDataScienceHandbook)             | Python Data Science Handbook: full text in Jupyter Notebooks                                                                                                                                                                                                                                                                  |
...
| [LineaPy (⭐653)](https://github.com/LineaLabs/lineapy)                                                  | Ever been frustrated with cleaning up long, messy Jupyter notebooks? With LineaPy, an open source Python library, it takes as little as two lines of code to transform messy development code into production pipelines.                                                                                                      |
...
| [cleanlab (⭐8.1k)](https://github.com/cleanlab/cleanlab)                                                | Python library for data-centric AI and automatically detecting various issues in ML datasets                                                                                                                                                                                                                                  |
| [AutoGluon (⭐7k)](https://github.com/awslabs/autogluon)                                                 | AutoML to easily produce accurate predictions for image, text, tabular, time-series, and multi-modal data                                                                                                                                                                                                                     |
...
| [Comet (⭐133)](https://github.com/comet-ml/comet-examples)                                              | An MLOps platform with experiment tracking, model production management, a model registry, and full data lineage to support your ML workflow from training straight through to production.                                                                                                                                    |
| [CometLLM (⭐421)](https://github.com/comet-ml/comet-llm)                                                | Log, track, visualize, and search your LLM prompts and chains in one easy-to-use, 100% open-source tool.                                                                                                                                                                                                                      |
...
| [teeplot (⭐9)](https://github.com/mmore500/teeplot)                                                     | Workflow tool to automatically organize data visualization output                                                                                                                                                                                                                                                             |
...
*   [Open Data Sources (⭐494)](https://github.com/datasciencemasters/data)
...
*   [Public Git Archive (⭐314)](https://github.com/src-d/datasets/tree/master/PublicGitArchive)
...
*   [5000 Images of Clothes (⭐90)](https://github.com/alexeygrigorev/clothing-dataset)
...
*   [Awesome Machine Learning (⭐63k)](https://github.com/josephmisiti/awesome-machine-learning)
*   [lists (⭐9.5k)](https://github.com/jnv/lists)
*   [awesome-dataviz (⭐3.5k)](https://github.com/javierluraschi/awesome-dataviz)
*   [awesome-python (⭐201k)](https://github.com/vinta/awesome-python)
...
*   [Awesome Data Science Ideas (⭐639)](https://github.com/JosPolfliet/awesome-ai-usecases)
...
*   [Awesome Gradient Boosting Papers (⭐977)](https://github.com/benedekrozemberczki/awesome-gradient-boosting-papers)
*   [Awesome Computer Vision Models (⭐491)](https://github.com/nerox8664/awesome-computer-vision-models)
*   [Awesome Monte Carlo Tree Search (⭐589)](https://github.com/benedekrozemberczki/awesome-monte-carlo-tree-search-papers)
...
*   [Awesome Game Datasets (⭐633)](https://github.com/leomaurodesenv/game-datasets#readme)
*   [Data Science Interviews Questions (⭐8.1k)](https://github.com/alexeygrigorev/data-science-interviews)
...
*   [Awesome Music Production (⭐906)](https://github.com/ad-si/awesome-music-production)
