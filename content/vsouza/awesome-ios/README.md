...
*   [Xcode Developer Disk Images (⭐250)](https://github.com/haikieu/xcode-developer-disk-image-all-platforms) - Xcode Developer Disk Images is needed when you want to put your build to the device, however sometimes your Xcode is not updated with the latest Disk Images, you could find them here for convenience.
...
*   [DrawerKit (⭐771)](https://github.com/babylonhealth/DrawerKit) - DrawerKit lets an UIViewController modally present another UIViewController in a manner similar to the way Apple's Maps app works.
...
*   [PasswordTextField (⭐300)](https://github.com/PiXeL16/PasswordTextField) - A custom TextField with a switchable icon which shows or hides the password and enforce good password policies.
...
*   [ios\_system (⭐730)](https://github.com/holzschu/ios_system) - Drop-in replacement for system() in iOS programs.
...
*   [Weaver (⭐683)](https://github.com/scribd/Weaver) - A declarative, easy-to-use and safe Dependency Injection framework for Swift.
...
*   [awesome-xcode-scripts (⭐109)](https://github.com/aashishtamsya/awesome-xcode-scripts) - A curated list of useful xcode scripts.
...
*   [Simplicity (⭐682)](https://github.com/SimplicityMobile/Simplicity) - A simple way to implement Facebook and Google login in your iOS and macOS apps.
...
*   [GRDB.swift (⭐5.5k)](https://github.com/groue/GRDB.swift) - A versatile SQLite toolkit for Swift, with WAL mode support.
...
*   [RSBarcodes\_Swift (⭐682)](https://github.com/yeahdongcn/RSBarcodes_Swift) - 1D and 2D barcodes reader and generators for iOS 8 with delightful controls. Now Swift.
...
*   [Lumina (⭐863)](https://github.com/dokun1/Lumina) - Full service camera that takes photos, videos, streams frames, detects metadata, and streams CoreML predictions.
...
*   [JMCBeaconManager (⭐144)](https://github.com/izotx/JMCBeaconManager) - An iBeacon Manager class that is responsible for detecting beacons nearby.
...
*   [set-simulator-location (⭐618)](https://github.com/lyft/set-simulator-location) - CLI for setting location in the iOS simulator.
...
*   [Localize (⭐278)](https://github.com/andresilvagomez/Localize) - Easy tool to localize apps using JSON or Strings and of course IBDesignables with extensions for UI components.
...
*   [SwiftyTextTable (⭐282)](https://github.com/scottrhoyt/SwiftyTextTable) - A lightweight tool for generating text tables.
...
*   [SwiftTrace (⭐604)](https://github.com/johnno1962/SwiftTrace) - Trace Swift and Objective-C method invocations.
...
*   [BigInt (⭐705)](https://github.com/attaswift/BigInt) - Arbitrary-precision arithmetic in pure Swift.
*   [SigmaSwiftStatistics (⭐654)](https://github.com/evgenyneu/SigmaSwiftStatistics) - A collection of functions for statistical calculation.
*   [VectorMath (⭐341)](https://github.com/nicklockwood/VectorMath) - A Swift library for Mac and iOS that implements common 2D and 3D vector and matrix functions, useful for games or vector-based graphics.
...
*   [Chirp (⭐310)](https://github.com/trifl/Chirp) - The easiest way to prepare, play, and remove sounds in your Swift app!
*   [Beethoven (⭐729)](https://github.com/vadymmarkov/Beethoven) - An audio processing Swift library for pitch detection of musical signals.
...
*   [AudioPlayer (⭐677)](https://github.com/delannoyk/AudioPlayer) - AudioPlayer is syntax and feature sugar over AVPlayer. It plays your audio files (local & remote).
...
*   [NVDSP (⭐410)](https://github.com/bartolsthoorn/NVDSP) - iOS/macOS DSP for audio (with Novocaine).
...
*   [BPMAnalyser (⭐70)](https://github.com/Luccifer/BPM-Analyser) - Fast and simple instrument to get the BPM rate from your audio-files.
...
*   [Voice Overlay (⭐487)](https://github.com/algolia/voice-overlay-ios) - An overlay that gets your user’s voice permission and input as text in a customizable UI.
*   [ModernAVPlayer (⭐258)](https://github.com/noreasonprojects/ModernAVPlayer) - Persistence player to resume playback after bad network connection even in background mode, manage headphone interactions, system interruptions, now playing informations and remote commands.
...
*   [Agrume (⭐593)](https://github.com/JanGorman/Agrume) - A lemony fresh iOS image viewer written in Swift.
...
*   [SwiftPhotoGallery (⭐270)](https://github.com/justinvallely/SwiftPhotoGallery) - Simple, fullscreen image gallery with tap, swipe, and pinch gestures.
...
*   [FacebookImagePicker (⭐230)](https://github.com/floriangbh/FacebookImagePicker) - Facebook album photo picker written in Swift.
...
*   [Paparazzo (⭐753)](https://github.com/avito-tech/Paparazzo) - Custom iOS camera and photo picker with editing capabilities.
*   [ZImageCropper (⭐218)](https://github.com/ZaidPathan/ZImageCropper) - A Swift  project to crop image in any shape.
...
*   [StyleArt (⭐221)](https://github.com/ileafsolutions/StyleArt) - Style Art library process images using COREML with a set of pre trained machine learning models and convert them to Art style.
...
*   [TPPDF (⭐579)](https://github.com/Techprimate/TPPDF) - Generate PDF using commands and automatic layout.
...
*   [Messenger Chat with Firebase (⭐610)](https://github.com/instamobile/messenger-iOS-chat-swift-firestore) - Swift messaging chat app with Firebase Firestore integration.
...
*   [HappyDns (⭐474)](https://github.com/qiniu/happy-dns-objc) - A Dns library, support custom dns server, dnspod httpdns. Only support A record.
...
*   [EVURLCache (⭐295)](https://github.com/evermeer/EVURLCache) - a NSURLCache subclass for handling all web requests that use NSURLRequest.
...
*   [TermiNetwork (⭐88)](https://github.com/billp/TermiNetwork) - A networking library written with Swift 4.0 that supports multi-environment configuration, routing and automatic deserialization.
...
*   [Postal (⭐642)](https://github.com/snipsco/Postal) - A swift framework providing simple access to common email providers.
...
*   [CSV.swift (⭐591)](https://github.com/yaslab/CSV.swift) - CSV reading and writing library written in Swift.
...
*   [Marshal (⭐695)](https://github.com/utahiosmac/Marshal) - Marshaling the typeless wild west of \[String: Any] (Protocol based).
...
*   [AEXML (⭐973)](https://github.com/tadija/AEXML) - Simple and lightweight XML parser written in Swift.
...
*   [Fuzi (⭐987)](https://github.com/cezheng/Fuzi) - A fast & lightweight XML & HTML parser in Swift with XPath & CSS support.
...
*   [XMLCoder (⭐654)](https://github.com/MaxDesiatov/XMLCoder) - Encoder & Decoder for XML using Swift's `Codable` protocols.
...
*   [monza (⭐157)](https://github.com/gabrielgarza/monza) - Ruby Gem for Rails - Easy iTunes In-App Purchase Receipt validation, including auto-renewable subscriptions.
...
*   [TPInAppReceipt (⭐517)](https://github.com/tikhop/TPInAppReceipt) - Reading and Validating In App Store Receipt.
...
*   [AREK (⭐960)](https://github.com/ennioma/arek) - AREK is a clean and easy to use wrapper over any kind of iOS permission.
...
*   [Runtime (⭐964)](https://github.com/wickwirew/Runtime) - A Swift Runtime library for viewing type info, and the dynamic getting and setting of properties.
...
*   [Spotify (⭐518)](https://github.com/spotify/ios-sdk) Spotify iOS SDK.
...
*   [Box (⭐109)](https://github.com/box/box-ios-sdk) iOS + macOS SDK for the Box API.
*   [OneDrive (⭐99)](https://github.com/OneDrive/onedrive-sdk-ios) Live SDK for iOS.
...
*   [algoliasearch-client-swift (⭐190)](https://github.com/algolia/algoliasearch-client-swift) - Algolia Search API Client for Swift.
*   [twitter-kit-ios (⭐673)](https://github.com/twitter-archive/twitter-kit-ios) - Twitter Kit is a native SDK to include Twitter content inside mobile apps.
...
*   [SwiftyVK (⭐259)](https://github.com/SwiftyVK/SwiftyVK) Library for easy interact with VK social network API written in Swift.
...
*   [BiometricAuthentication (⭐802)](https://github.com/rushisangani/BiometricAuthentication) - Use Apple FaceID or TouchID authentication in your app using BiometricAuthentication.
...
*   [SwiftHash (⭐206)](https://github.com/onmyway133/SwiftHash) - Hash in Swift.
...
*   [Obfuscator-iOS (⭐600)](https://github.com/pjebs/Obfuscator-iOS) - Secure your app by obfuscating all the hard-coded security-sensitive strings.
*   [swift-sodium (⭐480)](https://github.com/jedisct1/swift-sodium) - Safe and easy to use crypto for iOS.
...
*   [JOSESwift (⭐161)](https://github.com/airsidemobile/JOSESwift) - A framework for the JOSE standards JWS, JWE, and JWK written in Swift.
...
*   [SwiftyKeychainKit (⭐18)](https://github.com/andriyslyusar/SwiftyKeychainKit) - Keychain wrapper with the benefits of static typing and convenient syntax, support for primitive types, Codable, NSCoding.
...
*   [SwiftGD (⭐419)](https://github.com/twostraws/swiftgd) - A simple Swift wrapper for libgd.
...
*   [Marklight (⭐528)](https://github.com/macteo/Marklight) - Markdown syntax highlighter for iOS.
...
*   [Smile (⭐475)](https://github.com/onmyway133/Smile) Emoji in Swift.
...
*   [MarkdownKit (⭐686)](https://github.com/bmoliveira/MarkdownKit) - A simple and customizable Markdown Parser for Swift.
...
*   [robotframework-appiumlibrary (⭐325)](https://github.com/serhatbolsu/robotframework-appiumlibrary) - AppiumLibrary is an appium testing library for RobotFramework.
...
*   [Remote (⭐782)](https://github.com/johnno1962/Remote) - Control your iPhone from inside Xcode for end-to-end testing.
...
*   [TouchVisualizer (⭐847)](https://github.com/morizotter/TouchVisualizer) - Lightweight touch visualization library in Swift. A single line of code and visualize your touches!
...
*   [Vinyl (⭐272)](https://github.com/Velhotes/Vinyl) - Network testing à la VCR in Swift.
...
*   [AZExpandableIconListView (⭐291)](https://github.com/Azuritul/AZExpandableIconListView) - An expandable/collapsible view component written in Swift.
...
*   [SwiftVideoBackground (⭐333)](https://github.com/dingwilson/SwiftVideoBackground) - Easy to Use UIView subclass for implementing a video background.
...
*   [IGColorPicker (⭐270)](https://github.com/iGenius-Srl/IGColorPicker) - A customizable color picker for iOS in Swift.
*   [KPActionSheet (⭐7)](https://github.com/khuong291/KPActionSheet) -  A replacement of default action sheet, but has very simple usage.
*   [SegmentedProgressBar (⭐439)](https://github.com/D-32/SegmentedProgressBar) - Snapchat / Instagram Stories style animated indicator.
...
*   [Haptica (⭐700)](https://github.com/efremidze/Haptica) - Easy Haptic Feedback Generator.
...
*   [URWeatherView (⭐447)](https://github.com/jegumhon/URWeatherView) - Show the weather effects onto view.
...
*   [ParticlesLoadingView (⭐958)](https://github.com/BalestraPatrick/ParticlesLoadingView) - A customizable SpriteKit particles animation on the border of a view.
...
*   [FlexibleSteppedProgressBar (⭐546)](https://github.com/amratab/FlexibleSteppedProgressBar) - A beautiful easily customisable stepped progress bar.
...
*   [GradientProgressBar (⭐483)](https://github.com/fxm90/GradientProgressBar) - A gradient progress bar (UIProgressView).
...
*   [RSLoadingView (⭐417)](https://github.com/roytornado/RSLoadingView) - Awesome loading animations using 3D engine written with Swift.
*   [SendIndicator (⭐64)](https://github.com/LeonardoCardoso/SendIndicator) - Yet another task indicator.
*   [StepProgressView (⭐338)](https://github.com/yonat/StepProgressView) - Step-by-step progress view with labels and shapes. A good replacement for UIActivityIndicatorView and UIProgressView.
...
*   [Windless (⭐939)](https://github.com/Interactive-Studio/Windless) - Windless makes it easy to implement invisible layout loading view.
...
*   [MKProgress (⭐139)](https://github.com/kamirana4/MKProgress) - A lightweight ProgressHUD written in Swift. Looks similar to /MBProgressHUD/SVProgressHUD/KVNProgressHUD.
...
*   [JRMFloatingAnimation (⭐231)](https://github.com/carleihar/JRMFloatingAnimation) - An Objective-C animation library used to create floating image views.
...
*   [ZoomTransitioning (⭐674)](https://github.com/WorldDownTown/ZoomTransitioning) - A custom transition with image zooming animation.
...
*   [WXWaveView (⭐348)](https://github.com/WelkinXie/WXWaveView) - Add a pretty water wave to your view.
...
*   [YetAnotherAnimationLibrary (⭐510)](https://github.com/lkzhao/YetAnotherAnimationLibrary) - Designed for gesture-driven animations. Fast, simple, & extensible!
*   [Anima (⭐509)](https://github.com/satoshin21/Anima) - Anima is chainable Layer-Based Animation library for Swift4.
...
*   [fireworks (⭐322)](https://github.com/tomkowz/fireworks) - Fireworks effect for UIView
...
*   [TTGSnackbar (⭐605)](https://github.com/zekunyan/TTGSnackbar) - Show simple message and action button on the bottom of the screen with multi kinds of animation.
...
*   [Koyomi (⭐739)](https://github.com/shoheiyokoyama/Koyomi) - Simple customizable calendar component in Swift
...
*   [KDCalendarView (⭐524)](https://github.com/mmick66/CalendarView) - A calendar component for iOS written in Swift 4.0. It features both vertical and horizontal layout (and scrolling) and the display of native calendar events.
...
*   [CardsLayout (⭐788)](https://github.com/filletofish/CardsLayout) - Nice card-designed custom collection view layout.
...
*   [STULabel (⭐95)](https://github.com/stephan-tolksdorf/STULabel) -  A label view that's faster than UILabel and supports asynchronous rendering, links with UIDragInteraction, very flexible text truncation, Auto Layout, UIAccessibility and more.
...
*   [DropDownMenuKit (⭐257)](https://github.com/qmathe/DropDownMenuKit) - A simple, modular and highly customizable UIKit menu, that can be attached to the navigation bar or toolbar, written in Swift.
...
*   [CircleBar (⭐784)](https://github.com/softhausHQ/CircleBar) - 🔶 A fun, easy-to-use tab bar navigation controller for iOS.
*   [SPLarkController (⭐966)](https://github.com/IvanVorobei/SPLarkController) - Settings screen with buttons and switches.
...
*   [PickerView (⭐487)](https://github.com/filipealva/PickerView) - A customizable alternative to UIPickerView in Swift.
...
*   [CountryPicker (⭐205)](https://github.com/4taras4/CountryCode) - :date: UIPickerView with Country names flags and phoneCodes
*   [McPicker (⭐208)](https://github.com/kmcgill88/McPicker-iOS) - A customizable, closure driven UIPickerView drop-in solution with animations that is rotation ready.
...
*   [CRRefresh (⭐956)](https://github.com/CRAnimation/CRRefresh) - An easy way to use pull-to-refresh.
...
*   [ScrollingFollowView (⭐185)](https://github.com/ktanaka117/ScrollingFollowView) - ScrollingFollowView is a simple view which follows UIScrollView scrolling.
...
*   [SJFluidSegmentedControl (⭐895)](https://github.com/sasojadrovski/SJFluidSegmentedControl) - A segmented control with custom appearance and interactive animations. Written in Swift 3.0.
...
*   [MultiSelectSegmentedControl (⭐284)](https://github.com/yonat/MultiSelectSegmentedControl) - adds Multiple-Selection to the standard `UISegmentedControl`.
...
*   [PinterestSegment (⭐671)](https://github.com/TBXark/PinterestSegment) - A Pinterest-like segment control with masking animation.
...
*   [StepSlider (⭐517)](https://github.com/spromicky/StepSlider) - StepSlider its custom implementation of slider such as UISlider for preset integer values.
...
*   [RangeSeekSlider (⭐642)](https://github.com/WorldDownTown/RangeSeekSlider) - A customizable range slider for iOS.
*   [SectionedSlider (⭐361)](https://github.com/LeonardoCardoso/SectionedSlider) - Control Center Slider.
*   [MultiSlider (⭐321)](https://github.com/yonat/MultiSlider) - UISlider clone with multiple thumbs and values, optional snap intervals, optional value labels.
*   [AGCircularPicker (⭐616)](https://github.com/agilie/AGCircularPicker) - AGCircularPicker is helpful component for creating a controller aimed to manage any calculated parameter.
...
*   [AIFlatSwitch (⭐960)](https://github.com/cocoatoucher/AIFlatSwitch) - A flat component alternative to UISwitch on iOS
...
*   [MiniTabBar (⭐154)](https://github.com/D-32/MiniTabBar) - A clean simple alternative to the UITabBar
...
*   [WormTabStrip (⭐175)](https://github.com/EzimetYusup/WormTabStrip) Beatiful ViewPager For iOS written in Swift  (inspired by Android [SmartTabLayout (⭐7k)](https://github.com/ogaclejapan/SmartTabLayout))
...
*   [SwiftReorder (⭐379)](https://github.com/adamshin/SwiftReorder) - Add drag-and-drop reordering to any table view with just a few lines of code. Robust, lightweight, and completely customizable. \[e]
...
*   [CascadingTableDelegate (⭐921)](https://github.com/edopelawi/CascadingTableDelegate) - A no-nonsense way to write cleaner UITableViewDelegate and UITableViewDataSource in Swift.
...
*   [DataSources (⭐562)](https://github.com/muukii/DataSources) - Type-safe data-driven List-UI Framework. (We can also use ASCollectionNode)
*   [KDDragAndDropCollectionView (⭐507)](https://github.com/mmick66/KDDragAndDropCollectionView) - Dragging & Dropping data across multiple UICollectionViews.
...
*   [CampcotCollectionView (⭐171)](https://github.com/touchlane/CampcotCollectionView) - CampcotCollectionView is a custom UICollectionView written in Swift that allows to expand and collapse sections. It provides a simple API to manage collection view appearance.
...
*   [SimpleSource (⭐95)](https://github.com/Squarespace/simple-source) - Easy and type-safe iOS table and collection views in Swift.
...
*   [ExpandableCell (⭐726)](https://github.com/younatics/ExpandableCell) - Fully refactored YNExapnadableCell with more concise, bug free. Awesome expandable, collapsible tableview cell for iOS.
...
*   [ListPlaceholder (⭐627)](https://github.com/malkouz/ListPlaceholder) - ListPlaceholder is a swift library allows you to easily add facebook style animated loading placeholder to your tableviews or collection views
...
*   [Swinflate (⭐223)](https://github.com/VladIacobIonut/Swinflate) -  A bunch of layouts providing light and seamless experiences in your CollectionView.
...
*   [TagCellLayout (⭐342)](https://github.com/riteshhgupta/TagCellLayout) - UICollectionView layout for Tags with Left, Center & Right alignments.
...
*   [RSKGrowingTextView (⭐941)](https://github.com/ruslanskorb/RSKGrowingTextView) - A light-weight UITextView subclass that automatically grows and shrinks.
...
*   [GrowingTextView (⭐939)](https://github.com/KennethTsang/GrowingTextView) - An UITextView in Swift3 and Swift2.3. Support auto growing, placeholder and length limit.
...
*   [InstantSearch iOS (⭐565)](https://github.com/algolia/instantsearch-ios) - A library of widgets and helpers to build instant-search applications on iOS.
...
*   [Swifty360Player (⭐147)](https://github.com/abdullahselek/Swifty360Player) - iOS 360-degree video player streaming from an AVPlayer with Swift.
...
*   [AlertOnboarding (⭐828)](https://github.com/PhilippeBoisney/AlertOnboarding) - A simple and handsome AlertView for onboard your users in your amazing world.
...
*   [Model2App (⭐131)](https://github.com/Q-Mobile/Model2App) - Turn your Swift data model into a working CRUD app.
...
*   [iOS Learning Resources (⭐443)](https://github.com/sanketfirodiya/iOS-learning-resources) Comprehensive collection of high quality, frequently updated and well maintained iOS tutorial sites.
...
*   [awesome-gists (⭐526)](https://github.com/vsouza/awesome-gists#ios) - A list of amazing gists (iOS section).
...
*   [example-ios-apps (⭐745)](https://github.com/jogendra/example-ios-apps) - A curated list of Open Source example iOS apps developed in Swift.
...
*   [DeviceGuru (⭐440)](https://github.com/InderKumarRathore/DeviceGuru/) - DeviceGuru is a simple lib (Swift) to know the exact type of the device, e.g. iPhone 6 or iPhone 6s.
...
*   [DocumenterXcode (⭐33)](https://github.com/serhii-londar/DocumenterXcode) - Attempt to give a new life for VVDocumenter-Xcode as source editor extension.
