...
[🏠 Home](/README.md) · [🔍 Search](https://www.trackawesomelist.com/search/) · [🔥 Feed](https://www.trackawesomelist.com/vsouza/awesome-ios/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 vsouza/awesome-ios](https://github.com/vsouza/awesome-ios) · ⭐ 42K · 🏷️ Platforms
...
*   [awesome-ios-books (⭐196)](https://github.com/bystritskiy/awesome-ios-books) - A list of books for iOS developers.
...
*   [ios-uploader (⭐110)](https://github.com/simonnilsson/ios-uploader) - Easy to use, cross-platform tool to upload iOS apps to App Store Connect.
...
*   [awesome-ios-developer (⭐674)](https://github.com/jphong1111/awesome-ios-developer) - Useful knowledges and stuff for ios developer.
...
*   [DL4S (⭐87)](https://github.com/palle-k/DL4S) - Deep Learning for Swift: Accelerated tensor operations and dynamic neural networks based on reverse mode automatic differentiation for every device that can run Swift.
*   [SwiftCoreMLTools (⭐144)](https://github.com/JacopoMangiavacchi/SwiftCoreMLTools) - A Swift library for creating and exporting CoreML Models in Swift.
...
*   [Clean Architecture for SwiftUI + Combine (⭐4.2k)](https://github.com/nalexn/clean-architecture-swiftui) - A demo project showcasing the production setup of the SwiftUI app with Clean Architecture.
...
*   [IQDropDownTextField (⭐303)](https://github.com/hackiftekhar/IQDropDownTextField) - TextField with DropDown support using UIPickerView.
...
*   [Kvitto (⭐287)](https://github.com/Cocoanetics/Kvitto) - App Store Receipt Validation.
...
*   [SwiftyUtils (⭐531)](https://github.com/tbaranes/swiftyutils) - All the reusable code that we need in each project.
...
*   [swift-package-manager (⭐9.1k)](https://github.com/apple/swift-package-manager) - The Package Manager for the Swift Programming Language.
...
*   [WatchdogInspector (⭐513)](https://github.com/tapwork/WatchdogInspector) - Shows your current framerate (fps) in the status bar of your iOS app.
*   [Cichlid (⭐242)](https://github.com/dealforest/Cichlid) - automatically delete the current project's DerivedData directories.
*   [XCSwiftr (⭐339)](https://github.com/dzenbot/XCSwiftr) - An Xcode Plugin to convert Objective-C to Swift.
...
*   [Snowonder (⭐104)](https://github.com/Karetski/Snowonder) - Magical import declarations formatter for Xcode.
...
*   [awesome-gitignore-templates (⭐20)](https://github.com/aashishtamsya/awesome-gitignore-templates) - A collection of swift, objective-c, android and many more langugages .gitignore templates.
...
*   [SwiftSnippets (⭐155)](https://github.com/onmyway133/SwiftSnippets) - A collection of Swift snippets to be used in Xcode.
...
*   [iOS-Playbook (⭐365)](https://github.com/bakkenbaeck/iOS-handbook) - Guidelines and best practices for excellent iOS apps.
...
*   [Capable (⭐234)](https://github.com/chrs1885/Capable) - Track accessibility features to improve your app for people with certain disabilities.
...
*   [Segment (⭐385)](https://github.com/segmentio/analytics-ios) - The hassle-free way to integrate analytics into any iOS application.
...
*   [Appfigurate (⭐22)](https://github.com/electricbolt/appfiguratesdk) - Secure runtime configuration for iOS and watchOS, apps and app extensions.
*   [ScreenshotFramer (⭐702)](https://github.com/IdeasOnCanvas/ScreenshotFramer) - With Screenshot Framer you can easily create nice-looking and localized App Store Images.
...
*   [RouteComposer (⭐732)](https://github.com/ekazaev/route-composer) - Library that helps to handle view controllers composition, routing and deeplinking tasks.
...
*   [FocusTvButton (⭐70)](https://github.com/dcordero/FocusTvButton) - Light wrapper of UIButton that allows extra customization for tvOS
*   [ParallaxView (⭐467)](https://github.com/PGSSoft/ParallaxView) - iOS controls and extensions that add parallax effect to your application.
...
*   [AVPlayerViewController-Subtitles (⭐219)](https://github.com/mhergon/AVPlayerViewController-Subtitles) - AVPlayerViewController-Subtitles is a library to display subtitles on iOS. It's built as a Swift extension and it's very easy to integrate.
...
*   [VersaPlayer (⭐728)](https://github.com/josejuanqm/VersaPlayer) - Versatile AVPlayer implementation for iOS, macOS, and tvOS.
...
*   [MagicPie (⭐535)](https://github.com/AlexandrGraschenkov/MagicPie) - Awesome layer based pie chart. Fantastically fast and fully customizable. Amazing animations available with MagicPie.
*   [PieCharts (⭐506)](https://github.com/i-schuetz/PieCharts) - Easy to use and highly customizable pie charts library for iOS.
...
*   [DWURecyclingAlert (⭐565)](https://github.com/diwu/DWURecyclingAlert) - Optimizing UITableViewCell For Fast Scrolling.
...
*   [SwiftCop (⭐543)](https://github.com/andresinaka/SwiftCop) -  SwiftCop is a validation library fully written in Swift and inspired by the clarity of Ruby On Rails Active Record validations.
...
*   [Buglife (⭐500)](https://github.com/Buglife/Buglife-iOS) - Awesome bug reporting for iOS apps.
...
*   [CostumeKit (⭐302)](https://github.com/jakemarsh/CostumeKit) - Base types for theming an app.
*   [CSS3ColorsSwift (⭐67)](https://github.com/WorldDownTown/CSS3ColorsSwift) - A UIColor extension with CSS3 Colors name.
*   [ChromaColorPicker (⭐541)](https://github.com/joncardasis/ChromaColorPicker) - An intuitive iOS color picker built in Swift.
...
*   [ColorizeSwift (⭐286)](https://github.com/mtynior/ColorizeSwift) - Terminal string styling for Swift.
...
*   [Overdrive (⭐813)](https://github.com/saidsikira/Overdrive) - Fast async task based Swift framework with focus on type safety, concurrency and multi threading.
...
*   [OHMySQL (⭐212)](https://github.com/oleghnidets/OHMySQL) - An Objective-C wrapper of MySQL C API.
...
*   [Nora (⭐274)](https://github.com/SD10/Nora) - Nora is a Firebase abstraction layer for working with FirebaseDatabase and FirebaseStorage.
...
*   [SwiftGraph (⭐707)](https://github.com/davecom/SwiftGraph) - Graph data structure and utility functions in pure Swift.
*   [SwiftPriorityQueue (⭐353)](https://github.com/davecom/SwiftPriorityQueue) - A priority queue with a classic binary heap implementation in pure Swift.
...
*   [Httper-iOS (⭐412)](https://github.com/MuShare/Httper-iOS) - App for developers to test REST API.
...
*   [YYDispatchQueuePool (⭐465)](https://github.com/ibireme/YYDispatchQueuePool) - iOS utility class to manage global dispatch queue.
...
*   [Drawsana (⭐580)](https://github.com/Asana/Drawsana) - iOS framework for building raster drawing and image markup views.
...
*   [RSBarcodes\_Swift (⭐683)](https://github.com/yeahdongcn/RSBarcodes_Swift) - 1D and 2D barcodes reader and generators for iOS 8 with delightful controls. Now Swift.
...
*   [PeekView (⭐124)](https://github.com/itsmeichigo/PeekView) - PeekView supports peek, pop and preview actions for iOS devices without 3D Touch capibility.
...
*   [BeaconEmitter (⭐939)](https://github.com/lgaches/BeaconEmitter) - Turn your Mac as an iBeacon.
...
*   [set-simulator-location (⭐622)](https://github.com/lyft/set-simulator-location) - CLI for setting location in the iOS simulator.
...
*   [Haptico (⭐467)](https://github.com/iSapozhnik/Haptico) - Easy to use haptic feedback generator with pattern-play support.
...
*   [Rubustrings (⭐113)](https://github.com/dcordero/Rubustrings) - Check the format and consistency of Localizable.strings files.
...
*   [SwiftTrace (⭐610)](https://github.com/johnno1962/SwiftTrace) - Trace Swift and Objective-C method invocations.
...
*   [Twitter Logging Service (⭐291)](https://github.com/twitter/ios-twitter-logging-service) - Twitter Logging Service is a robust and performant logging framework for iOS clients.
...
*   [Tensorflow-iOS (⭐171k)](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/examples/ios) - The official Google-built powerful neural network library port for iOS.
...
*   [Surge (⭐18)](https://github.com/mattt/Surge) - A Swift library that uses the Accelerate framework to provide high-performance functions for matrix math, digital signal processing, and image manipulation.
...
*   [AudioKit (⭐9.6k)](https://github.com/audiokit/AudioKit) - A powerful toolkit for synthesizing, processing, and analyzing sounds.
...
*   [AsyncImageView (⭐914)](https://github.com/nicklockwood/AsyncImageView) - Simple extension of UIImageView for loading and displaying images asynchronously without lock up the UI.
...
*   [MapleBacon (⭐337)](https://github.com/JanGorman/MapleBacon) - An image download and caching library for iOS written in Swift.
...
*   [SABlurImageView (⭐554)](https://github.com/marty-suzuki/SABlurImageView) - Easily Adding Animated Blur/Unblur Effects To An Image.
...
*   [ComplimentaryGradientView (⭐727)](https://github.com/gkye/ComplimentaryGradientView) - Create complementary gradients generated from dominant and prominent colors in supplied image. Inspired by Grade.js.
...
*   [chat-sdk-ios (⭐884)](https://github.com/chat-sdk/chat-sdk-ios) - Chat SDK iOS - Open Source Mobile Messenger.
...
*   [MMLanScan (⭐462)](https://github.com/mavris/MMLanScan) - An iOS LAN Network Scanner library.
...
*   [AFNetworking+RetryPolicy (⭐210)](https://github.com/kubatruhlar/AFNetworking-RetryPolicy) - An objective-c category that adds the ability to set the retry logic for requests made with AFNetworking.
...
*   [Postal (⭐646)](https://github.com/snipsco/Postal) - A swift framework providing simple access to common email providers.
...
*   [Lumos (⭐149)](https://github.com/sushinoya/lumos) - A light Swift wrapper around Objective-C Runtime.
...
*   [PMJSON (⭐363)](https://github.com/postmates/PMJSON) - Pure Swift JSON encoding/decoding library.
...
*   [NSObject-Rx (⭐627)](https://github.com/RxSwiftCommunity/NSObject-Rx) - Handy RxSwift extensions on NSObject, including rx\_disposeBag.
...
*   [Runtime (⭐972)](https://github.com/wickwirew/Runtime) - A Swift Runtime library for viewing type info, and the dynamic getting and setting of properties.
...
*   [Spotify (⭐534)](https://github.com/spotify/ios-sdk) Spotify iOS SDK.
*   [SpotifyLogin (⭐345)](https://github.com/spotify/SpotifyLogin) Spotify SDK Login in Swift.
...
*   [Shopify (⭐416)](https://github.com/Shopify/mobile-buy-sdk-ios) - Shopify’s Mobile Buy SDK makes it simple to sell physical products inside your mobile app.
...
*   [BiometricAuthentication (⭐807)](https://github.com/rushisangani/BiometricAuthentication) - Use Apple FaceID or TouchID authentication in your app using BiometricAuthentication.
...
*   [SwCrypt (⭐697)](https://github.com/soyersoyer/SwCrypt) - RSA public/private key generation, RSA, AES encryption/decryption, RSA sign/verify in Swift with CommonCrypto in iOS and macOS.
...
*   [EnigmaKit (⭐114)](https://github.com/mikaoj/EnigmaKit) - Enigma encryption in Swift.
...
*   [Obfuscator-iOS (⭐603)](https://github.com/pjebs/Obfuscator-iOS) - Secure your app by obfuscating all the hard-coded security-sensitive strings.
*   [swift-sodium (⭐486)](https://github.com/jedisct1/swift-sodium) - Safe and easy to use crypto for iOS.
...
*   [JOSESwift (⭐166)](https://github.com/airsidemobile/JOSESwift) - A framework for the JOSE standards JWS, JWE, and JWK written in Swift.
...
*   [KeychainAccess (⭐7.2k)](https://github.com/kishikawakatsumi/KeychainAccess) - Simple Swift wrapper for Keychain that works on iOS and macOS.
*   [Keychains (⭐71)](https://github.com/hyperoslo/Keychains) - Because you should care... about the security... of your shit.
*   [Lockbox (⭐856)](https://github.com/granoff/Lockbox) - Objective-C utility class for storing data securely in the key chain.
...
*   [SwiftGD (⭐422)](https://github.com/twostraws/swiftgd) - A simple Swift wrapper for libgd.
...
*   [Marklight (⭐547)](https://github.com/macteo/Marklight) - Markdown syntax highlighter for iOS.
*   [MarkdownTextView (⭐677)](https://github.com/indragiek/MarkdownTextView) - Rich Markdown editing control for iOS.
*   [TextAttributes (⭐2.2k)](https://github.com/delba/TextAttributes) - An easier way to compose attributed strings.
*   [Reductio (⭐439)](https://github.com/fdzsergio/Reductio) - Automatic summarizer text in Swift.
...
*   [Heimdall (⭐395)](https://github.com/henrinormak/Heimdall) - Heimdall is a wrapper around the Security framework for simple encryption/decryption operations.
...
*   [Smile (⭐482)](https://github.com/onmyway133/Smile) Emoji in Swift.
*   [ISO8601 (⭐20)](https://github.com/onmyway133/iso8601) Super lightweight ISO8601 Date Formatter in Swift.
*   [Translucid (⭐553)](https://github.com/Ekhoo/Translucid) - Lightweight library to set an Image as text background.
...
*   [Croc (⭐128)](https://github.com/jkalash/croc) - A lightweight Swift library for Emoji parsing and querying.
...
*   [robotframework-appiumlibrary (⭐332)](https://github.com/serhatbolsu/robotframework-appiumlibrary) - AppiumLibrary is an appium testing library for RobotFramework.
...
*   [Remote (⭐792)](https://github.com/johnno1962/Remote) - Control your iPhone from inside Xcode for end-to-end testing.
*   [LayoutTest-iOS (⭐566)](https://github.com/linkedin/LayoutTest-iOS) - Write unit tests which test the layout of a view in multiple configurations.
...
*   [JDFlipNumberView (⭐755)](https://github.com/calimarkus/JDFlipNumberView) - Representing analog flip numbers like airport/trainstation displays.
...
*   [CardStackController (⭐526)](https://github.com/jobandtalent/CardStackController) - iOS custom controller used in Jobandtalent app to present new view controllers as cards.
...
*   [ElongationPreview (⭐887)](https://github.com/Ramotion/elongation-preview) - ElongationPreview is an elegant push-pop style view controller with 3D-Touch support and gestures.
...
*   [SegmentedProgressBar (⭐447)](https://github.com/D-32/SegmentedProgressBar) - Snapchat / Instagram Stories style animated indicator.
...
*   [Haptica (⭐703)](https://github.com/efremidze/Haptica) - Easy Haptic Feedback Generator.
...
*   [UI Fabric by Microsoft (⭐578)](https://github.com/OfficeDev/ui-fabric-ios) - UI framework based on [Fluent Design System](https://www.microsoft.com/design/fluent/#/ios) by Microsoft.
...
*   [AlamofireNetworkActivityIndicator (⭐714)](https://github.com/Alamofire/AlamofireNetworkActivityIndicator) - Controls the visibility of the network activity indicator on iOS using Alamofire.
...
*   [RPCircularProgress (⭐253)](https://github.com/iwasrobbed/RPCircularProgress) - (Swift) Circular progress UIView subclass with UIProgressView properties.
...
*   [DCAnimationKit (⭐798)](https://github.com/daltoniam/DCAnimationKit) - A collection of animations for iOS. Simple, just add water animations.
...
*   [Wave (⭐126)](https://github.com/onmyway133/Wave) - :ocean: Declarative chainable animations in Swift.
...
*   [anim (⭐558)](https://github.com/onurersel/anim) - An animation library for iOS with custom easings and easy to follow API.
...
*   [WaterDrops (⭐404)](https://github.com/LeFal/WaterDrops) - Simple water drops animation for iOS in Swift.
...
*   [Anima (⭐529)](https://github.com/satoshin21/Anima) - Anima is chainable Layer-Based Animation library for Swift4.
...
*   [Kaeru (⭐507)](https://github.com/bannzai/Kaeru) - Switch viewcontroller like iOS task manager.
...
*   [Dodo (⭐876)](https://github.com/evgenyneu/Dodo) - A message bar for iOS written in Swift.
...
*   [SwiftyButton (⭐544)](https://github.com/TakeScoop/SwiftyButton) - Simple and customizable button in Swift
...
*   [Koyomi (⭐743)](https://github.com/shoheiyokoyama/Koyomi) - Simple customizable calendar component in Swift
...
*   [Preloader.Ophiuchus (⭐883)](https://github.com/Yalantis/Preloader.Ophiuchus) - Custom Label to apply animations on whole text or letters.
...
*   [STULabel (⭐98)](https://github.com/stephan-tolksdorf/STULabel) -  A label view that's faster than UILabel and supports asynchronous rendering, links with UIDragInteraction, very flexible text truncation, Auto Layout, UIAccessibility and more.
...
*   [DropDownMenuKit (⭐260)](https://github.com/qmathe/DropDownMenuKit) - A simple, modular and highly customizable UIKit menu, that can be attached to the navigation bar or toolbar, written in Swift.
...
*   [RHSideButtons (⭐165)](https://github.com/robertherdzik/RHSideButtons) - Library provides easy to implement variation of Android (Material Design) Floating Action Button for iOS. You can use it as your app small side menu.
...
*   [PickerView (⭐499)](https://github.com/filipealva/PickerView) - A customizable alternative to UIPickerView in Swift.
*   [DatePickerDialog (⭐537)](https://github.com/squimer/DatePickerDialog-iOS-Swift) - Date picker dialog for iOS
...
*   [SKCountryPicker (⭐247)](https://github.com/SURYAKANTSHARMA/CountryPicker) - A simple, customizable Country picker for picking country or dialing code.
...
*   [FFPopup (⭐831)](https://github.com/JonyFang/FFPopup) - ⛩FFPopup is a lightweight library for presenting custom views as a popup.
...
*   [GradientCircularProgress (⭐524)](https://github.com/keygx/GradientCircularProgress) - Customizable progress indicator library in Swift.
...
*   [mntpulltoreact (⭐775)](https://github.com/mentionapp/mntpulltoreact) - One gesture, many actions. An evolution of Pull to Refresh.
...
*   [CRRefresh (⭐960)](https://github.com/CRAnimation/CRRefresh) - An easy way to use pull-to-refresh.
...
*   [RangeSlider (⭐307)](https://github.com/warchimede/RangeSlider) - A simple range slider made in Swift
*   [CircleSlider (⭐143)](https://github.com/shushutochako/CircleSlider) - CircleSlider is a Circular slider library. written in pure Swift.
...
*   [TTRangeSlider (⭐950)](https://github.com/TomThorpe/TTRangeSlider) - A slider, similar in style to UISlider, but which allows you to pick a minimum and maximum range.
*   [MMSegmentSlider (⭐48)](https://github.com/MedvedevMax/MMSegmentSlider) - Customizable animated slider for iOS.
*   [StepSlider (⭐522)](https://github.com/spromicky/StepSlider) - StepSlider its custom implementation of slider such as UISlider for preset integer values.
...
*   [TKSwitcherCollection (⭐904)](https://github.com/TBXark/TKSwitcherCollection) - An animate switch collection
...
*   [AIFlatSwitch (⭐968)](https://github.com/cocoatoucher/AIFlatSwitch) - A flat component alternative to UISwitch on iOS
...
*   [WormTabStrip (⭐177)](https://github.com/EzimetYusup/WormTabStrip) Beatiful ViewPager For iOS written in Swift  (inspired by Android [SmartTabLayout (⭐7k)](https://github.com/ogaclejapan/SmartTabLayout))
...
*   [ZYThumbnailTableView (⭐949)](https://github.com/liuzhiyi1992/ZYThumbnailTableView) - a TableView have thumbnail cell only, and you can use gesture let it expands other expansionView, all diy
...
*   [TableKit (⭐695)](https://github.com/maxsokolov/TableKit) - Type-safe declarative table views with Swift
...
*   [SwiftReorder (⭐380)](https://github.com/adamshin/SwiftReorder) - Add drag-and-drop reordering to any table view with just a few lines of code. Robust, lightweight, and completely customizable. \[e]
...
*   [TableViewDragger (⭐517)](https://github.com/KyoheiG3/TableViewDragger) - A cells of UITableView can be rearranged by drag and drop.
...
*   [CascadingTableDelegate (⭐918)](https://github.com/edopelawi/CascadingTableDelegate) - A no-nonsense way to write cleaner UITableViewDelegate and UITableViewDataSource in Swift.
...
*   [GenericDataSource (⭐131)](https://github.com/GenericDataSource/GenericDataSource) - A generic small reusable components for data source implementation for UITableView/UICollectionView in Swift.
...
*   [CampcotCollectionView (⭐176)](https://github.com/touchlane/CampcotCollectionView) - CampcotCollectionView is a custom UICollectionView written in Swift that allows to expand and collapse sections. It provides a simple API to manage collection view appearance.
...
*   [RSKGrowingTextView (⭐948)](https://github.com/ruslanskorb/RSKGrowingTextView) - A light-weight UITextView subclass that automatically grows and shrinks.
*   [RSKPlaceholderTextView (⭐221)](https://github.com/ruslanskorb/RSKPlaceholderTextView) - A light-weight UITextView subclass that adds support for placeholder.
...
*   [InstantSearch iOS (⭐568)](https://github.com/algolia/instantsearch-ios) - A library of widgets and helpers to build instant-search applications on iOS.
...
*   [TweeTextField (⭐473)](https://github.com/oleghnidets/TweeTextField) - Lightweight set of text fields with nice animation and functionality.
...
*   [Swifty360Player (⭐150)](https://github.com/abdullahselek/Swifty360Player) - iOS 360-degree video player streaming from an AVPlayer with Swift.
...
*   [AlertOnboarding (⭐834)](https://github.com/PhilippeBoisney/AlertOnboarding) - A simple and handsome AlertView for onboard your users in your amazing world.
...
*   [Swift-ActionCableClient (⭐162)](https://github.com/danielrhodes/Swift-ActionCableClient) - ActionCable is a new WebSocket server being released with Rails 5 which makes it easy to add real-time features to your app.
...
*   [Shark (⭐378)](https://github.com/kaandedeoglu/Shark) - Swift Script that transforms the .xcassets folder into a type safe enum.
...
*   [SwiftGen (⭐8.4k)](https://github.com/SwiftGen/SwiftGen) - A collection of Swift tools to generate Swift code (enums for your assets, storyboards, Localizable.strings and UIColors).
...
*   [abandoned-strings (⭐364)](https://github.com/ijoshsmith/abandoned-strings) - Command line program that detects unused resource strings in an iOS or macOS application.
...
*   [Kin (⭐868)](https://github.com/Karumi/Kin) - Have you ever found yourself undoing a merge due to a broken Xcode build? Then Kin is your tool. It will parse your project configuration file and detect errors.
...
*   [Realm Browser (⭐497)](https://github.com/realm/realm-browser-osx) - Realm Browser is a macOS utility to open and modify realm database files.
...
*   [Sourcery (⭐7k)](https://github.com/krzysztofzablocki/Sourcery) - A tool that brings meta-programming to Swift, allowing you to code generate Swift code.
*   [AssetChecker 👮 (⭐203)](https://github.com/freshOS/AssetChecker) - Keeps your Assets.xcassets files clean and emits warnings when something is suspicious.
*   [PlayAlways (⭐539)](https://github.com/insidegui/PlayAlways) - Create Xcode playgrounds from your menu bar
...
*   [Nori (⭐298)](https://github.com/yukiasai/Nori) - Easier to apply code based style guide to storyboard.
...
*   [Swift Cheat Sheet (⭐960)](https://github.com/iwasrobbed/Swift-CheatSheet) - A quick reference cheat sheet for common, high level topics in Swift.
...
*   [iOS Learning Resources (⭐471)](https://github.com/sanketfirodiya/iOS-learning-resources) Comprehensive collection of high quality, frequently updated and well maintained iOS tutorial sites.
...
*   [awesome-gists (⭐545)](https://github.com/vsouza/awesome-gists#ios) - A list of amazing gists (iOS section).
*   [awesome-ios-ui (⭐11k)](https://github.com/cjwirth/awesome-ios-ui) - A curated list of awesome iOS UI/UX libraries.
*   [awesome-interview-questions (⭐54k)](https://github.com/MaximAbramchuck/awesome-interview-questions#ios) - A curated awesome list of lists of interview questions including iOS.
