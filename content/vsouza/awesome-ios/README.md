...
[🏠 Home](/README.md) · [🔍 Search](https://www.trackawesomelist.com/search/) · [🔥 Feed](https://www.trackawesomelist.com/vsouza/awesome-ios/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 vsouza/awesome-ios](https://github.com/vsouza/awesome-ios) · ⭐ 41K · 🏷️ Platforms
...
*   [SVGView (⭐265)](https://github.com/exyte/SVGView) - SVG parser and renderer written in SwiftUI.
...
*   [Rugby (⭐484)](https://github.com/swiftyfinch/Rugby) - 🏈 Cache CocoaPods for faster rebuild and indexing Xcode project.
...
*   [SwiftCurrent (⭐286)](https://github.com/wwt/SwiftCurrent) - A library for managing complex workflows.
...
*   [DL4S (⭐86)](https://github.com/palle-k/DL4S) - Deep Learning for Swift: Accelerated tensor operations and dynamic neural networks based on reverse mode automatic differentiation for every device that can run Swift.
...
*   [Gedatsu (⭐519)](https://github.com/bannzai/gedatsu) - Provide readable format about AutoLayout error console log.
...
*   [SecurePropertyStorage (⭐442)](https://github.com/alexruperez/SecurePropertyStorage) - Helps you define secure storages for your properties using Swift property wrappers.
...
*   [Playbook (⭐969)](https://github.com/playbook-ui/playbook-ios) - A library for isolated developing UI components and automatically snapshots of them.
...
*   [WhirlyGlobe-Maply (⭐784)](https://github.com/mousebird/WhirlyGlobe) - 3D globe and flat-map SDK for iOS. This toolkit has a large API for fine-grained control over the map or globe. It reads a wide variety of GIS data formats.
...
*   [CrowdinSDK (⭐98)](https://github.com/crowdin/mobile-sdk-ios) - Crowdin iOS SDK delivers all new translations from Crowdin project to the application immediately.
...
*   [Clean Architecture for SwiftUI + Combine (⭐4k)](https://github.com/nalexn/clean-architecture-swiftui) - A demo project showcasing the production setup of the SwiftUI app with Clean Architecture.
...
*   [Matomo (⭐367)](https://github.com/matomo-org/matomo-sdk-ios) - The MatomoTracker is an iOS, tvOS and macOS SDK for sending app analytics to a Matomo server.
*   [Mixpanel](https://mixpanel.com/) - Advanced analytics platform.
*   [Segment (⭐383)](https://github.com/segmentio/analytics-ios) - The hassle-free way to integrate analytics into any iOS application.
...
*   [watchbuild (⭐324)](https://github.com/fastlane/watchbuild) - Get a notification once your iTunes Connect build is finished processing.
...
*   [Appfigurate (⭐21)](https://github.com/electricbolt/appfiguratesdk) - Secure runtime configuration for iOS and watchOS, apps and app extensions.
*   [ScreenshotFramer (⭐699)](https://github.com/IdeasOnCanvas/ScreenshotFramer) - With Screenshot Framer you can easily create nice-looking and localized App Store Images.
...
*   [ApplicationCoordinator (⭐791)](https://github.com/AndreyPanov/ApplicationCoordinator) - Coordinator is an object that handles navigation flow and shares flow’s handling for the next coordinator after switching on the next chain.
...
*   [Marshroute (⭐214)](https://github.com/avito-tech/Marshroute) - Marshroute is an iOS Library for making your Routers simple but extremely powerful.
*   [RouteComposer (⭐713)](https://github.com/ekazaev/route-composer) - Library that helps to handle view controllers composition, routing and deeplinking tasks.
*   [Router (⭐458)](https://github.com/freshOS/Router) - Simple Navigation for iOS.
...
*   [ZIKRouter (⭐631)](https://github.com/Zuikyo/ZIKRouter) - An interface-oriented router for discovering modules and injecting dependencies with protocol in OC & Swift, iOS & macOS. Handles route in a type safe way.
...
*   [Periscope VideoViewController (⭐504)](https://github.com/gontovnik/Periscope-VideoViewController) - Video view controller with Periscope fast rewind control.
...
*   [AVPlayerViewController-Subtitles (⭐216)](https://github.com/mhergon/AVPlayerViewController-Subtitles) - AVPlayerViewController-Subtitles is a library to display subtitles on iOS. It's built as a Swift extension and it's very easy to integrate.
...
*   [VideoPager (⭐55)](https://github.com/entotsu/VideoPager) - Paging Video UI, and some control components is available.
...
*   [PryntTrimmerView (⭐738)](https://github.com/HHK1/PryntTrimmerView) - A set of UI elements to trim, crop and select frames inside a video.
...
*   [YoutubeKit (⭐555)](https://github.com/rinov/YoutubeKit) - A video player that fully supports Youtube IFrame API and YoutubeDataAPI for easily create a Youtube app.
*   [Swift-YouTube-Player (⭐825)](https://github.com/gilesvangruisen/Swift-YouTube-Player) - Swift library for embedding and controlling YouTube videos in your iOS applications!
...
*   [VersaPlayer (⭐723)](https://github.com/josejuanqm/VersaPlayer) - Versatile AVPlayer implementation for iOS, macOS, and tvOS.
...
*   [iOS-Viper-Architecture (⭐652)](https://github.com/MindorksOpenSource/iOS-Viper-Architecture) - This repository contains a detailed sample app that implements VIPER architecture in iOS using libraries and frameworks like Alamofire, AlamofireImage, PKHUD, CoreData etc.
...
*   [Virtual Objects (⭐337)](https://github.com/ignacio-chiazzo/ARKit) - Placing Virtual Objects in Augmented Reality.
...
*   [AuthenticationViewController (⭐256)](https://github.com/raulriera/AuthenticationViewController) - A simple to use, standard interface for authenticating to oauth 2.0 protected endpoints via SFSafariViewController.
...
*   [Simplicity (⭐681)](https://github.com/SimplicityMobile/Simplicity) - A simple way to implement Facebook and Google login in your iOS and macOS apps.
...
*   [Web3.swift (⭐487)](https://github.com/Boilertalk/Web3.swift) - Web3 library for interacting with the Ethereum blockchain.
...
*   [XJYChart (⭐869)](https://github.com/JunyiXie/XJYChart) - A Beautiful chart for iOS. Support animation, click, slide, area highlight.
...
*   [MagicPie (⭐536)](https://github.com/AlexandrGraschenkov/MagicPie) - Awesome layer based pie chart. Fantastically fast and fully customizable. Amazing animations available with MagicPie.
...
*   [Buglife (⭐498)](https://github.com/Buglife/Buglife-iOS) - Awesome bug reporting for iOS apps.
...
*   [Taylor (⭐301)](https://github.com/yopeso/Taylor) - Measure Swift code metrics and get reports in Xcode, Jenkins and other CI platforms.
...
*   [RandomColorSwift (⭐623)](https://github.com/onevcat/RandomColorSwift) - An attractive color generator for Swift. Ported from `randomColor.js`.
...
*   [ColorizeSwift (⭐281)](https://github.com/mtynior/ColorizeSwift) - Terminal string styling for Swift.
...
*   [SwiftQueue (⭐367)](https://github.com/lucas34/SwiftQueue) - Job Scheduler with Concurrent run, failure/retry, persistence, repeat, delay and more.
...
*   [Zephyr (⭐841)](https://github.com/ArtSabintsev/Zephyr) - Effortlessly synchronize NSUserDefaults over iCloud.
...
*   [OHMySQL (⭐210)](https://github.com/oleghnidets/OHMySQL) - An Objective-C wrapper of MySQL C API.
...
*   [SwiftGraph (⭐700)](https://github.com/davecom/SwiftGraph) - Graph data structure and utility functions in pure Swift.
*   [SwiftPriorityQueue (⭐350)](https://github.com/davecom/SwiftPriorityQueue) - A priority queue with a classic binary heap implementation in pure Swift.
...
*   [Kronos (⭐575)](https://github.com/lyft/Kronos) - Elegant NTP date library in Swift.
...
*   [Solar (⭐493)](https://github.com/ceeK/Solar) - A Swift micro library for generating Sunrise and Sunset times.
...
*   [then🎬 (⭐962)](https://github.com/freshOS/then) - Elegant Async code in Swift.
...
*   [FileProvider (⭐890)](https://github.com/amosavian/FileProvider) - FileManager replacement for Local, iCloud and Remote (WebDAV/FTP/Dropbox/OneDrive/SMB2) files on iOS/tvOS and macOS.
...
*   [AMSMB2 (⭐157)](https://github.com/amosavian/AMSMB2) - Swift framework to connect SMB 2/3 shares for iOS.
...
*   [Bow (⭐613)](https://github.com/bow-swift/bow) - Typed Functional Programming companion library for Swift.
...
*   [SKTiled (⭐235)](https://github.com/mfessenden/SKTiled) - Swift framework for working with Tiled assets in SpriteKit.
...
*   [YYAsyncLayer (⭐672)](https://github.com/ibireme/YYAsyncLayer) - iOS utility classes for asynchronous rendering and display.
...
*   [Snowflake (⭐949)](https://github.com/onmyway133/Snowflake) - SVG in Swift.
...
*   [EPShapes (⭐390)](https://github.com/ipraba/EPShapes) - Design shapes in Interface Builder.
...
*   [Drawsana (⭐569)](https://github.com/Asana/Drawsana) - iOS framework for building raster drawing and image markup views.
...
*   [PeerKit (⭐861)](https://github.com/jpsim/PeerKit) An open-source Swift framework for building event-driven, zero-config Multipeer Connectivity apps.
...
*   [Lumina (⭐867)](https://github.com/dokun1/Lumina) - Full service camera that takes photos, videos, streams frames, detects metadata, and streams CoreML predictions.
...
*   [BeaconEmitter (⭐930)](https://github.com/lgaches/BeaconEmitter) - Turn your Mac as an iBeacon.
*   [JMCBeaconManager (⭐146)](https://github.com/izotx/JMCBeaconManager) - An iBeacon Manager class that is responsible for detecting beacons nearby.
...
*   [set-simulator-location (⭐620)](https://github.com/lyft/set-simulator-location) - CLI for setting location in the iOS simulator.
...
*   [DarkLightning (⭐318)](https://github.com/jensmeder/DarkLightning) - Simply the fastest way to transmit data between iOS/tvOS and macOS.
*   [Deviice (⭐56)](https://github.com/andrealufino/Deviice) - Simply library to detect the device on which the app is running (and some properties).
*   [DeviceKit (⭐3.9k)](https://github.com/devicekit/DeviceKit) - DeviceKit is a value-type replacement of UIDevice.
*   [Luminous (⭐324)](https://github.com/andrealufino/Luminous) - Luminous is a big framework which can give you a lot of information (more than 50) about the current system.
...
*   [WatchShaker (⭐200)](https://github.com/ezefranca/WatchShaker) - WatchShaker is a watchOS helper to get your shake movement written in swift.
...
*   [TapticEngine (⭐253)](https://github.com/WorldDownTown/TapticEngine) - TapticEngine generates iOS Device vibrations.
...
*   [Haptico (⭐461)](https://github.com/iSapozhnik/Haptico) - Easy to use haptic feedback generator with pattern-play support.
...
*   [Relayout (⭐560)](https://github.com/stevestreza/Relayout) - Swift microframework for declaring Auto Layout constraints functionally.
...
*   [Hodor (⭐545)](https://github.com/Aufree/Hodor) - Simple solution to localize your iOS App.
*   [Swifternalization (⭐575)](https://github.com/tomkowz/Swifternalization) - Localize iOS apps in a smarter way using JSON files. Swift framework.
...
*   [Localize (⭐279)](https://github.com/andresilvagomez/Localize) - Easy tool to localize apps using JSON or Strings and of course IBDesignables with extensions for UI components.
...
*   [SwiftyTextTable (⭐283)](https://github.com/scottrhoyt/SwiftyTextTable) - A lightweight tool for generating text tables.
...
*   [SwiftTrace (⭐605)](https://github.com/johnno1962/SwiftTrace) - Trace Swift and Objective-C method invocations.
*   [Willow (⭐1.3k)](https://github.com/Nike-Inc/Willow) - Willow is a powerful, yet lightweight logging library written in Swift.
*   [Bugfender (⭐69)](https://github.com/bugfender/BugfenderSDK-iOS) - Cloud storage for your app logs. Track user behaviour to find problems in your mobile apps.
...
*   [JustLog (⭐509)](https://github.com/justeat/JustLog) - Console, file and remote Logstash logging via TCP socket.
...
*   [AIToolbox (⭐776)](https://github.com/KevinCoble/AIToolbox) - A toolbox of AI modules written in Swift: Graphs/Trees, Linear Regression, Support Vector Machines, Neural Networks, PCA, KMeans, Genetic Algorithms, MDP, Mixture of Gaussians.
...
*   [ClusterKit (⭐502)](https://github.com/hulab/ClusterKit) - An iOS map clustering framework targeting MapKit, Google Maps and Mapbox.
*   [FlyoverKit (⭐692)](https://github.com/SvenTiigi/FlyoverKit) - FlyoverKit enables you to present stunning 360° flyover views on your MKMapView with zero effort while maintaining full configuration possibilities.
*   [MapViewPlus (⭐162)](https://github.com/okhanokbay/MapViewPlus) - Use any custom view as custom callout view of your MKMapView with cool animations. Also, easily use any image as annotation view.
...
*   [SwiftMath (⭐175)](https://github.com/madbat/SwiftMath) - A math framework for Swift. Includes: vectors, matrices, complex numbers, quaternions and polynomials.
...
*   [BigInt (⭐707)](https://github.com/attaswift/BigInt) - Arbitrary-precision arithmetic in pure Swift.
*   [SigmaSwiftStatistics (⭐657)](https://github.com/evgenyneu/SigmaSwiftStatistics) - A collection of functions for statistical calculation.
...
*   [AudioKit (⭐9.5k)](https://github.com/audiokit/AudioKit) - A powerful toolkit for synthesizing, processing, and analyzing sounds.
...
*   [Beethoven (⭐735)](https://github.com/vadymmarkov/Beethoven) - An audio processing Swift library for pitch detection of musical signals.
*   [AudioPlayerSwift (⭐260)](https://github.com/tbaranes/AudioPlayerSwift) - AudioPlayer is a simple class for playing audio in iOS, macOS and tvOS apps.
*   [AudioPlayer (⭐676)](https://github.com/delannoyk/AudioPlayer) - AudioPlayer is syntax and feature sugar over AVPlayer. It plays your audio files (local & remote).
...
*   [TheAmazingAudioEngine2 (⭐523)](https://github.com/TheAmazingAudioEngine/TheAmazingAudioEngine2) - The Amazing Audio Engine is a sophisticated framework for iOS audio applications, built so you don't have to.
...
*   [QuietModemKit (⭐442)](https://github.com/quiet/QuietModemKit) - iOS framework for the Quiet Modem (data over sound).
...
*   [Voice Overlay (⭐490)](https://github.com/algolia/voice-overlay-ios) - An overlay that gets your user’s voice permission and input as text in a customizable UI.
*   [ModernAVPlayer (⭐259)](https://github.com/noreasonprojects/ModernAVPlayer) - Persistence player to resume playback after bad network connection even in background mode, manage headphone interactions, system interruptions, now playing informations and remote commands.
...
*   [MapleBacon (⭐335)](https://github.com/JanGorman/MapleBacon) - An image download and caching library for iOS written in Swift.
...
*   [YXTMotionView (⭐79)](https://github.com/hanton/YXTMotionView) - A custom image view that implements device motion scrolling.
...
*   [Nuke (⭐7k)](https://github.com/kean/Nuke) - Image loading, processing, caching and preheating.
...
*   [ImageScout (⭐958)](https://github.com/kaishin/ImageScout) - A Swift implementation of fastimage. Supports PNG, GIF, and JPEG.
...
*   [Agrume (⭐601)](https://github.com/JanGorman/Agrume) - A lemony fresh iOS image viewer written in Swift.
...
*   [SwiftPhotoGallery (⭐271)](https://github.com/justinvallely/SwiftPhotoGallery) - Simple, fullscreen image gallery with tap, swipe, and pinch gestures.
...
*   [Imaginary (⭐597)](https://github.com/hyperoslo/Imaginary) - Remote images, as easy as one, two, three.
...
*   [FacebookImagePicker (⭐231)](https://github.com/floriangbh/FacebookImagePicker) - Facebook album photo picker written in Swift.
...
*   [FlexibleImage (⭐813)](https://github.com/kawoou/FlexibleImage) - A simple way to play with image!
...
*   [Paparazzo (⭐755)](https://github.com/avito-tech/Paparazzo) - Custom iOS camera and photo picker with editing capabilities.
*   [ZImageCropper (⭐219)](https://github.com/ZaidPathan/ZImageCropper) - A Swift  project to crop image in any shape.
...
*   [AXPhotoViewer (⭐595)](https://github.com/alexhillc/AXPhotoViewer) - An iPhone/iPad photo gallery viewer, useful for viewing a large (or small!) number of photos
...
*   [greedo-layout-for-ios (⭐831)](https://github.com/500px/greedo-layout-for-ios) - Full aspect ratio grid layout for iOS.
...
*   [ATGMediaBrowser (⭐200)](https://github.com/altayer-digital/ATGMediaBrowser) - Image slide-show viewer with multiple predefined transition styles, and ability to create new transitions with ease.
...
*   [QRCode (⭐730)](https://github.com/aschuch/QRCode) - A QRCode generator written in Swift.
...
*   [UIView 2 PDF (⭐34)](https://github.com/RobertAPhillips/UIView_2_PDF) - PDF generator using UIViews or UIViews with an associated XIB.
*   [FolioReaderKit (⭐2.5k)](https://github.com/FolioReader/FolioReaderKit) - A Swift ePub reader and parser framework for iOS.
*   [PDFGenerator (⭐711)](https://github.com/sgr-ksmt/PDFGenerator) - A simple Generator of PDF in Swift. Generate PDF from view(s) or image(s).
...
*   [TPPDF (⭐580)](https://github.com/Techprimate/TPPDF) - Generate PDF using commands and automatic layout.
...
*   [Jukebox (⭐545)](https://github.com/teodorpatras/Jukebox) - Player for streaming local and remote audio files. Written in Swift.
...
*   [Airstream (⭐374)](https://github.com/qasim/Airstream) - A framework for streaming audio between Apple devices using AirPlay.
...
*   [MessageKit (⭐5.4k)](https://github.com/MessageKit/MessageKit) - Eventually, a Swift re-write of JSQMessagesViewController.
...
*   [chat-sdk-ios (⭐878)](https://github.com/chat-sdk/chat-sdk-ios) - Chat SDK iOS - Open Source Mobile Messenger.
...
*   [Messenger Chat with Firebase (⭐614)](https://github.com/instamobile/messenger-iOS-chat-swift-firestore) - Swift messaging chat app with Firebase Firestore integration.
...
*   [Transporter (⭐450)](https://github.com/nghialv/Transporter) - A tiny library makes uploading and downloading easier.
*   [CDZPinger (⭐48)](https://github.com/cdzombak/CDZPinger) - Easy-to-use ICMP Ping.
*   [NSRails (⭐523)](https://github.com/dingbat/nsrails) - iOS/Mac OS framework for Rails.
...
*   [HappyDns (⭐475)](https://github.com/qiniu/happy-dns-objc) - A Dns library, support custom dns server, dnspod httpdns. Only support A record.
...
*   [TRON (⭐528)](https://github.com/MLSDev/TRON) - Lightweight network abstraction layer, written on top of Alamofire.
...
*   [MMLanScan (⭐459)](https://github.com/mavris/MMLanScan) - An iOS LAN Network Scanner library.
...
*   [AFNetworking+RetryPolicy (⭐209)](https://github.com/kubatruhlar/AFNetworking-RetryPolicy) - An objective-c category that adds the ability to set the retry logic for requests made with AFNetworking.
...
*   [EFInternetIndicator (⭐131)](https://github.com/ezefranca/EFInternetIndicator) - A little swift Internet error status indicator using ReachabilitySwift.
*   [AFNetworking-Synchronous (⭐160)](https://github.com/paulmelnikow/AFNetworking-Synchronous) - Synchronous requests for AFNetworking 1.x, 2.x, and 3.x.
...
*   [FGRoute (⭐137)](https://github.com/Feghal/FGRoute) - An easy-to-use library that helps developers to get wifi ssid, router and device ip addresses.
...
*   [AlamoRecord (⭐19)](https://github.com/tunespeak/AlamoRecord) - An elegant yet powerful iOS networking layer inspired by ActiveRecord.
...
*   [Postal (⭐644)](https://github.com/snipsco/Postal) - A swift framework providing simple access to common email providers.
...
*   [protobuf-swift (⭐933)](https://github.com/alexeyxo/protobuf-swift) - Google ProtocolBuffers for Apple Swift
...
*   [Pushkin (⭐257)](https://github.com/Nordeus/pushkin) - Free and open-source.
...
*   [Lumos (⭐139)](https://github.com/sushinoya/lumos) - A light Swift wrapper around Objective-C Runtime.
...
*   [CSV.swift (⭐592)](https://github.com/yaslab/CSV.swift) - CSV reading and writing library written in Swift.

### JSON

*   [Mantle (⭐11k)](https://github.com/Mantle/Mantle) - Model framework for Cocoa and Cocoa Touch.
*   [Groot (⭐533)](https://github.com/gonzalezreal/Groot) - Convert JSON dictionaries and arrays to and from Core Data managed objects.
...
*   [SwiftyJSONAccelerator (⭐929)](https://github.com/insanoid/SwiftyJSONAccelerator) - Generate Swift 5 model files from JSON with Codeable support.
...
*   [AEXML (⭐975)](https://github.com/tadija/AEXML) - Simple and lightweight XML parser written in Swift.
...
*   [Fuzi (⭐992)](https://github.com/cezheng/Fuzi) - A fast & lightweight XML & HTML parser in Swift with XPath & CSS support.
*   [Kanna (⭐2.3k)](https://github.com/tid-kijyun/Kanna)  - Kanna(鉋) is an XML/HTML parser for macOS/iOS.
*   [SwiftyXMLParser (⭐531)](https://github.com/yahoojapan/SwiftyXMLParser) - Simple XML Parser implemented in Swift.
...
*   [XMLCoder (⭐656)](https://github.com/MaxDesiatov/XMLCoder) - Encoder & Decoder for XML using Swift's `Codable` protocols.
...
*   [Erik (⭐543)](https://github.com/phimage/Erik) - Erik is an headless browser based on WebKit. An headless browser allow to run functional tests, to access and manipulate webpages using javascript.
...
*   [Venmo (⭐170)](https://github.com/venmo/venmo-ios-sdk) Make and accept payments in your iOS app via Venmo.
...
*   [monza (⭐158)](https://github.com/gabrielgarza/monza) - Ruby Gem for Rails - Easy iTunes In-App Purchase Receipt validation, including auto-renewable subscriptions.
...
*   [TPInAppReceipt (⭐519)](https://github.com/tikhop/TPInAppReceipt) - Reading and Validating In App Store Receipt.
...
*   [FramesIos (⭐47)](https://github.com/checkout/frames-ios) - Payment Form UI and Utilities in Swift.
*   [YRPayment (⭐177)](https://github.com/yassram/YRPayment) - Better payment user experience library with cool animation in Swift.
...
*   [AREK (⭐961)](https://github.com/ennioma/arek) - AREK is a clean and easy to use wrapper over any kind of iOS permission.
...
*   [NSObject-Rx (⭐625)](https://github.com/RxSwiftCommunity/NSObject-Rx) - Handy RxSwift extensions on NSObject, including rx\_disposeBag.
...
*   [Runtime (⭐968)](https://github.com/wickwirew/Runtime) - A Swift Runtime library for viewing type info, and the dynamic getting and setting of properties.
...
*   [Spotify (⭐522)](https://github.com/spotify/ios-sdk) Spotify iOS SDK.
*   [SpotifyLogin (⭐343)](https://github.com/spotify/SpotifyLogin) Spotify SDK Login in Swift.
*   [Facebook (⭐7.3k)](https://github.com/facebook/facebook-ios-sdk) Facebook iOS SDK.
...
*   [Tumblr (⭐420)](https://github.com/tumblr/TMTumblrSDK) Library for easily integrating Tumblr data into your iOS or macOS application.
*   [Evernote (⭐256)](https://github.com/evernote/evernote-cloud-sdk-ios) Evernote SDK for iOS.
*   [Box (⭐112)](https://github.com/box/box-ios-sdk) iOS + macOS SDK for the Box API.
...
*   [Shopify (⭐410)](https://github.com/Shopify/mobile-buy-sdk-ios) - Shopify’s Mobile Buy SDK makes it simple to sell physical products inside your mobile app.
*   [Pinterest](https://github.com/pinterest/ios-pdk) - Pinterest iOS SDK.
*   [playkit-ios (⭐77)](https://github.com/kaltura/playkit-ios) - PlayKit: Kaltura Player SDK for iOS.
*   [algoliasearch-client-swift (⭐192)](https://github.com/algolia/algoliasearch-client-swift) - Algolia Search API Client for Swift.
...
*   [rides-ios-sdk (⭐342)](https://github.com/uber/rides-ios-sdk) - Uber Rides iOS SDK (beta).
...
*   [objectiveflickr (⭐714)](https://github.com/lukhnos/objectiveflickr) - ObjectiveFlickr, a Flickr API framework for Objective-C.
...
*   [GitHub.swift (⭐184)](https://github.com/onmyway133/github.swift) - :octocat: Unofficial GitHub API client in Swift
...
*   [UnsplashKit (⭐188)](https://github.com/modo-studio/UnsplashKit) - Swift client for Unsplash.
*   [Swiftly Salesforce (⭐131)](https://github.com/mike4aday/SwiftlySalesforce) - An easy-to-use framework for building iOS apps that integrate with Salesforce, using Swift and promises.
...
*   [simple-touch (⭐117)](https://github.com/simple-machines/simple-touch) - Very simple swift wrapper for Biometric Authentication Services (Touch ID) on iOS.
...
*   [LTHPasscodeViewController (⭐627)](https://github.com/rolandleth/LTHPasscodeViewController) - An iOS passcode lockscreen replica (from Settings), with TouchID and simple (variable length) / complex support.
...
*   [BiometricAuthentication (⭐803)](https://github.com/rushisangani/BiometricAuthentication) - Use Apple FaceID or TouchID authentication in your app using BiometricAuthentication.
...
*   [IDZSwiftCommonCrypto (⭐472)](https://github.com/iosdevzone/IDZSwiftCommonCrypto) - A wrapper for Apple's Common Crypto library written in Swift.
...
*   [SwiftHash (⭐207)](https://github.com/onmyway133/SwiftHash) - Hash in Swift.
...
*   [SwCrypt (⭐695)](https://github.com/soyersoyer/SwCrypt) - RSA public/private key generation, RSA, AES encryption/decryption, RSA sign/verify in Swift with CommonCrypto in iOS and macOS.
...
*   [EnigmaKit (⭐113)](https://github.com/mikaoj/EnigmaKit) - Enigma encryption in Swift.
...
*   [Obfuscator-iOS (⭐601)](https://github.com/pjebs/Obfuscator-iOS) - Secure your app by obfuscating all the hard-coded security-sensitive strings.
*   [swift-sodium (⭐481)](https://github.com/jedisct1/swift-sodium) - Safe and easy to use crypto for iOS.
*   [CryptoSwift (⭐9.4k)](https://github.com/krzyzanowskim/CryptoSwift) - Crypto related functions and helpers for Swift implemented in Swift programming language.
...
*   [SecureEnclaveCrypto (⭐271)](https://github.com/trailofbits/SecureEnclaveCrypto) - Demonstration library for using the Secure Enclave on iOS.
...
*   [JOSESwift (⭐162)](https://github.com/airsidemobile/JOSESwift) - A framework for the JOSE standards JWS, JWE, and JWK written in Swift.
...
*   [SwiftGD (⭐420)](https://github.com/twostraws/swiftgd) - A simple Swift wrapper for libgd.
...
*   [Embassy (⭐540)](https://github.com/envoy/Embassy) - Super lightweight async HTTP server library in pure Swift runs in iOS / MacOS / Linux.
...
*   [Twitter Text Obj (⭐2.9k)](https://github.com/twitter/twitter-text) - An Objective-C implementation of Twitter's text processing library.
...
*   [PhoneNumberKit (⭐4.7k)](https://github.com/marmelroy/PhoneNumberKit) - A Swift framework for parsing, formatting and validating international phone numbers. Inspired by Google's libphonenumber.
...
*   [Marklight (⭐538)](https://github.com/macteo/Marklight) - Markdown syntax highlighter for iOS.
*   [MarkdownTextView (⭐676)](https://github.com/indragiek/MarkdownTextView) - Rich Markdown editing control for iOS.
*   [TextAttributes (⭐2.2k)](https://github.com/delba/TextAttributes) - An easier way to compose attributed strings.
*   [Reductio (⭐438)](https://github.com/fdzsergio/Reductio) - Automatic summarizer text in Swift.
...
*   [Heimdall (⭐393)](https://github.com/henrinormak/Heimdall) - Heimdall is a wrapper around the Security framework for simple encryption/decryption operations.
...
*   [Smile (⭐476)](https://github.com/onmyway133/Smile) Emoji in Swift.
...
*   [MarkdownKit (⭐687)](https://github.com/bmoliveira/MarkdownKit) - A simple and customizable Markdown Parser for Swift.
*   [CocoaMarkdown (⭐1.2k)](https://github.com/indragiek/CocoaMarkdown) - Markdown parsing and rendering for iOS and macOS.
*   [Notepad (⭐801)](https://github.com/ruddfawcett/Notepad) - A fully themeable markdown editor with live syntax highlighting.
...
*   [AttributedTextView (⭐430)](https://github.com/evermeer/AttributedTextView) - Easiest way to create an attributed UITextView with support for multiple links (including hashtags and mentions).
*   [StyleDecorator (⭐15)](https://github.com/dimpiax/StyleDecorator) - Design string simply by linking attributes to needed parts.
*   [Mustard (⭐695)](https://github.com/mathewsanders/Mustard) - Mustard is a Swift library for tokenizing strings when splitting by whitespace doesn't cut it.
*   [Input Mask (⭐548)](https://github.com/RedMadRobot/input-mask-ios) - Pattern-based user input formatter, parser and validator for iOS.
...
*   [Marky Mark (⭐287)](https://github.com/m2mobi/Marky-Mark) - Highly customizable Markdown parsing and native rendering in Swift.
...
*   [Swicon (⭐39)](https://github.com/UglyTroLL/Swicon) - Use 1600+ icons (and more!) from FontAwesome and Google Material Icons in your swift/iOS project in an easy and space-efficient way!
...
*   [Money (⭐883)](https://github.com/Flight-School/Money) - A precise, type-safe representation of a monetary amount in a given currency.
...
*   [robotframework-appiumlibrary (⭐327)](https://github.com/serhatbolsu/robotframework-appiumlibrary) - AppiumLibrary is an appium testing library for RobotFramework.
...
*   [Subliminal (⭐762)](https://github.com/inkling/Subliminal) - An understated approach to iOS integration testing.
...
*   [Remote (⭐791)](https://github.com/johnno1962/Remote) - Control your iPhone from inside Xcode for end-to-end testing.
...
*   [MirrorDiffKit (⭐179)](https://github.com/Kuniwak/MirrorDiffKit) - Pretty diff between any structs or classes.
...
*   [Texture (⭐7.7k)](https://github.com/TextureGroup/Texture) - Smooth asynchronous user interfaces for iOS apps.
...
*   [UIView-draggable (⭐440)](https://github.com/andreamazz/UIView-draggable) - UIView category that adds dragging capabilities.
...
*   [LeeGo (⭐970)](https://github.com/wangshengjia/LeeGo) - Declarative, configurable & highly reusable UI development as making Lego bricks.
...
*   [VisualEffectView (⭐955)](https://github.com/efremidze/VisualEffectView) - UIVisualEffectView subclass with tint color.
*   [Cacao (⭐1.1k)](https://github.com/PureSwift/Cacao) - Pure Swift Cross-platform UIKit (Cocoa Touch) implementation (Supports Linux).
*   [JDFlipNumberView (⭐750)](https://github.com/calimarkus/JDFlipNumberView) - Representing analog flip numbers like airport/trainstation displays.
...
*   [NightNight (⭐781)](https://github.com/Draveness/NightNight) - Elegant way to integrate night mode to swift projects.
...
*   [SwiftVideoBackground (⭐334)](https://github.com/dingwilson/SwiftVideoBackground) - Easy to Use UIView subclass for implementing a video background.
...
*   [Macaw-Examples (⭐347)](https://github.com/exyte/Macaw-Examples) - Various usages of the Macaw library.
...
*   [FAQView (⭐467)](https://github.com/mukeshthawani/FAQView) - An easy to use FAQ view for iOS written in Swift.
...
*   [IGColorPicker (⭐272)](https://github.com/iGenius-Srl/IGColorPicker) - A customizable color picker for iOS in Swift.
*   [KPActionSheet (⭐7)](https://github.com/khuong291/KPActionSheet) -  A replacement of default action sheet, but has very simple usage.
*   [SegmentedProgressBar (⭐442)](https://github.com/D-32/SegmentedProgressBar) - Snapchat / Instagram Stories style animated indicator.
...
*   [Haptica (⭐701)](https://github.com/efremidze/Haptica) - Easy Haptic Feedback Generator.
...
*   [SwiftyUI (⭐336)](https://github.com/haoking/SwiftyUI) - High performance and lightweight(one class each UI) UIView, UIImage, UIImageView, UIlabel, UIButton, Promise and more.
...
*   [HGRippleRadarView (⭐352)](https://github.com/HamzaGhazouani/HGRippleRadarView) - A beautiful radar view to show nearby items (users, restaurants, ...) with ripple animation, fully customizable.
*   [GDGauge (⭐74)](https://github.com/saeid/GDGauge) - Full Customizable, Beautiful, Easy to use gauge view Edit.
...
*   [Sejima (⭐64)](https://github.com/MoveUpwards/Sejima) - A collection of User Interface components for iOS.
*   [UI Fabric by Microsoft (⭐581)](https://github.com/OfficeDev/ui-fabric-ios) - UI framework based on [Fluent Design System](https://www.microsoft.com/design/fluent/#/ios) by Microsoft.
...
*   [iOS-CircleProgressView (⭐515)](https://github.com/CardinalNow/iOS-CircleProgressView) - This control will allow a user to use code instantiated or interface builder to create and render a circle progress view.
...
*   [KYNavigationProgress (⭐247)](https://github.com/ykyouhei/KYNavigationProgress) - Simple extension of UINavigationController to display progress on the UINavigationBar.
...
*   [ParticlesLoadingView (⭐959)](https://github.com/BalestraPatrick/ParticlesLoadingView) - A customizable SpriteKit particles animation on the border of a view.
...
*   [MBCircularProgressBar (⭐979)](https://github.com/MatiBot/MBCircularProgressBar) -  A circular, animatable & highly customizable progress bar, editable from the Interface Builder using IBDesignable.
...
*   [FlexibleSteppedProgressBar (⭐549)](https://github.com/amratab/FlexibleSteppedProgressBar) - A beautiful easily customisable stepped progress bar.
*   [GradientLoadingBar (⭐791)](https://github.com/fxm90/GradientLoadingBar) - An animated gradient loading bar.
...
*   [GradientProgressBar (⭐490)](https://github.com/fxm90/GradientProgressBar) - A gradient progress bar (UIProgressView).
...
*   [StepProgressView (⭐340)](https://github.com/yonat/StepProgressView) - Step-by-step progress view with labels and shapes. A good replacement for UIActivityIndicatorView and UIProgressView.
...
*   [JDBreaksLoading (⭐155)](https://github.com/jamesdouble/JDBreaksLoading) - You can easily start up a little breaking game indicator by one line.
...
*   [Windless (⭐940)](https://github.com/Interactive-Studio/Windless) - Windless makes it easy to implement invisible layout loading view.
...
*   [StatusBarOverlay (⭐160)](https://github.com/IdleHandsApps/StatusBarOverlay) - Automatically show/hide a "No Internet Connection" bar when your app loses/gains connection. It supports apps which hide the status bar and "The Notch".
...
*   [IHProgressHUD (⭐202)](https://github.com/Swiftify-Corp/IHProgressHUD) - Simple HUD, thread safe, supports iOS, tvOS and App Extensions.
...
*   [Cheetah (⭐592)](https://github.com/suguru/Cheetah) - Easy animation library on iOS.
...
*   [Animo (⭐279)](https://github.com/eure/Animo) - SpriteKit-like animation builders for CALayers.
...
*   [Walker (⭐152)](https://github.com/RamonGilabert/Walker) - A new animation engine for your app.
...
*   [ADPuzzleAnimation (⭐126)](https://github.com/Antondomashnev/ADPuzzleAnimation) - Custom animation for UIView inspired by Fabric - Answers animation.
...
*   [MotionMachine (⭐387)](https://github.com/poetmountain/MotionMachine) - A powerful, elegant, and modular animation library for Swift.
...
*   [Bubble (⭐218)](https://github.com/goldmoment/Bubble) - Fruit Animation.
...
*   [Anima (⭐528)](https://github.com/satoshin21/Anima) - Anima is chainable Layer-Based Animation library for Swift4.
...
*   [fireworks (⭐324)](https://github.com/tomkowz/fireworks) - Fireworks effect for UIView
...
*   [ZOZolaZoomTransition (⭐903)](https://github.com/NewAmsterdamLabs/ZOZolaZoomTransition) - Zoom transition that animates the entire view hierarchy. Used extensively in the Zola iOS application.
...
*   [Kaeru (⭐508)](https://github.com/bannzai/Kaeru) - Switch viewcontroller like iOS task manager.
...
*   [PresenterKit (⭐559)](https://github.com/jessesquires/PresenterKit) - Swifty view controller presentation for iOS.
...
*   [TTGSnackbar (⭐608)](https://github.com/zekunyan/TTGSnackbar) - Show simple message and action button on the bottom of the screen with multi kinds of animation.
...
*   [RMPickerViewController (⭐382)](https://github.com/CooperRS/RMPickerViewController) - Select something using UIPickerView in a UIAlertController like fashion.
...
*   [RMessage (⭐407)](https://github.com/donileo/RMessage) - A crisp in-app notification/message banner built in ObjC.
...
*   [Sheet (⭐322)](https://github.com/ParkGwangBeom/Sheet) - SHEET helps you easily create a wide variety of action sheets with navigation features used in the Flipboard App
...
*   [swift-badge (⭐385)](https://github.com/evgenyneu/swift-badge) - Badge view for iOS written in swift
*   [BadgeHub (⭐766)](https://github.com/jogendra/BadgeHub) - Make any UIView a full fledged animated notification center. It is a way to quickly add a notification badge icon to a UIView.
...
*   [SwiftyButton (⭐542)](https://github.com/TakeScoop/SwiftyButton) - Simple and customizable button in Swift
...
*   [NFDownloadButton (⭐433)](https://github.com/LeonardoCardoso/NFDownloadButton) - Revamped Download Button.
...
*   [Koyomi (⭐741)](https://github.com/shoheiyokoyama/Koyomi) - Simple customizable calendar component in Swift
...
*   [MBCalendarKit (⭐563)](https://github.com/MosheBerman/MBCalendarKit) - A calendar framework for iOS built with customization, and localization in mind.
...
*   [KDCalendarView (⭐525)](https://github.com/mmick66/CalendarView) - A calendar component for iOS written in Swift 4.0. It features both vertical and horizontal layout (and scrolling) and the display of native calendar events.
*   [CalendarPopUp (⭐186)](https://github.com/orazz/CalendarPopUp) - CalendarPopUp - JTAppleCalendar library.
...
*   [DMSwipeCards (⭐250)](https://github.com/D-32/DMSwipeCards) - Tinder like card stack that supports lazy loading and generics
...
*   [CardsLayout (⭐796)](https://github.com/filletofish/CardsLayout) - Nice card-designed custom collection view layout.
...
*   [ValidatedPropertyKit (⭐873)](https://github.com/SvenTiigi/ValidatedPropertyKit) - Easily validate your Properties with Property Wrappers.
...
*   [CountdownLabel (⭐902)](https://github.com/suzuki-0000/CountdownLabel) - Simple countdown UILabel with morphing animation, and some useful function.
...
*   [THLabel (⭐654)](https://github.com/tobihagemann/THLabel) - UILabel subclass, which additionally allows shadow blur, inner shadow, stroke text and fill gradient.
...
*   [AnimatedMaskLabel (⭐19)](https://github.com/jogendra/AnimatedMaskLabel) -  Animated Mask Label is a nice gradient animated label. This is an easy way to add a shimmering effect to any view in your app.
*   [STULabel (⭐96)](https://github.com/stephan-tolksdorf/STULabel) -  A label view that's faster than UILabel and supports asynchronous rendering, links with UIDragInteraction, very flexible text truncation, Auto Layout, UIAccessibility and more.
...
*   [Cely (⭐164)](https://github.com/cely-tools/Cely) - Plug-n-Play login framework written in Swift.
...
*   [DropDownMenuKit (⭐258)](https://github.com/qmathe/DropDownMenuKit) - A simple, modular and highly customizable UIKit menu, that can be attached to the navigation bar or toolbar, written in Swift.
...
*   [InteractiveSideMenu (⭐706)](https://github.com/handsomecode/InteractiveSideMenu) - Customizable iOS Interactive Side Menu written in Swift 3.
...
*   [AirBar (⭐625)](https://github.com/uptechteam/AirBar) - UIScrollView driven expandable menu written in Swift 3.
...
*   [ContextMenu (⭐971)](https://github.com/GitHawkApp/ContextMenu) - An iOS context menu UI inspired by Things 3.
...
*   [CircleBar (⭐786)](https://github.com/softhausHQ/CircleBar) - 🔶 A fun, easy-to-use tab bar navigation controller for iOS.
*   [SPLarkController (⭐965)](https://github.com/IvanVorobei/SPLarkController) - Settings screen with buttons and switches.
...
*   [PickerView (⭐488)](https://github.com/filipealva/PickerView) - A customizable alternative to UIPickerView in Swift.
*   [DatePickerDialog (⭐535)](https://github.com/squimer/DatePickerDialog-iOS-Swift) - Date picker dialog for iOS
...
*   [CountryPicker (⭐207)](https://github.com/4taras4/CountryCode) - :date: UIPickerView with Country names flags and phoneCodes
...
*   [D2PDatePicker (⭐292)](https://github.com/di2pra/D2PDatePicker) - Elegant and Easy-to-Use iOS Swift Date Picker
*   [CountryPickerView (⭐458)](https://github.com/kizitonwose/CountryPickerView)- A simple, customizable view for efficiently collecting country information in iOS apps
...
*   [SKCountryPicker (⭐243)](https://github.com/SURYAKANTSHARMA/CountryPicker) - A simple, customizable Country picker for picking country or dialing code.
...
*   [PopupController (⭐338)](https://github.com/daisuke310vvv/PopupController) - A customizable controller for showing temporary popup view.
...
*   [MIBlurPopup (⭐607)](https://github.com/MarioIannotta/MIBlurPopup) - MIBlurPopup let you create amazing popups with a blurred background.
...
*   [SwiftEntryKit (⭐6.1k)](https://github.com/huri000/SwiftEntryKit) - A highly customizable popups, alerts and banners presenter for iOS. It offers various presets and is written in pure Swift.
*   [FFPopup (⭐825)](https://github.com/JonyFang/FFPopup) - ⛩FFPopup is a lightweight library for presenting custom views as a popup.
...
*   [GradientCircularProgress (⭐523)](https://github.com/keygx/GradientCircularProgress) - Customizable progress indicator library in Swift.
...
*   [BOZPongRefreshControl (⭐885)](https://github.com/boztalay/BOZPongRefreshControl) - A pull-down-to-refresh control for iOS that plays pong, originally created for the MHacks III iOS app
...
*   [mntpulltoreact (⭐777)](https://github.com/mentionapp/mntpulltoreact) - One gesture, many actions. An evolution of Pull to Refresh.
...
*   [CRRefresh (⭐957)](https://github.com/CRAnimation/CRRefresh) - An easy way to use pull-to-refresh.
...
*   [AppStoreStyleHorizontalScrollView (⭐663)](https://github.com/terenceLuffy/AppStoreStyleHorizontalScrollView) - App store style horizontal scroll view.
...
*   [SlideController (⭐409)](https://github.com/touchlane/SlideController) - SlideController is simple and flexible UI component completely written in Swift. It is a nice alternative for UIPageViewController built using power of generic types.
...
*   [SJFluidSegmentedControl (⭐902)](https://github.com/sasojadrovski/SJFluidSegmentedControl) - A segmented control with custom appearance and interactive animations. Written in Swift 3.0.
...
*   [PinterestSegment (⭐672)](https://github.com/TBXark/PinterestSegment) - A Pinterest-like segment control with masking animation.
...
*   [RangeSlider (⭐305)](https://github.com/warchimede/RangeSlider) - A simple range slider made in Swift
...
*   [TTRangeSlider (⭐952)](https://github.com/TomThorpe/TTRangeSlider) - A slider, similar in style to UISlider, but which allows you to pick a minimum and maximum range.
*   [MMSegmentSlider (⭐48)](https://github.com/MedvedevMax/MMSegmentSlider) - Customizable animated slider for iOS.
*   [StepSlider (⭐520)](https://github.com/spromicky/StepSlider) - StepSlider its custom implementation of slider such as UISlider for preset integer values.
...
*   [RangeSeekSlider (⭐644)](https://github.com/WorldDownTown/RangeSeekSlider) - A customizable range slider for iOS.
*   [SectionedSlider (⭐361)](https://github.com/LeonardoCardoso/SectionedSlider) - Control Center Slider.
*   [MultiSlider (⭐325)](https://github.com/yonat/MultiSlider) - UISlider clone with multiple thumbs and values, optional snap intervals, optional value labels.
*   [AGCircularPicker (⭐617)](https://github.com/agilie/AGCircularPicker) - AGCircularPicker is helpful component for creating a controller aimed to manage any calculated parameter.
...
*   [ValueStepper (⭐364)](https://github.com/BalestraPatrick/ValueStepper) - A Stepper object that displays its value.
...
*   [TKSwitcherCollection (⭐903)](https://github.com/TBXark/TKSwitcherCollection) - An animate switch collection
...
*   [Switcher (⭐205)](https://github.com/knn90/Switcher) - Swift - Custom UISwitcher with animation when change status
...
*   [AIFlatSwitch (⭐961)](https://github.com/cocoatoucher/AIFlatSwitch) - A flat component alternative to UISwitch on iOS
...
*   [AZTabBarController (⭐335)](https://github.com/Minitour/AZTabBarController) - A custom tab bar controller for iOS written in Swift 3.0
...
*   [WormTabStrip (⭐176)](https://github.com/EzimetYusup/WormTabStrip) Beatiful ViewPager For iOS written in Swift  (inspired by Android [SmartTabLayout (⭐7k)](https://github.com/ogaclejapan/SmartTabLayout))
...
*   [ExpandedTabBar (⭐256)](https://github.com/yervandsar/ExpandedTabBar) - Very creative designed solution for "more" items in UITabBarController
...
*   [QuickTableViewController (⭐525)](https://github.com/bcylin/QuickTableViewController) - A simple way to create a UITableView for settings in Swift.
*   [TableKit (⭐694)](https://github.com/maxsokolov/TableKit) - Type-safe declarative table views with Swift
...
*   [MYTableViewIndex (⭐520)](https://github.com/mindz-eye/MYTableViewIndex) - A pixel perfect replacement for UITableView section index, written in Swift
...
*   [SwiftReorder (⭐378)](https://github.com/adamshin/SwiftReorder) - Add drag-and-drop reordering to any table view with just a few lines of code. Robust, lightweight, and completely customizable. \[e]
...
*   [TableViewDragger (⭐515)](https://github.com/KyoheiG3/TableViewDragger) - A cells of UITableView can be rearranged by drag and drop.
...
*   [CascadingTableDelegate (⭐920)](https://github.com/edopelawi/CascadingTableDelegate) - A no-nonsense way to write cleaner UITableViewDelegate and UITableViewDataSource in Swift.
...
*   [ASCollectionView (⭐364)](https://github.com/abdullahselek/ASCollectionView) - A Swift collection view inspired by Airbnb.
*   [GLTableCollectionView (⭐708)](https://github.com/giulio92/GLTableCollectionView) - Netflix and App Store like UITableView with UICollectionView
*   [EditDistance (⭐90)](https://github.com/kazuhiro4949/EditDistance) - Incremental update tool for UITableView and UICollectionView
*   [SwiftSpreadSheet (⭐636)](https://github.com/stuffrabbit/SwiftSpreadsheet) - Spreadsheet CollectionViewLayout in Swift. Fully customizable.
...
*   [KDDragAndDropCollectionView (⭐508)](https://github.com/mmick66/KDDragAndDropCollectionView) - Dragging & Dropping data across multiple UICollectionViews.
...
*   [CampcotCollectionView (⭐172)](https://github.com/touchlane/CampcotCollectionView) - CampcotCollectionView is a custom UICollectionView written in Swift that allows to expand and collapse sections. It provides a simple API to manage collection view appearance.
...
*   [YNExpandableCell (⭐457)](https://github.com/younatics/YNExpandableCell) - Awesome expandable, collapsible tableview cell for iOS.
...
*   [ExpandableCell (⭐727)](https://github.com/younatics/ExpandableCell) - Fully refactored YNExapnadableCell with more concise, bug free. Awesome expandable, collapsible tableview cell for iOS.
...
*   [SquareMosaicLayout (⭐254)](https://github.com/iwheelbuy/SquareMosaicLayout) - An extandable mosaic UICollectionViewLayout with a focus on extremely flexible customizations
...
*   [Swinflate (⭐224)](https://github.com/VladIacobIonut/Swinflate) -  A bunch of layouts providing light and seamless experiences in your CollectionView.
...
*   [TagCellLayout (⭐345)](https://github.com/riteshhgupta/TagCellLayout) - UICollectionView layout for Tags with Left, Center & Right alignments.
...
*   [UITextField-Shake (⭐749)](https://github.com/andreamazz/UITextField-Shake) - UITextField category that adds shake animation. [Also with Swift version (⭐15)](https://github.com/King-Wizard/UITextField-Shake-Swift)
...
*   [RSKGrowingTextView (⭐939)](https://github.com/ruslanskorb/RSKGrowingTextView) - A light-weight UITextView subclass that automatically grows and shrinks.
...
*   [KMPlaceholderTextView (⭐795)](https://github.com/MoZhouqi/KMPlaceholderTextView) - A UITextView subclass that adds support for multiline placeholder written in Swift.
...
*   [CBPinEntryView (⭐183)](https://github.com/Fawxy/CBPinEntryView) - A customisable view written in Swift 4.2 for any pin, code or password entry. Supports one time codes in iOS 12.
*   [GrowingTextView (⭐940)](https://github.com/KennethTsang/GrowingTextView) - An UITextView in Swift3 and Swift2.3. Support auto growing, placeholder and length limit.
*   [DTTextField (⭐306)](https://github.com/iDhaval/DTTextField) - DTTextField is a custom textfield with floating placeholder and error label in Swift3.0.
...
*   [InstantSearch iOS (⭐567)](https://github.com/algolia/instantsearch-ios) - A library of widgets and helpers to build instant-search applications on iOS.
...
*   [TweeTextField (⭐471)](https://github.com/oleghnidets/TweeTextField) - Lightweight set of text fields with nice animation and functionality.
...
*   [InputBarAccessoryView (⭐965)](https://github.com/nathantannar4/InputBarAccessoryView) - A simple and easily customizable InputAccessoryView for making powerful input bars with autocomplete and attachments.
...
*   [SwiftWebVC (⭐314)](https://github.com/meismyles/SwiftWebVC) - A drop-in inline browser for your Swift iOS app.
...
*   [Swifty360Player (⭐148)](https://github.com/abdullahselek/Swifty360Player) - iOS 360-degree video player streaming from an AVPlayer with Swift.
...
*   [GHWalkThrough (⭐717)](https://github.com/GnosisHub/GHWalkThrough) - A UICollectionView backed drop-in component for introduction views.
...
*   [AlertOnboarding (⭐829)](https://github.com/PhilippeBoisney/AlertOnboarding) - A simple and handsome AlertView for onboard your users in your amazing world.
...
*   [Material Showcase iOS (⭐349)](https://github.com/aromajoin/material-showcase-ios) - An elegant and beautiful showcase for iOS apps.
*   [ConcentricOnboarding (⭐950)](https://github.com/exyte/ConcentricOnboarding) - SwiftUI library for a walkthrough or onboarding flow with tap actions.
...
*   [crafter (⭐548)](https://github.com/krzysztofzablocki/crafter) - CLI that allows you to configure iOS project's template using custom DSL syntax, simple to use and quite powerful.
...
*   [Tuist (⭐3.1k)](https://github.com/tuist/tuist) - A tool to create, maintain and interact with Xcode projects at scale.
...
*   [Shark (⭐377)](https://github.com/kaandedeoglu/Shark) - Swift Script that transforms the .xcassets folder into a type safe enum.
...
*   [R.swift (⭐8.9k)](https://github.com/mac-cain13/R.swift) - Tool to get strong typed, autocompleted resources like images, cells and segues in your Swift project.
...
*   [Blade (⭐822)](https://github.com/jondot/blade) - Generate Xcode image catalogs for iOS / macOS app icons, universal images, and more.
...
*   [abandoned-strings (⭐360)](https://github.com/ijoshsmith/abandoned-strings) - Command line program that detects unused resource strings in an iOS or macOS application.
...
*   [Kin (⭐856)](https://github.com/Karumi/Kin) - Have you ever found yourself undoing a merge due to a broken Xcode build? Then Kin is your tool. It will parse your project configuration file and detect errors.
...
*   [FBSimulatorControl (⭐4k)](https://github.com/facebook/idb) - A macOS library for managing and manipulating iOS Simulators
...
*   [Sourcery (⭐6.9k)](https://github.com/krzysztofzablocki/Sourcery) - A tool that brings meta-programming to Swift, allowing you to code generate Swift code.
*   [AssetChecker 👮 (⭐202)](https://github.com/freshOS/AssetChecker) - Keeps your Assets.xcassets files clean and emits warnings when something is suspicious.
*   [PlayAlways (⭐538)](https://github.com/insidegui/PlayAlways) - Create Xcode playgrounds from your menu bar
...
*   [FengNiao (⭐3.1k)](https://github.com/onevcat/FengNiao) - A command line tool for cleaning unused resources in Xcode.
...
*   [XcodeGen (⭐5.8k)](https://github.com/yonaskolb/XcodeGen) - Command line tool that generates your Xcode project from a spec file and your folder structure.
...
*   [Model2App (⭐132)](https://github.com/Q-Mobile/Model2App) - Turn your Swift data model into a working CRUD app.
...
*   [Vaccine (⭐298)](https://github.com/zenangst/Vaccine) - Vaccine is a framework that aims to make your apps immune to recompile-decease.
...
*   [Swift Cheat Sheet (⭐957)](https://github.com/iwasrobbed/Swift-CheatSheet) - A quick reference cheat sheet for common, high level topics in Swift.
...
*   [Feeds for iOS Developer (⭐106)](https://github.com/rgnlax/Feeds-for-iOS-Developer) - The list of RSS feeds for iOS developers.
...
*   [iOS Learning Resources (⭐444)](https://github.com/sanketfirodiya/iOS-learning-resources) Comprehensive collection of high quality, frequently updated and well maintained iOS tutorial sites.
...
*   [awesome-gists (⭐528)](https://github.com/vsouza/awesome-gists#ios) - A list of amazing gists (iOS section).
*   [awesome-ios-ui (⭐11k)](https://github.com/cjwirth/awesome-ios-ui) - A curated list of awesome iOS UI/UX libraries.
*   [awesome-interview-questions (⭐52k)](https://github.com/MaximAbramchuck/awesome-interview-questions#ios) - A curated awesome list of lists of interview questions including iOS.
...
*   [example-ios-apps (⭐751)](https://github.com/jogendra/example-ios-apps) - A curated list of Open Source example iOS apps developed in Swift.
...
*   [Awesome iOS Interview question list (⭐995)](https://github.com/dashvlas/awesome-ios-interview) - Guide for interviewers and interviewees. Review these iOS interview questions - and get some practical tips along the way.
