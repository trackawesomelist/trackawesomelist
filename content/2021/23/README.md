...
*   [Threat Bus (⭐247)](https://github.com/tenzir/threatbus) - Threat intelligence dissemination layer to connect security tools through a distributed publish/subscribe message broker.
...
## [20. Awesome Bioinformatics](/content/danielecook/Awesome-Bioinformatics/week/README.md)
...
*   [michaelbull/kotlin-result (⭐944)](https://github.com/michaelbull/kotlin-result) - A Result monad for modelling success or failure operations - inspired by Elm, Rust, & Haskell.

### Libraries/Frameworks / Database

*   [consoleau/kotlin-jpa-specification-dsl (⭐247)](https://github.com/consoleau/kotlin-jpa-specification-dsl) - This library provides a fluent DSL for querying spring data JPA repositories using spring data Specifications.
...
*   [NTBBloodbath/cheovim (⭐332)](https://github.com/NTBBloodbath/cheovim) - Neovim configuration switcher written in Lua. Inspired by chemacs.
...
*   [jghauser/follow-md-links.nvim (⭐130)](https://github.com/jghauser/follow-md-links.nvim) - Press enter to follow internal markdown links.

### Snippet / Diagnostics

*   [L3MON4D3/LuaSnip (⭐3k)](https://github.com/L3MON4D3/LuaSnip) - A snippet engine written in Lua.
...
*   [sainnhe/gruvbox-material (⭐1.7k)](https://github.com/sainnhe/gruvbox-material) - Gruvbox modification with softer contrast and Tree-sitter support.
...
*   [NTBBloodbath/doom-one.nvim (⭐197)](https://github.com/NTBBloodbath/doom-one.nvim) - Lua port of doom-emacs' doom-one.

### Utility / Diagnostics

*   [jghauser/mkdir.nvim (⭐207)](https://github.com/jghauser/mkdir.nvim) - Automatically create missing directories when saving files.

### Debugging / Diagnostics

*   [rcarriga/nvim-dap-ui (⭐2.3k)](https://github.com/rcarriga/nvim-dap-ui) - A UI for nvim-dap.

### Git / Diagnostics

*   [sindrets/diffview.nvim (⭐3.4k)](https://github.com/sindrets/diffview.nvim) - Single tabpage interface for easily cycling through diffs for all modified files for any git rev.

### Editing Support / Diagnostics

*   [nacro90/numb.nvim (⭐585)](https://github.com/nacro90/numb.nvim) - Peek lines in a non-obtrusive way.
...
- API: [Currency-api (⭐12)](https://github.com/fawazahmed0/currency-api#readme)
