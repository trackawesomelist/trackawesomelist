...
- Name: [flow.ci](https://github.com/flowci)
  ...
  Documentation: [Documentation (⭐727)](https://github.com/flowci/docs)

  Price: [Open Source (⭐410)](https://github.com/flowci/docker-install)
...
*   [Diff (⭐178)](https://github.com/paleite/eslint-plugin-diff) - Run ESLint on your changed lines only. Also supports CI!
