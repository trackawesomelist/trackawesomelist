...
- API: [Movebank (⭐124)](https://github.com/movebank/movebank-api-doc)
...
- API: [npm Registry (⭐432)](https://github.com/npm/registry/blob/master/docs/REGISTRY-API.md)
...
- API: [Lanyard (⭐875)](https://github.com/Phineas/lanyard)
