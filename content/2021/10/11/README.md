...
- API: [Movebank (⭐110)](https://github.com/movebank/movebank-api-doc)
...
- API: [npm Registry (⭐396)](https://github.com/npm/registry/blob/master/docs/REGISTRY-API.md)
...
- API: [Lanyard (⭐772)](https://github.com/Phineas/lanyard)
