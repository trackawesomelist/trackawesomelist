...
*   [Awesome products in Clojure](#awesome-products-in-clojure)
    ...
    *   [Puppet Server (⭐277)](https://github.com/puppetlabs/puppet-server)
    ...
    *   [Clojupyter (⭐782)](https://github.com/clojupyter/clojupyter)
    *   [meins (⭐421)](https://github.com/matthiasn/meins)
    *   [Jepsen (⭐6.1k)](https://github.com/jepsen-io/jepsen)
    *   [Braid (⭐905)](https://github.com/braidchat/braid): a team-chat app with a novel UI that leads to better conversations
    *   [Accelerated Text (⭐701)](https://github.com/tokenmill/accelerated-text): a natural language generation environment (backend: Clojure, frontend: JS)
    *   [Ziggurat (⭐377)](https://github.com/gojek/ziggurat): a framework built to simplify Stream processing on Kafka
    *   [Nightcode (⭐1.4k)](https://github.com/oakes/Nightcode): An IDE for Clojure (archived)
    *   [Nightlight (⭐792)](https://github.com/oakes/Nightlight): text editor (archived)
    ...
    *   [racing-game-cljs (⭐225)](https://github.com/ertugrulcetin/racing-game-cljs) - A 3D racing game built with ClojureScript, React and ThreeJS

*   [Awesome SaaS (partially OSS) in Clojure](#awesome-saas-in-clojure)
    *   [Logseq (⭐23k)](https://github.com/logseq/logseq): knowledge management and collaboration (open frontend)

*   [Languages written with Clojure](#languages-written-with-clojure)
    *   [jank (⭐1.1k)](https://github.com/jeaye/jank)
    *   [lux (⭐1.5k)](https://github.com/LuxLang/lux)
    *   [mal (⭐9.3k)](https://github.com/kanaka/mal/tree/master/impls/clojure)
...
*   [meander (⭐866)](https://github.com/noprompt/meander) - transparent data transformation using datastructure pattermatching
