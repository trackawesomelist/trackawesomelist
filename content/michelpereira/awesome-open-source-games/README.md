...
[🏠 Home](/README.md) · [🔍 Search](https://www.trackawesomelist.com/search/) · [🔥 Feed](https://www.trackawesomelist.com/michelpereira/awesome-open-source-games/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 michelpereira/awesome-open-source-games](https://github.com/michelpereira/awesome-open-source-games) · ⭐ 3.1K · 🏷️ Gaming
...
*   [Pip (⭐10)](https://github.com/playpip/pip-web) - Single-player Texas Hold'em against AI opponents with distinct playing styles. Play money only. Runs in the browser, installs as a PWA and works offline. Built with Next.js and TypeScript.

## [Aug 03, 2026](/content/2026/08/03/README.md)

### Native / Sandbox

*   [Unturned (⭐3.8k)](https://github.com/SmartlyDressedGames/U3-SDK) - Free open-world zombie survival sandbox game.

### Mobile Games / Android

*   [Braincup (⭐291)](https://github.com/SimonSchubert/Braincup) - Memory, focus & math trainer.
...
*   [Blocks Beyond the Stars (⭐35)](https://github.com/marceld23/BlocksBeyondTheStars) - Block-based 3D space crafting sandbox with procedurally generated planets, block-by-block ship & base building and self-hostable multiplayer (Unity client, .NET server).

## [May 30, 2026](/content/2026/05/30/README.md)

### Browser-Based / Rhythm

*   [Bemuse (⭐1.2k)](https://github.com/bemusic/bemuse) - Online rhythm game playing songs in [BMS (⭐141)](https://github.com/wcko87/beatoraja-english-guide/wiki/BMS-Overview) format.

### Native / Rhythm

*   [Stepmania (⭐2.1k)](https://github.com/stepmania/stepmania) - Cross-platform dance rhythm game.
*   [lr2oraja (⭐63)](https://github.com/wcko87/lr2oraja) - [BMS player (⭐141)](https://github.com/wcko87/beatoraja-english-guide/wiki/BMS-Overview), fork of [beatoraja](https://mocha-repository.info/download.php) (popular BMS player) using Lunatic Rave 2 (LR2) gauges and judge (Requires a JVM. Recommended: [Liberica OpenJDK](https://bell-sw.com/pages/downloads/) Full version).
*   [lr2oraja \~Endless Dream\~ (⭐146)](https://github.com/seraxis/lr2oraja-endlessdream) - BMS player, fork of lr2oraja with additional features (Requires a JVM. Recommended: [Liberica OpenJDK](https://bell-sw.com/pages/downloads/) Full version).

## [Apr 27, 2026](/content/2026/04/27/README.md)

### Browser-Based / Boardgame

*   [Chessmata (⭐18)](https://github.com/jonradoff/chessmata) - Open-source multiplayer chess platform for humans and AI agents, with real-time WebSocket gameplay, Elo-based matchmaking, 3D browser board (Three.js), MCP server, and UCI-compatible CLI. Built with Go and React.
*   [Wolfcha (⭐701)](https://github.com/oil-oil/wolfcha) - AI-powered Werewolf (Mafia) social deduction game where every player is controlled by top LLMs. Built with Next.js and TypeScript.

### Browser-Based / Arcade

*   [DuckHunt JavaScript (⭐632)](https://github.com/MattSurabian/DuckHunt-JS) - DuckHunt ported to JavaScript and HTML5 with a level creator.
...
*   [Sandboxels (⭐458)](https://github.com/R74nCom/sandboxels) - Falling-sand experimentation game with over 500 materials to play with.
...
*   [Open-Ko (⭐358)](https://github.com/Open-KO/KnightOnline) - Reimplementation of old-school Knight Online that replicates the 1299 client functionality while preserving accuracy and compatibility with the version 1299 client and server.
...
*   [Beyond all Reason (BAR) (⭐4.2k)](https://github.com/beyond-all-reason/Beyond-All-Reason) - RTS born from mods of the Total Annihilation on the SpringRTS game engine.
...
*   [Super Bombinhas (⭐314)](https://github.com/victords/super-bombinhas) - Retro platformer game.
...
*   [Backdooms (⭐638)](https://github.com/Kuberwastaken/backdooms) - Game inspired by DOOM 1993 and The Backrooms, small enough to be self contained inside a QR code.
...
*   [Reia (⭐939)](https://github.com/Quaint-Studios/Reia) - RPG game action-adventure MMO focusing heavily on story, combat, and an open-world sandox adventure. Built with Godot, Rust, and Zig.
...
*   [Nazi Zombies Portable (⭐806)](https://github.com/nzp-team/nzportable) - Call of Duty: Zombies "de-make" powered by various enhanced forks of the Quake engine.
...
*   [AAAAXY (⭐300)](https://github.com/divVerent/aaaaxy) - Nonlinear 2D puzzle platformer taking place in impossible spaces.
...
*   [Rapid Dominance (⭐18)](https://github.com/wenta/rapid-dominance) - Open source turn-based strategy game. Clone of the Enemy Flag.
...
*   [111 one-button games (⭐88)](https://github.com/abagames/111-one-button-games-in-2021) - One button games are famous for realizing various actions with one button.
...
*   [Command & Conquer (⭐806)](https://github.com/adityaravishankar/command-and-conquer) - Recreation of the original Command and Conquer, Real Time Strategy game entirely in HTML5 and JavaScript.
...
*   [Mario 5 HTML (⭐528)](https://github.com/robertkleffner/marioHTML5) - Infinite Mario in HTML5 JavaScript using Canvas and Audio elements.
...
*   [Ski Free (⭐551)](https://github.com/basicallydan/skifree.js) - Controls a skier on a mountain slope, avoiding obstacles while racing against time or performing stunts for points, depending on the game mode.
...
*   [Room for Change (⭐145)](https://github.com/antionio/game-off-2013) - Randomly generated action RPG. You play as a chubby archeologist who is tasked to retrieve three sacred artifacts from the pyramid of the legendary Pharaohs.
...
*   [Hexa Battle (⭐88)](https://github.com/itajaja/hb) - Turn based dungeon crawler written with TypeScript, using React and SVG.
...
*   [Trigger Rally Online Edition (⭐369)](https://github.com/CodeArtemis/TriggerRally) - Fast arcade rally racing action, play in your browser with WebGL 3D graphics.
...
*   [Blk Game (⭐53)](https://github.com/morozd/blk-game) - Fully modifiable multiplayer voxel world in JS that can run efficiently in the browser.
...
*   [Asteroids (⭐355)](http://github.com/dmcinnes/HTML5-Asteroids) - Pure JavaScript asteroids. Destroy asteroids ans saucers controlling a triangular ship rotating left and right.
...
*   [Emberwind (⭐265)](https://github.com/operasoftware/Emberwind) - Fantasy game port of the indie platform game Emberwind.
...
*   [Green Mahjong (⭐104)](https://github.com/danbeck/green-mahjong) - Solitaire mahjong game done in HTML/CSS/JavaScript.
...
*   [Coffee Snake (⭐34)](https://github.com/dommmel/coffee-snake) - HTML5 snake game written in CoffeeScript.
...
*   [BananaBread (⭐1.5k)](https://github.com/kripken/BananaBread) - Port of the Cube 2/Sauerbraten 3D game engine/first person shooter to the web, compiling C++ and OpenGL to JavaScript and WebGL using Emscripten.
...
*   [Couch 2048 (⭐37)](https://github.com/mvasilkov/glitch2016) - A physics-based puzzle, loosely related to the original 2048 game.
...
*   [Zop (⭐45)](https://github.com/Zolmeister/zop) - Connect like colors.

### Browser-Based / Clicker

*   [Particle Clicker (⭐683)](https://github.com/particle-clicker/particle-clicker) - Addictive incremental game that teaches players the history of high energy particle physics.
...
*   [OpenLara (⭐5.1k)](https://github.com/XProger/OpenLara) - Tomb Raider open-source engine.
...
*   [PokerTH (⭐648)](https://github.com/pokerth/pokerth) - Implementation of Texas Hold'em supporting (online) multiplayer and botplay.
...
*   [Kriegspiel (⭐30)](https://github.com/binarymax/kriegspiel) - The game of imperfect information, the Kriegspiel chess variant.
...
*   [Roguish (⭐102)](https://github.com/CamHenlin/Roguish) - RPG/Rogue-like game created in JavaScript.
...
*   [DynaDungeons (⭐241)](https://github.com/akien-mga/dynadungeons) - Bomberman clone using the awesome open source Godot game engine.
...
*   [AssaultCube (⭐1.1k)](https://github.com/assaultcube/AC) - Total conversion of Wouter van Oortmerssen's FPS called Cube.
*   [Freedoom (⭐1.3k)](https://github.com/freedoom/freedoom) - Free software FPS based on the classic Doom engine.
*   [GlPortal (⭐383)](https://github.com/GlPortal/glPortal) - A modern 3D game and engine with portals written in C++.
...
*   [Dungeon Crawl Stone Soup (⭐3k)](https://github.com/crawl/crawl) - Single-player roguelike dungeon exploration game with a larger focus on combat compared to other popular roguelikes.
*   [Dungeon Monkey Eternal (⭐61)](https://github.com/jwvhewitt/dmeternal) - Party-based fantasy roguelike role-playing game.
*   [Egoboo (⭐130)](https://github.com/egoboo/egoboo) - Cool 3D dungeon crawling game in the spirit of NetHack.
...
*   [The Legend of Edgar (⭐143)](https://github.com/riksweeney/edgar) - 2D platform game with a persistent world.
...
*   [2048-in-terminal (⭐162)](https://github.com/alewmoose/2048-in-terminal) - CLI version of the game 2048 made right.
...
*   [EbbeFlut (⭐5)](https://github.com/karussell/ebbeflut) - Really nice board game implemented in a bad way a VERY long time ago.
...
*   [Stunt Rally (⭐648)](https://github.com/stuntrally/stuntrally) - Rally game with Track Editor, based on VDrift and OGRE.
...
*   [Race into Space (⭐229)](https://github.com/raceintospace/raceintospace) - Turn-based space race strategy game originally by Interplay.
...
*   [Doom (⭐832)](https://github.com/id-Software/DOOM-iOS) - Classic Doom Game for iOS.
...
*   [Aquaria (⭐325)](https://github.com/AquariaOSE/Aquaria) - Breath-taking underwater fantasy game. Winner of the Grand Prize at the 2007 Independent Games Festival.
...
*   [Jedi Academy (⭐754)](https://github.com/grayj/Jedi-Academy) - Source only, mirror of SourceForge from Raven Software.
*   [Jedi Outcast (⭐319)](https://github.com/grayj/Jedi-Outcast) - Source only, mirror of SourceForge from Raven Software.
*   [MaNGOS (⭐3.1k)](https://github.com/mangos/mangos) - Full featured World of Warcraft server.
*   [Miner Wars 2081 (⭐260)](https://github.com/KeenSoftwareHouse/Miner-Wars-2081) - For modders of Miner Wars 2081, a 6DOF action-survival space-shooter simulation-game set in the year 2081.
...
*   [Akihabara (⭐200)](https://github.com/Akihabara/akihabara) - Set of libraries, tools and presets to create pixelated indie-style 8/16-bit era games in JavaScript.
...
*   [Wurfel Engine (⭐119)](https://github.com/BSVogler/WurfelEngineSDK) - An isometric game engine for games with an open world made of blocks or voxels.
...
*   [IodineGBA (⭐291)](https://github.com/taisel/IodineGBA) - GameBoy Advance emulator written entirely in JavaScript and powered by HTML5.
...
*   [Leaderboard(Java) (⭐26)](https://github.com/agoragames/java-leaderboard) - Leaderboards backed by Redis(in Java).
...
*   [Mudlet (⭐910)](https://github.com/Mudlet/Mudlet) - A cross-platform, open source, and super fast MUD (text-only MMORPGs) client with scripting in Lua.
*   [Stats.js (⭐9.2k)](https://github.com/mrdoob/stats.js) - JavaScript performance monitor.
