...
- API: [Quotable Quotes (⭐1.7k)](https://github.com/lukePeavey/quotable)
...
- API: [Intelligence X (⭐383)](https://github.com/IntelligenceX/SDK/blob/master/Intelligence%20X%20API.pdf)
