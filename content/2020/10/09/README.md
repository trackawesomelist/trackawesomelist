...
*   [Kotlin/dukat (⭐552)](https://github.com/Kotlin/dukat) - Converter of <any kind of declarations> to Kotlin external declarations
...
*   [WSO2 API Management (⭐833)](https://github.com/wso2/product-apim) - API management tool with lightweight gateway and API lifecycle management, written in Java.
...
*   [Weld (⭐299)](https://github.com/serayuzgur/weld) - Full fake REST API generator
...
*   [coinbase-pro-rs (⭐144)](https://github.com/inv2004/coinbase-pro-rs) - Coinbase pro client, supports sync/async/websocket
...
*   Commodore 64
    *   [kondrak/rust64 (⭐257)](https://github.com/kondrak/rust64) - Commodore 64 emulator
*   Gameboy
    *   [Gekkio/mooneye-gb (⭐892)](https://github.com/Gekkio/mooneye-gb) - A Game Boy research project and emulator
    *   [joamag/boytacean (⭐616)](https://github.com/joamag/boytacean) - GameBoy Color emulator that runs on the Web using WebAssembly.
    *   [mohanson/gameboy (⭐1.4k)](https://github.com/mohanson/gameboy) - Full featured Cross-platform GameBoy emulator. Forever boys!.
    *   [mvdnes/rboy (⭐581)](https://github.com/mvdnes/rboy) - A Gameboy Emulator
*   Gameboy Advance
    *   [michelhe/rustboyadvance-ng (⭐590)](https://github.com/michelhe/rustboyadvance-ng) - RustboyAdvance-ng is a Gameboy Advance emulator with desktop, android and [WebAssembly](https://michelhe.github.io/rustboyadvance-ng/) support. [![build badge](https://github.com/michelhe/rustboyadvance-ng/workflows/Deploy/badge.svg?branch=master)](https://github.com/michelhe/rustboyadvance-ng/actions?query=workflow%3ADeploy)
...
*   [RazrFalcon/resvg (⭐2.7k)](https://github.com/RazrFalcon/resvg) - An SVG rendering library.
...
*   [thepowersgang/rust\_os (⭐719)](https://github.com/thepowersgang/rust_os) - An OS kernel written in rust. Non POSIX

### Applications / Security tools

*   [kpcyrd/rshijack (⭐454)](https://github.com/kpcyrd/rshijack) - A TCP connection hijacker; rewrite of shijack
*   [kpcyrd/sn0int (⭐2k)](https://github.com/kpcyrd/sn0int) - A semi-automatic OSINT framework and package manager

### Applications / System tools

*   [brocode/fblog (⭐417)](https://github.com/brocode/fblog) - Small command-line JSON Log viewer
...
*   [lotabout/rargs (⭐476)](https://github.com/lotabout/rargs) \[[rargs](https://crates.io/crates/rargs)] - xargs + awk with pattern matching support
*   [lotabout/skim (⭐5k)](https://github.com/lotabout/skim) - A fuzzy finder
*   [mitnk/cicada (⭐972)](https://github.com/mitnk/cicada) - A bash-like Unix shell
*   [mmstick/tv-renamer (⭐150)](https://github.com/mmstick/tv-renamer) - A tv series renaming application with an optional GTK3 frontend.
*   [redox-os/ion (⭐1.4k)](https://github.com/redox-os/ion) - Next-generation system shell
*   [sitkevij/hex (⭐508)](https://github.com/sitkevij/hex) - A colorized hexdump terminal utility.
...
*   [clog-tool/clog-cli (⭐843)](https://github.com/clog-tool/clog-cli) - generates a changelog from git metadata ([conventional changelog](https://blog.thoughtram.io/announcements/tools/2014/09/18/announcing-clog-a-conventional-changelog-generator-for-the-rest-of-us.html))
...
*   Erlang
    *   [rusterlium/rustler (⭐4.3k)](https://github.com/rusterlium/rustler) - safe Rust bridge for creating Erlang NIF functions
*   Java
    *   [bennettanderson/rjni (⭐72)](https://github.com/benanders/rjni) - use Java from Rust
    *   [drrb/java-rust-example (⭐339)](https://github.com/drrb/java-rust-example) - use Rust from Java
...
*   Lua
    ...
    *   [mlua-rs/mlua (⭐1.5k)](https://github.com/mlua-rs/mlua) - High level Lua 5.4/5.3/5.2/5.1 (including LuaJIT) and Roblox Luau bindings to Rust with async/await support [![build badge](https://github.com/mlua-rs/mlua/workflows/CI/badge.svg)](https://github.com/mlua-rs/mlua/actions)
    ...
    *   [tomaka/hlua (⭐505)](https://github.com/tomaka/hlua) - Rust library to interface with Lua
*   mruby
...
*   Python
    ...
    *   [getsentry/milksnake (⭐790)](https://github.com/getsentry/milksnake) - extension for python setuptools that allows you to distribute dynamic linked libraries in Python wheels in the most portable way imaginable.
    *   [PyO3/PyO3 (⭐12k)](https://github.com/PyO3/PyO3) - Rust bindings for the Python interpreter
    *   [RustPython (⭐19k)](https://github.com/RustPython/RustPython) - A Python Interpreter written in Rust [![Build Status](https://github.com/RustPython/RustPython/workflows/CI/badge.svg)](https://github.com/RustPython/RustPython/actions?query=workflow%3ACI)
...
*   [Ride (⭐172)](https://github.com/madeso/ride) - A Rust IDE
...
*   [jhasse/ears (⭐90)](https://github.com/jhasse/ears) - A simple library to play Sounds and Musics, on top of OpenAL and libsndfile

### Libraries / Automotive

*   [marcelbuesing/can-dbc (⭐61)](https://github.com/marcelbuesing/can-dbc) \[[can-dbc](https://crates.io/crates/can-dbc)] - A parser for the DBC format
...
*   miniz
    *   [rust-lang/flate2-rs (⭐876)](https://github.com/rust-lang/flate2-rs) - [miniz](https://code.google.com/archive/p/miniz) bindings [![build badge](https://github.com/rust-lang/flate2-rs/workflows/CI/badge.svg?branch=master)](https://github.com/rust-lang/flate2-rs/actions)
*   tar
    *   [alexcrichton/tar-rs (⭐612)](https://github.com/alexcrichton/tar-rs) - tar archive reading/writing

### Libraries / Computation

*   [argmin-rs/argmin (⭐961)](https://github.com/argmin-rs/argmin) \[[argmin](https://crates.io/crates/argmin)] - Optimization library
*   [LAPACK](https://en.wikipedia.org/wiki/LAPACK)
    *   [stainless-steel/lapack (⭐81)](https://github.com/blas-lapack-rs/lapack) - LAPACK bindings

### Libraries / Cryptography

*   [briansmith/ring (⭐3.7k)](https://github.com/briansmith/ring) - Safe, fast, small crypto using Rust and BoringSSL's cryptography primitives.
...
*   SQL \[[sql](https://crates.io/keywords/sql)]
    *   Generic
        *   [launchbadge/sqlx (⭐13k)](https://github.com/launchbadge/sqlx) - async PostgreSQL/MySQL/SQLite connection pool with strong typing support [![build badge](https://img.shields.io/github/workflow/status/launchbadge/sqlx/Rust/master?style=flat-square)](https://github.com/launchbadge/sqlx)
    ...
    *   MySql \[[mysql](https://crates.io/keywords/mysql)]
        ...
        *   [blackbeam/mysql\_async (⭐373)](https://github.com/blackbeam/mysql_async) \[[mysql\_async](https://crates.io/crates/mysql_async)] - asynchronous Mysql driver based on Tokio. [![CircleCI](https://circleci.com/gh/blackbeam/mysql_async/tree/master.svg?style=shield)](https://app.circleci.com/pipelines/github/blackbeam/mysql_async?branch=master)
        *   [blackbeam/rust-mysql-simple (⭐656)](https://github.com/blackbeam/rust-mysql-simple) \[[mysql](https://crates.io/crates/mysql)] - A native MySql client
    *   Oracle
        *   [kubo/rust-oracle (⭐184)](https://github.com/kubo/rust-oracle) \[[oracle](https://crates.io/crates/oracle)] - Oracle driver [![build badge](https://github.com/kubo/rust-oracle/actions/workflows/run-tests.yml/badge.svg?branch=master)](https://github.com/kubo/rust-oracle/actions/workflows/run-tests.yml)
...
*   [gsquire/sendgrid-rs (⭐104)](https://github.com/gsquire/sendgrid-rs) - Library for SendGrid API
...
*   Binary
    ...
    *   [jamesmunns/postcard (⭐809)](https://github.com/jamesmunns/postcard) \[[postcard](https://crates.io/crates/postcard)] - Postcard is a #!\[no\_std] focused serializer and deserializer for Serde.
...
*   Byte swapping
    *   [BurntSushi/byteorder (⭐957)](https://github.com/BurntSushi/byteorder) - Supports big-endian, little-endian and native byte orders
*   Cap'n Proto
...
*   Character Encoding
    *   [hsivonen/encoding\_rs (⭐374)](https://github.com/hsivonen/encoding_rs) \[[encoding\_rs](https://crates.io/crates/encoding_rs)] - A Gecko-oriented implementation of the Encoding Standard
...
*   CRC
    *   [mrhooray/crc-rs (⭐187)](https://github.com/mrhooray/crc-rs) - Rust implementation of CRC(16, 32, 64) with support of various standards
*   CSV
    *   [BurntSushi/rust-csv (⭐1.7k)](https://github.com/BurntSushi/rust-csv) - A fast and flexible CSV reader and writer, with support for Serde
*   HTML
...
*   PEM
    *   [jcreekmore/pem-rs (⭐54)](https://github.com/jcreekmore/pem-rs) \[[pem](https://crates.io/crates/pem)] - Parse and encode PEM-encoded data
*   RON (Rusty Object Notation)
    *   [https://github.com/ron-rs/ron (⭐3.3k)](https://github.com/ron-rs/ron) - Rusty Object Notation
...
*   Allegro
    *   [SiegeLord/RustAllegro (⭐96)](https://github.com/SiegeLord/RustAllegro) - [Allegro 5](https://liballeg.org/) bindings
...
*   Cocoa
    *   [servo/core-foundation-rs (⭐969)](https://github.com/servo/core-foundation-rs) - Rust bindings to Core Foundation and other low level libraries on Mac OS X and iOS
...
*   [teovoinea/steganography (⭐92)](https://github.com/teovoinea/steganography) \[[steganography](https://crates.io/crates/steganography)] - A simple steganography library

### Libraries / Language specification

*   [shnewto/bnf (⭐254)](https://github.com/shnewto/bnf) - A library for parsing Backus–Naur form context-free grammars.

### Libraries / Mobile

*   iOS
    *   [TimNN/cargo-lipo (⭐525)](https://github.com/TimNN/cargo-lipo) - A cargo lipo subcommand which automatically creates a universal library for use with your iOS application.

### Libraries / Network programming

*   FTP
    *   [mattnenterprise/rust-ftp (⭐178)](https://github.com/mattnenterprise/rust-ftp) - an [FTP](https://en.wikipedia.org/wiki/File_Transfer_Protocol) client
*   NanoMsg
    *   [thehydroimpulse/nanomsg.rs (⭐386)](https://github.com/thehydroimpulse/nanomsg.rs) - [nanomsg](https://nanomsg.org/) bindings
*   Stomp
...
*   ZeroMQ
    *   [erickt/rust-zmq (⭐895)](https://github.com/erickt/rust-zmq) - [ZeroMQ](https://zeromq.org/) bindings
...
*   [BurntSushi/tabwriter (⭐245)](https://github.com/BurntSushi/tabwriter) - Elastic tab stops (i.e., text column alignment)
*   [mgeisler/textwrap (⭐444)](https://github.com/mgeisler/textwrap) \[[textwrap](https://crates.io/crates/textwrap)] - Word wrap text (with support for hyphenation)
...
*   [beneills/quantum (⭐263)](https://github.com/beneills/quantum) - Advanced quantum computer simulator
...
*   HTTP Client
    ...
    *   [seanmonstar/reqwest (⭐9.6k)](https://github.com/seanmonstar/reqwest) - an ergonomic HTTP Client.
*   HTTP Server
    ...
    *   [Graphul (⭐442)](https://github.com/graphul-rs/graphul) - An Express-inspired web framework. [![crate](https://img.shields.io/crates/v/create-rust-app.svg)](https://crates.io/crates/graphul)
    ...
    *   [poem-web/poem (⭐3.4k)](https://github.com/poem-web/poem) - A full-featured and easy-to-use web framework. [![CI](https://github.com/poem-web/poem/actions/workflows/ci.yml/badge.svg)](https://github.com/poem-web/poem/actions/workflows/ci.yml)
    *   [Rocket (⭐24k)](https://github.com/rwf2/Rocket) - Rocket is a web framework with a focus on ease-of-use, expressability, and speed
    *   [Rustless (⭐617)](https://github.com/rustless/rustless) - A REST-like API micro-framework inspired by [Grape (⭐9.9k)](https://github.com/ruby-grape/grape) and [Hyper (⭐14k)](https://github.com/hyperium/hyper)
    *   [Salvo (⭐3k)](https://github.com/salvo-rs/salvo) - an easy to use webframework base on hyper and tokio. [![build build](https://github.com/salvo-rs/salvo/workflows/CI%20\(Linux\)/badge.svg?branch=master\&event=push)](https://github.com/salvo-rs/salvo/actions)
    *   [Saphir (⭐90)](https://github.com/richerarc/saphir) - A progressive web framework with low-level control, without the pain.
    *   [seanmonstar/warp (⭐9.4k)](https://github.com/seanmonstar/warp) - A super-easy, composable, web server framework for warp speeds. [![crate](https://img.shields.io/crates/v/create-rust-app.svg)](https://crates.io/crates/warp)
    *   [tiny-http (⭐985)](https://github.com/tiny-http/tiny-http) - Low level HTTP server library
    ...
    *   [Zino (⭐720)](https://github.com/zino-rs/zino) - Next-generation framework for composable applications
*   Static Site Generators
    ...
    *   [grego/blades (⭐329)](https://github.com/grego/blades) \[[blades](https://www.getblades.org/)] - Blazing fast dead simple static site generator.
