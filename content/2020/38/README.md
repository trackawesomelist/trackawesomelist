...
*   [JetBrains Rider (C#) (⭐352)](https://github.com/JetBrains/godot-support) - Syntax highlighting, autocompletion and run configurations.
...
*   [lvgl (⭐237)](https://github.com/lvgl/lv_binding_micropython) - An object-oriented, component-based high-level GUI library with MicroPython binding.
...
*   [micropython-camera-driver (⭐416)](https://github.com/lemariva/micropython-camera-driver) - OV2640 camera driver for MicroPython on ESP32.
...
*   [micrOS (⭐91)](https://github.com/BxNxM/micrOS) - MicroPython-based IoT Framework.
...
*   [ProtoBuf (⭐300)](https://github.com/SilentOrbit/protobuf) - Generate C# code for protocol buffer serialization from a .proto specification.

### Template Engine

*   [Scriban (⭐3k)](https://github.com/lunet-io/scriban) - A fast, powerful, safe and lightweight text templating language and engine for .NET
...
*   [SmartCode (⭐572)](https://github.com/dotnetcore/SmartCode) - SmartCode = IDataSource -> IBuildTask -> IOutput => Build Everything!!! (Including \[**Code generator**])
...
*   [CSLY (⭐346)](https://github.com/b3b00/CSLY) - A light embedded C# lexer/parser generator.
