...
*   [doukutsu-rs (⭐639)](https://github.com/doukutsu-rs/doukutsu-rs) — A Rust reimplementation of Cave Story engine with some enhancements.
...
*   [scikit-multilearn (⭐833)](https://github.com/scikit-multilearn/scikit-multilearn)
*   [sklearn-expertsys (⭐485)](https://github.com/tmadl/sklearn-expertsys)
*   [scikit-feature (⭐1.3k)](https://github.com/jundongl/scikit-feature)
*   [scikit-rebate (⭐382)](https://github.com/EpistasisLab/scikit-rebate)
...
*   [sklearn-deap (⭐721)](https://github.com/rsteca/sklearn-deap)
...
*   [scikit-opt (⭐4.1k)](https://github.com/guofei9987/scikit-opt)
*   [scikit-posthocs (⭐287)](https://github.com/maximtrp/scikit-posthocs)
...
*   [RuleFit (⭐355)](https://github.com/christophM/rulefit)
*   [pyGAM (⭐769)](https://github.com/dswah/pyGAM)

### Deep Learning Packages / PyTorch Ecosystem

*   [PyTorch (⭐67k)](https://github.com/pytorch/pytorch)
...
*   [tensorflow-upstream (⭐645)](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream)
...
*   [qkeras (⭐464)](https://github.com/google/qkeras)
...
*   [Awesome Game Datasets (⭐501)](https://github.com/leomaurodesenv/game-datasets#readme)

## [16. Awesome Flutter](/content/Solido/awesome-flutter/week/README.md)

### Device / Augmented Reality

*   [WidgetKit (⭐225)](https://github.com/fasky-software/flutter_widgetkit)<!--stargazers:baseflow/fasky-software/flutter_widgetkit--> - A plugins which allows you to create a Widget-Extention for iOS by [Thomas Leiter](https://github.com/tomLadder)
...
*   [CHIP-8 (⭐106)](https://github.com/tobiasvl/awesome-chip-8#readme) - Virtual computer game machine from the 70s.

### Business

*   [Engineering Team Management (⭐1.4k)](https://github.com/kdeldycke/awesome-engineering-team-management#readme) - How to transition from software development to engineering management.

### Miscellaneous

*   [Credit Modeling (⭐85)](https://github.com/mourarthur/awesome-credit-modeling#readme) - Methods for classifying credit applicants into risk classes.
...
*   [reoverlay (⭐127)](https://github.com/hiradary/reoverlay) - [demo](https://hiradary.github.io/reoverlay/) - The missing solution for managing modals.
...
*   👍 [Dexador (⭐316)](https://github.com/fukamachi/dexador) - An HTTP client, that aims at replacing Drakma. [MIT](https://opensource.org/licenses/MIT).
...
*   [parseq (⭐23)](https://github.com/mrossini-ethz/parseq) - a library for parsing sequences such as strings and lists using parsing expression grammars. Inspired by Esrap. GPL2.
