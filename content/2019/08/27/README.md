...
*   [mlpack (⭐4.8k)](https://github.com/mlpack/mlpack) - A scalable C++ machine learning library (Python bindings).
...
*   [pyGAM (⭐838)](https://github.com/dswah/pyGAM) - Generalized Additive Models in Python.

### Machine Learning / Kernel Methods

*   [liquidSVM (⭐64)](https://github.com/liquidSVM/liquidSVM) - An implementation of SVMs.
...
*   [CLTK (⭐820)](https://github.com/cltk/cltk) - The Classical Language Toolkik.
*   [gensim](https://radimrehurek.com/gensim/) - Topic Modelling for Humans.
*   [Phonemizer (⭐1.1k)](https://github.com/bootphon/phonemizer) - Simple text-to-phonemes converter for multiple languages.
...
*   [aubio (⭐3.2k)](https://github.com/aubio/aubio) - A library for audio and music analysis.
*   [Essentia (⭐2.7k)](https://github.com/MTG/essentia) - Library for audio and music analysis, description, and synthesis.
*   [LibXtract (⭐224)](https://github.com/jamiebullock/LibXtract) - A simple, portable, lightweight library of audio feature extraction functions.
*   [Marsyas (⭐392)](https://github.com/marsyas/marsyas) - Music Analysis, Retrieval, and Synthesis for Audio Signals.
*   [muda (⭐227)](https://github.com/bmcfee/muda) - A library for augmenting annotated audio data.
*   [madmom (⭐1.2k)](https://github.com/CPJKU/madmom) - Python audio and music signal processing library.

### Computer Vision / Others

*   [OpenCV (⭐76k)](https://github.com/opencv/opencv) - Open Source Computer Vision Library.
*   [scikit-image (⭐5.9k)](https://github.com/scikit-image/scikit-image) - Image Processing SciKit (Toolbox for SciPy).
...
*   [PyMC (⭐8.2k)](https://github.com/pymc-devs/pymc) - Bayesian Stochastic Modelling in Python.
*   [PyStan (⭐315)](https://github.com/stan-dev/pystan) - Bayesian inference using the No-U-Turn sampler (Python interface).
*   [emcee (⭐1.4k)](https://github.com/dfm/emcee) - The Python ensemble sampling toolkit for affine-invariant MCMC.
*   [hsmmlearn (⭐75)](https://github.com/jvkersch/hsmmlearn) - A library for hidden semi-Markov models with explicit durations.
*   [pyhsmm (⭐544)](https://github.com/mattjj/pyhsmm) - Bayesian inference in HSMMs and HMMs.

### Model Explanation / Others

*   [Alibi (⭐2.3k)](https://github.com/SeldonIO/alibi) - Algorithms for monitoring and explaining machine learning models.
*   [anchor (⭐785)](https://github.com/marcotcr/anchor) - Code for "High-Precision Model-Agnostic Explanations" paper.
*   [aequitas (⭐633)](https://github.com/dssg/aequitas) - Bias and Fairness Audit Toolkit.
...
*   [PDPbox (⭐824)](https://github.com/SauceCat/PDPbox) - Partial dependence plot toolbox.
...
*   [AI Explainability 360 (⭐1.5k)](https://github.com/IBM/AIX360) - Interpretability and explainability of data and machine learning models.

### Genetic Programming / Others

*   [DEAP (⭐5.6k)](https://github.com/DEAP/deap) - Distributed Evolutionary Algorithms in Python.
*   [monkeys (⭐120)](https://github.com/hchasestevens/monkeys) - A strongly-typed genetic programming framework for Python.

### Optimization / Others

*   [Spearmint (⭐1.5k)](https://github.com/HIPS/Spearmint) - Bayesian optimization.
*   [SMAC3 (⭐1k)](https://github.com/automl/SMAC3) - Sequential Model-based Algorithm Configuration.
*   [Optunity (⭐414)](https://github.com/claesenm/optunity) - Is a library containing various optimizers for hyperparameter tuning.
*   [hyperopt (⭐7.1k)](https://github.com/hyperopt/hyperopt) - Distributed Asynchronous Hyperparameter Optimization in Python.
*   [SafeOpt (⭐131)](https://github.com/befelix/SafeOpt) - Safe Bayesian Optimization.
...
*   [Solid (⭐574)](https://github.com/100/Solid) - A comprehensive gradient-free optimization framework written in Python.
*   [PySwarms (⭐1.2k)](https://github.com/ljvmiranda921/pyswarms) - A research toolkit for particle swarm optimization in Python.
*   [Platypus (⭐541)](https://github.com/Project-Platypus/Platypus) - A Free and Open Source Python Library for Multiobjective Optimization.
*   [POT (⭐2.3k)](https://github.com/rflamary/POT) - Python Optimal Transport library.
*   [Talos (⭐1.6k)](https://github.com/autonomio/talos) - Hyperparameter Optimization for Keras Models.
*   [nlopt (⭐1.7k)](https://github.com/stevengj/nlopt) - Library for nonlinear optimization (global and local, constrained or unconstrained).

### Feature Engineering / General

*   [Featuretools (⭐7k)](https://github.com/Featuretools/featuretools) - Automated feature engineering.

### Visualization / General Purposes

*   [Matplotlib (⭐19k)](https://github.com/matplotlib/matplotlib) - Plotting with Python.
...
*   [python-ternary (⭐698)](https://github.com/marcharper/python-ternary) - Ternary plotting library for Python with matplotlib.
*   [missingno (⭐3.8k)](https://github.com/ResidentMario/missingno) - Missing data visualization module for Python.

### Statistics / NLP

*   [scikit-posthocs (⭐323)](https://github.com/maximtrp/scikit-posthocs) - Pairwise Multiple Comparisons Post-hoc Tests.
...
*   [pdpipe (⭐716)](https://github.com/shaypal5/pdpipe) - Sasy pipelines for pandas DataFrames.
*   [SSPipe](https://sspipe.github.io/) - Python pipe (|) operator with support for DataFrames and Numpy, and Pytorch.
*   [Dataset (⭐196)](https://github.com/analysiscenter/dataset) - Helps you conveniently work with random or sequential batches of your data and define data processing.
*   [Prodmodel (⭐57)](https://github.com/prodmodel/prodmodel) - Build system for data science pipelines.

### Evaluation / Synthetic Data

*   [recmetrics (⭐558)](https://github.com/statisticianinstilettos/recmetrics) - Library of useful metrics and plots for evaluating recommender systems.
*   [Metrics (⭐1.6k)](https://github.com/benhamner/Metrics) - Machine learning evaluation metric.
*   [AI Fairness 360 (⭐2.3k)](https://github.com/IBM/AIF360) - Fairness metrics for datasets and ML models, explanations, and algorithms to mitigate bias in datasets and models.
...
*   [CuPy (⭐7.8k)](https://github.com/cupy/cupy) - NumPy-like API accelerated with CUDA.
*   [scikit-tensor (⭐401)](https://github.com/mnick/scikit-tensor) - Python library for multilinear algebra and tensor factorizations.
*   [numdifftools (⭐247)](https://github.com/pbrod/numdifftools) - Solve automatic numerical differentiation problems in one or more variables.
*   [quaternion (⭐594)](https://github.com/moble/quaternion) - Add built-in support for quaternions to numpy.
...
*   [QML (⭐193)](https://github.com/qmlcode/qml) - A Python Toolkit for Quantum Machine Learning.
...
*   [ONNX (⭐17k)](https://github.com/onnx/onnx) - Open Neural Network Exchange.
