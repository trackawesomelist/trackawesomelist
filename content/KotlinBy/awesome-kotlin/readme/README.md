...
*   [xchacha20-poly1305/husi (⭐272)](https://github.com/xchacha20-poly1305/husi) - 匪兕匪虎 率彼旷野
*   [MiniAiLive/FaceRecognition-LivenessDetection (⭐427)](https://github.com/MiniAiLive/FaceRecognition-LivenessDetection) - Face Recognition on NIST FRVT Top Ranked ,Face Liveness Detection Engine on iBeta 2 Certified(3D Face Anti-Spoofing) on Android
...
*   [aniyomiorg/aniyomi (⭐4.3k)](https://github.com/aniyomiorg/aniyomi) - An app for manga and anime
*   [vfsfitvnm/ViMusic (⭐7.8k)](https://github.com/vfsfitvnm/ViMusic) - An Android application for streaming music from YouTube Music.
...
*   [shubham-gangpuri/MVVM\_Clean\_Testing (⭐48)](https://github.com/shubham-gangpuri/MVVM_Clean_Testing) - Simple android application with API implementation (MVVM + Clean Architecture including Unit, Integration & UI Test Cases)
*   [mgz0227/legado-Harmony (⭐100)](https://github.com/mgz0227/legado-Harmony) - 开源阅读鸿蒙版仓库
*   [aniyomiorg/aniyomi-extensions (⭐496)](https://github.com/aniyomiorg/aniyomi-extensions) - Source extensions for the Aniyomi app.
...
*   [Skytils/SkytilsMod (⭐967)](https://github.com/Skytils/SkytilsMod) - Skytils is a Hypixel Skyblock mod! Be careful, malicious copies are distributed across GitHub. Confirm on discord.gg/skytils (807302538558308352)
...
*   [jellyfin/jellyfin-androidtv (⭐2.3k)](https://github.com/jellyfin/jellyfin-androidtv) - Android TV Client for Jellyfin
*   [yairm210/Unciv (⭐7.8k)](https://github.com/yairm210/Unciv) - Open-source Android/Desktop remake of Civ V
...
*   [mapbox/mapbox-maps-android (⭐429)](https://github.com/mapbox/mapbox-maps-android) - Interactive, thoroughly customizable maps in native Android powered by vector tiles and OpenGL.
...
*   [chenxiaolong/BCR (⭐1.4k)](https://github.com/chenxiaolong/BCR) - A Basic Call Recorder for rooted Android devices
*   [adrielcafe/voyager (⭐2.2k)](https://github.com/adrielcafe/voyager) - 🛸 A pragmatic navigation library for Jetpack Compose
*   [unit-mesh/auto-dev (⭐2.4k)](https://github.com/unit-mesh/auto-dev) - 🧙‍AutoDev: The AI-powered coding wizard with multilingual support 🌐, auto code generation 🏗️, and a helpful bug-slaying assistant 🐞! Customizable prompts 🎨 and a magic Auto Dev/Testing/Document/Agent  feature 🧪 included! 🚀
*   [google/ksp (⭐2.7k)](https://github.com/google/ksp) - Kotlin Symbol Processing API
*   [bmax121/APatch (⭐3.1k)](https://github.com/bmax121/APatch) - The patching of Android kernel and Android system
*   [simondankelmann/Bluetooth-LE-Spam (⭐3.5k)](https://github.com/simondankelmann/Bluetooth-LE-Spam)
*   [mobile-dev-inc/maestro (⭐5.2k)](https://github.com/mobile-dev-inc/maestro) - Painless Mobile UI Automation
*   [pinterest/ktlint (⭐6k)](https://github.com/pinterest/ktlint) - An anti-bikeshedding Kotlin linter with built-in formatter
*   [javalin/javalin (⭐7.2k)](https://github.com/javalin/javalin) - A simple and modern Java and Kotlin web framework
