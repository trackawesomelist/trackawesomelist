...
*   [maxrave-dev/SimpMusic (⭐1.9k)](https://github.com/maxrave-dev/SimpMusic) - A simple music app using YouTube Music for backend
*   [tanujnotes/Olauncher (⭐2.1k)](https://github.com/tanujnotes/Olauncher) - Minimal AF Launcher for Android. Reduce your screen time. Daily wallpapers.
*   [keiyoushi/extensions-source (⭐2.2k)](https://github.com/keiyoushi/extensions-source) - Source code of extensions for Tachiyomi/Mihon and variants.
*   [fumiama/copymanga (⭐2.5k)](https://github.com/fumiama/copymanga) - 拷贝漫画的第三方APP，优化阅读/下载体验
*   [GuoXiCheng/SKIP (⭐2.6k)](https://github.com/GuoXiCheng/SKIP) - 自动跳过APP开屏广告
*   [ReVanced/revanced-patches (⭐2.6k)](https://github.com/ReVanced/revanced-patches) - 🧩 Patches for ReVanced
*   [d4rken-org/sdmaid-se (⭐2.8k)](https://github.com/d4rken-org/sdmaid-se) - SD Maid 2/SE is Android's most thorough cleaning tool.
*   [deniscerri/ytdlnis (⭐4.2k)](https://github.com/deniscerri/ytdlnis) - Android Video/Audio Downloader app using yt-dlp
*   [amir1376/ab-download-manager (⭐3.4k)](https://github.com/amir1376/ab-download-manager) - A Download Manager that speeds up your downloads
*   [z-huang/InnerTune (⭐4.8k)](https://github.com/z-huang/InnerTune) - A Material 3 YouTube Music client for Android
*   [bitwarden/android (⭐6.6k)](https://github.com/bitwarden/android) - Bitwarden mobile app for Android.
*   [ankidroid/Anki-Android (⭐8.8k)](https://github.com/ankidroid/Anki-Android) - AnkiDroid: Anki flashcards on Android. Your secret trick to achieve superhuman information retention.
*   [firebase/quickstart-android (⭐8.9k)](https://github.com/firebase/quickstart-android) - Firebase Quickstart Samples for Android
*   [tiann/KernelSU (⭐11k)](https://github.com/tiann/KernelSU) - A Kernel based root solution for Android
*   [coil-kt/coil (⭐11k)](https://github.com/coil-kt/coil) - Image loading for Android and Compose Multiplatform.
*   [JunkFood02/Seal (⭐12k)](https://github.com/JunkFood02/Seal) - 🦭 Video/Audio Downloader for Android, based on yt-dlp, designed with Material You
...
*   [gkd-kit/gkd (⭐23k)](https://github.com/gkd-kit/gkd) - 基于无障碍，高级选择器，订阅规则的自定义屏幕点击 Android 应用 | An Android APP with custom screen tapping based on Accessibility, Advanced Selectors, and Subscription Rules
*   [gedoor/legado (⭐30k)](https://github.com/gedoor/legado) - Legado 3.0 Book Reader with powerful controls & full functions❤️阅读3.0, 阅读是一款可以自定义来源阅读网络内容的工具，为广大网络文学爱好者提供一种方便、快捷舒适的试读体验。
*   [2dust/v2rayNG (⭐36k)](https://github.com/2dust/v2rayNG) - A V2Ray client for Android, support Xray core and v2fly core
*   [bannedbook/fanqiang (⭐39k)](https://github.com/bannedbook/fanqiang) - 翻墙-科学上网

### <a name="github-trending-weekly"></a>Weekly <sup>[Back ⇈](#github-trending-weekly-subcategory)</sup>

*   [samolego/Canta (⭐1.3k)](https://github.com/samolego/Canta) - Uninstall any Android app without root (Shizuku)!
*   [google/ksp (⭐2.9k)](https://github.com/google/ksp) - Kotlin Symbol Processing API
*   [jellyfin/jellyfin-androidtv (⭐2.9k)](https://github.com/jellyfin/jellyfin-androidtv) - Android TV Client for Jellyfin
*   [fcitx5-android/fcitx5-android (⭐3.1k)](https://github.com/fcitx5-android/fcitx5-android) - Fcitx5 input method framework and engines ported to Android
*   [NeoApplications/Neo-Store (⭐3.1k)](https://github.com/NeoApplications/Neo-Store) - An F-Droid client with modern UI and an arsenal of extra features.
*   [XayahSuSuSu/Android-DataBackup (⭐3.9k)](https://github.com/XayahSuSuSu/Android-DataBackup) - DataBackup for Android 7.0+
*   [ethereum-lists/chains (⭐8.9k)](https://github.com/ethereum-lists/chains) - provides metadata for chains
*   [InsertKoinIO/koin (⭐9.1k)](https://github.com/InsertKoinIO/koin) - Koin - a pragmatic lightweight dependency injection framework for Kotlin & Kotlin Multiplatform
...
*   [DerGoogler/MMRL (⭐547)](https://github.com/DerGoogler/MMRL) - MMRL is an Android app that helps manage your own modules repository.
*   [aws/aws-toolkit-jetbrains (⭐769)](https://github.com/aws/aws-toolkit-jetbrains) - AWS Toolkit for JetBrains - a plugin for interacting with AWS from JetBrains IDEs
*   [getsentry/sentry-java (⭐1.2k)](https://github.com/getsentry/sentry-java) - A Sentry SDK for Java, Android and other JVM languages.
*   [lizongying/my-tv-0 (⭐2k)](https://github.com/lizongying/my-tv-0) - 電視網絡視頻播放軟件，可以自定義視頻源
*   [patrykandpatrick/vico (⭐2.2k)](https://github.com/patrykandpatrick/vico) - A light and extensible chart library for Android.
*   [rnmapbox/maps (⭐2.3k)](https://github.com/rnmapbox/maps) - A Mapbox react native module for creating custom maps
*   [oblador/react-native-keychain (⭐3.2k)](https://github.com/oblador/react-native-keychain) - :key: Keychain Access for React Native
*   [duckduckgo/Android (⭐3.9k)](https://github.com/duckduckgo/Android) - DuckDuckGo Android App
*   [androidx/androidx (⭐5.4k)](https://github.com/androidx/androidx) - Development environment for Android Jetpack extension libraries under the androidx namespace. Synchronized with Android Jetpack's primary development branch on AOSP.
*   [JetBrains/ideavim (⭐9.3k)](https://github.com/JetBrains/ideavim) - IdeaVim – A Vim engine for JetBrains IDEs
...
*   [lectra-tech/koson (⭐89)](https://github.com/lectra-tech/koson) - A concise and lightweight Kotlin DSL to build JSON objects and render their String representations
...
*   [pemistahl/lingua (⭐712)](https://github.com/pemistahl/lingua) - A language detection library suitable for long and short text alike
...
*   [breandan/kaliningraph (⭐118)](https://github.com/breandan/kaliningraph) - 🕸️ Graphs, finite fields and discrete dynamical systems in Kotlin
...
*   [mipt-npm/kmath (⭐657)](https://github.com/mipt-npm/kmath) - A (not so numpy-like) multiplatform mathematical library with higher level abstractions.
...
*   [krud-dev/ostara (⭐323)](https://github.com/krud-dev/ostara) - A desktop application that provides various features to monitor and interact with Spring Boot Applications via Actuator.
...
*   [zt64/Hyperion (⭐680)](https://github.com/zt64/Hyperion) - An alternative YouTube front-end using modern Android architecture and Material 3
*   [SimonSchubert/LinuxCommandBibliotheca (⭐876)](https://github.com/SimonSchubert/LinuxCommandBibliotheca) - Android app which provides a bunch of useful Linux commands.
...
*   [heart-switch (⭐64)](https://github.com/popovanton0/heart-switch) - A heart-shaped toggle switch component for Jetpack Compose
...
*   [Blueprint (⭐138)](https://github.com/popovanton0/Blueprint) - 📐 A library that draws a blueprint on top of your Jetpack Compose composables. It visualizes dimensions, like paddings and sizes.
...
*   [BennyWang/KBinding (⭐408)](https://github.com/BennyWang/KBinding) - Android MVVM framework write in kotlin, develop Android has never been so fun.
...
*   [chibatching/Kotpref (⭐697)](https://github.com/chibatching/Kotpref) - Kotpref - Android SharedPreferences delegation library for Kotlin
...
*   [pawegio/KAndroid (⭐895)](https://github.com/pawegio/KAndroid) - Kotlin library for Android
...
*   [hanjoongcho/aaf-easydiary (⭐439)](https://github.com/hanjoongcho/aaf-easydiary) - This is a diary application optimized to user experience.
*   [SimpleMobileTools/Simple-Draw (⭐519)](https://github.com/SimpleMobileTools/Simple-Draw) - A canvas you can draw on with different colors.
*   [cuongpm/youtube-dl-android (⭐521)](https://github.com/cuongpm/youtube-dl-android) - Video downloader for Android - Download videos from Youtube, Facebook, Twitter, Instagram, Dailymotion, Vimeo and more than 1000 other sites.
...
*   [SimpleMobileTools/Simple-Camera (⭐772)](https://github.com/SimpleMobileTools/Simple-Camera) - A camera with flash, zoom and no ads.
...
*   [jzbrooks/vgo (⭐43)](https://github.com/jzbrooks/vgo) - vgo is a tool for optimizing and converting between vector artwork representations.
*   [Kotlin/kdoctor (⭐612)](https://github.com/Kotlin/kdoctor) - CLI tool that helps to set up the environment for Kotlin Multiplatform Mobile app development.
...
*   [KakaoCup/Compose (⭐147)](https://github.com/KakaoCup/Compose) - Nice and simple DSL for Espresso Compose UI testing in Kotlin
*   [KakaoCup/Kakao (⭐332)](https://github.com/KakaoCup/Kakao) - Nice and simple DSL for Espresso in Kotlin

### <a name="android-multiplatform"></a>Multiplatform <sup>[Back ⇈](#android-multiplatform-subcategory)</sup>

*   [Reedyuk/blue-falcon (⭐348)](https://github.com/Reedyuk/blue-falcon) - A unified Bluetooth library for Android and iOS.
...
*   [Kotlin/dukat (⭐558)](https://github.com/Kotlin/dukat) - Converter of <any kind of declarations> to Kotlin external declarations
...
*   [trueangle/kotlin-native-aws-lambda-runtime (⭐6)](https://github.com/trueangle/kotlin-native-aws-lambda-runtime) - A runtime for executing AWS Lambda functions written in Kotlin/Native, designed to reduce cold start issues common with the JVM platform.
...
*   [msink/kotlin-libui (⭐651)](https://github.com/msink/kotlin-libui) - Kotlin/Native interop to libui: a portable GUI library
...
*   [Kotlin/Wasm Examples (⭐527)](https://github.com/Kotlin/kotlin-wasm-examples) - Explore a variety of Kotlin/Wasm example projects, showcasing applications like Compose Multiplatform, browser DOM API, Node.js, and WASI integration.
