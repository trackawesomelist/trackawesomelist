...
*   [nightscout/AndroidAPS (⭐547)](https://github.com/nightscout/AndroidAPS) - Opensource automated insulin delivery system (closed loop)
*   [fankes/TSBattery (⭐709)](https://github.com/fankes/TSBattery) - A new way to save your battery avoid cancer apps hacker it.
*   [FooIbar/EhViewer (⭐552)](https://github.com/FooIbar/EhViewer) - EhViewer overhauled with Material Design 3 and more, forked from [https://github.com/Ehviewer-Overhauled/Ehviewer (⭐4.5k)](https://github.com/Ehviewer-Overhauled/Ehviewer)
...
*   [Moriafly/SaltPlayerSource (⭐2.2k)](https://github.com/Moriafly/SaltPlayerSource) - Salt Player, The Best!
...
*   [SagerNet/SagerNet (⭐5.4k)](https://github.com/SagerNet/SagerNet) - The universal proxy toolchain for Android
...
*   [JunkFood02/Seal (⭐5.4k)](https://github.com/JunkFood02/Seal) - 🦭 Video/Audio Downloader for Android, based on yt-dlp, designed with Material You
...
*   [orgzly-revived/orgzly-android-revived (⭐105)](https://github.com/orgzly-revived/orgzly-android-revived) - Outliner for taking notes and managing to-do lists
*   [futo-org/grayjay-android (⭐178)](https://github.com/futo-org/grayjay-android) - Read-only mirror of Grayjay repo for issue tracking
*   [cyb3rko/flashdim (⭐207)](https://github.com/cyb3rko/flashdim) - Modern flashlight app with dim functionality on Android 13+
*   [rebelonion/Dantotsu (⭐308)](https://github.com/rebelonion/Dantotsu) - Anilist client based on Saikou
*   [TheChance101/beep-beep (⭐369)](https://github.com/TheChance101/beep-beep)
*   [anilbeesetti/nextplayer (⭐719)](https://github.com/anilbeesetti/nextplayer) - An Android native video player
*   [GuoXiCheng/SKIP (⭐835)](https://github.com/GuoXiCheng/SKIP) - 自动跳过APP开屏广告
*   [RookieTree/DaMaiHelper (⭐944)](https://github.com/RookieTree/DaMaiHelper) - 大麦抢票辅助
...
*   [simondankelmann/Bluetooth-LE-Spam (⭐654)](https://github.com/simondankelmann/Bluetooth-LE-Spam)
*   [rumboalla/apkupdater (⭐1.9k)](https://github.com/rumboalla/apkupdater) - APKUpdater is an open source tool that simplifies the process of finding updates for your installed apps.
*   [Kunzisoft/KeePassDX (⭐3.6k)](https://github.com/Kunzisoft/KeePassDX) - Lightweight vault and password manager for Android, KeePassDX allows editing encrypted data in a single file in KeePass format and fill in the forms in a secure way.
...
*   [JetBrains/amper (⭐218)](https://github.com/JetBrains/amper) - Amper - a tool for project configuration with a focus on the developer experience and the IDE support
*   [icerockdev/moko-resources (⭐823)](https://github.com/icerockdev/moko-resources) - Resources access for mobile (android & ios) Kotlin Multiplatform development
...
*   [JetBrains/lets-plot (⭐1.3k)](https://github.com/JetBrains/lets-plot) - Multiplatform plotting library based on Grammar of Graphics
...
*   [rnmapbox/maps (⭐1.9k)](https://github.com/rnmapbox/maps) - A Mapbox react native module for creating custom maps
*   [raamcosta/compose-destinations (⭐2.7k)](https://github.com/raamcosta/compose-destinations) - Annotation processing library for type-safe Jetpack Compose navigation with no boilerplate.
*   [square/wire (⭐4.1k)](https://github.com/square/wire) - gRPC and protocol buffers for Android, Kotlin, Swift and Java.
...
*   [cashapp/sqldelight (⭐5.6k)](https://github.com/cashapp/sqldelight) - SQLDelight - Generates typesafe Kotlin APIs from SQL
*   [square/moshi (⭐9.3k)](https://github.com/square/moshi) - A modern JSON library for Kotlin and Java.
...
*   [Ahoo-Wang/Wow (⭐73)](https://github.com/Ahoo-Wang/Wow) - A Modern Reactive CQRS Architecture Microservice development framework based on DDD and EventSourcing.
*   [gimlet2/kottpd (⭐74)](https://github.com/gimlet2/kottpd) - REST framework in pure Kotlin, inspired by spark-java
*   [ButterCam/sisyphus (⭐84)](https://github.com/ButterCam/sisyphus) - Modern gRPC service framework based on Kotlin/Spring Boot with Message DSL/HTTP transcoding/Google AIP support.
...
*   [hexagonkt/hexagon (⭐530)](https://github.com/hexagonkt/hexagon) - A Microservices framework that takes care of HTTP, serialization and storage.
*   [nacular/doodle](https://nacular.github.io/doodle/) - A pure Kotlin UI framework for the Web (and Desktop)
*   [jwstegemann/fritz2 (⭐566)](https://github.com/jwstegemann/fritz2) - small lib to build reactive web-apps in pure Kotlin based on Flows
*   [kwebio/kweb-core (⭐938)](https://github.com/kwebio/kweb-core) - Build rich live-updating web apps in pure server-side Kotlin.
*   [perwendel/spark-kotlin (⭐978)](https://github.com/perwendel/spark-kotlin) - A DSL in idiomatic Kotlin for the Spark web framework.
...
*   [Trendyol/stove4k (⭐88)](https://github.com/Trendyol/stove4k) - The easiest way of writing e2e tests for your back-end API with all physical dependencies in Kotlin.
...
*   [sokomishalov/skraper (⭐208)](https://github.com/sokomishalov/skraper) - Kotlin/Java library, cli tool and telegram-bot for scraping posts and media from various sources with neither authorization nor full page rendering (Facebook, Instagram, Twitter, Youtube, Tiktok, Telegram, Twitch, Reddit, Pinterest, Flickr, Tumblr, etc.)
...
*   [serpro69/kotlin-faker (⭐372)](https://github.com/serpro69/kotlin-faker) - Port of ruby faker gem written in kotlin
*   [Kotlin/kotlinx-benchmark (⭐403)](https://github.com/Kotlin/kotlinx-benchmark) - A powerful library for benchmarking in Kotlin.
*   [Ninja-Squad/springmockk (⭐444)](https://github.com/Ninja-Squad/springmockk) - SpringMockK: MockBean and SpyBean, but for MockK instead of Mockito
*   [robstoll/atrium (⭐491)](https://github.com/robstoll/atrium) - Multiplatform assertion library for Kotlin supporting i18n.
*   [robfletcher/strikt (⭐513)](https://github.com/robfletcher/strikt) - An assertion library for Kotlin
*   [tschuchortdev/kotlin-compile-testing (⭐606)](https://github.com/tschuchortdev/kotlin-compile-testing) - A library for testing Kotlin and Java annotation processors, compiler plugins and code generation
*   [willowtreeapps/assertk (⭐683)](https://github.com/willowtreeapps/assertk) - assertions for kotlin inspired by assertj
*   [skrapeit/skrape.it (⭐685)](https://github.com/skrapeit/skrape.it) - A DSL-driven HTML/XML parser-library that enables meaningful testing of rendered HTML templates.
...
*   [evant/kotlin-inject (⭐949)](https://github.com/evant/kotlin-inject) - Dependency injection lib for kotlin
...
*   [cloudoptlab/cloudopt-next (⭐327)](https://github.com/cloudoptlab/cloudopt-next) - A next-generation Java web lightweight framework based on vertx and kotlin.
*   [konrad-kaminski/spring-kotlin-coroutine (⭐437)](https://github.com/konrad-kaminski/spring-kotlin-coroutine) - Kotlin coroutine support for Spring.
*   [marcoferrer/kroto-plus (⭐490)](https://github.com/marcoferrer/kroto-plus) - Protoc plugin for bringing together Kotlin, Protobuf, Coroutines, and gRPC.
...
*   [fork-handles/result4k (⭐162)](https://github.com/fork-handles/forkhandles/blob/trunk/result4k) - Result monad for type safe error handling in Kotlin
...
*   [michaelbull/kotlin-result (⭐864)](https://github.com/michaelbull/kotlin-result) - A Result monad for modelling success or failure operations - inspired by Elm, Rust, & Haskell.
*   [kittinunf/Result (⭐864)](https://github.com/kittinunf/Result) - The modelling for success/failure of operations in Kotlin.
...
*   [knbt (⭐57)](https://github.com/BenWoodworth/knbt) - Minecraft NBT support for kotlinx.serialization
...
*   [konform-kt/konform (⭐595)](https://github.com/konform-kt/konform) - Multiplatform validations for Kotlin data classes
...
*   [ctripcorp/SQLlin (⭐173)](https://github.com/ctripcorp/SQLlin) - A DSL SQLite library for Kotlin Multiplatform
*   [seratch/kotliquery (⭐193)](https://github.com/seratch/kotliquery) - A handy database access library in Kotlin.
...
*   [komapper/komapper (⭐232)](https://github.com/komapper/komapper) - Komapper is an ORM library for server-side Kotlin with JDBC and R2DBC support.
...
*   [dizitart/nitrite-database (⭐773)](https://github.com/dizitart/nitrite-database/tree/master/potassium-nitrite) - Potassium Nitrite is a kotlin extension of nitrite database, an open source nosql embedded document store with mongodb like api.
...
*   [square/sqldelight (⭐5.6k)](https://github.com/square/sqldelight) - Generates Java models from CREATE TABLE statements.
...
*   [danger/kotlin (⭐456)](https://github.com/danger/kotlin) - Stop saying "you forgot to …" in code review in Kotlin
...
*   [mathiasfrohlich/vscode-kotlin (⭐195)](https://github.com/mathiasfrohlich/vscode-kotlin) - Kotlin language support for VS Code.
*   [udalov/kotlin-vim (⭐610)](https://github.com/udalov/kotlin-vim) - Kotlin Syntax Highlighter for Vim.
...
*   [cansik/kotlin-latex-listing (⭐116)](https://github.com/cansik/kotlin-latex-listing) - A syntax highlighting template for the Kotlin language in LaTeX listings.
...
*   [zeganstyl/thelema-engine (⭐67)](https://github.com/zeganstyl/thelema-engine) - 3d graphics engine in Kotlin, based on sources of libGDX. Platforms: JVM, TeaVM, Kotlin/JS, Kotlin/Native. See live demo: <a href="https://zeganstyl.github.io/thelema-teavm-tests/">TeaVM</a>, <a href="https://zeganstyl.github.io/thelema-kxjs-demo/">Kotlin/JS</a>
*   [KogeLabs/Ockero (⭐68)](https://github.com/KogeLabs/Ockero) - Ockero: Kotlin OpenGl Game Engine
*   [littlektframework/littlekt (⭐228)](https://github.com/littlektframework/littlekt) - A Kotlin multiplatform 2D game development framework based on OpenGL that is inspired by libGDX and KorGE. Current platforms: JVM, Web, and Android.
*   [icela/FriceEngine (⭐340)](https://github.com/icela/FriceEngine) - Make game developing easy again!
*   [Hexworks/zircon (⭐727)](https://github.com/Hexworks/zircon) - An extensible text GUI library which targets multiple platforms and designed specifically for game developers, written in Kotlin.
...
*   [z4kn4fein/kotlin-semver (⭐68)](https://github.com/z4kn4fein/kotlin-semver) - Semantic Versioning library for Kotlin Multiplatform.
...
*   [justwrote/kjob (⭐75)](https://github.com/justwrote/kjob) - A coroutine based persistent background scheduler written in Kotlin.
...
*   [pearxteam/kasechange (⭐79)](https://github.com/pearxteam/kasechange) - Multiplatform Kotlin library to convert strings between various case formats including Camel Case, Snake Case, Pascal Case and Kebab Case
...
*   [spoptchev/scientist (⭐89)](https://github.com/spoptchev/scientist) - A kotlin library for refactoring code. Port of GitHub's scientist.
...
*   [vendelieu/telegram-bot (⭐104)](https://github.com/vendelieu/telegram-bot) - A lightweight, feature-rich wrapper for the Telegram Bot API
*   [consoleau/kassava (⭐111)](https://github.com/consoleau/kassava) - This library provides some useful kotlin extension functions for implementing toString() and equals() without all of the boilerplate.
...
*   [fork-handles/tuples4k (⭐162)](https://github.com/fork-handles/forkhandles/tree/trunk/tuples4k) - Tuple classes
...
*   [krud-dev/shapeshift (⭐164)](https://github.com/krud-dev/shapeshift) - A Kotlin library for intelligent object mapping and conversion between objects.
...
*   [yole/kxdate (⭐253)](https://github.com/yole/kxdate) - Kotlin extensions for Java 8 java.time API
...
*   [insanusmokrassar/TelegramBotAPI (⭐290)](https://github.com/insanusmokrassar/TelegramBotAPI) - Kotlin Multiplatform library for type-safe work with Telegram Bot API
*   [oolong-kt/oolong](https://oolong-kt.org) - Elm inspired Model-View-Update (MVU) implementation for Kotlin multiplatform.
*   [touchlab/KMMBridge (⭐303)](https://github.com/touchlab/KMMBridge) - KMMBridge is a set of Gradle tooling that facilitates publishing and consuming pre-built KMM (Kotlin Multiplatform Mobile) Xcode Framework binaries.
*   [hotchemi/khronos (⭐327)](https://github.com/hotchemi/khronos) - An intuitive Date extensions in Kotlin.
*   [charleskorn/kaml (⭐413)](https://github.com/charleskorn/kaml) - YAML support for kotlinx.serialization
*   [doyaaaaaken/kotlin-csv (⭐557)](https://github.com/doyaaaaaken/kotlin-csv) - A pure kotlin simple csv reader/writer.
*   [cretz/asmble (⭐599)](https://github.com/cretz/asmble) - Compile WebAssembly to JVM and other WASM tools.
*   [pemistahl/lingua (⭐615)](https://github.com/pemistahl/lingua) - A language detection library suitable for long and short text alike
*   [pmwmedia/tinylog (⭐633)](https://github.com/pmwmedia/tinylog) - Lightweight logging framework with native logging API for Kotlin.
*   [mplatvoet/kovenant (⭐656)](https://github.com/mplatvoet/kovenant) - Promises for Kotlin and Android
*   [kotlin-telegram-bot/kotlin-telegram-bot (⭐737)](https://github.com/kotlin-telegram-bot/kotlin-telegram-bot) - A wrapper for the Telegram Bot API written in Kotlin.
*   [Kotlin/kotlinx.atomicfu (⭐747)](https://github.com/Kotlin/kotlinx.atomicfu) - The idiomatic way to use atomic operations in Kotlin.
...
*   [Pi4J/pi4j-kotlin (⭐41)](https://github.com/Pi4J/pi4j-kotlin) - Pi4J Kotlin DSL and API.
...
*   [data2viz/data2viz (⭐395)](https://github.com/data2viz/data2viz) - multiplatform dataviz library, d3js port
...
*   [kotlin-graphics/imgui (⭐574)](https://github.com/kotlin-graphics/imgui) - jvm port of imgui
...
*   [java-opengl-labs/modern-jogl-examples (⭐101)](https://github.com/java-opengl-labs/modern-jogl-examples) - port of 'Learning Modern 3D Graphic Programming' by J.L.McKesson (jogl)
...
*   [java-opengl-labs/Vulkan (⭐50)](https://github.com/java-opengl-labs/Vulkan) - port of [https://github.com/SaschaWillems/Vulkan (⭐9.2k)](https://github.com/SaschaWillems/Vulkan)
...
*   [nwillc/ksvg (⭐76)](https://github.com/nwillc/ksvg) - Kotlin SVG image generation DSL, supporting inline and file formats.
*   [openrndr/openrndr (⭐799)](https://github.com/openrndr/openrndr) - OPENRNDR, a framework for creative coding in Kotlin. Accelerated 2D and 3D graphics, vector graphics, shaders and animation
*   [openrndr/orx (⭐106)](https://github.com/openrndr/orx) - ORX is a collection extras for OPENRNDR which add support for sensors, live-coding, user interfaces and much more.
...
*   [JetBrains/lets-plot-kotlin (⭐369)](https://github.com/JetBrains/lets-plot-kotlin) - Grammar of graphics visualization for Kotlin
...
*   [Kotlin/kotlin-jupyter (⭐980)](https://github.com/Kotlin/kotlin-jupyter) - Official Kotlin Jupyter kernel
...
*   [mipt-npm/kmath (⭐573)](https://github.com/mipt-npm/kmath) - A (not so numpy-like) multiplatform mathematical library with higher level abstractions.
...
*   [breandan/kotlingrad (⭐499)](https://github.com/breandan/kotlingrad) - Shape-Safe Differentiable Programming with Algebraic Data Types.
...
*   [Kotlin/multik (⭐570)](https://github.com/Kotlin/multik) - A Kotlin library for working with multi-dimensional arrays
*   [Kotlin/dataframe (⭐586)](https://github.com/Kotlin/dataframe) - A Kotlin library for in-memory data manipulation
*   [breandan/kaliningraph (⭐93)](https://github.com/breandan/kaliningraph)
...
*   [ajalt/mordant (⭐825)](https://github.com/ajalt/mordant) - Mordant - Full-featured text styling for Kotlin command line applications.
...
*   [fork-handles/bunting4k (⭐162)](https://github.com/fork-handles/forkhandles/tree/trunk/bunting4k) - Simple, typesafe, testable command line flags
*   [dbaelz/Konclik (⭐46)](https://github.com/dbaelz/Konclik)
*   [varabyte/kotter (⭐470)](https://github.com/varabyte/kotter) - A declarative, Kotlin-idiomatic API for writing dynamic command line applications
*   [kotlin-inquirer (⭐179)](https://github.com/kotlin-inquirer/kotlin-inquirer) - A collection of common interactive command line user interfaces written in Kotlin
...
*   [adamint/spotify-web-api-kotlin (⭐164)](https://github.com/adamint/spotify-web-api-kotlin) - Spotify Web API wrapper for Kotlin/Android, JVM, JS, and Native targets.
*   [awslabs/aws-sdk-kotlin (⭐311)](https://github.com/awslabs/aws-sdk-kotlin) - Multiplatform AWS SDK for Kotlin
*   [MoviebaseApp/tmdb-api (⭐156)](https://github.com/MoviebaseApp/tmdb-api) - Modern powerful TMDB API to fetch movies and TV shows for Kotlin Multiplatform.
...
*   [LighthouseGames/KmLogging (⭐46)](https://github.com/LighthouseGames/KmLogging) - Kotlin multiplatform logging. High performance, composable and simple to use.
...
*   [CuriousNikhil/neumorphic-compose (⭐340)](https://github.com/CuriousNikhil/neumorphic-compose) - Neumorphism UI on Android with Jetpack Compose. Just add one modifier = Modifier.neumorphic()
*   [CuriousNikhil/compose-particle-system (⭐61)](https://github.com/CuriousNikhil/compose-particle-system) - A lightweight particle system for Jetpack Compose - Quarks
...
*   [Canopas/Intro-showcase-view (⭐322)](https://github.com/Canopas/Intro-showcase-view) - An android library to highlight different features of the app built using Jetpack Compose.
*   [mahozad/wavy-slider (⭐34)](https://github.com/mahozad/wavy-slider) - Multiplatform UI widget that recreates the Android 13 squiggly progress bar

## <a name="projects"></a>Projects <sup>[Back ⇈](#projects-category)</sup>

### <a name="projects-web"></a>Web <sup>[Back ⇈](#projects-web-subcategory)</sup>

*   [sdeleuze/spring-boot-kotlin-demo (⭐599)](https://github.com/sdeleuze/spring-boot-kotlin-demo) - Basic Spring Boot app in Kotlin.
...
*   [Ahoo-Wang/CoSky (⭐73)](https://github.com/Ahoo-Wang/CoSky) - High-performance, low-cost microservice governance platform. Service Discovery and Configuration Service
...
*   [mkobit/jenkins-pipeline-shared-libraries-gradle-plugin (⭐145)](https://github.com/mkobit/jenkins-pipeline-shared-libraries-gradle-plugin) - Gradle plugin to help with build and test of Jenkins Pipeline Shared Libraries.
...
*   [krud-dev/ostara (⭐271)](https://github.com/krud-dev/ostara) - A desktop application that provides various features to monitor and interact with Spring Boot Applications via Actuator.
...
*   [dkandalov/kotlin-99 (⭐635)](https://github.com/dkandalov/kotlin-99) - Solve 99 problems with Kotlin!
...
*   [bmaslakov/kotlin-algorithm-club (⭐932)](https://github.com/bmaslakov/kotlin-algorithm-club) - Classic algorithms and data structures in Kotlin.
...
*   [TobseF/Candy-Crush-Clone (⭐103)](https://github.com/TobseF/Candy-Crush-Clone) - A Kotlin Multiplatform match 3 sample game build to teach, made with KorGE.
...
*   [skydoves/themovies (⭐475)](https://github.com/skydoves/themovies) - A simple project for The Movie DB based on Kotlin MVVM clean architecture and material design & animations.
...
*   [SimonSchubert/LinuxCommandBibliotheca (⭐501)](https://github.com/SimonSchubert/LinuxCommandBibliotheca) - Android app which provides a bunch of useful Linux commands.
...
*   [zt64/Hyperion (⭐532)](https://github.com/zt64/Hyperion) - An alternative YouTube front-end using modern Android architecture and Material 3
...
*   [DanielMartinus/Stepper-Touch (⭐676)](https://github.com/DanielMartinus/Stepper-Touch) - Fun playful Android stepper widget for counting, written in Kotlin.
...
*   [coil-kt/coil (⭐9.7k)](https://github.com/coil-kt/coil) - Image loading for Android backed by Kotlin Coroutines.
...
*   [MackHartley/RoundedProgressBar (⭐659)](https://github.com/MackHartley/RoundedProgressBar) - A customizable, animated progress bar that features rounded corners. This Android library is designed to look great and be simple to use
...
*   [heart-switch (⭐45)](https://github.com/popovanton0/heart-switch) - A heart-shaped toggle switch component for Jetpack Compose
*   [Blueprint (⭐80)](https://github.com/popovanton0/Blueprint) - 📐 A library that draws a blueprint on top of your Jetpack Compose composables. It visualizes dimensions, like paddings and sizes.
...
*   [BanDev/Buddha-Quotes (⭐27)](https://github.com/BanDev/Buddha-Quotes) - A collaborative project to create a Free and Open Source Buddha Quotes app.
...
*   [SimpleMobileTools/Simple-Camera (⭐718)](https://github.com/SimpleMobileTools/Simple-Camera) - A camera with flash, zoom and no ads.
*   [SimpleMobileTools/Simple-Draw (⭐487)](https://github.com/SimpleMobileTools/Simple-Draw) - A canvas you can draw on with different colors.
...
*   [hanjoongcho/aaf-easydiary (⭐373)](https://github.com/hanjoongcho/aaf-easydiary) - This is a diary application optimized to user experience.
...
*   [adrielcafe/ChromaAndroidApp (⭐95)](https://github.com/adrielcafe/ChromaAndroidApp) - Chromatic tuner app.
*   [cuongpm/youtube-dl-android (⭐478)](https://github.com/cuongpm/youtube-dl-android) - Video downloader for Android - Download videos from Youtube, Facebook, Twitter, Instagram, Dailymotion, Vimeo and more than 1000 other sites.
...
*   [AmrDeveloper/Linkhub (⭐131)](https://github.com/AmrDeveloper/Linkhub) - Free and open source effective link management app with no ads.
...
*   [Kotlin/kdoctor (⭐495)](https://github.com/Kotlin/kdoctor) - CLI tool that helps to set up the environment for Kotlin Multiplatform Mobile app development.
...
*   [KakaoCup/Compose (⭐105)](https://github.com/KakaoCup/Compose) - Nice and simple DSL for Espresso Compose UI testing in Kotlin

### <a name="android-multiplatform"></a>Multiplatform <sup>[Back ⇈](#android-multiplatform-subcategory)</sup>

*   [Reedyuk/blue-falcon (⭐278)](https://github.com/Reedyuk/blue-falcon) - A unified Bluetooth library for Android and iOS.
...
*   [nosix/vue-kotlin (⭐188)](https://github.com/nosix/vue-kotlin) - Libraries and tools supporting the use of Vue.js in Kotlin
...
*   [Kotlin/dukat (⭐511)](https://github.com/Kotlin/dukat) - Converter of <any kind of declarations> to Kotlin external declarations
...
*   [JetBrains/kotlinconf-spinner (⭐618)](https://github.com/JetBrains/kotlinconf-spinner) - Simple spinner-like game intended to demonstrate capabilities of Kotlin/Native software stack.
...
*   [msink/kotlin-libui (⭐633)](https://github.com/msink/kotlin-libui)
