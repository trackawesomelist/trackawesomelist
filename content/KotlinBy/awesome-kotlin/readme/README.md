...
*   [CCBlueX/LiquidBounce (⭐855)](https://github.com/CCBlueX/LiquidBounce) - A free mixin-based injection hacked client for Minecraft using the Fabric API
...
*   [JetBrains/compose-multiplatform (⭐10k)](https://github.com/JetBrains/compose-multiplatform) - Compose Multiplatform, a modern UI framework for Kotlin that makes building performant and beautiful user interfaces easy and enjoyable.
...
*   [cssxsh/fix-protocol-version (⭐43)](https://github.com/cssxsh/fix-protocol-version)
*   [matthaigh27/ChatGPT-android-app (⭐86)](https://github.com/matthaigh27/ChatGPT-android-app) - Android app for accessing ChatGPT
*   [M0Coding/Pokedex (⭐162)](https://github.com/M0Coding/Pokedex) - Pokedex - a Kotlin Multiplatform app, built with Compose multiplatform, Coroutines, Flow, Koin, Ktor, SqlDelight, Decompose, MVIKotlin, and Material 3 based on MVI architecture
...
*   [ArisGuimera/Android-Expert (⭐275)](https://github.com/ArisGuimera/Android-Expert) - Aprende a PROGRAMAR aplicaciones ANDROID en KOTLIN sin conocimientos previos
...
*   [vinaygaba/Learn-Jetpack-Compose-By-Example (⭐2.8k)](https://github.com/vinaygaba/Learn-Jetpack-Compose-By-Example) - 🚀 This project contains various examples that show how you would do things the "Jetpack Compose" way
...
*   [mobile-dev-inc/maestro (⭐3.3k)](https://github.com/mobile-dev-inc/maestro) - Painless Mobile UI Automation
...
*   [muratozturk5/Mova (⭐65)](https://github.com/muratozturk5/Mova) - Mova is a TMDb mobile add that list movies and series, shows their details, you can even watch trailers, save movies to list for watch later
*   [dessalines/thumb-key (⭐85)](https://github.com/dessalines/thumb-key) - A privacy-conscious Android keyboard made for your thumbs
*   [re-ovo/awara (⭐131)](https://github.com/re-ovo/awara) - iwara android app
*   [philipplackner/CleanArchitectureNoteApp (⭐451)](https://github.com/philipplackner/CleanArchitectureNoteApp)
*   [easybangumiorg/EasyBangumi (⭐472)](https://github.com/easybangumiorg/EasyBangumi) - 纯纯看番，使用 Compose 开发的看番软件，支持多番剧源
*   [slackhq/circuit (⭐538)](https://github.com/slackhq/circuit) - ⚡️ A Compose-driven architecture for Kotlin and Android applications.
...
*   [raamcosta/compose-destinations (⭐2k)](https://github.com/raamcosta/compose-destinations) - Annotation processing library for type-safe Jetpack Compose navigation with no boilerplate.
*   [Kotlin/dokka (⭐2.9k)](https://github.com/Kotlin/dokka) - API documentation engine for Kotlin
*   [kotest/kotest (⭐3.8k)](https://github.com/kotest/kotest) - Powerful, elegant and flexible test framework for Kotlin with additional assertions, property testing and data driven testing
*   [detekt/detekt (⭐5.2k)](https://github.com/detekt/detekt) - Static code analysis for Kotlin
*   [JetBrains/Exposed (⭐6.9k)](https://github.com/JetBrains/Exposed) - Kotlin SQL Framework
