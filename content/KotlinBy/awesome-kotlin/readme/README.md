...
*   [android/platform-samples (⭐743)](https://github.com/android/platform-samples) - A collection of samples of different Android OS platform APIs.
*   [hefengbao/jingmo (⭐742)](https://github.com/hefengbao/jingmo) - 『京墨』开源的古诗词文（名句）、歇后语、成语、传统节日、绕口令等的阅读APP
...
*   [fcitx5-android/fcitx5-android (⭐1.9k)](https://github.com/fcitx5-android/fcitx5-android) - Fcitx5 input method framework and engines ported to Android
...
*   [mihonapp/mihon (⭐4.6k)](https://github.com/mihonapp/mihon) - Free and open source manga reader for Android
...
*   [bitfireAT/davx5-ose (⭐1.1k)](https://github.com/bitfireAT/davx5-ose) - DAVx⁵ is an open-source CalDAV/CardDAV suite and sync app for Android. You can also access your online files (WebDAV) with it.
...
*   [Kotlin/kotlinx-kover (⭐1.1k)](https://github.com/Kotlin/kotlinx-kover)
*   [android/codelab-android-compose (⭐1.2k)](https://github.com/android/codelab-android-compose)
*   [rnmapbox/maps (⭐2k)](https://github.com/rnmapbox/maps) - A Mapbox react native module for creating custom maps
*   [adrielcafe/voyager (⭐2k)](https://github.com/adrielcafe/voyager) - 🛸 A pragmatic navigation library for Jetpack Compose
...
*   [Mygod/VPNHotspot (⭐3.1k)](https://github.com/Mygod/VPNHotspot) - Share your VPN connection over hotspot or repeater! (root required)
...
*   [hectorqin/reader (⭐6.5k)](https://github.com/hectorqin/reader) - 阅读3服务器版，桌面端，iOS可用。后端 Kotlin + Spring Boot + Vert.x + Coroutine ；前端 Vue.js + Element。麻烦点点star，关注一下公众号【假装大佬】❗️  Demo服务器由于未备案已被关停，建议自行搭建
*   [tiann/KernelSU (⭐6.9k)](https://github.com/tiann/KernelSU) - A Kernel based root solution for Android
...
*   [cami-la/credit-application-system (⭐107)](https://github.com/cami-la/credit-application-system) - Conheça o Spring Boot. Nesse contexto, explore a linguagem de programação Kotlin e entenda como o projeto Spring Data JPA  facilita a criação de aplicativos baseados em Spring que usam tecnologias de acesso a dados.
...
*   [zacharee/Tweaker (⭐737)](https://github.com/zacharee/Tweaker)
*   [truefedex/tv-bro (⭐787)](https://github.com/truefedex/tv-bro) - Simple web browser for android optimized to use with TV remote
*   [rebelonion/Dantotsu (⭐848)](https://github.com/rebelonion/Dantotsu) - Anilist client based on Saikou
*   [10miaomiao/bilimiao2 (⭐1.2k)](https://github.com/10miaomiao/bilimiao2) - bilimiao 2.0
*   [lavalink-devs/Lavalink (⭐1.4k)](https://github.com/lavalink-devs/Lavalink) - Standalone audio sending node based on Lavaplayer.
*   [OxygenCobalt/Auxio (⭐1.6k)](https://github.com/OxygenCobalt/Auxio) - A simple, rational music player for android
...
*   [deniscerri/ytdlnis (⭐2.2k)](https://github.com/deniscerri/ytdlnis) - Android Video/Audio Downloader app using yt-dlp
*   [rumboalla/apkupdater (⭐2.1k)](https://github.com/rumboalla/apkupdater) - APKUpdater is an open source tool that simplifies the process of finding updates for your installed apps.
*   [tasks/tasks (⭐3.1k)](https://github.com/tasks/tasks) - Bringing Astrid Tasks back from the dead
...
*   [google/accompanist (⭐7.1k)](https://github.com/google/accompanist) - A collection of extension libraries for Jetpack Compose
*   [vfsfitvnm/ViMusic (⭐7.2k)](https://github.com/vfsfitvnm/ViMusic) - An Android application for streaming music from YouTube Music.
