...
*   [cssxsh/mirai-openai-plugin (⭐47)](https://github.com/cssxsh/mirai-openai-plugin) - Mirai Console OpenAI ChatBot 插件
*   [WaxMoon/MultiApp (⭐142)](https://github.com/WaxMoon/MultiApp) - A customizable virtual Android container/一款可定制的虚拟安卓容器
*   [KlassenKonstantin/ComposePhysicsLayout (⭐185)](https://github.com/KlassenKonstantin/ComposePhysicsLayout) - A custom Compose layout backed by a physics engine
*   [ktorio/ktor-documentation (⭐224)](https://github.com/ktorio/ktor-documentation)
*   [skydoves/chatgpt-android (⭐239)](https://github.com/skydoves/chatgpt-android) - 📱 ChatGPT Android demonstrates OpenAI's ChatGPT on Android with Stream Chat SDK for Compose.
*   [wdsqjq/FengYunWeather (⭐955)](https://github.com/wdsqjq/FengYunWeather) - 风云天气是Android 平台开源天气 App，采用Kotlin、Room、OKHttp3、 协程等框架实现。
...
*   [cashapp/sqldelight (⭐4.9k)](https://github.com/cashapp/sqldelight) - SQLDelight - Generates typesafe Kotlin APIs from SQL
...
*   [InsertKoinIO/koin (⭐7.7k)](https://github.com/InsertKoinIO/koin) - Koin - a pragmatic lightweight dependency injection framework for Kotlin & Kotlin Multiplatform
