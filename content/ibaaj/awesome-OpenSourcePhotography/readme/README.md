...
A list of awesome free open source software & libraries for photography. Also tools for video. For more awesomeness, check out [awesome (⭐223k)](https://github.com/sindresorhus/awesome).
