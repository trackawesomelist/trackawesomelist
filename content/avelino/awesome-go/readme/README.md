...
We use the *[Golang Bridge (⭐356)](https://github.com/gobridge/about-us/blob/master/README.md)* community slack for instant communication, follow the [form here to join](https://invite.slack.golangbridge.org/).
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python (⭐153k)](https://github.com/vinta/awesome-python).

**Contributing:**

Please take a quick gander at the [contribution guidelines (⭐94k)](https://github.com/avelino/awesome-go/blob/master/CONTRIBUTING.md) first. Thanks to all [contributors (⭐94k)](https://github.com/avelino/awesome-go/graphs/contributors); you rock!
...
*   [flac (⭐232)](https://github.com/mewkiz/flac) - Native Go FLAC encoder/decoder with support for FLAC streams.
*   [gaad (⭐107)](https://github.com/Comcast/gaad) - Native Go AAC bitstream parser.
*   [GoAudio (⭐271)](https://github.com/DylanMeeus/GoAudio) - Native Go Audio Processing Library.
*   [gosamplerate (⭐25)](https://github.com/dh1tw/gosamplerate) - libsamplerate bindings for go.
*   [id3v2 (⭐276)](https://github.com/bogem/id3v2) - ID3 decoding and encoding library for Go.
*   [malgo (⭐212)](https://github.com/gen2brain/malgo) - Mini audio library.
*   [minimp3 (⭐96)](https://github.com/tosone/minimp3) - Lightweight MP3 decoder library.
*   [Oto (⭐1.2k)](https://github.com/hajimehoshi/oto) - A low-level library to play sound on multiple platforms.
*   [PortAudio (⭐561)](https://github.com/gordonklaus/portaudio) - Go bindings for the PortAudio audio I/O library.
...
*   [otpgo (⭐50)](https://github.com/jltorresm/otpgo) - Time-Based One-Time Password (TOTP) and HMAC-Based One-Time Password (HOTP) library for Go.
*   [paseto (⭐661)](https://github.com/o1egl/paseto) - Golang implementation of Platform-Agnostic Security Tokens (PASETO).
...
*   [gossamer (⭐368)](https://github.com/ChainSafe/gossamer) - A Go implementation of the Polkadot Host.
*   [solana-go (⭐398)](https://github.com/gagliardetto/solana-go) - Go library to interface with Solana JSON RPC and WebSocket interfaces.
...
*   [echotron (⭐219)](https://github.com/NicoNex/echotron) - An elegant and concurrent library for Telegram Bots in Go.
...
*   [go-chat-bot (⭐770)](https://github.com/go-chat-bot/bot) - IRC, Slack & Telegram bot written in Go.
...
*   [go-twitch-irc (⭐274)](https://github.com/gempir/go-twitch-irc) - Library to write bots for twitch.tv chat
*   [Golang CryptoTrading Bot (⭐869)](https://github.com/saniales/golang-crypto-trading-bot) - A golang implementation of a console-based trading bot for cryptocurrency exchanges.
...
*   [Kelp (⭐959)](https://github.com/stellar/kelp) - official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies.
*   [larry (⭐111)](https://github.com/ezeoleaf/larry) - Larry 🐦 is a really simple Twitter bot generator that tweets random repositories from Github built in Go.
...
*   [slack-bot (⭐131)](https://github.com/innogames/slack-bot) - Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github...
*   [slacker (⭐722)](https://github.com/shomali11/slacker) - Easy to use framework to create Slack bots.
...
*   [telego (⭐137)](https://github.com/mymmrac/telego) - Telegram Bot API library for Golang with full one-to-one API implementation.
...
*   [1build (⭐204)](https://github.com/gopinath-langote/1build) - Command line tool to frictionlessly manage project-specific commands.
*   [anko (⭐29)](https://github.com/GuilhermeCaruso/anko) - Simple application watcher for multiple programming languages.
*   [gaper (⭐65)](https://github.com/maxcnunes/gaper) - Builds and restarts a Go project when it crashes or some watched file changes.
*   [gilbert](https://go-gilbert.github.io) - Build system and task runner for Go projects.
*   [goyek (⭐353)](https://github.com/goyek/goyek) - Create build pipelines in Go.
...
*   [Task (⭐6.6k)](https://github.com/go-task/task) - simple "Make" alternative.
...
*   [box-cli-maker (⭐328)](https://github.com/Delta456/box-cli-maker) - Make Highly Customized Boxes for your CLI.
...
*   [chalk (⭐419)](https://github.com/ttacon/chalk) - Intuitive package for prettifying terminal/console output.
...
*   [go-colorable (⭐670)](https://github.com/mattn/go-colorable) - Colorable writer for windows.
...
*   [marker (⭐36)](https://github.com/cyucelen/marker) - Easiest way to match and mark strings for colorful terminal outputs.
...
*   [uitable (⭐688)](https://github.com/gosuri/uitable) - Library to improve readability in terminal apps using tabular data.
...
*   [argparse (⭐490)](https://github.com/akamensky/argparse) - Command line argument parser inspired by Python's argparse module.
...
*   [cli (⭐677)](https://github.com/mkideal/cli) - Feature-rich and easy to use command-line package based on golang struct tags.
...
*   [clîr (⭐149)](https://github.com/leaanthony/clir) - A Simple and Clear CLI library. Dependency free.
...
*   [complete (⭐869)](https://github.com/posener/complete) - Write bash completions in Go + Go command bash completion.
...
*   [liner (⭐948)](https://github.com/peterh/liner) - Go readline-like library for command-line interfaces.
...
*   [aconfig (⭐423)](https://github.com/cristalhq/aconfig) - Simple, useful and opinionated config loader.
*   [cleanenv (⭐860)](https://github.com/ilyakaznacheev/cleanenv) - Minimalistic configuration reader (from files, ENV, and wherever you want).
*   [config (⭐323)](https://github.com/JeremyLoy/config) - Cloud native application configuration. Bind ENV to structs in only two lines.
...
*   [configuro (⭐83)](https://github.com/sherifabdlnaby/configuro) - opinionated configuration loading & validation framework from ENV and Files focused towards 12-Factor compliant applications.
...
*   [env (⭐3.1k)](https://github.com/caarlos0/env) - Parse environment variables to Go structs (with defaults).
...
*   [envconfig (⭐231)](https://github.com/vrischmann/envconfig) - Read your configuration from environment variables.
...
*   [godotenv (⭐5.7k)](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
*   [gookit/config (⭐418)](https://github.com/gookit/config) - application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge.
...
*   [xdg (⭐311)](https://github.com/adrg/xdg) - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
...
*   [goveralls (⭐751)](https://github.com/mattn/goveralls) - Go integration for Coveralls.io continuous code coverage tracking system.
...
*   [bitmap (⭐189)](https://github.com/kelindar/bitmap) - Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go.
...
*   [cmap (⭐46)](https://github.com/lrita/cmap) - a thread-safe concurrent map for go, support using `interface{}` as key and auto scale up shards.
...
*   [hilbert (⭐257)](https://github.com/google/hilbert) - Go package for mapping values to and from space-filling curves, such as Hilbert and Peano curves.
*   [hyperloglog (⭐823)](https://github.com/axiomhq/hyperloglog) - HyperLogLog implementation with Sparse, LogLog-Beta bias correction and TailCut space reduction.
...
*   [levenshtein (⭐257)](https://github.com/agnivade/levenshtein) - Implementation to calculate levenshtein distance in Go.
...
*   [skiplist (⭐240)](https://github.com/MauriceGit/skiplist) - Very fast Go Skiplist implementation.
...
*   [eliasdb (⭐959)](https://github.com/krotik/eliasdb) - Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language.
*   [godis (⭐2.4k)](https://github.com/hdt3213/godis) - A Golang implemented high-performance Redis server and cluster.
*   [goleveldb (⭐5.5k)](https://github.com/syndtr/goleveldb) - Implementation of the [LevelDB (⭐32k)](https://github.com/google/leveldb) key/value database in Go.
...
*   [levigo (⭐412)](https://github.com/jmhodges/levigo) - Levigo is a Go wrapper for LevelDB.
...
*   [moss (⭐898)](https://github.com/couchbase/moss) - Moss is a simple LSM key-value storage engine written in 100% Go.
...
*   [atlas (⭐2.3k)](https://github.com/ariga/atlas) - A Database Toolkit. A CLI designed to help companies better work with their data.
...
*   [goavro (⭐860)](https://github.com/linkedin/goavro) - A Go package that encodes and decodes Avro data.
...
*   [gormigrate (⭐853)](https://github.com/go-gormigrate/gormigrate) - Database schema migration helper for Gorm ORM.
...
*   [sqlize (⭐48)](https://github.com/sunary/sqlize) - Database migration generator. Allows generate sql migration from model and existing sql by differ them.
...
*   [octillery (⭐177)](https://github.com/knocknote/octillery) - Go package for sharding databases ( Supports every ORM or raw SQL ).
*   [orchestrator (⭐4.8k)](https://github.com/github/orchestrator) - MySQL replication topology manager & visualizer.
*   [pg\_timetable (⭐822)](https://github.com/cybertec-postgresql/pg_timetable) - Advanced scheduling for PostgreSQL.
...
*   [buildsqlx (⭐87)](https://github.com/arthurkushman/buildsqlx) - Go database query builder library for PostgreSQL.
...
*   [Dotsql (⭐656)](https://github.com/gchaincl/dotsql) - Go library that helps you keep sql files in one place and use them with ease.
...
*   [igor (⭐90)](https://github.com/galeone/igor) - Abstraction layer for PostgreSQL that supports advanced functionality and uses gorm-like syntax.
*   [jet (⭐989)](https://github.com/go-jet/jet) - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
*   [ormlite (⭐5)](https://github.com/pupizoid/ormlite) - Lightweight package containing some ORM-like features and helpers for sqlite databases.
*   [ozzo-dbx (⭐589)](https://github.com/go-ozzo/ozzo-dbx) - Powerful data retrieval methods as well as DB-agnostic query building capabilities.
...
*   [sq (⭐186)](https://github.com/bokwoon95/go-structured-query) - Type-safe SQL builder and struct mapper for Go.
...
*   [sqlingo (⭐275)](https://github.com/lqs/sqlingo) - A lightweight DSL to build SQL in Go.
...
*   [go-persian-calendar (⭐140)](https://github.com/yaa110/go-persian-calendar) - The implementation of the Persian (Solar Hijri) Calendar in Go (golang).
...
*   [gostradamus (⭐174)](https://github.com/bykof/gostradamus) - A Go package for working with dates.
...
*   [arpc (⭐667)](https://github.com/lesismal/arpc) - More effective network communication, support two-way-calling, notify, broadcast.
...
*   [consistent (⭐558)](https://github.com/buraksezer/consistent) - Consistent hashing with bounded loads.
*   [consistenthash (⭐15)](https://github.com/mbrostami/consistenthash) - Consistent hashing with configurable replicas.
*   [dht (⭐255)](https://github.com/anacrolix/dht) - BitTorrent Kademlia DHT implementation.
*   [digota (⭐470)](https://github.com/digota/digota) - grpc ecommerce microservice.
...
*   [go-doudou (⭐969)](https://github.com/unionj-cloud/go-doudou) - A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity.
*   [go-health (⭐658)](https://github.com/InVisionApp/go-health) - Library for enabling asynchronous dependency health checks in your service.
...
*   [go-sundheit (⭐506)](https://github.com/AppsFlyer/go-sundheit) - A library built to provide support for defining async service health checks for golang services.
...
*   [outboxer (⭐114)](https://github.com/italolelis/outboxer) - Outboxer is a go library that implements the outbox pattern.
*   [pglock](https://cirello.io/pglock) - PostgreSQL-backed distributed locking implementation.
*   [pjrpc](https://gitlab.com/pjrpc/pjrpc) - Golang JSON-RPC Server-Client with Protobuf spec.
*   [raft (⭐6.7k)](https://github.com/hashicorp/raft) - Golang implementation of the Raft consensus protocol, by HashiCorp.
*   [raft (⭐42k)](https://github.com/coreos/etcd/tree/master/raft) - Go implementation of the Raft consensus protocol, by CoreOS.
*   [rain (⭐796)](https://github.com/cenkalti/rain) - BitTorrent client and library.
*   [redis-lock (⭐892)](https://github.com/bsm/redislock) - Simplified distributed locking implementation using Redis.
*   [resgate](https://resgate.io/) - Realtime API Gateway for building REST, real time, and RPC APIs, where all clients are synchronized seamlessly.
*   [ringpop-go (⭐767)](https://github.com/uber/ringpop-go) - Scalable, fault-tolerant application-layer sharding for Go applications.
...
*   [email-verifier (⭐611)](https://github.com/AfterShip/email-verifier) - A Go library for email verification without sending any emails.
...
*   [go-message (⭐291)](https://github.com/emersion/go-message) - Streaming library for the Internet Message Format and mail messages.
*   [go-premailer (⭐96)](https://github.com/vanng822/go-premailer) - Inline styling for HTML mail in Go.
*   [go-simple-mail (⭐415)](https://github.com/xhit/go-simple-mail) - Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send.
...
*   [mailchain (⭐134)](https://github.com/mailchain/mailchain) - Send encrypted emails to blockchain addresses written in Go.
*   [mailgun-go (⭐628)](https://github.com/mailgun/mailgun-go) - Go library for sending mail with the Mailgun API.
...
*   [SendGrid (⭐873)](https://github.com/sendgrid/sendgrid-go) - SendGrid's Go library for sending email.
*   [smtp (⭐74)](https://github.com/mailhog/smtp) - SMTP server protocol state machine.
*   [smtpmock (⭐66)](https://github.com/mocktools/go-smtp-mock) - Lightweight configurable multithreaded fake SMTP server. Mimic any SMTP behaviour for your test environment.
...
*   [binder (⭐65)](https://github.com/alexeyco/binder) - Go to Lua binding library, based on [gopher-lua (⭐5.2k)](https://github.com/yuin/gopher-lua).
...
*   [go-php (⭐884)](https://github.com/deuill/go-php) - PHP bindings for Go.
...
*   [golua (⭐604)](https://github.com/aarzilli/golua) - Go bindings for Lua C API.
*   [gopher-lua (⭐5.2k)](https://github.com/yuin/gopher-lua) - Lua 5.1 VM and compiler written in Go.
*   [gval (⭐564)](https://github.com/PaesslerAG/gval) - A highly customizable expression language written in Go.
...
*   [prolog (⭐457)](https://github.com/ichiban/prolog) - Embeddable Prolog.
...
*   [emperror (⭐282)](https://github.com/emperror/emperror) - Error handling tools and best practices for Go libraries and applications.
...
*   [errorx (⭐937)](https://github.com/joomcode/errorx) - A feature rich error package with stack traces, composition of errors and more.
...
*   [tracerr (⭐754)](https://github.com/ztrue/tracerr) - Golang errors with stack trace and source fragments.
...
*   [afs (⭐221)](https://github.com/viant/afs) - Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go.
*   [baraka (⭐46)](https://github.com/xis/baraka) - A library to process http file uploads easily.
*   [bigfile (⭐238)](https://github.com/bigfile/bigfile) - A file transfer system, support to manage files with http api, rpc call and ftp client.
...
*   [copy (⭐512)](https://github.com/otiai10/copy) - Copy directory recursively.
...
*   [go-csv-tag (⭐102)](https://github.com/artonge/go-csv-tag) - Load csv file using tag.
*   [go-decent-copy (⭐17)](https://github.com/hugocarreira/go-decent-copy) - Copy files for humans.
*   [go-exiftool (⭐156)](https://github.com/barasher/go-exiftool) - Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...).
...
*   [notify (⭐791)](https://github.com/rjeczalik/notify) - File system event notification library with simple API, similar to os/signal.
...
*   [pdfcpu (⭐4.4k)](https://github.com/pdfcpu/pdfcpu) - PDF processor.
...
*   [vfs (⭐213)](https://github.com/C2FO/vfs) - A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS.
...
*   [accounting (⭐783)](https://github.com/leekchan/accounting) - money and currency formatting for golang.
...
*   [currency (⭐362)](https://github.com/bojanz/currency) - Handles currency amounts, provides currency information and formatting.
...
*   [go-finance (⭐144)](https://github.com/alpeb/go-finance) - Library of financial functions for time value of money (annuities), cash flow, interest rate conversions, bonds and depreciation calculations.
...
*   [orderbook (⭐320)](https://github.com/i25959341/orderbook) - Matching Engine for Limit Order Book in Golang.
*   [payme (⭐14)](https://github.com/jovandeginste/payme) - QR code generator (ASCII & PNG) for SEPA payments.
*   [sleet (⭐106)](https://github.com/BoltApp/sleet) - One unified interface for multiple Payment Service Providers (PsP) to process online payment.
*   [techan (⭐698)](https://github.com/sdcoffey/techan) - Technical analysis library with advanced market analysis and trading strategies.
...
*   [conform (⭐284)](https://github.com/leebenson/conform) - Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags.
*   [form (⭐575)](https://github.com/go-playground/form) - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
*   [gorilla/csrf (⭐863)](https://github.com/gorilla/csrf) - CSRF protection for Go web applications & services.
...
*   [fpGo (⭐305)](https://github.com/TeaEntityLab/fpGo) - Monad, Functional Programming features for Golang.
...
*   [go-astar (⭐538)](https://github.com/beefsack/go-astar) - Go implementation of the A\* path finding algorithm.
...
*   [prototype (⭐79)](https://github.com/gonutz/prototype) - Cross-platform (Windows/Linux/Mac) library for creating desktop games using a minimal API.
...
*   [tile (⭐83)](https://github.com/kelindar/tile) - Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export.
...
*   [go-enum (⭐425)](https://github.com/abice/go-enum) - Code generation for enums from code comments.
...
*   [goverter (⭐191)](https://github.com/jmattheis/goverter) - Generate converters by defining an interface.
*   [GoWrap (⭐703)](https://github.com/hexdigest/gowrap) - Generate decorators for Go interfaces using simple templates.
*   [interfaces (⭐364)](https://github.com/rjeczalik/interfaces) - Command line tool for generating interface definitions.
...
*   [mbtileserver (⭐438)](https://github.com/consbio/mbtileserver) - A simple Go-based server for map tiles stored in mbtiles format.
*   [osm (⭐258)](https://github.com/paulmach/osm) - Library for reading, writing and working with OpenStreetMap data and APIs.
...
*   [simplefeatures (⭐72)](https://github.com/peterstace/simplefeatures) - simplesfeatures is a 2D geometry library that provides Go types that model geometries, as well as algorithms that operate on them.
...
*   [ants (⭐9.7k)](https://github.com/panjf2000/ants) - A high-performance and low-cost goroutine pool in Go.
*   [artifex (⭐161)](https://github.com/borderstech/artifex) - Simple in-memory job queue for Golang using worker-based dispatching.
...
*   [concurrency-limiter (⭐11)](https://github.com/vivek-ng/concurrency-limiter) - Concurrency limiter with support for timeouts , dynamic priority and context cancellation of goroutines.
...
*   [go-flow (⭐204)](https://github.com/kamildrazkiewicz/go-flow) - Control goroutines execution order.
...
*   [gollback (⭐103)](https://github.com/vardius/gollback) - asynchronous simple function utilities, for managing execution of closures and callbacks.
*   [gowl (⭐41)](https://github.com/hamed-yousefi/gowl) - Gowl is a process management and process monitoring tool at once. An infinite worker pool gives you the ability to control the pool and processes and monitor their status.
...
*   [pond (⭐692)](https://github.com/alitto/pond) - Minimalistic and High-performance goroutine worker pool written in Go.
...
*   [workerpool (⭐986)](https://github.com/gammazero/workerpool) - Goroutine pool that limits the concurrency of task execution, not the number of tasks queued.
...
*   [gowd (⭐387)](https://github.com/dtylman/gowd) - Rapid and simple desktop UI development with GO, HTML, CSS and NW\.js. Cross platform.
...
*   [zenity (⭐392)](https://github.com/ncruces/zenity) - Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user.
...
*   [goroslib (⭐246)](https://github.com/aler9/goroslib) - Robot Operating System (ROS) library for Go.
*   [joystick (⭐41)](https://github.com/0xcafed00d/joystick) - a polled API to read the state of an attached joystick.
*   [sysinfo (⭐405)](https://github.com/zcalusic/sysinfo) - A pure Go library providing Linux OS / kernel / hardware system information.
...
*   [gltf (⭐188)](https://github.com/qmuntal/gltf) - Efficient and robust glTF 2.0 reader, writer and validator.
...
*   [go-webp (⭐103)](https://github.com/kolesa-team/go-webp) - Library for encode and decode webp pictures, using libwebp.
*   [gocv (⭐5.2k)](https://github.com/hybridgroup/gocv) - Go package for computer vision using OpenCV 3.3+.
*   [goimagehash (⭐561)](https://github.com/corona10/goimagehash) - Go Perceptual image hashing package.
*   [goimghdr (⭐40)](https://github.com/corona10/goimghdr) - The imghdr module determines the type of image contained in a file for Go.
*   [govatar (⭐538)](https://github.com/o1egl/govatar) - Library and CMD tool for generating funny avatars.
*   [govips (⭐815)](https://github.com/davidbyttow/govips) - A lightning fast image processing and resizing library for Go.
...
*   [image2ascii (⭐727)](https://github.com/qeesung/image2ascii) - Convert image to ASCII.
...
*   [mergi (⭐198)](https://github.com/noelyahan/mergi) - Tool & Go library for image manipulation (Merge, Crop, Resize, Watermark, Animate).
...
*   [gronx (⭐241)](https://github.com/adhocore/gronx) - Cron expression parser, task runner and daemon consuming crontab like task list.
*   [JobRunner (⭐949)](https://github.com/bamzi/jobrunner) - Smart and featureful cron job scheduler with job queuing and live monitoring built in.
...
*   [scheduler (⭐409)](https://github.com/carlescere/scheduler) - Cronjobs scheduling made easy.
*   [tasks (⭐132)](https://github.com/madflojo/tasks) - An easy to use in-process scheduler for recurring tasks in Go.
...
*   [ajson (⭐145)](https://github.com/spyzhov/ajson) - Abstract JSON for golang with JSONPath support.
...
*   [jsondiff (⭐216)](https://github.com/wI2L/jsondiff) - JSON diff library for Go based on RFC6902 (JSON Patch).
...
*   [kazaam (⭐249)](https://github.com/Qntfy/kazaam) - API for arbitrary transformation of JSON documents.
...
*   [OjG (⭐550)](https://github.com/ohler55/ojg) - Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath.
...
*   [logur (⭐187)](https://github.com/logur/logur) - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus (⭐22k)](https://github.com/sirupsen/logrus), [go-kit log (⭐24k)](https://github.com/go-kit/kit/tree/master/log), [zap (⭐18k)](https://github.com/uber-go/zap), [zerolog (⭐7.5k)](https://github.com/rs/zerolog), etc).
...
*   [zerolog (⭐7.5k)](https://github.com/rs/zerolog) - Zero-allocation JSON logger.
...
*   [bayesian (⭐745)](https://github.com/jbrukh/bayesian) - Naive Bayesian Classification for Golang.
...
*   [go-deep (⭐407)](https://github.com/patrikeh/go-deep) - A feature-rich neural network library in Go.
...
*   [GoMind (⭐43)](https://github.com/surenderthakran/gomind) - A simplistic Neural Network Library in Go.
...
*   [Goptuna (⭐229)](https://github.com/c-bata/goptuna) - Bayesian optimization framework for black-box functions written in Go. Everything will be optimized.
...
*   [ocrserver (⭐542)](https://github.com/otiai10/ocrserver) - A simple OCR API server, seriously easy to be deployed by Docker and Heroku.
*   [onnx-go (⭐461)](https://github.com/owulveryck/onnx-go) - Go Interface to Open Neural Network Exchange (ONNX).
...
*   [amqp (⭐689)](https://github.com/rabbitmq/amqp091-go) - Go RabbitMQ Client Library.
...
*   [Asynq (⭐5.2k)](https://github.com/hibiken/asynq) - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
*   [Benthos (⭐5.6k)](https://github.com/Jeffail/benthos) - A message streaming bridge between a range of protocols.
*   [Bus (⭐283)](https://github.com/mustafaturan/bus) - Minimalist message bus implementation for internal communication.
*   [Centrifugo (⭐6.7k)](https://github.com/centrifugal/centrifugo) - Real-time messaging (Websockets or SockJS) server in Go.
*   [Chanify (⭐990)](https://github.com/chanify/chanify) - A push notification server send message to your iOS devices.
...
*   [dbus (⭐808)](https://github.com/godbus/dbus) - Native Go bindings for D-Bus.
...
*   [emitter (⭐448)](https://github.com/olebedev/emitter) - Emits events using Go way, with wildcard, predicates, cancellation possibilities and many other good wins.
...
*   [gorush (⭐6.8k)](https://github.com/appleboy/gorush) - Push notification server using [APNs2 (⭐2.7k)](https://github.com/sideshow/apns2) and google [GCM (⭐103)](https://github.com/google/go-gcm).
...
*   [mangos (⭐569)](https://github.com/nanomsg/mangos) - Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability.
...
*   [messagebus (⭐240)](https://github.com/vardius/message-bus) - messagebus is a Go simple async message bus, perfect for using as event bus when doing event sourcing, CQRS, DDD.
...
*   [redisqueue (⭐96)](https://github.com/robinjoseph08/redisqueue) - redisqueue provides a producer and consumer of a queue that uses Redis streams.
...
*   [di (⭐169)](https://github.com/goava/di) - A dependency injection container for go programming language.
*   [dig (⭐2.9k)](https://github.com/uber-go/dig) - A reflection based dependency injection toolkit for Go.
*   [dingo (⭐155)](https://github.com/i-love-flamingo/dingo) - A dependency injection toolkit for Go, based on Guice.
...
*   [google/wire (⭐9.8k)](https://github.com/google/wire) - Automated Initialization in Go.
...
*   [cookiecutter-golang (⭐572)](https://github.com/lacion/cookiecutter-golang) - A Go application boilerplate template for quick starting projects following production best practices.
*   [go-sample (⭐116)](https://github.com/zitryss/go-sample) - A sample layout for Go application projects with the real code.
*   [go-starter (⭐295)](https://github.com/allaboutapps/go-starter) - An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers.
*   [go-todo-backend (⭐193)](https://github.com/Fs02/go-todo-backend) - Go Todo Backend example using modular project layout for product microservice.
...
*   [golang-templates/seed (⭐357)](https://github.com/golang-templates/seed) - Go application GitHub repository template.
...
*   [gobeam/Stringy (⭐153)](https://github.com/gobeam/Stringy) - String manipulation library to convert string to camel case, snake case, kebab case / slugify etc.
*   [strutil (⭐195)](https://github.com/ozgio/strutil) - String utilities.
*   [sttr (⭐636)](https://github.com/abhimanyu003/sttr) - cross-platform, cli app to perform various operations on string.
...
*   [antch (⭐244)](https://github.com/antchfx/antch) - A fast, powerful and extensible web crawling & scraping framework.
...
*   [battery (⭐215)](https://github.com/distatus/battery) - Cross-platform, normalized battery information library.
...
*   [faker (⭐68)](https://github.com/pioz/faker) - Random fake data and struct generator for Go.
*   [ffmt (⭐287)](https://github.com/go-ffmt/ffmt) - Beautify data display for Humans.
...
*   [go-unarr (⭐222)](https://github.com/gen2brain/go-unarr) - Decompression library for RAR, TAR, ZIP and 7z archives.
*   [gofakeit (⭐2.8k)](https://github.com/brianvoe/gofakeit) - Random data generator written in go.
*   [gommit (⭐101)](https://github.com/antham/gommit) - Analyze git commit messages to ensure they follow defined patterns.
*   [gopsutil (⭐8.6k)](https://github.com/shirou/gopsutil) - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
*   [shortid (⭐834)](https://github.com/teris-io/shortid) - Distributed generation of super short, unique, non-sequential, URL friendly IDs.
*   [shoutrrr (⭐542)](https://github.com/containrrr/shoutrrr) - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
*   [sitemap-format (⭐2)](https://github.com/mingard/sitemap-format) - A simple sitemap generator, with a little syntactic sugar.
*   [stateless (⭐528)](https://github.com/qmuntal/stateless) - A fluent library for creating state machines.
...
*   [govader (⭐29)](https://github.com/jonreiter/govader) - Go implementation of [VADER Sentiment Analysis (⭐3.8k)](https://github.com/cjhutto/vaderSentiment).
...
*   [kagome (⭐704)](https://github.com/ikawaha/kagome) - JP morphological analyzer written in pure Go.
...
*   [nlp (⭐387)](https://github.com/james-bowman/nlp) - Go Natural Language Processing library supporting LSA (Latent Semantic Analysis).
...
*   [cidranger (⭐780)](https://github.com/yl2chen/cidranger) - Fast IP to CIDR lookup for Go.
...
*   [easytcp (⭐552)](https://github.com/DarthPestilane/easytcp) - A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful.
...
*   [ftpserverlib (⭐341)](https://github.com/fclairamb/ftpserverlib) - Fully featured FTP server library.
...
*   [gmqtt (⭐820)](https://github.com/DrmagicE/gmqtt) - Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1.
...
*   [go-stun (⭐548)](https://github.com/ccding/go-stun) - Go implementation of the STUN client (RFC 3489 and RFC 5389).
...
*   [gosnmp (⭐929)](https://github.com/soniah/gosnmp) - Native Go library for performing SNMP actions.
...
*   [iplib (⭐99)](https://github.com/c-robinson/iplib) - Library for working with IP addresses (net.IP, net.IPNet), inspired by python [ipaddress](https://docs.python.org/3/library/ipaddress.html) and ruby [ipaddr](https://ruby-doc.org/stdlib-2.5.1/libdoc/ipaddr/rdoc/IPAddr.html)
...
*   [mdns (⭐935)](https://github.com/hashicorp/mdns) - Simple mDNS (Multicast DNS) client/server library in Golang.
...
*   [peerdiscovery (⭐578)](https://github.com/schollz/peerdiscovery) - Pure Go library for cross-platform local peer discovery using UDP multicast.
...
*   [quic-go (⭐7.7k)](https://github.com/lucas-clemente/quic-go) - An implementation of the QUIC protocol in pure Go.
...
*   [winrm (⭐390)](https://github.com/masterzen/winrm) - Go WinRM client to remotely execute commands on Windows machines.
...
*   [gentleman (⭐989)](https://github.com/h2non/gentleman) - Full-featured plugin-driven HTTP client library.
...
*   [pester (⭐614)](https://github.com/sethgrid/pester) - Go HTTP client calls with retries, backoff, and concurrency.
...
*   [requests (⭐491)](https://github.com/carlmjohnson/requests) - HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools.
*   [resty (⭐7.2k)](https://github.com/go-resty/resty) - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
*   [gl (⭐948)](https://github.com/go-gl/gl) - Go bindings for OpenGL (generated via glow).
...
*   [mathgl (⭐470)](https://github.com/go-gl/mathgl) - Pure Go math package specialized for 3D math, with inspiration from GLM.
...
*   [go-sqlbuilder (⭐911)](https://github.com/huandu/go-sqlbuilder) - A flexible and powerful SQL string builder library plus a zero-config ORM.
...
*   [rel (⭐615)](https://github.com/go-rel/rel) - Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API.
...
*   [jsonpath (⭐14)](https://github.com/AsaiYusuke/jsonpath) - A query library for retrieving part of JSON based on JSONPath syntax.
*   [jsonql (⭐261)](https://github.com/elgs/jsonql) - JSON query expression library in Golang.
*   [jsonslice (⭐74)](https://github.com/bhmj/jsonslice) - Jsonpath queries with advanced filters.
*   [rql (⭐276)](https://github.com/a8m/rql) - Resource Query Language for REST API.
*   [rqp (⭐51)](https://github.com/timsolov/rest-query-parser) - Query Parser for REST API. Filtering, validations, both `AND`, `OR` operations are supported directly in the query.
...
*   [fileb0x (⭐623)](https://github.com/UnnoTed/fileb0x) - Simple tool to embed files in go with focus on "customization" and ease to use.
...
*   [go-dsp (⭐803)](https://github.com/mjibson/go-dsp) - Digital Signal Processing for Go.
...
*   [graph (⭐617)](https://github.com/yourbasic/graph) - Library of basic graph algorithms.
...
*   [orb (⭐612)](https://github.com/paulmach/orb) - 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support.
...
*   [TextRank (⭐170)](https://github.com/DavidBelicza/TextRank) - TextRank implementation in Golang with extendable features (summarization, weighting, phrase extraction) and multithreading (goroutine) support.
...
*   [dongle (⭐587)](https://github.com/golang-module/dongle) - A simple, semantic and developer-friendly golang package for encoding\&decoding and encryption\&decryption.
...
*   [go-password-validator (⭐373)](https://github.com/lane-c-wagner/go-password-validator) - Password validator based on raw cryptographic entropy values.
*   [go-yara (⭐283)](https://github.com/hillu/go-yara) - Go Bindings for [YARA (⭐129)](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)".
...
*   [passlib (⭐279)](https://github.com/hlandau/passlib) - Futureproof password hashing library.
...
*   [secureio (⭐27)](https://github.com/xaionaro-go/secureio) - An keyexchanging+authenticating+encrypting wrapper and multiplexer for `io.ReadWriteCloser` based on XChaCha20-poly1305, ECDH and ED25519.
...
*   [ssh-vault (⭐366)](https://github.com/ssh-vault/ssh-vault) - encrypt/decrypt using ssh keys.
...
*   [cbor (⭐518)](https://github.com/fxamacker/cbor) - Small, safe, and easy CBOR encoding and decoding library.
...
*   [Euterpe (⭐456)](https://github.com/ironsmile/euterpe) - Self-hosted music streaming server with built-in web UI and REST API.
...
*   [go-feature-flag (⭐571)](https://github.com/thomaspoignant/go-feature-flag) - A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it.
*   [go-proxy-cache (⭐83)](https://github.com/fabiocicerchia/go-proxy-cache) - Simple Reverse Proxy with Caching, written in Go, using Redis.
...
*   [SFTPGo (⭐5.4k)](https://github.com/drakkan/sftpgo) - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
*   [stream (⭐71)](https://github.com/youthlin/stream) - Go Stream, like Java 8 Stream: Filter/Map/FlatMap/Peek/Sorted/ForEach/Reduce...
...
*   [ego (⭐543)](https://github.com/benbjohnson/ego) - Lightweight templating language that lets you write templates in Go. Templates are translated into Go and compiled.
...
*   [fasttemplate (⭐677)](https://github.com/valyala/fasttemplate) - Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](https://golang.org/pkg/text/template/).
...
*   [goview (⭐320)](https://github.com/foolin/goview) - Goview is a lightweight, minimalist and idiomatic template library based on golang html/template for building Go web application.
*   [jet (⭐988)](https://github.com/CloudyKit/jet) - Jet template engine.
*   [liquid (⭐188)](https://github.com/osteele/liquid) - Go implementation of Shopify Liquid templates.
*   [maroto (⭐899)](https://github.com/johnfercher/maroto) - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
*   Testing Frameworks
    ...
    *   [baloo (⭐749)](https://github.com/h2non/baloo) - Expressive and versatile end-to-end HTTP API testing made easy.
    *   [be (⭐53)](https://github.com/carlmjohnson/be) - The minimalist generic test assertion library.
    ...
    *   [commander (⭐210)](https://github.com/SimonBaeumer/commander) - Tool for testing cli applications on windows, linux and osx.
    *   [covergates (⭐55)](https://github.com/covergates/covergates) - Self-hosted code coverage report review and management service.
    *   [cupaloy (⭐246)](https://github.com/bradleyjkemp/cupaloy) - Simple snapshot testing addon for your test framework.
    *   [dbcleaner (⭐147)](https://github.com/khaiql/dbcleaner) - Clean database for testing purpose, inspired by `database_cleaner` in Ruby.
    ...
    *   [embedded-postgres (⭐501)](https://github.com/fergusstrange/embedded-postgres) - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
    *   [endly (⭐233)](https://github.com/viant/endly) - Declarative end to end functional testing.
    ...
    *   [go-hit (⭐164)](https://github.com/Eun/go-hit) - Hit is an http integration test framework written in golang.
    ...
    *   [go-snaps (⭐42)](http://github.com/gkampitakis/go-snaps) - Jest-like snapshot testing in Golang.
    *   [go-testdeep (⭐338)](https://github.com/maxatome/go-testdeep) - Extremely flexible golang deep comparison, extends the go testing package.
    ...
    *   [goblin (⭐872)](https://github.com/franela/goblin) - Mocha like testing framework fo Go.
    *   [goc (⭐614)](https://github.com/qiniu/goc) - Goc is a comprehensive coverage testing system for The Go Programming Language.
    ...
    *   [gotest.tools (⭐383)](https://github.com/gotestyourself/gotest.tools) - A collection of packages to augment the go testing package and support common patterns.
    ...
    *   [jsonassert (⭐102)](https://github.com/kinbiko/jsonassert) - Package for verifying that your JSON payloads are serialized correctly.
    ...
    *   [testfixtures (⭐895)](https://github.com/go-testfixtures/testfixtures) - A helper for Rails' like test fixtures to test database applications.
...
*   Mock
    ...
    *   [counterfeiter (⭐773)](https://github.com/maxbrunsfeld/counterfeiter) - Tool for generating self-contained mock objects.
    ...
    *   [go-txdb (⭐502)](https://github.com/DATA-DOG/go-txdb) - Single transaction based database driver mainly for testing purposes.
    *   [gock (⭐1.8k)](https://github.com/h2non/gock) - Versatile HTTP mocking made easy.
    *   [gomock (⭐8.4k)](https://github.com/golang/mock) - Mocking framework for the Go programming language.
...
*   Selenium and browser control tools.
    ...
    *   [cdp (⭐656)](https://github.com/mafredri/cdp) - Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it.
...
*   Fail injection
    *   [failpoint (⭐762)](https://github.com/pingcap/failpoint) - An implementation of [failpoints](https://www.freebsd.org/cgi/man.cgi?query=fail) for Golang.
...
*   [airtable (⭐47)](https://github.com/mehanizm/airtable) - Go client library for the [Airtable API](https://airtable.com/api).
...
*   [coinpaprika-go (⭐18)](https://github.com/coinpaprika/coinpaprika-api-go-client) - Go client library for interacting with Coinpaprika's API.
...
*   [ethrpc (⭐247)](https://github.com/onrik/ethrpc) - Go bindings for Ethereum JSON RPC API.
...
*   [go-lark (⭐126)](https://github.com/go-lark/lark) - An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform.
...
*   [google-play-scraper (⭐53)](https://github.com/n0madic/google-play-scraper) - Get data from Google Play Store.
...
*   [gosip (⭐93)](https://github.com/koltyakov/gosip) - Go client library SharePoint API.
...
*   [lark (⭐278)](https://github.com/chyroc/lark) - [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback.
...
*   [patreon-go (⭐34)](https://github.com/mxpv/patreon-go) - Go library for Patreon API.
*   [paypal (⭐557)](https://github.com/logpacker/PayPal-Go-SDK) - Wrapper for PayPal payment API.
...
*   [twitter-scraper (⭐312)](https://github.com/n0madic/twitter-scraper) - Scrape the Twitter Frontend API without authentication and limits.
*   [uptimerobot (⭐54)](https://github.com/bitfield/uptimerobot) - Go wrapper and command-line client for the Uptime Robot v2 API.
*   [vl-go (⭐2)](https://github.com/verifid/vl-go) - Go client library around the VerifID identity verification layer API.
*   [webhooks (⭐797)](https://github.com/go-playground/webhooks) - Webhook receiver for GitHub and Bitbucket.
*   [wit-go (⭐136)](https://github.com/wit-ai/wit-go) - Go client for wit.ai HTTP API.
...
*   [changie (⭐410)](https://github.com/miniscruff/changie) - Automated changelog tool for preparing releases with lots of customization options.
...
*   [circuit (⭐682)](https://github.com/cep21/circuit) - An efficient and feature complete Hystrix like Go implementation of the circuit breaker pattern.
*   [circuitbreaker (⭐1k)](https://github.com/rubyist/circuitbreaker) - Circuit Breakers in Go.
*   [clipboard (⭐326)](https://github.com/golang-design/clipboard) - 📋 cross-platform clipboard package in Go.
*   [clockwork (⭐429)](https://github.com/jonboulle/clockwork) - A simple fake clock for golang.
...
*   [delve (⭐554)](https://github.com/derekparker/delve) - Go debugger.
...
*   [ghokin (⭐31)](https://github.com/antham/ghokin) - Parallelized formatter with no external dependencies for gherkin (cucumber, behat...).
...
*   [go-bsdiff (⭐138)](https://github.com/gabstv/go-bsdiff) - Pure Go bsdiff and bspatch libraries and CLI tools.
...
*   [go-sitemap-generator (⭐191)](https://github.com/ikeikeikeike/go-sitemap-generator) - XML Sitemap generator written in Go.
...
*   [gotenv (⭐245)](https://github.com/subosito/gotenv) - Load environment variables from `.env` or any `io.Reader` in Go.
*   [goval (⭐102)](https://github.com/maja42/goval) - Evaluate arbitrary expressions in Go.
*   [gpath (⭐42)](https://github.com/tenntenn/gpath) - Library to simplify access struct fields with Go's expression in reflection.
...
*   [grofer (⭐249)](https://github.com/pesos/grofer) - A system and resource monitoring tool written in Golang!
*   [gubrak (⭐424)](https://github.com/novalagung/gubrak) - Golang utility library with syntactic sugar. It's like lodash, but for golang.
*   [handy (⭐73)](https://github.com/miguelpragier/handy) - Many utilities and helpers like string handlers/formatters and validators.
*   [hostctl (⭐839)](https://github.com/guumaster/hostctl) - A CLI tool to manage /etc/hosts with easy commands.
...
*   [mani (⭐334)](https://github.com/alajmo/mani) - CLI tool to help you manage multiple repositories.
...
*   [mimemagic (⭐84)](https://github.com/zRedShift/mimemagic) - Pure Go ultra performant MIME sniffing library/utility.
*   [mimesniffer (⭐27)](https://github.com/aofei/mimesniffer) - A MIME type sniffer for Go.
*   [mimetype (⭐899)](https://github.com/gabriel-vasile/mimetype) - Package for MIME type detection based on magic numbers.
...
*   [nostromo (⭐128)](https://github.com/pokanop/nostromo) - CLI for building powerful aliases.
...
*   [pgo (⭐75)](https://github.com/arthurkushman/pgo) - Convenient functions for PHP community.
...
*   [rospo (⭐190)](https://github.com/ferama/rospo) - Simple and reliable ssh tunnels with embedded ssh server in Golang.
*   [scan (⭐332)](https://github.com/blockloop/scan) - Scan golang `sql.Rows` directly to structs, slices, or primitive types.
*   [scan (⭐45)](https://github.com/wroge/scan) - Scan sql rows into any type powered by generics.
*   [scany (⭐823)](https://github.com/georgysavva/scany) - Library for scanning data from a database into Go structs and more.
...
*   [util (⭐268)](https://github.com/shomali11/util) - Collection of useful utility functions. (strings, concurrency, manipulations, ...).
...
*   [wuid (⭐482)](https://github.com/edwingeng/wuid) - An extremely fast unique number generator, 10-135 times faster than UUID.
...
*   [validate (⭐829)](https://github.com/gookit/validate) - Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features.
...
*   [froggit-go (⭐28)](https://github.com/jfrog/froggit-go) - Froggit-Go is a Go library, allowing to perform actions on VCS providers.
...
*   [githooks (⭐59)](https://github.com/gabyx/githooks) - Per-repo and shared Git hooks with version control and auto update.
...
*   [gmf (⭐816)](https://github.com/3d0c/gmf) - Go bindings for FFmpeg av\* libraries.
*   [go-astisub (⭐433)](https://github.com/asticode/go-astisub) - Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.).
*   [go-astits (⭐458)](https://github.com/asticode/go-astits) - Parse and demux MPEG Transport Streams (.ts) natively in GO.
...
*   [gortsplib (⭐340)](https://github.com/aler9/gortsplib) - Pure Go RTSP server and client library.
...
*   [libvlc-go (⭐329)](https://github.com/adrg/libvlc-go) - Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player).
*   [m3u8 (⭐988)](https://github.com/grafov/m3u8) - Parser and generator library of M3U8 playlists for Apple HLS.
...
*   [Aero (⭐511)](https://github.com/aerogo/aero) - High-performance web framework for Go, reaches top scores in Lighthouse.
...
*   [Flamingo (⭐343)](https://github.com/i-love-flamingo/flamingo) - Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc.
*   [Flamingo Commerce (⭐390)](https://github.com/i-love-flamingo/flamingo-commerce) - Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications.
*   [Gearbox (⭐700)](https://github.com/abahmed/gearbox) - A web framework written in Go with a focus on high performance and memory optimization.
...
*   [Ginrpc (⭐248)](https://github.com/xxjwxc/ginrpc) - Gin parameter automatic binding tool,gin rpc tools.
...
*   [gongular (⭐477)](https://github.com/mustafaakin/gongular) - Fast Go web framework with input mapping/validation and (DI) Dependency Injection.
...
*   [rk-boot (⭐353)](https://github.com/rookie-ninja/rk-boot) - A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily.
*   [rux (⭐87)](https://github.com/gookit/rux) - Simple and fast web framework for build golang HTTP applications.
...
*   [uAdmin (⭐224)](https://github.com/uadmin/uadmin) - Fully featured web framework for Golang, inspired by Django.
...
*   [go-server-timing (⭐845)](https://github.com/mitchellh/go-server-timing) - Add/parse Server-Timing header.
...
*   [alien (⭐124)](https://github.com/gernest/alien) - Lightweight and fast http router from outer space.
...
*   [Goji (⭐928)](https://github.com/goji/goji) - Goji is a minimalistic and flexible HTTP request multiplexer with support for `net/context`.
...
*   [GoRouter (⭐144)](https://github.com/vardius/gorouter) - GoRouter is a Server/API micro framework, HTTP request router, multiplexer, mux that provides request router with middleware supporting `net/context`.
...
*   [httptreemux (⭐578)](https://github.com/dimfeld/httptreemux) - High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter.
...
*   [go-canvas (⭐194)](https://github.com/markfarnan/go-canvas) - Library to use HTML5 Canvas, with all drawing within go code.
...
*   [d3d9 (⭐135)](https://github.com/gonutz/d3d9) - Go bindings for Direct3D9.
*   [go-ole (⭐934)](https://github.com/go-ole/go-ole) - Win32 OLE implementation for golang.
...
*   [xpath (⭐532)](https://github.com/antchfx/xpath) - XPath package for Go.
*   [xquery (⭐155)](https://github.com/antchfx/xquery) - XQuery lets you extract data from HTML/XML documents using XPath expression.
*   [zek (⭐622)](https://github.com/miku/zek) - Generate a Go struct from XML.
...
*   [in-toto (⭐74)](https://github.com/in-toto/in-toto-golang) - Go implementation of the in-toto (provides a framework to protect the integrity of the software supply chain) python reference implementation.
*   [Spiffe-Vault (⭐50)](https://github.com/philips-labs/spiffe-vault) - Utilizes Spiffe JWT authentication with Hashicorp Vault for secretless authentication.
...
*   [go-cleanarch (⭐680)](https://github.com/roblaszczak/go-cleanarch) - go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects.
...
*   [go-mod-outdated (⭐607)](https://github.com/psampaz/go-mod-outdated) - An easy way to find outdated dependencies of your Go projects.
*   [go-outdated (⭐44)](https://github.com/firstrow/go-outdated) - Console application that displays outdated packages.
*   [goast-viewer (⭐678)](https://github.com/yuroyoro/goast-viewer) - Web based Golang AST visualizer.
*   [goimports](https://godoc.org/golang.org/x/tools/cmd/goimports) - Tool to fix (add, remove) your Go imports automatically.
*   [golang-ifood-sdk (⭐10)](https://github.com/arxdsilva/golang-ifood-sdk) - iFood API SDK.
*   [golines (⭐533)](https://github.com/segmentio/golines) - Formatter that automatically shortens long lines in Go code.
...
*   [php-parser (⭐900)](https://github.com/z7zmey/php-parser) - A Parser for PHP written in Go.
...
*   [tickgit (⭐292)](https://github.com/augmentable-dev/tickgit) - CLI and go package for surfacing code comment TODOs (in any language) and applying a `git blame`to identify the author.
...
*   [coc-go language server extension for Vim/Neovim (⭐513)](https://github.com/josa42/coc-go) - This plugin adds [gopls (⭐6.6k)](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim.
...
*   [goimports-reviser (⭐246)](https://github.com/incu6us/goimports-reviser) - Formatting tool for imports.
...
*   [gounit (⭐67)](https://github.com/hexdigest/gounit) - Generate Go tests using your own templates.
...
*   [xgen (⭐212)](https://github.com/xuri/xgen) - XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.
...
*   [depth (⭐811)](https://github.com/KyleBanks/depth) - Visualize dependency trees of any package by analyzing imports.
...
*   [richgo (⭐756)](https://github.com/kyoh86/richgo) - Enrich `go test` outputs with text decorations.
*   [roumon (⭐132)](https://github.com/becheran/roumon) - Monitor current state of all active goroutines via a command line interface.
...
*   [aurora (⭐571)](https://github.com/xuri/aurora) - Cross-platform web-based Beanstalkd queue server console.
...
*   [Blast (⭐208)](https://github.com/dave/blast) - A simple tool for API load testing and batch jobs.
...
*   [cassowary (⭐649)](https://github.com/rogerwelin/cassowary) - Modern cross-platform HTTP load-testing tool written in Go.
...
*   [Dockerfile-Generator (⭐138)](https://github.com/ozankasikci/dockerfile-generator) - A go library and an executable that produces valid Dockerfiles using various input channels.
...
*   [easyssh-proxy (⭐271)](https://github.com/appleboy/easyssh-proxy) - Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`.
...
*   [jcli (⭐346)](https://github.com/jenkins-zh/jenkins-cli) - Jenkins CLI allows you manage your Jenkins as an easy way.
*   [kala (⭐1.9k)](https://github.com/ajvb/kala) - Simplistic, modern, and performant job scheduler.
*   [kcli (⭐189)](https://github.com/cswank/kcli) - Command line tool for inspecting kafka topics/partitions/messages.
*   [ko (⭐5.5k)](https://github.com/google/ko) - Command line tool for building and deploying Go applications on Kubernetes
*   [kool (⭐618)](https://github.com/kool-dev/kool) - Command line tool for managing Docker environments as an easy way.
*   [kubernetes (⭐95k)](https://github.com/kubernetes/kubernetes) - Container Cluster Manager from Google.
*   [kwatch (⭐711)](https://github.com/abahmed/kwatch) - Monitor & detect crashes in your Kubernetes(K8s) cluster instantly.
*   [lstags (⭐303)](https://github.com/ivanilves/lstags) - Tool and API to sync Docker images across different registries.
...
*   [Mizu (⭐8.1k)](https://github.com/up9inc/mizu) - API traffic viewer for Kubernetes enabling you to view all API communication between microservices, multiprotocol support: HTTP1.1, HTTP/2, AMQP, Kafka, Redis.
...
*   [Mora (⭐306)](https://github.com/emicklei/mora) - REST server for accessing MongoDB documents and meta data.
...
*   [Pewpew (⭐367)](https://github.com/bengadbois/pewpew) - Flexible HTTP command line stress tester.
...
*   [s3-proxy (⭐154)](https://github.com/oxyno-zeta/s3-proxy) - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
*   [Scaleway-cli (⭐798)](https://github.com/scaleway/scaleway-cli) - Manage BareMetal Servers from Command Line (as easily as with Docker).
*   [script (⭐3.7k)](https://github.com/bitfield/script) - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
*   [skm (⭐836)](https://github.com/TimothyYe/skm) - SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily!
...
*   [uTask (⭐806)](https://github.com/ovh/utask) - Automation engine that models and executes business processes declared in yaml.
...
*   [crawley (⭐117)](https://github.com/s0rg/crawley) - Web scraper/crawler for cli.
...
*   [gocc (⭐550)](https://github.com/goccmack/gocc) - Gocc is a compiler kit for Go written in Go.
...
*   [ipe (⭐362)](https://github.com/dimiro1/ipe) - Open source Pusher server implementation compatible with Pusher client libraries written in GO.
...
*   [mockingjay (⭐530)](https://github.com/quii/mockingjay-server) - Fake HTTP servers and consumer driven contracts from one configuration file. You can also make the server randomly misbehave to help do more realistic performance tests.
...
*   [Neo-cowsay (⭐238)](https://github.com/Code-Hex/Neo-cowsay) - 🐮 cowsay is reborn. for a New Era.
...
*   [peg (⭐888)](https://github.com/pointlander/peg) - Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator.
...
*   [sake (⭐586)](https://github.com/alajmo/sake) - sake is a command runner for local and remote hosts.
...
*   [vFlow (⭐950)](https://github.com/VerizonDigital/vflow) - High-performance, scalable and reliable IPFIX, sFlow and Netflow collector.
...
*   [woke (⭐363)](https://github.com/get-woke/woke) - Detect non-inclusive language in your source code.
...
*   [speedtest-resize (⭐229)](https://github.com/fawick/speedtest-resize) - Compare various Image resize algorithms for the Go language.
...
*   [gopher-stickers (⭐547)](https://github.com/tenntenn/gopher-stickers)
*   [gophericons (⭐609)](https://github.com/shalakhin/gophericons)
*   [gopherize.me (⭐620)](https://github.com/matryer/gopherize.me) - Gopherize yourself.
...
*   [gophers (⭐112)](https://github.com/sillecelik/go-gopher) - Gopher amigurumi toy pattern.
...
*   [go-clean-template (⭐4.4k)](https://github.com/evrone/go-clean-template) - Clean Architecture template for Golang services.
*   [go-patterns (⭐21k)](https://github.com/tmrts/go-patterns) - Curated list of Go design patterns, recipes and idioms.
*   [goapp (⭐570)](https://github.com/bnkamalesh/goapp) - An opinionated guideline to structure & develop a Go web application/service.
*   [Golang for Node.js Developers (⭐3.5k)](https://github.com/miguelmota/golang-for-nodejs-developers) - Examples of Golang compared to Node.js for learning.
