...
[🏠 Home](/README.md) · [🔥 Feed](https://www.trackawesomelist.com/avelino/awesome-go/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 avelino/awesome-go](https://github.com/avelino/awesome-go) · ⭐ 130K · 🏷️ Programming Languages
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python (⭐220k)](https://github.com/vinta/awesome-python).
...
*   [Goakt (⭐170)](https://github.com/Tochemey/goakt) - Fast and Distributed Actor framework using protocol buffers as message for Golang.
...
*   [langchaingo (⭐4.4k)](https://github.com/tmc/langchaingo) - LangChainGo is a framework for developing applications powered by language models.
*   [LocalAI (⭐24k)](https://github.com/mudler/LocalAI) - Open Source OpenAI alternative, self-host AI models.
*   [Ollama (⭐92k)](https://github.com/jmorganca/ollama) - Run large language models locally.
*   [OllamaFarm (⭐25)](https://github.com/presbrey/ollamafarm) - Manage, load-balance, and failover packs of Ollamas
...
*   [GoAudio (⭐345)](https://github.com/DylanMeeus/GoAudio) - Native Go Audio Processing Library.
*   [gosamplerate (⭐34)](https://github.com/dh1tw/gosamplerate) - libsamplerate bindings for go.
*   [id3v2 (⭐334)](https://github.com/bogem/id3v2) - ID3 decoding and encoding library for Go.
*   [malgo (⭐293)](https://github.com/gen2brain/malgo) - Mini audio library.
...
*   [PortAudio (⭐698)](https://github.com/gordonklaus/portaudio) - Go bindings for the PortAudio audio I/O library.
...
*   [go-guardian (⭐549)](https://github.com/shaj13/go-guardian) - Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token, and Certificate based authentication.
*   [go-jose (⭐318)](https://github.com/go-jose/go-jose) - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
...
*   [gosession (⭐253)](http://github.com/Kwynto/gosession) - This is quick session for net/http in GoLang. This package is perhaps the best implementation of the session mechanism, or at least it tries to become one.
...
*   [jwt-go (⭐7k)](https://github.com/golang-jwt/jwt) - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
*   [otpgen (⭐136)](https://github.com/grijul/otpgen) - Library to generate TOTP/HOTP codes.
...
*   [paseto (⭐851)](https://github.com/o1egl/paseto) - Golang implementation of Platform-Agnostic Security Tokens (PASETO).
...
*   [securecookie (⭐79)](https://github.com/chmike/securecookie) - Efficient secure cookie encoding/decoding.
...
*   [cometbft (⭐625)](https://github.com/cometbft/cometbft) - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
*   [cosmos-sdk (⭐6.2k)](https://github.com/cosmos/cosmos-sdk) - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
*   [gno (⭐880)](https://github.com/gnolang/gno) - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
...
*   [solana-go (⭐822)](https://github.com/gagliardetto/solana-go) - Go library to interface with Solana JSON RPC and WebSocket interfaces.
...
*   [bot (⭐670)](https://github.com/go-telegram/bot) - Zero-dependencies Telegram Bot library with additional UI components
*   [echotron (⭐362)](https://github.com/NicoNex/echotron) - An elegant and concurrent library for Telegram Bots in Go.
...
*   [go-tg (⭐95)](https://github.com/mr-linch/go-tg) - Generated from official docs Go client library for accessing Telegram Bot API, with batteries for building complex bots included.
...
*   [go-twitch-irc (⭐355)](https://github.com/gempir/go-twitch-irc) - Library to write bots for twitch.tv chat
...
*   [slack-bot (⭐179)](https://github.com/innogames/slack-bot) - Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github...
...
*   [telego (⭐520)](https://github.com/mymmrac/telego) - Telegram Bot API library for Golang with full one-to-one API implementation.
...
*   [goyek (⭐558)](https://github.com/goyek/goyek) - Create build pipelines in Go.
...
*   [taskctl (⭐292)](https://github.com/taskctl/taskctl) - Concurrent task runner.
...
*   [box-cli-maker (⭐531)](https://github.com/Delta456/box-cli-maker) - Make Highly Customized Boxes for your CLI.
*   [bubble-table (⭐442)](https://github.com/Evertras/bubble-table) - An interactive table component for bubbletea.
*   [bubbles (⭐5.4k)](https://github.com/charmbracelet/bubbles) - TUI components for bubbletea.
...
*   [cfmt (⭐67)](https://github.com/i582/cfmt) - Simple and convenient formatted stylized output fully compatible with fmt library.
*   [chalk (⭐448)](https://github.com/ttacon/chalk) - Intuitive package for prettifying terminal/console output.
...
*   [go-colorable (⭐761)](https://github.com/mattn/go-colorable) - Colorable writer for windows.
*   [go-colortext (⭐215)](https://github.com/daviddengcn/go-colortext) - Go library for color output in terminals.
*   [go-isatty (⭐826)](https://github.com/mattn/go-isatty) - isatty for golang.
...
*   [yacspin (⭐438)](https://github.com/theckman/yacspin) - Yet Another CLi Spinner package, for working with terminal spinners.
...
*   [argparse (⭐604)](https://github.com/akamensky/argparse) - Command line argument parser inspired by Python's argparse module.
...
*   [flaggy (⭐856)](https://github.com/integrii/flaggy) - A robust and idiomatic flags package with excellent subcommand support.
...
*   [go-getoptions (⭐55)](https://github.com/DavidGamba/go-getoptions) - Go option parser inspired by the flexibility of Perl’s GetOpt::Long.
...
*   [readline (⭐87)](https://github.com/reeflective/readline) Shell library with modern and easy to use UI features.
...
*   [aconfig (⭐539)](https://github.com/cristalhq/aconfig) - Simple, useful and opinionated config loader.
...
*   [confita (⭐494)](https://github.com/heetch/confita) - Load configuration in cascade from multiple backends into a struct.
...
*   [env (⭐4.8k)](https://github.com/caarlos0/env) - Parse environment variables to Go structs (with defaults).
*   [env (⭐62)](https://github.com/junk1tm/env) - A lightweight package for loading environment variables into structs.
...
*   [fig (⭐371)](https://github.com/kkyr/fig) - Tiny library for reading configuration from a file and from environment variables (with validation & defaults).
...
*   [go-aws-ssm (⭐58)](https://github.com/PaddleHQ/go-aws-ssm) - Go package that fetches parameters from AWS System Manager - Parameter Store.
...
*   [godotenv (⭐8.2k)](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
*   [gofigure (⭐68)](https://github.com/ian-kent/gofigure) - Go application configuration made easy.
*   [GoLobby/Config (⭐362)](https://github.com/golobby/config) - GoLobby Config is a lightweight yet powerful configuration manager for the Go programming language.
...
*   [hjson (⭐330)](https://github.com/hjson/hjson-go) - Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments.
...
*   [konf (⭐226)](https://github.com/nil-go/konf) - The simplest API for reading/watching config from file, env, flag and clouds (e.g. AWS, Azure, GCP).
...
*   [xdg (⭐681)](https://github.com/adrg/xdg) - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/latest/) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
...
*   [go-beautiful-html-coverage (⭐11)](https://github.com/gha-common/go-beautiful-html-coverage) - A GitHub Action to track code coverage in your pull requests, with a beautiful HTML preview, for free.
...
*   [go-test-coverage (⭐83)](https://github.com/vladopajic/go-test-coverage) - Tool and GitHub action which reports issues when test coverage is below set threshold.
*   [gomason (⭐65)](https://github.com/nikogura/gomason) - Test, Build, Sign, and Publish your go binaries from a clean workspace.
*   [gotestfmt (⭐506)](https://github.com/GoTestTools/gotestfmt) - go test output for humans.
...
*   [omniparser (⭐931)](https://github.com/jf-tech/omniparser) - A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema.
...
*   [bitmap (⭐303)](https://github.com/kelindar/bitmap) - Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go.
...
*   [cuckoo-filter (⭐294)](https://github.com/linvon/cuckoo-filter) - Cuckoo filter: a comprehensive cuckoo filter, which is configurable and space optimized compared with other implements, and all features mentioned in original paper are available.
...
*   [quadtree (⭐36)](https://github.com/s0rg/quadtree) - Generic, zero-alloc, 100%-test covered quadtree.
...
*   [deque (⭐179)](https://github.com/edwingeng/deque) - A highly optimized double-ended queue.
*   [deque (⭐568)](https://github.com/gammazero/deque) - Fast ring-buffer deque (double-ended queue).
*   [goconcurrentqueue (⭐388)](https://github.com/enriquebris/goconcurrentqueue) - Concurrent FIFO queue.
*   [hatchet (⭐4.1k)](https://github.com/hatchet-dev/hatchet) - Distributed, Fault-tolerant task queue.
*   [memlog (⭐117)](https://github.com/embano1/memlog) - An easy to use, lightweight, thread-safe and append-only in-memory data structure inspired by Apache Kafka.
*   [queue (⭐266)](https://github.com/adrianbrad/queue) - Multiple thread-safe, generic queue implementations for Go.
...
*   [go-adaptive-radix-tree (⭐358)](https://github.com/plar/go-adaptive-radix-tree) - Go implementation of Adaptive Radix Tree.
*   [go-edlib (⭐475)](https://github.com/hbollon/go-edlib) - Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode.
...
*   [levenshtein (⭐349)](https://github.com/agnivade/levenshtein) - Implementation to calculate levenshtein distance in Go.
...
*   [trie (⭐755)](https://github.com/derekparker/trie) - Trie implementation in Go.
...
*   [cachego (⭐368)](https://github.com/faabiosr/cachego) - Golang Cache component for multiple drivers.
...
*   [EchoVault (⭐385)](https://github.com/EchoVault/EchoVault) - Embeddable Distributed in-memory data store compatible with Redis clients.
...
*   [go-freelru (⭐145)](https://github.com/elastic/go-freelru) A GC-less, fast and generic LRU hashmap library with optional locking, sharding, eviction and expiration.
...
*   [gocache (⭐8)](https://github.com/yuseferi/gocache) - A data race free Go ache library with high performance and auto pruge functionality
...
*   [sturdyc (⭐278)](https://github.com/creativecreature/sturdyc) - A caching library with advanced concurrency features designed to make I/O heavy applications robust and highly performant.
*   [theine (⭐254)](https://github.com/Yiling-J/theine-go) - High performance, near optimal in-memory cache with proactive TTL expiration and generics.
*   [timedmap (⭐71)](https://github.com/zekroTJA/timedmap) - Map with expiring key-value pairs.
*   [ttlcache (⭐929)](https://github.com/jellydator/ttlcache) - An in-memory cache with item expiration and generics.
...
*   [clover (⭐675)](https://github.com/ostafen/clover) - A lightweight document-oriented NoSQL database written in pure Golang.
...
*   [moss (⭐953)](https://github.com/couchbase/moss) - Moss is a simple LSM key-value storage engine written in 100% Go.
...
*   [goavro (⭐974)](https://github.com/linkedin/goavro) - A Go package that encodes and decodes Avro data.
...
*   [goose (⭐6.7k)](https://github.com/pressly/goose) - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
*   [schema (⭐32)](https://github.com/adlio/schema) - Library to embed schema migrations for database/sql-compatible databases inside your Go binaries.
...
*   [sqlize (⭐96)](https://github.com/sunary/sqlize) - Database migration generator. Allows generate sql migration from model and existing sql by differ them.
...
*   [dbbench (⭐100)](https://github.com/sj14/dbbench) - Database benchmarking tool with support for several databases and scripts.
...
*   [gorm-multitenancy (⭐39)](https://github.com/bartventer/gorm-multitenancy) - Multi-tenancy support for GORM managed databases.
*   [hasql](https://golang.yandex/hasql) - Library for accessing multi-host SQL database installations.
*   [octillery (⭐192)](https://github.com/knocknote/octillery) - Go package for sharding databases ( Supports every ORM or raw SQL ).
*   [onedump (⭐87)](https://github.com/liweiyi88/onedump) - Database backup from different drivers to different destinations with one command and configuration.
...
*   [rdb (⭐384)](https://github.com/HDT3213/rdb) - Redis RDB file parser for secondary development and memory analysis.
...
*   [bqb (⭐146)](https://github.com/nullism/bqb) - Lightweight and easy to learn query builder.
*   [buildsqlx (⭐170)](https://github.com/arthurkushman/buildsqlx) - Go database query builder library for PostgreSQL.
...
*   [Dotsql (⭐737)](https://github.com/gchaincl/dotsql) - Go library that helps you keep sql files in one place and use them with ease.
...
*   [jet (⭐2.5k)](https://github.com/go-jet/jet) - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
*   [sqlf (⭐143)](https://github.com/leporo/sqlf) - Fast SQL query builder.
*   [sqlingo (⭐405)](https://github.com/lqs/sqlingo) - A lightweight DSL to build SQL in Go.
...
*   [go-transaction-manager (⭐225)](https://github.com/avito-tech/go-transaction-manager) - Transaction manager with multiple adapters (sql, sqlx, gorm, mongo, ...) controls transaction boundaries.
*   [gokv (⭐733)](https://github.com/philippgille/gokv) - Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more).
...
*   [firebirdsql (⭐227)](https://github.com/nakagami/firebirdsql) - Firebird RDBMS SQL driver for Go.
...
*   [godror (⭐527)](https://github.com/godror/godror) - Oracle driver for Go, using the ODPI-C driver.
*   [gofreetds (⭐113)](https://github.com/minus5/gofreetds) - Microsoft MSSQL driver. Go wrapper over [FreeTDS](https://www.freetds.org).
*   [KSQL (⭐305)](https://github.com/VinGarcia/ksql) - A Simple and Powerful Golang SQL Library
...
*   [Sqinn-Go (⭐420)](https://github.com/cvilsmeier/sqinn-go) - SQLite with pure Go.
*   [sqlhooks (⭐649)](https://github.com/qustavo/sqlhooks) - Attach hooks to any database/sql driver.
*   [surrealdb.go (⭐237)](https://github.com/surrealdb/surrealdb.go) - SurrealDB Driver for Go.
*   [ydb-go-sdk (⭐137)](https://github.com/ydb-platform/ydb-go-sdk) - native and database/sql driver YDB (Yandex Database)

### NoSQL Database Drivers

*   [aerospike-client-go (⭐432)](https://github.com/aerospike/aerospike-client-go) - Aerospike client in Go language.
...
*   [go-mongox (⭐121)](https://github.com/chenmingyong0423/go-mongox) - A Go Mongo library based on the official driver, featuring streamlined document operations, generic binding of structs to collections, built-in CRUD, aggregation, automated field updates, struct validation, hooks, and plugin-based programming.
...
*   [gocb (⭐368)](https://github.com/couchbase/gocb) - Official Couchbase Go SDK.
...
*   [Kivik (⭐312)](https://github.com/go-kivik/kivik) - Kivik provides a common Go and GopherJS client library for CouchDB, PouchDB, and similar databases.
...
*   [go-sunrise (⭐145)](https://github.com/nathan-osman/go-sunrise) - Calculate the sunrise and sunset times for a given location.
...
*   [arpc (⭐951)](https://github.com/lesismal/arpc) - More effective network communication, support two-way-calling, notify, broadcast.
...
*   [consistent (⭐689)](https://github.com/buraksezer/consistent) - Consistent hashing with bounded loads.
*   [consistenthash (⭐27)](https://github.com/mbrostami/consistenthash) - Consistent hashing with configurable replicas.
*   [dht (⭐309)](https://github.com/anacrolix/dht) - BitTorrent Kademlia DHT implementation.
...
*   [go-health (⭐747)](https://github.com/InVisionApp/go-health) - Library for enabling asynchronous dependency health checks in your service.
...
*   [go-sundheit (⭐535)](https://github.com/AppsFlyer/go-sundheit) - A library built to provide support for defining async service health checks for golang services.
...
*   [gorpc (⭐696)](https://github.com/valyala/gorpc) - Simple, fast and scalable RPC library for high load.
...
*   [jsonrpc (⭐326)](https://github.com/ybbus/jsonrpc) - JSON-RPC 2.0 HTTP client implementation.
*   [K8gb (⭐862)](https://github.com/k8gb-io/k8gb) - A cloud native Kubernetes Global Balancer.
...
*   [raft (⭐639)](https://github.com/etcd-io/raft) - Go implementation of the Raft consensus protocol, by CoreOS.
*   [rain (⭐964)](https://github.com/cenkalti/rain) - BitTorrent client and library.
...
*   [ringpop-go (⭐827)](https://github.com/uber/ringpop-go) - Scalable, fault-tolerant application-layer sharding for Go applications.
...
*   [sponge (⭐1.3k)](https://github.com/zhufuyi/sponge) - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
*   [Temporal (⭐519)](https://github.com/temporalio/sdk-go) - Durable execution system for making code fault-tolerant and simple.
*   [torrent (⭐5.5k)](https://github.com/anacrolix/torrent) - BitTorrent client package.
*   [trpc-go (⭐808)](https://github.com/trpc-group/trpc-go) - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
*   [go-mail (⭐587)](https://github.com/wneessen/go-mail) - A simple Go library for sending mails in Go.
*   [go-message (⭐381)](https://github.com/emersion/go-message) - Streaming library for the Internet Message Format and mail messages.
*   [go-premailer (⭐139)](https://github.com/vanng822/go-premailer) - Inline styling for HTML mail in Go.
*   [go-simple-mail (⭐644)](https://github.com/xhit/go-simple-mail) - Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send.
...
*   [mailgun-go (⭐694)](https://github.com/mailgun/mailgun-go) - Go library for sending mail with the Mailgun API.
*   [MailHog (⭐14k)](https://github.com/mailhog/MailHog) - Email and SMTP testing with web and API interface.
*   [Mailpit (⭐5.4k)](https://github.com/axllent/mailpit) - Email and SMTP testing tool for developers.
...
*   [SendGrid (⭐981)](https://github.com/sendgrid/sendgrid-go) - SendGrid's Go library for sending email.
...
*   [truemail-go (⭐101)](https://github.com/truemail-rb/truemail-go) - Configurable Golang email validator/verifier. Verify email via Regex, DNS, SMTP and even more.
...
*   [go-php (⭐927)](https://github.com/deuill/go-php) - PHP bindings for Go.
...
*   [gval (⭐731)](https://github.com/PaesslerAG/gval) - A highly customizable expression language written in Go.
...
*   [prolog (⭐608)](https://github.com/ichiban/prolog) - Embeddable Prolog.
...
*   [starlet (⭐17)](https://github.com/1set/starlet) - Go wrapper for [starlark-go (⭐2.3k)](https://github.com/google/starlark-go) that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
...
*   [oops (⭐404)](https://github.com/samber/oops) - Error handling with context, stack trace and source fragments.
*   [tracerr (⭐978)](https://github.com/ztrue/tracerr) - Golang errors with stack trace and source fragments.
...
*   [afs (⭐302)](https://github.com/viant/afs) - Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go.
...
*   [copy (⭐714)](https://github.com/otiai10/copy) - Copy directory recursively.
...
*   [go-csv-tag (⭐120)](https://github.com/artonge/go-csv-tag) - Load csv file using tag.
*   [go-decent-copy (⭐22)](https://github.com/hugocarreira/go-decent-copy) - Copy files for humans.
*   [go-exiftool (⭐248)](https://github.com/barasher/go-exiftool) - Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...).
...
*   [gofs (⭐465)](https://github.com/no-src/gofs) - A cross-platform real-time file synchronization tool out of the box.
...
*   [iso9660 (⭐260)](https://github.com/kdomanski/iso9660) - A package for reading and creating ISO9660 disk images
*   [notify (⭐905)](https://github.com/rjeczalik/notify) - File system event notification library with simple API, similar to os/signal.
*   [opc (⭐75)](https://github.com/qmuntal/opc) - Load Open Packaging Conventions (OPC) files for Go.
*   [parquet (⭐105)](https://github.com/parsyl/parquet) - Read and write [parquet](https://parquet.apache.org) files.
...
*   [skywalker (⭐100)](https://github.com/dixonwille/skywalker) - Package to allow one to concurrently go through a filesystem with ease.
...
*   [vfs (⭐299)](https://github.com/C2FO/vfs) - A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS.
...
*   [orderbook (⭐428)](https://github.com/i25959341/orderbook) - Matching Engine for Limit Order Book in Golang.
...
*   [techan (⭐829)](https://github.com/sdcoffey/techan) - Technical analysis library with advanced market analysis and trading strategies.
...
*   [conform (⭐319)](https://github.com/leebenson/conform) - Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags.
*   [form (⭐756)](https://github.com/go-playground/form) - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
*   [httpin (⭐312)](https://github.com/ggicci/httpin) - Decode an HTTP request into a custom struct, including querystring, forms, HTTP headers, etc.
...
*   [go-functional (⭐429)](https://github.com/BooleanCat/go-functional) - Functional programming in Go using generics
...
*   [underscore (⭐109)](https://github.com/rjNemo/underscore) - Functional programming helpers for Go 1.18 and beyond.
...
*   [ecs (⭐118)](https://github.com/andygeiss/ecs) - Build your own Game-Engine based on the Entity Component System concept in Golang.
...
*   [go3d (⭐310)](https://github.com/ungerik/go3d) - Performance oriented 2D/3D math package for Go.
...
*   [grid (⭐17)](https://github.com/s0rg/grid) - Generic 2D grid with ray-casting, shadow-casting and path finding.
*   [Harfang3D (⭐559)](https://github.com/harfang3d/harfang3d) - 3D engine for the Go language, works on Windows and Linux ([Harfang on Go.dev (⭐37)](https://github.com/harfang3d/harfang-go)).
...
*   [tile (⭐153)](https://github.com/kelindar/tile) - Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export.
...
*   [convergen (⭐38)](https://github.com/reedom/convergen) - Feature rich type-to-type copy code generator.
*   [copygen (⭐351)](https://github.com/switchupcb/copygen) - Generate type-to-type and type-based code without reflection.
...
*   [oapi-codegen (⭐6.1k)](https://github.com/deepmap/oapi-codegen) - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
*   [geoos (⭐615)](https://github.com/spatial-go/geoos) - A library provides spatial data and geometric algorithms.
*   [geoserver (⭐88)](https://github.com/hishamkaram/geoserver) - geoserver Is a Go Package For Manipulating a GeoServer Instance via the GeoServer REST API.
*   [gismanager (⭐55)](https://github.com/hishamkaram/gismanager) - Publish Your GIS Data(Vector Data) to PostGIS and Geoserver.
*   [godal (⭐130)](https://github.com/airbusgeo/godal) - Go wrapper for GDAL.
*   [H3 (⭐302)](https://github.com/uber/h3-go) - Go bindings for H3, a hierarchical hexagonal geospatial indexing system.
...
*   [mbtileserver (⭐645)](https://github.com/consbio/mbtileserver) - A simple Go-based server for map tiles stored in mbtiles format.
*   [osm (⭐371)](https://github.com/paulmach/osm) - Library for reading, writing and working with OpenStreetMap data and APIs.
...
*   [WGS84 (⭐124)](https://github.com/wroge/wgs84) - Library for Coordinate Conversion and Transformation (ETRS89, OSGB36, NAD83, RGF93, Web Mercator, UTM).
...
*   [c4go (⭐364)](https://github.com/Konstantin8105/c4go) - Transpile C code to Go code.
*   [esp32 (⭐84)](https://github.com/andygeiss/esp32-transpiler) - Transpile Go into Arduino code.
...
*   [artifex (⭐200)](https://github.com/borderstech/artifex) - Simple in-memory job queue for Golang using worker-based dispatching.
*   [async (⭐4)](https://github.com/yaitoo/async) - An asynchronous task package with async/await style for Go.
*   [async (⭐216)](https://github.com/reugn/async) - An alternative sync library for Go (Future, Promise, Locks).
...
*   [flowmatic (⭐361)](https://github.com/carlmjohnson/flowmatic) - Structured concurrency made easy.
...
*   [gowp (⭐499)](https://github.com/xxjwxc/gowp) - gowp is concurrency limiting goroutine pool.
...
*   [neilotoole/errgroup (⭐160)](https://github.com/neilotoole/errgroup) - Drop-in alternative to `sync/errgroup`, limited to a pool of N worker goroutines.
...
*   [rill (⭐494)](https://github.com/destel/rill) - Go concurrency with channel transformations. No boilerplate, type safety, batching and error handling.
*   [routine (⭐228)](https://github.com/timandy/routine) - `routine` is a `ThreadLocal` for go library. It encapsulates and provides some easy-to-use, non-competitive, high-performance `goroutine` context access interfaces, which can help you access coroutine context information more gracefully.
...
*   [cimgui-go (⭐336)](https://github.com/AllenDang/cimgui-go) - Auto generated Go wrapper for [Dear ImGui (⭐60k)](https://github.com/ocornut/imgui) via [cimgui (⭐1.5k)](https://github.com/cimgui/cimgui).
...
*   [energy (⭐364)](https://github.com/energye/energy) - Cross-platform based on LCL(Native System UI Control Library) and CEF(Chromium Embedded Framework) (Windows/ macOS / Linux)
...
*   [unison (⭐193)](https://github.com/richardwilkes/unison) - A unified graphical user experience toolkit for Go desktop applications. macOS, Windows, and Linux are supported.
...
*   [zenity (⭐709)](https://github.com/ncruces/zenity) - Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user.
...
*   [go-osc (⭐199)](https://github.com/hypebeast/go-osc) - Open Sound Control (OSC) bindings for Go.
*   [go-rpio (⭐2.2k)](https://github.com/stianeikeland/go-rpio) - GPIO for Go, doesn't require cgo.
*   [goroslib (⭐323)](https://github.com/aler9/goroslib) - Robot Operating System (ROS) library for Go.
*   [joystick (⭐59)](https://github.com/0xcafed00d/joystick) - a polled API to read the state of an attached joystick.
*   [sysinfo (⭐520)](https://github.com/zcalusic/sysinfo) - A pure Go library providing Linux OS / kernel / hardware system information.
...
*   [draft (⭐578)](https://github.com/lucasepe/draft) - Generate High Level Microservice Architecture diagrams for GraphViz using simple YAML syntax.
...
*   [go-cairo (⭐143)](https://github.com/ungerik/go-cairo) - Go binding for the cairo graphics library.
...
*   [go-webp (⭐220)](https://github.com/kolesa-team/go-webp) - Library for encode and decode webp pictures, using libwebp.
*   [gocv (⭐6.6k)](https://github.com/hybridgroup/gocv) - Go package for computer vision using OpenCV 3.3+.
*   [goimagehash (⭐736)](https://github.com/corona10/goimagehash) - Go Perceptual image hashing package.
...
*   [gowitness (⭐3k)](https://github.com/sensepost/gowitness) - Screenshoting webpages using go and headless chrome on command line.
*   [gridder (⭐76)](https://github.com/shomali11/gridder) - A Grid based 2D Graphics library.
*   [image2ascii (⭐867)](https://github.com/qeesung/image2ascii) - Convert image to ASCII.
...
*   [steganography (⭐313)](https://github.com/auyer/steganography) - Pure Go Library for LSB steganography.
...
*   [transformimgs (⭐221)](https://github.com/Pixboost/transformimgs) - Transformimgs resizes and optimises images for Web using next-generation formats.
...
*   [connectordb (⭐402)](https://github.com/connectordb/connectordb) - Open-Source Platform for Quantified Self & IoT.
...
*   [Cadence-client (⭐345)](https://github.com/uber-go/cadence-client) - A framework for authoring workflows and activities running on top of the Cadence orchestration engine made by Uber.
*   [cdule (⭐48)](https://github.com/deepaksinghvi/cdule) - Job scheduler library with database support
*   [cheek (⭐146)](https://github.com/datarootsio/cheek) - A simple crontab like scheduler that aims to offer a KISS approach to job scheduling.
*   [clockwerk (⭐146)](https://github.com/onatm/clockwerk) - Go package to schedule periodic jobs using a simple, fluent syntax.
*   [cronticker (⭐16)](https://github.com/krayzpipes/cronticker) - A ticker implementation to support cron schedules.
*   [Dagu (⭐1.5k)](https://github.com/dagu-go/dagu) - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
*   [go-dag (⭐17)](https://github.com/rhosocial/go-dag) - A framework developed in Go that manages the execution of workflows described by directed acyclic graphs.
...
*   [goflow (⭐370)](https://github.com/fieldryand/goflow) - A simple but powerful DAG scheduler and dashboard.
...
*   [gronx (⭐399)](https://github.com/adhocore/gronx) - Cron expression parser, task runner and daemon consuming crontab like task list.
...
*   [jobs (⭐500)](https://github.com/albrow/jobs) - Persistent and flexible background jobs library.
...
*   [tasks (⭐294)](https://github.com/madflojo/tasks) - An easy to use in-process scheduler for recurring tasks in Go.
...
*   [ajson (⭐233)](https://github.com/spyzhov/ajson) - Abstract JSON for golang with JSONPath support.
...
*   [json2go (⭐131)](https://github.com/m-zajac/json2go) - Advanced JSON to Go struct conversion. Provides package that can parse multiple JSON documents and create struct to fit them all.
*   [jsonapi-errors (⭐14)](https://github.com/AmuzaTkts/jsonapi-errors) - Go bindings based on the JSON API errors reference.
*   [jsoncolor (⭐45)](https://github.com/neilotoole/jsoncolor) - Drop-in replacement for `encoding/json` that outputs colorized JSON.
*   [jsondiff (⭐515)](https://github.com/wI2L/jsondiff) - JSON diff library for Go based on RFC6902 (JSON Patch).
...
*   [kazaam (⭐279)](https://github.com/Qntfy/kazaam) - API for arbitrary transformation of JSON documents.
...
*   [OjG (⭐841)](https://github.com/ohler55/ojg) - Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath.
...
*   [httpretty (⭐393)](https://github.com/henvic/httpretty) - Pretty-prints your regular HTTP requests on your terminal for debugging (similar to http.DumpRequest).
...
*   [logur (⭐201)](https://github.com/logur/logur) - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus (⭐25k)](https://github.com/sirupsen/logrus), [go-kit log (⭐27k)](https://github.com/go-kit/kit/tree/master/log), [zap (⭐22k)](https://github.com/uber-go/zap), [zerolog (⭐10k)](https://github.com/rs/zerolog), etc).
...
*   [phuslu/log (⭐659)](https://github.com/phuslu/log) - High performance structured logging.
...
*   [slog (⭐391)](https://github.com/gookit/slog) - Lightweight, configurable, extensible logger for Go.
*   [slog-formatter (⭐109)](https://github.com/samber/slog-formatter) - Common formatters for slog and helpers to build your own.
*   [slog-multi (⭐359)](https://github.com/samber/slog-multi) - Chain of slog.Handler (pipeline, fanout...).
...
*   [sqldb-logger (⭐350)](https://github.com/simukti/sqldb-logger) - A logger for Go SQL database driver without modify existing \*sql.DB stdlib usage.
...
*   [tint (⭐729)](https://github.com/lmittmann/tint) - A slog.Handler that writes tinted logs.
...
*   [zax (⭐23)](https://github.com/yuseferi/zax) - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
...
*   [go-deep (⭐531)](https://github.com/patrikeh/go-deep) - A feature-rich neural network library in Go.
...
*   [hugot (⭐264)](https://github.com/knights-analytics/hugot) - Huggingface transformer pipelines for golang with onnxruntime.
...
*   [ocrserver (⭐689)](https://github.com/otiai10/ocrserver) - A simple OCR API server, seriously easy to be deployed by Docker and Heroku.
*   [onnx-go (⭐688)](https://github.com/owulveryck/onnx-go) - Go Interface to Open Neural Network Exchange (ONNX).
...
*   [Asynq (⭐9.5k)](https://github.com/hibiken/asynq) - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
*   [dbus (⭐975)](https://github.com/godbus/dbus) - Native Go bindings for D-Bus.
...
*   [Go-MediatR (⭐207)](https://github.com/mehdihadeli/Go-MediatR) - A library for handling mediator patterns and simplified CQRS patterns within an event-driven architecture, inspired by csharp MediatR library.
...
*   [golongpoll (⭐654)](https://github.com/jcuga/golongpoll) - HTTP longpoll server library that makes web pub-sub simple.
*   [gopush-cluster (⭐2.1k)](https://github.com/Terry-Mao/gopush-cluster) - gopush-cluster is a go push server cluster.
*   [gorush (⭐8k)](https://github.com/appleboy/gorush) - Push notification server using [APNs2 (⭐3k)](https://github.com/sideshow/apns2) and google [GCM (⭐104)](https://github.com/google/go-gcm).
...
*   [pubsub (⭐425)](https://github.com/tuxychandru/pubsub) - Simple pubsub package for go.
*   [Quamina (⭐391)](https://github.com/timbray/quamina) - Fast pattern-matching for filtering messages and events.
...
*   [Watermill (⭐7.3k)](https://github.com/ThreeDotsLabs/watermill) - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
*   [fx (⭐5.7k)](https://github.com/uber-go/fx) - A dependency injection based application framework for Go (built on top of dig).
...
*   [GoLobby/Container (⭐558)](https://github.com/golobby/container) - GoLobby Container is a lightweight yet powerful IoC dependency injection container for the Go programming language.
*   [gontainer (⭐37)](https://github.com/NVIDIA/gontainer) - A dependency injection service container for Go projects.
...
*   [kod (⭐149)](https://github.com/go-kod/kod) - A generics based dependency injection framework for Go.
...
*   [go-blueprint (⭐3.9k)](https://github.com/Melkeydev/go-blueprint) - Allows users to spin up a quick Go project using a popular framework.
...
*   [go-starter (⭐492)](https://github.com/allaboutapps/go-starter) - An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers.
*   [go-todo-backend (⭐317)](https://github.com/Fs02/go-todo-backend) - Go Todo Backend example using modular project layout for product microservice.
...
*   [gobeam/Stringy (⭐230)](https://github.com/gobeam/Stringy) - String manipulation library to convert string to camel case, snake case, kebab case / slugify etc.
*   [strutil (⭐205)](https://github.com/ozgio/strutil) - String utilities.
*   [sttr (⭐936)](https://github.com/abhimanyu003/sttr) - cross-platform, cli app to perform various operations on string.
...
*   [battery (⭐246)](https://github.com/distatus/battery) - Cross-platform, normalized battery information library.
*   [bitio (⭐242)](https://github.com/icza/bitio) - Highly optimized bit-level Reader and Writer for Go.
...
*   [captcha (⭐154)](https://github.com/steambap/captcha) - Package captcha provides an easy to use, unopinionated API for captcha generation.
...
*   [gatus (⭐6.1k)](https://github.com/TwinProduction/gatus) - Automated service health dashboard.
...
*   [go-unarr (⭐280)](https://github.com/gen2brain/go-unarr) - Decompression library for RAR, TAR, ZIP and 7z archives.
...
*   [gtree (⭐235)](https://github.com/ddddddO/gtree) - Provide CLI, Package and Web for tree output and directories creation from Markdown or programmatically.
*   [health (⭐773)](https://github.com/alexliesenfeld/health) - A simple and flexible health check library for Go.
...
*   [lk (⭐367)](https://github.com/hyperboloide/lk) - A simple licensing library for golang.
...
*   [shortid (⭐937)](https://github.com/teris-io/shortid) - Distributed generation of super short, unique, non-sequential, URL friendly IDs.
*   [shoutrrr (⭐975)](https://github.com/containrrr/shoutrrr) - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
*   [sitemap-format (⭐4)](https://github.com/mingard/sitemap-format) - A simple sitemap generator, with a little syntactic sugar.
*   [stateless (⭐940)](https://github.com/qmuntal/stateless) - A fluent library for creating state machines.
...
*   [xz (⭐475)](https://github.com/ulikunitz/xz) - Pure golang package for reading and writing xz-compressed files.
...
*   [whatlanggo (⭐638)](https://github.com/abadojack/whatlanggo) - Natural language detection package for Go. Supports 84 languages and 24 scripts (writing systems e.g. Latin, Cyrillic, etc).
...
*   [kagome (⭐815)](https://github.com/ikawaha/kagome) - JP morphological analyzer written in pure Go.
...
*   [sentences (⭐436)](https://github.com/neurosnap/sentences) - Sentence tokenizer: converts text into a list of sentences.
...
*   [ctxi18n (⭐39)](https://github.com/invopop/ctxi18n/) - Context aware i18n with a short and consise API, pluralization, interpolation, and `fs.FS` support. YAML locale definitions are based on [Rails i18n](https://guides.rubyonrails.org/i18n.html).
...
*   [gotext (⭐435)](https://github.com/leonelquinteros/gotext) - GNU gettext utilities for Go.
...
*   [easytcp (⭐806)](https://github.com/DarthPestilane/easytcp) - A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful.
...
*   [ftpserverlib (⭐417)](https://github.com/fclairamb/ftpserverlib) - Fully featured FTP server library.
...
*   [gaio (⭐793)](https://github.com/xtaci/gaio) - High performance async-io networking for Golang in proactor mode.
...
*   [gmqtt (⭐986)](https://github.com/DrmagicE/gmqtt) - Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1.
*   [gnet (⭐9.5k)](https://github.com/panjf2000/gnet) - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
*   [go-stun (⭐666)](https://github.com/ccding/go-stun) - Go implementation of the STUN client (RFC 3489 and RFC 5389).
...
*   [iplib (⭐143)](https://github.com/c-robinson/iplib) - Library for working with IP addresses (net.IP, net.IPNet), inspired by python [ipaddress](https://docs.python.org/3/library/ipaddress.html) and ruby [ipaddr](https://ruby-doc.org/stdlib-2.5.1/libdoc/ipaddr/rdoc/IPAddr.html)
*   [jazigo (⭐214)](https://github.com/udhos/jazigo) - Jazigo is a tool written in Go for retrieving configuration for multiple network devices.
...
*   [peerdiscovery (⭐638)](https://github.com/schollz/peerdiscovery) - Pure Go library for cross-platform local peer discovery using UDP multicast.
...
*   [sdns (⭐952)](https://github.com/semihalev/sdns) - A high-performance, recursive DNS resolver server with DNSSEC support, focused on preserving privacy.
...
*   [tun2socks (⭐3.1k)](https://github.com/xjasonlyu/tun2socks) - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
*   [utp (⭐173)](https://github.com/anacrolix/utp) - Go uTP micro transport protocol implementation.
*   [vssh (⭐955)](https://github.com/yahoo/vssh) - Go library for building network and server automation over SSH protocol.
...
*   [fast-shot (⭐61)](https://github.com/opus-domini/fast-shot) - Hit your API targets with rapid-fire precision using Go's fastest and simple HTTP Client.
*   [gentleman (⭐1.1k)](https://github.com/h2non/gentleman) - Full-featured plugin-driven HTTP client library.
*   [go-cleanhttp (⭐366)](https://github.com/hashicorp/go-cleanhttp) - Get easily stdlib HTTP client, which does not share any state with other clients.
*   [go-http-client (⭐77)](https://github.com/bozd4g/go-http-client) - Make http calls simply and easily.
...
*   [httpretry (⭐45)](https://github.com/ybbus/httpretry) - Enriches the default go HTTP client with retry functionality.
...
*   [bob (⭐760)](https://github.com/stephenafamo/bob) - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
...
*   [rel (⭐762)](https://github.com/go-rel/rel) - Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API.
...
*   [gup (⭐330)](https://github.com/nao1215/gup) - Update binaries installed by "go install".
...
*   [go-instrument (⭐204)](https://github.com/nikolaydubina/go-instrument) - Automatically add spans to all methods and functions.
...
*   [rql (⭐340)](https://github.com/a8m/rql) - Resource Query Language for REST API.
...
*   [ewma (⭐435)](https://github.com/VividCortex/ewma) - Exponentially-weighted moving averages.
...
*   [orb (⭐899)](https://github.com/paulmach/orb) - 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support.
...
*   [dongle (⭐881)](https://github.com/golang-module/dongle) - A simple, semantic and developer-friendly golang package for encoding\&decoding and encryption\&decryption.
...
*   [go-password-validator (⭐495)](https://github.com/lane-c-wagner/go-password-validator) - Password validator based on raw cryptographic entropy values.
*   [go-peer (⭐256)](https://github.com/number571/go-peer) - A software library for creating secure and anonymous decentralized systems.
*   [go-yara (⭐356)](https://github.com/hillu/go-yara) - Go Bindings for [YARA (⭐137)](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)".
...
*   [lego (⭐7.9k)](https://github.com/go-acme/lego) - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
*   [ssh-vault (⭐442)](https://github.com/ssh-vault/ssh-vault) - encrypt/decrypt using ssh keys.
*   [sslmgr (⭐26)](https://github.com/adrianosela/sslmgr) - SSL certificates made easy with a high level wrapper around acme/autocert.
*   [teler-waf (⭐347)](https://github.com/kitabisa/teler-waf) - teler-waf is a Go HTTP middleware that provide teler IDS functionality to protect against web-based attacks and improve the security of Go-based web applications. It is highly configurable and easy to integrate into existing Go applications.
...
*   [cbor (⭐717)](https://github.com/fxamacker/cbor) - Small, safe, and easy CBOR encoding and decoding library.
*   [colfer (⭐744)](https://github.com/pascaldekloe/colfer) - Code generation for the Colfer binary format.
*   [csvutil (⭐928)](https://github.com/jszwec/csvutil) - High Performance, idiomatic CSV record encoding and decoding to native Go structures.
...
*   [Euterpe (⭐534)](https://github.com/ironsmile/euterpe) - Self-hosted music streaming server with built-in web UI and REST API.
...
*   [go-proxy-cache (⭐127)](https://github.com/fabiocicerchia/go-proxy-cache) - Simple Reverse Proxy with Caching, written in Go, using Redis.
...
*   [fasttemplate (⭐828)](https://github.com/valyala/fasttemplate) - Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](https://golang.org/pkg/text/template/).
...
*   [gospin (⭐58)](https://github.com/m1/gospin) - Article spinning and spintax/spinning syntax engine, useful for A/B, testing pieces of text/articles and creating more natural conversations.
...
*   [goview (⭐420)](https://github.com/foolin/goview) - Goview is a lightweight, minimalist and idiomatic template library based on golang html/template for building Go web application.
...
*   [maroto (⭐1.8k)](https://github.com/johnfercher/maroto) - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
*   [raymond (⭐602)](https://github.com/aymerick/raymond) - Complete handlebars implementation in Go.
*   [Razor (⭐857)](https://github.com/sipin/gorazor) - Razor view engine for Golang.
...
*   [templ (⭐8k)](https://github.com/a-h/templ) - A HTML templating language that has great developer tooling.
...
*   [arch-go (⭐162)](https://github.com/fdaines/arch-go) - Architecture testing tool for Go projects.
...
*   [cupaloy (⭐300)](https://github.com/bradleyjkemp/cupaloy) - Simple snapshot testing addon for your test framework.
...
*   [embedded-postgres (⭐826)](https://github.com/fergusstrange/embedded-postgres) - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
*   [fixenv (⭐29)](https://github.com/rekby/fixenv) - Fixture manage engine, inspired by pytest fixtures.
...
*   [gherkingen (⭐74)](https://github.com/hedhyw/gherkingen) - BDD boilerplate generator and framework.
...
*   [go-snaps (⭐163)](http://github.com/gkampitakis/go-snaps) - Jest-like snapshot testing in Golang.
...
*   [gotest.tools (⭐512)](https://github.com/gotestyourself/gotest.tools) - A collection of packages to augment the go testing package and support common patterns.
...
*   [jsonassert (⭐126)](https://github.com/kinbiko/jsonassert) - Package for verifying that your JSON payloads are serialized correctly.
*   [keploy (⭐4.1k)](https://github.com/keploy/keploy) - Generate Testcase and Data Mocks from API calls automatically.
...
*   [testcontainers-go (⭐3.5k)](https://github.com/testcontainers/testcontainers-go) - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
*   [counterfeiter (⭐971)](https://github.com/maxbrunsfeld/counterfeiter) - Tool for generating self-contained mock objects.
...
*   [go-txdb (⭐648)](https://github.com/DATA-DOG/go-txdb) - Single transaction based database driver mainly for testing purposes.
...
*   [minimock (⭐632)](https://github.com/gojuno/minimock) - Mock generator for Go interfaces.
*   [mockery (⭐6k)](https://github.com/vektra/mockery) - Tool to generate Go interfaces.
...
*   [xgo (⭐330)](https://github.com/xhd2015/xgo) - A general pureposed function mocking library.
...
*   [cdp (⭐722)](https://github.com/mafredri/cdp) - Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it.
...
*   [failpoint (⭐815)](https://github.com/pingcap/failpoint) - An implementation of [failpoints](https://www.freebsd.org/cgi/man.cgi?query=fail) for Golang.
...
*   [gotabulate (⭐332)](https://github.com/bndr/gotabulate) - Easily pretty-print your tabular data with Go.
...
*   [go-output-format (⭐16)](https://github.com/drewstinnett/go-output-format) - Output go structures into multiple formats (YAML/JSON/etc) in your command line app.
...
*   [html-to-markdown (⭐852)](https://github.com/JohannesKaufmann/html-to-markdown) - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
*   [htmlquery (⭐732)](https://github.com/antchfx/htmlquery) - An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression.
...
*   [go-nmea (⭐226)](https://github.com/adrianmo/go-nmea) - NMEA parser library for the Go language.
...
*   [godump (⭐148)](https://github.com/yassinebenaid/godump) - Pretty print any GO variable with ease, an alternative to Go's `fmt.Printf("%#v")`.
*   [gofeed (⭐2.6k)](https://github.com/mmcdole/gofeed) - Parse RSS and Atom feeds in Go.
*   [gographviz (⭐549)](https://github.com/awalterschulze/gographviz) - Parses the Graphviz DOT language.
...
*   [tokenizer (⭐92)](https://github.com/bzick/tokenizer) - Parse any string, slice or infinite buffer to any tokens.
...
*   [go-wildcard (⭐80)](https://github.com/IGLOU-EU/go-wildcard) - Simple and lightweight wildcard pattern matching.
*   [goregen (⭐90)](https://github.com/zach-klippenstein/goregen) - Library for generating random strings from regular expressions.
*   [regroup (⭐144)](https://github.com/oriser/regroup) - Match regex expression named groups into go struct using struct tags and automatic parsing.
*   [rex (⭐194)](https://github.com/hedhyw/rex) - Regular expressions builder.
...
*   [dataflowkit (⭐658)](https://github.com/slotix/dataflowkit) - Web scraping Framework to turn websites into structured data.
...
*   [go-runewidth (⭐607)](https://github.com/mattn/go-runewidth) - Functions to get fixed width of the character or string.
...
*   [go-atlassian (⭐123)](https://github.com/ctreminiom/go-atlassian) - Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud)
...
*   [go-lark (⭐201)](https://github.com/go-lark/lark) - An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform.
...
*   [go-openai (⭐9k)](https://github.com/sashabaranov/go-openai) - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
*   [go-redoc (⭐69)](https://github.com/mvrilo/go-redoc) - Embedded OpenAPI/Swagger documentation ui for Go using [ReDoc](https://redocly.com/).
...
*   [go-salesforce (⭐25)](https://github.com/k-capehart/go-salesforce) - Go client library for interacting with the [Salesforce REST API](https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/resources_list.htm).
...
*   [golang-tmdb (⭐119)](https://github.com/cyruzin/golang-tmdb) - Golang wrapper for The Movie Database API v3.
...
*   [lark (⭐416)](https://github.com/chyroc/lark) - [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback.
...
*   [paypal (⭐682)](https://github.com/logpacker/PayPal-Go-SDK) - Wrapper for PayPal payment API.
...
*   [simples3 (⭐149)](https://github.com/rhnvrm/simples3) - Simple no frills AWS S3 Library using REST with V4 Signing written in Go.
...
*   [twitter-scraper (⭐893)](https://github.com/n0madic/twitter-scraper) - Scrape the Twitter Frontend API without authentication and limits.
...
*   [webhooks (⭐951)](https://github.com/go-playground/webhooks) - Webhook receiver for GitHub and Bitbucket.
*   [wit-go (⭐158)](https://github.com/wit-ai/wit-go) - Go client for wit.ai HTTP API.
...
*   [changie (⭐674)](https://github.com/miniscruff/changie) - Automated changelog tool for preparing releases with lots of customization options.
*   [chyle (⭐157)](https://github.com/antham/chyle) - Changelog generator using a git repository with multiple configuration possibilities.
...
*   [clipboard (⭐591)](https://github.com/golang-design/clipboard) - 📋 cross-platform clipboard package in Go.
...
*   [config-file-validator (⭐324)](https://github.com/Boeing/config-file-validator) - Cross Platform tool to validate configuration files.
...
*   [countries (⭐397)](https://github.com/biter777/countries) - Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standards.
...
*   [ergo (⭐622)](https://github.com/cristianoliveira/ergo) - The management of multiple local services running over different ports made easy.
...
*   [go-qr (⭐27)](https://github.com/piglig/go-qr) - A native, high-quality and minimalistic QR code generator.
...
*   [gofn (⭐42)](https://github.com/tiendc/gofn) - High performance utility functions written using Generics for Go 1.18+.
...
*   [immortal (⭐801)](https://github.com/immortal/immortal) - \*nix cross-platform (OS agnostic) supervisor.
...
*   [lancet (⭐4.5k)](https://github.com/duke-git/lancet) - A comprehensive, efficient, and reusable util function library of go.
...
*   [limiters (⭐427)](https://github.com/mennanov/limiters) - Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks.
...
*   [mani (⭐437)](https://github.com/alajmo/mani) - CLI tool to help you manage multiple repositories.
...
*   [remote-touchpad (⭐514)](https://github.com/Unrud/remote-touchpad) - Control mouse and keyboard from a smartphone.
...
*   [rospo (⭐308)](https://github.com/ferama/rospo) - Simple and reliable ssh tunnels with embedded ssh server in Golang.
*   [scan (⭐556)](https://github.com/blockloop/scan) - Scan golang `sql.Rows` directly to structs, slices, or primitive types.
...
*   [serve (⭐333)](https://github.com/syntaqx/serve) - A static http server anywhere you need.
...
*   [upterm (⭐837)](https://github.com/owenthereal/upterm) - A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.
...
*   [wifiqr (⭐262)](https://github.com/reugn/wifiqr) - Wi-Fi QR Code Generator.
...
*   [jio (⭐111)](https://github.com/faceair/jio) - jio is a json schema validator similar to [joi (⭐21k)](https://github.com/hapijs/joi).
...
*   [go-astiav (⭐362)](https://github.com/asticode/go-astiav) - Better C bindings for ffmpeg in GO.
*   [go-astisub (⭐577)](https://github.com/asticode/go-astisub) - Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.).
...
*   [gortsplib (⭐674)](https://github.com/aler9/gortsplib) - Pure Go RTSP server and client library.
...
*   [libvlc-go (⭐432)](https://github.com/adrg/libvlc-go) - Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player).
...
*   [Don (⭐51)](https://github.com/abemedia/go-don) - A highly performant and simple to use API framework.
*   [Echo (⭐30k)](https://github.com/labstack/echo) - High performance, minimalist Go web framework.
*   [Fastschema (⭐232)](https://github.com/fastschema/fastschema) - A flexible Go web framework and Headless CMS.
...
*   [Flamingo (⭐452)](https://github.com/i-love-flamingo/flamingo) - Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc.
*   [Flamingo Commerce (⭐505)](https://github.com/i-love-flamingo/flamingo-commerce) - Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications.
*   [Fuego (⭐815)](https://github.com/go-fuego/fuego) - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
*   [Gearbox (⭐755)](https://github.com/abahmed/gearbox) - A web framework written in Go with a focus on high performance and memory optimization.
...
*   [GoFr (⭐2.8k)](https://github.com/gofr-dev/gofr) - Gofr is an opinionated microservice development framework.
...
*   [Gone (⭐116)](https://github.com/gone-io/gone) - A lightweight dependency injection and web framework inspired by Spring.
...
*   [rk-boot (⭐514)](https://github.com/rookie-ninja/rk-boot) - A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily.
...
*   [uAdmin (⭐336)](https://github.com/uadmin/uadmin) - Fully featured web framework for Golang, inspired by Django.
...
*   [Yokai (⭐366)](https://github.com/ankorstore/yokai) - Simple, modular, and observable Go framework for backend applications.
...
*   [Extism Go SDK (⭐77)](https://github.com/extism/go-sdk) - Universal, cross-language WebAssembly framework for building plug-in systems and polyglot apps.
...
*   [webapi (⭐173)](https://github.com/gowebapi/webapi) - Bindings for DOM and HTML generated from WebIDL.
...
*   [xpath (⭐686)](https://github.com/antchfx/xpath) - XPath package for Go.
*   [xquery (⭐157)](https://github.com/antchfx/xquery) - XQuery lets you extract data from HTML/XML documents using XPath expression.
*   [zek (⭐747)](https://github.com/miku/zek) - Generate a Go struct from XML.
...
*   [in-toto (⭐129)](https://github.com/in-toto/in-toto-golang) - Go implementation of the in-toto (provides a framework to protect the integrity of the software supply chain) python reference implementation.
*   [Spiffe-Vault (⭐84)](https://github.com/philips-labs/spiffe-vault) - Utilizes Spiffe JWT authentication with Hashicorp Vault for secretless authentication.
...
*   [asty (⭐79)](https://github.com/asty-org/asty) - Converts golang AST to JSON and JSON to AST.
...
*   [go-cleanarch (⭐855)](https://github.com/roblaszczak/go-cleanarch) - go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects.
...
*   [golines (⭐911)](https://github.com/segmentio/golines) - Formatter that automatically shortens long lines in Go code.
...
*   [wrapcheck (⭐302)](https://github.com/tomarrell/wrapcheck) - A linter to check that errors from external packages are wrapped.
...
*   [coc-go language server extension for Vim/Neovim (⭐564)](https://github.com/josa42/coc-go) - This plugin adds [gopls (⭐7.4k)](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim.
...
*   [goimports-reviser (⭐586)](https://github.com/incu6us/goimports-reviser) - Formatting tool for imports.
...
*   [envdoc (⭐55)](https://github.com/g4s8/envdoc) -  generate documentation for environment variables from Go source files.
...
*   [xgen (⭐326)](https://github.com/xuri/xgen) - XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.
...
*   [depth (⭐923)](https://github.com/KyleBanks/depth) - Visualize dependency trees of any package by analyzing imports.
...
*   [gotestdox (⭐112)](https://github.com/bitfield/gotestdox) - Show Go test results as readable sentences.
...
*   [roumon (⭐183)](https://github.com/becheran/roumon) - Monitor current state of all active goroutines via a command line interface.
...
*   [typex (⭐198)](https://github.com/dtgorski/typex) - Examine Go types and their transitive dependencies, alternatively export results as TypeScript value objects (or types) declaration.
...
*   [abbreviate (⭐219)](https://github.com/dnnrly/abbreviate) - abbreviate is a tool turning long strings in to shorter ones with configurable separators, for example to embed branch names in to deployment stack IDs.
...
*   [aurora (⭐597)](https://github.com/xuri/aurora) - Cross-platform web-based Beanstalkd queue server console.
...
*   [bombardier (⭐5.9k)](https://github.com/codesenberg/bombardier) - Fast cross-platform HTTP benchmarking tool.
*   [bosun (⭐3.4k)](https://github.com/bosun-monitor/bosun) - Time Series Alerting Framework.
*   [cassowary (⭐759)](https://github.com/rogerwelin/cassowary) - Modern cross-platform HTTP load-testing tool written in Go.
*   [Ddosify (⭐8.4k)](https://github.com/ddosify/ddosify) - High-performance load testing tool, written in Golang.
*   [decompose (⭐84)](https://github.com/s0rg/decompose) - tool to generate and process Docker containers connections graphs.
...
*   [go-rocket-update (⭐102)](https://github.com/mouuff/go-rocket-update) - A simple way to make self updating Go applications - Supports Github and Gitlab.
...
*   [gobrew (⭐367)](https://github.com/kevincobain2000/gobrew) - Go version manager. Super simple tool to install and manage Go versions. Install go without root. Gobrew doesn't require shell rehash.
...
*   [kool (⭐664)](https://github.com/kool-dev/kool) - Command line tool for managing Docker environments as an easy way.
...
*   [KubeVPN (⭐544)](https://github.com/kubenetworks/kubevpn) - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
*   [KusionStack (⭐865)](https://github.com/KusionStack/kusion) - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
*   [kwatch (⭐958)](https://github.com/abahmed/kwatch) - Monitor & detect crashes in your Kubernetes(K8s) cluster instantly.
...
*   [Pewpew (⭐417)](https://github.com/bengadbois/pewpew) - Flexible HTTP command line stress tester.
...
*   [s3-proxy (⭐296)](https://github.com/oxyno-zeta/s3-proxy) - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
*   [Scaleway-cli (⭐881)](https://github.com/scaleway/scaleway-cli) - Manage BareMetal Servers from Command Line (as easily as with Docker).
...
*   [skm (⭐952)](https://github.com/TimothyYe/skm) - SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily!
...
*   [crawley (⭐254)](https://github.com/s0rg/crawley) - Web scraper/crawler for cli.
...
*   [fjira (⭐133)](https://github.com/mk-5/fjira) - A fuzzy-search based terminal UI application for Attlasian Jira
...
*   [gocc (⭐604)](https://github.com/goccmack/gocc) - Gocc is a compiler kit for Go written in Go.
...
*   [GoNB (⭐628)](https://github.com/janpfeifer/gonb) - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
...
*   [hotswap (⭐342)](https://github.com/edwingeng/hotswap) - A complete solution to reload your go code without restarting your server, interrupting or blocking any ongoing procedure.
...
*   [Neo-cowsay (⭐306)](https://github.com/Code-Hex/Neo-cowsay) - 🐮 cowsay is reborn. for a New Era.
...
*   [sake (⭐649)](https://github.com/alajmo/sake) - sake is a command runner for local and remote hosts.
...
*   [stew (⭐153)](https://github.com/marwanhawari/stew) - An independent package manager for compiled binaries.
...
*   [woke (⭐448)](https://github.com/get-woke/woke) - Detect non-inclusive language in your source code.
*   [yai (⭐635)](https://github.com/ekkinox/yai) - AI powered terminal assistant.
...
*   [gophericons (⭐614)](https://github.com/shalakhin/gophericons)
*   [gopherize.me (⭐708)](https://github.com/matryer/gopherize.me) - Gopherize yourself.
...
*   [Go Projects (⭐123k)](https://github.com/golang/go/wiki/Projects) - List of projects on the Go community wiki.
...
*   [Hex Monscape (⭐66)](https://github.com/Haraj-backend/hex-monscape) - Getting started guidelines in writing maintainable code using Hexagonal Architecture.
