...
[🏠 Home](/README.md) · [🔥 Feed](https://www.trackawesomelist.com/avelino/awesome-go/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 avelino/awesome-go](https://github.com/avelino/awesome-go) · ⭐ 140K · 🏷️ Programming Languages
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python (⭐238k)](https://github.com/vinta/awesome-python).
...
*   [Goakt (⭐225)](https://github.com/Tochemey/goakt) - Fast and Distributed Actor framework using protocol buffers as message for Golang.
*   [Hollywood (⭐1.8k)](https://github.com/anthdm/hollywood) - Blazingly fast and light-weight Actor engine written in Golang.
...
*   [chromem-go (⭐469)](https://github.com/philippgille/chromem-go) - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
*   [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
*   [langchaingo (⭐6.1k)](https://github.com/tmc/langchaingo) - LangChainGo is a framework for developing applications powered by language models.
*   [LocalAI (⭐31k)](https://github.com/mudler/LocalAI) - Open Source OpenAI alternative, self-host AI models.
*   [Ollama (⭐133k)](https://github.com/jmorganca/ollama) - Run large language models locally.
*   [OllamaFarm (⭐66)](https://github.com/presbrey/ollamafarm) - Manage, load-balance, and failover packs of Ollamas
...
*   [GoAudio (⭐365)](https://github.com/DylanMeeus/GoAudio) - Native Go Audio Processing Library.
...
*   [malgo (⭐323)](https://github.com/gen2brain/malgo) - Mini audio library.
...
*   [PortAudio (⭐743)](https://github.com/gordonklaus/portaudio) - Go bindings for the PortAudio audio I/O library.
...
*   [branca (⭐88)](https://github.com/essentialkaos/branca) - branca token [specification implementation (⭐229)](https://github.com/tuupola/branca-spec) for Golang 1.15+.
...
*   [go-guardian (⭐574)](https://github.com/shaj13/go-guardian) - Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token, and Certificate based authentication.
*   [go-jose (⭐366)](https://github.com/go-jose/go-jose) - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
*   [goiabada (⭐147)](https://github.com/leodip/goiabada) - An open-source authentication and authorization server supporting OAuth2 and OpenID Connect.
...
*   [gosession (⭐263)](https://github.com/Kwynto/gosession) - This is quick session for net/http in GoLang. This package is perhaps the best implementation of the session mechanism, or at least it tries to become one.
...
*   [jeff (⭐268)](https://github.com/abraithwaite/jeff) - Simple, flexible, secure, and idiomatic web session management with pluggable backends.
*   [jwt (⭐359)](https://github.com/pascaldekloe/jwt) - Lightweight JSON Web Token (JWT) library.
*   [jwt (⭐674)](https://github.com/cristalhq/jwt) - Safe, simple, and fast JSON Web Tokens for Go.
*   [jwt-auth (⭐235)](https://github.com/adam-hanna/jwt-auth) - JWT middleware for Golang http servers with many configuration options.
*   [jwt-go (⭐7.8k)](https://github.com/golang-jwt/jwt) - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
*   [openfga (⭐3.4k)](https://github.com/openfga/openfga) - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
*   [paseto (⭐876)](https://github.com/o1egl/paseto) - Golang implementation of Platform-Agnostic Security Tokens (PASETO).
...
*   [cometbft (⭐720)](https://github.com/cometbft/cometbft) - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
*   [cosmos-sdk (⭐6.5k)](https://github.com/cosmos/cosmos-sdk) - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
*   [gno (⭐937)](https://github.com/gnolang/gno) - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
...
*   [gossamer (⭐446)](https://github.com/ChainSafe/gossamer) - A Go implementation of the Polkadot Host.
...
*   [arikawa (⭐498)](https://github.com/diamondburned/arikawa) - A library and framework for the Discord API.
*   [bot (⭐988)](https://github.com/go-telegram/bot) - Zero-dependencies Telegram Bot library with additional UI components
*   [echotron (⭐389)](https://github.com/NicoNex/echotron) - An elegant and concurrent library for Telegram Bots in Go.
*   [ephemeral-roles (⭐92)](https://github.com/ewohltman/ephemeral-roles) - A Discord bot for managing ephemeral roles based upon voice channel member presence.
...
*   [go-tg (⭐112)](https://github.com/mr-linch/go-tg) - Generated from official docs Go client library for accessing Telegram Bot API, with batteries for building complex bots included.
...
*   [go-twitch-irc (⭐373)](https://github.com/gempir/go-twitch-irc) - Library to write bots for twitch.tv chat
...
*   [hanu (⭐157)](https://github.com/sbstjn/hanu) - Framework for writing Slack bots.
*   [larry (⭐162)](https://github.com/ezeoleaf/larry) - Larry 🐦 is a really simple Twitter bot generator that tweets random repositories from Github built in Go.
...
*   [slack-bot (⭐189)](https://github.com/innogames/slack-bot) - Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github...
*   [slacker (⭐50)](https://github.com/slack-io/slacker) - Easy to use framework to create Slack bots.
...
*   [telego (⭐654)](https://github.com/mymmrac/telego) - Telegram Bot API library for Golang with full one-to-one API implementation.
...
*   [goyek (⭐605)](https://github.com/goyek/goyek) - Create build pipelines in Go.
...
*   [box-cli-maker (⭐553)](https://github.com/Delta456/box-cli-maker) - Make Highly Customized Boxes for your CLI.
*   [bubble-table (⭐481)](https://github.com/Evertras/bubble-table) - An interactive table component for bubbletea.
*   [bubbles (⭐6.1k)](https://github.com/charmbracelet/bubbles) - TUI components for bubbletea.
...
*   [chalk (⭐460)](https://github.com/ttacon/chalk) - Intuitive package for prettifying terminal/console output.
...
*   [go-colorable (⭐783)](https://github.com/mattn/go-colorable) - Colorable writer for windows.
*   [go-colortext (⭐217)](https://github.com/daviddengcn/go-colortext) - Go library for color output in terminals.
*   [go-isatty (⭐853)](https://github.com/mattn/go-isatty) - isatty for golang.
...
*   [gommon/color (⭐548)](https://github.com/labstack/gommon/tree/master/color) - Style terminal text.
...
*   [lipgloss (⭐8.7k)](https://github.com/charmbracelet/lipgloss) - Declaratively define styles for color, format and layout in the terminal.
...
*   [simpletable (⭐535)](https://github.com/alexeyco/simpletable) - Simple tables in a terminal with Go.
...
*   [yacspin (⭐444)](https://github.com/theckman/yacspin) - Yet Another CLi Spinner package, for working with terminal spinners.
...
*   [acmd (⭐122)](https://github.com/cristalhq/acmd) - Simple, useful, and opinionated CLI package in Go.
...
*   [carapace (⭐549)](https://github.com/rsteube/carapace) - Command argument completion generator for spf13/cobra.
...
*   [climax (⭐218)](https://github.com/tucnak/climax) - Alternative CLI with "human face", in spirit of Go command.
*   [clîr (⭐189)](https://github.com/leaanthony/clir) - A Simple and Clear CLI library. Dependency free.
*   [cmd (⭐43)](https://github.com/posener/cmd) - Extends the standard `flag` package to support sub commands and more in idiomatic way.
*   [cmdr (⭐138)](https://github.com/hedzr/cmdr) - A POSIX/GNU style, getopt-like command-line UI Go library.
...
*   [console (⭐88)](https://github.com/reeflective/console) Closed-loop application library for Cobra commands, with oh-my-posh prompts, and more.
...
*   [hashicorp/cli (⭐21)](https://github.com/hashicorp/cli) - Go library for implementing command-line interfaces.
...
*   [readline (⭐109)](https://github.com/reeflective/readline) - Shell library with modern and easy to use UI features.
...
*   [bcl (⭐24)](https://github.com/wkhere/bcl) - BCL is a configuration language similar to HCL.
...
*   [config (⭐55)](https://github.com/num30/config) - configure your app using file, environment variables, or flags in two lines of code
...
*   [go-cfg (⭐45)](https://github.com/dsbasko/go-cfg) - The library provides a unified way to read configuration data into a structure from various sources, such as env, flags, and configuration files (.json, .yaml, .toml, .env).
...
*   [godotenv (⭐8.9k)](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
*   [gookit/config (⭐549)](https://github.com/gookit/config) - application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge.
...
*   [hocon (⭐83)](https://github.com/gurkankaymak/hocon) - Configuration library for working with the HOCON(a human-friendly JSON superset) format, supports features like environment variables, referencing other values, comments and multiple files.
...
*   [konf (⭐307)](https://github.com/nil-go/konf) - The simplest API for reading/watching config from file, env, flag and clouds (e.g. AWS, Azure, GCP).
...
*   [sonic (⭐7.7k)](https://github.com/bytedance/sonic) - A blazingly fast JSON serializing & deserializing library.
...
*   [xdg (⭐784)](https://github.com/adrg/xdg) - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/latest/) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
...
*   [go-semver-release (⭐11)](https://github.com/s0ders/go-semver-release) - Automate the semantic versioning of Git repositories.
*   [go-test-coverage (⭐138)](https://github.com/vladopajic/go-test-coverage) - Tool and GitHub action which reports issues when test coverage is below set threshold.
*   [gomason (⭐65)](https://github.com/nikogura/gomason) - Test, Build, Sign, and Publish your go binaries from a clean workspace.
*   [gotestfmt (⭐538)](https://github.com/GoTestTools/gotestfmt) - go test output for humans.
...
*   [woodpecker (⭐4.8k)](https://github.com/woodpecker-ci/woodpecker) - Woodpecker is a community fork of the Drone CI system.
...
*   [bingo (⭐43)](https://github.com/iancmcc/bingo) - Fast, zero-allocation, lexicographical-order-preserving packing of native types to bytes.
*   [binpacker (⭐224)](https://github.com/zhuangsirui/binpacker) - Binary packer and unpacker helps user build custom binary stream.
*   [bit (⭐162)](https://github.com/yourbasic/bit) - Golang set data structure with bonus bit-twiddling functions.
*   [crunch (⭐98)](https://github.com/superwhiskers/crunch) - Go package implementing buffers for handling various datatypes easily.
*   [go-ef (⭐35)](https://github.com/amallia/go-ef) - A Go implementation of the Elias-Fano encoding.
*   [roaring (⭐2.6k)](https://github.com/RoaringBitmap/roaring) - Go package implementing compressed bitsets.

### Bit Sets

*   [bitmap (⭐324)](https://github.com/kelindar/bitmap) - Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go.
...
*   [go-tuple (⭐86)](https://github.com/barweiss/go-tuple) - Generic tuple implementation for Go 1.18+.
...
*   [hyperloglog (⭐968)](https://github.com/axiomhq/hyperloglog) - HyperLogLog implementation with Sparse, LogLog-Beta bias correction and TailCut space reduction.
...
*   [deque (⭐192)](https://github.com/edwingeng/deque) - A highly optimized double-ended queue.
*   [deque (⭐658)](https://github.com/gammazero/deque) - Fast ring-buffer deque (double-ended queue).
*   [goconcurrentqueue (⭐419)](https://github.com/enriquebris/goconcurrentqueue) - Concurrent FIFO queue.
*   [hatchet (⭐4.6k)](https://github.com/hatchet-dev/hatchet) - Distributed, Fault-tolerant task queue.
*   [memlog (⭐130)](https://github.com/embano1/memlog) - An easy to use, lightweight, thread-safe and append-only in-memory data structure inspired by Apache Kafka.
*   [queue (⭐284)](https://github.com/adrianbrad/queue) - Multiple thread-safe, generic queue implementations for Go.
...
*   [go-adaptive-radix-tree (⭐385)](https://github.com/plar/go-adaptive-radix-tree) - Go implementation of Adaptive Radix Tree.
*   [go-edlib (⭐504)](https://github.com/hbollon/go-edlib) - Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode.
...
*   [levenshtein (⭐382)](https://github.com/agnivade/levenshtein) - Implementation to calculate levenshtein distance in Go.
...
*   [skiplist (⭐283)](https://github.com/MauriceGit/skiplist) - Very fast Go Skiplist implementation.
...
*   [EchoVault (⭐456)](https://github.com/EchoVault/EchoVault) - Embeddable Distributed in-memory data store compatible with Redis clients.
...
*   [go-cache (⭐148)](https://github.com/viney-shih/go-cache) - A flexible multi-layer Go caching library to deal with in-memory and shared cache by adopting Cache-Aside pattern.
*   [go-freelru (⭐226)](https://github.com/elastic/go-freelru) A GC-less, fast and generic LRU hashmap library with optional locking, sharding, eviction and expiration.
...
*   [pocache (⭐221)](https://github.com/naughtygopher/pocache) - Pocache is a minimal cache package which focuses on a preemptive optimistic caching strategy.
...
*   [theine (⭐288)](https://github.com/Yiling-J/theine-go) - High performance, near optimal in-memory cache with proactive TTL expiration and generics.
...
*   [bbolt (⭐8.6k)](https://github.com/etcd-io/bbolt) - An embedded key/value database for Go.
...
*   [clover (⭐730)](https://github.com/ostafen/clover) - A lightweight document-oriented NoSQL database written in pure Golang.
...
*   [libradb (⭐177)](https://github.com/amit-davidson/LibraDB) - LibraDB is a simple database with less than 1000 lines of code for learning.
...
*   [atlas (⭐6.6k)](https://github.com/ariga/atlas) - A Database Toolkit. A CLI designed to help companies better work with their data.
...
*   [dbmate (⭐5.8k)](https://github.com/amacneil/dbmate) - A lightweight, framework-agnostic database migration tool.
...
*   [goose (⭐8k)](https://github.com/pressly/goose) - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
*   [libschema (⭐16)](https://github.com/muir/libschema) - Define your migrations separately in each library. Migrations for open source libraries. MySQL & PostgreSQL.
...
*   [sqlize (⭐120)](https://github.com/sunary/sqlize) - Database migration generator. Allows generate sql migration from model and existing sql by differ them.

### Database Tools

*   [chproxy (⭐1.3k)](https://github.com/Vertamedia/chproxy) - HTTP proxy for ClickHouse database.
*   [clickhouse-bulk (⭐483)](https://github.com/nikepan/clickhouse-bulk) - Collects small inserts and sends big requests to ClickHouse servers.
...
*   [gatewayd (⭐240)](https://github.com/gatewayd-io/gatewayd) - Cloud-native database gateway and framework for building data-driven applications. Like API gateways, for databases.
...
*   [onedump (⭐157)](https://github.com/liweiyi88/onedump) - Database backup from different drivers to different destinations with one command and configuration.
...
*   [rdb (⭐475)](https://github.com/HDT3213/rdb) - Redis RDB file parser for secondary development and memory analysis.
...
*   [wescale (⭐289)](https://github.com/wesql/wescale) - WeScale is a database proxy designed to enhance the scalability, performance, security, and resilience of your applications.
...
*   [buildsqlx (⭐177)](https://github.com/arthurkushman/buildsqlx) - Go database query builder library for PostgreSQL.
...
*   [jet (⭐3k)](https://github.com/go-jet/jet) - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
*   [sqlf (⭐167)](https://github.com/leporo/sqlf) - Fast SQL query builder.
...
*   [go-transaction-manager (⭐276)](https://github.com/avito-tech/go-transaction-manager) - Transaction manager with multiple adapters (sql, sqlx, gorm, mongo, ...) controls transaction boundaries.
*   [gokv (⭐772)](https://github.com/philippgille/gokv) - Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more).
...
*   [firebirdsql (⭐232)](https://github.com/nakagami/firebirdsql) - Firebird RDBMS SQL driver for Go.
...
*   [go-sqlite3 (⭐620)](https://github.com/ncruces/go-sqlite3) - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
*   [godror (⭐547)](https://github.com/godror/godror) - Oracle driver for Go, using the ODPI-C driver.
*   [gofreetds (⭐113)](https://github.com/minus5/gofreetds) - Microsoft MSSQL driver. Go wrapper over [FreeTDS](https://www.freetds.org).
*   [KSQL (⭐331)](https://github.com/VinGarcia/ksql) - A Simple and Powerful Golang SQL Library
...
*   [Sqinn-Go (⭐443)](https://github.com/cvilsmeier/sqinn-go) - SQLite with pure Go.
...
*   [surrealdb.go (⭐270)](https://github.com/surrealdb/surrealdb.go) - SurrealDB Driver for Go.
*   [ydb-go-sdk (⭐150)](https://github.com/ydb-platform/ydb-go-sdk) - native and database/sql driver YDB (Yandex Database)

### NoSQL Database Drivers

*   [aerospike-client-go (⭐445)](https://github.com/aerospike/aerospike-client-go) - Aerospike client in Go language.
...
*   [Kivik (⭐318)](https://github.com/go-kivik/kivik) - Kivik provides a common Go and GopherJS client library for CouchDB, PouchDB, and similar databases.
...
*   [zoekt (⭐867)](https://github.com/sourcegraph/zoekt) - Fast trigram based code search.
...
*   [durafmt (⭐498)](https://github.com/hako/durafmt) - Time duration formatting library for Go.
...
*   [go-anytime (⭐28)](https://github.com/ijt/go-anytime) - Parse dates/times like "next dec 22nd at 3pm" and ranges like "from today until next thursday" without knowing the format in advance.
*   [go-datebin (⭐4)](https://github.com/deatil/go-datebin) - A simple datetime parse pkg.
*   [go-persian-calendar (⭐214)](https://github.com/yaa110/go-persian-calendar) - The implementation of the Persian (Solar Hijri) Calendar in Go (golang).
*   [go-str2duration (⭐111)](https://github.com/xhit/go-str2duration) - Convert string to duration. Support time.Duration returned string and more.
...
*   [bedrock (⭐11)](https://github.com/z5labs/bedrock) - Provides a minimal, modular and composable foundation for quickly developing services and more use case specific frameworks in Go.
*   [capillaries (⭐65)](https://github.com/capillariesio/capillaries) - distributed batch data processing framework.
...
*   [consistent (⭐722)](https://github.com/buraksezer/consistent) - Consistent hashing with bounded loads.
*   [consistenthash (⭐27)](https://github.com/mbrostami/consistenthash) - Consistent hashing with configurable replicas.
*   [dht (⭐325)](https://github.com/anacrolix/dht) - BitTorrent Kademlia DHT implementation.
...
*   [doublejump (⭐105)](https://github.com/edwingeng/doublejump) - A revamped Google's jump consistent hash.
...
*   [go-health (⭐749)](https://github.com/InVisionApp/go-health) - Library for enabling asynchronous dependency health checks in your service.
...
*   [jsonrpc (⭐341)](https://github.com/ybbus/jsonrpc) - JSON-RPC 2.0 HTTP client implementation.
*   [K8gb (⭐955)](https://github.com/k8gb-io/k8gb) - A cloud native Kubernetes Global Balancer.
...
*   [raft (⭐753)](https://github.com/etcd-io/raft) - Go implementation of the Raft consensus protocol, by CoreOS.
...
*   [Tarmac (⭐330)](https://github.com/tarmac-project/tarmac) - Framework for writing functions, microservices, or monoliths with WebAssembly
*   [Temporal (⭐590)](https://github.com/temporalio/sdk-go) - Durable execution system for making code fault-tolerant and simple.
*   [torrent (⭐5.7k)](https://github.com/anacrolix/torrent) - BitTorrent client package.
*   [trpc-go (⭐900)](https://github.com/trpc-group/trpc-go) - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
*   [go-email-normalizer (⭐68)](https://github.com/dimuska139/go-email-normalizer) - Golang library for providing a canonical representation of email address.
...
*   [go-mail (⭐907)](https://github.com/wneessen/go-mail) - A simple Go library for sending mails in Go.
*   [go-message (⭐400)](https://github.com/emersion/go-message) - Streaming library for the Internet Message Format and mail messages.
*   [go-premailer (⭐160)](https://github.com/vanng822/go-premailer) - Inline styling for HTML mail in Go.
*   [go-simple-mail (⭐662)](https://github.com/xhit/go-simple-mail) - Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send.
...
*   [mailgun-go (⭐714)](https://github.com/mailgun/mailgun-go) - Go library for sending mail with the Mailgun API.
*   [MailHog (⭐15k)](https://github.com/mailhog/MailHog) - Email and SMTP testing with web and API interface.
*   [Mailpit (⭐6.8k)](https://github.com/axllent/mailpit) - Email and SMTP testing tool for developers.
...
*   [mox (⭐4.7k)](https://github.com/mjl-/mox) - Modern full-featured secure mail server for low-maintenance, self-hosted email.
*   [SendGrid (⭐996)](https://github.com/sendgrid/sendgrid-go) - SendGrid's Go library for sending email.
...
*   [expr (⭐6.7k)](https://github.com/antonmedv/expr) - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
*   [gentee (⭐139)](https://github.com/gentee/gentee) - Embeddable scripting programming language.
*   [gisp (⭐519)](https://github.com/jcla1/gisp) - Simple LISP in Go.
...
*   [goja (⭐6k)](https://github.com/dop251/goja) - ECMAScript 5.1(+) implementation in Go.
*   [golua (⭐667)](https://github.com/aarzilli/golua) - Go bindings for Lua C API.
*   [gopher-lua (⭐6.5k)](https://github.com/yuin/gopher-lua) - Lua 5.1 VM and compiler written in Go.
*   [gval (⭐778)](https://github.com/PaesslerAG/gval) - A highly customizable expression language written in Go.
...
*   [prolog (⭐651)](https://github.com/ichiban/prolog) - Embeddable Prolog.
...
*   [emperror (⭐351)](https://github.com/emperror/emperror) - Error handling tools and best practices for Go libraries and applications.
...
*   [Fault (⭐174)](https://github.com/Southclaws/fault) - An ergonomic mechanism for wrapping errors in order to facilitate structured metadata and context for error values.
...
*   [oops (⭐598)](https://github.com/samber/oops) - Error handling with context, stack trace and source fragments.
...
*   [afs (⭐316)](https://github.com/viant/afs) - Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go.
*   [baraka (⭐60)](https://github.com/xis/baraka) - A library to process http file uploads easily.
*   [checksum (⭐108)](https://github.com/codingsince1985/checksum) - Compute message digest, like MD5, SHA256, SHA1, CRC or BLAKE2s, for large files.
*   [copy (⭐745)](https://github.com/otiai10/copy) - Copy directory recursively.
...
*   [gdu (⭐4.3k)](https://github.com/dundee/gdu) - Disk usage analyzer with console interface.
*   [go-csv-tag (⭐123)](https://github.com/artonge/go-csv-tag) - Load csv file using tag.
...
*   [gofs (⭐505)](https://github.com/no-src/gofs) - A cross-platform real-time file synchronization tool out of the box.
...
*   [notify (⭐914)](https://github.com/rjeczalik/notify) - File system event notification library with simple API, similar to os/signal.
*   [opc (⭐75)](https://github.com/qmuntal/opc) - Load Open Packaging Conventions (OPC) files for Go.
*   [parquet (⭐116)](https://github.com/parsyl/parquet) - Read and write [parquet](https://parquet.apache.org) files.
*   [pathtype (⭐12)](https://github.com/jonchun/pathtype) - Treat paths as their own type instead of using strings.
*   [pdfcpu (⭐7.4k)](https://github.com/pdfcpu/pdfcpu) - PDF processor.
...
*   [vfs (⭐327)](https://github.com/C2FO/vfs) - A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS.
...
*   [accounting (⭐887)](https://github.com/leekchan/accounting) - money and currency formatting for golang.
*   [ach (⭐478)](https://github.com/moov-io/ach) - A reader, writer, and validator for Automated Clearing House (ACH) files.
...
*   [currency (⭐579)](https://github.com/bojanz/currency) - Handles currency amounts, provides currency information and formatting.
...
*   [decimal (⭐142)](https://github.com/govalues/decimal) - Immutable decimal numbers with panic-free arithmetic.
...
*   [fpmoney (⭐33)](https://github.com/nikolaydubina/fpmoney) - Fast and simple ISO4217 fixed-point decimal money.
*   [go-finance (⭐178)](https://github.com/alpeb/go-finance) - Library of financial functions for time value of money (annuities), cash flow, interest rate conversions, bonds and depreciation calculations.
...
*   [go-finnhub (⭐92)](https://github.com/m1/go-finnhub) - Client for stock market, forex and crypto data from finnhub.io. Access real-time financial market data from 60+ stock exchanges, 10 forex brokers, and 15+ crypto exchanges.
...
*   [orderbook (⭐470)](https://github.com/i25959341/orderbook) - Matching Engine for Limit Order Book in Golang.
...
*   [techan (⭐854)](https://github.com/sdcoffey/techan) - Technical analysis library with advanced market analysis and trading strategies.
...
*   [udecimal (⭐131)](https://github.com/quagmt/udecimal) - High performance, high precision, zero allocation fixed-point decimal library for financial applications.
...
*   [form (⭐801)](https://github.com/go-playground/form) - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
*   [httpin (⭐338)](https://github.com/ggicci/httpin) - Decode an HTTP request into a custom struct, including querystring, forms, HTTP headers, etc.
...
*   [fp-go (⭐310)](https://github.com/repeale/fp-go) - Collection of Functional Programming helpers powered by Golang 1.18+ generics.
...
*   [go-functional (⭐491)](https://github.com/BooleanCat/go-functional) - Functional programming in Go using generics
...
*   [ecs (⭐138)](https://github.com/andygeiss/ecs) - Build your own Game-Engine based on the Entity Component System concept in Golang.
...
*   [fantasyname (⭐35)](https://github.com/s0rg/fantasyname) - Fantasy names generator.
*   [g3n (⭐2.9k)](https://github.com/g3n/engine) - Go 3D Game Engine.
*   [go-astar (⭐609)](https://github.com/beefsack/go-astar) - Go implementation of the A\* path finding algorithm.
...
*   [Harfang3D (⭐601)](https://github.com/harfang3d/harfang3d) - 3D engine for the Go language, works on Windows and Linux ([Harfang on Go.dev (⭐38)](https://github.com/harfang3d/harfang-go)).
...
*   [Pixel (⭐297)](https://github.com/gopxl/pixel) - Hand-crafted 2D game library in Go.
...
*   [tile (⭐182)](https://github.com/kelindar/tile) - Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export.
...
*   [copygen (⭐376)](https://github.com/switchupcb/copygen) - Generate any code based on Go types, including type-to-type converters (copy code) without reflection by default.
...
*   [go-enum (⭐808)](https://github.com/abice/go-enum) - Code generation for enums from code comments.
...
*   [goverter (⭐635)](https://github.com/jmattheis/goverter) - Generate converters by defining an interface.
*   [GoWrap (⭐1.2k)](https://github.com/hexdigest/gowrap) - Generate decorators for Go interfaces using simple templates.
*   [interfaces (⭐428)](https://github.com/rjeczalik/interfaces) - Command line tool for generating interface definitions.
*   [jennifer (⭐3.4k)](https://github.com/dave/jennifer) - Generate arbitrary Go code without templates.
*   [oapi-codegen (⭐6.8k)](https://github.com/deepmap/oapi-codegen) - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
*   [geoos (⭐511)](https://github.com/spatial-go/geoos) - A library provides spatial data and geometric algorithms.
...
*   [godal (⭐152)](https://github.com/airbusgeo/godal) - Go wrapper for GDAL.
*   [H3 (⭐334)](https://github.com/uber/h3-go) - Go bindings for H3, a hierarchical hexagonal geospatial indexing system.
...
*   [mbtileserver (⭐695)](https://github.com/consbio/mbtileserver) - A simple Go-based server for map tiles stored in mbtiles format.
*   [osm (⭐396)](https://github.com/paulmach/osm) - Library for reading, writing and working with OpenStreetMap data and APIs.
...
*   [esp32 (⭐90)](https://github.com/andygeiss/esp32-transpiler) - Transpile Go into Arduino code.
*   [f4go (⭐48)](https://github.com/Konstantin8105/f4go) - Transpile FORTRAN 77 code to Go code.
*   [go2hx (⭐120)](https://github.com/go2hx/go2hx) - Compiler from Go to Haxe to Javascript/C++/Java/C#.
...
*   [async (⭐11)](https://github.com/yaitoo/async) - An asynchronous task package with async/await style for Go.
*   [async (⭐238)](https://github.com/reugn/async) - An alternative sync library for Go (Future, Promise, Locks).
...
*   [conc (⭐9.8k)](https://github.com/sourcegraph/conc) - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
*   [flowmatic (⭐376)](https://github.com/carlmjohnson/flowmatic) - Structured concurrency made easy.
...
*   [go-actor (⭐200)](https://github.com/vladopajic/go-actor) - A tiny library for writing concurrent programs using actor model.
...
*   [gollback (⭐126)](https://github.com/vardius/gollback) - asynchronous simple function utilities, for managing execution of closures and callbacks.
...
*   [routine (⭐252)](https://github.com/timandy/routine) - `routine` is a `ThreadLocal` for go library. It encapsulates and provides some easy-to-use, non-competitive, high-performance `goroutine` context access interfaces, which can help you access coroutine context information more gracefully.
...
*   [cimgui-go (⭐392)](https://github.com/AllenDang/cimgui-go) - Auto generated Go wrapper for [Dear ImGui (⭐64k)](https://github.com/ocornut/imgui) via [cimgui (⭐1.6k)](https://github.com/cimgui/cimgui).
...
*   [energy (⭐436)](https://github.com/energye/energy) - Cross-platform based on LCL(Native System UI Control Library) and CEF(Chromium Embedded Framework) (Windows/ macOS / Linux)
...
*   [zenity (⭐788)](https://github.com/ncruces/zenity) - Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user.
...
*   [goroslib (⭐357)](https://github.com/aler9/goroslib) - Robot Operating System (ROS) library for Go.
...
*   [darkroom (⭐231)](https://github.com/gojek/darkroom) - An image proxy with changeable storage backends and image processing engines with focus on speed and resiliency.
...
*   [gltf (⭐253)](https://github.com/qmuntal/gltf) - Efficient and robust glTF 2.0 reader, writer and validator.
...
*   [go-qrcode (⭐645)](https://github.com/yeqown/go-qrcode) - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
*   [go-webcolors (⭐28)](https://github.com/jyotiska/go-webcolors) - Port of webcolors library from Python to Go.
*   [go-webp (⭐245)](https://github.com/kolesa-team/go-webp) - Library for encode and decode webp pictures, using libwebp.
*   [gocv (⭐6.9k)](https://github.com/hybridgroup/gocv) - Go package for computer vision using OpenCV 3.3+.
*   [goimagehash (⭐780)](https://github.com/corona10/goimagehash) - Go Perceptual image hashing package.
*   [goimghdr (⭐40)](https://github.com/corona10/goimghdr) - The imghdr module determines the type of image contained in a file for Go.
*   [govatar (⭐589)](https://github.com/o1egl/govatar) - Library and CMD tool for generating funny avatars.
...
*   [image2ascii (⭐909)](https://github.com/qeesung/image2ascii) - Convert image to ASCII.
...
*   [steganography (⭐331)](https://github.com/auyer/steganography) - Pure Go Library for LSB steganography.
...
*   [transformimgs (⭐252)](https://github.com/Pixboost/transformimgs) - Transformimgs resizes and optimises images for Web using next-generation formats.
...
*   [connectordb (⭐410)](https://github.com/connectordb/connectordb) - Open-Source Platform for Quantified Self & IoT.
...
*   [mainflux (⭐48)](https://github.com/Mainflux/mainflux) - Industrial IoT Messaging and Device Management Server.
*   [periph](https://periph.io/) - Peripherals I/O to interface with low-level board facilities.
*   [rulego (⭐1k)](https://github.com/rulego/rulego) - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
*   [cheek (⭐179)](https://github.com/datarootsio/cheek) - A simple crontab like scheduler that aims to offer a KISS approach to job scheduling.
*   [clockwerk (⭐170)](https://github.com/onatm/clockwerk) - Go package to schedule periodic jobs using a simple, fluent syntax.
...
*   [goflow (⭐429)](https://github.com/fieldryand/goflow) - A simple but powerful DAG scheduler and dashboard.
...
*   [gronx (⭐441)](https://github.com/adhocore/gronx) - Cron expression parser, task runner and daemon consuming crontab like task list.
...
*   [tasks (⭐310)](https://github.com/madflojo/tasks) - An easy to use in-process scheduler for recurring tasks in Go.
...
*   [ajson (⭐264)](https://github.com/spyzhov/ajson) - Abstract JSON for golang with JSONPath support.
...
*   [jsondiff (⭐553)](https://github.com/wI2L/jsondiff) - JSON diff library for Go based on RFC6902 (JSON Patch).
...
*   [marshmallow (⭐379)](https://github.com/PerimeterX/marshmallow) - Performant JSON unmarshalling for flexible use cases.
*   [mp (⭐47)](https://github.com/sanbornm/mp) - Simple cli email parser. It currently takes stdin and outputs JSON.
*   [OjG (⭐874)](https://github.com/ohler55/ojg) - Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath.
...
*   [httpretty (⭐407)](https://github.com/henvic/httpretty) - Pretty-prints your regular HTTP requests on your terminal for debugging (similar to http.DumpRequest).
...
*   [lazyjournal (⭐415)](https://github.com/Lifailon/lazyjournal) - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
*   [log (⭐294)](https://github.com/go-playground/log) - Simple, configurable and scalable Structured Logging for Go.
...
*   [phuslu/log (⭐734)](https://github.com/phuslu/log) - High performance structured logging.
...
*   [slog (⭐430)](https://github.com/gookit/slog) - Lightweight, configurable, extensible logger for Go.
*   [slog-formatter (⭐162)](https://github.com/samber/slog-formatter) - Common formatters for slog and helpers to build your own.
*   [slog-multi (⭐452)](https://github.com/samber/slog-multi) - Chain of slog.Handler (pipeline, fanout...).
...
*   [tint (⭐907)](https://github.com/lmittmann/tint) - A slog.Handler that writes tinted logs.
...
*   [go-deep (⭐543)](https://github.com/patrikeh/go-deep) - A feature-rich neural network library in Go.
...
*   [GoMind (⭐87)](https://github.com/surenderthakran/gomind) - A simplistic Neural Network Library in Go.
*   [goml (⭐1.6k)](https://github.com/cdipaolo/goml) - On-line Machine Learning in Go.
*   [GoMLX (⭐693)](https://github.com/gomlx/gomlx) - An accelerated Machine Learning framework for Go.
...
*   [hugot (⭐369)](https://github.com/knights-analytics/hugot) - Huggingface transformer pipelines for golang with onnxruntime.
...
*   [ocrserver (⭐724)](https://github.com/otiai10/ocrserver) - A simple OCR API server, seriously easy to be deployed by Docker and Heroku.
*   [onnx-go (⭐755)](https://github.com/owulveryck/onnx-go) - Go Interface to Open Neural Network Exchange (ONNX).
...
*   [Bus (⭐344)](https://github.com/mustafaturan/bus) - Minimalist message bus implementation for internal communication.
...
*   [mangos (⭐695)](https://github.com/nanomsg/mangos) - Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability.
...
*   [NATS Go Client (⭐5.8k)](https://github.com/nats-io/nats.go) - Go client for the NATS
    messaging system.
...
*   [rabtap (⭐266)](https://github.com/jandelgado/rabtap) - RabbitMQ swiss army knife cli app.
...
*   [Ratus (⭐118)](https://github.com/hyperonym/ratus) - Ratus is a RESTful asynchronous task queue server.
*   [redisqueue (⭐132)](https://github.com/robinjoseph08/redisqueue) - redisqueue provides a producer and consumer of a queue that uses Redis streams.
...
*   [Watermill (⭐8.2k)](https://github.com/ThreeDotsLabs/watermill) - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
*   [godocx (⭐151)](https://github.com/gomutex/godocx) - Library for reading and writing Microsoft Word (Docx) files.
...
*   [GoLobby/Container (⭐580)](https://github.com/golobby/container) - GoLobby Container is a lightweight yet powerful IoC dependency injection container for the Go programming language.
*   [gontainer (⭐41)](https://github.com/NVIDIA/gontainer) - A dependency injection service container for Go projects.
...
*   [go-blueprint (⭐7.1k)](https://github.com/Melkeydev/go-blueprint) - Allows users to spin up a quick Go project using a popular framework.
*   [go-module (⭐32)](https://github.com/octomation/go-module) - Template for a typical module written on Go.
*   [go-sample (⭐132)](https://github.com/zitryss/go-sample) - A sample layout for Go application projects with the real code.
*   [go-starter (⭐526)](https://github.com/allaboutapps/go-starter) - An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers.
*   [go-todo-backend (⭐325)](https://github.com/Fs02/go-todo-backend) - Go Todo Backend example using modular project layout for product microservice.
...
*   [golang-templates/seed (⭐507)](https://github.com/golang-templates/seed) - Go application GitHub repository template.
...
*   [gobeam/Stringy (⭐247)](https://github.com/gobeam/Stringy) - String manipulation library to convert string to camel case, snake case, kebab case / slugify etc.
...
*   [archives (⭐185)](https://github.com/mholt/archives) - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
*   [battery (⭐255)](https://github.com/distatus/battery) - Cross-platform, normalized battery information library.
...
*   [captcha (⭐158)](https://github.com/steambap/captcha) - Package captcha provides an easy to use, unopinionated API for captcha generation.
...
*   [gatus (⭐7.2k)](https://github.com/TwinProduction/gatus) - Automated service health dashboard.
...
*   [go-unarr (⭐289)](https://github.com/gen2brain/go-unarr) - Decompression library for RAR, TAR, ZIP and 7z archives.
...
*   [gountries (⭐412)](https://github.com/pariz/gountries) - Package that exposes country and subdivision data.
*   [gtree (⭐269)](https://github.com/ddddddO/gtree) - Provide CLI, Package and Web for tree output and directories creation from Markdown or programmatically.
*   [health (⭐802)](https://github.com/alexliesenfeld/health) - A simple and flexible health check library for Go.
...
*   [lk (⭐380)](https://github.com/hyperboloide/lk) - A simple licensing library for golang.
...
*   [numa (⭐33)](https://github.com/lrita/numa) - NUMA is a utility library, which is written in go. It help us to write some NUMA-AWARED code.
...
*   [persian (⭐89)](https://github.com/mavihq/persian) - Some utilities for Persian language in go.
...
*   [shortid (⭐946)](https://github.com/teris-io/shortid) - Distributed generation of super short, unique, non-sequential, URL friendly IDs.
...
*   [xz (⭐497)](https://github.com/ulikunitz/xz) - Pure golang package for reading and writing xz-compressed files.
...
*   [whatlanggo (⭐652)](https://github.com/abadojack/whatlanggo) - Natural language detection package for Go. Supports 84 languages and 24 scripts (writing systems e.g. Latin, Cyrillic, etc).
...
*   [kagome (⭐852)](https://github.com/ikawaha/kagome) - JP morphological analyzer written in pure Go.
...
*   [ctxi18n (⭐65)](https://github.com/invopop/ctxi18n/) - Context aware i18n with a short and consise API, pluralization, interpolation, and `fs.FS` support. YAML locale definitions are based on [Rails i18n](https://guides.rubyonrails.org/i18n.html).
...
*   [gotext (⭐452)](https://github.com/leonelquinteros/gotext) - GNU gettext utilities for Go.
...
*   [arp (⭐371)](https://github.com/mdlayher/arp) - Package arp implements the ARP protocol, as described in RFC 826.
*   [bart (⭐58)](https://github.com/gaissmai/bart) - Package bart provides a fast routing table algorithm.
...
*   [cidranger (⭐924)](https://github.com/yl2chen/cidranger) - Fast IP to CIDR lookup for Go.
...
*   [dnsmonster (⭐324)](https://github.com/mosajjal/dnsmonster) - Passive DNS Capture/Monitoring Framework.
...
*   [ftpserverlib (⭐445)](https://github.com/fclairamb/ftpserverlib) - Fully featured FTP server library.
...
*   [fwdctl (⭐63)](https://github.com/alegrey91/fwdctl) - A simple and intuitive CLI to manage IPTables forwards in your Linux server.
...
*   [gmqtt (⭐994)](https://github.com/DrmagicE/gmqtt) - Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1.
...
*   [go-stun (⭐692)](https://github.com/ccding/go-stun) - Go implementation of the STUN client (RFC 3489 and RFC 5389).
...
*   [natiu-mqtt (⭐91)](https://github.com/soypat/natiu-mqtt) - A dead-simple, non-allocating, low level implementation of MQTT well suited for embedded systems.
...
*   [peerdiscovery (⭐654)](https://github.com/schollz/peerdiscovery) - Pure Go library for cross-platform local peer discovery using UDP multicast.
...
*   [psql-wire (⭐133)](https://github.com/jeroenrinzema/psql-wire) - PostgreSQL server wire protocol. Build your own server and start serving connections..
...
*   [sdns (⭐979)](https://github.com/semihalev/sdns) - A high-performance, recursive DNS resolver server with DNSSEC support, focused on preserving privacy.
...
*   [vssh (⭐966)](https://github.com/yahoo/vssh) - Go library for building network and server automation over SSH protocol.
...
*   [winrm (⭐435)](https://github.com/masterzen/winrm) - Go WinRM client to remotely execute commands on Windows machines.
...
*   [axios4go (⭐22)](https://github.com/rezmoss/axios4go) - A Go HTTP client library inspired by Axios, providing a simple and intuitive API for making HTTP requests.
*   [azuretls-client (⭐215)](https://github.com/Noooste/azuretls-client) -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
*   [go-cleanhttp (⭐389)](https://github.com/hashicorp/go-cleanhttp) - Get easily stdlib HTTP client, which does not share any state with other clients.
...
*   [tls-client (⭐1k)](https://github.com/bogdanfinn/tls-client) - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
*   [bob (⭐947)](https://github.com/stephenafamo/bob) - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
...
*   [rel (⭐779)](https://github.com/go-rel/rel) - Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API.
...
*   [gup (⭐390)](https://github.com/nao1215/gup) - Update binaries installed by "go install".
...
*   [syft (⭐6.7k)](https://github.com/anchore/syft) - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
*   [go-instrument (⭐251)](https://github.com/nikolaydubina/go-instrument) - Automatically add spans to all methods and functions.
*   [jaeger (⭐21k)](https://github.com/jaegertracing/jaeger) - A distributed tracing system.
*   [mm-go (⭐161)](https://github.com/joetifa2003/mm-go) - Generic manual memory management for golang.
*   [pixie (⭐5.9k)](https://github.com/pixie-labs/pixie) - No instrumentation tracing for Golang applications via eBPF.
...
*   [rql (⭐350)](https://github.com/a8m/rql) - Resource Query Language for REST API.
*   [rqp (⭐81)](https://github.com/timsolov/rest-query-parser) - Query Parser for REST API. Filtering, validations, both `AND`, `OR` operations are supported directly in the query.
...
*   [Deepcopier (⭐454)](https://github.com/ulule/deepcopier) - Simple struct copying for Go.
*   [go-deepcopy (⭐46)](https://github.com/tiendc/go-deepcopy) - Fast deep copy library.
*   [goenum (⭐13)](https://github.com/lvyahui8/goenum) - A common enumeration struct based on generics and reflection that allows you to quickly define enumerations and use a set of useful default methods.
...
*   [ewma (⭐442)](https://github.com/VividCortex/ewma) - Exponentially-weighted moving averages.
*   [geom (⭐55)](https://github.com/skelterjohn/geom) - 2D geometry for golang.
*   [go-dsp (⭐871)](https://github.com/mjibson/go-dsp) - Digital Signal Processing for Go.
...
*   [go-hep (⭐235)](https://github.com/go-hep/hep) - A set of libraries and tools for performing High Energy Physics analyses with ease.
...
*   [graph (⭐717)](https://github.com/yourbasic/graph) - Library of basic graph algorithms.
...
*   [orb (⭐954)](https://github.com/paulmach/orb) - 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support.
...
*   [Poly (⭐691)](https://github.com/bebop/poly) - A Go package for engineering organisms.
...
*   [TextRank (⭐210)](https://github.com/DavidBelicza/TextRank) - TextRank implementation in Golang with extendable features (summarization, weighting, phrase extraction) and multithreading (goroutine) support.
...
*   [beelzebub (⭐879)](https://github.com/mariocandela/beelzebub) - A secure low code honeypot framework, leveraging AI for System Virtualization.
*   [booster (⭐560)](https://github.com/anatol/booster) - Fast initramfs generator with full-disk encryption support.
...
*   [Coraza (⭐2.5k)](https://github.com/corazawaf/coraza) - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
*   [dongle (⭐972)](https://github.com/golang-module/dongle) - A simple, semantic and developer-friendly golang package for encoding\&decoding and encryption\&decryption.
...
*   [go-htpasswd (⭐43)](https://github.com/tg123/go-htpasswd) - Apache htpasswd Parser for Go.
*   [go-password-validator (⭐522)](https://github.com/lane-c-wagner/go-password-validator) - Password validator based on raw cryptographic entropy values.
*   [go-peer (⭐284)](https://github.com/number571/go-peer) - A software library for creating secure and anonymous decentralized systems.
*   [go-yara (⭐365)](https://github.com/hillu/go-yara) - Go Bindings for [YARA (⭐138)](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)".
...
*   [nacl (⭐546)](https://github.com/kevinburke/nacl) - Go implementation of the NaCL set of API's.
...
*   [cbor (⭐831)](https://github.com/fxamacker/cbor) - Small, safe, and easy CBOR encoding and decoding library.
*   [colfer (⭐750)](https://github.com/pascaldekloe/colfer) - Code generation for the Colfer binary format.
*   [csvutil (⭐956)](https://github.com/jszwec/csvutil) - High Performance, idiomatic CSV record encoding and decoding to native Go structures.
...
*   [Clace (⭐575)](https://github.com/claceio/clace) - Clace makes internal tool deployment and management easy by implementing an app server for containerized webapps.
*   [consul](https://www.consul.io/) - Consul is a tool for service discovery, monitoring and configuration.
*   [cortex-tenant (⭐117)](https://github.com/blind-oracle/cortex-tenant) - Prometheus remote write proxy that adds add Cortex tenant ID header based on metric labels.
...
*   [Euterpe (⭐551)](https://github.com/ironsmile/euterpe) - Self-hosted music streaming server with built-in web UI and REST API.
...
*   [go-proxy-cache (⭐137)](https://github.com/fabiocicerchia/go-proxy-cache) - Simple Reverse Proxy with Caching, written in Go, using Redis.
...
*   [go-etl (⭐136)](https://github.com/Breeze0806/go-etl) - A lightweight toolkit for data source extraction, transformation, and loading (ETL).
...
*   [raymond (⭐619)](https://github.com/aymerick/raymond) - Complete handlebars implementation in Go.
...
*   [sprout (⭐155)](https://github.com/go-sprout/sprout) - Useful template functions for Go templates.
...
*   [templ (⭐9k)](https://github.com/a-h/templ) - A HTML templating language that has great developer tooling.
...
*   [be (⭐106)](https://github.com/carlmjohnson/be) - The minimalist generic test assertion library.
...
*   [cupaloy (⭐314)](https://github.com/bradleyjkemp/cupaloy) - Simple snapshot testing addon for your test framework.
...
*   [go-snaps (⭐195)](http://github.com/gkampitakis/go-snaps) - Jest-like snapshot testing in Golang.
...
*   [goc (⭐843)](https://github.com/qiniu/goc) - Goc is a comprehensive coverage testing system for The Go Programming Language.
...
*   [gotest.tools (⭐541)](https://github.com/gotestyourself/gotest.tools) - A collection of packages to augment the go testing package and support common patterns.
...
*   [jsonassert (⭐133)](https://github.com/kinbiko/jsonassert) - Package for verifying that your JSON payloads are serialized correctly.
*   [keploy (⭐6.6k)](https://github.com/keploy/keploy) - Generate Testcase and Data Mocks from API calls automatically.
...
*   [go-txdb (⭐702)](https://github.com/DATA-DOG/go-txdb) - Single transaction based database driver mainly for testing purposes.
...
*   [minimock (⭐666)](https://github.com/gojuno/minimock) - Mock generator for Go interfaces.
...
*   [pgxmock (⭐446)](https://github.com/pashagolub/pgxmock) - A mock library implementing [pgx - PostgreSQL Driver and Toolkit (⭐11k)](https://github.com/jackc/pgx/).
*   [timex (⭐71)](https://github.com/cabify/timex) - A test-friendly replacement for the native `time` package.
*   [xgo (⭐391)](https://github.com/xhd2015/xgo) - A general pureposed function mocking library.
...
*   [cdp (⭐748)](https://github.com/mafredri/cdp) - Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it.
...
*   [playwright-go (⭐2.5k)](https://github.com/mxschmitt/playwright-go) - browser automation library to control Chromium, Firefox and WebKit with a single API.
*   [rod (⭐5.8k)](https://github.com/go-rod/rod) - A Devtools driver to make web automation and scraping easy.
...
*   [failpoint (⭐841)](https://github.com/pingcap/failpoint) - An implementation of [failpoints](https://www.freebsd.org/cgi/man.cgi?query=fail) for Golang.
...
*   [bytes (⭐548)](https://github.com/labstack/gommon/tree/master/bytes) - Formats and parses numeric byte values (10K, 2M, 3G, etc.).
*   [go-fixedwidth (⭐84)](https://github.com/ianlopshire/go-fixedwidth) - Fixed-width text formatting (encoder/decoder with reflection).
...
*   [goq (⭐266)](https://github.com/andrewstuart/goq) - Declarative unmarshalling of HTML using struct tags with jQuery syntax (uses GoQuery).
...
*   [htmlquery (⭐762)](https://github.com/antchfx/htmlquery) - An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression.
...
*   [go-nmea (⭐239)](https://github.com/adrianmo/go-nmea) - NMEA parser library for the Go language.
...
*   [godump (⭐193)](https://github.com/yassinebenaid/godump) - Pretty print any GO variable with ease, an alternative to Go's `fmt.Printf("%#v")`.
...
*   [sh (⭐7.6k)](https://github.com/mvdan/sh) - Shell parser and formatter.
*   [tokenizer (⭐121)](https://github.com/bzick/tokenizer) - Parse any string, slice or infinite buffer to any tokens.
...
*   [rex (⭐202)](https://github.com/hedhyw/rex) - Regular expressions builder.
...
*   [dataflowkit (⭐680)](https://github.com/slotix/dataflowkit) - Web scraping Framework to turn websites into structured data.
...
*   [go-runewidth (⭐629)](https://github.com/mattn/go-runewidth) - Functions to get fixed width of the character or string.
...
*   [disgo (⭐97)](https://github.com/switchupcb/disgo) - Go API Wrapper for the Discord API.
...
*   [go-atlassian (⭐145)](https://github.com/ctreminiom/go-atlassian) - Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud)
...
*   [go-openai (⭐9.8k)](https://github.com/sashabaranov/go-openai) - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
*   [go-redoc (⭐84)](https://github.com/mvrilo/go-redoc) - Embedded OpenAPI/Swagger documentation ui for Go using [ReDoc](https://redocly.com/).
...
*   [go-salesforce (⭐37)](https://github.com/k-capehart/go-salesforce) - Go client library for interacting with the [Salesforce REST API](https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/resources_list.htm).
...
*   [GoFreeDB (⭐83)](https://github.com/FreeLeh/GoFreeDB) - Golang library providing common and simple database abstractions on top of Google Sheets.
...
*   [gosip (⭐155)](https://github.com/koltyakov/gosip) - Client library for SharePoint.
...
*   [lark (⭐432)](https://github.com/chyroc/lark) - [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback.
...
*   [openaigo (⭐293)](https://github.com/otiai10/openaigo) - OpenAI GPT3/GPT3.5 ChatGPT API client library for Go.
*   [patreon-go (⭐43)](https://github.com/mxpv/patreon-go) - Go library for Patreon API.
*   [paypal (⭐712)](https://github.com/logpacker/PayPal-Go-SDK) - Wrapper for PayPal payment API.
...
*   [Trello (⭐221)](https://github.com/adlio/trello) - Go wrapper for the Trello API.
...
*   [webhooks (⭐974)](https://github.com/go-playground/webhooks) - Webhook receiver for GitHub and Bitbucket.
*   [wit-go (⭐164)](https://github.com/wit-ai/wit-go) - Go client for wit.ai HTTP API.
...
*   [backscanner (⭐66)](https://github.com/icza/backscanner) - A scanner similar to bufio.Scanner, but it reads and returns lines in reverse order, starting at a given position and going backward.
...
*   [changie (⭐739)](https://github.com/miniscruff/changie) - Automated changelog tool for preparing releases with lots of customization options.
...
*   [clipboard (⭐660)](https://github.com/golang-design/clipboard) - 📋 cross-platform clipboard package in Go.
*   [clockwork (⭐685)](https://github.com/jonboulle/clockwork) - A simple fake clock for golang.
...
*   [config-file-validator (⭐370)](https://github.com/Boeing/config-file-validator) - Cross Platform tool to validate configuration files.
...
*   [countries (⭐432)](https://github.com/biter777/countries) - Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standards.
...
*   [fzf (⭐69k)](https://github.com/junegunn/fzf) - Command-line fuzzy finder written in Go.
...
*   [git-time-metric (⭐991)](https://github.com/git-time-metric/gtm) - Simple, seamless, lightweight time tracking for Git.
...
*   [goval (⭐164)](https://github.com/maja42/goval) - Evaluate arbitrary expressions in Go.
...
*   [grofer (⭐369)](https://github.com/pesos/grofer) - A system and resource monitoring tool written in Golang!
...
*   [immortal (⭐812)](https://github.com/immortal/immortal) - \*nix cross-platform (OS agnostic) supervisor.
...
*   [json-log-viewer (⭐147)](https://github.com/hedhyw/json-log-viewer) - Interactive viewer for JSON logs.
...
*   [limiters (⭐533)](https://github.com/mennanov/limiters) - Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks.
...
*   [mani (⭐467)](https://github.com/alajmo/mani) - CLI tool to help you manage multiple repositories.
...
*   [nostromo (⭐145)](https://github.com/pokanop/nostromo) - CLI for building powerful aliases.
...
*   [pgo (⭐87)](https://github.com/arthurkushman/pgo) - Convenient functions for PHP community.
...
*   [remote-touchpad (⭐582)](https://github.com/Unrud/remote-touchpad) - Control mouse and keyboard from a smartphone.
...
*   [rospo (⭐325)](https://github.com/ferama/rospo) - Simple and reliable ssh tunnels with embedded ssh server in Golang.
*   [scan (⭐585)](https://github.com/blockloop/scan) - Scan golang `sql.Rows` directly to structs, slices, or primitive types.
...
*   [serve (⭐336)](https://github.com/syntaqx/serve) - A static http server anywhere you need.
*   [sesh (⭐889)](https://github.com/joshmedeski/sesh) - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
*   [upterm (⭐909)](https://github.com/owenthereal/upterm) - A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.
...
*   [wifiqr (⭐268)](https://github.com/reugn/wifiqr) - Wi-Fi QR Code Generator.
...
*   [go-validator (⭐29)](https://github.com/tiendc/go-validator) - Validation library using Generics.
*   [gody (⭐124)](https://github.com/guiferpa/gody) - :balloon: A lightweight struct validator for Go.
*   [govalid (⭐82)](https://github.com/twharmon/govalid) - Fast, tag-based validation for structs.
...
*   [Zog (⭐730)](https://github.com/Oudwins/zog) - A [Zod (⭐36k)](https://github.com/colinhacks/zod) inspired schema builder for runtime value parsing and validation.
    **[⬆ back to top](#contents)**
...
*   [githooks (⭐108)](https://github.com/gabyx/githooks) - Per-repo and shared Git hooks with version control and auto update.
*   [go-git (⭐6.3k)](https://github.com/go-git/go-git) - highly extensible Git implementation in pure Go.
...
*   [gmf (⭐905)](https://github.com/3d0c/gmf) - Go bindings for FFmpeg av\* libraries.
*   [go-astiav (⭐456)](https://github.com/asticode/go-astiav) - Better C bindings for ffmpeg in GO.
*   [go-astisub (⭐619)](https://github.com/asticode/go-astisub) - Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.).
*   [go-astits (⭐559)](https://github.com/asticode/go-astits) - Parse and demux MPEG Transport Streams (.ts) natively in GO.
...
*   [mp4ff (⭐506)](https://github.com/Eyevinn/mp4ff) - Library and tools for working with MP4 files containing video, audio, subtitles, or metadata.
...
*   [Fastschema (⭐403)](https://github.com/fastschema/fastschema) - A flexible Go web framework and Headless CMS.
*   [Fiber (⭐35k)](https://github.com/gofiber/fiber) - An Express.js inspired web framework build on Fasthttp.
*   [Flamingo (⭐505)](https://github.com/i-love-flamingo/flamingo) - Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc.
*   [Flamingo Commerce (⭐547)](https://github.com/i-love-flamingo/flamingo-commerce) - Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications.
...
*   [Ginrpc (⭐294)](https://github.com/xxjwxc/ginrpc) - Gin parameter automatic binding tool,gin rpc tools.
...
*   [GoFr (⭐4.8k)](https://github.com/gofr-dev/gofr) - Gofr is an opinionated microservice development framework.
...
*   [goravel (⭐3.5k)](https://github.com/goravel/goravel) - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
*   [Hertz (⭐6k)](https://github.com/cloudwego/hertz) - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
*   [Huma (⭐2.8k)](https://github.com/danielgtaylor/huma/) - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
*   [iWF (⭐545)](https://github.com/indeedeng/iwf) - iWF is an all-in-one platform for developing long-running business processes. It offers a convenient abstraction for utilizing databases, ElasticSearch, message queues, durable timers, and more, with a clean, simple, and user-friendly interface.
...
*   [Microservice (⭐117)](https://github.com/claygod/microservice) - The framework for the creation of microservices, written in Golang.
...
*   [Yokai (⭐680)](https://github.com/ankorstore/yokai) - Simple, modular, and observable Go framework for backend applications.
...
*   [Goji (⭐970)](https://github.com/goji/goji) - Goji is a minimalistic and flexible HTTP request multiplexer with support for `net/context`.
...
*   [dom (⭐493)](https://github.com/dennwc/dom) - DOM library.
*   [Extism Go SDK (⭐107)](https://github.com/extism/go-sdk) - Universal, cross-language WebAssembly framework for building plug-in systems and polyglot apps.
...
*   [wasmbrowsertest (⭐195)](https://github.com/agnivade/wasmbrowsertest) - Run Go WASM tests in your browser.
...
*   [WebhookX (⭐144)](https://github.com/webhookx-io/webhookx) - A webhooks gateway for message receiving, processing, and reliable delivering.
...
*   [go-taskflow (⭐472)](https://github.com/noneback/go-taskflow) - A taskflow-like General-purpose Task-parallel Programming Framework with integrated visualizer and profiler.
*   [workflow (⭐145)](https://github.com/luno/workflow) - A tech stack agnostic Event Driven Workflow framework.
...
*   [xmlquery (⭐462)](https://github.com/antchfx/xmlquery) - xmlquery is Golang XPath package for XML query.
*   [xmlwriter (⭐28)](https://github.com/shabbyrobe/xmlwriter) - Procedural XML generation API based on libxml2's xmlwriter module.
*   [xpath (⭐705)](https://github.com/antchfx/xpath) - XPath package for Go.
...
*   [Cosign (⭐4.8k)](https://github.com/sigstore/cosign) - Container Signing, Verification and Storage in an OCI registry.
*   [in-toto (⭐136)](https://github.com/in-toto/in-toto-golang) - Go implementation of the in-toto (provides a framework to protect the integrity of the software supply chain) python reference implementation.
*   [OpenZiti (⭐3.2k)](https://github.com/openziti/ziti) - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang (⭐102)](https://github.com/openziti/sdk-golang) allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh (⭐39)](https://github.com/openziti-test-kitchen/zssh)
...
*   [asty (⭐84)](https://github.com/asty-org/asty) - Converts golang AST to JSON and JSON to AST.
...
*   [fatcontext (⭐28)](https://github.com/Crocmagnon/fatcontext) - Fatcontext detects nested contexts in loops or function literals.
...
*   [go-cleanarch (⭐916)](https://github.com/roblaszczak/go-cleanarch) - go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects.
...
*   [go-mod-outdated (⭐654)](https://github.com/psampaz/go-mod-outdated) - An easy way to find outdated dependencies of your Go projects.
...
*   [goreturns (⭐532)](https://github.com/sqs/goreturns) - Adds zero-value return statements to match the func return types.
...
*   [php-parser (⭐947)](https://github.com/z7zmey/php-parser) - A Parser for PHP written in Go.
*   [revive (⭐5k)](https://github.com/mgechev/revive) – \~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
...
*   [testifylint (⭐127)](https://github.com/Antonboom/testifylint) – A linter that checks usage of [github.com/stretchr/testify (⭐24k)](https://github.com/stretchr/testify).
...
*   [todocheck (⭐430)](https://github.com/preslavmihaylov/todocheck) - Static code analyser which links TODO comments in code with issues in your issue tracker.
...
*   [vacuum (⭐733)](https://github.com/daveshanley/vacuum) - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
*   [validate (⭐62)](https://github.com/mccoyst/validate) - Automatically validates struct fields with tags.
*   [wrapcheck (⭐324)](https://github.com/tomarrell/wrapcheck) - A linter to check that errors from external packages are wrapped.
...
*   [goimports-reviser (⭐642)](https://github.com/incu6us/goimports-reviser) - Formatting tool for imports.
...
*   [gocontracts (⭐112)](https://github.com/Parquery/gocontracts) - brings design-by-contract to Go by synchronizing the code with the documentation.
...
*   [xgen (⭐355)](https://github.com/xuri/xgen) - XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.
...
*   [MoniGO (⭐263)](https://github.com/iyashjayesh/monigo) - A performance monitoring library for Go applications. It provides real-time insights into application performance! 🚀
...
*   [alaz (⭐678)](https://github.com/ddosify/alaz) - Effortless, Low-Overhead, eBPF-based Kubernetes Monitoring.
...
*   [cassowary (⭐782)](https://github.com/rogerwelin/cassowary) - Modern cross-platform HTTP load-testing tool written in Go.
*   [Ddosify (⭐8.5k)](https://github.com/ddosify/ddosify) - High-performance load testing tool, written in Golang.
*   [decompose (⭐95)](https://github.com/s0rg/decompose) - tool to generate and process Docker containers connections graphs.
...
*   [docker-go-mingw (⭐50)](https://github.com/x1unix/docker-go-mingw) - Docker image for building Go binaries for Windows with MinGW toolchain.
*   [Dockerfile-Generator (⭐175)](https://github.com/ozankasikci/dockerfile-generator) - A go library and an executable that produces valid Dockerfiles using various input channels.
...
*   [drone-scp (⭐147)](https://github.com/appleboy/drone-scp) - Copy files and artifacts via SSH using a binary, docker or Drone CI.
...
*   [gobrew (⭐392)](https://github.com/kevincobain2000/gobrew) - Go version manager. Super simple tool to install and manage Go versions. Install go without root. Gobrew doesn't require shell rehash.
...
*   [kool (⭐676)](https://github.com/kool-dev/kool) - Command line tool for managing Docker environments as an easy way.
*   [kubeblocks (⭐2.6k)](https://github.com/apecloud/kubeblocks) - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
*   [kubernetes (⭐114k)](https://github.com/kubernetes/kubernetes) - Container Cluster Manager from Google.
...
*   [Mantil (⭐111)](https://github.com/mantil-io/mantil) - Go specific framework for building serverless applications on AWS that enables you to focus on pure Go code while Mantil takes care of the infrastructure.
...
*   [Pewpew (⭐425)](https://github.com/bengadbois/pewpew) - Flexible HTTP command line stress tester.
...
*   [s3-proxy (⭐326)](https://github.com/oxyno-zeta/s3-proxy) - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
*   [Scaleway-cli (⭐905)](https://github.com/scaleway/scaleway-cli) - Manage BareMetal Servers from Command Line (as easily as with Docker).
...
*   [skm (⭐964)](https://github.com/TimothyYe/skm) - SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily!
...
*   [tau (⭐3.8k)](https://github.com/taubyte/tau) - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
*   [tf-profile (⭐157)](https://github.com/datarootsio/tf-profile) - Profiler for Terraform runs. Generate global stats, resource-level stats or visualizations.
...
*   [Chapar (⭐544)](https://github.com/chapar-rest/chapar) - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
*   [crawley (⭐288)](https://github.com/s0rg/crawley) - Web scraper/crawler for cli.
...
*   [fjira (⭐170)](https://github.com/mk-5/fjira) - A fuzzy-search based terminal UI application for Attlasian Jira
...
*   [gocc (⭐630)](https://github.com/goccmack/gocc) - Gocc is a compiler kit for Go written in Go.
...
*   [GoNB (⭐796)](https://github.com/janpfeifer/gonb) - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
...
*   [hotswap (⭐380)](https://github.com/edwingeng/hotswap) - A complete solution to reload your go code without restarting your server, interrupting or blocking any ongoing procedure.
...
*   [joincap (⭐215)](https://github.com/assafmo/joincap) - Command-line utility for merging multiple pcap files together.
...
*   [Neo-cowsay (⭐322)](https://github.com/Code-Hex/Neo-cowsay) - 🐮 cowsay is reborn. for a New Era.
...
*   [sake (⭐656)](https://github.com/alajmo/sake) - sake is a command runner for local and remote hosts.
...
*   [stew (⭐220)](https://github.com/marwanhawari/stew) - An independent package manager for compiled binaries.
...
*   [woke (⭐479)](https://github.com/get-woke/woke) - Detect non-inclusive language in your source code.
*   [yai (⭐760)](https://github.com/ekkinox/yai) - AI powered terminal assistant.
...
*   [gospeed (⭐124)](https://github.com/feyeleanor/GoSpeed) - Go micro-benchmarks for calculating the speed of language constructs.
...
*   [Build a blockchain from scratch in Go with gRPC (⭐360)](https://github.com/volodymyrprokopyuk/go-blockchain) - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC.
...
*   [gophericons (⭐618)](https://github.com/shalakhin/gophericons)
*   [gopherize.me (⭐719)](https://github.com/matryer/gopherize.me) - Gopherize yourself.
...
*   [gophers (⭐150)](https://github.com/sillecelik/go-gopher) - Gopher amigurumi toy pattern.
...
*   [Awesome Golang Workshops (⭐517)](https://github.com/amit-davidson/awesome-golang-workshops) - A curated list of awesome golang workshops.
...
*   [Go in 7 days (⭐148)](https://github.com/harrytran103/7_days_of_go) - Learn everything about Go in 7 days (from a Nodejs developer).
...
*   [go-clean-template (⭐6.6k)](https://github.com/evrone/go-clean-template) - Clean Architecture template for Golang services.
*   [go-patterns (⭐26k)](https://github.com/tmrts/go-patterns) - Curated list of Go design patterns, recipes and idioms.
*   [goapp (⭐945)](https://github.com/naughtygopher/goapp) - An opinionated guideline to structure & develop a Go web application/service.
