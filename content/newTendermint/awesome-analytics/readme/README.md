...
A curated list of awesome analytics platforms, resources and other awesomeness. Inspired by [awesome-bigdata (⭐11k)](https://github.com/onurakpolat/awesome-bigdata).
...
*   [EDA](https://eda.jortilles.com/en/jortilles-english/) - Open source analytics/BI tool.  ([Source Code (⭐62)](https://github.com/jortilles/EDA)) `Apache-2.0` `Angular/Nodejs`
