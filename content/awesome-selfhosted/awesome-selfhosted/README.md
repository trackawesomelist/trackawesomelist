...
[🏠 Home](/README.md) · [🔍 Search](https://www.trackawesomelist.com/search/) · [🔥 Feed](https://www.trackawesomelist.com/awesome-selfhosted/awesome-selfhosted/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) · ⭐ 180K · 🏷️ Miscellaneous
...
*   [Ocular (⭐25)](https://github.com/simonwep/ocular) - Simplistic and straightforward budgeting app to track your budget across months and years. ([Demo](https://ocular.reinisch.io/#demo)) `MIT` `Docker`

## [May 03, 2024](/content/2024/05/03/README.md)

### Software / Media Streaming - Audio Streaming

*   [Pinepods](https://www.pinepods.online/) - A rust based podcast management system with multi-user support. Pinepods utilizes a central database so aspects like listen time and themes follow from device to device. ([Demo](https://try.pinepods.online), [Source Code (⭐124)](https://github.com/madeofpendletonwool/PinePods)) `GPL-3.0` `Docker`
...
*   [multi-scrobbler](https://foxxmd.github.io/multi-scrobbler) - Scrobble plays from multiple sources to multiple scrobbling services. ([Source Code (⭐278)](https://github.com/FoxxMD/multi-scrobbler)) `MIT` `Nodejs/Docker`
...
*   [HortusFox](https://hortusfox.github.io) - A collaborative plant management system. ([Source Code (⭐435)](https://github.com/danielbrendel/hortusfox-web)) `MIT` `PHP/Docker`
...
*   [OpenSlides](https://openslides.com/) - A web based presentation and assembly system for managing and projecting agenda, motions and elections of an assembly. ([Demo](https://demo.os4.openslides.com/login), [Source Code (⭐478)](https://github.com/OpenSlides/OpenSlides)) `MIT` `Docker`
...
*   [Kyoo (⭐1.2k)](https://github.com/zoriya/kyoo) - Innovative media browser designed for seamless streaming of anime, series and movies, offering advanced features like dynamic transcoding, auto watch history and intelligent metadata retrieval. ([Demo](https://kyoo.zoriya.dev)) `GPL-3.0` `Docker`
...
*   [ryot (⭐1.6k)](https://github.com/ignisda/ryot) - Platform for tracking various facets of your life - media, fitness, etc. ([Demo (⭐1.6k)](https://github.com/IgnisDa/ryot?tab=readme-ov-file#-demo)) `GPL-3.0` `Docker`

### Software / Software Development - API Management

*   [Panora](https://panora.dev) `⚠` - An API to add an integration catalog to your SaaS product in minutes (alternative to Merge.dev). ([Source Code (⭐263)](https://github.com/panoratech/Panora)) `AGPL-3.0` `Nodejs/Docker`
...
*   [HoloPlay](https://app.holoplay.io) `⚠` - Web app using Invidious API for listening to Youtube audio sources. ([Source Code (⭐79)](https://github.com/stephane-r/holoplay-pwa)) `MIT` `Nodejs/Docker`

### Software / Software Development - Low Code

*   [CASE](https://case.app) - Lightweight BaaS (Backend As A Service) requiring minimal coding, with database, admin panel, API, and Javascript SDK. ([Source Code (⭐226)](https://github.com/casejs/case)) `MIT` `Nodejs`
...
*   [Gramps Web](https://www.grampsweb.org/) - Web app for collaborative genealogy, based on and interoperable with Gramps, the open source genealogy desktop application. ([Demo](https://gramps-project.github.io/gramps-web-api/), [Source Code (⭐66)](https://github.com/gramps-project/gramps-web-api)) `AGPL-3.0` `Docker`

### Software / Groupware

*   [Twenty](https://twenty.com) - A modern CRM offering the flexibility of open source, advanced features, and a sleek design. ([Source Code (⭐14k)](https://github.com/twentyhq/twenty)) `AGPL-3.0` `Docker`

### Software / Pastebins

*   [ybFeed (⭐24)](https://github.com/ybizeul/ybFeed) - Personal micro feed where you can post snippets of text or images. `MIT` `Go/Nodejs/Docker`

## [Jan 19, 2024](/content/2024/01/19/README.md)

### Software / Database Management

*   [AdminerEvo](https://docs.adminerevo.org/) - Database management in a single PHP file. Available for MySQL, MariaDB, PostgreSQL, SQLite, MS SQL, Oracle, Elasticsearch, MongoDB and others (fork of Adminer). ([Source Code (⭐286)](https://github.com/adminerevo/adminerevo)) `Apache-2.0/GPL-2.0` `PHP`

## [Jan 14, 2024](/content/2024/01/14/README.md)

### Software / Automation

*   [Mylar3](https://mylarcomics.com/) - Automated Comic Book (cbr/cbz) downloader program for use with NZB and torrents. ([Source Code (⭐970)](https://github.com/mylar3/mylar3)) `GPL-3.0` `Python/Docker`

### Software / File Transfer - Object Storage & File Servers

*   [ZOT OCI Registry](https://zotregistry.dev) - A production-ready vendor-neutral OCI-native container image registry. ([Demo](https://zothub.io), [Source Code (⭐754)](https://github.com/project-zot/zot)) `Apache-2.0` `Go/Docker`

### Software / Proxy

*   [txtdot](https://txtdot.github.io/documentation/) - A HTTP proxy that parses only text, links and pictures from pages reducing internet bandwidth usage, removing ads and heavy scripts. ([Demo](https://txt.dc09.ru), [Source Code (⭐122)](https://github.com/TxtDot/txtdot)) `MIT` `Nodejs/Docker`
...
*   [Stalwart Mail Server](https://stalw.art) - All-in-one mail server with JMAP, IMAP4, and SMTP support and a wide range of modern features. ([Source Code (⭐3.2k)](https://github.com/stalwartlabs/mail-server)) `AGPL-3.0` `Rust/Docker`
...
*   [mikochi (⭐154)](https://github.com/zer0tonin/Mikochi) - Browse remote folders, upload files, delete, rename, download and stream files to VLC/mpv. `MIT` `Go/Docker/K8S`
...
*   [OpenTrashmail (⭐484)](https://github.com/HaschekSolutions/opentrashmail) - Complete trashmail solution that exposes an SMTP server and has a web interface to manage received emails. Works with multiple and wildcard domains and is fully file based (no database needed). Includes RSS feeds and JSON API. `Apache-2.0` `Python/PHP/Docker`
...
*   [DocKing](https://docking.shipsaas.tech) - Document management service/microservice that handles templates and renders them in PDF format, all in one place. ([Demo](https://docking-demo.shipsaas.tech/console), [Source Code (⭐169)](https://github.com/shipsaas/docking)) `MIT` `PHP/Nodejs/Docker`
...
*   [Flyimg](https://flyimg.io) - Resize and crop images on the fly. Get optimised images with MozJPEG, WebP or PNG using ImageMagick, with an efficient caching system. ([Demo](https://demo.flyimg.io), [Source Code (⭐931)](https://github.com/flyimg/flyimg)) `MIT` `Docker`
...
*   [Mataroa](https://mataroa.blog/) - Mataroa is a naked blogging platform for minimalists. ([Source Code (⭐189)](https://github.com/mataroa-blog/mataroa)) `MIT` `Python`
...
*   [Websurfx (⭐625)](https://github.com/neon-mmd/websurfx) `⚠` - Aggregate results from other search engines (metasearch engine) without ads while keeping privacy and security in mind. It is extremely fast and provides a high level of customization (alternative to SearX). `AGPL-3.0` `Rust/Docker`
...
*   [Sunshine](https://app.lizardbyte.dev/Sunshine/) - Remote game stream host for Moonlight with support up to 120 frames per second and 4K resolution. ([Source Code (⭐13k)](https://github.com/LizardByte/Sunshine)) `GPL-3.0` `C++/deb/Docker`
...
*   [Hemmelig](https://hemmelig.app) - Share encrypted secrets cross organizations, or as private persons. ([Source Code (⭐653)](https://github.com/HemmeligOrg/Hemmelig.app)) `MIT` `Docker/Nodejs`

### Software / Software Development - API Management

*   [Graphweaver](https://graphweaver.com/) - Turn multiple data sources into a single GraphQL API. ([Source Code (⭐444)](https://github.com/exogee-technology/graphweaver)) `MIT` `Nodejs`

### Software / Software Development - Project Management

*   [rgit (⭐68)](https://github.com/w4/rgit) - An ultra-fast & lightweight cgit clone. `WTFPL` `Rust/Docker`
...
*   [yt-dlp Web UI (⭐599)](https://github.com/marcopeocchi/yt-dlp-web-ui) - Web GUI for yt-dlp. `MPL-2.0` `Docker/Go/Nodejs`
...
*   [Open-Meteo](https://open-meteo.com/) - Open-source weather API with open-data forecasts, historical and climate data from all major national weather services. ([Demo](https://open-meteo.com/en/docs), [Source Code (⭐2k)](https://github.com/open-meteo/open-meteo)) `AGPL-3.0` `Docker`
...
*   [Uguu (⭐775)](https://github.com/nokonoko/uguu) - Stores files and deletes after X amount of time. `MIT` `PHP`
...
*   [Chevereto](https://chevereto.com/) - Ultimate image sharing software. Create your very own personal image hosting website in just minutes. ([Source Code (⭐372)](https://github.com/chevereto/chevereto)) `AGPL-3.0` `PHP/Docker`
...
*   [FlowForge](https://flowforge.com/) - FlowForge allows companies to deploy Node-RED applications in a reliable, scalable and secure manner. The FlowForge platform provides DevOps capabilities for Node-RED development teams. ([Source Code (⭐229)](https://github.com/flowforge/flowforge)) `Apache-2.0` `Nodejs/Docker/K8S`
...
*   [Hyphanet](https://hyphanet.org/) - Anonymously share files, browse and publish *freesites* (web sites accessible only through Hyphanet) and chat on forums. ([Source Code (⭐993)](https://github.com/hyphanet/fred)) `GPL-2.0` `Java`
...
*   [Picsur (⭐679)](https://github.com/CaramelFur/Picsur) - A simple imaging hosting platform that allows you to easily host, edit, and share images. `GPL-3.0` `Docker`

### Software / Knowledge Management Tools

*   [Atomic Server (⭐817)](https://github.com/atomicdata-dev/atomic-server) - Knowledge graph database with documents (similar to Notion), tables, search, and a powerful linked data API. Lightweight, very fast and no runtime dependencies. ([Demo](https://atomicdata.dev/)) `MIT` `Docker/Rust`
...
*   [Immich](https://immich.app/) - Self-hosted photo and video backup solution directly from your mobile phone. ([Source Code (⭐33k)](https://github.com/immich-app/immich)) `AGPL-3.0` `Docker`
...
*   [Synapse](https://matrix-org.github.io/synapse/latest/) - Server for [Matrix](https://matrix.org/), an open standard for decentralized persistent communication. ([Source Code (⭐782)](https://github.com/element-hq/synapse)) `Apache-2.0` `Python/deb`

### Software / Games - Administrative Utilities & Control Panels

*   [Lodestone (⭐666)](https://github.com/Lodestone-Team/lodestone) - A free, open source server hosting tool for Minecraft and other multiplayers. `AGPL-3.0` `Docker/Rust`
*   [SourceBans++](https://sbpp.github.io/) - Admin, ban, and communication management system for games running on the Source engine. ([Source Code (⭐320)](https://github.com/sbpp/sourcebans-pp)) `CC-BY-SA-4.0` `PHP`

### Software / Miscellaneous

*   [Mere Medical](https://meremedical.co/) `⚠` - With Mere Medical, you can finally manage all of your medical records from Epic MyChart, Cerner, and OnPatient patient portals in one place. Privacy-focused, self-hosted, and offline-first. ([Demo](https://demo.meremedical.co), [Source Code (⭐50)](https://github.com/cfu288/mere-medical)) `GPL-3.0` `Docker/Nodejs`
...
*   [Romm (⭐1.3k)](https://github.com/zurdi15/romm) `⚠` - RomM (Rom Manager) is a web based retro roms manager integrated with IGDB. `GPL-3.0` `Docker`
...
*   [PoeticMetric](https://www.poeticmetric.com) - Free as in freedom, open source, privacy-first and regulation-compliant web analytics tool. ([Demo](https://www.poeticmetric.com/s?d=www.poeticmetric.com), [Source Code (⭐209)](https://github.com/th0th/poeticmetric)) `AGPL-3.0` `Docker`

### Software / Polls and Events

*   [Input](https://getinput.co) - A privacy-focused, no-code, open-source form builder designed for simplicity and brand consistency. ([Source Code (⭐149)](https://github.com/deck9/input)) `AGPL-3.0` `PHP/Nodejs/Docker`

## [Jun 12, 2023](/content/2023/06/12/README.md)

### Software / URL Shorteners

*   [Just Short It! (⭐23)](https://github.com/miawinter98/just-short-it) - A KISS, single-user URL shortener that runs in just one container. `MIT` `Docker`
...
*   [Jellyseerr (⭐2.9k)](https://github.com/Fallenbagel/jellyseerr) - Manage requests for your media library, supports Plex, Jellyfin and Emby media servers (fork of Overseerr). `MIT` `Docker/Nodejs`
...
*   [Pastefy](https://pastefy.app/) - Beautiful, simple and easy to deploy Pastebin with optional Client-Encryption, Multitab-Pastes, an API, a highlighted Editor and more. ([Source Code (⭐229)](https://github.com/interaapps/pastefy), [Clients](https://github.com/topics/pastefy-addon)) `MIT` `Docker/K8S/Java`
...
*   [penpot](https://penpot.app/) - A web based design and prototyping platform meant for cross-domain teams. ([Source Code (⭐28k)](https://github.com/penpot/penpot)) `MPL-2.0` `Docker`
...
*   [Lynx](https://getlynx.dev) - URL shortener with many functions such as multiple accounts, ShareX support and an attractive but simple interface. ([Demo](https://demo.getlynx.dev), [Source Code (⭐155)](https://github.com/Lynx-Shortener/Lynx)) `MIT` `Nodejs/Docker`
...
*   [flatnotes (⭐1k)](https://github.com/dullage/flatnotes) - A self-hosted, database-less note-taking web app that utilises a flat folder of markdown files for storage. ([Demo](https://demo.flatnotes.io)) `MIT` `Docker`

### Software / Personal Dashboards

*   [Homarr](https://homarr.dev) - Sleek, modern dashboard with many integrations and web-based config. ([Demo](https://demo.homarr.dev), [Source Code (⭐5.2k)](https://github.com/ajnart/homarr)) `MIT` `Docker/Nodejs`

### Software / Task Management & To-do Lists

*   [Tasks.md (⭐394)](https://github.com/BaldissaraMatheus/Tasks.md) - A self-hosted, file based task management board that supports Markdown syntax. `MIT` `Docker`

### Software / Wikis

*   [Mycorrhiza Wiki](https://mycorrhiza.wiki/) - Filesystem and git-based wiki engine written in Go using Mycomarkup as its primary markup language. ([Source Code (⭐238)](https://github.com/bouncepaw/mycorrhiza/)) `AGPL-3.0` `Go`

## [May 23, 2023](/content/2023/05/23/README.md)

### Software / Office Suites

*   [CryptPad](https://cryptpad.org) - CryptPad is a collaboration suite that is end-to-end-encrypted and open-source. It is built to enable collaboration, synchronizing changes to documents in real time. ([Source Code (⭐5.3k)](https://github.com/cryptpad/cryptpad)) `AGPL-3.0` `Nodejs/Docker`
...
*   [Opengist (⭐1.4k)](https://github.com/thomiceli/opengist) - Self-hosted pastebin powered by Git. ([Demo](https://demo.opengist.io)) `AGPL-3.0` `Docker/Go/Nodejs`
...
*   [SwingMusic](https://swingmusic.vercel.app/) - Swing Music is a beautiful, self-hosted music player and streaming server for your local audio files. Like a cooler Spotify ... but bring your own music. ([Source Code (⭐619)](https://github.com/swing-opensource/swingmusic)) `MIT` `Python/Docker`
...
*   [Stalwart SMTP](https://stalw.art/smtp) - Modern SMTP server designed with a focus on security, speed, and extensive configurability. ([Source Code (⭐459)](https://github.com/stalwartlabs/smtp-server)) `AGPL-3.0` `Rust`
...
*   [Hubleys (⭐48)](https://github.com/knrdl/hubleys-dashboard) - Self-hosted personal dashboards to organize links for multiple users via a central yaml config. `MIT` `Docker`
...
*   [PocketBase](https://pocketbase.io/) - Open Source backend for your next SaaS and Mobile app in 1 file. ([Source Code (⭐34k)](https://github.com/pocketbase/pocketbase)) `MIT` `Go/Docker`
...
*   [Red Eclipse 2](https://redeclipse.net) - A FOSS Arena First-Person Shooter Similar to Unreal Tournament. ([Source Code (⭐408)](https://github.com/redeclipse/base)) `Zlib/MIT/CC-BY-SA-4.0` `C/C++/deb`

### Software / Software Development - Testing

*   [Bencher](https://bencher.dev/) - Bencher is a suite of continuous benchmarking tools designed to catch performance regressions in CI. ([Source Code (⭐398)](https://github.com/bencherdev/bencher)) `MIT/Apache-2.0` `Rust`
...
*   [PostHog](https://posthog.com) - Product analytics, session recording, feature flagging and a/b testing that you can self-host (alternative to Mixpanel/Amplitude/Heap/HotJar/Optimizely). ([Source Code (⭐18k)](https://github.com/posthog/posthog)) `MIT` `Python`
...
*   [mosparo](https://mosparo.io/) - The modern spam protection tool. It replaces other captcha methods with a simple and easy to use spam protection solution. ([Source Code (⭐164)](https://github.com/mosparo/mosparo)) `MIT` `PHP`

## [Feb 08, 2023](/content/2023/02/08/README.md)

### Software / File Transfer - Web-based File Managers

*   [copyparty (⭐456)](https://github.com/9001/copyparty) - Portable file server with accelerated resumable uploads, deduplication, WebDAV, FTP, zeroconf, media indexer, video thumbnails, audio transcoding, and write-only folders, in a single file with no mandatory dependencies. ([Demo](https://a.ocv.me/pub/demo/)) `MIT` `Python`
...
*   [POMjs](https://password.oppetmoln.se/) - Random Password Generator. ([Source Code (⭐25)](https://github.com/joho1968/POMjs)) `GPL-2.0` `Javascript`
...
*   [MiroTalk C2C](https://c2c.mirotalk.com) - Real-time cam-2-cam video calls & screen sharing, end-to-end encrypted, to embed in any website with a simple iframe. ([Source Code (⭐196)](https://github.com/miroslavpejic85/mirotalkc2c)) `MIT` `Nodejs/Docker`
...
*   [IconCaptcha](https://www.fabianwennink.nl/projects/IconCaptcha/) - IconCaptcha is a self-hosted, fast, simple and user-friendly captcha for PHP. ([Source Code (⭐117)](https://github.com/fabianwennink/IconCaptcha-Plugin-jQuery-PHP)) `MIT` `PHP`

### Software / Money, Budgeting & Management

*   [OpenBudgeteer (⭐716)](https://github.com/TheAxelander/OpenBudgeteer) - A budgeting app based on the Bucket Budgeting Principle. `MIT` `Docker/C#`
...
*   [ITFlow](https://itflow.org) - Client IT Documentation, Ticketing, Invoicing and Accounting Web Application for MSPs (Managed Service Providers). ([Demo](https://demo.itflow.org), [Source Code (⭐490)](https://github.com/itflow-org/itflow)) `GPL-3.0` `PHP`
...
*   [RustDesk](https://rustdesk.com/) - Remote Desktop Access software that works out-of-the-box (alternative to TeamViewer). ([Source Code (⭐5.7k)](https://github.com/rustdesk/rustdesk-server)) `AGPL-3.0` `Rust/Docker/deb`
...
*   [Uploady (⭐72)](https://github.com/farisc0de/Uploady) - Uploady is a simple file uploader script with multi file upload support. `MIT` `PHP`
...
*   [Stalwart JMAP](https://stalw.art/jmap) - JMAP and IMAP server designed to be secure, fast, robust and scalable. ([Source Code (⭐589)](https://github.com/stalwartlabs/jmap-server)) `AGPL-3.0` `Rust/Docker`
...
*   [Claper](https://claper.co/) - The ultimate tool to interact with your audience (alternative to Slido, AhaSlides and Mentimeter). ([Source Code (⭐377)](https://github.com/ClaperCo/Claper)) `GPL-3.0` `Elixir/Docker`

### Software / Ticketing

*   [Iguana (⭐78)](https://github.com/iguana-project/iguana) - Iguana is an open source issue management system with a kanban board. `CC-BY-SA-4.0` `Python/Docker`

## [Sep 21, 2022](/content/2022/09/21/README.md)

### Software / Bookmarks and Link Sharing

*   [Briefkasten (⭐754)](https://github.com/ndom91/briefkasten) - Modern app for saving and managing your own bookmarks. Includes a browser extension. ([Demo](https://briefkastenhq.com/auth/signin)) `MIT` `Nodejs/Docker`
...
*   [Posio (⭐549)](https://github.com/abrenaut/posio) - Geography multiplayer game. `MIT` `Python`
...
*   [Genea.app](https://www.genea.app/) - Genea is a privacy by design and open source tool anyone can use to author or edit their family tree. Data is stored in the GEDCOM format and all processing is done in the browser. ([Source Code (⭐173)](https://github.com/genea-app/genea-app)) `MIT` `Javascript`
...
*   [Gibbon](https://gibbonedu.org/) - The flexible, open source school management platform designed to make life better for teachers, students, parents and leaders. ([Source Code (⭐445)](https://github.com/GibbonEdu/core)) `GPL-3.0` `PHP`

### Software / Note-taking & Editors

*   [Standard Notes](https://docs.standardnotes.com/self-hosting/getting-started) - Simple and private notes app. Protect your privacy while getting more done. That's Standard Notes. ([Demo](https://app.standardnotes.org/), [Source Code (⭐5k)](https://github.com/standardnotes/app)) `GPL-3.0` `Ruby`

### Software / Polls and Events

*   [Christmas Community (⭐179)](https://github.com/Wingysam/Christmas-Community) - Create a simple place for your entire family to use to find gifts that people want, and to avoid double-gifting. `AGPL-3.0` `Docker/Nodejs`
*   [Fider](https://fider.io) - Open platform to collect and prioritize feedback (alternative to UserVoice). ([Demo](https://demo.fider.io), [Source Code (⭐2.7k)](https://github.com/getfider/fider)) `MIT` `Docker`
...
*   [Meetable](https://events.indieweb.org) - A minimal events aggregator. ([Source Code (⭐94)](https://github.com/aaronpk/Meetable)) `MIT` `PHP`
...
*   [NeonLink (⭐254)](https://github.com/AlexSciFier/neonlink) - Self-hosted bookmark service with unique design and simple installation with Docker. `MIT` `Docker`
...
*   [Ganymede (⭐373)](https://github.com/Zibbp/ganymede) `⚠` - Twitch VOD and Live Stream archiving platform. Includes a rendered chat for each archive. `GPL-3.0` `Docker`
...
*   [OrangeHRM](https://www.orangehrm.com/) - OrangeHRM is a comprehensive HRM system that captures all the essential functionalities required for any enterprise. ([Demo](https://opensource-demo.orangehrmlive.com/), [Source Code (⭐738)](https://github.com/orangehrm/orangehrm)) `GPL-2.0` `PHP`
...
*   [Navidrome Music Server](https://www.navidrome.org) - Modern Music Server and Streamer, compatible with Subsonic/Airsonic. ([Demo](https://www.navidrome.org/demo), [Source Code (⭐10k)](https://github.com/navidrome/navidrome), [Clients](https://www.navidrome.org/docs/overview/#apps)) `GPL-3.0` `Docker/Go`
...
*   [farmOS](https://farmos.org/) - Web-based farm record keeping application. ([Demo](https://farmos-demo.rootedsolutions.io/), [Source Code (⭐925)](https://github.com/farmOS/farmOS)) `GPL-2.0` `PHP/Docker`

### Software / Search Engines

*   [Fess](https://fess.codelibs.org/) - Fess is a very powerful and easily deployable Enterprise Search Server. ([Demo](https://search.n2sm.co.jp/), [Source Code (⭐965)](https://github.com/codelibs/fess)) `Apache-2.0` `Java/Docker`
...
*   [Glowing Bear (⭐939)](https://github.com/glowing-bear/glowing-bear) - A web frontend for WeeChat. ([Demo](https://www.glowing-bear.org)) `GPL-3.0` `Nodejs`
...
*   [Novu](https://novu.co/) - Self-hosted / cloud notification infrastructure for developers. ([Source Code (⭐33k)](https://github.com/novuhq/novu/)) `MIT` `Docker/Nodejs`

### Software / Communication - Video Conferencing

*   [Galene](https://galene.org/) - Galène (or Galene) is a videoconference server (an “SFU”) that is easy to deploy and that requires moderate server resources. ([Source Code (⭐877)](https://github.com/jech/galene)) `MIT` `Go`

### Software / Media Streaming - Audio Streaming

*   [Audiobookshelf](https://www.audiobookshelf.org/) - Fully open-source self-hosted audiobook and podcast server. It streams all audio formats, keeps and syncs progress across devices. Comes with open-source apps for Android and iOS. ([Source Code (⭐5.4k)](https://github.com/advplyr/audiobookshelf), [Clients (⭐986)](https://github.com/advplyr/audiobookshelf-app)) `GPL-3.0` `Docker/deb/Nodejs`
...
*   [Apache Solr](https://lucene.apache.org/solr/) - Enterprise search platform featuring full-text search, hit highlighting, faceted search, real-time indexing, dynamic clustering, and rich document (e.g., Word, PDF) handling. ([Source Code (⭐1k)](https://github.com/apache/solr)) `Apache-2.0` `Java/Docker/K8S`

### Software / Software Development - IDE & Tools

*   [Coder](https://coder.com/) - Remote development machines on your own infrastructure. ([Source Code (⭐7k)](https://github.com/coder/coder)) `AGPL-3.0` `Go/Docker/K8S/deb`
...
*   [plugNmeet](https://www.plugnmeet.org/) - Scalable, High Performance, Open source web conferencing system. ([Demo](https://demo.plugnmeet.com/login.html), [Source Code (⭐239)](https://github.com/mynaparrot/plugNmeet-server)) `MIT` `Docker/Go`
...
*   [Unison](https://www.cis.upenn.edu/~bcpierce/unison/) - Unison is a file-synchronization tool for OSX, Unix, and Windows. ([Source Code (⭐3.8k)](https://github.com/bcpierce00/unison)) `GPL-3.0` `deb/OCaml`

### Software / File Transfer - Single-click & Drag-n-drop Upload

*   [XBackBone](https://xbackbone.app/) - A simple, fast and lightweight file manager with instant sharing tools integration, like ShareX (a free and open-source screenshot utility for Windows). ([Source Code (⭐951)](https://github.com/SergiX44/XBackBone)) `AGPL-3.0` `PHP/Docker`
...
*   [Libre Translate](https://libretranslate.com/) - Free and Open Source Machine Translation API, entirely self-hosted. ([Source Code (⭐6.8k)](https://github.com/LibreTranslate/LibreTranslate)) `AGPL-3.0` `Docker/Python`
...
*   [Revolt](https://revolt.chat/) - Revolt is a user-first chat platform built with modern web technologies. ([Source Code (⭐808)](https://github.com/revoltchat/self-hosted)) `AGPL-3.0` `Rust`

### Software / Communication - Social Networks and Forums

*   [GoToSocial (⭐3.5k)](https://github.com/superseriousbusiness/gotosocial) - ActivityPub federated social network server implementing the Mastodon client API. `AGPL-3.0` `Docker/Go`

### Software / DNS

*   [Technitium DNS Server](https://technitium.com/dns/) - Authoritative/recursive DNS server with ad blocking functionality. ([Source Code (⭐3.6k)](https://github.com/TechnitiumSoftware/DnsServer)) `GPL-3.0` `Docker/C#`

### Software / Feed Readers

*   [Readflow](https://readflow.app) - Lightweight news reader with modern interface and features: full-text search, automatic categorization, archiving, offline support, notifications... ([Source Code (⭐380)](https://github.com/ncarlier/readflow)) `MIT` `Go/Docker`

### Software / Note-taking & Editors

*   [kiwix-serve](https://www.kiwix.org/en/downloads/kiwix-serve/) - HTTP daemon for serving wikis from ZIM files. ([Source Code (⭐387)](https://github.com/kiwix/kiwix-tools)) `GPL-3.0` `C++`

### Software / Software Development - Testing

*   [Touca](https://touca.io) - Continuous regression testing for engineering teams. Get feedback when you write code that could break your software. ([Source Code (⭐483)](https://github.com/trytouca/trytouca)) `Apache-2.0` `Docker/Nodejs`
...
*   [s-cart](https://s-cart.org/) - S-Cart is a free e-commerce website project for individuals and businesses, built on top of Laravel Framework. ([Demo](https://demo.s-cart.org/), [Source Code (⭐607)](https://github.com/s-cart/s-cart)) `MIT` `PHP`
...
*   [Lancache](https://lancache.net) `⚠` - LAN Party game caching made easy. ([Source Code (⭐711)](https://github.com/lancachenet/monolithic)) `MIT` `Docker/Shell`
...
*   [Jump (⭐485)](https://github.com/daledavies/jump) - Yet another self-hosted startpage for your server designed to be simple, stylish, fast and secure. `MIT` `Docker/PHP`
*   [Web-Portal (⭐178)](https://github.com/enchant97/web-portal) - A python web app designed to allow a easy way to manage the links to all of your web services. `AGPL-3.0` `Docker/Python`
...
*   [Shhh (⭐362)](https://github.com/smallwat3r/shhh) - Keep secrets out of emails or chat logs, share them using secure links with passphrase and expiration dates. `MIT` `Python`

## [Jul 09, 2022](/content/2022/07/09/README.md)

### Software / Archiving and Digital Preservation (DP)

*   [LiveStreamDVR (⭐290)](https://github.com/MrBrax/LiveStreamDVR) `⚠` - An automatic Twitch recorder capable of capturing live streams, chat messages and stream metadata. `MIT` `Python/Nodejs/Docker`
...
*   [Bitpoll (⭐230)](https://github.com/fsinfuhh/Bitpoll) - A web application for scheduling meetings and general polling. ([Demo](https://bitpoll.de/)) `GPL-3.0` `Docker/Python`

### Software / Search Engines

*   [OpenSearch](https://opensearch.org) - Open source distributed and RESTful search engine. ([Source Code (⭐8.8k)](https://github.com/opensearch-project/OpenSearch)) `Apache-2.0` `Java/Docker/K8S/deb`
...
*   [Datasette](https://datasette.io/) - An open source multi-tool for exploring and publishing data, easy import and export and database management. ([Demo](https://global-power-plants.datasettes.com/global-power-plants/global-power-plants), [Source Code (⭐9k)](https://github.com/simonw/datasette)) `Apache-2.0` `Python/Docker`
...
*   [Stump](https://www.stumpapp.dev) - A fast, free and open source comics, manga and digital book server with OPDS support. ([Source Code (⭐792)](https://github.com/stumpapp/stump)) `MIT` `Rust`

### Software / Games - Administrative Utilities & Control Panels

*   [ARRCON (⭐164)](https://github.com/radj307/ARRCON) - Terminal-based RCON client compatible with any game servers using the Source RCON Protocol. `GPL-3.0` `C++`
...
*   [Pterodactyl](https://pterodactyl.io/) - Management panel for game servers, with an intuitive UI for end users. ([Source Code (⭐6.1k)](https://github.com/pterodactyl/panel)) `MIT` `PHP`
*   [RconCli (⭐425)](https://github.com/gorcon/rcon-cli) - CLI for executing queries on a remote Valve Source dedicated server using the RCON Protocol. `MIT` `Go`
...
*   [Mars Server (⭐79)](https://github.com/borjapazr/mars-server) - Managed home server with Docker, Docker Compose, Make and Bash. `MIT` `Docker`
...
*   [Octave Online](https://octave-online.net/) - Infrastructure behind a web UI for GNU Octave (alternative to MATLAB). ([Source Code (⭐308)](https://github.com/octave-online/octave-online-server)) `AGPL-3.0` `Docker/Nodejs`
...
*   [Notifo (⭐704)](https://github.com/notifo-io/notifo) - Multichannel notification server with support for Email, Mobile Push, Web Push, SMS, messaging and a javascript plugin. `MIT` `C#`

### Software / E-commerce

*   [Vendure](https://www.vendure.io) - A headless commerce framework. ([Demo](https://demo.vendure.io), [Source Code (⭐5.3k)](https://github.com/vendure-ecommerce/vendure)) `MIT` `Nodejs`

### Software / Feed Readers

*   [Bubo Reader (⭐174)](https://github.com/georgemandis/bubo-rss) - Open source, "irrationally minimal" RSS feed reader. ([Demo](https://bubo-rss-demo.netlify.app/)) `MIT` `Nodejs`

### Software / File Transfer - Single-click & Drag-n-drop Upload

*   [GoSƐ (⭐180)](https://github.com/stv0g/gose) - GoSƐ is a modern file-uploader focusing on scalability and simplicity. It only depends on a S3 storage backend and hence scales horizontally without the need for additional databases or caches. ([Demo](https://gose.0l.de)) `Apache-2.0` `Go/Docker`
...
*   [string.is](https://string.is/) - An open-source, privacy-friendly online string toolkit for developers. ([Source Code (⭐197)](https://github.com/recurser/string-is)) `AGPL-3.0` `Nodejs`
...
*   [Titra](https://titra.io/) - Time-tracking solution for freelancers and small teams. ([Source Code (⭐382)](https://github.com/kromitgmbh/titra)) `GPL-3.0` `Javascript/Docker`

## [Jun 03, 2022](/content/2022/06/03/README.md)

### Software / Automation

*   [betanin (⭐309)](https://github.com/sentriz/betanin) - Music organization man-in-the-middle of your torrent client and music player. Based on beets.io, similar to Sonarr and Radarr. `GPL-3.0` `Python/Docker`

### Software / Calendar & Contacts

*   [Davis (⭐304)](https://github.com/tchapi/davis) - A simple, dockerizable and fully translatable admin interface for sabre/dav based on Symfony 5 and Bootstrap 4, largely inspired by Baïkal. `MIT` `PHP`
...
*   [DOCAT (⭐739)](https://github.com/docat-org/docat) - Host your docs. Simple. Versioned. Fancy. `MIT` `Python/Docker`
*   [EveryDocs (⭐181)](https://github.com/jonashellmann/everydocs-core) - A simple Document Management System for private use with basic functionality to organize your documents digitally. `GPL-3.0` `Docker/Ruby`
...
*   [Soketi](https://soketi.app/) - Simple, fast, and resilient open-source WebSockets server (drop-in alternative to Pusher). ([Source Code (⭐4.6k)](https://github.com/soketi/soketi)) `MIT` `Nodejs/Docker/K8S`

## [May 21, 2022](/content/2022/05/21/README.md)

### Software / File Transfer - Single-click & Drag-n-drop Upload

*   [FileShelter (⭐435)](https://github.com/epoupon/fileshelter) - FileShelter is a self-hosted software that allows you to easily share files over the Internet. `GPL-3.0` `C++/deb`

### Software / Games

*   [Word Mastermind (⭐111)](https://github.com/clupasq/word-mastermind) - Wordle clone. A Mastermind-like game, but instead of colors you need to guess words. ([Demo](https://word-mastermind.glitch.me/)) `MIT` `Nodejs`

### Software / Maps and Global Positioning System (GPS)

*   [Bicimon (⭐44)](https://github.com/knrdl/bicimon) - Bike Speedometer as Progressive Web App. ([Demo](https://knrdl.github.io/bicimon/)) `MIT` `Javascript`

### Software / Media Streaming - Audio Streaming

*   [LMS (⭐990)](https://github.com/epoupon/lms) - Access your self-hosted music using a web interface. `GPL-3.0` `Docker/deb/C++`
...
*   [WeeWX](https://weewx.com/) - Open source software for your weather station. ([Demo](https://weewx.com/showcase.html), [Source Code (⭐967)](https://github.com/weewx/weewx)) `GPL-3.0` `Python/deb`

### Software / Pastebins

*   [ExBin (⭐80)](https://github.com/m1dnight/exbin) - A pastebin with public/private snippets and netcat server. `MIT` `Docker`

### Software / Personal Dashboards

*   [Fenrus (⭐461)](https://github.com/revenz/fenrus) - A self hosted personal home page that allows for multiple users, guest access and multiple dashboards for each user. It also has "Smart Apps" which display live data for those apps. `GPL-3.0` `.NET/Docker`
...
*   [ntfy](https://ntfy.sh/) - Push notifications to phone or desktop using HTTP PUT/POST, with Android app, CLI and web app, similar to Pushover and Gotify. ([Demo](https://ntfy.sh/app), [Source Code (⭐17k)](https://github.com/binwiederhier/ntfy), [Clients (⭐451)](https://github.com/binwiederhier/ntfy-android)) `Apache-2.0/GPL-2.0` `Go/Docker/K8S`
*   [Typebot](https://typebot.io) - Conversational app builder (alternative to Typeform or Landbot). ([Source Code (⭐5k)](https://github.com/baptisteArno/typebot.io)) `AGPL-3.0` `Docker`

### Software / Pastebins

*   [paaster](https://paaster.io) - Paaster is a secure by default end-to-end encrypted pastebin built with the objective of simplicity. ([Source Code (⭐410)](https://github.com/WardPearce/paaster)) `GPL-3.0` `Docker`
...
*   [Rallly](https://rallly.co) - Create polls to vote on dates and times (alternative to Doodle). ([Demo](https://app.rallly.co), [Source Code (⭐3.1k)](https://github.com/lukevella/rallly)) `AGPL-3.0` `Nodejs/Docker`
...
*   [ydl\_api\_ng (⭐118)](https://github.com/Totonyus/ydl_api_ng) - Simple youtube-dl REST API to launch downloads on a distant server. `GPL-3.0` `Python`
...
*   [OTOBO](https://otobo.de/en/) - Flexible web-based ticketing system used for Customer Service, Help Desk, IT Service Management. ([Demo](https://otobo.de/en/open-source-ticketing-system/#demos), [Source Code (⭐233)](https://github.com/RotherOSS/otobo)) `GPL-3.0` `Perl/Docker`
...
*   [ClearFlask](https://clearflask.com) - Community-feedback tool for managing incoming feedback and prioritizing a public roadmap (alternative to Canny, UserVoice, Upvoty). ([Demo](https://product.clearflask.com), [Source Code (⭐257)](https://github.com/clearflask/clearflask)) `AGPL-3.0` `Docker`
...
*   [Passky](https://passky.org) - Simple, modern and open source password manager with website, browser extension, android and desktop application. ([Demo](https://vault.passky.org), [Source Code (⭐157)](https://github.com/Rabbit-Company/Passky-Server)) `GPL-3.0` `PHP`
...
*   [Stash](https://stashapp.cc) - A web-based library organizer and player for your adult media stash, with auto-tagging and metadata scraping support. ([Source Code (⭐8.3k)](https://github.com/stashapp/stash)) `AGPL-3.0` `Docker/Go`
...
*   [Krayin](https://krayincrm.com/) - Free and Opensource Laravel CRM Application. ([Demo](https://demo.krayincrm.com/), [Source Code (⭐6.7k)](https://github.com/krayin/laravel-crm)) `MIT` `PHP`

### Software / File Transfer - Single-click & Drag-n-drop Upload

*   [QuickShare (⭐486)](https://github.com/ihexxa/quickshare) - Quick and simple file sharing between different devices. `LGPL-3.0` `Docker/Go`

### Software / Photo and Video Galleries

*   [Mejiro (⭐156)](https://github.com/dmpop/mejiro) - An easy-to-use PHP web application for instant photo publishing. `GPL-3.0` `PHP`
...
*   [REI3](https://rei3.de/home_en/) - Open source, expandable Business Management Software. Manage tasks, time, assets and much more. ([Demo](https://rei3.de/demo_en/), [Source Code (⭐254)](https://github.com/r3-team/r3)) `MIT` `Go`
...
*   [Blink](https://docs.blink.rest) - Easy-to-host, SSO-integrated, CDN-powered link shortener (+decoupled analytics) for teams. ([Source Code (⭐261)](https://github.com/JaneJeon/blink)) `AGPL-3.0` `Nodejs/Docker`

## [Sep 17, 2021](/content/2021/09/17/README.md)

### Software / Communication - Email - Mail Delivery Agents

*   [Cyrus IMAP](https://www.cyrusimap.org/) - Email (IMAP/POP3), contacts and calendar server. ([Source Code (⭐512)](https://github.com/cyrusimap/cyrus-imapd)) `BSD-3-Clause-Attribution` `C`
*   [Dovecot](https://www.dovecot.org/) - IMAP and POP3 server written primarily with security in mind. ([Source Code (⭐904)](https://github.com/dovecot/core)) `MIT/LGPL-2.1` `C/deb`
...
*   [Thelia](https://thelia.net/) - Thelia is an open source and flexible e-commerce solution. ([Demo](https://demo.thelia.net/), [Source Code (⭐833)](https://github.com/thelia/thelia)) `LGPL-3.0` `PHP`
...
*   [Feedpushr (⭐326)](https://github.com/ncarlier/feedpushr) - Powerful RSS aggregator, able to transform and send articles to many outputs. Single binary, extensible with plugins. `GPL-3.0` `Go/Docker`
*   [Goeland (⭐162)](https://github.com/slurdge/goeland) - Reads RSS/Atom feeds and filter/digest them to create beautiful emails. `MIT` `Go`
*   [RSS2EMail (⭐352)](https://github.com/rss2email/rss2email) - Fetches RSS/Atom-feeds and pushes new Content to any email-receiver, supports OPML. `GPL-2.0` `Python/deb`

### Software / File Transfer - Object Storage & File Servers

*   [SFTPGo (⭐8.3k)](https://github.com/drakkan/sftpgo) - Flexible, fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. `AGPL-3.0` `Go/deb/Docker`
...
*   [RecipeSage (⭐543)](https://github.com/julianpoy/recipesage) - A recipe keeper, meal plan organizer, and shopping list manager that can import recipes directly from any URL. ([Demo](https://recipesage.com)) `AGPL-3.0` `Nodejs`

### Software / Self-hosting Solutions

*   [Ansible-NAS (⭐3k)](https://github.com/DaveStephens/ansible-nas) - Build a full-featured home server with this playbook and an Ubuntu box. `MIT` `Ansible/Docker`
*   [DietPi](https://dietpi.com/) - Minimal Debian OS optimized for single-board computers, which allows you to easily install and manage several services for selfhosting at home. ([Source Code (⭐4.6k)](https://github.com/MichaIng/DietPi)) `GPL-2.0` `Shell`
...
*   [xsrv](https://xsrv.readthedocs.io/) - Install and manage self-hosted services/applications, on your own server(s). ([Source Code (⭐294)](https://github.com/nodiscc/xsrv)) `GPL-3.0` `Ansible/Shell`
...
*   [Jellyfin](https://jellyfin.org) - Media server for audio, video, books, comics, and photos with a sleek interface and robust transcoding capabilities. Almost all modern platforms have clients, including Roku, Android TV, iOS, and Kodi. ([Demo](https://demo.jellyfin.org/stable), [Source Code (⭐30k)](https://github.com/jellyfin/jellyfin), [Clients (⭐1.3k)](https://github.com/awesome-jellyfin/awesome-jellyfin)) `GPL-2.0` `C#/deb/Docker`
...
*   [MistServer](https://mistserver.org/) - Streaming media server that works well in any streaming environment. ([Source Code (⭐344)](https://github.com/DDVTECH/mistserver)) `AGPL-3.0` `C++`
...
*   [Lura](https://luraproject.org/) - Open source High-Performance API Gateway. ([Source Code (⭐6.1k)](https://github.com/luraproject/lura)) `Apache-2.0` `Go`
*   [Para](https://paraio.org) - Flexible and modular backend framework/server for object persistence, API development and authentication. ([Source Code (⭐516)](https://github.com/erudika/para)) `Apache-2.0` `Java/Docker`
*   [Tyk](https://tyk.io) - Fast and scalable open source API Gateway. Out of the box, Tyk offers an API Management Platform with an API Gateway, API Analytics, Developer Portal and API Management Dashboard. ([Source Code (⭐9.3k)](https://github.com/TykTechnologies/tyk)) `MPL-2.0` `Go/Docker/K8S`
...
*   [Weblate](https://weblate.org) - Web-based translation tool with tight version control integration. ([Demo](https://demo.weblate.org), [Source Code (⭐4.3k)](https://github.com/WeblateOrg/weblate)) `GPL-3.0` `Python/Docker/K8S`
...
*   [Haven](https://havenweb.org/) - Private blogging system with markdown editing and built in RSS reader. ([Demo](https://havenweb.org/demo.html), [Source Code (⭐593)](https://github.com/havenweb/haven)) `MIT` `Ruby`
...
*   [Collective Access - Providence](https://collectiveaccess.org/) - Highly configurable Web-based framework for management, description, and discovery of digital and physical collections supporting a variety of metadata standards, data types, and media formats. ([Source Code (⭐279)](https://github.com/collectiveaccess/providence)) `GPL-3.0` `PHP`

### Software / Automation

*   [feedmixer (⭐154)](https://github.com/cristoper/feedmixer) - FeedMixer is a WSGI (Python3) micro web service which takes a list of feed URLs and returns a new feed consisting of the most recent n entries from each given feed(Returns Atom, RSS, or JSON). ([Demo](https://mretc.net/feedmixer/json?f=https://hnrss.org/newest\&f=https://americancynic.net/atom.xml\&n=1)) `WTFPL` `Python`

### Software / Blogging Platforms

*   [Chyrp Lite](https://chyrplite.net) - Extra-awesome, extra-lightweight blog engine. ([Source Code (⭐370)](https://github.com/xenocrat/chyrp-lite)) `BSD-3-Clause` `PHP`
...
*   [Cypht](https://cypht.org) - Feed reader for your email accounts. ([Source Code (⭐927)](https://github.com/cypht-org/cypht)) `LGPL-2.1` `PHP`
...
*   [osem](https://osem.io/) - Event management tailored to free Software conferences. ([Source Code (⭐857)](https://github.com/openSUSE/osem)) `MIT` `Ruby/Docker`
...
*   [Cockpit](https://getcockpit.com) - Simple Content Platform to manage any structured content. ([Source Code (⭐334)](https://github.com/Cockpit-HQ/Cockpit)) `MIT` `PHP`
...
*   [CouchCMS](https://www.couchcms.com/) - Simple Open-Source CMS for designers. ([Source Code (⭐338)](https://github.com/CouchCMS/CouchCMS)) `CPAL-1.0` `PHP`
...
*   [Textpattern](https://textpattern.com/) - Flexible, elegant and easy-to-use CMS. ([Demo](https://textpattern.co/demo), [Source Code (⭐765)](https://github.com/textpattern/textpattern)) `GPL-2.0` `PHP`
*   [WonderCMS](https://www.wondercms.com) - WonderCMS is the smallest flat file CMS since 2008. ([Demo](https://www.wondercms.com/demo), [Source Code (⭐638)](https://github.com/WonderCMS/wondercms)) `MIT` `PHP`
...
*   [DSpace](https://duraspace.org/dspace/) - Turnkey repository application providing durable access to digital resources. ([Source Code (⭐842)](https://github.com/DSpace/DSpace)) `BSD-3-Clause` `Java`
...
*   [FreshRSS](https://freshrss.org/) - Self-hostable RSS feed aggregator. ([Demo](https://demo.freshrss.org/i/), [Source Code (⭐8.5k)](https://github.com/FreshRSS/FreshRSS), [Clients (⭐121)](https://github.com/Alkarex/EasyRSS)) `AGPL-3.0` `PHP/Docker`
...
*   [egroupware](https://www.egroupware.org/) - Software suite including calendars, address books, notepad, project management tools, client relationship management tools (CRM), knowledge management tools, a wiki and a CMS. ([Source Code (⭐239)](https://github.com/EGroupware/egroupware)) `GPL-2.0` `PHP`
*   [SuiteCRM](https://suitecrm.com) - The award-winning, enterprise-class open source CRM. ([Source Code (⭐4.2k)](https://github.com/salesagility/SuiteCRM)) `AGPL-3.0` `PHP`
...
*   [openHAB](https://www.openhab.org) - Vendor and technology agnostic open source software for home automation. ([Source Code (⭐884)](https://github.com/openhab/openhab-core)) `EPL-2.0` `Java`

### Software / Learning and Courses

*   [ILIAS](https://www.ilias.de) - ILIAS is the Learning Management System that can cope with anything you throw at it. ([Demo](https://demo.ilias.de), [Source Code (⭐373)](https://github.com/ILIAS-eLearning/ILIAS)) `GPL-3.0` `PHP`
...
*   [OwnTracks Recorder (⭐800)](https://github.com/owntracks/recorder) `⚠` - Store and access data published by [OwnTracks](https://owntracks.org/) location tracking apps. `GPL-2.0` `C/Lua/deb/Docker`
...
*   [LibreTime](https://libretime.org) - Simple, open source platform that lets you broadcast streaming radio on the web (fork of [Airtime (⭐618)](https://github.com/sourcefabric/Airtime)). ([Source Code (⭐762)](https://github.com/LibreTime/libretime)) `AGPL-3.0` `Docker/PHP`
...
*   [SWAG (Secure Web Application Gateway) (⭐2.6k)](https://github.com/linuxserver/docker-swag) - Nginx webserver and reverse proxy with PHP support, built-in Certbot (Let's Encrypt) client and fail2ban integration. `GPL-3.0` `Docker`
...
*   [myTinyTodo](https://www.mytinytodo.net/) - Simple way to manage your todo list in AJAX style. Uses PHP, jQuery, SQLite/MySQL. GTD compliant. ([Demo](https://www.mytinytodo.net/demo/), [Source Code (⭐147)](https://github.com/maxpozdeev/mytinytodo/)) `GPL-2.0` `PHP`
...
*   [XWiki](https://www.xwiki.org) - Second generation wiki that allows the user to extend its functionalities with a powerful extension-based architecture. ([Demo](https://playground.xwiki.org), [Source Code (⭐931)](https://github.com/xwiki/xwiki-platform)) `LGPL-2.1` `Java/Docker/deb`
...
*   [μlogger (⭐509)](https://github.com/bfabiszewski/ulogger-server) - Collect geolocation from users in real-time and display their GPS tracks on a website. ([Demo](http://ulogger.fabiszewski.net/)) `GPL-3.0` `PHP`
...
*   [BTCPay Server](https://btcpayserver.org/) - A self-hosted Bitcoin and other cryptocurrencies payment processor. ([Demo](https://mainnet.demo.btcpayserver.org/), [Source Code (⭐6.1k)](https://github.com/btcpayserver/btcpayserver)) `MIT` `C#`
...
*   [turndown](https://mixmark-io.github.io/turndown/) - HTML to Markdown converter written in Javascript. ([Source Code (⭐8k)](https://github.com/mixmark-io/turndown)) `MIT` `Javascript`
...
*   [GeneWeb](https://geneweb.tuxfamily.org/wiki/GeneWeb) - Genealogy software. It comes with a Web interface and can be used off-line or as a Web service. ([Demo](https://demo.geneweb.tuxfamily.org/gw7/), [Source Code (⭐290)](https://github.com/geneweb/geneweb)) `GPL-2.0` `OCaml`
...
*   [Outline](https://www.getoutline.com/) `⚠` - An open, extensible, wiki for your team. ([Source Code (⭐25k)](https://github.com/outline/outline)) `BSD-3-Clause` `Nodejs/Docker`

## [Jul 10, 2021](/content/2021/07/10/README.md)

### Software / Communication - Email - Complete Solutions

*   [Maddy Mail Server (⭐4.7k)](https://github.com/foxcpp/maddy) - All-in-one mail server that implements SMTP (both MTA and MX) and IMAP. Replaces Postfix, Dovecot, OpenDKIM, OpenSPF, OpenDMARC with single daemon. `GPL-3.0` `Go`
...
*   [OliveTin (⭐1.7k)](https://github.com/OliveTin/OliveTin) - OliveTin is a web interface for running Linux shell commands. `AGPL-3.0` `Go`
...
*   [Shiori (⭐8.8k)](https://github.com/go-shiori/shiori) - Simple bookmark manager built with Go. `MIT` `Go/Docker`

### Software / Communication - Custom Communication Systems

*   [PushBits (⭐298)](https://github.com/pushbits/server) - Self-hosted notification server for relaying push notifications via Matrix, similar to PushBullet and Gotify. `ISC` `Go`
...
*   [Miniflux](https://miniflux.app/) - Miniflux is a minimalist and open source news reader, written in Go and PostgreSQL. ([Source Code (⭐6.3k)](https://github.com/miniflux/v2)) `Apache-2.0` `Go/deb/Docker`
...
*   [PictShare](https://www.pictshare.net/) - PictShare is a multi lingual, open source image hosting service with a simple resizing and upload API. ([Source Code (⭐811)](https://github.com/HaschekSolutions/pictshare)) `Apache-2.0` `PHP/Docker`
...
*   [TimeOff.Management](https://timeoff.management) - Simple yet powerful absence management software for small and medium size business. ([Demo](https://app.timeoff.management), [Source Code (⭐907)](https://github.com/timeoff-management/timeoff-management-application)) `MIT` `Nodejs`
...
*   [Home Assistant](https://home-assistant.io/) - Open-source home automation platform. ([Demo](https://home-assistant.io/demo/), [Source Code (⭐69k)](https://github.com/home-assistant/core)) `Apache-2.0` `Python/Docker`
...
*   [Anchr](https://anchr.io) - Anchr is a toolbox for tiny tasks on the internet, including bookmark collections, URL shortening and (encrypted) image uploads. ([Source Code (⭐247)](https://github.com/muety/anchr)) `GPL-3.0` `Nodejs`
...
*   [imgproxy](https://imgproxy.net/) - Fast and secure standalone server for resizing and converting remote images. It works great when you need to resize multiple images on the fly without preparing a ton of cached resized images or re-doing it every time the design changes. ([Source Code (⭐8.3k)](https://github.com/imgproxy/imgproxy)) `MIT` `Go/Docker/K8S`

### Software / Software Development - IDE & Tools

*   [Judge0 CE](https://judge0.com) - Open source API to compile and run source code. ([Source Code (⭐2.2k)](https://github.com/judge0/judge0)) `GPL-3.0` `Docker`
*   [Wakapi](https://wakapi.dev/) - Tracking tool for coding statistics, compatible with WakaTime. ([Source Code (⭐2.3k)](https://github.com/muety/wakapi)) `GPL-3.0` `Go/Docker`
...
*   [ass (⭐609)](https://github.com/tycrek/ass) - The superior self-hosted ShareX server. For use with clients such as ShareX (Windows), Flameshot (Linux), & MagicCap (Linux, macOS). `ISC` `Nodejs/Docker`
...
*   [HomeGallery](https://home-gallery.org) - Self-hosted open-source web gallery to browse personal photos and videos featuring tagging, mobile-friendly, and AI powered image discovery. ([Demo](https://demo.home-gallery.org), [Source Code (⭐699)](https://github.com/xemle/home-gallery)) `MIT` `Nodejs/Docker`

### Software / Proxy

*   [socks5-proxy-server (⭐79)](https://github.com/nskondratev/socks5-proxy-server) - SOCKS5 proxy server with built-in authentication and Telegram-bot for user management and user statistics on data spent (handy when you pay per GB of data). It is dockerised and simple to install. `Apache-2.0` `Docker`
...
*   [EspoCRM](https://www.espocrm.com/) - CRM with a frontend designed as a single page application, and a REST API. ([Demo](https://demo.espocrm.com/), [Source Code (⭐1.5k)](https://github.com/espocrm/espocrm)) `AGPL-3.0` `PHP`
...
*   [Foodsoft](https://foodcoops.net/) - Web-based software to manage a non-profit food coop (product catalog, ordering, accounting, job scheduling). ([Source Code (⭐313)](https://github.com/foodcoops/foodsoft)) `AGPL-3.0` `Docker/Ruby`
...
*   [ChiefOnboarding](https://chiefonboarding.com) - Employee onboarding platform that allows you to provision user accounts and create sequences with todo items, resources, text/email/Slack messages, and more! Available as a web portal and Slack bot. ([Source Code (⭐599)](https://github.com/chiefonboarding/ChiefOnboarding)) `AGPL-3.0` `Docker`
...
*   [Gokapi (⭐1k)](https://github.com/Forceu/gokapi) - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to the discontinued Firefox Send, with the difference that only the admin is allowed to upload files. `GPL-3.0` `Go/Docker`
...
*   [Kerberos.io](https://kerberos.io) - Kerberos.io is a video surveillance solution, which works with any camera and on every Linux based machine (Raspberry Pi, Docker, Kubernetes cluster). ([Demo](https://demo.kerberos.io/), [Source Code (⭐579)](https://github.com/kerberos-io/agent)) `MIT` `Docker/K8S`
...
*   [blocky (⭐4.3k)](https://github.com/0xERR0R/blocky) - Fast and lightweight DNS proxy (like Pi-hole) as ad-blocker for local network with many features. `Apache-2.0` `Go/Docker`
...
*   [Firefox Account Server](https://mozilla-services.readthedocs.io/en/latest/howtos/run-fxa.html) - This allows you to host your own Firefox accounts server. ([Source Code (⭐561)](https://github.com/mozilla/fxa)) `MPL-2.0` `Nodejs/Java`
...
*   [Tinode](https://github.com/tinode) - Instant messaging platform. Backend in Go. Clients: Swift iOS, Java Android, JS webapp, scriptable command line; chatbots. ([Demo](https://sandbox.tinode.co/), [Source Code (⭐12k)](https://github.com/tinode/chat), [Clients (⭐307)](https://github.com/tinode/webapp)) `GPL-3.0` `Go`
...
*   [SCM Manager](https://www.scm-manager.org/) - The easiest way to share and manage your Git, Mercurial and Subversion repositories over http. ([Source Code (⭐129)](https://github.com/scm-manager/scm-manager)) `BSD-3-Clause` `Java/deb/Docker/K8S`
...
*   [reader (⭐419)](https://github.com/lemon24/reader) - A Python feed reader web app and library (so you can use it to build your own), with only standard library and pure-Python dependencies. `BSD-3-Clause` `Python`
...
*   [Family Accounting Tool (⭐179)](https://github.com/nymanjens/facto) - Web-based finance management tool for partners with partially shared expenses. `Apache-2.0` `Scala`
...
*   [Plainpad](https://alextselegidis.com/get/plainpad/) - A modern note taking application for the cloud, utilizing the best features of progressive web apps technology. ([Demo](https://alextselegidis.com/try/plainpad/), [Source Code (⭐245)](https://github.com/alextselegidis/plainpad)) `GPL-3.0` `PHP`
...
*   [Kiwi IRC](https://kiwiirc.com/) - Responsive web IRC client with theming support. ([Demo](https://kiwiirc.com/nextclient/), [Source Code (⭐832)](https://github.com/kiwiirc/kiwiirc)) `Apache-2.0` `Nodejs`
...
*   [HRConvert2 (⭐899)](https://github.com/zelon88/HRConvert2) - Drag-and-drop file conversion server with session based authentication, automatic temporary file maintenance, and logging capability. `GPL-3.0` `PHP`
...
*   [Sharry (⭐762)](https://github.com/eikek/sharry) - Share files easily over the internet between authenticated and anonymous users (both ways) with resumable up- and downloads. `GPL-3.0` `Scala/Java/deb/Docker`

### Software / Proxy

*   [Tinyproxy](https://tinyproxy.github.io/) - Light-weight HTTP/HTTPS proxy daemon. ([Source Code (⭐4.6k)](https://github.com/tinyproxy/tinyproxy)) `GPL-2.0` `C/deb`

## [Aug 11, 2019](/content/2019/08/11/README.md)

### Software / Communication - Custom Communication Systems

*   [KChat (⭐139)](https://github.com/php-kchat/kchat) - PHP Based Live Chat Application. `Apache-2.0` `PHP`

### Software / Internet of Things (IoT)

*   [DeviceHive](https://www.devicehive.com/) - Open Source IoT Platform with a wide range of integration options. ([Demo](https://playground.devicehive.com/), [Source Code (⭐353)](https://github.com/devicehive/devicehive-java-server)) `Apache-2.0` `Java/Docker/K8S`
...
*   [Kibitzr](https://kibitzr.github.io) - Lightweight personal web assistant with powerful integrations. ([Source Code (⭐629)](https://github.com/kibitzr/kibitzr)) `MIT` `Python`
...
*   [Strapi](https://strapi.io/) - The most advanced open-source Content Management Framework (headless-CMS) to build powerful API with no effort. ([Source Code (⭐61k)](https://github.com/strapi/strapi)) `MIT` `Nodejs`
...
*   [IFM (⭐328)](https://github.com/misterunknown/ifm) - Single script file manager. `MIT` `PHP`

### Software / Learning and Courses

*   [RELATE](https://documen.tician.de/relate/) - RELATE is a web-based courseware package, includes features such as: flexible rules, statistics, multi-course support, class calendar. ([Source Code (⭐363)](https://github.com/inducer/relate)) `MIT` `Python`
...
*   [Klaus (⭐668)](https://github.com/jonashaag/klaus) - Simple, easy-to-set-up Git web viewer that Just Works. `ISC` `Python/Docker`

### Software / Wikis

*   [Pepperminty Wiki (⭐173)](https://github.com/sbrl/Pepperminty-Wiki) - Complete markdown-powered wiki contained in a single PHP file. ([Demo](https://starbeamrainbowlabs.com/labs/peppermint/build/)) `MPL-2.0` `PHP`
...
*   [Gotify](https://gotify.net/) - Self-hosted notification server with Android and CLI clients, similar to PushBullet. ([Source Code (⭐10k)](https://github.com/gotify/server), [Clients (⭐832)](https://github.com/gotify/android)) `MIT` `Go/Docker`
...
*   [Expressa (⭐431)](https://github.com/thomas4019/expressa) - Content Management System for powering database driven websites using JSON schemas. Provides permission management and automatic REST APIs. `MIT` `Nodejs`
...
*   [bepasty](https://bepasty-server.readthedocs.io/en/latest/) - A pastebin for all kinds of files. ([Source Code (⭐175)](https://github.com/bepasty/bepasty-server)) `BSD-2-Clause` `Python/deb`
...
*   [homebox (⭐442)](https://github.com/progmaticltd/homebox) - Suite of Ansible scripts to deploy a fully functional mail server on Debian. Unobtrusive and automatic as much as possible, focusing on stability and security. `GPL-3.0` `Shell`
...
*   [Backdrop CMS](https://backdropcms.org/) - Comprehensive CMS for small to medium sized businesses and non-profits. ([Source Code (⭐958)](https://github.com/backdrop/backdrop)) `GPL-2.0` `PHP`
...
*   [Chamilo LMS](https://chamilo.org/) - Chamilo LMS allows you to create a virtual campus for the provision of online or semi-online training. ([Source Code (⭐753)](https://github.com/chamilo/chamilo-lms)) `GPL-3.0` `PHP`
...
*   [OpenProject](https://www.openproject.org) - OpenProject is a web-based project management system. ([Source Code (⭐8.5k)](https://github.com/opf/openproject)) `GPL-3.0` `Ruby/deb/Docker`
...
*   [CUPS](https://www.cups.org/) - The Common Unix Print System uses Internet Printing Protocol (IPP) to support printing to local and network printers. ([Source Code (⭐914)](https://github.com/OpenPrinting/cups)) `GPL-2.0` `C`
...
*   [Mautic](https://www.mautic.org/) - Mautic is marketing automation software (email, social and more). ([Source Code (⭐6.7k)](https://github.com/mautic/mautic)) `GPL-3.0` `PHP`
...
*   [REDAXO](https://www.redaxo.org) - Simple, flexible and useful content management system (documentation only available in German). ([Source Code (⭐319)](https://github.com/redaxo/redaxo)) `MIT` `PHP/Docker`
...
*   [DomainMOD](https://domainmod.org) - Application to manage your domains and other internet assets in a central location. DomainMOD includes a Data Warehouse framework that allows you to import your WHM/cPanel web server data so that you can view, export, and report on your data. ([Demo](https://demo.domainmod.org), [Source Code (⭐452)](https://github.com/domainmod/domainmod)) `GPL-3.0` `PHP`
...
*   [Invoice Ninja](https://www.invoiceninja.org/) - Powerful tool to invoice clients online. ([Demo](https://app.invoiceninja.com/invoices/create), [Source Code (⭐7.8k)](https://github.com/invoiceninja/invoiceninja)) `AAL` `PHP/Docker/K8S`
...
*   [Sup3rS3cretMes5age (⭐477)](https://github.com/algolia/sup3rS3cretMes5age) - Very simple (to deploy and to use) secret message service using Hashicorp Vault as a secrets storage. `MIT` `Go`
...
*   [Healthchecks](https://healthchecks.io/) - Django app which listens for pings and sends alerts when pings are late. ([Source Code (⭐7.4k)](https://github.com/healthchecks/healthchecks)) `BSD-3-Clause` `Python`

### Software / Communication - IRC

*   [Robust IRC](https://robustirc.net/) - RobustIRC is IRC without netsplits. Distributed IRC server, based on RobustSession protocol. ([Source Code (⭐174)](https://github.com/robustirc/robustirc)) `BSD-3-Clause` `Go`
...
*   [Radarr](https://radarr.video/) - Radarr is an independent fork of Sonarr reworked for automatically downloading movies via Usenet and BitTorrent, à la Couchpotato. ([Source Code (⭐9.3k)](https://github.com/Radarr/Radarr)) `GPL-3.0` `C#/Docker`
...
*   [FreeSWITCH](https://freeswitch.org/) - Scalable open source cross-platform telephony platform. ([Source Code (⭐3.2k)](https://github.com/signalwire/freeswitch)) `MPL-2.0` `C`
...
*   [Mastodon](https://joinmastodon.org/) - Federated microblogging server. ([Source Code (⭐46k)](https://github.com/mastodon/mastodon), [Clients (⭐20)](https://github.com/hyperupcall/awesome-mastodon)) `AGPL-3.0` `Ruby`
...
*   [Koha](https://koha-community.org/) - Enterprise-class ILS with modules for acquisitions, circulation, cataloging, label printing, offline circulation for when Internet access is not available, and much more. ([Demo](https://koha-community.org/demo/), [Source Code (⭐470)](https://github.com/Koha-Community/Koha)) `GPL-3.0` `Perl`
...
*   [RSS Monster (⭐428)](https://github.com/pietheinstrengholt/rssmonster) - An easy to use web-based RSS aggregator and reader compatible with the Fever API (alternative to Google Reader). `MIT` `PHP`
...
*   [Syncthing](https://syncthing.net/) - Syncthing is an open source peer-to-peer file synchronisation tool. ([Source Code (⭐60k)](https://github.com/syncthing/syncthing)) `MPL-2.0` `Go/Docker/deb`

### Software / File Transfer - Single-click & Drag-n-drop Upload

*   [Files Sharing (⭐180)](https://github.com/axeloz/filesharing) - Open Source and self-hosted files sharing application based on unique and temporary links. `GPL-3.0` `PHP/Docker`

### Software / Human Resources Management (HRM)

*   [admidio](https://www.admidio.org/) - Admidio is a free open source user management system for websites of organizations and groups. The system has a flexible role model so that it’s possible to reflect the structure and permissions of your organization. ([Demo](https://www.admidio.org/demo/), [Source Code (⭐292)](https://github.com/Admidio/admidio)) `GPL-2.0` `PHP/Docker`

### Software / Inventory Management

*   [Inventaire](https://inventaire.io/welcome) - Collaborative resources mapper project, while yet only focused on exploring books mapping with wikidata and ISBNs. ([Source Code (⭐421)](https://github.com/inventaire/inventaire)) `AGPL-3.0` `Nodejs`
...
*   [Meemo](https://meemo.minimal-space.de/) - Personal notes stream with Markdown support. ([Source Code (⭐347)](https://github.com/cloudron-io/meemo)) `MIT` `Nodejs`

### Software / Pastebins

*   [PrivateBin](https://privatebin.info/) - PrivateBin is a minimalist, open source online pastebin/discussion board where the server has zero knowledge of hosted data. ([Demo](https://privatebin.net/), [Source Code (⭐5.9k)](https://github.com/PrivateBin/PrivateBin)) `Zlib` `PHP`

### Software / Photo and Video Galleries

*   [sigal (⭐856)](https://github.com/saimn/sigal) - Yet another simple static gallery generator. `MIT` `Python`
