...
[🏠 Home](/README.md) · [🔥 Feed](https://www.trackawesomelist.com/JesseTG/awesome-qt/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 JesseTG/awesome-qt](https://github.com/JesseTG/awesome-qt) · ⭐ 1.1K · 🏷️ Platforms
...
*   [Qt Creator](https://www.qt.io/ide) [:octocat: (⭐1.9k)](https://github.com/qtproject/qt-creator) - By no means does Qt lock you into its provided IDE, but its firm integration with the framework makes it a good sell.  Among other things, it provides a UI designer, modeling tools, a documentation browser, and great QML support if you're into that sort of thing.  There's also a plugin system, but third-party plugins are unfortunately scarce.
    *   [Qt Designer](https://doc.qt.io/qt-5/qtdesigner-manual.html) [:octocat: (⭐125)](https://github.com/qt/qttools/tree/dev/src/designer) - If you'd rather just design the interfaces and let someone else hook them up to logic, the GUI designer is available as a separate application.
    *   [Qt Assistant](https://doc.qt.io/qt-5/qtassistant-index.html) [:octocat: (⭐125)](https://github.com/qt/qttools/tree/dev/src/assistant) - So is the documentation viewer, for that matter.
