...
*   [veri (⭐27)](https://github.com/brownboxdev/veri) - A gem for cookie-based authentication with fine-grained session control and management. [:red\_circle:](https://rubygems.org/gems/veri)

## [Jun 26, 2025](/content/2025/06/26/README.md)

### Open Source Rails Apps / Other external resources

*   [Listopia (⭐28)](https://github.com/spaquet/listopia) - A modern list / task management app (using Rails 8). - [:earth\_africa:](https://listopia-dhv.pages.dev)
...
*   [kreds (⭐19)](https://github.com/enjaku4/kreds) - A shorthand for Rails credentials access. [:red\_circle:](https://rubygems.org/gems/kreds)
...
*   [freeATS (⭐37)](https://github.com/freeats/freeats/) - An open source applicant tracking system with self-hosting capabilities (using Rails 7.1). - [:earth\_africa:](https://www.freeats.com/)
...
*   [passive\_columns (⭐46)](https://github.com/headmandev/passive_columns) - A gem that extends Active Record to retrieve specific columns from DB on demand. [:red\_circle:](https://rubygems.org/gems/passive_columns)

## [Mar 05, 2024](/content/2024/03/05/README.md)

### Gems / Other external resources

*   [rabarber (⭐181)](https://github.com/enjaku4/rabarber) - A gem to handle role-based authorization. [:red\_circle:](https://rubygems.org/gems/rabarber)
...
*   [solid\_queue (⭐2.3k)](https://github.com/basecamp/solid_queue) - A gem to Database-backed Active Job backend [:red\_circle:](https://rubygems.org/gems/solid_queue)

## [Dec 28, 2023](/content/2023/12/28/README.md)

### Open Source Rails Apps / Other external resources

*   [obl.ong (⭐22)](https://github.com/obl-ong/admin) - A multi-tenant subdomain control panel (using Rails 7.1) - [🌍](https://obl.ong)

## [Dec 16, 2023](/content/2023/12/16/README.md)

### Open Source Rails Apps / Other external resources

*   [chronlife (⭐10)](https://github.com/maciejb2k/chronlife) - A social platform for people with chronic diseases (using Rails 7.0).

## [Dec 05, 2023](/content/2023/12/05/README.md)

### Open Source Rails Apps / Other external resources

*   [somleng (⭐87)](https://github.com/somleng/somleng) - An Open Source Communications-Platform-as-a-Service (CPaaS) and Telco-as-a-service (TaaS). (using Rails 7.1). - [:earth\_africa:](https://www.somleng.org)

## [Oct 05, 2023](/content/2023/10/05/README.md)

### Open Source Rails Apps / Other external resources

*   [granny (⭐11)](https://github.com/roberthopman/granny) - An OpenAI chat app (Rails 7.0)
...
*   [blackCandy (⭐4k)](https://github.com/blackcandy-org/black_candy) - A music streaming app (using Rails 7.0).
...
*   [mastodon (⭐49k)](https://github.com/mastodon/mastodon) - A microblogging app (using Rails 6.1). - [:earth\_africa:](https://mastodon.social/about)
...
*   [rails\_semantic\_logger (⭐385)](https://github.com/reidmorrison/rails_semantic_logger) - A gem to provide alternative logging approach for Rails app. [:red\_circle:](https://rubygems.org/gems/rails_semantic_logger)
...
*   [rubocop-rails (⭐858)](https://github.com/rubocop/rubocop-rails) - A code style checking tool. [:red\_circle:](https://rubygems.org/gems/rubocop-rails)
...
*   [retrospring (⭐288)](https://github.com/retrospring/retrospring) - A social network following the Q/A (question and answer) principle - [:earth\_africa:](https://retrospring.net)
...
*   [human-essentials (⭐554)](https://github.com/rubyforgood/human-essentials) - An inventory management system for essentials banks (using Rails 7.0). - [:earth\_africa:](https://humanessentials.app/)
...
*   [rails-mermaid\_erd (⭐174)](https://github.com/koedame/rails-mermaid_erd) - A gem to interactively generate entity-relationship diagram in image or Markdown format. [:red\_circle:](https://rubygems.org/gems/rails-mermaid_erd)

## [Oct 11, 2022](/content/2022/10/11/README.md)

### Open Source Rails Apps / Other external resources

*   [activeWorkflow (⭐863)](https://github.com/automaticmode/active_workflow) - An intelligent process and workflow automation platform based on software agents (using Rails 6.0).
...
*   [alaveteli (⭐406)](https://github.com/mysociety/alaveteli) - A platform for making public freedom of information requests - using Rails 7.0 - [:earth\_africa:](https://alaveteli.org)
*   [api.rss (⭐347)](https://github.com/davidesantangelo/api.rss) - A RSS feed conversion (to API) app (using Rails 6.0).
*   [autolab (⭐798)](https://github.com/autolab/Autolab) - A course management app (using Rails 6.0). - [:earth\_africa:](https://autolabproject.com/)
...
*   [campo (⭐439)](https://github.com/chloerei/campo) - A forum app (using Rails 4.1).
*   [chatwoot (⭐26k)](https://github.com/chatwoot/chatwoot) - A simple and elegant live chat software (using Rails 6.1).
...
*   [danbooru (⭐2.6k)](https://github.com/danbooru/danbooru) - A taggable image board app (using Rails 7.0).
...
*   [ekylibre (⭐461)](https://github.com/ekylibre/ekylibre) - A farm management app (using Rails 5.0).
*   [expertiza (⭐192)](https://github.com/expertiza/expertiza) - A learning material sharing app (using Rails 5.1).
...
*   [fromthepage (⭐179)](https://github.com/benwbrum/fromthepage) - A wiki-like app for crowdsourcing transcription of handwritten documents (using Rails 6.0). - [:earth\_africa:](https://www.fromthepage.com/)
*   [gitlabhq (⭐24k)](https://github.com/gitlabhq/gitlabhq) - A code collaboration app (using Rails 6.1).
*   [growstuff (⭐456)](https://github.com/Growstuff/growstuff) - A data management app for food gardeners (using Rails 6.1). - [:earth\_africa:](https://www.growstuff.org/)
*   [hackershare (⭐635)](https://github.com/hackershare/hackershare) - Social bookmarks website for hackers (using Rails 7.0). - [:earth\_africa:](https://hackershare.dev/en)
*   [hitobito (⭐452)](https://github.com/hitobito/hitobito) - An event organization app (using Rails 6.1). - [:earth\_africa:](https://hitobito.com/en)
*   [inaturalist (⭐772)](https://github.com/inaturalist/inaturalist) - A community app for nature and related stuff (using Rails 6.1). - [:earth\_africa:](https://www.inaturalist.org)
*   [lobsters (⭐4.5k)](https://github.com/lobsters/lobsters) - A link aggregation app (using Rails 7.0). - [:earth\_africa:](https://lobste.rs)
...
*   [openproject (⭐13k)](https://github.com/opf/openproject) - A project management app (using Rails 7.0). - [:earth\_africa:](https://www.openproject.org)
...
*   [otwarchive (⭐1.7k)](https://github.com/otwcode/otwarchive) - A social networking app for fans - using Rails 6.0 - [:earth\_africa:](https://archiveofourown.org)
*   [passwordPusher (⭐2.8k)](https://github.com/pglombardo/PasswordPusher) - A password delivery app (using Rails 6.1). - [:earth\_africa:](https://pwpush.com)
*   [planningalerts-app (⭐101)](https://github.com/openaustralia/planningalerts) - A planned applications tracking app (using Rails 6.1). - [:earth\_africa:](https://www.planningalerts.org.au)
...
*   [theodinproject (⭐4.2k)](https://github.com/TheOdinProject/theodinproject) - A teaching & learning platform (using Rails 6.1). - [:earth\_africa:](https://www.theodinproject.com/)
...
*   [vglist (⭐153)](https://github.com/connorshea/vglist) - A video game library tracking web app (using Rails 7.0). - [:earth\_africa:](https://vglist.co/)
...
*   [alonetone (⭐371)](https://github.com/sudara/alonetone) - A music hosting, management & distribution app (using Rails 7.0). - [:earth\_africa:](https://alonetone.com)
...
*   [shakapacker (⭐461)](https://github.com/shakacode/shakapacker) - A gem to use webpack to manage app-like JavaScript modules in Rails. [:red\_circle:](https://rubygems.org/gems/shakapacker)
...
*   [rails\_api\_base (⭐605)](https://github.com/rootstrap/rails_api_base) - Rails 6 boilerplate project for JSON RESTful APIs.
...
*   [kanban (⭐645)](https://github.com/seanomlor/kanban) - A Trello clone (using Rails 4.2).
...
*   [activerecord-analyze (⭐228)](https://github.com/pawurb/activerecord-analyze) - A gem to add EXPLAIN ANALYZE to Rails Active Record query objects. [:red\_circle:](https://rubygems.org/gems/activerecord-analyze)
...
*   [activerecord-postgis-adapter (⭐916)](https://github.com/rgeo/activerecord-postgis-adapter) - ActiveRecord connection adapter for PostGIS. [:red\_circle:](https://rubygems.org/gems/activerecord-postgis-adapter)
...
*   [activity\_notification (⭐515)](https://github.com/simukappu/activity_notification) - A gem to integrate user activity notification. [:red\_circle:](https://rubygems.org/gems/activity_notification)
...
*   [algoliasearch-rails (⭐417)](https://github.com/algolia/algoliasearch-rails) - A gem to integrate Algolia search. [:red\_circle:](https://rubygems.org/gems/algoliasearch-rails)
...
*   [anycable-rails (⭐514)](https://github.com/anycable/anycable-rails) - A gem to handle websocket server. [:red\_circle:](https://rubygems.org/gems/anycable-rails)
...
*   [bulma-rails (⭐356)](https://github.com/joshuajansen/bulma-rails) - A wrapper for Bulma, a CSS framework based on flexbox. [:red\_circle:](https://rubygems.org/gems/bulma-rails)
...
*   [caxlsx\_rails (⭐754)](https://github.com/caxlsx/caxlsx_rails) - A gem to generate entity-relationship diagram. [:red\_circle:](https://rubygems.org/gems/caxlsx_rails)
...
*   [frozen\_record (⭐430)](https://github.com/byroot/frozen_record) - A gem to provide ActiveRecord-like interface to query static YAML files. [:red\_circle:](https://rubygems.org/gems/frozen_record)
...
*   [gretel (⭐20)](https://github.com/kzkn/gretel) - A tool to generate breadcrumbs. [:red\_circle:](https://rubygems.org/gems/gretel)
...
*   [kt-paperclip (⭐288)](https://github.com/kreeti/kt-paperclip) - A gem to handle file uploads. [:red\_circle:](https://rubygems.org/gems/kt-paperclip)
...
*   [rgeo-activerecord (⭐97)](https://github.com/rgeo/rgeo-activerecord) - A gem to provide common tools used by RGeo-based spatial adapters. [:red\_circle:](https://rubygems.org/gems/rgeo-activerecord)
*   [rodauth-rails (⭐719)](https://github.com/janko/rodauth-rails) - A gem to wrap Rodauth, an authentication handler, for Rails apps. [:red\_circle:](https://rubygems.org/gems/rodauth-rails)
*   [rollup (⭐343)](https://github.com/ankane/rollup) -  A gem to handle time-series data in Rails [:red\_circle:](https://rubygems.org/gems/rollups)
*   [route\_translator (⭐933)](https://github.com/enriclluelles/route_translator) - A tool to handle route translation. [:red\_circle:](https://rubygems.org/gems/route_translator)
...
*   [solidus (⭐5.2k)](https://github.com/solidusio/solidus) - A fork of Spree gem, an open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/solidus)
*   [sorbet-rails (⭐633)](https://github.com/chanzuckerberg/sorbet-rails) - A gem to integrate Sorbet gem in Rails apps. [:red\_circle:](https://rubygems.org/gems/sorbet-rails)
...
*   [stimulus-rails (⭐707)](https://github.com/hotwired/stimulus-rails) - A gem to integrate Stimulus.js in Rails apps. [:red\_circle:](https://rubygems.org/gems/stimulus-rails)
...
*   [trove (⭐75)](https://github.com/ankane/trove) - A gem to handle machine learning models deployment. [:red\_circle:](https://rubygems.org/gems/trove)
...
*   [rails-template(ackama) (⭐363)](https://github.com/ackama/rails-template) - Application template for Rails 6.1 projects; preloaded with best practices for TDD, security, deployment, and developer productivity.
...
*   [rails-templates(lewagon) (⭐678)](https://github.com/lewagon/rails-templates) - Jump start your Rails development with Le Wagon best practices.
...
*   [vuejs-rails-starterkit (⭐214)](https://github.com/jetthoughts/vuejs-rails-starterkit) - Vue.js + Rails Starting Kit GitHub Template to develop Hybrid Mobile Application.
...
*   [adopt-a-hydrant (⭐761)](https://github.com/codeforamerica/adopt-a-hydrant) - A civic infrastructure detection app (using Rails 4.2).
...
*   [canvas-lms (⭐6.3k)](https://github.com/instructure/canvas-lms) - A learning management app.
...
*   [covoiturage-libre (⭐113)](https://github.com/covoiturage-libre/covoiturage-libre) - A carpooling app - using Rails 5.0 (archived).
...
*   [encrypt.to (⭐141)](https://github.com/encrypt-to/encrypt.to) - A messaging app with encryption support (using Rails 4.2).
...
*   [intercityup.com (⭐115)](https://github.com/intercity/intercity-next) - A control panel app for app deployment (using Rails 4.1).
*   [kitsu-tools (⭐2.2k)](https://github.com/hummingbird-me/kitsu-tools) - An anime discovery platform (using Rails 4.1).
*   [lavish (⭐690)](https://github.com/mquan/lavish) - A color scheme generator (using Rails 4.2).
*   [lifeToRemind (⭐11)](https://github.com/eduqg/LifeToRemind) - A career planning app (using Rails 5.2).
*   [obtvse2 (⭐256)](https://github.com/natew/obtvse2) - A blogging app (using Rails 4.0).
...
*   [whitehall (⭐977)](https://github.com/alphagov/whitehall) - A content management app used by UK government - using Rails 7.0
