...
*   [HammerDB (⭐733)](https://github.com/TPC-Council/HammerDB) - An open-source database benchmark for MySQL/MariaDB and other open source and commercial databases.
*   [go-tpc (⭐210)](https://github.com/pingcap/go-tpc) - A golang port of [TPCC](http://www.tpc.org/tpcc/) and [TPCH](http://www.tpc.org/tpch/) benchmark for MySQL.
...
*   [TPCC-MySQL (⭐490)](https://github.com/Percona-Lab/tpcc-mysql) (archived) - A port of the popular [TPCC](http://www.tpc.org/tpcc/) benchmark for MySQL.

## Binlog-Replication

*   [DM (⭐454)](https://github.com/pingcap/tiflow) - A High-Availability data migration platform which supports migrating data from MySQL/MariaDB to TiDB and merging shard tables
*   [Kingbus (⭐895)](https://github.com/flike/kingbus) - A distributed MySQL binlog storage system built on Raft
...
*   [MariaDB Connector/J (⭐357)](https://github.com/mariadb-corporation/mariadb-connector-j) - LGPL-licensed MariaDB Client Library for Java Applications.
...
*   [MySQL Connector/C++ (⭐699)](https://github.com/mysql/mysql-connector-cpp) - Official C/C++ driver for MySQL.
...
*   [MySQL Connector/NET (⭐324)](https://github.com/mysql/mysql-connector-net) - a standardized database driver for .Net platforms and development.
*   [MySQL Connector/Node.js (⭐159)](https://github.com/mysql/mysql-connector-nodejs) - Official Node.js driver for MySQL.
*   [MySQL Connector/Python (⭐943)](https://github.com/mysql/mysql-connector-python) - a standardized database driver for Python platforms and development.
...
*   [wtx (⭐343)](https://github.com/c410-f3r/wtx) - Client for MySQL/MariaDB/Percona written in Rust

## Deployment

*MySQL deployment tools*

*   [MariaDB4j (⭐894)](https://github.com/MariaDB4j/MariaDB4j) - A Java launcher to run MariaDB without installation or external dependencies.
...
*   [Liquibase (⭐5.4k)](https://github.com/liquibase/liquibase) - Source control for your database
...
*   [MySQL Shell (⭐217)](https://github.com/mysql/mysql-shell/) - Advanced client and code editor for MySQL that supports development and administration for the MySQL Server and MySQL InnoDB cluster (AdminAPI) with an interactive JavaScript, Python, or SQL interface.
*   [MySQL Workbench (⭐984)](https://github.com/mysql/mysql-workbench) - provides DBAs and developers an integrated tools environment for database design & modeling; SQL devleopment; database administration.
...
*   [Galera Cluster (⭐487)](https://github.com/codership/galera) - a true Multimaster Cluster based on synchronous replication.
...
*   [replication-manager (⭐727)](https://github.com/signal18/replication-manager) - a high availability solution to manage MariaDB 10.x and MySQL & Percona Server 5.7 GTID replication topologies.

## MCP

*   [MCP MariaDB Server (⭐131)](https://github.com/MariaDB/mcp) - the official MariaDB MCP server.
*   [MySQL MCP Server (⭐12)](https://github.com/askdba/mysql-mcp-server) - Advanced MCP server exposing MySQL via the Model Context Protocol
...
*   [sys (⭐829)](https://github.com/mysql/mysql-sys) (archived) - A collection of views, functions and procedures to help MySQL administrators get insight in to MySQL Database usage. See [sys schema docs](https://dev.mysql.com/doc/refman/8.4/en/sys-schema.html)
...
*   [MariaDB (⭐7.2k)](https://github.com/MariaDB/server) - Community developed fork of MySQL server.
...
*   [MyVector (⭐1)](https://github.com/askdba/myvector) - Native vector search plugin for MySQL, shipped as a server plugin.
...
*   [UnDROP (⭐416)](https://github.com/twindb/undrop-for-innodb) (archived) - a tool to recover data from dropped or corrupted InnoDB tables.
...
*   [VillageSQL (⭐98)](https://github.com/villagesql/villagesql-server) - A drop-in replacement for MySQL with extensions for the agentic AI era.
