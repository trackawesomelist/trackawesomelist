...
[🏠 Home](/README.md) · [🔥 Feed](https://www.trackawesomelist.com/jaredthecoder/awesome-vehicle-security/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 jaredthecoder/awesome-vehicle-security](https://github.com/jaredthecoder/awesome-vehicle-security) · ⭐ 2.7K · 🏷️ Security
...
I would love as much help as I can get. [Start contributing! (⭐2.7k)](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md)
...
*   [Awesome CAN Bus - an awesome list just for CAN Bus-related tools (hardware, software, etc.) (⭐1.6k)](https://github.com/iDoka/awesome-canbus)
*   [Awesome LIN Bus - an awesome list just for LIN-Bus related tools (hardware, software, etc.) (⭐112)](https://github.com/iDoka/awesome-linbus)
...
[Welcoming contributions (⭐2.7k)](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md)!
...
[Custom Applications SDK for Mazda Connect Infotainment System (⭐167)](https://github.com/flyandi/mazda-custom-application-sdk) - A micro framework that allows you to write and deploy custom applications for the Mazda Infotainment System.
...
Your contributions are always welcome! Please take a look at the [contribution guidelines (⭐2.7k)](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) first.
