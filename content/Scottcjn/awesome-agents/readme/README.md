...
Contributions welcome! Please read the [contribution guidelines](https://github.com/Scottcjn/awesome-agents/blob/main/README.md/CONTRIBUTING.md) first.

## Footnotes

This list is maintained by [Elyan Labs](https://github.com/Scottcjn). Built with the same ethos as the [OpenClaw Beacon (⭐116)](https://github.com/Scottcjn/beacon-skill) network — open discovery, interoperability, and agent autonomy.
