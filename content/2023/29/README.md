...
*   [iUI (⭐112)](https://github.com/isaiahpatton/ui) - Isaiah's cross-platform GUI library for V. Inspired by the syntax of Java's Swing.
...
*   [terragrunt-atlantis-config (⭐659)](https://github.com/transcend-io/terragrunt-atlantis-config) - Generate Atlantis config for Terragrunt projects.
...
*   [shoes (⭐334)](https://github.com/cfal/shoes) - A multi-protocol proxy server
...
*   [awesome-anti-forensic (⭐834)](https://github.com/remiflavien1/awesome-anti-forensic) by @remiflavien1
...
*   [awesome-privacy (⭐7.4k)](https://github.com/Lissy93/awesome-privacy/) by @Lissy93
...
*   [awesome-threat-intelligence (⭐8.5k)](https://github.com/hslatman/awesome-threat-intelligence) by @hslatman
...
*   [SecLists (⭐61k)](https://github.com/danielmiessler/SecLists) by @danielmiessler
...
*   [AD9833-MicroPython-Module (⭐8)](https://github.com/owainm713/AD9833-MicroPython-Module) - MicroPython module to use the AD9833 programmable waveform generator.
...
*   [nvimdev/lspsaga.nvim (⭐3.6k)](https://github.com/nvimdev/lspsaga.nvim) - A light-weight LSP plugin based on Neovim's built-in LSP with a highly performant UI.

### Markdown and LaTeX / Diagnostics

*   [richardbizik/nvim-toc (⭐40)](https://github.com/richardbizik/nvim-toc) - Easily generate table of contents for markdown files.

### Tree-sitter Supported Colorscheme / Diagnostics

*   [nvimdev/zephyr-nvim (⭐360)](https://github.com/nvimdev/zephyr-nvim) - A dark colorscheme with Tree-sitter support.
*   [AlexvZyl/nordic.nvim (⭐815)](https://github.com/AlexvZyl/nordic.nvim) - Nord for Neovim, but warmer and darker. Supports a variety of plugins and other platforms.
...
*   [HiPhish/rainbow-delimiters.nvim (⭐655)](https://github.com/HiPhish/rainbow-delimiters.nvim) - Rainbow delimiters with Tree-sitter.
...
*   [niuiic/format.nvim (⭐33)](https://github.com/niuiic/format.nvim) - An asynchronous, multitasking, and highly configurable formatting plugin.
*   [elentok/format-on-save.nvim (⭐168)](https://github.com/elentok/format-on-save.nvim) - A synchronous formatter that combines LSP and non-LSP formatting (e.g. shfmt, stylua, prettier), focused specifically on format-on-save.
