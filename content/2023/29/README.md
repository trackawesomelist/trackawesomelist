...
*   [iUI (⭐88)](https://github.com/isaiahpatton/ui) - Isaiah's cross-platform GUI library for V. Inspired by the syntax of Java's Swing.
...
*   [ble.sh (⭐2.4k)](https://github.com/akinomyoga/ble.sh) - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
*   [shoes (⭐194)](https://github.com/cfal/shoes) - A multi-protocol proxy server
...
## [12. Awesome Chatgpt](/content/saharmor/awesome-chatgpt/week/README.md)
...
## [24. Awesome Orgs](/content/beansource/awesome-orgs/week/README.md)
...
*   [FUSB302B (⭐19)](https://github.com/fmckeogh/usb-pd-rs) - I2C - Programmable USB Type‐C Controller with USB Power Delivery - [github (⭐19)](https://github.com/fmckeogh/usb-pd-rs)
...
*   [usb-pd (⭐19)](https://github.com/fmckeogh/usb-pd-rs): USB-PD library, supports using the FUSB302B as a Sink driver, with Source functionality planned.

### Firmware projects / WIP

*   [Stabilizer (⭐104)](https://github.com/quartiq/stabilizer): Firmware for a DSP tool used in quantum physics experimentation, includes telemetry via MQTT and run-time configuration
...
*   [Card/IO ECG (⭐29)](https://github.com/card-io-ecg/card-io-fw): Firmware for a business-card-sized ECG device with Wifi connectivity

## [30. Awesome Ada](/content/ohenley/awesome-ada/week/README.md)

### OS and Kernels / Apache License

*   [hirtos (⭐29)](https://github.com/jgrivera67/HiRTOS) - A high-integrity RTOS written in SPARK Ada.
...
*   [ReactPy (⭐7.8k)](https://github.com/reactive-python/reactpy) - It's React, but in Python. Insert dynamically rendered Python into Django templates using the [ReactPy-Django module (⭐322)](https://github.com/reactive-python/reactpy-django).
...
## [44. Awesome Azure Openai Llm](/content/kimtth/awesome-azure-openai-llm/week/README.md)
...
*   [nvimdev/zephyr-nvim (⭐340)](https://github.com/nvimdev/zephyr-nvim) - A dark colorscheme with Tree-sitter support.
*   [AlexvZyl/nordic.nvim (⭐667)](https://github.com/AlexvZyl/nordic.nvim) - Nord for Neovim, but warmer and darker. Supports a variety of plugins and other platforms.
...
*   [elentok/format-on-save.nvim (⭐157)](https://github.com/elentok/format-on-save.nvim) - A synchronous formatter that combines LSP and non-LSP formatting (e.g. shfmt, stylua, prettier), focused specifically on format-on-save.
...
## [51. Awesome Cryptography](/content/sobolevn/awesome-cryptography/week/README.md)
