...
*   [mgl (⭐338)](https://github.com/melisgl/mgl/) - Neural networks (boltzmann machines, feed-forward and recurrent nets), Gaussian Processes.
...
*   [SignalProcessing (⭐323)](https://github.com/JuliaDSP/DSP.jl) - Signal Processing tools for Julia.
...
*   [Torch7](http://torch.ch/)
    ...
    *   [cutorch (⭐334)](https://github.com/torch/cutorch) - Torch CUDA Implementation.
...
*   [Little Ball of Fur (⭐619)](https://github.com/benedekrozemberczki/littleballoffur) -> A graph sampling extension library for NetworkX with a Scikit-Learn like API.
