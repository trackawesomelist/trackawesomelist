...
[🏠 Home](/README.md) · [🔍 Search](https://www.trackawesomelist.com/search/) · [🔥 Feed](https://www.trackawesomelist.com/ChristosChristofidis/awesome-deep-learning/week/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 ChristosChristofidis/awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) · ⭐ 25K · 🏷️ Computer Science
...
*   [SberQuAD (⭐2)](https://github.com/annnyway/QA-for-Russian) - Sberbank released \~90,000 Russian QA pairs
...
*   [InsNet - A neural network library for building instance-dependent NLP models with padding-free dynamic batching (⭐66)](https://github.com/chncwang/InsNet)

## [Apr 25 - May 01, 2022](/content/2022/17/README.md)

### Researchers / Tools

*   [Nebullvm (⭐8.4k)](https://github.com/nebuly-ai/nebullvm) - Easy-to-use library to boost deep learning inference leveraging multiple deep learning compilers.
...
*   [Colossal-AI - An Integrated Large-scale Model Training System with Efficient Parallelization Techniques (⭐41k)](https://github.com/hpcaitech/ColossalAI)
...
*   [Awesome Drug Interactions, Synergy, and Polypharmacy Prediction (⭐94)](https://github.com/AstraZeneca/awesome-polipharmacy-side-effect-prediction/)
...
*   [LLVIP (⭐725)](https://github.com/bupt-ai-cz/LLVIP) - 15488 visible-infrared paired images (30976 images) for low-light vision research, [Project\_Page](https://bupt-ai-cz.github.io/LLVIP/)
*   [MSDA (⭐202)](https://github.com/bupt-ai-cz/Meta-SelfLearning) - Over over 5 million images from 5 different domains for multi-source ocr/text recognition DA research, [Project\_Page](https://bupt-ai-cz.github.io/Meta-SelfLearning/)
...
*   [hub (⭐8.6k)](https://github.com/activeloopai/Hub) - Fastest unstructured dataset management for TensorFlow/PyTorch by activeloop.ai. Stream & version-control data. Converts large data into single     numpy-like array on the cloud, accessible on any machine.
...
*   [Trax — Deep Learning with Clear Code and Speed (⭐8.2k)](https://github.com/google/trax)
*   [Flax - a neural network ecosystem for JAX that is designed for flexibility (⭐6.6k)](https://github.com/google/flax)
*   [QuickVision (⭐51)](https://github.com/Quick-AI/quickvision)
...
*   [lightly - A computer vision framework for self-supervised learning (⭐3.4k)](https://github.com/lightly-ai/lightly)
...
*   [Determined (⭐3.1k)](https://github.com/determined-ai/determined) - Deep learning training platform with integrated support for distributed training, hyperparameter tuning, smart GPU scheduling, experiment tracking, and a model registry.
...
*   [PyTorch Geometric Temporal - Representation learning on dynamic graphs (⭐6.1k)](https://github.com/gojek/feast)
...
*   [Hopsworks - A Feature Store for ML and Data-Intensive AI (⭐1.2k)](https://github.com/logicalclocks/hopsworks)
*   [Feast - A Feature Store for ML for GCP by Gojek/Google (⭐6.1k)](https://github.com/gojek/feast)
...
*   [Hardware for AI: Understanding computer hardware & build your own computer (⭐9)](https://github.com/MelAbgrall/HardwareforAI)
...
*   [Catalyst: High-level utils for PyTorch DL & RL research. It was developed with a focus on reproducibility, fast experimentation and code/ideas reusing (⭐3.4k)](https://github.com/catalyst-team/catalyst)
*   [garage - A toolkit for reproducible reinforcement learning research (⭐2k)](https://github.com/rlworkgroup/garage)
*   [Detecto - Train and run object detection models with 5-10 lines of code (⭐619)](https://github.com/alankbi/detecto)
*   [Karate Club - An unsupervised machine learning library for graph structured data (⭐2.2k)](https://github.com/benedekrozemberczki/karateclub)
*   [Synapses - A lightweight library for neural networks that runs anywhere (⭐71)](https://github.com/mrdimosthenis/Synapses)
*   [TensorForce - A TensorFlow library for applied reinforcement learning (⭐3.3k)](https://github.com/reinforceio/tensorforce)

### Researchers / Tools

*   [ML Workspace (⭐3.5k)](https://github.com/ml-tooling/ml-workspace) - All-in-one web-based IDE for machine learning and data science.
*   [dowel (⭐33)](https://github.com/rlworkgroup/dowel) - A little logger for machine learning research. Log any object to the console, CSVs, TensorBoard, text log files, and more with just one call to `logger.log()`

### Researchers / Miscellaneous

*   [Microsoft Recommenders (⭐20k)](https://github.com/Microsoft/Recommenders) contains examples, utilities and best practices for building recommendation systems. Implementations of several state-of-the-art algorithms are provided for self-study and customization in your own applications.
...
*   [Ladder Network (⭐100)](https://github.com/divamgupta/ladder_network_keras) - Keras Implementation of Ladder Network for Semi-Supervised Learning
...
*   [MXnet - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning framework (⭐21k)](https://github.com/apache/incubator-mxnet)
...
*   [Neuraxle - A general-purpose ML pipelining framework (⭐612)](https://github.com/Neuraxio/Neuraxle)
...
*   [Dockerface (⭐191)](https://github.com/natanielruiz/dockerface) - Easy to install and use deep learning Faster R-CNN face detection for images and video in a docker container.
*   [Awesome Deep Learning Music (⭐2.9k)](https://github.com/ybayle/awesome-deep-learning-music) - Curated list of articles related to deep learning scientific research applied to music
*   [Awesome Graph Embedding (⭐4.8k)](https://github.com/benedekrozemberczki/awesome-graph-embedding) - Curated list of articles related to deep learning scientific research on graph structured data at the graph level.
*   [Awesome Network Embedding (⭐2.6k)](https://github.com/chihming/awesome-network-embedding) - Curated list of articles related to deep learning scientific research on graph structured data at the node level.
...
*   [TensorWatch (⭐3.4k)](https://github.com/microsoft/tensorwatch) - Debugging and visualization for deep learning
...
*   [albumentations - A fast and framework agnostic image augmentation library (⭐15k)](https://github.com/albu/albumentations)

### Researchers / Tools

*   [Jupyter Notebook](http://jupyter.org) - Web-based notebook environment for interactive computing
*   [TensorBoard (⭐6.9k)](https://github.com/tensorflow/tensorboard) - TensorFlow's Visualization Toolkit

### Researchers / Miscellaneous

*   [Torch7 Cheat sheet (⭐9k)](https://github.com/torch/torch7/wiki/Cheatsheet)
...
*   [Fashion-MNIST (⭐12k)](https://github.com/zalandoresearch/fashion-mnist) - MNIST like fashion product dataset consisting of a training set of 60,000 examples and a test set of 10,000 examples. Each example is a 28x28 grayscale image, associated with a label from 10 classes.

## [Feb 12 - Feb 18, 2018](/content/2018/7/README.md)

### Researchers / Datasets

*   [FakeNewsCorpus (⭐395)](https://github.com/several27/FakeNewsCorpus) - Contains about 10 million news articles classified using [opensources.co](http://opensources.co) types

## [Feb 05 - Feb 11, 2018](/content/2018/6/README.md)

### Researchers / Frameworks

*   [Coach - Reinforcement Learning Coach by Intel® AI Lab (⭐2.3k)](https://github.com/NervanaSystems/coach)
...
*   [Pytorch Tutorial by Yunjey Choi (⭐31k)](https://github.com/yunjey/pytorch-tutorial)
...
*   [Serpent.AI - Game agent framework: Use any video game as a deep learning sandbox (⭐6.9k)](https://github.com/SerpentAI/SerpentAI)
...
*   [CNTK - Microsoft Cognitive Toolkit (⭐18k)](https://github.com/Microsoft/CNTK)
...
*   [The Best Machine Learning Tutorials On The Web (⭐469)](https://github.com/josephmisiti/machine-learning-module)

### Researchers / Frameworks

*   [nolearn - wrappers and abstractions around existing neural network libraries, most notably Lasagne (⭐952)](https://github.com/dnouri/nolearn)
*   [Sonnet - a library for constructing neural networks by Google's DeepMind (⭐9.9k)](https://github.com/deepmind/sonnet)
*   [PyTorch - Tensors and Dynamic neural networks in Python with strong GPU acceleration (⭐90k)](https://github.com/pytorch/pytorch)
...
*   [Reproducing the results of "Playing Atari with Deep Reinforcement Learning" by DeepMind (⭐654)](https://github.com/kristjankorjus/Replicating-DeepMind)
...
*   [Lasagne - a lightweight library to build and train neural networks in Theano (⭐3.9k)](https://github.com/Lasagne/Lasagne)

## [Dec 12 - Dec 18, 2016](/content/2016/50/README.md)

### Table of Contents / Tutorials

*   [Classification on raw time series in TensorFlow with a LSTM RNN (⭐3.4k)](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition)

## [Dec 05 - Dec 11, 2016](/content/2016/49/README.md)

### Table of Contents / Tutorials

*   [Torch7 Tutorials (⭐130)](https://github.com/clementfarabet/ipam-tutorials/tree/master/th_tutorials)
...
*   [Open Images dataset (⭐4.3k)](https://github.com/openimages/dataset) - Open Images is a dataset of \~9 million URLs to images that have been annotated with labels spanning over 6000 categories.

## [Aug 29 - Sep 04, 2016](/content/2016/35/README.md)

### Researchers / Frameworks

*   [Paddle - PArallel Distributed Deep LEarning by Baidu (⭐23k)](https://github.com/baidu/paddle)
...
*   [SyntaxNet - Google's syntactic parser - A TensorFlow dependency library (⭐78k)](https://github.com/tensorflow/models/tree/master/syntaxnet)
...
*   [More TensorFlow tutorials (⭐5.7k)](https://github.com/pkmital/tensorflow_tutorials)
...
*   [Keras and Lasagne Deep Learning Tutorials (⭐424)](https://github.com/Vict0rSch/deep_learning)

## [Nov 30 - Dec 06, 2015](/content/2015/48/README.md)

### Researchers / Frameworks

*   [Veles - Samsung Distributed machine learning platform (⭐908)](https://github.com/Samsung/veles)
*   [Marvin - A Minimalist GPU-only N-Dimensional ConvNets Framework (⭐423)](https://github.com/PrincetonVision/marvin)

## [Nov 23 - Nov 29, 2015](/content/2015/47/README.md)

### Table of Contents / Tutorials

*   [TensorFlow Python Notebooks (⭐44k)](https://github.com/aymericdamien/TensorFlow-Examples)
...
*   [TensorFlow tutorials (⭐6k)](https://github.com/nlintz/TensorFlow-Tutorials)

### Researchers / Frameworks

*   [Tensorflow - Open source software library for numerical computation using data flow graphs (⭐190k)](https://github.com/tensorflow/tensorflow)
...
*   [Minerva - a fast and flexible tool for deep learning on multi-GPU (⭐700)](https://github.com/dmlc/minerva)
...
*   [neuraltalk (⭐5.4k)](https://github.com/karpathy/neuraltalk) by Andrej Karpathy : numpy-based RNN/LSTM implementation
...
*   [char-rnn (⭐12k)](https://github.com/karpathy/char-rnn)
...
*   [Nvidia DIGITS - a web app based on Caffe (⭐4.2k)](https://github.com/NVIDIA/DIGITS)

### Researchers / Miscellaneous

*   [Caffe DockerFile (⭐81)](https://github.com/tleyden/docker/tree/master/caffe)
...
*   [Wiki2Vec. Getting Word2vec vectors for entities and word from Wikipedia Dumps (⭐600)](https://github.com/idio/wiki2vec)
...
*   [convetjs (⭐11k)](https://github.com/karpathy/convnetjs)
*   [DeepLearnToolbox (⭐3.8k)](https://github.com/rasmusbergpalm/DeepLearnToolbox)
*   [Deepnet (⭐897)](https://github.com/nitishsrivastava/deepnet)
...
*   [OpenDL (⭐220)](https://github.com/guoding83128/OpenDL)
*   [cuDNN](https://developer.nvidia.com/cuDNN)

### Researchers / Miscellaneous

*   [gfx.js (⭐125)](https://github.com/clementfarabet/gfx.js)
...
*   [A chess AI that learns to play chess using deep learning. (⭐817)](https://github.com/erikbern/deep-pink)
...
*   [TorontoDeepLEarning convnet (⭐506)](https://github.com/TorontoDeepLearning/convnet)