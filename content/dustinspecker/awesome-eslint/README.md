...
*   [paths (⭐38)](https://github.com/vitonsky/eslint-plugin-paths) - Use paths from tsconfig/jsconfig and auto fix relative paths to aliases.
...
*   [Playwright (⭐232)](https://github.com/playwright-community/eslint-plugin-playwright) - Linting rules for Playwright.
...
*   [Svelte (⭐266)](https://github.com/sveltejs/eslint-plugin-svelte) - Linting rules for Svelte v3 Components.

## [Feb 21, 2023](/content/2023/02/21/README.md)

### Configs / Other Configs

*   [Sheriff (⭐90)](https://github.com/AndreaPontrandolfo/sheriff) - Comprehensive and highly opinionated Eslint configuration. Typescript oriented.
...
*   [html (⭐27)](https://github.com/shuoshubao/eslint-formatter-html) - A enhanced ESLint formatter
...
*   [eslint-doc-generator (⭐90)](https://github.com/bmish/eslint-doc-generator) - Generate documentation for your ESLint plugin including a rules table for your readme and header for your rule docs.
...
*   [eslint-plugin-hexagonal-architecture (⭐282)](https://github.com/CodelyTV/eslint-plugin-hexagonal-architecture) - A plugin that helps you to enforce hexagonal architecture best practices.

## [Aug 23, 2022](/content/2022/08/23/README.md)

### Plugins / Frameworks

*   [Solid (⭐200)](https://github.com/joshwilsonvu/eslint-plugin-solid) - Linting rules for Solid and JSX.
...
*   [Astro (⭐271)](https://github.com/ota-meshi/eslint-plugin-astro) - Plugin for [Astro components](https://docs.astro.build/en/core-concepts/astro-components/).

## [Feb 17, 2022](/content/2022/02/17/README.md)

### Plugins / Code Quality

*   [GitHub (⭐280)](https://github.com/github/eslint-plugin-github) - Misc. rules from GitHub.
...
*   [eslint-plugin-eslint-plugin (⭐185)](https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin) - An ESLint plugin for linting ESLint plugins.
...
*   [ESLint Comments (⭐353)](https://github.com/mysticatea/eslint-plugin-eslint-comments) - Best practices about ESLint directive comments (`/*eslint-disable*/`, etc.).
...
*   [eslint-define-config (⭐343)](https://github.com/Shinigami92/eslint-define-config) - Provide a `defineConfig` function for `.eslintrc.js` files.
...
*   [eslint-interactive (⭐326)](https://github.com/mizdra/eslint-interactive) - The CLI tool to fix huge number of ESLint errors.
...
*   [Diff (⭐162)](https://github.com/paleite/eslint-plugin-diff) - Run ESLint on your changed lines only. Also supports CI!
...
*   JSON
    *   [JSON (⭐193)](https://github.com/azeemba/eslint-plugin-json) - Lint your JSON files.
    ...
    *   [JSON with Comments (⭐173)](https://github.com/ota-meshi/eslint-plugin-jsonc) - ESLint plugin for JSON, JSONC and JSON5.
    *   [JSON Schema (⭐64)](https://github.com/ota-meshi/eslint-plugin-json-schema-validator) - Validates data defined in JavaScript, JSON, YAML and TOML using JSON Schema Validator.

## [Feb 07, 2021](/content/2021/02/07/README.md)

### Configs / Other Prominent Configs (100 stars or so)

*   [Auto (⭐395)](https://github.com/davidjbradshaw/eslint-config-auto) - Automatically configure ESLint based on your project's dependencies.
...
*   [HTML (⭐143)](https://github.com/yeonjuan/html-eslint) - ESLint plugin for HTML.
...
*   [generator-eslint (⭐224)](https://github.com/eslint/generator-eslint) - Generate ESLint
...
*   [YAML (⭐105)](https://github.com/ota-meshi/eslint-plugin-yml) - ESLint plugin for YAML.
...
*   GraphQL
    *   [dotansimha/graphql-eslint (⭐768)](https://github.com/dotansimha/graphql-eslint) - Validates, prettifies and checks your GraphQL operations and GraphQL schema for best-practices.
...
*   [GraphQL (⭐768)](https://github.com/dotansimha/graphql-eslint) - Parser for the GraphQL AST. Includes parser, plugin, processor (for non-graphql files) and rules.

## [Sep 04, 2020](/content/2020/09/04/README.md)

### Plugins / Languages and Environments

*   [MDX (⭐254)](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) - ESLint Parser/Plugin for MDX.

## [Aug 29, 2020](/content/2020/08/29/README.md)

### Plugins / CSS in JS

*   [CSS-modules (⭐151)](https://github.com/atfzl/eslint-plugin-css-modules) - Lint undefined or unused rules for css modules.
*   Styled Components
    ...
    *   [styled-components-a11y (⭐139)](https://github.com/brendanmorrell/eslint-plugin-styled-components-a11y) - A11y for Styled Components.
...
*   [RegExp (⭐654)](https://github.com/ota-meshi/eslint-plugin-regexp) - ESLint plugin for finding regexp mistakes and style guide violations.
...
*   [Healthier (⭐83)](https://github.com/KidkArolis/healthier) - Code style agnostic version of Standard, perfect companion to Prettier.
...
*   [ES and browser globals (⭐350)](https://github.com/sindresorhus/globals) (originally from ESLint)
...
*   [Shopify (⭐459)](https://github.com/Shopify/web-foundation/blob/main/packages/eslint-plugin/README.md) - Shareable config for [Shopify's style guide (⭐253)](https://github.com/Shopify/javascript).
...
*   [boundaries (⭐469)](https://github.com/javierbrea/eslint-plugin-boundaries) - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
...
*   [ecmascript-compat (⭐61)](https://github.com/robatwilliams/es-compat) - Disable ECMAScript language features not supported by your browserslist targets.
...
*   [deprecation (⭐295)](https://github.com/gund/eslint-plugin-deprecation) - Identifies use of
...
*   [HTML (⭐424)](https://github.com/BenoitZugmeyer/eslint-plugin-html) - Linting for JavaScript inside of HTML `<script>` tags.
*   [Markdown (⭐363)](https://github.com/eslint/eslint-plugin-markdown) - Linting for JavaScript inside of Markdown.
...
*   React
    ...
    *   [React Hooks (⭐223k)](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) - Linting rules for React Hooks.
    *   [React Native (⭐710)](https://github.com/Intellicode/eslint-plugin-react-native) - React Native specific linting rules.
...
*   Vue
    ...
    *   [VueJS Scoped CSS (⭐93)](https://github.com/future-architect/eslint-plugin-vue-scoped-css) - Plugin for Scoped CSS in VueJS.
...
*   [Node (⭐956)](https://github.com/mysticatea/eslint-plugin-node) - Additional ESLint's rules for Node.js.
...
*   Lodash
    ...
    *   [Lodash/fp (⭐149)](https://github.com/jfmengels/eslint-plugin-lodash-fp) - Lodash/fp specific linting rules.
...
*   [PutOut (⭐661)](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) - an ESLint plugin integrates [putout (⭐661)](https://github.com/coderaiser/putout) linter into ESLint.

### Plugins / Practices and Specific ES Features

*   [Immutable (⭐910)](https://github.com/jhusain/eslint-plugin-immutable) - Disable all mutation in JavaScript.

### Plugins / Performance

*   [DOM (⭐9)](https://github.com/amilajack/eslint-plugin-dom)
*   [Optimize Regex (⭐73)](https://github.com/BrainMaestro/eslint-plugin-optimize-regex) - Optimize regex literals.
...
*   Jest
    ...
    *   [Jest-DOM (⭐352)](https://github.com/testing-library/eslint-plugin-jest-dom) - Linting rules for Jest-DOM.
...
*   [Only-Warn (⭐153)](https://github.com/bfanger/eslint-plugin-only-warn) - Convert all rules to warnings.

### Plugins / Testing Tools

*   [Testing Library (⭐961)](https://github.com/testing-library/eslint-plugin-testing-library) - Linting rules for Testing Library.

## [Jun 03, 2020](/content/2020/06/03/README.md)

### Plugins / Security

*   [no-secrets (⭐123)](https://github.com/nickdeis/eslint-plugin-no-secrets) - An eslint plugin that detects potential secrets/credentials.
*   [no-unsanitized (⭐217)](https://github.com/mozilla/eslint-plugin-no-unsanitized) - Checks for `innerHTML`, `outerHTML`, etc.
...
*   [Canonical (⭐569)](https://github.com/gajus/eslint-config-canonical) - Shareable config for [Canonical style guide (⭐18)](https://github.com/gajus/canonical).
...
*   [XO (⭐264)](https://github.com/xojs/eslint-config-xo) - Shareable config for [XO (⭐7.6k)](https://github.com/xojs/xo).
...
*   [Hardcore (⭐384)](https://github.com/EvgenyOrekhov/eslint-config-hardcore) - The most strict (but practical) ESLint config out there.
...
*   Mocha
    *   [Enforcing practices (⭐275)](https://github.com/lo1tuma/eslint-plugin-mocha) - Linting rules for Mocha.
...
*   [functional (⭐741)](https://github.com/jonaskello/eslint-plugin-functional) - ESLint rules to disable mutation and promote fp in JavaScript and TypeScript.
...
*   [array-func (⭐92)](https://github.com/freaktechnik/eslint-plugin-array-func) - Avoid redundancy when using es2015 array methods and functions.
...
*   [no-loops (⭐125)](https://github.com/buildo/eslint-plugin-no-loops) - It's 2019 and you still use loops?
...
*   [Switch case (⭐16)](https://github.com/lukeapage/eslint-plugin-switch-case) - Switch-case-specific linting rules for ESLint.
...
*   [Promise (⭐902)](https://github.com/xjamundx/eslint-plugin-promise) - Best practices when working with promises.
...
*   [eslint-nibble (⭐755)](https://github.com/IanVS/eslint-nibble) - Ease into ESLint, by fixing one rule at a time.
...
*   [eslint-watch (⭐192)](https://github.com/rizowski/eslint-watch) - Run ESLint with watch mode.
