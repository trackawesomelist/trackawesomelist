...
[🏠 Home](/README.md) · [🔥 Feed](https://www.trackawesomelist.com/ashishb/android-security-awesome/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 ashishb/android-security-awesome](https://github.com/ashishb/android-security-awesome) · ⭐ 9.2K · 🏷️ Security
...
1.  [Androwarn (⭐522)](https://github.com/maaaaz/androwarn/) - detect and warn the user about potential malicious behaviors developed by an Android application.
...
15. [RiskInDroid (⭐161)](https://github.com/ClaudiuGeorgiu/RiskInDroid) - A tool for calculating the risk of Android apps based on their permissions, with an online demo available.
16. [SUPER (⭐426)](https://github.com/SUPERAndroidAnalyzer/super) - Secure, Unified, Powerful, and Extensible Rust Android Analyzer
...
18. [StaCoAn (⭐866)](https://github.com/vincentcox/StaCoAn) - Cross-platform tool that aids developers, bug-bounty hunters, and ethical hackers in performing static code analysis on mobile applications. This tool was created with a big focus on usability and graphical guidance in the user interface.
...
22. [APKLeaks (⭐5.8k)](https://github.com/dwisiswant0/apkleaks) - Scanning APK file for URIs, endpoints & secrets.
23. [Mobile Audit (⭐225)](https://github.com/mpast/mobileAudit) - Web application for performing Static Analysis and detecting malware in Android APKs.
24. [Detekt (⭐6.8k)](https://github.com/detekt/detekt) - Static code analysis for Kotlin
25. [APKdevastate (⭐33)](https://github.com/rafigk2v9c/APKdevastate/) - Advanced analysis software for APK payloads created by RATs.
...
5.  [Droidbox (⭐795)](https://github.com/pjlantz/droidbox)
...
10. [ProbeDroid (⭐202)](https://github.com/ZSShen/ProbeDroid) - Dynamic Java code instrumentation
...
12. [CuckooDroid (⭐602)](https://github.com/idanr1986/cuckoo-droid) - Android extension for Cuckoo sandbox
...
21. [Vezir Project (⭐114)](https://github.com/oguzhantopgul/Vezir-Project) - Virtual Machine for Mobile Application Pentesting and Mobile Malware Analysis
22. [MARA (⭐665)](https://github.com/xtiankisutsa/MARA_Framework) - Mobile Application Reverse Engineering and Analysis Framework
...
25. [Android Malware Sandbox (⭐300)](https://github.com/Areizen/Android-Malware-Sandbox)
...
29. [Android\_application\_analyzer (⭐170)](https://github.com/NotSoSecure/android_application_analyzer) - The tool is used to analyze the content of the Android application in local storage.
30. [Decompiler.com](https://www.decompiler.com/) - Online APK and Java decompiler
31. [friTap (⭐461)](https://github.com/fkie-cad/friTap)- Intercept SSL/TLS connections with Frida; Allows TLS key extraction and decryption of TLS payload as PCAP on Android in real-time.
32. [HacknDroid (⭐124)](https://github.com/RaffaDNDM/HacknDroid) - A tool designed to automate various Mobile Application Penetration Testing (MAPT) tasks and facilitate interaction with Android devices.
33. [adbsploit (⭐875)](https://github.com/mesquidar/adbsploit) - tools for exploiting device via ADB
...
35. [MPT (⭐53)](https://github.com/ByteSnipers/mobile-pentest-toolkit) - MPT (Mobile Pentest Toolkit) is a must-have solution for your Android penetration testing workflows. This tool allows you to automate security tasks.
...
2.  [emacs syntax coloring for smali files (⭐35)](https://github.com/strazzere/Emacs-Smali)
...
9.  [Android OpenDebug (⭐135)](https://github.com/iSECPartners/Android-OpenDebug) – make any application on the device debuggable (using Cydia Substrate).
...
16. [Introspy (⭐483)](https://github.com/iSECPartners/Introspy-Android)
...
26. [Jadx (⭐47k)](https://github.com/skylot/jadx)
...
35. [odex-patcher (⭐100)](https://github.com/giacomoferretti/odex-patcher) - Run arbitrary code by patching OAT files
36. [PhoneSpolit-Pro (⭐5.6k)](https://github.com/AzeemIdrisi/PhoneSploit-Pro) - An all-in-one hacking tool to remotely exploit Android devices using ADB and Metasploit Framework to get a Meterpreter session.
37. [APKLab (⭐3.7k)](https://github.com/APKLab/APKLab) - plugin for VS code to analyze APKs
...
2.  [Google Play crawler (Python) (⭐897)](https://github.com/egirault/googleplay-api)
...
3.  [adb autocomplete (⭐260)](https://github.com/mbrubeck/android-completion)
4.  [mitmproxy (⭐42k)](https://github.com/mitmproxy/mitmproxy)
...
8.  [Internal Blue (⭐764)](https://github.com/seemoo-lab/internalblue) - Bluetooth experimentation framework based on the Reverse Engineering of Broadcom Bluetooth Controllers
...
10. [NullKia (⭐6)](https://github.com/bad-antics/nullkia) - Comprehensive mobile security framework supporting 18 manufacturers with baseband exploitation, cellular security, TEE/TrustZone research, and BootROM extraction tools.
11. [Firmware Extractor (⭐345)](https://github.com/AndroidDumps/Firmware_extractor) - Extract given archive to images
12. [ARMv7 payload that provides arbitrary code execution on MediaTek bootloaders (⭐175)](https://github.com/R0rt1z2/kaeru)
13. [DroidGround (⭐107)](https://github.com/SECFORCE/droidground) - A flexible playground for Android CTF challenges
14. [sundaysec/Android-Exploits (⭐962)](https://github.com/sundaysec/Android-Exploits) - A collection of android Exploits and Hacks
...
4.  [GoatDroid (⭐252)](https://github.com/jackMannino/OWASP-GoatDroid-Project)
5.  [Android InsecureBank (⭐1.4k)](https://github.com/dineshshetty/Android-InsecureBankv2)
6.  [Insecureshop (⭐256)](https://github.com/optiv/insecureshop)
7.  [Oversecured Vulnerable Android App (OVAA) (⭐730)](https://github.com/oversecured/ovaa)
...
2.  [Android security-related presentations (⭐175)](https://github.com/jacobsoo/AndroidSlides)
