...
[🏠 Home](/README.md) · [🔥 Feed](https://www.trackawesomelist.com/ashishb/android-security-awesome/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 ashishb/android-security-awesome](https://github.com/ashishb/android-security-awesome) · ⭐ 7.9K · 🏷️ Security
...
3.  [APKInspector (⭐826)](https://github.com/honeynet/apkinspector/)
...
11. [CFGScanDroid (⭐58)](https://github.com/douggard/CFGScanDroid) - Scans and compares CFG against CFG of malicious applications
...
14. [ConDroid (⭐54)](https://github.com/JulianSchuette/ConDroid) - Performs a combination of symbolic + concrete execution of the app
15. [DroidRA (⭐50)](https://github.com/serval-snt-uni-lu/DroidRA)
16. [RiskInDroid (⭐130)](https://github.com/ClaudiuGeorgiu/RiskInDroid) - A tool for calculating the risk of Android apps based on their permissions, with an online demo available.
17. [SUPER (⭐416)](https://github.com/SUPERAndroidAnalyzer/super) - Secure, Unified, Powerful and Extensible Rust Android Analyzer
18. [ClassyShark (⭐7.5k)](https://github.com/google/android-classyshark) - Standalone binary inspection tool which can browse any Android executable and show important info.
19. [StaCoAn (⭐820)](https://github.com/vincentcox/StaCoAn) - Cross-platform tool which aids developers, bug-bounty hunters, and ethical hackers in performing static code analysis on mobile applications. This tool was created with a big focus on usability and graphical guidance in the user interface.
20. [JAADAS (⭐346)](https://github.com/flankerhqd/JAADAS) - Joint intraprocedural and interprocedural program analysis tool to find vulnerabilities in Android apps, built on Soot and Scala
21. [Quark-Engine (⭐1.3k)](https://github.com/quark-engine/quark-engine) - An Obfuscation-Neglect Android Malware Scoring System
22. [One Step Decompiler (⭐242)](https://github.com/b-mueller/apkx) - Android APK Decompilation for the Lazy
23. [APKLeaks (⭐4.8k)](https://github.com/dwisiswant0/apkleaks) - Scanning APK file for URIs, endpoints & secrets.
24. [Mobile Audit (⭐198)](https://github.com/mpast/mobileAudit) - Web application for performing Static Analysis and detecting malware in Android APKs.
...
6.  [Droidbox (⭐749)](https://github.com/pjlantz/droidbox)
7.  [Drozer (⭐3.7k)](https://github.com/mwrlabs/drozer)
...
11. [ProbeDroid (⭐196)](https://github.com/ZSShen/ProbeDroid) - Dynamic Java code instrumentation
12. [DECAF (⭐794)](https://github.com/sycurelab/DECAF) - Dynamic Executable Code Analysis Framework based on QEMU (DroidScope is now an extension to DECAF)
13. [CuckooDroid (⭐577)](https://github.com/idanr1986/cuckoo-droid) - Android extension for Cuckoo sandbox
14. [Mem (⭐64)](https://github.com/MobileForensicsResearch/mem) - Memory analysis of Android (root required)
...
18. [Aurasium (⭐36)](https://github.com/xurubin/aurasium) – Practical security policy enforcement for Android apps via bytecode rewriting and in-place reference monitor.
...
24. [MARA (⭐616)](https://github.com/xtiankisutsa/MARA_Framework) - Mobile Application Reverse Engineering and Analysis Framework
...
28. [AndroPyTool (⭐334)](https://github.com/alexMyG/AndroPyTool) - a tool for extracting static and dynamic features from Android APKs. It combines different well-known Android app analysis tools such as DroidBox, FlowDroid, Strace, AndroGuard, or VirusTotal analysis.
29. [Runtime Mobile Security (RMS) (⭐2.5k)](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) - is a powerful web interface that helps you to manipulate Android and iOS Apps at Runtime
30. [PAPIMonitor (⭐48)](https://github.com/Dado1513/PAPIMonitor) – PAPIMonitor (Python API Monitor for Android apps) is a Python tool based on Frida for monitoring user-select APIs during the app execution.
31. [Android\_application\_analyzer (⭐150)](https://github.com/NotSoSecure/android_application_analyzer) - The tool is used to analyze the content of the Android application in local storage.
...
2.  [emacs syntax coloring for smali files (⭐32)](https://github.com/strazzere/Emacs-Smali)
3.  [vim syntax coloring for smali files](http://codetastrophe.com/smali.vim)
4.  [AndBug (⭐596)](https://github.com/swdunlop/AndBug)
5.  [Androguard (⭐5.1k)](https://github.com/androguard/androguard) – powerful, integrates well with other tools
6.  [Apktool](https://ibotpeaches.github.io/Apktool/) – really useful for compilation/decompilation (uses smali)
7.  [Android Framework for Exploitation (⭐183)](https://github.com/appknox/AFE)
...
17. [Introspy (⭐463)](https://github.com/iSECPartners/Introspy-Android)
...
23. [Redexer (⭐161)](https://github.com/plum-umd/redexer) – apk manipulation
...
27. [Jadx (⭐40k)](https://github.com/skylot/jadx)
28. [Dwarf (⭐1.2k)](https://github.com/iGio90/Dwarf) - GUI for reverse engineering
29. [Andromeda (⭐695)](https://github.com/secrary/Andromeda) - Another basic command-line reverse engineering tool
30. [apk-mitm (⭐3.6k)](https://github.com/shroudedcode/apk-mitm) - A CLI application that prepares Android APK files for HTTPS inspection
31. [Noia (⭐110)](https://github.com/0x742/noia) - Simple Android application sandbox file browser tool
...
33. [ARMANDroid (⭐11)](https://github.com/Mobile-IoT-Security-Lab/ARMANDroid) - ARMAND (Anti-Repackaging through Multi-patternAnti-tampering based on Native Detection) is a novel anti-tampering protection scheme that embeds logic bombs and AT detection nodes directly in the apk file without needing their source code.
...
35. [Dexmod (⭐42)](https://github.com/google/dexmod) - tool to exemplify patching Dalvik bytecode in a DEX (Dalvik Executable) file, and assist in the static analysis of Android applications.
...
4.  [Media Fuzzing Framework for Android (⭐330)](https://github.com/fuzzing/MFFA)
5.  [AndroFuzz (⭐37)](https://github.com/jonmetz/AndroFuzz)
6.  [QuarksLab's Android Fuzzing (⭐97)](https://github.com/quarkslab/android-fuzzing)
...
1.  [Google Play crawler (Java) (⭐560)](https://github.com/Akdeniz/google-play-crawler)
2.  [Google Play crawler (Python) (⭐878)](https://github.com/egirault/googleplay-api)
...
4.  [Aptoide downloader (Node) (⭐23)](https://github.com/dweinstein/node-aptoide) - download apps from Aptoide third-party Android market
...
3.  [adb autocomplete (⭐248)](https://github.com/mbrubeck/android-completion)
4.  [mitmproxy (⭐35k)](https://github.com/mitmproxy/mitmproxy)
5.  [dockerfile/androguard (⭐40)](https://github.com/dweinstein/dockerfile-androguard)
...
8.  [Internal Blue (⭐667)](https://github.com/seemoo-lab/internalblue) - Bluetooth experimentation framework based on Reverse Engineering of Broadcom Bluetooth Controllers
9.  [Android Mobile Device Hardening (⭐192)](https://github.com/SecTheTech/AMDH) - AMDH scans and hardens the device's settings and lists harmful installed Apps based on permissions.
...
1.  [Damn Insecure Vulnerable Application (DIVA) (⭐934)](https://github.com/payatu/diva-android)
2.  [Vuldroid (⭐58)](https://github.com/jaiswalakshansh/Vuldroid)
3.  [ExploitMe Android Labs](http://securitycompass.github.io/AndroidLabs/setup.html)
4.  [GoatDroid (⭐237)](https://github.com/jackMannino/OWASP-GoatDroid-Project)
5.  [Android InsecureBank (⭐1.2k)](https://github.com/dineshshetty/Android-InsecureBankv2)
6.  [Insecureshop (⭐227)](https://github.com/optiv/insecureshop)
7.  [Oversecured Vulnerable Android App (OVAA) (⭐615)](https://github.com/oversecured/ovaa)
...
2.  [Android security-related presentations (⭐165)](https://github.com/jacobsoo/AndroidSlides)
...
2.  [doridori/Android-Security-Reference (⭐901)](https://github.com/doridori/Android-Security-Reference)
3.  [android app security checklist (⭐844)](https://github.com/b-mueller/android_app_security_checklist)
