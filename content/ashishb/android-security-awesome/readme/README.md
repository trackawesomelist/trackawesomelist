...
[🏠 Home](/README.md) · [🔥 Feed](https://www.trackawesomelist.com/ashishb/android-security-awesome/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 ashishb/android-security-awesome](https://github.com/ashishb/android-security-awesome) · ⭐ 7.1K · 🏷️ Security
...
1.  [Androwarn (⭐450)](https://github.com/maaaaz/androwarn/) - detect and warn the user about potential malicious behaviors developed by an Android application.
2.  [ApkAnalyser (⭐986)](https://github.com/sonyxperiadev/ApkAnalyser)
3.  [APKInspector (⭐806)](https://github.com/honeynet/apkinspector/)
...
12. [CFGScanDroid (⭐53)](https://github.com/douggard/CFGScanDroid) - Scans and compares CFG against CFG of malicious applications
13. [Madrolyzer (⭐95)](https://github.com/maldroid/maldrolyzer) - extracts actionable data like C\&C, phone number etc.
...
17. [RiskInDroid (⭐78)](https://github.com/ClaudiuGeorgiu/RiskInDroid) - A tool for calculating the risk of Android apps based on their permissions, with an online demo available.
18. [SUPER (⭐401)](https://github.com/SUPERAndroidAnalyzer/super) - Secure, Unified, Powerful and Extensible Rust Android Analyzer
...
20. [StaCoAn (⭐796)](https://github.com/vincentcox/StaCoAn) - Cross-platform tool which aids developers, bug-bounty hunters, and ethical hackers in performing static code analysis on mobile applications. This tool was created with a big focus on usability and graphical guidance in the user interface.
21. [JAADAS (⭐333)](https://github.com/flankerhqd/JAADAS) - Joint intraprocedural and interprocedural program analysis tool to find vulnerabilities in Android apps, built on Soot and Scala
22. [Quark-Engine (⭐1.1k)](https://github.com/quark-engine/quark-engine) - An Obfuscation-Neglect Android Malware Scoring System
23. [One Step Decompiler (⭐216)](https://github.com/b-mueller/apkx) - Android APK Decompilation for the Lazy
24. [APKLeaks (⭐4.1k)](https://github.com/dwisiswant0/apkleaks) - Scanning APK file for URIs, endpoints & secrets.
25. [Mobile Audit (⭐178)](https://github.com/mpast/mobileAudit) - Web application for performing Static Analysis and detecting malware in Android APKs.
26. ~~[Several tools from PSU](http://siis.cse.psu.edu/tools.html)~~

### App Vulnerability Scanners

1.  [QARK (⭐3k)](https://github.com/linkedin/qark/) - QARK by LinkedIn is for app developers to scan apps for security issues
...
4.  [Mobile-Security-Framework MobSF (⭐15k)](https://github.com/MobSF/Mobile-Security-Framework-MobSF) - Mobile Security Framework is an intelligent, all-in-one open-source mobile application (Android/iOS) automated pen-testing framework capable of performing static, dynamic analysis and web API testing.
5.  [AppUse](https://appsec-labs.com/AppUse/) – custom build for penetration testing
6.  [Droidbox (⭐688)](https://github.com/pjlantz/droidbox)
...
11. [ProbeDroid (⭐193)](https://github.com/ZSShen/ProbeDroid) - Dynamic Java code instrumentation
12. ~~[Android Tamer](https://androidtamer.com/) - Virtual / Live Platform for Android Security Professionals~~
13. [DECAF (⭐743)](https://github.com/sycurelab/DECAF) - Dynamic Executable Code Analysis Framework based on QEMU (DroidScope is now an extension to DECAF)
14. [CuckooDroid (⭐552)](https://github.com/idanr1986/cuckoo-droid) - Android extension for Cuckoo sandbox
...
20. [Android Linux Kernel modules (⭐196)](https://github.com/strazzere/android-lkms)
...
24. [Vezir Project (⭐93)](https://github.com/oguzhantopgul/Vezir-Project) - Virtual Machine for Mobile Application Pentesting and Mobile Malware Analysis
25. [MARA (⭐593)](https://github.com/xtiankisutsa/MARA_Framework) - Mobile Application Reverse Engineering and Analysis Framework
...
28. [Android Malware Sandbox (⭐252)](https://github.com/Areizen/Android-Malware-Sandbox)
29. [AndroPyTool (⭐282)](https://github.com/alexMyG/AndroPyTool) - a tool for extracting static and dynamic features from Android APKs. It combines different well-known Android app analysis tools such as DroidBox, FlowDroid, Strace, AndroGuard, or VirusTotal analysis.
30. [Runtime Mobile Security (RMS) (⭐2.3k)](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) - is a powerful web interface that helps you to manipulate Android and iOS Apps at Runtime
31. [PAPIMonitor (⭐40)](https://github.com/Dado1513/PAPIMonitor) – PAPIMonitor (Python API Monitor for Android apps) is a Python tool based on Frida for monitoring user-select APIs during the app execution.
32. [Android\_application\_analyzer (⭐132)](https://github.com/NotSoSecure/android_application_analyzer) - The tool is used to analyze the content of the Android application in local storage.
...
1.  [Smali/Baksmali (⭐6k)](https://github.com/JesusFreke/smali) – apk decompilation
...
4.  [AndBug (⭐584)](https://github.com/swdunlop/AndBug)
5.  [Androguard (⭐4.6k)](https://github.com/androguard/androguard) – powerful, integrates well with other tools
...
9.  [Android OpenDebug (⭐126)](https://github.com/iSECPartners/Android-OpenDebug) – make any application on the device debuggable (using cydia substrate).
...
13. [Fino (⭐101)](https://github.com/sysdream/fino)
14. [Frida](https://www.frida.re/) - inject javascript to explore applications and a [GUI tool (⭐167)](https://github.com/antojoseph/diff-gui) for it
...
22. [FernFlower (⭐3k)](https://github.com/fesh0r/fernflower) - Java decompiler
...
27. [Jadx (⭐36k)](https://github.com/skylot/jadx)
28. [Dwarf (⭐1.2k)](https://github.com/iGio90/Dwarf) - GUI for reverse engineering
29. [Andromeda (⭐681)](https://github.com/secrary/Andromeda) - Another basic command-line reverse engineering tool
30. [apk-mitm (⭐2.9k)](https://github.com/shroudedcode/apk-mitm) - A CLI application that prepares Android APK files for HTTPS inspection
31. [Noia (⭐90)](https://github.com/0x742/noia) - Simple Android application sandbox file browser tool
32. [Obfuscapk (⭐930)](https://github.com/ClaudiuGeorgiu/Obfuscapk) - Obfuscapk is a modular Python tool for obfuscating Android apps without needing their source code.
...
34. [MVT (Mobile Verification Toolkit) (⭐8.9k)](https://github.com/mvt-project/mvt) - a collection of utilities to simplify and automate the process of gathering forensic traces helpful to identify a potential compromise of Android and iOS devices
...
2.  [Honggfuzz (⭐2.8k)](https://github.com/google/honggfuzz)
3.  [An Android port of the Melkor ELF fuzzer (⭐56)](https://github.com/anestisb/melkor-android)
4.  [Media Fuzzing Framework for Android (⭐327)](https://github.com/fuzzing/MFFA)
5.  [AndroFuzz (⭐36)](https://github.com/jonmetz/AndroFuzz)
6.  [QuarksLab's Android Fuzzing (⭐46)](https://github.com/quarkslab/android-fuzzing)
...
1.  [Google Play crawler (Java) (⭐538)](https://github.com/Akdeniz/google-play-crawler)
2.  [Google Play crawler (Python) (⭐851)](https://github.com/egirault/googleplay-api)
3.  [Google Play crawler (Node) (⭐264)](https://github.com/dweinstein/node-google-play) - get app details and download apps from the official Google Play Store.
...
3.  [adb autocomplete (⭐239)](https://github.com/mbrubeck/android-completion)
4.  [mitmproxy (⭐32k)](https://github.com/mitmproxy/mitmproxy)
...
8.  [Internal Blue (⭐596)](https://github.com/seemoo-lab/internalblue) - Bluetooth experimentation framework based on Reverse Engineering of Broadcom Bluetooth Controllers
9.  [Android Mobile Device Hardening (⭐169)](https://github.com/SecTheTech/AMDH) - AMDH scans and hardens the device's settings and lists harmful installed Apps based on permissions.
...
1.  [Damn Insecure Vulnerable Application (DIVA) (⭐835)](https://github.com/payatu/diva-android)
2.  [Vuldroid (⭐47)](https://github.com/jaiswalakshansh/Vuldroid)
3.  [ExploitMe Android Labs](http://securitycompass.github.io/AndroidLabs/setup.html)
4.  [GoatDroid (⭐233)](https://github.com/jackMannino/OWASP-GoatDroid-Project)
5.  [Android InsecureBank (⭐1.1k)](https://github.com/dineshshetty/Android-InsecureBankv2)
6.  [Insecureshop (⭐215)](https://github.com/optiv/insecureshop)
7.  [Oversecured Vulnerable Android App (OVAA) (⭐500)](https://github.com/oversecured/ovaa)
...
2.  [Android security-related presentations (⭐161)](https://github.com/jacobsoo/AndroidSlides)
...
2.  [doridori/Android-Security-Reference (⭐853)](https://github.com/doridori/Android-Security-Reference)
3.  [android app security checklist (⭐807)](https://github.com/b-mueller/android_app_security_checklist)
4.  [Mobile App Pentest Cheat Sheet (⭐4.1k)](https://github.com/tanprathan/MobileApp-Pentest-Cheatsheet)
...
2.  [Android Malware Github repo (⭐952)](https://github.com/ashishb/android-malware)
