...
[🏠 Home](/README.md) · [🔍 Search](https://www.trackawesomelist.com/search/) · [🔥 Feed](https://www.trackawesomelist.com/ashishb/android-security-awesome/week/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 ashishb/android-security-awesome](https://github.com/ashishb/android-security-awesome) · ⭐ 9K · 🏷️ Security
...
*   [adbsploit (⭐854)](https://github.com/mesquidar/adbsploit) - tools for exploiting device via ADB

### Tools / Reverse Engineering

*   [PhoneSpolit-Pro (⭐5.4k)](https://github.com/AzeemIdrisi/PhoneSploit-Pro) - An all-in-one hacking tool to remotely exploit Android devices using ADB and Metasploit Framework to get a Meterpreter session.
*   [APKLab (⭐3.6k)](https://github.com/APKLab/APKLab) - plugin for VS code to analyze APKs

### Tools / Misc Tools

*   [ARMv7 payload that provides arbitrary code execution on MediaTek bootloaders (⭐132)](https://github.com/R0rt1z2/kaeru)

## [May 19 - May 25, 2025](/content/2025/20/README.md)

### Tools / Dynamic Analysis Tools

*   [HacknDroid (⭐109)](https://github.com/RaffaDNDM/HacknDroid) - A tool designed to automate various Mobile Application Penetration Testing (MAPT) tasks and facilitate interaction with Android devices.

## [Apr 14 - Apr 20, 2025](/content/2025/15/README.md)

### Tools / Reverse Engineering

*   [odex-patcher (⭐95)](https://github.com/giacomoferretti/odex-patcher) - Run arbitrary code by patching OAT files

### Tools / Misc Tools

*   [Firmware Extractor (⭐339)](https://github.com/AndroidDumps/Firmware_extractor) - Extract given archive to images

## [Dec 09 - Dec 15, 2024](/content/2024/50/README.md)

### Tools / Dynamic Analysis Tools

*   [friTap (⭐433)](https://github.com/fkie-cad/friTap)- Intercept SSL/TLS connections with Frida; Allows TLS key extraction and decryption of TLS payload as PCAP on Android in real-time.
...
*   [Google Play crawler (Java) (⭐588)](https://github.com/Akdeniz/google-play-crawler)
*   [Google Play crawler (Python) (⭐895)](https://github.com/egirault/googleplay-api)
*   [Google Play crawler (Node) (⭐278)](https://github.com/dweinstein/node-google-play) - get app details and download apps from the official Google Play Store.
...
*   [QuarksLab's Android Fuzzing (⭐124)](https://github.com/quarkslab/android-fuzzing)
...
*   [Oversecured Vulnerable Android App (OVAA) (⭐723)](https://github.com/oversecured/ovaa)
...
*   [Android\_application\_analyzer (⭐167)](https://github.com/NotSoSecure/android_application_analyzer) - The tool is used to analyze the content of the Android application in local storage.
...
*   [Insecureshop (⭐249)](https://github.com/optiv/insecureshop)
...
*   [PAPIMonitor (⭐79)](https://github.com/Dado1513/PAPIMonitor) – PAPIMonitor (Python API Monitor for Android apps) is a Python tool based on Frida for monitoring user-select APIs during the app execution.
...
*   [ARMANDroid (⭐14)](https://github.com/Mobile-IoT-Security-Lab/ARMANDroid) - ARMAND (Anti-Repackaging through Multi-pattern, Anti-tampering based on Native Detection) is a novel anti-tampering protection scheme that embeds logic bombs and AT detection nodes directly in the apk file without needing their source code.
...
*   [Mobile Audit (⭐222)](https://github.com/mpast/mobileAudit) - Web application for performing Static Analysis and detecting malware in Android APKs.
...
*   [APKLeaks (⭐5.7k)](https://github.com/dwisiswant0/apkleaks) - Scanning APK file for URIs, endpoints & secrets.
...
*   [One Step Decompiler (⭐285)](https://github.com/b-mueller/apkx) - Android APK Decompilation for the Lazy

### Tools / Misc Tools

*   [Android Mobile Device Hardening (⭐214)](https://github.com/SecTheTech/AMDH) - AMDH scans and hardens the device's settings and lists harmful installed Apps based on permissions.
...
*   [mitmproxy (⭐41k)](https://github.com/mitmproxy/mitmproxy)
*   [dockerfile/androguard (⭐44)](https://github.com/dweinstein/dockerfile-androguard)
...
*   [Internal Blue (⭐746)](https://github.com/seemoo-lab/internalblue) - Bluetooth experimentation framework based on the Reverse Engineering of Broadcom Bluetooth Controllers
...
*   [GoatDroid (⭐247)](https://github.com/jackMannino/OWASP-GoatDroid-Project)
...
*   [Runtime Mobile Security (RMS) (⭐2.9k)](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) - is a powerful web interface that helps you to manipulate Android and iOS Apps at Runtime
...
*   [Droidbox (⭐786)](https://github.com/pjlantz/droidbox)

## [Dec 23 - Dec 29, 2019](/content/2019/51/README.md)

### Tools / Dynamic Analysis Tools

*   [Android Malware Sandbox (⭐293)](https://github.com/Areizen/Android-Malware-Sandbox)
...
*   [apk-mitm (⭐4.8k)](https://github.com/shroudedcode/apk-mitm) - A CLI application that prepares Android APK files for HTTPS inspection
...
*   [Androwarn (⭐515)](https://github.com/maaaaz/androwarn/) - detect and warn the user about potential malicious behaviors developed by an Android application.
...
*   [Jadx (⭐46k)](https://github.com/skylot/jadx)

### Academic/Research/Publications/Books / Others

*   [doridori/Android-Security-Reference (⭐973)](https://github.com/doridori/Android-Security-Reference)
*   [android app security checklist (⭐886)](https://github.com/b-mueller/android_app_security_checklist)
...
*   [StaCoAn (⭐855)](https://github.com/vincentcox/StaCoAn) - Cross-platform tool that aids developers, bug-bounty hunters, and ethical hackers in performing static code analysis on mobile applications. This tool was created with a big focus on usability and graphical guidance in the user interface.
...
*   [APKInspector (⭐848)](https://github.com/honeynet/apkinspector/)
...
*   [CFGScanDroid (⭐60)](https://github.com/douggard/CFGScanDroid) - Scans and compares the CFG against the CFG of malicious applications
...
*   [RiskInDroid (⭐156)](https://github.com/ClaudiuGeorgiu/RiskInDroid) - A tool for calculating the risk of Android apps based on their permissions, with an online demo available.
...
*   [Android Hooker (⭐413)](https://github.com/AndroidHooker/hooker) - Dynamic Java code instrumentation (requires the Substrate Framework)
*   [ProbeDroid (⭐199)](https://github.com/ZSShen/ProbeDroid) - Dynamic Java code instrumentation
*   [DECAF (⭐832)](https://github.com/sycurelab/DECAF) - Dynamic Executable Code Analysis Framework based on QEMU (DroidScope is now an extension to DECAF)
*   [CuckooDroid (⭐596)](https://github.com/idanr1986/cuckoo-droid) - Android extension for Cuckoo sandbox
...
*   [Android Linux Kernel modules (⭐216)](https://github.com/strazzere/android-lkms)
*   [StaDynA (⭐24)](https://github.com/zyrikby/StaDynA) - a system supporting security app analysis in the presence of dynamic code update features (dynamic class loading and reflection). This tool combines static and dynamic analysis of Android applications in order to reveal the hidden/updated behavior and extend static analysis results with this information.
*   [DroidAnalytics (⭐29)](https://github.com/zhengmin1989/DroidAnalytics) - incomplete
*   [Vezir Project (⭐111)](https://github.com/oguzhantopgul/Vezir-Project) - Virtual Machine for Mobile Application Pentesting and Mobile Malware Analysis
*   [MARA (⭐655)](https://github.com/xtiankisutsa/MARA_Framework) - Mobile Application Reverse Engineering and Analysis Framework
...
*   [AndBug (⭐601)](https://github.com/swdunlop/AndBug)
...
*   [Frida](https://www.frida.re/) - inject JavaScript to explore applications and a [GUI tool (⭐181)](https://github.com/antojoseph/diff-gui) for it
*   [Indroid](https://bitbucket.org/aseemjakhar/indroid) – thread injection kit
*   [Introspy (⭐481)](https://github.com/iSECPartners/Introspy-Android)
...
*   [FernFlower (⭐4.1k)](https://github.com/fesh0r/fernflower) - Java decompiler
*   [Redexer (⭐169)](https://github.com/plum-umd/redexer) – apk manipulation
...
*   [FSquaDRA (⭐73)](https://github.com/zyrikby/FSquaDRA) - a tool for detecting repackaged Android applications based on app resources hash comparison.
