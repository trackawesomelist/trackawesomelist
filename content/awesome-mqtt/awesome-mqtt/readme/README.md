...
[🏠 Home](/README.md) · [🔥 Feed](https://www.trackawesomelist.com/awesome-mqtt/awesome-mqtt/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 awesome-mqtt/awesome-mqtt](https://github.com/awesome-mqtt/awesome-mqtt) · ⭐ 2.4K · 🏷️ Miscellaneous

[ [Daily](/content/awesome-mqtt/awesome-mqtt/README.md) / [Weekly](/content/awesome-mqtt/awesome-mqtt/week/README.md) / Overview ]
...
Contributions welcome! Read the [contribution guidelines](https://github.com/awesome-mqtt/awesome-mqtt/blob/master/README.md/contributing.md) first.

## Community Resources

*   [mqtt.org](https://mqtt.org/)
*   [MQTT community wiki (⭐5.1k)](https://github.com/mqtt/mqtt.org/wiki)
...
*   [Aedes (⭐2k)](https://github.com/moscajs/aedes) - Barebone MQTT broker that can run on any stream server, the node way.
...
*   [comqtt (⭐1.2k)](https://github.com/wind-c/comqtt) - A lightweight, high-performance go mqtt server(v3.0|v3.1.1|v5.0) supporting distributed cluster.
*   [Eclipse Amlen (⭐53)](https://github.com/eclipse/amlen) - A scalable, secure, easy to use message broker that can be used for IoT, web and mobile use-cases. Open-sourced from IBM MessageSight.
*   [Emitter (⭐4k)](https://github.com/emitter-io/emitter) - A distributed, scalable and fault-tolerant publish-subscribe messaging platform based on MQTT protocol and featuring message storage.
*   [EMQ X (⭐17k)](https://github.com/emqx/emqx) - Scalable and Reliable Real-time MQTT Messaging Engine for IoT in 5G Era.
*   [esp\_uMQTT\_broker (⭐309)](https://github.com/martin-ger/esp_mqtt) - A basic MQTT Broker on the ESP8266.

<!--lint disable double-link-->

*   [hbmqtt Broker (⭐819)](https://github.com/beerfactory/hbmqtt) - Python MQTT broker using asyncio.
...
*   [KMQTT (⭐295)](https://github.com/davidepianca98/KMQTT) - Kotlin Multiplatform MQTT broker, both embeddable and standalone.
...
*   [mqtt5 (⭐55)](https://github.com/LabOverWire/mqtt-lib) - Async MQTT v5.0 broker in Rust with TCP, TLS, WebSocket, and QUIC transport, plus authentication, ACL, bridging, and session persistence.

<!--lint enable double-link-->

*   [MyQttHub](https://myqtthub.com) - Cloud MQTT broker.
*   [Mystique (⭐23)](https://github.com/TheThingsIndustries/mystique) - An extendable MQTT broker written in Go, with HTTP capabilities for observability. Implements MQTT v3.1.1.
...
*   [tbmq (⭐750)](https://github.com/thingsboard/tbmq) - Open-source, scalable, fault-tolerant and durable messaging broker for millions of IoT devices.
...
*   [Vert.x MQTT Server (⭐214)](https://github.com/vert-x3/vertx-mqtt) - Vert.x component to handle connections, communication and messages exchange with remote MQTT clients.

<!--lint enable double-link-->

*   [Waterstream](https://waterstream.io/) - MQTT broker leveraging Apache Kafka as its own storage and distribution engine.
*   [NanoMQ (⭐2.6k)](https://github.com/nanomq/nanomq) - A light-weight and Blazing-fast MQTT Broker for IoT Edge platform.
...
*   [ForestHub](https://foresthub.ai) - Edge AI agent platform; its open-source runtime [edge-agents (⭐97)](https://github.com/ForestHubAI/edge-agents) orchestrates AI agents on Linux edge gateways with MQTT as a first-class workflow transport, running offline with local SLMs alongside cloud LLMs.
...
*   [Mer-cli (⭐15)](https://github.com/iotmertech/iot-data-generator) - A high-performance IoT data generator written in Rust. Supports MQTT, HTTP, and TCP for simulating realistic sensor payloads with Handlebars templates.
*   [mockd (⭐141)](https://github.com/getmockd/mockd) - Multi-protocol mock server with a built-in MQTT broker supporting QoS 0-2, retained messages, topic patterns, and device simulation for IoT development and testing.
...
*   [MQTT Board (⭐103)](https://github.com/flespi-software/MQTT-Board) - Open-source diagnostic-oriented MQTT client tool.
...
*   [mqtt-malaria (⭐265)](https://github.com/etactica/mqtt-malaria) - Scalability and load testing utilities for MQTT environments.
*   [mqtt-mirror (⭐42)](https://github.com/4nte/mqtt-mirror) - Mirror MQTT traffic from one broker to another. Available as a CLI tool, Helm chart or Docker image.
*   [mqtt\_recorder (⭐41)](https://github.com/rpdswtk/mqtt_recorder) - Simple cli tool for recording and replaying MQTT messages.
*   [mqtt-shell (⭐17)](https://github.com/pidster-dot-org/mqtt-shell) - A simple interactive shell for MQTT.
...
*   [mqtt\_tree (⭐6)](https://github.com/poggenpower/mqtt_tree) - Displays all Topics in an expandable tree, helps to get an overview if you have a lot of clients publishing. (python, tkinter)
...
*   [MQTT TUI (⭐714)](https://github.com/EdJoPaTo/mqttui) - Simple lightweight terminal based MQTT monitor and publisher.
*   [Python MQTT Client Shell (⭐58)](https://github.com/bapowell/python-mqtt-client-shell) - Text console-based, interactive shell for exercising various tasks associated with MQTT client communications.
...
*   [MQTTX (⭐5k)](https://github.com/emqx/MQTTX) - Cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows.
...
*   [mqtt\_monitor (⭐11)](https://github.com/filipsPL/mqtt-monitor) - Simple and lightweight console moniotor for mqtt topics, with eye-candies, in python 3.
...
*   [mqttv5 (⭐55)](https://github.com/LabOverWire/mqtt-lib) - Unified MQTT v5.0 CLI for publishing, subscribing, running a broker, and benchmarking with multi-transport support.
...
*   [aiomqtt (⭐569)](https://github.com/empicano/aiomqtt) - The idiomatic asyncio MQTT client.
*   [gmqtt (⭐450)](https://github.com/wialon/gmqtt) - Python MQTT v5.0 client (asyncio-based).

<!--lint disable double-link-->

*   [hbmqtt Client (⭐819)](https://github.com/beerfactory/hbmqtt) - Python MQTT client using asyncio.
...
*   [mqtt-elements (⭐27)](https://github.com/mqttjs/mqtt-elements) - Polymer elements for MQTT.
...
*   [Vert.x Client (⭐214)](https://github.com/vert-x3/vertx-mqtt) - Vert.x component that provides methods for connecting/disconnecting to a broker, publishing messages and subscribing to topics.

<!--lint enable double-link-->

### Java

*   [hivemq-mqtt-client (⭐1.1k)](https://github.com/hivemq/hivemq-mqtt-client) - High-performance Java MQTT client library with different API flavours for MQTT 5.0 and 3.1.1.

### Erlang or Elixir

*   [emqttc (⭐438)](https://github.com/emqx/emqtt) - Asynchronous Erlang MQTT Client.
*   [mqttex (⭐45)](https://github.com/alfert/mqttex) - MQTT implementation in Elixir.

### Ballerina

*   [ballerina-mqtt (⭐106)](https://github.com/ballerina-platform/module-ballerina-mqtt) - Ballerina MQTT client based on paho-mqtt.

### C or C++

*   [mqtt\_cpp (⭐483)](https://github.com/redboltz/mqtt_cpp) - MQTT client for C++14 based on Boost.Asio.
*   [MQTT-C (⭐895)](https://github.com/LiamBindle/MQTT-C) - A portable MQTT C client for embedded systems and PCs alike.
...
*   [Machine Head (⭐81)](https://github.com/clojurewerkz/machine_head) - A Clojure MQTT Client.

### Dart

*   [mqtt.dart (⭐51)](https://github.com/jnguillerme/mqtt.dart) - Dart MQTT client.

### C# / .NET

*   [HiveMQtt (⭐96)](https://github.com/hivemq/hivemq-mqtt-client-dotnet) - MQTT 5.0 compliant secure client with automatic back pressure management and TCP & WebSocket transport support.
*   [MQTTnet (⭐5.1k)](https://github.com/chkr1011/MQTTnet) - MQTT client and broker .NET implementations.

### Delphi

*   [delphi-mqtt (⭐162)](https://github.com/pjde/delphi-mqtt) - MQTT server and client components.
*   [TMQTTClient (⭐26)](https://github.com/jamiei/Delphi-TMQTT2) - MQTT Client Library for Delphi. Alpha and long term unmaintained.

### GoLang

*   [go-mqtt (⭐8)](https://github.com/go-mqtt/mqtt) - MQTT client.
*   [MQTT for Go (⭐825)](https://github.com/jeffallen/mqtt) - MQTT Clients, Servers and Load Testers in Go.

### Lua

*   [luamqtt (⭐183)](https://github.com/xHasKx/luamqtt/) - Pure-lua MQTT v3.1.1 and v5.0 client.
...
*   [Mosquitto-PHP (⭐541)](https://github.com/mgdm/Mosquitto-PHP) - A wrapper for the Mosquitto MQTT client library for PHP.

### Ruby

*   [ruby-mqtt (⭐561)](https://github.com/njh/ruby-mqtt) - Pure Ruby gem that implements the MQTT protocol.
...
*   [mqtt5 (⭐55)](https://github.com/LabOverWire/mqtt-lib) - Complete async MQTT v5.0 client and broker library for Rust with TCP, TLS, WebSocket, and QUIC support.

<!--lint enable double-link-->

### Swift

*   [CocoaMQTT (⭐1.7k)](https://github.com/emqx/CocoaMQTT) - MQTT for iOS and macOS written with Swift.
*   [Moscapsule (⭐274)](https://github.com/flightonary/Moscapsule) - MQTT Client for iOS written in Swift.

### TCL

*   [tcl-mqtt (⭐5)](https://github.com/Tingenek/tcl-mqtt) - Small library to connect to a MQTT broker. Very, very basic, and not maintained.
...
*   [mqtt-scripts (⭐62)](https://github.com/hobbyquaker/mqtt-scripts/) - Node.js based script runner.
...
*   [Basecamp (⭐255)](https://github.com/ct-Open-Source/Basecamp) - An Arduino library to ease the use of the ESP32 in IoT projects. See [c't Magazin 2'2018 (German)](https://www.heise.de/select/ct/2018/2/1515452111258448).
*   [deskmate (⭐68)](https://github.com/rbaron/deskmate) - A hackable & portable MQTT-powered mini dashboard and control center.
*   [MySensors](https://www.mysensors.org/) - Arduino NRF24L01 based sensor network with support for an MQTT gateway.
*   [RFM69-MQTT-client (⭐81)](https://github.com/computourist/RFM69-MQTT-client) - Arduino RFM69 based sensors and MQTT gateway.
*   [rpi2mqtt (⭐23)](https://github.com/hobbyquaker/rpi2mqtt) - Connect a RaspberryPis GPIOs and 1-Wire Temperature Sensors to MQTT.
...
There are many inexpensive smart home Wi-Fi devices based on inexpensive ESP8266 chip *(see: [1](https://templates.blakadder.com/index.html), [2 (⭐3.1k)](https://github.com/xoseperez/espurna/wiki/Hardware), [3](https://www.letscontrolit.com/wiki/index.php?title=ESP_Hardware))*. Most of them can be reflashed with custom firmware.
...
*   [Espurna (⭐3.1k)](https://github.com/xoseperez/espurna) - <abbr title="Home automation">HA</abbr> firmware for ESP8266-based devices with rich web UI and ≈120 devices supported out of the box.
...
*   [OpenMQTTGateway (⭐4.1k)](https://github.com/1technophile/OpenMQTTGateway) - MQTT gateway for ESP8266, ESP32, Sonoff RF Bridge or Arduino with bidirectional 433mhz/315mhz/868mhz, Infrared communications, BLE, beacons detection, mi flora, mi jia, LYWSD02, LYWSD03MMC, Mi Scale compatibility, SMS & LORA.
*   [Sonoff-Tasmota (⭐25k)](https://github.com/arendst/Tasmota) - Firmware for ESP8266 devices with web-based configuration. ≈500 devices supported (not only Sonoffs).
...
*   [sip2mqtt (⭐45)](https://github.com/MartyTremblay/sip2mqtt) - A SIP monitoring script that publishes incoming calls with CallerID to MQTT.
*   [sms2mqtt (⭐67)](https://github.com/Domochip/sms2mqtt) - Docker Gateway to send/receive SMS through MQTT using an USB GSM dongle (gammu).
...
*   [mqtt-os-status (⭐19)](https://github.com/oskarhagberg/mqtt-os-status) - Operating-system related data, published to an MQTT broker at fixed intervals.
*   [mqttlauncher (⭐187)](https://github.com/jpmens/mqtt-launcher) - Execute shell commands triggered by published MQTT messages.
...
*   [psmqtt (⭐184)](https://github.com/eschava/psmqtt) - Utility reporting system health and status via MQTT.
...
*   [ccusage-mqtt (⭐1)](https://github.com/george-vice/ccusage-mqtt) - Publishes Claude Code (Anthropic's AI coding agent) usage telemetry to MQTT with Home Assistant auto-discovery. 15 sensors, mood classifier.
*   [check-mqtt (⭐66)](https://github.com/jpmens/check-mqtt) - A Nagios/Icinga plugin for checking connectivity to an MQTT broker.
*   [nag2mqtt (⭐7)](https://github.com/DE-IBH/nag2mqtt) - Nagios event broker to MQTT gateway.
*   [notify-by-mqtt (⭐16)](https://github.com/jpmens/notify-by-mqtt) - A Nagios/Icinga notification module which wraps data into JSON and fires it off to an MQTT broker.
*   [mqtt2notifysend (⭐13)](https://github.com/David-Lor/MQTT2NotifySend) - Subscribe to a topic and show notifications from MQTT messages on Ubuntu & other notify-send compatible Linux distros.
...
*   [influx4mqtt (⭐38)](https://github.com/hobbyquaker/influx4mqtt) - Subscribe to MQTT topics and insert into InfluxDB.
*   [mqtt2elasticsearch (⭐3)](https://github.com/hobbyquaker/mqtt2elasticsearch) - Send MQTT messages to Elasticsearch.

<!--lint disable double-link-->

*   [mqttwarn (⭐978)](https://github.com/jpmens/mqttwarn) - Use with [carbon](https://mqttwarn.readthedocs.io/en/latest/notifier-catalog.html#carbon) plugin.

<!--lint enable double-link-->

*   [mqttcollect (⭐22)](https://github.com/jpmens/mqttcollect) - A collectd "Exec" plugin for MQTT.
*   [mqtthandler (⭐22)](https://github.com/changyuheng/MQTTHandler) - A Python logging handler module for MQTT.
*   [mqtt2mongodb (⭐19)](https://github.com/David-Lor/MQTT2MongoDB) - Subscribe to MQTT topics and insert into MongoDB.
...
*   [ble-scale-sync (⭐150)](https://github.com/KristianP26/ble-scale-sync) - BLE-to-MQTT bridge for smart scales (23 brands) with Home Assistant auto-discovery. Reads weight + impedance, calculates body composition, publishes all 11 metrics with LWT and display precision. [Website](https://blescalesync.dev).
...
*   [Bambuddy (⭐2.8k)](https://github.com/maziggy/bambuddy) - Self-hosted management tool for Bambu Lab 3D printers using MQTT, with real-time monitoring, scheduling, and Home Assistant integration.
*   [can2mqtt (⭐102)](https://github.com/c3re/can2mqtt) - CAN-Bus - MQTT Bridge (also works vice versa).
...
*   [eno2mqtt (⭐10)](https://github.com/owagner/eno2mqtt) - Interface between an Enocean USB300 (TCM310) adapter and MQTT.
...
*   [gardena2mqtt (⭐12)](https://github.com/Domochip/gardena2mqtt) - Docker Gateway to control GARDENA Smart system devices (Sileno mower, Irrigation Control, etc.) through MQTT.
*   [helios2mqtt (⭐8)](https://github.com/mreschka/helios2mqtt) - A daemon for syncing a helios easy controls system like my KWL EC 220D to MQTT.
...
*   [huABus (⭐7)](https://github.com/arboeh/huABus) - Home Assistant application (Add-on) and MQTT bridge for Huawei solar inverters (SUN2000/3000/5000).
...
*   [knx-mqtt-bridge (⭐43)](https://github.com/pakerfeldt/knx-mqtt-bridge) - Bridges KNX and MQTT using the knx.js library.
...
*   [mqtt-dss-bridge (⭐5)](https://github.com/cgHome/mqtt-dss-bridge) - MQTT digitalSTROM-Server Bridge.
*   [mqtt-unifi-protect-bridge (⭐24)](https://github.com/terafin/mqtt-unifi-protect-bridge) - Adding motion-status from UniFi Protect Cameras to MQTT.

<!--lint disable double-link-->

*   [mqtt2homekit (⭐39)](https://github.com/forty2/mqtt2homekit) - Roughly the opposite of [homekit2mqtt (⭐357)](https://github.com/hobbyquaker/homekit2mqtt): Control your HomeKit-enabled devices with MQTT and without Siri or iPhone.
...
*   [Home.Pi (⭐191)](https://github.com/denschu/home.pi) - Based on MQTT.
...
*   [homekit2mqtt (⭐357)](https://github.com/hobbyquaker/homekit2mqtt) - Interface between [HAP-NodeJS (⭐2.7k)](https://github.com/homebridge/HAP-NodeJS) and MQTT. Control MQTT connected devices with Siri or HomeKit Apps.

<!--lint enable double-link-->

*   [ioBroker](https://github.com/ioBroker) - Includes a [MQTT adapter (⭐58)](https://github.com/ioBroker/ioBroker.mqtt).
...
*   [she - smart home engine (⭐8)](https://github.com/hobbyquaker/she) - Scriptable smart home automation engine with AI assistance.
...
*   [Arilux\_AL-LC0X (⭐187)](https://github.com/mertenats/Arilux_AL-LC0X) - This is an alternative firmware for Arilux LED controllers which uses MQTT.
*   [chromoflex2mqtt (⭐2)](https://github.com/owagner/chromoflex2mqtt) - Control Chromoflex USP3 RGB LED modules via MQTT.
*   [hue2mqtt.js (⭐30)](https://github.com/hobbyquaker/hue2mqtt.js) - Interface between the Philips Hue bridge and MQTT.
*   [MQTT DMX Controller (⭐70)](https://github.com/hobbyquaker/mqtt-dmx-controller) - DMX Controller with MQTT support.
...
*   [lgtv2mqtt (⭐109)](https://github.com/hobbyquaker/lgtv2mqtt) - Interface between LG WebOS Smart TVs and MQTT.
...
*   [mqtt2tivoremote (⭐4)](https://github.com/forty2/mqtt2tivoremote) - Make TiVo DVR remote control available through an MQTT smarthome style interface.
*   [onkyo2mqtt (⭐39)](https://github.com/owagner/onkyo2mqtt) - Interface between Onkyo AVR's EISCP network remote protocol and MQTT. Uses the onkyo-eiscp library.
*   [sonos2mqtt (⭐83)](https://github.com/svrooij/sonos2mqtt) - A bridge between Sonos and MQTT.
*   [VLC MQTT Module](https://wiki.videolan.org/Documentation:Modules/mqtt/) - Control VLC via MQTT.
*   [xbmc2mqtt (⭐4)](https://github.com/gordonjcp/xbmc-mqtt) - A simple plugin for XBMC to listen for a particular topic on an MQTT broker, and display a popup message.
*   [yamaha-avr2mqtt (⭐10)](https://github.com/akentner/yamaha-avr2mqtt) - A simple adapter for connection Yamaha AVR to MQTT.
...
*   [rpi-mqtt-monitor (⭐316)](https://github.com/hjelev/rpi-mqtt-monitor) - The easiest way to track your Raspberry Pi or Ubuntu computer system health and performance in Home Assistant via MQTT.

### Messaging

*   [mqtt-irc-bot (⭐24)](https://github.com/dobermai/mqtt-irc-bot) - A MQTT to IRC / IRC to MQTT bridge or bot.

<!--lint disable double-link-->

*   [mqttwarn (⭐978)](https://github.com/jpmens/mqttwarn) - Subscribe to MQTT topics (with wildcards) and notify pluggable services.

<!--lint enable double-link-->

*   [twitter-to-mqtt (⭐18)](https://github.com/knolleary/twitter-to-mqtt) - A python daemon that uses the Twitter Streaming API to access tweets and republishes them to an MQTT topic.

### Misc

*   [AlexaMqttBridge (⭐109)](https://github.com/mhdawson/AlexaMqttBridge) - Bridge between Amazon Alexa and MQTT.
...
*   [bt-mqtt-gateway (⭐552)](https://github.com/zewelor/bt-mqtt-gateway) - Easily extensible Bluetooth to MQTT gateway, currently supports: EQ3 smart thermostat, Xiaomi Mi Scale, Linak Desk, MySensors and Xiaomi Mi Flora plant sensor.
...
*   [gBridge (⭐170)](https://github.com/kservices/gBridge) - Control (almost) any smart home device, any smart home software, with Google Assistant. Therefore, it transforms actions received from Google by voice commands to MQTT messages.
...
*   [miflora-mqtt-daemon (⭐623)](https://github.com/ThomDietrich/miflora-mqtt-daemon) - Linux service to send Xiaomi Mi Flora plant sensor data to an MQTT broker.
...
*   [Valetudo (⭐9.5k)](https://github.com/Hypfer/Valetudo) - Xiaomi (Roborock) Vacuum Robots Firmware with MQTT and Webinterface.
...
*   [awtSCADA (⭐5)](https://github.com/larionovavi-stack/awtscada) - Industrial SCADA/HMI system with MQTT support (plus IEC 61850, OPC UA, Modbus TCP). Runs from a single HTML file in any browser, zero installation. 53 function blocks, 65 graphic elements, real-time trends.
*   [Crouton (⭐297)](https://github.com/edfungus/Crouton) - A dashboard that taps into your IOT network, using only MQTT and JSON.
*   [d3-MQTT-Topic-Tree (⭐97)](https://github.com/hardillb/d3-MQTT-Topic-Tree) - A MQTT Topic Tree viewer using the d3 collapsible tree and MQTT over websockets.
*   [Feezal (⭐11)](https://github.com/feezal/feezal) - Dashboard editor powered by Web Components and MQTT.
...
*   [mqtt-dashboard (⭐16)](https://github.com/jmischler72/mqtt-dashboard) - Self-hostable MQTT dashboard/explorer with drag-and-drop panels like cron, button, log and topic browser to help interact and monitor MQTT topics.
...
*   [MQTT-Tiles (⭐113)](https://github.com/flespi-software/MQTT-Tiles) - MQTT-based IoT dashboard visualization tool. Allows easy dashboards sharing. Works with any MQTT broker supporting the WSS protocol.
*   [mqtt2highcharts (⭐62)](https://github.com/matbor/mqtt2highcharts) - Plotting live numbered data from a subscribed MQTT topic using Highcharts.
...
*   [PlotJuggler (⭐6.1k)](https://github.com/facontidavide/PlotJuggler) - Visualize time series (from sources such as: MQTT, Websockets, ZeroMQ, UDP, etc., supports data formats such as JSON, CBOR, BSON, Message Pack, etc.). It is a fast, powerful and intuitive cross-platform tool.
...
*   [mqtt-smarthome (⭐453)](https://github.com/mqtt-smarthome/mqtt-smarthome) - Smart home automation with MQTT as the central message bus - Architectural proposal.
...
*   [MQTT-PWN (⭐450)](https://github.com/akamai-threat-research/mqtt-pwn) - IoT Broker penetration-testing and security assessment operations.
