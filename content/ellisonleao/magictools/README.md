...
[🏠 Home](/README.md) · [🔍 Search](https://www.trackawesomelist.com/search/) · [🔥 Feed](https://www.trackawesomelist.com/ellisonleao/magictools/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 ellisonleao/magictools](https://github.com/ellisonleao/magictools) · ⭐ 16K · 🏷️ Gaming
...
*   :tada: [steamworks-ffi-node (⭐50)](https://github.com/ArtyProf/steamworks-ffi-node) - a Node.js wrapper for Steamworks SDK.
...
*   :tada: [vectarine (⭐117)](https://github.com/vanyle/vectarine/) - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.

## [Feb 08, 2026](/content/2026/02/08/README.md)

### Engines and Frameworks / Voxel Editors

*   :tada: [Carimbo (⭐182)](https://github.com/willtobyte/carimbo) - A 2D game engine developed in modern C++ using SDL, an Entity-Component-System (ECS) architecture, and Box2D. It features Lua scripting and is designed for web portability via WebAssembly.

## [Nov 26, 2025](/content/2025/11/26/README.md)

### Engines and Frameworks / Voxel Editors

*   :free: :tada: [Folded Paper Engine (⭐154)](https://github.com/papercraftgames/folded-paper-engine) – Blender to Godot game mechanics engine/plug-ins. Just a few clicks. Super easy. Featuring: 2.5D/first-person/third-person controls, trigger commands/events, inventory, holdable items and all kinds of stuff.
...
*   :tada: [AI Game Developer (⭐2k)](https://github.com/IvanMurzak/Unity-MCP) - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
*   :tada: [is::Engine (⭐227)](https://github.com/Is-Daouda/is-Engine) - C++, SDL 2 and SFML game engine that allows to create games on Nintendo Switch, Web (HTML 5), Mobile and PC.
...
*   :tada: [Box2D.NET (⭐169)](https://github.com/ikpil/Box2D.NET) - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
*   :free: [Canvascript (⭐94)](https://github.com/VBproDev/Canvascript) - A tool for creating HTML canvas graphics without writing code.
...
*   :free: [FamiTracker (⭐496)](https://github.com/Dn-Programming-Core-Management/Dn-FamiTracker) - free windows tracker for producing music for the NES/Famicom-systems.
...
*   :tada: [RGFW (⭐1.7k)](https://github.com/ColleagueRiley/RGFW) - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
*   :tada: [Foster (⭐806)](https://github.com/FosterFramework/Foster) - A small cross-platform 2D game framework in C#.

## [Feb 08, 2024](/content/2024/02/08/README.md)

### Complete Game Sources / Voxel Editors

*   :tada: [Barotrauma (⭐2.1k)](https://github.com/Regalis11/Barotrauma)
...
*   :tada: [DotRecast (⭐873)](https://github.com/ikpil/DotRecast) - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
...
*   :tada: [axys (⭐1.3k)](https://github.com/axys1/axys) - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
*   :tada: [asimov-ts (⭐15)](https://github.com/pedrozaalex/asimov-ts) - A type safe (as much as possible) engine for the web written in TypeScript.
...
*   :tada: [Material Maker (⭐5.3k)](https://github.com/RodZill4/material-maker) - procedural texture creator made in Godot
...
*   :tada: [Pixel Composer (⭐1.2k)](https://github.com/Ttanasart-pt/Pixel-Composer) - Powerful node-based VFX editor for pixel art
...
*   :tada: [Grid (⭐754)](https://github.com/Planimeter/game-engine-2d) - A multiplayer-first game engine for Lua.
...
*   :tada: [Screen 13 (⭐333)](https://github.com/attackgoat/screen-13) - An easy-to-use Vulkan rendering engine. Provides a render graph for Rust.
...
*   :tada: [Pyxel (⭐17k)](https://github.com/kitao/pyxel) - a retro game engine for Python.
...
*   :tada: [macroquad (⭐4.4k)](https://github.com/not-fl3/macroquad) - The cross-platform game engine in Rust.

## [Jan 23, 2022](/content/2022/01/23/README.md)

### Graphics / Spritesheet Tools

*   :tada: [EzSpriteSheet (⭐56)](https://github.com/z64me/EzSpriteSheet) - Creates sprite sheets from animated GIFs and more
...
*   :free: [Matcaps (⭐3.2k)](https://github.com/nidorx/matcaps#matcaps) - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
*   :tada: [Cheetah-Texture-Packer (⭐251)](https://github.com/scriptum/Cheetah-Texture-Packer) - High efficient and fast 2D bin packing tool
...
*   :tada: [Tilesplit (⭐4)](https://github.com/AlexPoulsen/tilesplit) - CLI text-based tilesheet splitter and namer. Turn a spritesheet into many separate files with names you pick, or not if you don't care. Support templates and textures that are not all the same size.
...
*   :moneybag: [Pixen (⭐936)](https://github.com/Pixen/Pixen) - Pixel Art Editor for OSX
...
*   :tada: [Overlap2D (⭐789)](https://github.com/UnderwaterApps/overlap2d/) - a 2D level and UI editor with an engine agnostic philosophy.
...
*   :tada: [goxel (⭐3.1k)](https://github.com/guillaumechereau/goxel)
...
*   :tada: [Astera (⭐295)](https://github.com/tek256/astera) - 2D C99 Cross Platform Game Library / Framework
...
*   :tada: [Bladecoder (⭐636)](https://github.com/bladecoder/bladecoder-adventure-engine) - Classic point and click adventure game engine and editor.
...
*   :tada: [Blitz3D (⭐282)](https://github.com/blitz-research/blitz3d) 3D basic-like programming language for fast 3D desktop games.
...
*   :tada: [Chipmunk C# (⭐84)](https://github.com/netonjm/ChipmunkSharp) - C# implementation of the Chipmunk2D lib.
...
*   :tada: [Dash (⭐428)](https://github.com/Circular-Studios/Dash) - A free and open 3D game engine written in D.
*   :tada: [Dear Imgui (⭐72k)](https://github.com/ocornut/imgui/) - A bloat-free immediate mode GUI for C++ with minimal dependencies.
*   :tada: [DEM Net Elevation API C# (⭐345)](https://github.com/dem-net/DEM.Net) - Terrain generation from real data with textures, normal maps, glTF, OBJ, STL support
*   :tada: [Diligent Engine (⭐4.2k)](https://github.com/DiligentGraphics/DiligentEngine) - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
...
*   :tada: [ecs-lib (⭐216)](https://github.com/nidorx/ecs-lib#readme) - **ecs-lib** is a tiny and easy to use ECS (Entity Component System) library for game programming. It's written in Typescript but you can use on node.js and web browser too.
*   :tada: [Ejecta](http://impactjs.com/ejecta) - A Fast, Open Source JavaScript, Canvas & Audio Implementation for iOS.
*   :tada: [EnTT (⭐12k)](https://github.com/skypjack/entt) - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
*   :tada: [FXGL (⭐4.8k)](https://github.com/AlmasB/FXGL) - A JavaFX/Kotlin game engine for Win/Mac/Linux.
*   :tada: [Farseer (⭐733)](https://github.com/VelcroPhysics/VelcroPhysics) - a collision detection system with realistic physics responses.
...
*   :tada: [Glide Engine (⭐507)](https://github.com/cocoatoucher/Glide) - Engine for making 2d games on iOS, macOS and tvOS in Swift programming language, with practical examples and tutorials.
...
*   :tada: [LumixEngine (⭐3.8k)](https://github.com/nem0/LumixEngine) - 3D Game engine built on C++.
...
*   :tada: [Nakama (⭐12k)](https://github.com/heroiclabs/nakama) - Distributed server for social and realtime games and apps.
...
*   :tada: [ÖbEngine (⭐858)](https://github.com/Sygmei/ObEngine) - 2D Game Engine with Lua Scripting made on top of SFML !
...
*   :tada: [Fluent Behaviour Tree (⭐398)](https://github.com/codecapers/Fluent-Behaviour-Tree) - C# behaviour tree library with a fluent API released under MIT.
...
*   :tada: [MilkyTracker (⭐2k)](https://github.com/milkytracker/MilkyTracker) - open source tracker for Mac/Linux/Windows platforms.
...
*   [awesome-gametalks (⭐1.2k)](https://github.com/hzoo/awesome-gametalks) - A curated list of game talks (GDC, youtube, etc).
...
*   :tada: [OpenTTD (⭐7.8k)](https://github.com/OpenTTD/OpenTTD)
*   :tada: [Prince of Persia (⭐6.8k)](https://github.com/jmechner/Prince-of-Persia-Apple-II)
*   :tada: [Quake 2 (⭐3.2k)](https://github.com/id-Software/Quake-2)
*   :tada: [Quake III Arena (⭐8k)](https://github.com/id-Software/Quake-III-Arena)
*   :tada: [Quake (⭐5.7k)](https://github.com/id-Software/Quake)
*   :tada: [SimCity (⭐1k)](https://github.com/simhacker/micropolis)
*   :tada: [Wolfenstein 3D (⭐2.5k)](https://github.com/id-Software/wolf3d)
*   :free: [VVVVVV (⭐7.9k)](https://github.com/TerryCavanagh/VVVVVV)
...
*   :free: [miloyip/game-programmer (⭐19k)](https://github.com/miloyip/game-programmer) A Study Path for Game Programmer :octocat:
...
*   :free: [3D Game Shaders For Beginners (⭐20k)](https://github.com/lettier/3d-game-shaders-for-beginners)
