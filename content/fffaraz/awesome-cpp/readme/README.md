...
*   [nuklear (⭐7.8k)](https://github.com/Immediate-Mode-UI/Nuklear) - A single-header ANSI C gui library. \[PublicDomain]
...
*   [awesome (⭐270k)](https://github.com/sindresorhus/awesome) :zap: - A curated list of awesome lists.
