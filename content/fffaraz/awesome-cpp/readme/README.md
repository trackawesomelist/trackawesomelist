...
[🏠 Home](/README.md) · [🔥 Feed](https://www.trackawesomelist.com/fffaraz/awesome-cpp/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 fffaraz/awesome-cpp](https://github.com/fffaraz/awesome-cpp) · ⭐ 57K · 🏷️ Programming Languages
...
*   [MiLi (⭐32)](https://github.com/MariadeAnton/MiLi) - Minimal headers-only C++ Library. \[Boost]
...
*   [Asio (⭐4.7k)](https://github.com/chriskohlhoff/asio/) - A cross-platform C++ library for network and low-level I/O programming that provides developers with a consistent asynchronous model using a modern C++ approach. \[Boost] [website](http://think-async.com/)
...
*   [Amplitude Audio SDK (⭐23)](https://github.com/SparkyStudios/AmplitudeAudioSDK) - A cross-platform audio engine designed with the needs of games in mind. \[Apache-2.0] [website](https://amplitudeaudiosdk.com)
...
*   [Vcflib (⭐608)](https://github.com/ekg/vcflib) - A C++ library for parsing and manipulating VCF files. \[MIT]
...
*   [gromacs (⭐672)](https://github.com/gromacs/gromacs) - A message-passing parallel molecular dynamics implementation. \[GPL] [website](http://www.gromacs.org)
*   [Reaktoro (⭐148)](https://github.com/reaktoro/reaktoro) - A computational framework in C++ and Python for modeling chemically reactive systems. \[LGPL] [website](https://reaktoro.org)
...
*   [MADNESS (⭐173)](https://github.com/m-a-d-n-e-s-s/madness) - Multiresolution Adaptive Numerical Environment for Scientific Simulation. \[GPL] [website (⭐173)](https://github.com/m-a-d-n-e-s-s/madness)
...
*   [Psi (⭐938)](https://github.com/psi4/psi4) - An ab initio computational chemistry package. \[GPL] [website](https://psicode.org/)
...
*   [Boost.Program\_options (⭐104)](https://github.com/boostorg/program_options) - A library to obtain program options via conventional methods such as command line and config file. \[Boost] [website](https://boost.org/libs/program_options)
...
*   [popl (⭐159)](https://github.com/badaix/popl) - A single-header templated command line arguments and ini file parser for C++ 11 and beyond. \[MIT]
...
*   [LZ4 (⭐9.4k)](https://github.com/lz4/lz4) - Extremely Fast Compression algorithm. \[BSD] [website](http://www.lz4.org/)
...
*   [ring\_span lite (⭐148)](https://github.com/martinmoene/ring-span-lite) - A simplified implementation of Arthur O'Dwyer's ring\_span implementation ie. a circular buffer view. \[MIT]
...
*   [Glaze (⭐982)](https://github.com/stephenberry/glaze) - High performance, header only, CSV library with reflection support. \[MIT]
...
*   [MongoDB C Driver (⭐802)](https://github.com/mongodb/mongo-c-driver) - MongoDB client library for C. \[Apache2]
...
*   [Celero (⭐809)](https://github.com/DigitalInBlue/Celero) - C++ Benchmarking Framework. \[Apache2]
...
*   [utest.h (⭐788)](https://github.com/sheredom/utest.h) - Single header unit testing framework for C and C++. \[Unlicense]
...
*   [MyGUI (⭐698)](https://github.com/MyGUI/mygui) - Fast, flexible and simple GUI. \[MIT]
...
*   [Partio (⭐452)](https://github.com/wdas/partio) - Library for wrangling particle data, with support for most common file formats. \[Modified BSD]
...
*   [ThorVG (⭐600)](https://github.com/thorvg/thorvg) - a platform-independent portable library that allows for drawing vector-based scenes and animations, including SVG and Lottie. \[MIT] [website](https://www.thorvg.org/)
...
*   [Boost.GIL (⭐176)](https://github.com/boostorg/gil) - Generic Image Library. \[Boost] [website](https://boost.org/libs/gil)
...
*   [libspng (⭐703)](https://github.com/randy408/libspng) - Simple, modern libpng alternative. \[BSD-2] [website](https://libspng.org/)
...
*   [TinyDNG (⭐145)](https://github.com/syoyo/tinydng) - Header-only Tiny DNG/TIFF loader and writer in C++. \[MIT]
...
*   [VIGRA (⭐406)](https://github.com/ukoethe/vigra) - A generic C++ computer vision library for image analysis. \[MIT X11]
...
*   [Boost.Interprocess (⭐125)](https://github.com/boostorg/interprocess) - Header-only Boost library that supports kernel-level shared memory and memory-mapped files, with in-built synchronization mechanisms (semaphores, mutexes, and more). \[Boost] [website](https://boost.org/libs/interprocess)
...
*   [Boost.PropertyTree (⭐53)](https://github.com/boostorg/property_tree) - A property tree parser/generator that can be used to parse XML/JSON/INI/Info files. \[Boost] [website](https://boost.org/libs/property_tree)
...
*   [frozen (⭐704)](https://github.com/cesanta/frozen) - JSON parser and generator for C/C++. \[GPL & GPL2]
...
*   [json.h (⭐681)](https://github.com/sheredom/json.h) - A simple one header/one source solution to parsing JSON in C and C++. \[Unlicense]
...
*   [Boost.Log (⭐177)](https://github.com/boostorg/log) - Designed to be very modular and extensible. \[Boost] [website](https://boost.org/libs/log)
...
*   [Minerva (⭐697)](https://github.com/dmlc/minerva) - A fast and flexible system for deep learning. \[Apache2]
...
*   [Boost.Multiprecision (⭐185)](https://github.com/boostorg/multiprecision) - provides higher-range/precision integer, rational and floating-point types in C++, header-only or with GMP/MPFR/LibTomMath backends. \[Boost] [website](https://boost.org/libs/multiprecision)
...
*   [SDL (⭐8.8k)](https://github.com/libsdl-org/SDL) :zap: - Simple DirectMedia Layer. \[zlib] [website](https://libsdl.org)
...
*   [curlcpp (⭐620)](https://github.com/JosephP91/curlcpp) - An object oriented C++ wrapper for CURL(libcurl). \[MIT]
...
*   [librdkafka (⭐43)](https://github.com/edenhill/librdkafka) - Apache Kafka client library for C and C++. \[BSD-2-Clause]
...
*   [MQTT-C (⭐743)](https://github.com/LiamBindle/MQTT-C) - A portable MQTT C client for embedded systems and PCs alike. \[MIT] [website](https://liambindle.ca/MQTT-C)
...
*   [nghttp3 (⭐828)](https://github.com/ngtcp2/nghttp3) - HTTP/3 library written in C. \[MIT] [website](https://nghttp2.org/nghttp3/)
...
*   [Tufão (⭐583)](https://github.com/vinipsmaker/tufao) - An asynchronous web framework for C++ built on top of Qt. \[LGPL2]
...
*   [Kratos (⭐985)](https://github.com/KratosMultiphysics/Kratos) - framework for building parallel, multi-disciplinary simulation software, aiming at modularity, extensibility, and high performance. \[BSD] [website](http://www.cimne.com/kratos/)
*   [LiquidFun (⭐4.7k)](https://github.com/google/liquidfun) - A 2D physics engine for games. \[BSD-like]
*   [Newton Dynamics (⭐928)](https://github.com/MADEAPPS/newton-dynamics) - An integrated solution for real time simulation of physics environments. \[zlib]
...
*   [clReflect (⭐261)](https://github.com/Celtoys/clReflect) - C++ Reflection using clang. \[MIT]
...
*   [meta (⭐564)](https://github.com/skypjack/meta) - Header-only, non-intrusive and macro-free runtime reflection system in C++. \[MIT]
...
*   [Ponder (⭐633)](https://github.com/billyquith/ponder) - A C++11 library for reflection. \[MIT]
...
*   [Boost.Python (⭐454)](https://github.com/boostorg/python) - A C++ library which enables seamless interoperability between C++ and the Python programming language. \[Boost] [website](https://boost.org/libs/python)
...
*   [zpp\_bits (⭐689)](https://github.com/eyalz800/zpp_bits) - Actually, the fastest modern **S**erialization library. Just check [this video](https://www.youtube.com/watch?v=G7-GQhCw8eE\&ab_channel=CppCon).
...
*   [Cutelyst (⭐896)](https://github.com/cutelyst/cutelyst) - A C++ Web Framework built on top of Qt, using the simple approach of Catalyst (Perl) framework. \[LGPLv2.1+] [website](https://cutelyst.org/)
...
*   [faker-cxx (⭐266)](https://github.com/cieslarmichal/faker-cxx) - C++20 Faker library for generating fake (but realistic) data for testing and development. \[MIT]
...
*   [fccf (⭐354)](https://github.com/p-ranav/fccf) - A command-line tool that recursively searches a directory to find C/C++ source code matching a search string. \[MIT]
...
*   [Jinja2С++ (⭐481)](https://github.com/jinja2cpp/Jinja2Cpp) - almost full-conformance template engine implementation. [website](https://jinja2cpp.github.io/)
...
*   [libcpuid (⭐425)](https://github.com/anrieff/libcpuid) - A small C library for x86 CPU detection and feature extraction. \[BSD]
...
*   [libsigc++ (⭐359)](https://github.com/libsigcplusplus/libsigcplusplus) - A typesafe callback system for standard C++. \[LGPL] [website](https://libsigcplusplus.github.io/libsigcplusplus)
...
*   [Stage (⭐390)](https://github.com/rtv/Stage) - Mobile robot simulator. \[GPL2]
...
*   [CPM (⭐739)](https://github.com/iauns/cpm) - A C++ Package Manager based on CMake and Git.
...
*   [tundra (⭐435)](https://github.com/deplinenoise/tundra) - High-performance code build system designed to give the best possible incremental build times even for very large software projects.
...
Please take a quick gander at the [contribution guidelines (⭐57k)](https://github.com/fffaraz/awesome-cpp/blob/master/CONTRIBUTING.md) for details.
Thanks to all [contributors (⭐57k)](https://github.com/fffaraz/awesome-cpp/graphs/contributors); you rock!
