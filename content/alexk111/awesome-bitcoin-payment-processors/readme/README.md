...
| [One Time Address (⭐50)](https://github.com/alexk111/One-Time-Address) |       No fees      |     No    |           Yes           |                                                                                   No                                                                                   | NodeJS                                                           |
...
| [LnMe (⭐131)](https://github.com/bumi/lnme)                            |       No fees      |    Yes    |           Yes           |                                                                                   No                                                                                   | LND node                                                         |
| [SatSale (⭐151)](https://github.com/nickfarrow/SatSale)                |       No fees      |    Yes    |           Yes           |                          Weakhands: [swap to USDT on Liquid (⭐151)](https://github.com/nickfarrow/SatSale/blob/master/config.toml#L82), no-KYC                         | A Bitcoin node and Python. Lightning node & Woocommerce optional |
