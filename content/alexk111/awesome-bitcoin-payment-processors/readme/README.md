...
| [One Time Address (⭐60)](https://github.com/alexk111/One-Time-Address) |       No fees      |     No    |           Yes           |                                                                                   No                                                                                   | NodeJS                                                       |
...
| [LnMe (⭐159)](https://github.com/bumi/lnme)                            |       No fees      |    Yes    |           Yes           |                                                                                   No                                                                                   | LND node                                                     |
| [SatSale (⭐210)](https://github.com/SatSale/SatSale)                   |       No fees      |    Yes    |           Yes           |          Weakhands: [swap to USDT on Liquid (⭐210)](https://github.com/SatSale/SatSale/blob/471c8c03bbc269df1f322f6484b6e7a7364e5b34/config.toml#L101), no-KYC         | Python. Bitcoin node, Lightning node & WooCommerce optional. |
| [CypherpunkPay](https://cypherpunkpay.org/)                            |       No fees      |     No    |           Yes           |                                                                                   No                                                                                   | Linux (1GB RAM)                                              |
| [Keagate (⭐112)](https://github.com/dilan-dio4/Keagate)                |       No fees      |     No    |           Yes           |                                                                                   No                                                                                   | 1 GB RAM, Unix                                               |
| [LNURL Daemon (⭐10)](https://github.com/yanascz/lnurld)                |       No fees      |    Yes    |           Yes           |                                                                                   No                                                                                   | LND node                                                     |
