...
*   ![v3] [@vitejs/plugin-vue (⭐415)](https://github.com/vitejs/vite-plugin-vue) - Official Vue 3 support.
*   ![v3] [@vitejs/plugin-vue-jsx (⭐415)](https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue-jsx) - Official Vue 3 JSX support.
*   ![v2] [@vitejs/plugin-vue2 (⭐531)](https://github.com/vitejs/vite-plugin-vue2) - Official Vue 2 support.
...
*   ![v2] [unplugin-vue2-script-setup (⭐596)](https://github.com/antfu/unplugin-vue2-script-setup) - Enabling `<script setup>` syntax for Vue 2.
...
*   ![v3] [unplugin-vue-router (⭐1.3k)](https://github.com/posva/unplugin-vue-router) - Official experimental file based routing.
...
*   ![v23] [vite-plugin-md (⭐580)](https://github.com/antfu/vite-plugin-md) - Markdown as Vue components / Vue components in Markdown.
*   ![v3] [vite-svg-loader (⭐536)](https://github.com/jpkleemans/vite-svg-loader) - Load SVG files as Vue components.
...
*   ![v3] [vite-plugin-md-preview (⭐164)](https://github.com/JasKang/vite-plugin-md-preview) - Markdown code preview.
...
*   ![v23] [vite-plugin-vue-inspector (⭐626)](https://github.com/webfansplz/vite-plugin-vue-inspector) - Jump to local IDE source code while click the element of browser.
...
*   [vue-ssr (⭐9)](https://github.com/bistroo/vue-ssr) - Minimalistic wrapper to develop and run SSR powered Vue apps. ![vue3]
*   [vite-ssr-boost (⭐66)](https://github.com/Lomray-Software/vite-ssr-boost) - Server side rendering library for create awesome app based on `react-router`. ![react]
