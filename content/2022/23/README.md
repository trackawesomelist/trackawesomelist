...
*   nRF
    *   [nrf-rs/nrf-hal (⭐481)](https://github.com/nrf-rs/nrf-hal) - A Rust HAL for the nRF family of devices

### Libraries / Audio and Music

*   [RustAudio](https://github.com/RustAudio)
    *   [RustAudio/cpal (⭐2.5k)](https://github.com/RustAudio/cpal) - Low-level cross-platform audio I/O library. [![Actions Status](https://github.com/RustAudio/cpal/workflows/cpal/badge.svg?branch=master)](https://github.com/RustAudio/cpal/actions)
    *   [RustAudio/rodio (⭐1.7k)](https://github.com/RustAudio/rodio) - Audio playback library
    *   [RustAudio/rust-portaudio (⭐368)](https://github.com/RustAudio/rust-portaudio) - PortAudio bindings
...
*   [Wagtail Grapple (⭐146)](https://github.com/torchbox/wagtail-grapple) - A Wagtail app that makes building GraphQL endpoints a breeze.
...
*   [robfletcher/strikt (⭐533)](https://github.com/robfletcher/strikt) - An assertion library for Kotlin
*   [tschuchortdev/kotlin-compile-testing (⭐642)](https://github.com/tschuchortdev/kotlin-compile-testing) - A library for testing Kotlin and Java annotation processors, compiler plugins and code generation

### Libraries/Frameworks / Logging

*   [InsanusMokrassar/KSLog (⭐11)](https://github.com/InsanusMokrassar/KSLog) - Simple Kotlin Logging

### Libraries/Frameworks / Misc

*   [charleskorn/kaml (⭐489)](https://github.com/charleskorn/kaml) - YAML support for kotlinx.serialization
...
*   [neko (⭐47)](https://github.com/load1n9/neko) - 🐈 caviar's twin frame buffer deno module with a framebuffer canvas implementation
*   [sdl2 (⭐128)](https://github.com/littledivy/deno_sdl2) - SDL2 module for Deno
...
*   [WTelegramClient (⭐900)](https://github.com/wiz0u/WTelegramClient) - Automate a user account on Telegram, using the latest version of [Telegram Client API](https://core.telegram.org/methods)

### Blazor

*   [Megabit.Blazorise (⭐3.2k)](https://github.com/Megabit/Blazorise) - Blazorise is a component library built on top of Blazor and CSS frameworks like Bootstrap, Bulma and Material. Very easy to use.
...
*   Visual Studio Code: [pico8-ls (⭐53)](https://github.com/japhib/pico8-ls) - PICO-8 Language Server, providing full language support for the PICO-8 dialect of Lua.
...
*   [smjonas/inc-rename.nvim (⭐575)](https://github.com/smjonas/inc-rename.nvim) - Provides an incremental LSP rename command based on Neovim's command-preview feature.
...
*   [filipdutescu/renamer.nvim (⭐292)](https://github.com/filipdutescu/renamer.nvim) - VS Code-like renaming UI, written in Lua.

### Preconfigured Configuration / Diagnostics

*   [imbacraft/dusk.nvim (⭐43)](https://github.com/imbacraft/dusk.nvim) - Dusk is a lightweight, aesthetically minimal Neovim config, written in Lua, able to provide for web and Java development.
...
*   [Harfang 3D (⭐529)](https://github.com/harfang3d/harfang3d) 3D visualization library usable in C++, Python, Lua and Go. Based on BGFX. \[GPLv3/LGPLv3/Proprietary] [website](https://www.harfang3d.com)
