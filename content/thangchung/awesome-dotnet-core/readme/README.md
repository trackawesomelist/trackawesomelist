...
Inspired by [awesome (⭐223k)](https://github.com/sindresorhus/awesome), [awesome-dotnet (⭐16k)](https://github.com/quozd/awesome-dotnet),  [awesome-nodejs (⭐47k)](https://github.com/sindresorhus/awesome-nodejs), [frontend-dev-bookmarks (⭐36k)](https://github.com/dypsilon/frontend-dev-bookmarks).

Contributions are always welcome! Please take a look at the [contribution guidelines (⭐17k)](https://github.com/thangchung/awesome-dotnet-core/blob/master/contributing.md) pages first. We accept proprietary and commercial software too.

Thanks to all [contributors (⭐17k)](https://github.com/thangchung/awesome-dotnet-core/graphs/contributors), you're awesome and wouldn't be possible without you! The goal is to build a categorized community-driven collection of very well-known resources.
