...
Inspired by [awesome-ruby (⭐12k)](https://github.com/markets/awesome-ruby), [awesome-php (⭐28k)](https://github.com/ziadoz/awesome-php), [awesome-python (⭐145k)](https://github.com/vinta/awesome-python), [frontend-dev-bookmarks (⭐36k)](https://github.com/dypsilon/frontend-dev-bookmarks) and [ruby-bookmarks (⭐2k)](https://github.com/dreikanter/ruby-bookmarks).
...
*   [Orleans (⭐8.9k)](https://github.com/dotnet/orleans) - Orleans is a framework that provides a straight-forward approach to building distributed high-scale computing applications, without the need to learn and apply complex concurrency or other scaling patterns
