...
*   [buildcage (⭐2)](https://github.com/dash14/buildcage) - Restricts outbound network access during Docker builds to prevent supply chain attacks, working as a drop-in BuildKit remote driver for Docker Buildx, with ready-to-use GitHub Actions.
...
*   [d4s (⭐46)](https://github.com/jr-k/d4s) - A fast, keyboard-driven terminal UI to manage Docker containers, Compose stacks, and Swarm services with the ergonomics of K9s.
*   [DockMate (⭐276)](https://github.com/shubh-io/dockmate) - Lightweight terminal-based Docker and Podman manager with a text-based user interface,.
...
*   [Dockadvisor (⭐178)](https://github.com/deckrun/dockadvisor) - Lightweight Dockerfile linter with 60+ rules, quality scoring, and security checks.

## [Nov 24 - Nov 30, 2025](/content/2025/47/README.md)

### Base Tools / Other

*   [microcheck (⭐123)](https://github.com/tarampampam/microcheck) - Lightweight health check utilities for Docker containers (75 KB instead of 9.3 MB for httpcheck versus cURL) in pure C - http(s), port checks, and parallel execution are included.
...
*   [Defang (⭐145)](https://github.com/DefangLabs/defang) - Deploy Docker Compose to your favorite cloud in minutes.
...
*   [docker-to-iac (⭐23)](https://github.com/deploystackio/docker-to-iac) - Translate docker run and commit into Infrastructure as Code templates for AWS, Render.com and DigitalOcean.
...
*   [Anchor Enterprise](https://anchore.com/) - :heavy\_dollar\_sign: Analyze images for CVE vulnerabilities and against custom security policies.
...
*   [goManageDocker (⭐632)](https://github.com/ajayd-san/gomanagedocker) - TUI tool to view and manage your docker objects blazingly fast with sensible keybindings, also supports VIM navigation out of the box.
...
*   [dockemon (⭐751)](https://github.com/ProductiveOps/dokemon) - Docker Container Management GUI.
*   [dockge (⭐22k)](https://github.com/louislam/dockge) - Easy-to-use and reactive self-hosted docker compose.yaml stack-oriented manager.
...
*   [Docuum (⭐683)](https://github.com/stepchowfun/docuum) - Least recently used (LRU) eviction of Docker images.

## [Jan 22 - Jan 28, 2024](/content/2024/4/README.md)

### Web / Other

*   [Mafl (⭐671)](https://github.com/hywax/mafl) - Minimalistic flexible homepage.
...
*   [oxker (⭐1.5k)](https://github.com/mrjackwills/oxker) - A simple tui to view & control docker containers. Written in [Rust](https://rust-lang.org/), making heavy use of [ratatui (⭐19k)](https://github.com/tui-rs-revival/ratatui) & [Bollard (⭐1.2k)](https://github.com/fussybeaver/bollard),.
...
*   [docker rollout (⭐3.1k)](https://github.com/Wowu/docker-rollout) - Zero downtime deployment for Docker Compose services.
...
*   [ctk (⭐297)](https://github.com/ctk-hq/ctk) - Visual composer for container based workloads. By [corpulent](https://github.com/corpulent).
...
*   [crowdr (⭐98)](https://github.com/polonskiy/crowdr) - Tool for managing multiple Docker containers (`docker-compose` alternative).
*   [docker-config-update (⭐50)](https://github.com/sudo-bmitch/docker-config-update) - Utility to update docker configs and secrets for deploying in a compose file.
*   [elsy (⭐80)](https://github.com/cisco/elsy) - An opinionated, multi-language, build tool based on Docker and Docker Compose.
*   [habitus (⭐1.4k)](https://github.com/cloud66-oss/habitus) - A Build Flow Tool for Docker.
...
*   [Conduit (⭐108)](https://github.com/ehazlett/conduit) - Experimental deployment system for Docker.
...
*   [Docker-Flow-Monitor (⭐88)](https://github.com/docker-flow/docker-flow-monitor) - Reconfigures Prometheus when a new service is updated or deployed automatically.
*   [DockProc](https://gitlab.com/n0r1sk/dockproc) - I/O monitoring for containers on processlevel.
*   [dockprom (⭐6.5k)](https://github.com/stefanprodan/dockprom) - Docker hosts and containers monitoring with Prometheus, Grafana, cAdvisor, NodeExporter and AlertManager.
...
*   [Glances (⭐32k)](https://github.com/nicolargo/glances) - A cross-platform curses-based system monitoring tool written in Python.
*   [InfluxDB, cAdvisor, Grafana (⭐473)](https://github.com/vegasbrianc/docker-monitoring) - InfluxDB Time series DB in combination with Grafana and cAdvisor.
*   [Logspout (⭐4.7k)](https://github.com/gliderlabs/logspout) - Log routing for Docker container logs.
...
*   [NexClipper (⭐566)](https://github.com/NexClipper/NexClipper) - NexClipper is the container monitoring and performance management solution specialized in Docker, Apache Mesos, Marathon, DC/OS, Mesosphere, Kubernetes.
...
*   [netshoot (⭐10k)](https://github.com/nicolaka/netshoot) - The netshoot container has a powerful set of networking tools to help troubleshoot Docker networking issues.
...
*   [rlxc (⭐18)](https://github.com/brauner/rlxc) - LXC binary written in Rust.
*   [runtime-tools (⭐471)](https://github.com/opencontainers/runtime-tools) - Oci-runtime-tool is a collection of tools for working with the OCI runtime specification.
...
*   [bane (⭐1.2k)](https://github.com/genuinetools/bane) - AppArmor profile generator for Docker containers.
...
*   [docker-explorer (⭐552)](https://github.com/google/docker-explorer) - A tool to help forensicate offline docker acquisitions.
...
*   [docker-ls (⭐456)](https://github.com/mayflower/docker-ls) - CLI tools for browsing and manipulating docker registries.
*   [DVM (⭐524)](https://github.com/howtowhale/dvm) - Docker version manager.
*   [goinside (⭐30)](https://github.com/iamsoorena/goinside) - Get inside a running docker container easily.
*   [Pdocker (⭐7)](https://github.com/g31s/Pdocker) - A simple tool to manage and maintain Docker for personal projects.
*   [proco (⭐109)](https://github.com/shiwaforce/poco) - Proco will help you to organise and manage Docker, Docker-Compose, Kubernetes projects of any complexity using simple YAML config files to shorten the route from finding your project to initialising it in your local environment.
*   [scuba (⭐95)](https://github.com/JonathonReinhart/scuba) - Transparently use Docker containers to encapsulate software build environments,.
*   [skopeo (⭐10k)](https://github.com/containers/skopeo) - Work with remote images registries - retrieving information, images, signing content.
...
*   [tsaotun (⭐58)](https://github.com/qazbnm456/tsaotun) - Python based Assistance for Docker.
...
*   [Powerline-Docker (⭐61)](https://github.com/adrianmo/powerline-docker) - A Powerline segment for showing the status of Docker containers.
...
*   [Docker Registry Browser (⭐672)](https://github.com/klausmeyer/docker-registry-browser) - Web Interface for the Docker Registry HTTP API v2.
*   [docker-registry-web (⭐548)](https://github.com/mkuchin/docker-registry-web) - Web UI, authentication service and event recorder for private docker registry v2.
...
*   [Kubevious (⭐1.7k)](https://github.com/kubevious/kubevious) - A highly visual web UI for Kubernetes which renders configuration and state in an application centric way.
...
*   [Rapid Dashboard (⭐147)](https://github.com/ozlerhakan/rapid) - A simple query dashboard to use Docker Remote API.
*   [Seagull (⭐1.9k)](https://github.com/tobegit3hub/seagull) - Friendly Web UI to monitor docker daemon.
...
*   [amicontained (⭐1.1k)](https://github.com/genuinetools/amicontained) - Container introspection tool. Find out what container runtime is being used as well as features available.
*   [Chaperone (⭐178)](https://github.com/garywiz/chaperone) - A single PID1 process designed for docker containers. Does user management, log management, startup, zombie reaping, all in one small package.
...
*   [docker-alpine (⭐5.7k)](https://github.com/gliderlabs/docker-alpine) - A super small Docker base image *(5MB)* using Alpine Linux.
*   [docker-gen (⭐4.6k)](https://github.com/jwilder/docker-gen) - Generate files from docker container meta-data.
*   [GoSu (⭐4.9k)](https://github.com/tianon/gosu) - Run this specific application as this specific user and get out of the pipeline (entrypoint script tool).
*   [is-docker (⭐231)](https://github.com/sindresorhus/is-docker) - Check if the process is running inside a Docker container.
*   [lstags (⭐340)](https://github.com/ivanilves/lstags) - Sync Docker images across registries.
...
*   [ansible-bender (⭐692)](https://github.com/ansible-community/ansible-bender) - A tool utilising `ansible` and `buildah`.
*   [buildah (⭐8.6k)](https://github.com/containers/buildah) - A tool that facilitates building OCI images.
*   [BuildKit (⭐9.8k)](https://github.com/moby/buildkit) - Concurrent, cache-efficient, and Dockerfile-agnostic builder toolkit.
*   [cekit (⭐113)](https://github.com/cekit/cekit) - A tool used by openshift to build base images using different build engines.
*   [container-factory (⭐64)](https://github.com/mutable/container-factory) - Produces Docker images from tarballs of application source code.
*   [copy-docker-image (⭐38)](https://github.com/mdlavin/copy-docker-image) - Copy a Docker image between registries without a full Docker installation.
...
*   [Dockly (⭐228)](https://github.com/swipely/dockly) - Dockly is a gem made to ease the pain of packaging an application in Docker.
...
*   [HPC Container Maker (⭐507)](https://github.com/NVIDIA/hpc-container-maker) - Generates Dockerfiles from a high level Python recipe, including building blocks for High-Performance Computing components.
...
*   [portainer (⭐134)](https://github.com/duedil-ltd/portainer) - Apache Mesos framework for building Docker images.
...
*   [Whales (⭐391)](https://github.com/Gueils/whales) - A tool to automatically dockerize your applications.
...
*   [FROM:latest (⭐1k)](https://github.com/replicatedhq/dockerfilelint) - An opinionated Dockerfile linter.
...
*   [cleanreg (⭐59)](https://github.com/hcguersoy/cleanreg) - A small tool to delete image manifests from a Docker Registry implementing the API v2, dereferencing them for the GC.
...
*   [Docket (⭐709)](https://github.com/netvarun/docket) - Custom docker registry that allows for lightning fast deploys through bittorrent.
...
*   [Quay.io :heavy\_dollar\_sign:](https://quay.io/) - Secure hosting for private Docker repositories.
*   [Registryo (⭐15)](https://github.com/inmagik/registryo) - UI and token based authentication server for onpremise docker registry.
*   [Rescoyl (⭐18)](https://github.com/noteed/rescoyl) - Private Docker registry (free and open source).

### API Client / Other

*   [ahab (⭐137)](https://github.com/instacart/ahab) - Docker event handling with Python.
...
*   [Docker Client for JVM (⭐118)](https://github.com/gesellix/docker-client) - A Docker remote api client library for the JVM, written in Groovy.
...
*   [docker-it-scala (⭐433)](https://github.com/whisklabs/docker-it-scala) - Docker integration testing kit with Scala.
...
*   [dockerode (⭐4.8k)](https://github.com/apocas/dockerode) - Docker Remote API node.js module.
...
*   [Gradle Docker plugin (⭐81)](https://github.com/gesellix/gradle-docker-plugin) - A Docker remote api plugin for Gradle.
*   [Portainer stack utils (⭐74)](https://github.com/greenled/portainer-stack-utils) - Bash script to deploy/update/undeploy Docker stacks in a Portainer instance from a docker-compose yaml file. By [greenled](https://github.com/greenled).
*   [sbt-docker (⭐734)](https://github.com/marcuslonnberg/sbt-docker) - Create Docker images directly from sbt.
...
*   [Cyclone (⭐1.1k)](https://github.com/caicloud/cyclone) - Powerful workflow engine and end-to-end pipeline solutions implemented with native Kubernetes resources.
...
*   [coder (⭐12k)](https://github.com/coder/coder) - Remote development machines powered by Terraform or Docker.
*   [construi (⭐24)](https://github.com/lstephen/construi) - Run your builds inside a Docker defined environment.
...
*   [docker-vm (⭐43)](https://github.com/shyiko/docker-vm) - Simple and transparent alternative to boot2docker (backed by Vagrant).
...
*   [Vagga (⭐1.9k)](https://github.com/tailhook/vagga) - Vagga is a containerisation tool without daemons. It is a fully-userspace container engine inspired by Vagrant and Docker, specialized for development environments.
...
*   [Docker Clean (⭐1.3k)](https://github.com/ZZROTDesign/docker-clean) - A script that cleans Docker containers, images and volumes.
*   [docker-custodian (⭐374)](https://github.com/Yelp/docker-custodian) - Keep docker hosts tidy. By [Yelp](https://github.com/Yelp).
*   [docker\_gc (⭐127)](https://github.com/pdacity/docker_gc) - Image for automatic removing unused Docker Swarm objects. Also works just as Docker Service.
...
*   [SCAR (⭐600)](https://github.com/grycap/scar) - Serverless Container-aware Architectures (SCAR) is a serverless framework that allows easy deployment and execution of containers (e.g. Docker) in Serverless environments (e.g. Lambda).
...
*   [Dray (⭐386)](https://github.com/CenturyLinkLabs/dray) - An engine for managing the execution of container-based workflows.
...
*   [Shutit (⭐2.1k)](https://github.com/ianmiell/shutit) - Tool for building and maintaining complex Docker deployments.
...
*   [udocker (⭐1.7k)](https://github.com/indigo-dc/udocker) - A tool to execute simple docker containers in batch or interactive systems without root privileges.
...
*   [Mesosphere DC/OS Platform](https://d2iq.com/products/dcos) - :heavy\_dollar\_sign: Integrated platform for data and containers built on Apache Mesos.
...
*   [Awesome Selfhosted (⭐276k)](https://github.com/awesome-selfhosted/awesome-selfhosted) list of Free Software network services and web applications which can be hosted locally by running in a classical way (setup local web server and run applications from there) or in a Docker container. By [Kickball](https://github.com/Kickball)
