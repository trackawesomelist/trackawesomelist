...
*   [dockerize (⭐196)](https://github.com/powerman/dockerize) - Utility to simplify running applications in docker containers by [jwilder](https://github.com/jwilder), [powerman](https://github.com/powerman).
...
*   [Swarm-cronjob (⭐866)](https://github.com/crazy-max/swarm-cronjob) - Create jobs on a time-based schedule on Swarm by [crazy-max](https://github.com/crazy-max).
