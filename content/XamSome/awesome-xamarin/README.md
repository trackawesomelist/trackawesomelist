...
[🏠 Home](/README.md) · [🔍 Search](https://www.trackawesomelist.com/search/) · [🔥 Feed](https://www.trackawesomelist.com/XamSome/awesome-xamarin/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 XamSome/awesome-xamarin](https://github.com/XamSome/awesome-xamarin) · ⭐ 1.9K · 🏷️ Platforms
...
*   [DryIoc (⭐861)](https://github.com/dadhi/DryIoc) - Fast, small, full-featured IoC Container for .NET.
...
*   [AutoMapper ★5,724 (⭐9.4k)](https://github.com/AutoMapper/AutoMapper) - A convention-based object-object mapper in .NET.
*   [Humanizer ★3,426 (⭐7.7k)](https://github.com/Humanizr/Humanizer) - Manipulation and displaying of strings, enums, dates, times, timespans, numbers and quantities.
...
*   [Stateless ★2,294 (⭐4.8k)](https://github.com/dotnet-state-machine/stateless) - State Machines.

### Async

*   [AsyncEx ★1,253 (⭐3.2k)](https://github.com/StephenCleary/AsyncEx) - A helper library for async/await.
...
*   [FireSharp ★479 (⭐672)](https://github.com/ziyasal/FireSharp) - Firebase REST API wrapper.
...
*   [Couchbase.Lite ★299 (⭐426)](https://github.com/couchbase/couchbase-lite-net) - Lightweight embedded NoSQL database.
...
*   [Fody ★2,150 (⭐4k)](https://github.com/Fody/Fody) - Extensible tool for weaving .net assemblies.
    ...
    *   [ReactiveUI.Fody ★105 (⭐144)](https://github.com/kswoll/ReactiveUI.Fody) - Generate RaisePropertyChange notifications for properties and ObservableAsPropertyHelper properties.
...
*   [SimplyMobile ★103 (⭐114)](https://github.com/sami1971/SimplyMobile) - Collection of abstracted mobile functionalities.
...
*   [CocosSharp ★463 (⭐488)](https://github.com/mono/CocosSharp) - CSharp implementation of the Cocos2D and Cocos3D APIs.
*   [MonoGame ★5,276 (⭐9.5k)](https://github.com/MonoGame/MonoGame) - Open source implementation of the Microsoft XNA 4.x Framework.
*   [Paradox ★1,706 (⭐1.6k)](https://github.com/SiliconStudio/xenko) - Paradox3D + Silicon Studio .NET.
*   [UrhoSharp ★275 (⭐455)](https://github.com/xamarin/urho) - Cross-platform high-level 3D and 2D engine.
...
*   [LightInject ★320 (⭐586)](https://github.com/seesharper/LightInject) - Light, simple and stunningly fast IoC container for .NET.
...
*   [TinyIoC ★585 (⭐814)](https://github.com/grumpydev/TinyIoC) - Single-class easy IoC container.

### Internationalization

*   [I18NPortable ★49 (⭐103)](https://github.com/xleon/I18N-Portable) - Simple and cross platform internationalization/translations for Xamarin and .NET.
...
*   [Vernacular ★167 (⭐169)](https://github.com/rdio/vernacular) - Cross Platform Localisation, tools to convert standard strings formats.

### Layout

*   [Flex ★128 (⭐181)](https://github.com/xamarin/flex) - Flexible box layout system.
...
*   [NGraphics ★482 (⭐690)](https://github.com/praeclarum/NGraphics) - Cross platform library for rendering vector graphics.
...
*   [SkiaSharp ★920 (⭐3.4k)](https://github.com/mono/SkiaSharp) - Powerful C# API for doing 2D graphics. It is powered by Google’s Skia library.
*   [Splat ★590 (⭐919)](https://github.com/reactiveui/splat) - Cross platform image loading, colors and stuff.
*   [SimpleAudioPlayer ★14 (⭐132)](https://github.com/adrianstevens/Xamarin-Plugins/tree/master/SimpleAudioPlayer) - Simple plugin for plays local files and audio data as a stream.
...
*   [Bind ★158 (⭐202)](https://github.com/praeclarum/Bind) - Bind gives you easy two-way data binding between properties of objects.
*   [FreshMvvm ★324 (⭐586)](https://github.com/rid00z/FreshMvvm) - Super light Mvvm Framework designed specifically for Xamarin.Forms.
...
*   [MugenMvvmToolkit ★127 (⭐159)](https://github.com/MugenMvvmToolkit/MugenMvvmToolkit) - Cross-platform MVVM toolkit.
*   [MvvmNano ★46 (⭐59)](https://github.com/aspnetde/MvvmNano) - Small and smart MVVM framework made with ❤ for Xamarin.Forms.
*   [Prism ★2,365 (⭐5.6k)](https://github.com/prismlibrary/prism) - Cross-platform MVVM development framework.

### Reactive

*   [ReactiveUI ★3,917 (⭐7.5k)](https://github.com/reactiveui/ReactiveUI) - Rx MVVM framework.
*   [Refit ★2,762 (⭐7.2k)](https://github.com/reactiveui/refit) - Refit is a library heavily inspired by Square's Retrofit library, and it turns your REST API into a live interface.
*   [Akavache ★1,692 (⭐2.3k)](https://github.com/reactiveui/Akavache) - An Asynchronous Key-Value Store for Native Applications.
*   [ReactiveProperty ★361 (⭐816)](https://github.com/runceel/ReactiveProperty) - Provides MVVM and asynchronous support features under Reactive Extensions.
...
*   [Connectivity ★200 (⭐262)](https://github.com/jamesmontemagno/ConnectivityPlugin) - Cross-platform network/connection status.
...
*   [Flurl ★1,295 (⭐3.6k)](https://github.com/tmenier/Flurl) - Flurl is a modern, fluent, asynchronous, testable, portable, buzzword-laden URL builder and HTTP client library.
*   [Messaging ★1 (⭐113)](https://github.com/cjlotz/Xamarin.Plugins/tree/master/Messaging) - Make a phone call, send a sms or send an e-mail using the default messaging applications.
*   [NFC ★14 (⭐38)](https://github.com/smstuebe/xamarin-nfc) - Xamarin plugin for reading NFC tags.
...
*   [RestEase ★339 (⭐961)](https://github.com/canton7/RestEase) - Refit on steroids, simpler auth, parsing...
*   [RestLess ★57 (⭐109)](https://github.com/letsar/RestLess) - The automatic type-safe-reflectionless REST API client library for .Net Standard.
*   [Sockets ★185 (⭐224)](https://github.com/rdavisau/sockets-for-pcl) - An abstraction over the socket helper classes of .NET and WinRT.

### Security

*   [Fingerprint Plugin ★165 (⭐466)](https://github.com/smstuebe/xamarin-fingerprint) - Xamarin and MvvMCross plugin for accessing the fingerprint sensor.
*   [PCLCrypto ★184 (⭐225)](https://github.com/AArnott/PCLCrypto) - Cryptography for portable class libraries (MD5,...).
...
*   [NBehave ★47 (⭐58)](https://github.com/nbehave/NBehave) - Framework for Behaviour-Driven Development.

### Tools

*   [Cheeseknife ★53 (⭐57)](https://github.com/MarcelBraghetto/Cheeseknife) - A view injection library for Xamarin.Android.
*   [GradleBindings ★103 (⭐141)](https://github.com/EgorBo/Xamarin.GradleBindings) - Visual Studio extension, for referencing gradle libs in Android projects.
...
*   [AdvancedTimer ★35 (⭐39)](https://github.com/ufuf/AdvancedTimer) - Timer object and its methods are implemented for extended support for timers.
...
*   [SVG ★1 (⭐275)](https://github.com/paulpatarinski/Xamarin.Forms.Plugins/tree/master/SVG) - SVG file format support.
*   [Swipecards ★80 (⭐129)](https://github.com/robinmanuelthiel/swipecards) - A Tinder-like swipe control for Xamarin.Forms.
*   [Toasts Plugin ★208 (⭐275)](https://github.com/EgorBo/Toasts.Forms.Plugin) - A simple way of showing some notifications inside your Xamarin.Forms application.
...
*   [Xamarin.Forms.GoogleMaps ★250 (⭐532)](https://github.com/amay077/Xamarin.Forms.GoogleMaps) - Maps library for Xamarin.Forms using Google Mapps API.
*   [XamFormsMvxTemplate ★19 (⭐27)](https://github.com/JTOne123/XamFormsMvxTemplate) - MVVMCross.Forms Visual Studio 2017 project template (iOS, Android, UWP).
...
*   [Fingerprint ★165 (⭐466)](https://github.com/smstuebe/xamarin-fingerprint) - Xamarin and MvvMCross plugin for accessing the fingerprint sensor.
...
*   [Messaging ★88 (⭐113)](https://github.com/cjlotz/Xamarin.Plugins) - The Messaging plugin makes it possible to make a phone call, send a sms or send an e-mail using the default messaging applications on the different mobile platforms.
...
*   [userdialogs ★510 (⭐947)](https://github.com/aritchie/userdialogs) - Standard user dialogs from a shared/portable library.
...
*   [Xamarin.Mobile ★237 (⭐237)](https://github.com/xamarin/Xamarin.Mobile) - Reading the user's address book and using the camera.
...
*   [Open Source Xamarin Apps ★11 (⭐429)](https://github.com/wcoder/open-source-xamarin-apps) - A list of open source Xamarin apps.
