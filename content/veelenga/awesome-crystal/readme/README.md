...
A curated list of awesome Crystal code and resources. Inspired by [awesome (⭐249k)](https://github.com/sindresorhus/awesome) and [awesome-awesomeness (⭐30k)](https://github.com/bayandin/awesome-awesomeness).
...
*   [fzy (⭐41)](https://github.com/hugopl/fzy) - A Crystal port of awesome Fzy project fuzzy finder algorithm
...
*   [crystal-db (⭐267)](https://github.com/crystal-lang/crystal-db) - Common db api
