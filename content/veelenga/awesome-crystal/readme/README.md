...
A curated list of awesome Crystal code and resources. Inspired by [awesome (⭐296k)](https://github.com/sindresorhus/awesome) and [awesome-awesomeness (⭐31k)](https://github.com/bayandin/awesome-awesomeness).
...
*   [markd (⭐107)](https://github.com/icyleaf/markd) - Yet another markdown parser built for speed, Compliant to CommonMark specification
