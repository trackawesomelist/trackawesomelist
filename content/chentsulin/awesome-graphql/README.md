...
*   [pylon (⭐165)](https://github.com/getcronit/pylon) - Write full-feature APIs with just functions. No more boilerplate code, no more setup. Just write functions and deploy.
...
*   [Bruno (⭐27k)](https://github.com/usebruno/bruno) - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.

## [Feb 25, 2024](/content/2024/02/25/README.md)

### Clients

*   [genql (⭐881)](https://github.com/remorses/genql) - Type safe TypeScript client for any GraphQL API.
...
*   [WunderGraph Cosmo (⭐734)](https://github.com/wundergraph/cosmo) - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.

### Go / React

*   [graphql-go-tools (⭐694)](https://github.com/wundergraph/graphql-go-tools) - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
*   [GraphQLer (⭐126)](https://github.com/omar2535/GraphQLer) - Dependency-aware dynamic GraphQL testing tool
...
*   [goctopus (⭐101)](https://github.com/Escape-Technologies/goctopus) - an incredibly fast GraphQL discovery & fingerprinting toolbox.
...
*   [GraphQL Cop (⭐382)](https://github.com/dolevf/graphql-cop) - Security Audit Utility for GraphQL
...
*   [gqty (⭐930)](https://github.com/gqty-dev/gqty) - A No GraphQL client for TypeScript

### Frontend Framework Integrations / React

*   [@gqty/react (⭐930)](https://github.com/gqty-dev/gqty) - A No GraphQL client for TypeScript
...
*   [graphql-armor (⭐500)](https://github.com/Escape-Technologies/graphql-armor) - An instant security layer for production GraphQL Endpoints.

### Python / React

*   [sgqlc (⭐514)](https://github.com/profusion/sgqlc) - Simple GraphQL Client makes working with GraphQL API responses easier in Python.
...
*   [morpheus-graphql (⭐410)](https://github.com/morpheusgraphql/morpheus-graphql) - Haskell GraphQL Api, Client and Tools.

## [Aug 14, 2022](/content/2022/08/14/README.md)

### .NET / React

*   [EntityGraphQL (⭐417)](https://github.com/EntityGraphQL/EntityGraphQL) - library to build a GraphQL API on top of data model with the extensibility to bring multiple data sources together in the single GraphQL schema.
*   [ZeroQL (⭐278)](https://github.com/byme8/ZeroQL) - type-safe GraphQL client with Linq-like interface for C#

## [Aug 08, 2022](/content/2022/08/08/README.md)

### Python / React

*   [graphql-core (⭐512)](https://github.com/graphql-python/graphql-core) - GraphQL implementation for Python based on GraphQL.js v16.3.0 reference implementation
...
*   [GraphCrawler - The all-in-one GraphQL Security toolkit (⭐302)](https://github.com/gsmith257-cyber/GraphCrawler) - The all-in-one automated penetration tester toolkit for GraphQL, written in Python

## [Jul 08, 2022](/content/2022/07/08/README.md)

### Tools - Editors & IDEs & Explorers / React

*   [Escape GraphMan (⭐241)](https://github.com/Escape-Technologies/graphman) - Generate a complete Postman collection from a GraphQL endpoint.

## [Jun 10, 2022](/content/2022/06/10/README.md)

### Tools - Editors & IDEs & Explorers / React

*   [gqt (⭐464)](https://github.com/eerimoq/gqt) - Build and execute GraphQL queries in the terminal.
...
*   [schemathesis (⭐2.3k)](https://github.com/schemathesis/schemathesis) - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
*   [supertest-graphql (⭐33)](https://github.com/alexstrat/supertest-graphql) - Extends [supertest (⭐14k)](https://github.com/visionmedia/supertest) to easily test a GraphQL endpoint
...
*   [sveltekit-kitql (⭐406)](https://github.com/jycouet/kitql) - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.

## [Feb 07, 2022](/content/2022/02/07/README.md)

### Python / React

*   [turms (⭐61)](https://github.com/jhnnsrs/turms) - A pythonic graphql codegenerator built around graphql-core and pydantic
...
*   [GraphVinci (⭐74)](https://github.com/Comcast/graphvinci) - An interactive schema visualizer for GraphQL APIs.
...
*   [GraphQL over HTTP (⭐388)](https://github.com/graphql/graphql-over-http) - Working draft of "GraphQL over HTTP" specification.
...
*   [mst-gql (⭐684)](https://github.com/mobxjs/mst-gql) - Bindings for mobx-state-tree and GraphQL.
...
*   [graphql-java-extended-scalars (⭐261)](https://github.com/graphql-java/graphql-java-extended-scalars) - Extended scalars for graphql-java.
...
*   [ts-graphql-plugin (⭐723)](https://github.com/Quramy/ts-graphql-plugin) - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
*   [Prisma (⭐40k)](https://github.com/prisma/prisma) - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
...
*   [Next.js TypeScript and GraphQL Example (⭐127k)](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
...
*   [NAPERG (⭐761)](https://github.com/alan345/naperg) - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
*   [GraphQL Starter (⭐103)](https://github.com/cerino-ligutom/GraphQL-Starter) - A boilerplate for TypeScript + Node Express + Apollo GraphQL APIs.
...
*   [overblog/graphql-bundle (⭐788)](https://github.com/overblog/GraphQLBundle) - This bundle provides tools to build a complete GraphQL server in your Symfony App. Supports react-relay.
*   [wp-graphql (⭐3.7k)](https://github.com/wp-graphql/wp-graphql) - GraphQL API for WordPress.
*   [graphqlite (⭐557)](https://github.com/thecodingmachine/graphqlite) - Framework agnostic library that allows you to write GraphQL server by annotating your PHP classes.
...
*   [graphql-java-tools (⭐810)](https://github.com/graphql-java-kickstart/graphql-java-tools) - Schema-first graphql-java convenience library that makes it easy to bring your own implementations as data resolvers. Inspired by [graphql-tools (⭐5.4k)](https://github.com/apollographql/graphql-tools) for JS.
...
*   [graphql-java-codegen-gradle-plugin (⭐19)](https://github.com/kobylynskyi/graphql-java-codegen-gradle-plugin) - Schema-first gradle plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [gradle-swagger-generator-plugin (⭐305)](https://github.com/int128/gradle-swagger-generator-plugin).
...
*   [federation-jvm (⭐251)](https://github.com/apollographql/federation-jvm) - Apollo Federation on the JVM.
*   [graphql-java-extended-validation (⭐128)](https://github.com/graphql-java/graphql-java-extended-validation) - Provides extended validation of fields and field arguments for graphql-java.
...
*   [cppgraphqlgen (⭐325)](https://github.com/Microsoft/cppgraphqlgen) - C++ GraphQL schema service generator.
...
*   [caliban (⭐947)](https://github.com/ghostdogpr/caliban) - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
*   [graphql-lua (⭐186)](https://github.com/bjornbytes/graphql-lua) - GraphQL for Lua.
...
*   [re-graph (⭐462)](https://github.com/oliyh/re-graph) - A GraphQL client for ClojureScript with bindings for re-frame applications.
...
*   [GraphQL (⭐938)](https://github.com/GraphQLSwift/GraphQL) - The Swift implementation for GraphQL.
...
*   [graphql-parser (⭐353)](https://github.com/graphql-rust/graphql-parser) - A parser, formatter and AST for the GraphQL query and schema definition language for Rust.
...
*   [graphql-crystal (⭐215)](https://github.com/ziprandom/graphql-crystal) - library inspired by [graphql-ruby (⭐5.4k)](https://github.com/rmosolgo/graphql-ruby) & [go-graphql (⭐248)](https://github.com/playlyfe/go-graphql) & [graphql-parser (⭐217)](https://github.com/graphql-dotnet/parser).
...
*   [GraphQL Voyager (⭐7.8k)](https://github.com/APIs-guru/graphql-voyager) - Represent any GraphQL API as an interactive graph.
...
*   [vim-graphql (⭐491)](https://github.com/jparise/vim-graphql) - A Vim plugin that provides GraphQL file detection and syntax highlighting.
