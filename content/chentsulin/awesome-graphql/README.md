...
*   [GraphQL Cop (⭐222)](https://github.com/dolevf/graphql-cop) - Security Audit Utility for GraphQL
...
*   [gqty (⭐732)](https://github.com/gqty-dev/gqty) - A No GraphQL client for TypeScript

### Frontend Framework Integrations / React

*   [@gqty/react (⭐732)](https://github.com/gqty-dev/gqty) - A No GraphQL client for TypeScript
...
*   [graphql-armor (⭐383)](https://github.com/Escape-Technologies/graphql-armor) - An instant security layer for production GraphQL Endpoints.

### Python / React

*   [sgqlc (⭐475)](https://github.com/profusion/sgqlc) - Simple GraphQL Client makes working with GraphQL API responses easier in Python.
...
*   [morpheus-graphql (⭐389)](https://github.com/morpheusgraphql/morpheus-graphql) - Haskell GraphQL Api, Client and Tools.

## [Aug 14, 2022](/content/2022/08/14/README.md)

### .NET / React

*   [EntityGraphQL (⭐339)](https://github.com/EntityGraphQL/EntityGraphQL) - library to build a GraphQL API on top of data model with the extensibility to bring multiple data sources together in the single GraphQL schema.
*   [ZeroQL (⭐199)](https://github.com/byme8/ZeroQL) - type-safe GraphQL client with Linq-like interface for C#

## [Aug 08, 2022](/content/2022/08/08/README.md)

### Python / React

*   [graphql-core (⭐485)](https://github.com/graphql-python/graphql-core) - GraphQL implementation for Python based on GraphQL.js v16.3.0 reference implementation
...
*   [GraphCrawler - The all-in-one GraphQL Security toolkit (⭐257)](https://github.com/gsmith257-cyber/GraphCrawler) - The all-in-one automated penetration tester toolkit for GraphQL, written in Python

## [Jul 08, 2022](/content/2022/07/08/README.md)

### Tools - Editors & IDEs & Explorers / React

*   [Escape GraphMan (⭐216)](https://github.com/Escape-Technologies/graphman) - Generate a complete Postman collection from a GraphQL endpoint.
...
*   [Escape Graphinder - GraphQL Subdomain Enumeration (⭐106)](https://github.com/Escape-Technologies/graphinder) – Blazing fast GraphQL endpoints finder using subdomain enumeration, scripts analysis and bruteforce.
...
*   [schemathesis (⭐1.8k)](https://github.com/schemathesis/schemathesis) - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
*   [pothos (⭐2k)](https://github.com/hayes/pothos) - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.

## [Apr 07, 2022](/content/2022/04/07/README.md)

### Tools - Docs / React

*   [spectaql (⭐953)](https://github.com/anvilco/spectaql) - Autogenerate static GraphQL API documentation.
...
*   [Typetta (⭐90)](https://github.com/twinlogix/typetta) - Node.js ORM written in TypeScript for type lovers. Typetta is the perfect ORM for the GraphQL + NodeJS + Typescript stack.
...
*   [sveltekit-kitql (⭐309)](https://github.com/jycouet/kitql) - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.

## [Feb 07, 2022](/content/2022/02/07/README.md)

### Python / React

*   [turms (⭐44)](https://github.com/jhnnsrs/turms) - A pythonic graphql codegenerator built around graphql-core and pydantic
...
*   [graphql-jit (⭐979)](https://github.com/zalando-incubator/graphql-jit) - GraphQL execution using a JIT compiler.
...
*   [graphql-request (⭐5.4k)](https://github.com/prisma-labs/graphql-request) - A minimal GraphQL client for Node and browsers.
...
*   [svelte-apollo (⭐919)](https://github.com/timhall/svelte-apollo) - Svelte integration for Apollo GraphQL.
...
*   [apollo-elements (⭐400)](https://github.com/apollo-elements/apollo-elements) - GraphQL web components that work in any frontend framework.
...
*   [graphql-yoga (⭐7.7k)](https://github.com/prisma-labs/graphql-yoga) - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
...
*   [graphql-java-extended-scalars (⭐220)](https://github.com/graphql-java/graphql-java-extended-scalars) - Extended scalars for graphql-java.
...
*   [ts-graphql-plugin (⭐681)](https://github.com/Quramy/ts-graphql-plugin) - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
*   [graphql-live-query (⭐418)](https://github.com/n1ru4l/graphql-live-query) - Realtime GraphQL Live Queries with JavaScript.
...
*   [Next.js TypeScript and GraphQL Example (⭐112k)](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
...
*   [Next.js Apollo TypeScript Starter (⭐264)](https://github.com/borisowsky/nextjs-apollo-ts-starter) - Next.js starter project focused on developer experience.
*   [GraphQL Starter (⭐78)](https://github.com/cerino-ligutom/GraphQL-Starter) - A boilerplate for TypeScript + Node Express + Apollo GraphQL APIs.
...
*   [agoo (⭐849)](https://github.com/ohler55/agoo) - Ruby web server that implements Facebook's GraphQL.
...
*   [agoo-demo (⭐849)](https://github.com/ohler55/agoo/tree/develop/example/graphql) - Use of the Agoo server to demonstrate a simple GraphQL application.
*   [rails-devise-graphql (⭐279)](https://github.com/zauberware/rails-devise-graphql) - A rails 6 boilerplate with devise, graphql & JWT auth.
...
*   [overblog/graphql-bundle (⭐753)](https://github.com/overblog/GraphQLBundle) - This bundle provides tools to build a complete GraphQL server in your Symfony App. Supports react-relay.
*   [wp-graphql (⭐3.5k)](https://github.com/wp-graphql/wp-graphql) - GraphQL API for WordPress.
*   [graphqlite (⭐537)](https://github.com/thecodingmachine/graphqlite) - Framework agnostic library that allows you to write GraphQL server by annotating your PHP classes.
...
*   [django-graphql-auth (⭐318)](https://github.com/PedroBern/django-graphql-auth) - Django registration and authentication with GraphQL.
*   [strawberry (⭐3.4k)](https://github.com/strawberry-graphql/strawberry) - A new GraphQL library for Python.
...
*   [graphql-java-annotations (⭐378)](https://github.com/Enigmatis/graphql-java-annotations) - Provides annotations-based syntax for schema definition with GraphQL Java.
...
*   [graphql-java-extended-validation (⭐110)](https://github.com/graphql-java/graphql-java-extended-validation) - Provides extended validation of fields and field arguments for graphql-java.
...
*   [graphql-spqr-samples (⭐102)](https://github.com/leangen/graphql-spqr-samples) - An example GraphQL server written with Spring MVC and GraphQL-SPQR.
...
*   [graphql-java-kickstart\_samples (⭐107)](https://github.com/graphql-java-kickstart/samples) - Samples for using the GraphQL Java Kickstart projects.
...
*   [caliban (⭐881)](https://github.com/ghostdogpr/caliban) - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
*   [Hot Chocolate (⭐4.6k)](https://github.com/ChilliCream/hotchocolate) - GraphQL server for .Net Core and .NET Framework.
*   [Snowflaqe (⭐153)](https://github.com/Zaid-Ajaj/Snowflaqe) - Type-safe GraphQL code generator for F# and [Fable (⭐2.7k)](https://github.com/fable-compiler/Fable)
...
*   [GraphQL (⭐918)](https://github.com/GraphQLSwift/GraphQL) - The Swift implementation for GraphQL.
...
*   [Artemis (⭐490)](https://github.com/comigor/artemis) - A GraphQL type and query generator for Dart/Flutter.
...
*   [Warp GraphQL Juniper Demo (⭐5.3k)](https://github.com/graphql-rust/juniper/tree/master/examples/warp_async)
...
*   [ghql (⭐136)](https://github.com/ropensci/ghql) - General purpose GraphQL R client.
...
*   [graphql-crystal (⭐217)](https://github.com/ziprandom/graphql-crystal) - library inspired by [graphql-ruby (⭐5.3k)](https://github.com/rmosolgo/graphql-ruby) & [go-graphql (⭐249)](https://github.com/playlyfe/go-graphql) & [graphql-parser (⭐202)](https://github.com/graphql-dotnet/parser).
...
*   [gqldoc (⭐185)](https://github.com/Code-Hex/gqldoc) - The easiest way to make API documents for GraphQL.
...
*   [js-graphql-intellij-plugin (⭐859)](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
*   [vim-graphql (⭐476)](https://github.com/jparise/vim-graphql) - A Vim plugin that provides GraphQL file detection and syntax highlighting.
...
*   [Weaviate (⭐7.5k)](https://github.com/semi-technologies/weaviate) - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
*   [Saleor (⭐67)](https://github.com/mirumee/saleor/) - GraphQL-first headless e-commerce platform.
