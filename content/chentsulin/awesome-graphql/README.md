...
*   [modus (⭐360)](https://github.com/hypermodeinc/modus) - Serverless runtime based on WebAssembly that delivers auto-generated GraphQL APIs.
...
*   [gqloom (⭐39)](https://github.com/modevol-com/gqloom) - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot (⭐7.5k)](https://github.com/fabian-hiller/valibot), [Zod (⭐37k)](https://github.com/colinhacks/zod), or [Yup (⭐23k)](https://github.com/jquense/yup).

## [Aug 12, 2024](/content/2024/08/12/README.md)

### Miscellaneous / React

*   [graphql-sunset (⭐5)](https://github.com/sophiabits/graphql-sunset) - Quickly and easily add support for the `Sunset` header to your GraphQL server, to better communicate upcoming breaking changes.
...
*   [pylon (⭐272)](https://github.com/getcronit/pylon) - Write full-feature APIs with just functions. No more boilerplate code, no more setup. Just write functions and deploy.
...
*   [Bruno (⭐33k)](https://github.com/usebruno/bruno) - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.

## [Feb 25, 2024](/content/2024/02/25/README.md)

### Clients

*   [genql (⭐922)](https://github.com/remorses/genql) - Type safe TypeScript client for any GraphQL API.
...
*   [WunderGraph Cosmo (⭐917)](https://github.com/wundergraph/cosmo) - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.

### Go / React

*   [graphql-go-tools (⭐737)](https://github.com/wundergraph/graphql-go-tools) - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
*   [GraphQLer (⭐139)](https://github.com/omar2535/GraphQLer) - Dependency-aware dynamic GraphQL testing tool
...
*   [goctopus (⭐109)](https://github.com/Escape-Technologies/goctopus) - an incredibly fast GraphQL discovery & fingerprinting toolbox.
...
*   [GraphQL Cop (⭐450)](https://github.com/dolevf/graphql-cop) - Security Audit Utility for GraphQL
...
*   [gqty (⭐998)](https://github.com/gqty-dev/gqty) - A No GraphQL client for TypeScript

### Frontend Framework Integrations / React

*   [@gqty/react (⭐998)](https://github.com/gqty-dev/gqty) - A No GraphQL client for TypeScript
...
*   [graphql-armor (⭐520)](https://github.com/Escape-Technologies/graphql-armor) - An instant security layer for production GraphQL Endpoints.

### Python / React

*   [sgqlc (⭐529)](https://github.com/profusion/sgqlc) - Simple GraphQL Client makes working with GraphQL API responses easier in Python.
...
*   [EntityGraphQL (⭐434)](https://github.com/EntityGraphQL/EntityGraphQL) - library to build a GraphQL API on top of data model with the extensibility to bring multiple data sources together in the single GraphQL schema.
*   [ZeroQL (⭐296)](https://github.com/byme8/ZeroQL) - type-safe GraphQL client with Linq-like interface for C#

## [Aug 08, 2022](/content/2022/08/08/README.md)

### Python / React

*   [graphql-core (⭐516)](https://github.com/graphql-python/graphql-core) - GraphQL implementation for Python based on GraphQL.js v16.3.0 reference implementation
...
*   [GraphCrawler - The all-in-one GraphQL Security toolkit (⭐315)](https://github.com/gsmith257-cyber/GraphCrawler) - The all-in-one automated penetration tester toolkit for GraphQL, written in Python
...
*   [gqt (⭐469)](https://github.com/eerimoq/gqt) - Build and execute GraphQL queries in the terminal.
...
*   [dgs-federation-example (⭐111)](https://github.com/Netflix/dgs-federation-example) - A Netflix DGS federation example.
...
*   [Escape Graphinder - GraphQL Subdomain Enumeration (⭐215)](https://github.com/Escape-Technologies/graphinder) – Blazing fast GraphQL endpoints finder using subdomain enumeration, scripts analysis and bruteforce.
...
*   [schemathesis (⭐2.5k)](https://github.com/schemathesis/schemathesis) - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
*   [sveltekit-kitql (⭐430)](https://github.com/jycouet/kitql) - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.

## [Feb 07, 2022](/content/2022/02/07/README.md)

### Python / React

*   [turms (⭐65)](https://github.com/jhnnsrs/turms) - A pythonic graphql codegenerator built around graphql-core and pydantic
...
*   [GraphVinci (⭐76)](https://github.com/Comcast/graphvinci) - An interactive schema visualizer for GraphQL APIs.
...
*   [GraphQL over HTTP (⭐406)](https://github.com/graphql/graphql-over-http) - Working draft of "GraphQL over HTTP" specification.
...
*   [gql (⭐197)](https://github.com/deno-libs/gql) - Universal GraphQL HTTP middleware for Deno.
...
*   [graphql-java-extended-scalars (⭐272)](https://github.com/graphql-java/graphql-java-extended-scalars) - Extended scalars for graphql-java.
...
*   [ts-graphql-plugin (⭐740)](https://github.com/Quramy/ts-graphql-plugin) - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
*   [Prisma (⭐42k)](https://github.com/prisma/prisma) - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
...
*   [Next.js TypeScript and GraphQL Example (⭐131k)](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
...
*   [NAPERG (⭐1.1k)](https://github.com/alan345/naperg) - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
*   [GraphQL Starter (⭐107)](https://github.com/cerino-ligutom/GraphQL-Starter) - A boilerplate for TypeScript + Node Express + Apollo GraphQL APIs.
...
*   [agoo (⭐915)](https://github.com/ohler55/agoo) - Ruby web server that implements Facebook's GraphQL.
...
*   [agoo-demo (⭐915)](https://github.com/ohler55/agoo/tree/develop/example/graphql) - Use of the Agoo server to demonstrate a simple GraphQL application.
...
*   [overblog/graphql-bundle (⭐790)](https://github.com/overblog/GraphQLBundle) - This bundle provides tools to build a complete GraphQL server in your Symfony App. Supports react-relay.
...
*   [graphql-java-tools (⭐816)](https://github.com/graphql-java-kickstart/graphql-java-tools) - Schema-first graphql-java convenience library that makes it easy to bring your own implementations as data resolvers. Inspired by [graphql-tools (⭐5.4k)](https://github.com/apollographql/graphql-tools) for JS.
...
*   [federation-jvm (⭐262)](https://github.com/apollographql/federation-jvm) - Apollo Federation on the JVM.
...
*   [cppgraphqlgen (⭐330)](https://github.com/Microsoft/cppgraphqlgen) - C++ GraphQL schema service generator.
...
*   [caliban (⭐956)](https://github.com/ghostdogpr/caliban) - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
*   [elm-graphql (⭐782)](https://github.com/dillonkearns/elm-graphql) - GraphQL for Elm.
...
*   [GraphQL (⭐951)](https://github.com/GraphQLSwift/GraphQL) - The Swift implementation for GraphQL.
...
*   [reason-urql (⭐239)](https://github.com/FormidableLabs/reason-urql) - ReasonML binding for urql Client.
...
*   [graphql-parser (⭐360)](https://github.com/graphql-rust/graphql-parser) - A parser, formatter and AST for the GraphQL query and schema definition language for Rust.
...
*   [ghql (⭐148)](https://github.com/ropensci/ghql) - General purpose GraphQL R client.
...
*   [graphql-crystal (⭐215)](https://github.com/ziprandom/graphql-crystal) - library inspired by [graphql-ruby (⭐5.4k)](https://github.com/rmosolgo/graphql-ruby) & [go-graphql (⭐248)](https://github.com/playlyfe/go-graphql) & [graphql-parser (⭐221)](https://github.com/graphql-dotnet/parser).
...
*   [GraphQL Birdseye (⭐705)](https://github.com/Novvum/graphql-birdseye) – View any GraphQL schema as a dynamic and interactive graph.
...
*   [js-graphql-intellij-plugin (⭐889)](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
*   [vim-graphql (⭐502)](https://github.com/jparise/vim-graphql) - A Vim plugin that provides GraphQL file detection and syntax highlighting.
