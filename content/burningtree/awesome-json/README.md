...
*   [Sequence JSON (⭐141)](https://github.com/soundio/music-json/) - A proposal for a standard way of creating music sequence data in JSON.

## [May 02, 2024](/content/2024/05/02/README.md)

### Applications

*   [Visual JSON (⭐304)](https://github.com/youknowone/VisualJSON) - simple JSON pretty-viewer for Mac OS X. (inactive)

### Format Extensions

*   [NDJSON (⭐832)](https://github.com/ndjson/ndjson-spec) (Newline delimited JSON) - a standard for delimiting JSON in stream protocols.
...
*   [JsonHilo (⭐45)](https://github.com/xtao-org/jsonhilo) - Minimal lossless parse event streaming, akin to SAX.
...
*   [JSON Formatter](https://chromewebstore.google.com/detail/json-formatter/bcjindcccaagfpapjjmafapmmgkkhgoa) ([github (⭐4.1k)](https://github.com/callumlocke/json-formatter)) - Makes JSON easy to read. Open source.
*   [JSON Viewer](https://chromewebstore.google.com/detail/json-viewer/gbmdgpbipfallnflgajpaliibnhdgobh) ([github (⭐3.5k)](https://github.com/tulios/json-viewer)) - It is a Chrome extension for printing JSON and JSONP.
*   [JSON Finder](https://chromewebstore.google.com/detail/json-finder/flhdcaebggmmpnnaljiajhihdfconkbj) ([github (⭐41)](https://github.com/rapee/jsonfinder)) - Browse like you do it in Finder.
*   [JSON Viewer Pro](https://chromewebstore.google.com/detail/json-viewer-pro/eifflpmocdbdmepbjaopkkhbfmdgijcc) ([github (⭐583)](https://github.com/rbrahul/Awesome-JSON-Viewer) - An open source Chrome extension for browsing JSON with syntax highlighting and folding, or as a visual graph.
...
*   [jq (⭐35k)](https://github.com/jqlang/jq) - A lightweight and flexible command-line JSON processor.
    *   [jaq (⭐3.6k)](https://github.com/01mf02/jaq) - A jq clone focussed on correctness, speed, and simplicity. Written in Rust.
    *   [gojq (⭐3.8k)](https://github.com/itchyny/gojq) - Pure Go implementation of jq. A bit faster and more portable.
*   [livejq (⭐17)](https://github.com/kunalsin9h/livejq) - An alternative `jq` implementation in rust for continuous parsing without crashing on invalid JSON
...
*   [jc (⭐8.6k)](https://github.com/kellyjonbrazil/jc) - Converts the output of many CLI tools, file-types, and common strings into JSON
*   [logdy (⭐2.2k)](https://github.com/logdyhq/logdy-core) - jq, tail, less, grep and awk merged together and available in a clean web UI.
...
*   [J<sub>ack</sub>SON: JSON secret keeper (⭐19)](https://github.com/rosehgal/jackson) - JSONic way of storing secrets in config file.

### Frontend components

*   [@textea/json-viewer (⭐529)](https://github.com/TexteaInc/json-viewer) - A React component for JSON viewer. (React)

### Libraries

*   [Jansson (⭐3.3k)](https://github.com/akheron/jansson) - A C library for encoding, decoding and manipulating data.
...
*   [Kwalify (⭐23)](https://github.com/kvs/kwalify) - A parser, schema validator, and data binding tool
...
*   [nimnjs (⭐46)](https://github.com/NaturalIntelligence/nimnjs) - JSON to nimn bidirectional converter.
...
*   [Awesome JSON Schema (⭐168)](https://github.com/sourcemeta/awesome-jsonschema) - A curated list of awesome JSON Schema resources, tutorials, tools, and more.

### JSON Schema Validators

*   [jsonschema (⭐5k)](https://github.com/python-jsonschema/jsonschema) - Python implementation of jsonschema.
*   [Ruby JSON Schema Validator (⭐1.6k)](https://github.com/voxpupuli/json-schema) - validating against a JSON schema conforming to JSON Schema Draft 4.
...
*   [json-build (⭐50)](https://github.com/lcsmuller/json-build) - A minimalistic serializer in C. It can be easily integrated into the resource-limited projects or embedded systems.

## [Jan 15, 2022](/content/2022/01/15/README.md)

### Command-line tools

*   [dsq (⭐3.9k)](https://github.com/multiprocessio/dsq) - Tool for running SQL queries against JSON, CSV, Excel, Parquet, and more.
...
*   [nvim-jqx (⭐338)](https://github.com/gennaro-tedesco/nvim-jqx) - Browse and query json files in neovim from the quickfix window. (Lua)
...
*   [JSONAce](https://apps.apple.com/us/story/id1377753262?id=com.acrogenesis.jsonace-56Q494QF3LL) ([github (⭐71)](https://github.com/acrogenesis/JSONAce)) - Formats & syntax highlights JSON viewed inside of the web browser using the ACE editor.
...
*   [jsonapi-consumer (⭐7)](https://github.com/OKTAYKIR/jsonapi-consumer) - Client framework for consuming JSONAPI based APIs on the [JSON API standard](https://jsonapi.org).
...
*   [AXON (⭐24)](https://github.com/intellimath/pyaxon) - A simple text based format for interchanging of objects, documents and data. It tries to combine the best of JSON, XML and YAML.
...
*   [dasel (⭐8k)](https://github.com/tomwright/dasel) - Query and update data structures using selectors from the command line. Comparable to [jq (⭐35k)](https://github.com/jqlang/jq) / [yq (⭐3k)](https://github.com/kislyuk/yq) but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
*   [ajv (⭐15k)](https://github.com/ajv-validator/ajv) - The fastest schema validator. Supports draft-04/06/07/2019-09/2020-12.
...
*   [ngx-formly (⭐3k)](https://github.com/ngx-formly/ngx-formly) - JSON powered / Dynamic forms for Angular

## [Nov 01, 2020](/content/2020/11/01/README.md)

### Command-line tools

*   [visidata (⭐9.1k)](https://github.com/saulpw/visidata) - A terminal spreadsheet-like tool for interactively exploring data.

## [Oct 07, 2020](/content/2020/10/07/README.md)

### Command-line tools

*   [jo (⭐4.9k)](https://github.com/jpmens/jo) - A small utility to create JSON objects
...
*   [simdjson (⭐24k)](https://github.com/simdjson/simdjson) - Parsing gigabytes of JSON per second.

## [Jun 23, 2020](/content/2020/06/23/README.md)

### Command-line tools

*   [oj (⭐948)](https://github.com/ohler55/ojg) - A fast and flexible command line JSON processor.
...
*   [ojc (⭐37)](https://github.com/ohler55/ojc) - A fast JSON parser.
*   [ojg (⭐948)](https://github.com/ohler55/ojg) - A collection of high performance JSON processing and generating tool.

## [Apr 15, 2020](/content/2020/04/15/README.md)

### Libraries

*   [Nlohmann JSON (⭐50k)](https://github.com/nlohmann/json) - A C++11 header-only class.

## [Feb 10, 2020](/content/2020/02/10/README.md)

### JSON Schema Validators

*   [Medeia Validator (⭐60)](https://github.com/worldturner/medeia-validator) - Compliant (draft-04/06/07) and fast streaming validator written in Kotlin

## [Dec 29, 2019](/content/2019/12/29/README.md)

### Libraries

*   [essential-json (⭐25)](https://github.com/arkanovicz/essential-json) - A lightweight Java library for serialization, parsing and manipulation with a clean and precise API.
*   [dsl-json (⭐1.1k)](https://github.com/ngs-doo/dsl-json) - A very fast streaming JSON library. Operates on byte arrays.
*   [mjson (⭐93)](https://github.com/bolerio/mjson) - Lean JSON Library for Java, with a compact, elegant API.

### Testing

*   [JSON Parsing Test Suite (⭐1.1k)](https://github.com/nst/JSONTestSuite) - A very complete test suite and validation framework.
...
*   [json-dotenv (⭐9)](https://github.com/decryptus/json-dotenv) - Manipulate and extract envfiles in json format.
...
*   [EJDB (⭐1.5k)](https://github.com/Softmotions/ejdb) - Embedded JSON Database engine published under MIT license. (C)
...
*   [x2js (⭐1k)](https://github.com/abdolence/x2js) - XML to JSON and vice versa javascript conversion functions. (Javascript)
...
*   [JSON Schema $Ref Parser (⭐1.1k)](https://github.com/APIDevTools/json-schema-ref-parser) - Parse, resolve, and dereference JSON Schema $ref pointers
...
*   [fx (⭐21k)](https://github.com/antonmedv/fx) - A interactive terminal tool.
...
*   [Awesome jq (⭐965)](https://github.com/fiatjaf/awesome-jq) - A curated list of awesome jq tools and resources.
...
*   [RapidJSON (⭐15k)](https://github.com/Tencent/rapidjson) - A fast JSON parser/generator for C++ with both SAX/DOM style API
...
*   [HOCON (⭐6.3k)](https://github.com/lightbend/config/blob/master/HOCON.md) - Human-Optimized Config Object Notation.
...
*   [Type-o-rama (⭐247)](https://github.com/stereobooster/type-o-rama) - JS type systems interportability, comparison of different JS type systems and conversion between them.

### Transformations

*   [fast-xml-parser (⭐3.1k)](https://github.com/NaturalIntelligence/fast-xml-parser) - Fast XML to JSON and vice versa javascript/JSON conversion.

## [Feb 22, 2018](/content/2018/02/22/README.md)

### Transformations

*   [Sawmill (⭐123)](https://github.com/logzio/sawmill) - JSON transformation library (Java)

## [Jan 21, 2018](/content/2018/01/21/README.md)

### Libraries

*   [jsoniter-scala (⭐817)](https://github.com/plokhotnyuk/jsoniter-scala) - Scala macros for compile-time generation of ultra-fast JSON codecs.
...
*   [RxDB (⭐23k)](https://github.com/pubkey/rxdb) - Event-driven JSON-Database with JSON-Schema, mango-Query and CouchDB-sync. (Javascript)

### Format Extensions

*   [JSON-LD](https://json-ld.org/) - A lightweight Linked Data format.
*   [JSON6 (⭐240)](https://github.com/d3x0r/json6) - JSON for Humans (ES6).
...
*   [JSONProxy (⭐301)](https://github.com/afeld/jsonp) - Simple HTTP proxy that enables cross-domain requests to any JSON API.

### Transformations

*   [JSON-populate (⭐159)](https://github.com/eiriklv/json-populate) - Tool for populating JSON data with infinitely recursive circular references. Sort of like Falcor, but for plain JSON.
*   [CircularJSON (⭐608)](https://github.com/WebReflection/circular-json) - JSON does not handle circular references. Now it does.

## [Jun 30, 2017](/content/2017/06/30/README.md)

### Command-line tools

*   [jiq (⭐935)](https://github.com/fiatjaf/jiq) - It's `jid` with `jq`. You can drill down interactively by using `jq` filtering queries.
*   [jv (⭐121)](https://github.com/maxzender/jv) - jv (for jsonviewer) helps you view your JSON.
...
*   [TOML (⭐21k)](https://github.com/toml-lang/toml) - A minimal configuration file format that's easy to read due to obvious semantics.
*   [HCL (⭐5.8k)](https://github.com/hashicorp/hcl) - A structured configuration language that is both human and machine friendly.

## [Feb 21, 2017](/content/2017/02/21/README.md)

### Command-line tools

*   [jid (⭐7.1k)](https://github.com/simeji/jid) - Incremental Digger. Drill down JSON interactively by using filtering queries like jq.

### Databases

*   [JSONlite (⭐845)](https://github.com/nodesocket/jsonlite) - A simple, self-contained, serverless, zero-configuration, json document store. (Bash)

### Libraries

*   [aeson-qq (⭐79)](https://github.com/sol/aeson-qq) - JSON quasiquoter for Haskell.
*   [json2react (⭐173)](https://github.com/txgruppi/json2react) - Use JSON to create React Stateless Components.
...
*   [gron (⭐14k)](https://github.com/tomnomnom/gron) - Convert a JSON file into discrete assignments that are greppable.
...
*   [JSON-Fortran (⭐377)](https://github.com/jacobwilliams/json-fortran) - A Fortran library for writing, reading, and manipulating JSON files and data structures.
...
*   [Orderly JSON (⭐227)](https://github.com/lloyd/orderly) - A textual format for describing JSON compiled into JSONSchema.

## [Jul 10, 2016](/content/2016/07/10/README.md)

### Transformations

*   [json-transforms (⭐146)](https://github.com/ColinEberhardt/json-transforms) - A recursive, pattern-matching, approach to transforming JSON structures.
...
*   [MultiJSON (⭐765)](https://github.com/intridea/multi_json) - A generic swappable back-end for JSON handling.

### Transformations

*   [JsonMapper (⭐1.6k)](https://github.com/cweiske/jsonmapper) - Map nested structures onto PHP classes (PHP)
...
*   [JSON-java (⭐4.7k)](https://github.com/stleary/JSON-java) - A reference implementation.
...
*   [PL/JSON (⭐461)](https://github.com/pljson/pljson) - A generic JSON object written in PL/SQL.

## [Jan 20, 2016](/content/2016/01/20/README.md)

### Databases

*   [Kinto (⭐4.4k)](https://github.com/Kinto/kinto) - A lightweight JSON storage service with synchronisation and sharing abilities.
...
*   [Gson (⭐24k)](https://github.com/google/gson) - A Java library to convert JSON to Java objects and vice-versa.

### JSON Schema Tools

*   [JSON Schema + Faker (⭐3.4k)](https://github.com/json-schema-faker/json-schema-faker) - Fake your schemas.

## [May 07, 2015](/content/2015/05/07/README.md)

### Databases

*   [JSON Server (⭐76k)](https://github.com/typicode/json-server) - Get a full fake REST API with zero coding in less than 30 seconds.
...
*   [HanSON (⭐157)](https://github.com/timjansen/hanson) - JSON for Humans - with unquoted identifiers, multi-line strings and comments.

### Related formats

*   [CSON (⭐1.3k)](https://github.com/bevry/cson) - CoffeeScript-Object-Notation. JSON for CoffeeScript objects.
*   [MSON (⭐899)](https://github.com/apiaryio/mson) - Markdown syntax compatible with describing JSON and JSON Schema.
...
*   [DLL.js (⭐68)](https://github.com/moll/js-ddl) - Gets you a JSON Schema from PostgreSQL or SQLite3.
...
*   [PSON (⭐464)](https://github.com/dcodeIO/PSON) - Protocol JSON, super efficient binary serialization format.

## [Apr 10, 2015](/content/2015/04/10/README.md)

### Data generation

*   [dyson (⭐834)](https://github.com/webpro/dyson) - Server for dynamic, fake JSON. (node.js)

### Libraries

*   [moshi (⭐10k)](https://github.com/square/moshi) - A modern JSON library for Android and Java.
...
*   [Docson (⭐497)](https://github.com/lbovet/docson) - Documentation for your types.
...
*   [μson (⭐79)](https://github.com/burningtree/uson) (uson) - a shorthand for JSON.
...
*   [lowdb (⭐23k)](https://github.com/typicode/lowdb) - Flat file database built on lodash API. (Javascript)
...
*   [dffptch (⭐171)](https://github.com/paldepind/dffptch) - A micro library for diffing and patching using a compact diff format. (Javascript)
*   [jsondiffpatch (⭐5.3k)](https://github.com/benjamine/jsondiffpatch) - Diff & patch for JavaScript objects. (Javascript)
...
*   [JSON-stat (⭐26)](https://github.com/jsonstat/jsonstat) - Simple lightweight format for data dissemination.
...
*   [JSON Reformat (⭐175)](https://github.com/gongo/json-reformat) - Reformat tool.

### Transformations

*   [json2json (⭐192)](https://github.com/joelvh/json2json) - Transform (reformat) structures from one to another. (Javascript)

### Queries

*   [searchjs (⭐310)](https://github.com/deitch/searchjs) - A library for filtering based on a json SQL-like language.

### JSON Schema Tools

*   [prmd (⭐2.1k)](https://github.com/interagent/prmd) - Tools and doc generation for HTTP APIs.
*   [jsonschema2pojo (⭐6.4k)](https://github.com/joelittlejohn/jsonschema2pojo) - Generates Java types and annotates those types for data-binding with Jackson 1.x or 2.x, Gson, etc.
*   [Matic (⭐180)](https://github.com/mattyod/matic) - Build tool for generating HTML documentation.

## [Mar 28, 2015](/content/2015/03/28/README.md)

### Browser Extensions

*   [JSONView](https://addons.mozilla.org/en-US/firefox/addon/jsonview/) ([github (⭐1.7k)](https://github.com/bhollis/jsonview)) - View JSON documents in the browser.

### Datasets

*   [countries (⭐6.2k)](https://github.com/mledoze/countries) - World countries.

### Differencing

*   [JSON-Patch (⭐2k)](https://github.com/Starcounter-Jack/JSON-Patch) - Lean and mean Javascript implementation of the JSON-Patch standard (RFC 6902). (Javascript)
*   [jiff (⭐641)](https://github.com/cujojs/jiff) - JSON Patch and diff based on rfc6902. (Javascript)
*   [json-patch-php (⭐112)](https://github.com/mikemccabe/json-patch-php) - implementation of JSON-patch (IETF RFC 6902) (PHP)
...
*   [JSON editor jQuery plugin (⭐565)](https://github.com/DavidDurman/FlexiJsonEditor) - component for you web apps/pages. (jQuery)
*   [jqTree](http://mbraak.github.io/jqTree/) - Widget for displaying a tree structure in html. (jQuery)

### Libraries

*   [ArduinoJson (⭐7.2k)](https://github.com/bblanchon/ArduinoJson) - An efficient library for embedded systems.
*   [JSON++ (⭐41)](https://github.com/tunnuz/json) - A self contained Flex/Bison parser for C++11.
*   [json11 (⭐2.6k)](https://github.com/dropbox/json11) - A tiny library for C++11.
...
*   [Webmozart JSON (⭐352)](https://github.com/webmozart/json) - A robust decoder/encoder with support for schema validation.
*   [simplejson (⭐1.7k)](https://github.com/simplejson/simplejson) - A simple, fast, extensible encoder/decoder
*   [jsonpickle](http://jsonpickle.github.io/) - Library for serializing any arbitrary object graph.
*   [oj (⭐3.2k)](https://github.com/ohler55/oj) - A fast JSON parser and Object marshaller as a Ruby gem.
*   [jsonfx (⭐379)](https://github.com/jsonfx/jsonfx) - serialization framework for .NET.
*   [spray-json (⭐972)](https://github.com/spray/spray-json) - A lightweight, clean and simple implementation in Scala.
*   [SwiftyJSON (⭐23k)](https://github.com/SwiftyJSON/SwiftyJSON) - The better way to deal with data in Swift.

### Linters

*   [jsonlint (⭐2k)](https://github.com/zaach/jsonlint) - Parser and validator with a CLI. (Javascript)
...
*   [JSONassert (⭐1.1k)](https://github.com/skyscreamer/JSONassert) - Write JSON unit tests in less code. Great for testing REST interfaces. (Java)
*   [JsonUnit (⭐997)](https://github.com/lukas-krecan/JsonUnit) - A library that simplifies JSON comparison in unit tests. It's strongly inspired by XmlUnit.
...
*   [osmtogeojson (⭐748)](https://github.com/tyrasd/osmtogeojson) - Converts OSM data to GeoJSON. (Javascript)
*   [JSONC (⭐652)](https://github.com/tcorral/JSONC) - JSON compressor and decompressor. (Javascript)
...
*   [JSON Mask (⭐870)](https://github.com/nemtsov/json-mask) - Tiny language and engine for selecting specific parts of a JS object, hiding the rest. (Javascript)

### JSON Schema Tools

*   [generate-schema (⭐1.1k)](https://github.com/Nijikokun/generate-schema) - Effortlessly convert your JSON Object to JSON Schema, Mongoose Schema, or a Generic template for quick documentation / upstart.

### JSON Schema Validators

*   [json-schema-benchmark (⭐387)](https://github.com/ebdrup/json-schema-benchmark) - Performance benchmark for Node.js validators.
*   [is-my-json-valid (⭐965)](https://github.com/mafintosh/is-my-json-valid) - A validator that uses code generation to be extremely fast.
*   [jsen (⭐155)](https://github.com/bugventure/jsen) - A validator built for speed.
...
*   [z-schema (⭐345)](https://github.com/zaggino/z-schema) - validator written in JavaScript for NodeJS and Browsers.
*   [jjv (⭐200)](https://github.com/acornejo/jjv) - Javascript Library for Schema Validation.
...
*   [JSON Schema for PHP (⭐3.6k)](https://github.com/justinrainbow/json-schema) - PHP implementation of JSON schema.