...
See also [A comparison of operating systems written in Rust (⭐784)](https://github.com/flosse/rust-os-comparison).
...
[Rust Embedded](https://rust-embedded.org/) focuses on improving the end-to-end experience of using Rust in resource-constrained environments and non-traditional platforms. See [awesome-embedded-rust (⭐7.2k)](https://github.com/rust-embedded/awesome-embedded-rust) for a curated, and more extended list of embedded Rust resources.
...
*   [zonyitoo/coio-rs (⭐462)](https://github.com/zonyitoo/coio-rs) - A coroutine I/O library with a working-stealing scheduler
...
See also [Are we web yet?](https://www.arewewebyet.org) and [Rust web framework comparison (⭐5.5k)](https://github.com/flosse/rust-web-framework-comparison).
