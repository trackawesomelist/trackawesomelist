...
[🏠 Home](/README.md) · [🔥 Feed](https://www.trackawesomelist.com/rust-unofficial/awesome-rust/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 rust-unofficial/awesome-rust](https://github.com/rust-unofficial/awesome-rust) · ⭐ 48K · 🏷️ Programming Languages
...
See also [A comparison of operating systems written in Rust (⭐724)](https://github.com/flosse/rust-os-comparison).
...
[Rust Embedded](https://rust-embedded.org/) focuses on improving the end-to-end experience of using Rust in resource-constrained environments and non-traditional platforms. See [awesome-embedded-rust (⭐6.5k)](https://github.com/rust-embedded/awesome-embedded-rust) for a curated, and more extended list of embedded Rust resources.
...
*   [zonyitoo/coio-rs (⭐459)](https://github.com/zonyitoo/coio-rs) - A coroutine I/O library with a working-stealing scheduler
...
See also [Are we web yet?](https://www.arewewebyet.org) and [Rust web framework comparison (⭐5.2k)](https://github.com/flosse/rust-web-framework-comparison).
