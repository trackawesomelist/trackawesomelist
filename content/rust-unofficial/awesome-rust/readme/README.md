...
See also [A comparison of operating systems written in Rust (⭐680)](https://github.com/flosse/rust-os-comparison).
...
[Rust Embedded](https://rust-embedded.org/) focuses on improving the end-to-end experience of using Rust in resource-constrained environments and non-traditional platforms. See [awesome-embedded-rust (⭐6k)](https://github.com/rust-embedded/awesome-embedded-rust) for a curated, and more extended list of embedded Rust resources.
