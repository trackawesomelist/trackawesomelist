...
[🏠 Home](/README.md) · [🔍 Search](https://www.trackawesomelist.com/search/) · [🔥 Feed](https://www.trackawesomelist.com/rothgar/awesome-tmux/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 rothgar/awesome-tmux](https://github.com/rothgar/awesome-tmux) · ⭐ 5.9K · 🏷️ Development Environment
...
*   [catppuccin (⭐297)](https://github.com/catppuccin/tmux) Catppuccin `Latte`, `Frappe`, `Macchiato`, and `Mocha` themes for tmux.
*   [tmux-tokyo-night (⭐26)](https://github.com/fabioluciano/tmux-tokyo-night) A vim inspired tokyo night theme

## [May 15, 2023](/content/2023/05/15/README.md)

### Themes

*   [tmux-dark-notify (⭐8)](https://github.com/erikw/tmux-dark-notify) - Make tmux's theme follow macOS dark/light mode.
...
*   [tmux-nerd-font-window-name (⭐45)](https://github.com/joshmedeski/tmux-nerd-font-window-name) Nerd Font icons for your tmux windows

## [Mar 02, 2023](/content/2023/03/02/README.md)

### Tools and session management

*   [t (⭐108)](https://github.com/joshmedeski/t-smart-tmux-session-manager) The smart tmux session manager
...
*   [tokyo-night-tmux (⭐82)](https://github.com/janoamaral/tokyo-night-tmux) tokyo-night theme for tmux
...
*   [tmux-fzf-session-switch (⭐20)](https://github.com/thuanOwa/tmux-fzf-session-switch) Easy way to switch, when you have a ton of sessions.
...
*   [tmux-session-wizard (⭐58)](https://github.com/27medkamal/tmux-session-wizard) One prefix to control all your session creation, naming, switching, etc using [fzf (⭐53k)](https://github.com/junegunn/fzf) & [zoxide (⭐11k)](https://github.com/ajeetdsouza/zoxide).
...
*   [tmux-menus (⭐165)](https://github.com/jaclu/tmux-menus) - Popup menus to help with managing your environment.
...
*   [tmux-window-name (⭐115)](https://github.com/ofirgall/tmux-window-name) Names your tmux windows smartly.
...
*   [tmux-modal (⭐123)](https://github.com/whame/tmux-modal) - Execute complex tmux commands in just a few keystrokes with a modal mode that is designed to be efficient, easy to remember and comfortable.
...
*   [tmux-cpu (⭐348)](https://github.com/tmux-plugins/tmux-cpu) Show CPU load with easy icons
...
*   [tmux-gruvbox (⭐394)](https://github.com/egel/tmux-gruvbox) Light and dark tmux theme
...
*   [tmux-pomodoro-plus (⭐132)](https://github.com/olimorris/tmux-pomodoro-plus) Incorporate the Pomodoro technique into your tmux workflow

## [Oct 07, 2021](/content/2021/10/07/README.md)

### Miscellaneous / Development and testing

*   [sixel-tmux (⭐412)](https://github.com/csdvrx/sixel-tmux) a fork of tmux, with just one goal: having the most reliable support of graphics
...
*   [tmux-nova (⭐105)](https://github.com/o0th/tmux-nova) Fully customizable tmux theme
...
*   [tmux-mode-indicator (⭐67)](https://github.com/MunifTanjim/tmux-mode-indicator) Displays prompt indicating currently active Tmux mode.
...
*   [tmux-wormhole (⭐64)](https://github.com/gcla/tmux-wormhole) Use tmux to download files with magic wormhole
...
*   [libtmux (⭐879)](https://github.com/tmux-python/libtmux) Python API for tmux
...
*   [smug (⭐509)](https://github.com/ivaaaan/smug) A session manager for tmux written in Go

## [Nov 23, 2020](/content/2020/11/23/README.md)

### Themes

*   [dracula/tmux (⭐460)](https://github.com/dracula/tmux) 🧛🏻‍♂️ The official [dracula theme](https://draculatheme.com/) for tmux

## [Nov 16, 2020](/content/2020/11/16/README.md)

### Plugins

*   [tmux-bitwarden (⭐25)](https://github.com/Alkindi42/tmux-bitwarden) Access your Bitwarden login items in a tmux pane.
...
*   [nord tmux (⭐945)](https://github.com/arcticicestudio/nord-tmux) An arctic, north-bluish clean and elegant tmux color theme.

## [Jun 24, 2020](/content/2020/06/24/README.md)

### Tools and session management

*   [dmux (⭐259)](https://github.com/zdcthomas/dmux) Configurable tmux workspace manager written in Rust

## [Jun 14, 2020](/content/2020/06/14/README.md)

### Themes

*   [tmux-power (⭐359)](https://github.com/wfxr/tmux-power) 8 powerline style themes for tmux, easily to expand.

### Plugins

*   [tmux-fzf-url (⭐388)](https://github.com/wfxr/tmux-fzf-url) For opening urls from browser quickly without mouse.
...
*   [tmux-tilish (⭐316)](https://github.com/jabirali/tmux-tilish) Turn tmux into a dynamic window manager with intuitive keybindings (inspired by i3wm/sway)
...
*   [tmux-thumbs (⭐704)](https://github.com/fcsonline/tmux-thumbs) A lightning fast version of tmux-fingers written in Rust, copy/pasting tmux like vimium/vimperator

## [Feb 20, 2020](/content/2020/02/20/README.md)

### Plugins

*   [tmux-jump (⭐254)](https://github.com/schasse/tmux-jump) Vimium/Easymotion like navigation for tmux.

## [Jan 06, 2020](/content/2020/01/06/README.md)

### Status Bar

*   [gitmux (⭐426)](https://github.com/arl/gitmux) Show Git status in tmux status bar

### Plugins

*   [tmux-spotify (⭐84)](https://github.com/xamut/tmux-spotify) Show a nice menu to manage Spotify application
...
*   [tmux-network-bandwidth (⭐63)](https://github.com/xamut/tmux-network-bandwidth) Show
    network bandwidth
*   [tmux-weather (⭐44)](https://github.com/xamut/tmux-weather) Show current weather using wttr.in

## [Mar 06, 2019](/content/2019/03/06/README.md)

### Plugins

*   [extrakto (⭐700)](https://github.com/laktak/extrakto) tmux clipboard copy and output completions
...
*   [tmux-battery (⭐425)](https://github.com/tmux-plugins/tmux-battery) Plug and play battery percentage and icon indicator for Tmux.
...
*   [tmux-mem-cpu-load (⭐928)](https://github.com/thewtex/tmux-mem-cpu-load) CPU, RAM memory, and load monitor for use with tmux
...
*   [tmux-prefix-highlight (⭐467)](https://github.com/tmux-plugins/tmux-prefix-highlight) Plugin that highlights when you press tmux prefix key

## [Dec 18, 2018](/content/2018/12/18/README.md)

### Themes

*   [tmux-base16-statusline (⭐26)](https://github.com/jatap/tmux-base16-statusline) Statusline based on [base16-shell (⭐63)](https://github.com/chriskempson/base16-shell)
...
*   [tmux-1password (⭐233)](https://github.com/yardnsm/tmux-1password) Access your 1Password login items in a tmux pane.

## [Jan 17, 2017](/content/2017/01/17/README.md)

### Plugins

*   [tmux-better-mouse-mode (⭐842)](https://github.com/NHDaly/tmux-better-mouse-mode) A tmux plugin to better manage and configure the mouse.
...
*   [tmux-fingers (⭐751)](https://github.com/Morantron/tmux-fingers) copy pasting in terminal with vimium/vimperator like hints.
...
*   [tmuxifier (⭐981)](https://github.com/jimeh/tmuxifier) Tmuxify your Tmux. Powerful session, window & pane management for Tmux.
...
*   [tmux-plugins](https://github.com/tmux-plugins) Official tmux plugins
    ...
    *   [tmux-fpp (⭐271)](https://github.com/tmux-plugins/tmux-fpp) Quickly open any path on your terminal window in your $EDITOR of choice!
    *   [tmux-logging (⭐919)](https://github.com/tmux-plugins/tmux-logging) Easy logging and screen capturing for Tmux.
    *   [tmux-open (⭐550)](https://github.com/tmux-plugins/tmux-open) Tmux key bindings for quick opening of a highlighted file or url
    *   [tmux-pain-control (⭐641)](https://github.com/tmux-plugins/tmux-pain-control) standard pane key-bindings for tmux
    ...
    *   [tmux-sidebar (⭐470)](https://github.com/tmux-plugins/tmux-sidebar) A sidebar with the directory tree for the current path. Tries to make tmux more IDE like.
    *   [tmux-tpm (⭐9.6k)](https://github.com/tmux-plugins/tpm) Tmux Plugin Manager
    *   [tmux-urlview (⭐236)](https://github.com/tmux-plugins/tmux-urlview) Quickly open any url on your terminal window! (No commits since 2016, see tmux-urlscan or tmux-fzf-url for a maintained alternative.)
