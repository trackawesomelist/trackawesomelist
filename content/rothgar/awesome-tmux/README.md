...
[🏠 Home](/README.md) · [🔍 Search](https://www.trackawesomelist.com/search/) · [🔥 Feed](https://www.trackawesomelist.com/rothgar/awesome-tmux/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 rothgar/awesome-tmux](https://github.com/rothgar/awesome-tmux) · ⭐ 9.7K · 🏷️ Development Environment
...
*   [tmux-grip (⭐0)](https://github.com/leohenon/tmux-grip) Pin tmux sessions to fixed numbered slots with direct key jumps and a popup manager
...
*   [cole-tmux (⭐3)](https://github.com/thekylehuang/cole-tmux) Stationery-inspired minimal theme displayed in vintage earth tones

### Status Bar

*   [tmux-session-dots (⭐18)](https://github.com/jtmcginty/tmux-session-dots) Visual session indicator showing all sessions as dots with the current session highlighted.

### Plugins

*   [tmux-agent-indicator (⭐32)](https://github.com/accessd/tmux-agent-indicator) Track AI agent state (Claude, Codex, etc.) with pane borders, background colors, window titles, and status bar icons.
*   [tmux-claude-sessions (⭐6)](https://github.com/aomerk/tmux-claude-sessions) Browse and resume Claude AI conversations from a fzf popup

## [Feb 08, 2026](/content/2026/02/08/README.md)

### Tools and session management

*   [ccb (⭐2k)](https://github.com/bfly123/claude_code_bridge) A CLI tool to orchestrate multiple LLMs (Claude, Gemini, etc.) in tmux panes with cross-agent interaction
*   [tmux-canvas (⭐6)](https://github.com/juancruzfl/tmux-canvas) Create, save, and automate session layouts using executable shell script blueprints.
*   [tmux-lazy-restore (⭐42)](https://github.com/bcampolo/tmux-lazy-restore) A session manager that allows sessions to be lazily restored in order to save memory and CPU cycles.
...
*   [tmux-powerkit (⭐498)](https://github.com/fabioluciano/tmux-powerkit) A tmux framework to create and distribute plugins and themes - Already have 36+ plugins, and 2 themes.
...
*   [tmux-speedtest (⭐4)](https://github.com/YousefHadder/tmux-speedtest) Run internet speed tests and display results in your status bar.

### Plugins

*   [nunchux (⭐62)](https://github.com/datamadsen/nunchux) A fuzzy launcher for apps, files, and build tasks with live status, keyboard shortcuts, and task runner integration.
*   [tmux-llm (⭐10)](https://github.com/hynek-urban/tmux-llm) Get quick responses to your terminal contents from LLM assistants.
...
*   [tmux-oasis (⭐45)](https://github.com/uhs-robert/tmux-oasis): Desert theme pack with 12 variants for every color of the rainbow and a dynamic statusline for all tmux modes.
...
*   [tmux-grimoire (⭐106)](https://github.com/navahas/tmux-grimoire) - Customizable popup shells (aka shpells) driven by custom scripts.
...
*   [tmux-pane-focus (⭐21)](https://github.com/graemedavidson/tmux-pane-focus) Auto-Resizing splits to improve readability.
...
*   [tmux-tpad (⭐28)](https://github.com/Subbeh/tmux-tpad) A popup window session manager.

## [Jun 09, 2025](/content/2025/06/09/README.md)

### Configuration

*   [mooks (⭐17)](https://github.com/TomhetArkitektur/mooks) A minimal tmux configuration framework designed for well-structured modular setups

## [Apr 29, 2025](/content/2025/04/29/README.md)

### Miscellaneous / Development and testing

*   [tmuxai (⭐1.7k)](https://github.com/alvinunreal/tmuxai) AI-Powered, Non-Intrusive Terminal Assistant
...
*   [tmux-kubectx (⭐8)](https://github.com/tony-sol/tmux-kubectx) Show kubernetes context in statusbar

## [Feb 06, 2025](/content/2025/02/06/README.md)

### Tools and session management

*   [mynav (⭐229)](https://github.com/GianlucaP106/mynav) Workspace and session management TUI built on tmux

## [Jan 10, 2025](/content/2025/01/10/README.md)

### Plugins

*   [tmux-fzf-open-files-nvim (⭐12)](https://github.com/Peter-McKinney/tmux-fzf-open-files-nvim) - A plugin that parses pane text for files for selection in fzf to open in neovim.
...
*   [tmux-command-palette (⭐33)](https://github.com/lost-melody/tmux-command-palette) Search for keybindings and custom commands with fzf.

## [Nov 12, 2024](/content/2024/11/12/README.md)

### Plugins

*   [tmux-easymotion (⭐44)](https://github.com/ddzero2c/tmux-easymotion) EasyMotion-like plugin with pane jumping capabilities in tmux.
...
*   [tmux-tea (⭐79)](https://github.com/2KAbhishek/tmux-tea) Session manager with previews, integrations with tmuxinator, fzf, neovim and more.
...
*   [harpoon (⭐71)](https://github.com/Chaitanyabsprip/tmux-harpoon) A tool to bookmark sessions and jump between them in a flash. Like ThePrimeagen/harpoon, but for tmux.

### Status Bar

*   [muxbar (⭐38)](https://github.com/dlurak/muxbar) configure the status bar in Rust.
...
*   [tome (⭐158)](https://github.com/laktak/tome) 🔁 Playbooks for tmux & vim, replacing your shell history
...
*   [rose-pine (⭐259)](https://github.com/rose-pine/tmux) - Soho vibes for tmux
*   [tmux-kanagawa (⭐132)](https://github.com/Nybkox/tmux-kanagawa): Dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
...
*   [tmux2k (⭐390)](https://github.com/2KAbhishek/tmux2k) Highly customizable tmux status bar framework, providing you with a sleek and informative status bar.
...
*   [tmux-tilit (⭐76)](https://github.com/2KAbhishek/tmux-tilit) Brings tiling window manager features and intuitive keybindings to your tmux workflow.
...
*   [tmux-notify (⭐241)](https://github.com/rickstaa/tmux-notify) A plugin to notify you when processes are finished.
...
*   [catppuccin (⭐2.9k)](https://github.com/catppuccin/tmux) Catppuccin `Latte`, `Frappe`, `Macchiato`, and `Mocha` themes for tmux.
...
*   [tmux-project (⭐7)](https://github.com/sei40kr/tmux-project) Search projects and open them in a new session
...
*   [twm (⭐57)](https://github.com/vinnymeller/twm) A highly configurable workspace manager that is easy to extend with shell scripts, written in Rust

## [Mar 03, 2023](/content/2023/03/03/README.md)

### Status Bar

*   [tmux-nerd-font-window-name (⭐209)](https://github.com/joshmedeski/tmux-nerd-font-window-name) Nerd Font icons for your tmux windows

## [Mar 02, 2023](/content/2023/03/02/README.md)

### Tools and session management

*   [t (⭐350)](https://github.com/joshmedeski/t-smart-tmux-session-manager) The smart tmux session manager
...
*   [tokyo-night-tmux (⭐544)](https://github.com/janoamaral/tokyo-night-tmux) tokyo-night theme for tmux
...
*   [tmux-fzf-session-switch (⭐89)](https://github.com/thuanOwa/tmux-fzf-session-switch) Easy way to switch, when you have a ton of sessions.
...
*   [tmux-session-wizard (⭐253)](https://github.com/27medkamal/tmux-session-wizard) One prefix to control all your session creation, naming, switching, etc using [fzf (⭐79k)](https://github.com/junegunn/fzf) & [zoxide (⭐35k)](https://github.com/ajeetdsouza/zoxide).
...
*   [tmux-menus (⭐480)](https://github.com/jaclu/tmux-menus) - Popup menus to help with managing your environment.
...
*   [tmux-window-name (⭐276)](https://github.com/ofirgall/tmux-window-name) Names your tmux windows smartly.
...
*   [tmux-modal (⭐214)](https://github.com/whame/tmux-modal) - Execute complex tmux commands in just a few keystrokes with a modal mode that is designed to be efficient, easy to remember and comfortable.
...
*   [tmux-cpu (⭐514)](https://github.com/tmux-plugins/tmux-cpu) Show CPU load with easy icons
...
*   [tmux-mouse-swipe (⭐21)](https://github.com/jaclu/tmux-mouse-swipe) - Switch Window or Session by clicking right mouse button and swiping.

## [Dec 06, 2021](/content/2021/12/06/README.md)

### Themes

*   [tmux-gruvbox (⭐671)](https://github.com/egel/tmux-gruvbox) Light and dark tmux theme

## [Nov 27, 2021](/content/2021/11/27/README.md)

### Plugins

*   [tmux-super-fingers (⭐102)](https://github.com/artemave/tmux_super_fingers) like fingers, but also opens files in vim.

## [Nov 16, 2021](/content/2021/11/16/README.md)

### Status Bar

*   [tmux-pomodoro-plus (⭐450)](https://github.com/olimorris/tmux-pomodoro-plus) Incorporate the Pomodoro technique into your tmux workflow

## [Oct 07, 2021](/content/2021/10/07/README.md)

### Miscellaneous / Development and testing

*   [sixel-tmux (⭐510)](https://github.com/csdvrx/sixel-tmux) a fork of tmux, with just one goal: having the most reliable support of graphics

## [Sep 17, 2021](/content/2021/09/17/README.md)

### Tools and session management

*   [automux (⭐14)](https://github.com/sriramkandukuri/automux) Wrappers to tmux commands, useful for tmux based automation
...
*   [tmuxake (⭐13)](https://github.com/nkh/tmuxake) A side-pane manager for tmux

## [Aug 11, 2021](/content/2021/08/11/README.md)

### Plugins

*   [muxile (⭐169)](https://github.com/bjesus/muxile) - View and control your tmux session from your mobile.
...
*   [tmux-fuzzback (⭐176)](https://github.com/roosta/tmux-fuzzback) Search your scrollback buffer using fzf.

## [Jul 21, 2021](/content/2021/07/21/README.md)

### Themes

*   [tmux-nova (⭐206)](https://github.com/o0th/tmux-nova) Fully customizable tmux theme
...
*   [tmux-mode-indicator (⭐192)](https://github.com/MunifTanjim/tmux-mode-indicator) Displays prompt indicating currently active Tmux mode.
...
*   [tmux-wormhole (⭐119)](https://github.com/gcla/tmux-wormhole) Use tmux to download files with magic wormhole
...
*   [smug (⭐874)](https://github.com/ivaaaan/smug) A session manager for tmux written in Go

## [Nov 23, 2020](/content/2020/11/23/README.md)

### Themes

*   [dracula/tmux (⭐813)](https://github.com/dracula/tmux) 🧛🏻‍♂️ The official [dracula theme](https://draculatheme.com/) for tmux

## [Nov 16, 2020](/content/2020/11/16/README.md)

### Plugins

*   [tmux-bitwarden (⭐49)](https://github.com/Alkindi42/tmux-bitwarden) Access your Bitwarden login items in a tmux pane.
...
*   [dmux (⭐367)](https://github.com/zdcthomas/dmux) Configurable tmux workspace manager written in Rust

## [Jun 14, 2020](/content/2020/06/14/README.md)

### Themes

*   [tmux-power (⭐670)](https://github.com/wfxr/tmux-power) 8 powerline style themes for tmux, easily to expand.

### Plugins

*   [tmux-fzf-url (⭐679)](https://github.com/wfxr/tmux-fzf-url) For opening urls from browser quickly without mouse.
...
*   [tmux-tilish (⭐486)](https://github.com/jabirali/tmux-tilish) Turn tmux into a dynamic window manager with intuitive keybindings (inspired by i3wm/sway)
...
*   [tmux-cssh (⭐100)](https://github.com/zinic/tmux-cssh) Tmux with a "ClusterSSH"-like behavior
...
*   [tmux-jump (⭐437)](https://github.com/schasse/tmux-jump) Vimium/Easymotion like navigation for tmux.

## [Jan 06, 2020](/content/2020/01/06/README.md)

### Status Bar

*   [gitmux (⭐772)](https://github.com/arl/gitmux) Show Git status in tmux status bar
...
*   [tmux-battery (⭐562)](https://github.com/tmux-plugins/tmux-battery) Plug and play battery percentage and icon indicator for Tmux.
*   [tmux-maildir-counter (⭐35)](https://github.com/tmux-plugins/tmux-maildir-counter) Plugin that counts files on a specific mail directory
...
*   [tmux-prefix-highlight (⭐658)](https://github.com/tmux-plugins/tmux-prefix-highlight) Plugin that highlights when you press tmux prefix key

## [Dec 18, 2018](/content/2018/12/18/README.md)

### Themes

*   [tmux-base16-statusline (⭐28)](https://github.com/jatap/tmux-base16-statusline) Statusline based on [base16-shell (⭐270)](https://github.com/chriskempson/base16-shell)
...
*   [tmux-1password (⭐273)](https://github.com/yardnsm/tmux-1password) Access your 1Password login items in a tmux pane.

## [Jan 17, 2017](/content/2017/01/17/README.md)

### Plugins

*   [tmux-better-mouse-mode (⭐972)](https://github.com/NHDaly/tmux-better-mouse-mode) A tmux plugin to better manage and configure the mouse.
...
*   [tmux2html (⭐736)](https://github.com/tweekmonster/tmux2html) :cat2: Render full tmux windows or individual panes as HTML
*   [tmux-plugins](https://github.com/tmux-plugins) Official tmux plugins
    ...
    *   [tmux-open (⭐718)](https://github.com/tmux-plugins/tmux-open) Tmux key bindings for quick opening of a highlighted file or url
    *   [tmux-pain-control (⭐840)](https://github.com/tmux-plugins/tmux-pain-control) standard pane key-bindings for tmux
    ...
    *   [tmux-sidebar (⭐624)](https://github.com/tmux-plugins/tmux-sidebar) A sidebar with the directory tree for the current path. Tries to make tmux more IDE like.
    *   [tmux-smooth-scroll (⭐59)](https://github.com/azorng/tmux-smooth-scroll) Smooth scrolling for tmux
    *   [tmux-tpm (⭐14k)](https://github.com/tmux-plugins/tpm) Tmux Plugin Manager
    *   [tmux-urlview (⭐288)](https://github.com/tmux-plugins/tmux-urlview) Quickly open any url on your terminal window! (No commits since 2016, see tmux-urlscan or tmux-fzf-url for a maintained alternative.)
...
*   [tmux-test (⭐18)](https://github.com/tmux-plugins/tmux-test) A small framework for isolated testing of tmux plugins.

### Miscellaneous / Development and testing

*   [Statically linked tmux](https://gist.github.com/rothgar/719ef460efc214c8d222) Install new version without root access
*   [vim-tmux (⭐341)](https://github.com/tmux-plugins/vim-tmux) vim plugin for tmux.conf