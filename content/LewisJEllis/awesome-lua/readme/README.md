...
[🏠 Home](/README.md) · [🔥 Feed](https://www.trackawesomelist.com/LewisJEllis/awesome-lua/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 LewisJEllis/awesome-lua](https://github.com/LewisJEllis/awesome-lua) · ⭐ 3.2K · 🏷️ Programming Languages
...
Inspired by the lists [awesome (⭐223k)](https://github.com/sindresorhus/awesome), [awesome-awesomeness (⭐29k)](https://github.com/bayandin/awesome-awesomeness), and [awesome-nodejs (⭐47k)](https://github.com/sindresorhus/awesome-nodejs).
...
*   LÖVE
    ...
    *   [lurker (⭐240)](https://github.com/rxi/lurker) - Shortens the iteration cycle by auto-swapping changed Lua files in a running LÖVE project.
