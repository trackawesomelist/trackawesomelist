...
*   [PyRIT (⭐1.7k)](https://github.com/Azure/PyRIT): Python Risk Identification Tool for generative AI (PyRIT). LLM robustness against harms like hallucination, bias, and harassment. \[Dec 2023]
...
*   [observer\_ward (⭐1.2k)](https://github.com/emo-crab/observer_ward) - Web application and service fingerprint identification tool
...
*   [p0n1/epub\_to\_audiobook (⭐963)](https://github.com/p0n1/epub_to_audiobook): EPUB to audiobook converter, optimized for Audiobookshelf
...
- Prev: [Jul 12, 2024](/content/2024/07/12/README.md)
- Next: [Jul 10, 2024](/content/2024/07/10/README.md)