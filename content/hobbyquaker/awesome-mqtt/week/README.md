...
[🏠 Home](/README.md) · [🔍 Search](https://www.trackawesomelist.com/search/) · [🔥 Feed](https://www.trackawesomelist.com/hobbyquaker/awesome-mqtt/week/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 hobbyquaker/awesome-mqtt](https://github.com/awesome-mqtt/awesome-mqtt) · ⭐ 2.3K · 🏷️ Miscellaneous
...
*   [mqtt\_monitor (⭐9)](https://github.com/filipsPL/mqtt-monitor) - Simple and lightweight console moniotor for mqtt topics, with eye-candies, in python 3.

### Smart Home Hardware Interfaces / Firmwares for ESP based Devices

*   [can2mqtt (⭐100)](https://github.com/c3re/can2mqtt) - CAN-Bus - MQTT Bridge (also works vice versa).
...
*   [serial2mqtt (⭐146)](https://github.com/vortex314/serial2mqtt) - A Linux gateway to connect low-cost microcontrollers only with a serial port to MQTT.

### Visualization, Dashboards / Firmwares for ESP based Devices

*   [MYHELLOIOT](https://adrianromero.github.io/myhelloiot/) - MQTT dashboard application.
*   [PlotJuggler (⭐5.6k)](https://github.com/facontidavide/PlotJuggler) - Visualize time series (from sources such as: MQTT, Websockets, ZeroMQ, UDP, etc., supports data formats such as JSON, CBOR, BSON, Message Pack, etc.). It is a fast, powerful and intuitive cross-platform tool.

## [Mar 01 - Mar 07, 2021](/content/2021/9/README.md)

### Tools

*   [MQTT TUI (⭐607)](https://github.com/EdJoPaTo/mqttui) - Simple lightweight terminal based MQTT monitor and publisher.

### Telephony, PBX / Firmwares for ESP based Devices

*   [sms2mqtt (⭐65)](https://github.com/Domochip/sms2mqtt) - Docker Gateway to send/receive SMS through MQTT using an USB GSM dongle (gammu).
...
*   [mqtt\_recorder (⭐34)](https://github.com/rpdswtk/mqtt_recorder) - Simple cli tool for recording and replaying MQTT messages.
...
*   [mqtt-ir-transceiver (⭐145)](https://github.com/piotrC4/mqtt-ir-transceiver) - ESP8266 based bidirectional gateway between MQTT and IR. Use with PlatformIO.

### Smart Home Hardware Interfaces / Firmwares for ESP based Devices

*   [aqara2mqtt (⭐6)](https://github.com/hobbyquaker/aqara2mqtt) - Attach [Aqara](https://www.aqara.com) Smart Hubs to MQTT.
...
*   [OpenMQTTGateway (⭐3.9k)](https://github.com/1technophile/OpenMQTTGateway) - MQTT gateway for ESP8266, ESP32, Sonoff RF Bridge or Arduino with bidirectional 433mhz/315mhz/868mhz, Infrared communications, BLE, beacons detection, mi flora, mi jia, LYWSD02, LYWSD03MMC, Mi Scale compatibility, SMS & LORA.
...
*   [KMQTT (⭐272)](https://github.com/davidepianca98/KMQTT) - Kotlin Multiplatform MQTT broker, both embeddable and standalone.
...
*   [ESP32-BLE2MQTT (⭐749)](https://github.com/shmuelzon/esp32-ble2mqtt) - BLE to MQTT bridge, exposes BLE GATT characteristics as MQTT topics for bidirectional communication.
...
*   [AlexaMqttBridge (⭐108)](https://github.com/mhdawson/AlexaMqttBridge) - Bridge between Amazon Alexa and MQTT.
...
*   [MQTTX (⭐4.7k)](https://github.com/emqx/MQTTX) - Cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows.
...
*   [Crouton (⭐295)](https://github.com/edfungus/Crouton) - A dashboard that taps into your IOT network, using only MQTT and JSON.
...
*   [MQTT CLI (⭐354)](https://github.com/hivemq/mqtt-cli) - A command line interface for connecting various MQTT clients supporting MQTT 5.0 and 3.1.1.

### Python

*   [aiomqtt (⭐55)](https://github.com/mossblaser/aiomqtt) - Async Python MQTT client based on paho-mqtt.

### Java

*   [hivemq-mqtt-client (⭐1k)](https://github.com/hivemq/hivemq-mqtt-client) - High-performance Java MQTT client library with different API flavours for MQTT 5.0 and 3.1.1.
...
*   [emqttc (⭐428)](https://github.com/emqx/emqtt) - Asynchronous Erlang MQTT Client.

### Delphi

*   [TMQTTClient (⭐24)](https://github.com/jamiei/Delphi-TMQTT2) - MQTT Client Library for Delphi. Alpha and long term unmaintained.
...
*   [mqtt2mongodb (⭐18)](https://github.com/David-Lor/MQTT2MongoDB) - Subscribe to MQTT topics and insert into MongoDB.
...
*   [gmqtt (⭐436)](https://github.com/wialon/gmqtt) - Python MQTT v5.0 client (asyncio-based).

### Lua

*   [luamqtt (⭐175)](https://github.com/xHasKx/luamqtt/) - Pure-lua MQTT v3.1.1 and v5.0 client.
...
*   [mqtt-malaria (⭐267)](https://github.com/etactica/mqtt-malaria) - Scalability and load testing utilities for MQTT environments.
...
*   [Valetudo (⭐8.4k)](https://github.com/Hypfer/Valetudo) - Xiaomi (Roborock) Vacuum Robots Firmware with MQTT and Webinterface.
...
*   [spicierModbus2mqtt (⭐67)](https://github.com/mbs38/spicierModbus2mqtt) - Modbus master which publishes register values via MQTT.
...
*   [hrotti (⭐126)](https://github.com/alsm/hrotti) - A MQTT broker written in Go.
...
*   [mqttcli (⭐124)](https://github.com/shirou/mqttcli) - MQTT Client for shell scripting.
...
*   [mqtt\_cpp (⭐475)](https://github.com/redboltz/mqtt_cpp) - MQTT client for C++14 based on Boost.Asio.
...
*   [Home.Pi (⭐190)](https://github.com/denschu/home.pi) - Based on MQTT.

### Home Entertainment / Firmwares for ESP based Devices

*   [kodi2mqtt (⭐89)](https://github.com/owagner/kodi2mqtt) - Interface between a Kodi media center instance and MQTT.
...
*   [bt-mqtt-gateway (⭐559)](https://github.com/zewelor/bt-mqtt-gateway) - Easily extensible Bluetooth to MQTT gateway, currently supports: EQ3 smart thermostat, Xiaomi Mi Scale, Linak Desk, MySensors and Xiaomi Mi Flora plant sensor.
...
*   [CODESYS-MQTT (⭐133)](https://github.com/stefandreyer/CODESYS-MQTT) - A MQTT client for CODESYS PLC.
...
*   [MQTT-PWN (⭐425)](https://github.com/akamai-threat-research/mqtt-pwn) - IoT Broker penetration-testing and security assessment operations.
...
*   [sip2mqtt (⭐44)](https://github.com/MartyTremblay/sip2mqtt) - A SIP monitoring script that publishes incoming calls with CallerID to MQTT.
...
*   [zigbee2mqtt (⭐14k)](https://github.com/Koenkk/zigbee2mqtt) - Allows you to use your Zigbee devices without the vendors (Xiaomi/TRADFRI/Hue) bridge/gateway.
...
*   [MQTT-C (⭐870)](https://github.com/LiamBindle/MQTT-C) - A portable MQTT C client for embedded systems and PCs alike.

## [Mar 26 - Apr 01, 2018](/content/2018/13/README.md)

### Architecture, Convention / Firmwares for ESP based Devices

*   [The Homie Convention (⭐740)](https://github.com/homieiot/convention) - A lightweight MQTT convention for the IoT.
...
*   [unifi2mqtt (⭐74)](https://github.com/hobbyquaker/unifi2mqtt) - Publish connected clients from Ubiquiti Unifi to MQTT.

## [Jan 01 - Jan 07, 2018](/content/2018/1/README.md)

### Home Entertainment / Firmwares for ESP based Devices

*   [sonos2mqtt (⭐77)](https://github.com/svrooij/sonos2mqtt) - A bridge between Sonos and MQTT.
...
*   [helios2mqtt (⭐7)](https://github.com/mreschka/helios2mqtt) - A daemon for syncing a helios easy controls system like my KWL EC 220D to MQTT.
...
*   [mqttclpro (⭐107)](https://github.com/dc297/mqttclpro) - MQTT Client with tasker integration Android app.
...
*   [WinThing (⭐102)](https://github.com/msiedlarek/winthing) - Remotely control Windows through MQTT.
...
*   [broadlink-mqtt (⭐235)](https://github.com/eschava/broadlink-mqtt) - MQTT client to control BroadLink RM devices.

## [Jul 24 - Jul 30, 2017](/content/2017/30/README.md)

### Smart Home Hardware Interfaces / Firmwares for ESP based Devices

*   [smartthings-mqtt-bridge (⭐375)](https://github.com/stjohnjohnson/smartthings-mqtt-bridge) - Bridge between [SmartThings](https://www.smartthings.com/) and MQTT.
...
*   [HelloIoT (⭐108)](https://github.com/adrianromero/helloiot) - MQTT client and dashboard application.

## [May 15 - May 21, 2017](/content/2017/20/README.md)

### Operating System / Firmwares for ESP based Devices

*   [psmqtt (⭐177)](https://github.com/eschava/psmqtt) - Utility reporting system health and status via MQTT.
...
*   [bravia2mqtt (⭐14)](https://github.com/forty2/bravia2mqtt) - Control your Sony Bravia TV with MQTT.
...
*   [mqtt-rs (⭐184)](https://github.com/zonyitoo/mqtt-rs) - MQTT protocol library for Rust.
...
*   [harmony-api (⭐399)](https://github.com/maddox/harmony-api) - A simple server allowing you to query/control multiple local Harmony Home Hubs over HTTP or MQTT.
...
*   [Wireshark-MQTT (⭐92)](https://github.com/menudoproblema/Wireshark-MQTT) - MQTT dissector for Wireshark.
...
*   [mqtt-scripts (⭐61)](https://github.com/hobbyquaker/mqtt-scripts/) - Node.js based script runner.
...
*   [mqtt-admin (⭐128)](https://github.com/hobbyquaker/mqtt-admin/) - Web based MQTT frontend. [Direct Link](https://hobbyquaker.github.io/mqtt-admin/).
...
*   [ruby-mqtt (⭐554)](https://github.com/njh/ruby-mqtt) - Pure Ruby gem that implements the MQTT protocol.
...
*   [mqtt-smarthome (⭐448)](https://github.com/mqtt-smarthome/mqtt-smarthome) - Smart home automation with MQTT as the central message bus - Architectural proposal.
...
*   [mqtt-os-status (⭐18)](https://github.com/oskarhagberg/mqtt-os-status) - Operating-system related data, published to an MQTT broker at fixed intervals.
...
*   [twitter-to-mqtt (⭐16)](https://github.com/knolleary/twitter-to-mqtt) - A python daemon that uses the Twitter Streaming API to access tweets and republishes them to an MQTT topic.
