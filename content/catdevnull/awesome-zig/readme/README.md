...
*   [ziglibs/s2s (⭐82)](https://github.com/ziglibs/s2s) - Binary serialization format and library.
...
*   [kristoff-it/zig-cuckoofilter (⭐70)](https://github.com/kristoff-it/zig-cuckoofilter) - Production-ready Cuckoo Filters for any C ABI compatible target.
...
*   [hexops/xorfilter (⭐208)](https://github.com/hexops/xorfilter) - Xor Filters for checking if a key is part of a set.
*   [JakubSzark/zig-string (⭐130)](https://github.com/JakubSzark/zig-string) - UTF-8 string data structure.
...
*   [orhun/linuxwave (⭐379)](https://github.com/orhun/linuxwave) - Generate music from the entropy of Linux.

## Bootables

*   [AndreaOrru/zen (⭐321)](https://github.com/AndreaOrru/zen) - Experimental operating system.
*   [andrewrk/clashos (⭐193)](https://github.com/andrewrk/clashos) - Multiplayer arcade game for bare metal Raspberry Pi 3 B+.
*   [andrewrk/HellOS (⭐192)](https://github.com/andrewrk/HellOS) - "hello world" x86 kernel example.
...
*   [jzck/kernel-zig (⭐393)](https://github.com/jzck/kernel-zig) - Hobby x86 kernel.
...
*   [SamTebbs33/pluto (⭐367)](https://github.com/SamTebbs33/pluto) - An x86 kernel.
...
*   [Vexu/bog (⭐430)](https://github.com/Vexu/bog) - Small, strongly typed, embeddable language.
...
*   [squeek502/zua (⭐116)](https://github.com/squeek502/zua) - An implementation of Lua 5.1 for learning purposes.
...
*   [dantecatalfamo/mruby-zig (⭐26)](https://github.com/dantecatalfamo/mruby-zig) - [mruby](https://mruby.org/) bindings.
*   [dantecatalfamo/wren-zig (⭐25)](https://github.com/dantecatalfamo/wren-zig) - [wren](https://wren.io/) bindings.
*   [fubark/cyber (⭐794)](https://github.com/fubark/cyber) - Fast and concurrent scripting.

## Database

*   [coilhq/tigerbeetle (⭐2.6k)](https://github.com/coilhq/tigerbeetle) - A distributed financial accounting database designed for mission critical safety and performance.
...
*   [kristoff-it/zig-okredis (⭐154)](https://github.com/kristoff-it/zig-okredis) - Zero-allocation Client for Redis 6+.
...
*   [vrischmann/zig-sqlite (⭐232)](https://github.com/vrischmann/zig-sqlite) - SQLite wrapper.

## Editor plugins

*   [MarioAriasC/zig-support (⭐65)](https://github.com/MarioAriasC/zig-support) - Language support for JetBrains IDEs (IntelliJ, CLion and others)
...
*   [ziglang/vscode-zig (⭐344)](https://github.com/ziglang/vscode-zig) - Zig language support for VSCode.
*   [ziglang/zig-mode (⭐108)](https://github.com/ziglang/zig-mode) - Zig mode for Emacs.
*   [ziglang/zig.vim (⭐312)](https://github.com/ziglang/zig.vim) - Vim configuration for Zig.
*   [zigtools/zls (⭐1.6k)](https://github.com/zigtools/zls) - Zig LSP implementation + Zig Language Server.

## Emulators

*   [fengb/fundude (⭐158)](https://github.com/fengb/fundude) - Gameboy emulator for WASM.
...
*   [floooh/sokol-zig (⭐184)](https://github.com/floooh/sokol-zig) - [Sokol (⭐4.7k)](https://github.com/floooh/sokol) bindings.
...
*   [andrewrk/tetris (⭐256)](https://github.com/andrewrk/tetris) - A simple tetris clone.
...
*   [thejoshwolfe/legend-of-swarkland (⭐84)](https://github.com/thejoshwolfe/legend-of-swarkland) - Hack-n-slash roguelike inspired by NetHack.
*   [tiehuis/zstack (⭐3)](https://github.com/tiehuis/zstack) - Line-race tetris mode.
*   [kooparse/zalgebra (⭐162)](https://github.com/kooparse/zalgebra) - Linear algebra library for games and real-time computer graphics.
...
*   [capy-ui/capy (⭐840)](https://github.com/capy-ui/capy) - Cross-platform library for making true native GUIs.
*   [david-vanderson/gui (⭐59)](https://github.com/david-vanderson/gui) - Immediate mode GUI for Zig.
*   [Aransentin/ZWL (⭐86)](https://github.com/Aransentin/ZWL) - Zig Windowing Library.
...
*   [batiati/IUPforZig (⭐92)](https://github.com/batiati/IUPforZig) - Zig idiomatic and type-checked bindings for IUP Portable User Interface Toolkit.
*   [andrewrk/zig-sdl (⭐64)](https://github.com/andrewrk/zig-sdl) - Self-contained SDL2 package for Zig.
*   [Snektron/vulkan-zig (⭐260)](https://github.com/Snektron/vulkan-zig) - Vulkan binding generator.
...
*   [kassane/QML-zig (⭐49)](https://github.com/kassane/qml_zig) - QML bindings.
*   [cshenton/learnopengl (⭐112)](https://github.com/cshenton/learnopengl) - [Learn OpenGL](https://learnopengl.com) tutorials ported to Zig.
...
*   [natecraddock/ziglua (⭐84)](https://github.com/natecraddock/ziglua) - Bindings for the Lua C API.
*   [ryoppippi/zigcv (⭐72)](https://github.com/ryoppippi/zigcv) - Bindings for OpenCV4.
...
*   [kprotty/zap (⭐339)](https://github.com/kprotty/zap) - A collection of libraries which provide interfaces over the system for writing high performance applications.
*   [mlarouche/zigimg (⭐251)](https://github.com/mlarouche/zigimg) - Zig library for reading and writing different image formats.
...
*   [karlseguin/log.zig (⭐41)](https://github.com/karlseguin/log.zig) - Structured logging library.
*   [dantecatalfamo/9p-zig (⭐3)](https://github.com/dantecatalfamo/9p-zig) - 9P2000 client/server library.

## Network

*   [MasterQ32/zig-network (⭐289)](https://github.com/MasterQ32/zig-network) - Small network abstraction layer around TCP & UDP.
...
*   [ducdetronquito/requestz (⭐104)](https://github.com/ducdetronquito/requestz) - HTTP client based on h11.
...
*   ~~[Vexu/routez (⭐233)](https://github.com/Vexu/routez) - HTTP server.~~
*   [frmdstryr/zhp (⭐312)](https://github.com/frmdstryr/zhp) - Featureful HTTP server.
*   [axgdev/telegram\_echobot\_zig (⭐4)](https://github.com/axgdev/telegram_echobot_zig) - Telegram echo bot.
*   [karlseguin/http.zig (⭐74)](https://github.com/karlseguin/http.zig) - HTTP/1.1 server.
*   [zigzap/zap (⭐663)](https://github.com/zigzap/zap) - blazingly fast, robust HTTP server.

## Web

*   [andrewrk/lua-in-the-browser (⭐27)](https://github.com/andrewrk/lua-in-the-browser) - Using Zig to build Lua for WebAssembly.
*   [karlseguin/websocket.zig (⭐117)](https://github.com/karlseguin/websocket.zig) - A WebSocket implementation.
...
*   [floscodes/zerve (⭐15)](https://github.com/floscodes/zerve) - Simple framework for writing web services and web apps.
...
*   [marler8997/zigup (⭐320)](https://github.com/marler8997/zigup) - Download and manage zig compilers.
...
*   [zigtools/zpm (⭐66)](https://github.com/zigtools/zpm) - Unofficial Zig package manager.
*   [mattnite/gyro (⭐561)](https://github.com/mattnite/gyro) - Package manager with an index, build runner, and build dependencies.
*   [nektro/zigmod (⭐530)](https://github.com/nektro/zigmod) - Zig package manager.
*   [cheetah/asdf-zig (⭐18)](https://github.com/cheetah/asdf-zig) - Zig plugin for the ASDF package manager.

## Parser

*   [darithorn/zig-toml (⭐70)](https://github.com/darithorn/zig-toml) - A TOML parser.
*   [Himujjal/zig-json5 (⭐24)](https://github.com/Himujjal/zig-json5) - JSON5 parser resembling the `std.json` APIs.
*   [chwayne/rem (⭐76)](https://github.com/chwayne/rem) - An HTML parsing library.
*   [goto-bus-stop/ziguid (⭐7)](https://github.com/goto-bus-stop/ziguid) - GUID parsing/stringifying.
*   [Hejsil/zig-clap (⭐451)](https://github.com/Hejsil/zig-clap) - Simple command line argument parsing library.
*   [sam701/zig-cli (⭐53)](https://github.com/sam701/zig-cli) - Package for building command line apps.
...
*   [kubkon/zig-yaml (⭐74)](https://github.com/kubkon/zig-yaml) - YAML parser.
...
*   [Arwalk/zig-protobuf (⭐73)](https://github.com/Arwalk/zig-protobuf) - Implementation of Protocol Buffers v3 leveraging Zig's comptime.
...
*   [Sobeston/ziglearn (⭐344)](https://github.com/Sobeston/ziglearn) - Zig learning resources.
*   [ratfactor/ziglings (⭐3.1k)](https://github.com/ratfactor/ziglings) - Learn Zig by fixing tiny example programs.
...
*   [andrewrk/SDL (⭐23)](https://github.com/andrewrk/SDL) - Simple Directmedia Layer.
*   [andrewrk/ffmpeg (⭐26)](https://github.com/andrewrk/ffmpeg) - library only.
...
*   [kassane/winpthreads (⭐4)](https://github.com/kassane/winpthreads-zigbuild) - PThread library for MinGW.
...
*   [kubkon/zig-ios-example (⭐85)](https://github.com/kubkon/zig-ios-example) - Minimal `build.zig` for targeting iOS.
