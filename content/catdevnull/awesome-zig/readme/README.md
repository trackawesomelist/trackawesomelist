...
*   [ziglibs/s2s (⭐83)](https://github.com/ziglibs/s2s) - Binary serialization format and library.
...
*   [Srekel/zig-sparse-set (⭐51)](https://github.com/Srekel/zig-sparse-set) - Sparse sets, supporting both SOA and AOS style.
*   [hexops/xorfilter (⭐216)](https://github.com/hexops/xorfilter) - Xor Filters for checking if a key is part of a set.
*   [JakubSzark/zig-string (⭐139)](https://github.com/JakubSzark/zig-string) - UTF-8 string data structure.
...
*   [Hejsil/zig-gc (⭐32)](https://github.com/Hejsil/zig-gc) - A super simple mark-and-sweep garbage collector.
...
*   [orhun/linuxwave (⭐390)](https://github.com/orhun/linuxwave) - Generate music from the entropy of Linux.

## Bootables

*   [AndreaOrru/zen (⭐327)](https://github.com/AndreaOrru/zen) - Experimental operating system.
*   [andrewrk/clashos (⭐195)](https://github.com/andrewrk/clashos) - Multiplayer arcade game for bare metal Raspberry Pi 3 B+.
*   [andrewrk/HellOS (⭐194)](https://github.com/andrewrk/HellOS) - "hello world" x86 kernel example.
...
*   [iguessthislldo/georgios (⭐37)](https://github.com/iguessthislldo/georgios) - Hobby Operating System.
*   [jzck/kernel-zig (⭐395)](https://github.com/jzck/kernel-zig) - Hobby x86 kernel.
...
*   [markfirmware/zig-bare-metal-raspberry-pi (⭐65)](https://github.com/markfirmware/zig-bare-metal-raspberry-pi) - Bare metal raspberry pi program.
*   [MasterQ32/RetrOS (⭐48)](https://github.com/MasterQ32/RetrOS) - A retro-style gaming console running on bare x86 metal.
*   [nrdmn/uefi-examples (⭐40)](https://github.com/nrdmn/uefi-examples) - UEFI examples.
*   [nrdmn/uefi-paint (⭐39)](https://github.com/nrdmn/uefi-paint) - UEFI-bootable touch paint app.
*   [rafaelbreno/zig-os (⭐19)](https://github.com/rafaelbreno/zig-os) - A simple OS following Philipp Oppermann's posts "Writing an OS in Rust".
*   [SamTebbs33/pluto (⭐375)](https://github.com/SamTebbs33/pluto) - An x86 kernel.
*   [sjdh02/trOS (⭐45)](https://github.com/sjdh02/trOS) - Tiny aarch64 baremetal OS thingy.
*   [tralamazza/embedded\_zig (⭐57)](https://github.com/tralamazza/embedded_zig) - Minimal embedded ARM example (STM32F103 blue pill).
*   [yvt/zig-armv8m-test (⭐8)](https://github.com/yvt/zig-armv8m-test) - Example app for Armv8-M + TrustZone.
*   [ZeeBoppityZagZiggity/ZBZZ.OS (⭐7)](https://github.com/ZeeBoppityZagZiggity/ZBZZ.OS) - An operating system built for RISCV.
...
*   [Vexu/bog (⭐439)](https://github.com/Vexu/bog) - Small, strongly typed, embeddable language.
*   [LoLa Programming Language](https://lola.random-projects.net/) - ([GitHub (⭐155)](https://github.com/MasterQ32/LoLa)) An embeddable programming language for game scripting.
*   [squeek502/zua (⭐121)](https://github.com/squeek502/zua) - An implementation of Lua 5.1 for learning purposes.
...
*   [dantecatalfamo/mruby-zig (⭐27)](https://github.com/dantecatalfamo/mruby-zig) - [mruby](https://mruby.org/) bindings.
*   [dantecatalfamo/wren-zig (⭐24)](https://github.com/dantecatalfamo/wren-zig) - [wren](https://wren.io/) bindings.
*   [fubark/cyber (⭐804)](https://github.com/fubark/cyber) - Fast and concurrent scripting.

## Database

*   [coilhq/tigerbeetle (⭐2.7k)](https://github.com/coilhq/tigerbeetle) - A distributed financial accounting database designed for mission critical safety and performance.
*   [kristoff-it/redis-cuckoofilter (⭐216)](https://github.com/kristoff-it/redis-cuckoofilter) - Hashing-function agnostic Cuckoo filters for Redis.
*   [kristoff-it/zig-okredis (⭐157)](https://github.com/kristoff-it/zig-okredis) - Zero-allocation Client for Redis 6+.
*   [leroycep/sqlite-zig (⭐38)](https://github.com/leroycep/sqlite-zig) - SQLite bindings.
*   [vrischmann/zig-cassandra (⭐5)](https://github.com/vrischmann/zig-cassandra) - Client for Cassandra 2.1+.
*   [vrischmann/zig-sqlite (⭐235)](https://github.com/vrischmann/zig-sqlite) - SQLite wrapper.
*   [karlseguin/zuckdb.zig (⭐13)](https://github.com/karlseguin/zuckdb.zig) - DuckDB wrapper.

## Editor plugins

*   [MarioAriasC/zig-support (⭐67)](https://github.com/MarioAriasC/zig-support) - Language support for JetBrains IDEs (IntelliJ, CLion and others)
...
*   [ziglang/vscode-zig (⭐356)](https://github.com/ziglang/vscode-zig) - Zig language support for VSCode.
*   [ziglang/zig-mode (⭐111)](https://github.com/ziglang/zig-mode) - Zig mode for Emacs.
*   [ziglang/zig.vim (⭐320)](https://github.com/ziglang/zig.vim) - Vim configuration for Zig.
*   [zigtools/zls (⭐1.6k)](https://github.com/zigtools/zls) - Zig LSP implementation + Zig Language Server.

## Emulators

*   [fengb/fundude (⭐159)](https://github.com/fengb/fundude) - Gameboy emulator for WASM.
...
*   [hexops/mach (⭐1.9k)](https://github.com/hexops/mach) - Game engine and graphics toolkit.
*   [michal-z/zig-gamedev (⭐1.5k)](https://github.com/michal-z/zig-gamedev) - DirectX 12 game development ecosystem.
*   [floooh/sokol-zig (⭐190)](https://github.com/floooh/sokol-zig) - [Sokol (⭐4.7k)](https://github.com/floooh/sokol) bindings.
...
*   [wendigojaeger/ZigGBA (⭐302)](https://github.com/wendigojaeger/ZigGBA) - SDK for creating Game Boy Advance games using Zig.
...
*   [andrewrk/tetris (⭐263)](https://github.com/andrewrk/tetris) - A simple tetris clone.
*   [fabioarnold/snake-zig (⭐9)](https://github.com/fabioarnold/snake-zig) - A simple snake clone.
*   [Stenodyon/blink (⭐15)](https://github.com/Stenodyon/blink) - A game about building logic with lasers.
*   [thejoshwolfe/legend-of-swarkland (⭐87)](https://github.com/thejoshwolfe/legend-of-swarkland) - Hack-n-slash roguelike inspired by NetHack.
*   [tiehuis/zstack (⭐3)](https://github.com/tiehuis/zstack) - Line-race tetris mode.
*   [kooparse/zalgebra (⭐166)](https://github.com/kooparse/zalgebra) - Linear algebra library for games and real-time computer graphics.
...
*   [capy-ui/capy (⭐886)](https://github.com/capy-ui/capy) - Cross-platform library for making true native GUIs.
*   [david-vanderson/gui (⭐67)](https://github.com/david-vanderson/gui) - Immediate mode GUI for Zig.
*   [Aransentin/ZWL (⭐89)](https://github.com/Aransentin/ZWL) - Zig Windowing Library.
*   [prime31/zig-upaya (⭐125)](https://github.com/prime31/zig-upaya) - GUI toolkit.
*   [fubark/cosmic (⭐290)](https://github.com/fubark/cosmic) - GUI toolkit.
*   [batiati/IUPforZig (⭐91)](https://github.com/batiati/IUPforZig) - Zig idiomatic and type-checked bindings for IUP Portable User Interface Toolkit.
*   [andrewrk/zig-sdl (⭐64)](https://github.com/andrewrk/zig-sdl) - Self-contained SDL2 package for Zig.
*   [Snektron/vulkan-zig (⭐279)](https://github.com/Snektron/vulkan-zig) - Vulkan binding generator.
*   [Avokadoen/zig\_vulkan (⭐38)](https://github.com/Avokadoen/zig_vulkan) - Toy renderer using Vulkan and GLFW.
*   [andrewrk/zig-vulkan-triangle (⭐73)](https://github.com/andrewrk/zig-vulkan-triangle) - Simple triangle displayed using Vulkan, GLFW, and Zig.
*   [kassane/QML-zig (⭐50)](https://github.com/kassane/qml_zig) - QML bindings.
*   [cshenton/learnopengl (⭐113)](https://github.com/cshenton/learnopengl) - [Learn OpenGL](https://learnopengl.com) tutorials ported to Zig.
*   [ifreund/river (⭐2.4k)](https://github.com/ifreund/river) - Dynamic wayland compositor that takes inspiration from dwm and bspwm.
*   [Nelarius/weekend-raytracer-zig (⭐79)](https://github.com/Nelarius/weekend-raytracer-zig) - An implementation of the "Ray Tracing in One Weekend" book.
*   [SpexGuy/Zig-Gltf-Display (⭐21)](https://github.com/SpexGuy/Zig-Gltf-Display) - A program that displays glTF files using Vulkan.
...
*   [natecraddock/ziglua (⭐94)](https://github.com/natecraddock/ziglua) - Bindings for the Lua C API.
*   [ryoppippi/zigcv (⭐73)](https://github.com/ryoppippi/zigcv) - Bindings for OpenCV4.
*   [BraedonWooding/Lazy-Zig (⭐33)](https://github.com/BraedonWooding/Lazy-Zig) - Linq.
...
*   [kprotty/zap (⭐343)](https://github.com/kprotty/zap) - A collection of libraries which provide interfaces over the system for writing high performance applications.
*   [mlarouche/zigimg (⭐258)](https://github.com/mlarouche/zigimg) - Zig library for reading and writing different image formats.
*   [ziglibs/known-folders (⭐163)](https://github.com/ziglibs/known-folders) - Provides access to well-known folders across several operating systems.
*   [SasLuca/zig-nanoid (⭐22)](https://github.com/SasLuca/zig-nanoid) - Battle-tested, tiny, secure, URL-friendly, unique string ID generator. Now available in pure Zig.
*   [kassane/libvlc-zig (⭐11)](https://github.com/kassane/libvlc-zig) - Zig bindings for libVLC media framework.
*   [karlseguin/log.zig (⭐42)](https://github.com/karlseguin/log.zig) - Structured logging library.
...
*   [MasterQ32/zig-network (⭐301)](https://github.com/MasterQ32/zig-network) - Small network abstraction layer around TCP & UDP.
...
*   [Luukdegram/apple\_pie (⭐148)](https://github.com/Luukdegram/apple_pie) - HTTP 1.0/1.1 Server implementation.
*   [truemedian/zfetch (⭐61)](https://github.com/truemedian/zfetch) - HTTP(S) client based on iguanaTLS.
*   [ducdetronquito/requestz (⭐111)](https://github.com/ducdetronquito/requestz) - HTTP client based on h11.
...
*   [frmdstryr/zhp (⭐325)](https://github.com/frmdstryr/zhp) - Featureful HTTP server.
*   [axgdev/telegram\_echobot\_zig (⭐4)](https://github.com/axgdev/telegram_echobot_zig) - Telegram echo bot.
*   [karlseguin/http.zig (⭐85)](https://github.com/karlseguin/http.zig) - HTTP/1.1 server.
*   [zigzap/zap (⭐781)](https://github.com/zigzap/zap) - blazingly fast, robust HTTP server.

## Web

*   [andrewrk/lua-in-the-browser (⭐27)](https://github.com/andrewrk/lua-in-the-browser) - Using Zig to build Lua for WebAssembly.
*   [karlseguin/websocket.zig (⭐121)](https://github.com/karlseguin/websocket.zig) - A WebSocket implementation.
*   [kivikakk/htmlentities.zig (⭐8)](https://github.com/kivikakk/htmlentities.zig) - HTML5 entity data.
...
*   [shritesh/zig-wasm-dom (⭐106)](https://github.com/shritesh/zig-wasm-dom) - Zig + WebAssembly + JS + DOM.
*   [shritesh/zigfmt-web (⭐35)](https://github.com/shritesh/zigfmt-web) - Zig fmt on the web.
*   [zigwasm/wasm-zig (⭐23)](https://github.com/zigwasm/wasm-zig) - Common WASM runtime binding to C API.
*   [zigwasm/wasmer-zig (⭐47)](https://github.com/zigwasm/wasmer-zig) - Bindings for the Wasmer WebAssembly runtime.
*   [zigwasm/wasmtime-zig (⭐82)](https://github.com/zigwasm/wasmtime-zig) - Bindings of Wasmtime.
*   [batiati/mustache-zig (⭐67)](https://github.com/batiati/mustache-zig) - Mustache implementation.
*   [floscodes/zerve (⭐17)](https://github.com/floscodes/zerve) - Simple framework for writing web services and web apps.

## System tools

*   [pbui-project/pbui-main (⭐90)](https://github.com/pbui-project/pbui-main) - BSD/Linux core utilities written in Zig.
...
*   [kubkon/zacho (⭐35)](https://github.com/kubkon/zacho) - Zig's Mach-O parser.

## Zig development tools

*   [marler8997/zigup (⭐325)](https://github.com/marler8997/zigup) - Download and manage zig compilers.
...
*   [zigtools/zpm (⭐68)](https://github.com/zigtools/zpm) - Unofficial Zig package manager.
*   [mattnite/gyro (⭐570)](https://github.com/mattnite/gyro) - Package manager with an index, build runner, and build dependencies.
*   [nektro/zigmod (⭐556)](https://github.com/nektro/zigmod) - Zig package manager.
*   [cheetah/asdf-zig (⭐18)](https://github.com/cheetah/asdf-zig) - Zig plugin for the ASDF package manager.

## Parser

*   [darithorn/zig-toml (⭐72)](https://github.com/darithorn/zig-toml) - A TOML parser.
...
*   [Hejsil/zig-clap (⭐466)](https://github.com/Hejsil/zig-clap) - Simple command line argument parsing library.
*   [sam701/zig-cli (⭐62)](https://github.com/sam701/zig-cli) - Package for building command line apps.
*   [kivikakk/libpcre.zig (⭐17)](https://github.com/kivikakk/libpcre.zig) - Bindings to libpcre for Perl-compatible regular expressions.
*   [kivikakk/koino (⭐91)](https://github.com/kivikakk/koino) - CommonMark/GitHub Flavored Markdown parser and HTML renderer.
*   [kubkon/zig-yaml (⭐77)](https://github.com/kubkon/zig-yaml) - YAML parser.
...
*   [tiehuis/zig-regex (⭐104)](https://github.com/tiehuis/zig-regex) - A regex implementation.
*   [tiehuis/zig-ryu (⭐15)](https://github.com/tiehuis/zig-ryu) - Port of [ryu (⭐1k)](https://github.com/ulfjack/ryu).
...
*   [Arwalk/zig-protobuf (⭐79)](https://github.com/Arwalk/zig-protobuf) - Implementation of Protocol Buffers v3 leveraging Zig's comptime.
...
*   [Sobeston/ziglearn (⭐361)](https://github.com/Sobeston/ziglearn) - Zig learning resources.
*   [ratfactor/ziglings (⭐3.2k)](https://github.com/ratfactor/ziglings) - Learn Zig by fixing tiny example programs.
...
*   [andrewrk/SDL (⭐27)](https://github.com/andrewrk/SDL) - Simple Directmedia Layer.
*   [andrewrk/ffmpeg (⭐27)](https://github.com/andrewrk/ffmpeg) - library only.
*   [andrewrk/libgroove (⭐278)](https://github.com/andrewrk/libgroove) - streaming audio processing library.
*   [andrewrk/libsoundio (⭐1.7k)](https://github.com/andrewrk/libsoundio/tree/zig-pkg) - library for real-time audio input and output.
*   [kassane/openssl (⭐2)](https://github.com/kassane/openssl) - crypto, providers & ssl libraries only.
...
*   [kubkon/zig-ios-example (⭐86)](https://github.com/kubkon/zig-ios-example) - Minimal `build.zig` for targeting iOS.
