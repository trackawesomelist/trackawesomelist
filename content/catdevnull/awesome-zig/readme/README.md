...
*   [ziglibs/s2s (⭐98)](https://github.com/ziglibs/s2s) - Binary serialization format and library.
...
*   [emekoi/deque.zig (⭐10)](https://github.com/emekoi/deque.zig) - A lock free chase-lev deque.
*   [kristoff-it/zig-cuckoofilter (⭐73)](https://github.com/kristoff-it/zig-cuckoofilter) - Production-ready Cuckoo Filters for any C ABI compatible target.
...
*   [Srekel/zig-sparse-set (⭐53)](https://github.com/Srekel/zig-sparse-set) - Sparse sets, supporting both SOA and AOS style.
*   [hexops/xorfilter (⭐224)](https://github.com/hexops/xorfilter) - Xor Filters for checking if a key is part of a set.
*   [JakubSzark/zig-string (⭐176)](https://github.com/JakubSzark/zig-string) - UTF-8 string data structure.
*   [karlseguin/cache.zig (⭐16)](https://github.com/karlseguin/cache.zig) - Thread-safe, expiration-aware, LRU cache.

## Allocators and memory

*   [fengb/zee\_alloc (⭐76)](https://github.com/fengb/zee_alloc) - Tiny allocator primarily targeting WebAssembly.
...
*   [Hejsil/zig-midi (⭐23)](https://github.com/Hejsil/zig-midi)
...
*   [orhun/linuxwave (⭐427)](https://github.com/orhun/linuxwave) - Generate music from the entropy of Linux.

## Bootables

*   [AndreaOrru/zen (⭐360)](https://github.com/AndreaOrru/zen) - Experimental operating system.
*   [andrewrk/clashos (⭐199)](https://github.com/andrewrk/clashos) - Multiplayer arcade game for bare metal Raspberry Pi 3 B+.
*   [andrewrk/HellOS (⭐213)](https://github.com/andrewrk/HellOS) - "hello world" x86 kernel example.
...
*   [iguessthislldo/georgios (⭐40)](https://github.com/iguessthislldo/georgios) - Hobby Operating System.
*   [jzck/kernel-zig (⭐404)](https://github.com/jzck/kernel-zig) - Hobby x86 kernel.
...
*   [markfirmware/zig-bare-metal-raspberry-pi (⭐72)](https://github.com/markfirmware/zig-bare-metal-raspberry-pi) - Bare metal raspberry pi program.
...
*   [rafaelbreno/zig-os (⭐23)](https://github.com/rafaelbreno/zig-os) - A simple OS following Philipp Oppermann's posts "Writing an OS in Rust".
*   [SamTebbs33/pluto (⭐412)](https://github.com/SamTebbs33/pluto) - An x86 kernel.
*   [sjdh02/trOS (⭐45)](https://github.com/sjdh02/trOS) - Tiny aarch64 baremetal OS thingy.
*   [tralamazza/embedded\_zig (⭐65)](https://github.com/tralamazza/embedded_zig) - Minimal embedded ARM example (STM32F103 blue pill).
...
*   [oven-sh/bun (⭐65k)](https://github.com/oven-sh/bun) - Incredibly fast JavaScript runtime, bundler, transpiler and package manager – all in one.
*   [Vexu/bog (⭐483)](https://github.com/Vexu/bog) - Small, strongly typed, embeddable language.
*   [LoLa Programming Language](https://lola.random-projects.net/) - ([GitHub (⭐172)](https://github.com/MasterQ32/LoLa)) An embeddable programming language for game scripting.
*   [squeek502/zua (⭐130)](https://github.com/squeek502/zua) - An implementation of Lua 5.1 for learning purposes.
...
*   [dantecatalfamo/mruby-zig (⭐30)](https://github.com/dantecatalfamo/mruby-zig) - [mruby](https://mruby.org/) bindings.
*   [dantecatalfamo/wren-zig (⭐24)](https://github.com/dantecatalfamo/wren-zig) - [wren](https://wren.io/) bindings.
*   [fulcrum-so/ziggy-pydust (⭐175)](https://github.com/fulcrum-so/ziggy-pydust) - [Python](https://python.org/) bindings.
*   [fubark/cyber (⭐871)](https://github.com/fubark/cyber) - Fast and concurrent scripting.

## Concurrency

*   [mitchellh/libxev (⭐722)](https://github.com/mitchellh/libxev) - Cross-platform event-loop.
*   [kprotty/zefi (⭐31)](https://github.com/kprotty/zefi) - Fiber library.
*   [rsepassi/zigcoro (⭐29)](https://github.com/rsepassi/zigcoro) - coroutine-friendly, based on libxev.
*   [iacore/minicoro-zig](https://git.envs.net/iacore/minicoro-zig) - Bindings for minicoro - Stackful Stack-Switching Coroutine.

## Database

*   [coilhq/tigerbeetle (⭐3.2k)](https://github.com/coilhq/tigerbeetle) - A distributed financial accounting database designed for mission critical safety and performance.
*   [kristoff-it/redis-cuckoofilter (⭐224)](https://github.com/kristoff-it/redis-cuckoofilter) - Hashing-function agnostic Cuckoo filters for Redis.
*   [kristoff-it/zig-okredis (⭐180)](https://github.com/kristoff-it/zig-okredis) - Zero-allocation Client for Redis 6+.
*   [leroycep/sqlite-zig (⭐51)](https://github.com/leroycep/sqlite-zig) - SQLite bindings.
*   [vrischmann/zig-cassandra (⭐5)](https://github.com/vrischmann/zig-cassandra) - Client for Cassandra 2.1+.
*   [vrischmann/zig-sqlite (⭐277)](https://github.com/vrischmann/zig-sqlite) - SQLite wrapper.
*   [karlseguin/zuckdb.zig (⭐26)](https://github.com/karlseguin/zuckdb.zig) - DuckDB wrapper.
*   [karlseguin/pg.zig (⭐18)](https://github.com/karlseguin/pg.zig) - Native PostgreSQL client.

## Editor plugins

*   [MarioAriasC/zig-support (⭐77)](https://github.com/MarioAriasC/zig-support) - Language support for JetBrains IDEs (IntelliJ, CLion and others)
...
*   [ziglang/vscode-zig (⭐407)](https://github.com/ziglang/vscode-zig) - Zig language support for VSCode.
*   [ziglang/zig-mode (⭐121)](https://github.com/ziglang/zig-mode) - Zig mode for Emacs.
*   [ziglang/zig.vim (⭐363)](https://github.com/ziglang/zig.vim) - Vim configuration for Zig.
*   [zigtools/zls (⭐1.9k)](https://github.com/zigtools/zls) - Zig LSP implementation + Zig Language Server.

## Emulators

*   [fengb/fundude (⭐169)](https://github.com/fengb/fundude) - Gameboy emulator for WASM.
...
*   [floooh/kc85.zig (⭐40)](https://github.com/floooh/kc85.zig) - A KC85 emulator.
*   [Arwalk/ChipZ (⭐0)](https://github.com/Arwalk/ChipZ) A simple Chip8 emulator (library and executable).

## Game tools and libraries

*   [hexops/mach (⭐2.3k)](https://github.com/hexops/mach) - Game engine and graphics toolkit.
*   [michal-z/zig-gamedev (⭐1.7k)](https://github.com/michal-z/zig-gamedev) - DirectX 12 game development ecosystem.
*   [floooh/sokol-zig (⭐221)](https://github.com/floooh/sokol-zig) - [Sokol (⭐5.3k)](https://github.com/floooh/sokol) bindings.
*   [TM35-Metronome/metronome (⭐39)](https://github.com/TM35-Metronome/metronome) - A set of tools for modifying and randomizing Pokémon games.
...
*   [andrewrk/tetris (⭐319)](https://github.com/andrewrk/tetris) - A simple tetris clone.
*   [fabioarnold/snake-zig (⭐11)](https://github.com/fabioarnold/snake-zig) - A simple snake clone.
*   [Stenodyon/blink (⭐13)](https://github.com/Stenodyon/blink) - A game about building logic with lasers.
*   [thejoshwolfe/legend-of-swarkland (⭐88)](https://github.com/thejoshwolfe/legend-of-swarkland) - Hack-n-slash roguelike inspired by NetHack.
*   [tiehuis/zstack (⭐3)](https://github.com/tiehuis/zstack) - Line-race tetris mode.
*   [kooparse/zalgebra (⭐177)](https://github.com/kooparse/zalgebra) - Linear algebra library for games and real-time computer graphics.
*   [floooh/pacman.zig (⭐180)](https://github.com/floooh/pacman.zig) - A Pacman clone.
*   [dantecatalfamo/OpenCSE (⭐1)](https://github.com/dantecatalfamo/OpenCSE) - Free implementation of the Can't Stop Express dice game.

## GUI

*   [capy-ui/capy (⭐1.1k)](https://github.com/capy-ui/capy) - Cross-platform library for making true native GUIs.
*   [david-vanderson/gui (⭐109)](https://github.com/david-vanderson/gui) - Immediate mode GUI for Zig.
...
*   [fubark/cosmic (⭐302)](https://github.com/fubark/cosmic) - GUI toolkit.
*   [batiati/IUPforZig (⭐95)](https://github.com/batiati/IUPforZig) - Zig idiomatic and type-checked bindings for IUP Portable User Interface Toolkit.
*   [andrewrk/zig-sdl](https://github.com/andrewrk/zig-sdl) - Self-contained SDL2 package for Zig.
*   [Snektron/vulkan-zig (⭐320)](https://github.com/Snektron/vulkan-zig) - Vulkan binding generator.
*   [Avokadoen/zig\_vulkan (⭐39)](https://github.com/Avokadoen/zig_vulkan) - Toy renderer using Vulkan and GLFW.
...
*   [kassane/QML-zig (⭐59)](https://github.com/kassane/qml_zig) - QML bindings.
*   [cshenton/learnopengl (⭐125)](https://github.com/cshenton/learnopengl) - [Learn OpenGL](https://learnopengl.com) tutorials ported to Zig.
*   [ifreund/river (⭐2.5k)](https://github.com/ifreund/river) - Dynamic wayland compositor that takes inspiration from dwm and bspwm.
*   [Nelarius/weekend-raytracer-zig (⭐83)](https://github.com/Nelarius/weekend-raytracer-zig) - An implementation of the "Ray Tracing in One Weekend" book.
...
*   [donpdonp/zootdeck (⭐36)](https://github.com/donpdonp/zootdeck) - Fediverse GTK Desktop Reader.
...
*   [natecraddock/ziglua (⭐119)](https://github.com/natecraddock/ziglua) - Bindings for the Lua C API.
*   [ryoppippi/zigcv (⭐78)](https://github.com/ryoppippi/zigcv) - Bindings for OpenCV4.
*   [BraedonWooding/Lazy-Zig (⭐36)](https://github.com/BraedonWooding/Lazy-Zig) - Linq.
...
*   [kprotty/zap (⭐364)](https://github.com/kprotty/zap) - A collection of libraries which provide interfaces over the system for writing high performance applications.
*   [mlarouche/zigimg (⭐305)](https://github.com/mlarouche/zigimg) - Zig library for reading and writing different image formats.
*   [ziglibs/known-folders (⭐178)](https://github.com/ziglibs/known-folders) - Provides access to well-known folders across several operating systems.
...
*   [karlseguin/log.zig (⭐48)](https://github.com/karlseguin/log.zig) - Structured logging library.
...
*   [MasterQ32/zig-network (⭐335)](https://github.com/MasterQ32/zig-network) - Small network abstraction layer around TCP & UDP.
...
*   [lun-4/zigdig (⭐31)](https://github.com/lun-4/zigdig) - Naive DNS client library.
...
*   [Luukdegram/apple\_pie (⭐158)](https://github.com/Luukdegram/apple_pie) - HTTP 1.0/1.1 Server implementation.
...
*   [karlseguin/http.zig (⭐162)](https://github.com/karlseguin/http.zig) - HTTP/1.1 server.
*   [zigzap/zap (⭐1.3k)](https://github.com/zigzap/zap) - blazingly fast, robust HTTP server.

## Web

*   [andrewrk/lua-in-the-browser (⭐29)](https://github.com/andrewrk/lua-in-the-browser) - Using Zig to build Lua for WebAssembly.
*   [karlseguin/websocket.zig (⭐148)](https://github.com/karlseguin/websocket.zig) - A WebSocket implementation.
...
*   [shritesh/zig-wasm-dom (⭐115)](https://github.com/shritesh/zig-wasm-dom) - Zig + WebAssembly + JS + DOM.
*   [shritesh/zigfmt-web (⭐38)](https://github.com/shritesh/zigfmt-web) - Zig fmt on the web.
*   [zigwasm/wasm-zig (⭐24)](https://github.com/zigwasm/wasm-zig) - Common WASM runtime binding to C API.
...
*   [batiati/mustache-zig (⭐81)](https://github.com/batiati/mustache-zig) - Mustache implementation.
*   [floscodes/zerve (⭐30)](https://github.com/floscodes/zerve) - Simple framework for writing web services and web apps.
...
*   [marler8997/zigup (⭐390)](https://github.com/marler8997/zigup) - Download and manage zig compilers.
...
*   [zigtools/zpm (⭐78)](https://github.com/zigtools/zpm) - Unofficial Zig package manager.
*   [mattnite/gyro (⭐580)](https://github.com/mattnite/gyro) - Package manager with an index, build runner, and build dependencies.
*   [nektro/zigmod (⭐632)](https://github.com/nektro/zigmod) - Zig package manager.
*   [cheetah/asdf-zig (⭐22)](https://github.com/cheetah/asdf-zig) - Zig plugin for the ASDF package manager.
*   [mattnite/ezpkg (⭐24)](https://github.com/mattnite/ezpkg) - Zig Package Manager Expansion Pack.
*   [nix-community/zon2nix (⭐48)](https://github.com/nix-community/zon2nix) - Convert the dependencies in `build.zig.zon` to a Nix expression.

## Parser

*   [darithorn/zig-toml (⭐83)](https://github.com/darithorn/zig-toml) - A TOML parser.
*   [Himujjal/zig-json5 (⭐24)](https://github.com/Himujjal/zig-json5) - JSON5 parser resembling the `std.json` APIs.
*   [chwayne/rem (⭐87)](https://github.com/chwayne/rem) - An HTML parsing library.
*   [goto-bus-stop/ziguid (⭐7)](https://github.com/goto-bus-stop/ziguid) - GUID parsing/stringifying.
*   [Hejsil/zig-clap (⭐545)](https://github.com/Hejsil/zig-clap) - Simple command line argument parsing library.
*   [sam701/zig-cli (⭐82)](https://github.com/sam701/zig-cli) - Package for building command line apps.
...
*   [kivikakk/koino (⭐100)](https://github.com/kivikakk/koino) - CommonMark/GitHub Flavored Markdown parser and HTML renderer.
*   [kubkon/zig-yaml (⭐87)](https://github.com/kubkon/zig-yaml) - YAML parser.
...
*   [tiehuis/zig-regex (⭐110)](https://github.com/tiehuis/zig-regex) - A regex implementation.
*   [tiehuis/zig-ryu (⭐15)](https://github.com/tiehuis/zig-ryu) - Port of [ryu (⭐1.1k)](https://github.com/ulfjack/ryu).
*   [Vexu/zuri (⭐42)](https://github.com/Vexu/zuri) - URI parser.
...
*   [Arwalk/zig-protobuf (⭐123)](https://github.com/Arwalk/zig-protobuf) - Implementation of Protocol Buffers v3 leveraging Zig's comptime.
...
*   [InKryption/comath (⭐25)](https://github.com/InKryption/comath) - Calculate math expressions in comptime.

## Learning resources

*   [belse-de/zig-tut (⭐13)](https://github.com/belse-de/zig-tut) - A collection of small projects and tutorials to learn Zig.
*   [Sobeston/ziglearn (⭐399)](https://github.com/Sobeston/ziglearn) - Zig learning resources.
*   [zighelp/zighelp (⭐20)](https://github.com/zighelp/zighelp) - Get up to speed with Zig quickly (ziglearn fork).
*   [ratfactor/ziglings (⭐3.7k)](https://github.com/ratfactor/ziglings) - Learn Zig by fixing tiny example programs.
...
*   [andrewrk/SDL (⭐43)](https://github.com/andrewrk/SDL) - Simple Directmedia Layer.
*   [andrewrk/libz (⭐11)](https://github.com/andrewrk/libz) - Zlib data compression.
*   [andrewrk/ffmpeg (⭐46)](https://github.com/andrewrk/ffmpeg) - library only.
*   [andrewrk/libgroove (⭐282)](https://github.com/andrewrk/libgroove) - streaming audio processing library.
...
*   [kassane/wolfssl (⭐3)](https://github.com/kassane/wolfssl) - wolfssl library.
*   [kassane/libbpf (⭐1)](https://github.com/kassane/libbpf) - BPF CO-RE (Compile Once – Run Everywhere).
*   [kassane/winpthreads (⭐5)](https://github.com/kassane/winpthreads-zigbuild) - PThread library for MinGW.
*   [raysan5/raylib (⭐16k)](https://github.com/raysan5/raylib) - A simple and easy-to-use library to enjoy videogames programming.
...
*   [kassane/asio (⭐2)](https://github.com/kassane/asio) - (non-boost) Networking I/O library (w/ event-loop, C++14/17/20).
...
*   [kassane/libzmq (⭐1)](https://github.com/kassane/libzmq) - ZeroMQ core engine in C++ library.
...
*   [nrdmn/ilo\_license\_key (⭐13)](https://github.com/nrdmn/ilo_license_key) - ILO license key library.
...
*   [ve-nt/outfieldr](https://gitlab.com/ve-nt/outfieldr) - [TLDR (⭐46k)](https://github.com/tldr-pages/tldr) client.
*   [kubkon/zig-ios-example (⭐103)](https://github.com/kubkon/zig-ios-example) - Minimal `build.zig` for targeting iOS.
