...
*   [ziglibs/s2s (⭐74)](https://github.com/ziglibs/s2s) - Binary serialization format and library.
...
*   [kristoff-it/zig-cuckoofilter (⭐68)](https://github.com/kristoff-it/zig-cuckoofilter) - Production-ready Cuckoo Filters for any C ABI compatible target.
...
*   [hexops/xorfilter (⭐163)](https://github.com/hexops/xorfilter) - Xor Filters for checking if a key is part of a set.
*   [JakubSzark/zig-string (⭐106)](https://github.com/JakubSzark/zig-string) - UTF-8 string data structure.
...
*   [Hejsil/zig-midi (⭐15)](https://github.com/Hejsil/zig-midi)
...
*   [AndreaOrru/zen (⭐305)](https://github.com/AndreaOrru/zen) - Experimental operating system.
*   [andrewrk/clashos (⭐192)](https://github.com/andrewrk/clashos) - Multiplayer arcade game for bare metal Raspberry Pi 3 B+.
*   [andrewrk/HellOS (⭐180)](https://github.com/andrewrk/HellOS) - "hello world" x86 kernel example.
*   [chivay/vmt (⭐6)](https://github.com/chivay/vmt) - Toy OS.
*   [DorianXGH/Lukarnel (⭐13)](https://github.com/DorianXGH/Lukarnel) - A microkernel with Rust microservices.
*   [iguessthislldo/georgios (⭐35)](https://github.com/iguessthislldo/georgios) - Hobby Operating System.
...
*   [markfirmware/zig-bare-metal-raspberry-pi (⭐62)](https://github.com/markfirmware/zig-bare-metal-raspberry-pi) - Bare metal raspberry pi program.
*   [MasterQ32/RetrOS (⭐47)](https://github.com/MasterQ32/RetrOS) - A retro-style gaming console running on bare x86 metal.
*   [nrdmn/uefi-examples (⭐36)](https://github.com/nrdmn/uefi-examples) - UEFI examples.
*   [nrdmn/uefi-paint (⭐38)](https://github.com/nrdmn/uefi-paint) - UEFI-bootable touch paint app.
...
*   [SamTebbs33/pluto (⭐349)](https://github.com/SamTebbs33/pluto) - An x86 kernel.
*   [sjdh02/trOS (⭐43)](https://github.com/sjdh02/trOS) - Tiny aarch64 baremetal OS thingy.
*   [tralamazza/embedded\_zig (⭐55)](https://github.com/tralamazza/embedded_zig) - Minimal embedded ARM example (STM32F103 blue pill).
...
*   [oven-sh/bun (⭐41k)](https://github.com/oven-sh/bun) - Incredibly fast JavaScript runtime, bundler, transpiler and package manager – all in one.
*   [Vexu/bog (⭐413)](https://github.com/Vexu/bog) - Small, strongly typed, embeddable language.
*   [LoLa Programming Language](https://lola.random-projects.net/) - ([GitHub (⭐150)](https://github.com/MasterQ32/LoLa)) An embeddable programming language for game scripting.
...
*   [fubark/cyber (⭐750)](https://github.com/fubark/cyber) - Fast and concurrent scripting.

## Database

*   [coilhq/tigerbeetle (⭐2.3k)](https://github.com/coilhq/tigerbeetle) - A distributed financial accounting database designed for mission critical safety and performance.
*   [kristoff-it/redis-cuckoofilter (⭐214)](https://github.com/kristoff-it/redis-cuckoofilter) - Hashing-function agnostic Cuckoo filters for Redis.
*   [kristoff-it/zig-okredis (⭐148)](https://github.com/kristoff-it/zig-okredis) - Zero-allocation Client for Redis 6+.
*   [leroycep/sqlite-zig (⭐32)](https://github.com/leroycep/sqlite-zig) - SQLite bindings.
*   [vrischmann/zig-cassandra (⭐4)](https://github.com/vrischmann/zig-cassandra) - Client for Cassandra 2.1+.
*   [vrischmann/zig-sqlite (⭐196)](https://github.com/vrischmann/zig-sqlite) - SQLite wrapper.

## Editor plugins

*   [MarioAriasC/zig-support (⭐53)](https://github.com/MarioAriasC/zig-support) - Language support for JetBrains IDEs (IntelliJ, CLion and others)
...
*   [ziglang/vscode-zig (⭐302)](https://github.com/ziglang/vscode-zig) - Zig language support for VSCode.
*   [ziglang/zig-mode (⭐101)](https://github.com/ziglang/zig-mode) - Zig mode for Emacs.
*   [ziglang/zig.vim (⭐290)](https://github.com/ziglang/zig.vim) - Vim configuration for Zig.
*   [zigtools/zls (⭐1.4k)](https://github.com/zigtools/zls) - Zig LSP implementation + Zig Language Server.

## Emulators

*   [fengb/fundude (⭐149)](https://github.com/fengb/fundude) - Gameboy emulator for WASM.
...
*   [hexops/mach (⭐1.7k)](https://github.com/hexops/mach) - Game engine and graphics toolkit.
*   [michal-z/zig-gamedev (⭐1.4k)](https://github.com/michal-z/zig-gamedev) - DirectX 12 game development ecosystem.
*   [floooh/sokol-zig (⭐171)](https://github.com/floooh/sokol-zig) - [Sokol (⭐4.4k)](https://github.com/floooh/sokol) bindings.
...
*   [wendigojaeger/ZigGBA (⭐294)](https://github.com/wendigojaeger/ZigGBA) - SDK for creating Game Boy Advance games using Zig.
...
*   [andrewrk/tetris (⭐238)](https://github.com/andrewrk/tetris) - A simple tetris clone.
...
*   [thejoshwolfe/legend-of-swarkland (⭐79)](https://github.com/thejoshwolfe/legend-of-swarkland) - Hack-n-slash roguelike inspired by NetHack.
*   [tiehuis/zstack (⭐3)](https://github.com/tiehuis/zstack) - Line-race tetris mode.
*   [kooparse/zalgebra (⭐152)](https://github.com/kooparse/zalgebra) - Linear algebra library for games and real-time computer graphics.
...
*   [capy-ui/capy (⭐745)](https://github.com/capy-ui/capy) - Cross-platform library for making true native GUIs.
*   [david-vanderson/gui (⭐49)](https://github.com/david-vanderson/gui) - Immediate mode GUI for Zig.
*   [Aransentin/ZWL (⭐84)](https://github.com/Aransentin/ZWL) - Zig Windowing Library.
*   [prime31/zig-upaya (⭐121)](https://github.com/prime31/zig-upaya) - GUI toolkit.
*   [fubark/cosmic (⭐286)](https://github.com/fubark/cosmic) - GUI toolkit.
...
*   [Snektron/vulkan-zig (⭐224)](https://github.com/Snektron/vulkan-zig) - Vulkan binding generator.
*   [Avokadoen/zig\_vulkan (⭐36)](https://github.com/Avokadoen/zig_vulkan) - Toy renderer using Vulkan and GLFW.
*   [andrewrk/zig-vulkan-triangle (⭐69)](https://github.com/andrewrk/zig-vulkan-triangle) - Simple triangle displayed using Vulkan, GLFW, and Zig.
*   [kassane/QML-zig (⭐44)](https://github.com/kassane/qml_zig) - QML bindings.
...
*   [ifreund/river (⭐2.2k)](https://github.com/ifreund/river) - Dynamic wayland compositor that takes inspiration from dwm and bspwm.
...
*   [natecraddock/ziglua (⭐77)](https://github.com/natecraddock/ziglua) - Bindings for the Lua C API.
*   [ryoppippi/zigcv (⭐65)](https://github.com/ryoppippi/zigcv) - Bindings for OpenCV4.
...
*   [kprotty/zap (⭐325)](https://github.com/kprotty/zap) - A collection of libraries which provide interfaces over the system for writing high performance applications.
*   [mlarouche/zigimg (⭐219)](https://github.com/mlarouche/zigimg) - Zig library for reading and writing different image formats.
*   [ziglibs/known-folders (⭐150)](https://github.com/ziglibs/known-folders) - Provides access to well-known folders across several operating systems.
...
*   [kassane/libvlc-zig (⭐7)](https://github.com/kassane/libvlc-zig) - Zig bindings for libVLC media framework.
*   [karlseguin/log.zig (⭐38)](https://github.com/karlseguin/log.zig) - Structured logging library.
*   [dantecatalfamo/9p-zig (⭐2)](https://github.com/dantecatalfamo/9p-zig) - 9P2000 client/server library.

## Network

*   [MasterQ32/zig-network (⭐268)](https://github.com/MasterQ32/zig-network) - Small network abstraction layer around TCP & UDP.
...
*   [Luukdegram/apple\_pie (⭐145)](https://github.com/Luukdegram/apple_pie) - HTTP 1.0/1.1 Server implementation.
...
*   [frmdstryr/zhp (⭐287)](https://github.com/frmdstryr/zhp) - Featureful HTTP server.
*   [axgdev/telegram\_echobot\_zig (⭐4)](https://github.com/axgdev/telegram_echobot_zig) - Telegram echo bot.
*   [karlseguin/http.zig (⭐38)](https://github.com/karlseguin/http.zig) - HTTP/1.1 server.

## Web

*   [andrewrk/lua-in-the-browser (⭐25)](https://github.com/andrewrk/lua-in-the-browser) - Using Zig to build Lua for WebAssembly.
*   [karlseguin/websocket.zig (⭐96)](https://github.com/karlseguin/websocket.zig) - A WebSocket implementation.
*   [kivikakk/htmlentities.zig (⭐7)](https://github.com/kivikakk/htmlentities.zig) - HTML5 entity data.
*   [meheleventyone/zig-wasm-test (⭐40)](https://github.com/meheleventyone/zig-wasm-test) - A minimal WebAssembly example using Zig's build system.
*   [shritesh/zig-wasm-dom (⭐98)](https://github.com/shritesh/zig-wasm-dom) - Zig + WebAssembly + JS + DOM.
...
*   [zigwasm/wasmer-zig (⭐42)](https://github.com/zigwasm/wasmer-zig) - Bindings for the Wasmer WebAssembly runtime.
...
*   [marler8997/zigup (⭐274)](https://github.com/marler8997/zigup) - Download and manage zig compilers.
...
*   [zigtools/zpm (⭐63)](https://github.com/zigtools/zpm) - Unofficial Zig package manager.
*   [mattnite/gyro (⭐529)](https://github.com/mattnite/gyro) - Package manager with an index, build runner, and build dependencies.
*   [nektro/zigmod (⭐470)](https://github.com/nektro/zigmod) - Zig package manager.
...
*   [Hejsil/zig-clap (⭐413)](https://github.com/Hejsil/zig-clap) - Simple command line argument parsing library.
*   [sam701/zig-cli (⭐47)](https://github.com/sam701/zig-cli) - Package for building command line apps.
...
*   [kivikakk/koino (⭐87)](https://github.com/kivikakk/koino) - CommonMark/GitHub Flavored Markdown parser and HTML renderer.
*   [kubkon/zig-yaml (⭐67)](https://github.com/kubkon/zig-yaml) - YAML parser.
...
*   [tiehuis/zig-regex (⭐78)](https://github.com/tiehuis/zig-regex) - A regex implementation.
...
*   [Arwalk/zig-protobuf (⭐65)](https://github.com/Arwalk/zig-protobuf) - Implementation of Protocol Buffers v3 leveraging Zig's comptime.
...
*   [Sobeston/ziglearn (⭐314)](https://github.com/Sobeston/ziglearn) - Zig learning resources.
