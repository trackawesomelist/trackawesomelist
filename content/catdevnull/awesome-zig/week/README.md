...
*   [nine-lives-later/zzmq (⭐4)](https://github.com/nine-lives-later/zzmq) - ZeroMQ library, based on CZMQ.

### Parser / Package managers

*   [00JCIV00/cova (⭐70)](https://github.com/00JCIV00/cova) - Commands, Options, Values, Arguments. A simple yet robust cross-platform command line argument parsing library.
...
*   [karlseguin/pg.zig (⭐93)](https://github.com/karlseguin/pg.zig) - Native PostgreSQL client.

## [Sep 18 - Sep 24, 2023](/content/2023/38/README.md)

### Compilers and interpreters

*   [fulcrum-so/ziggy-pydust (⭐239)](https://github.com/fulcrum-so/ziggy-pydust) - [Python](https://python.org/) bindings.

## [Sep 04 - Sep 10, 2023](/content/2023/36/README.md)

### Concurrency

*   [mitchellh/libxev (⭐932)](https://github.com/mitchellh/libxev) - Cross-platform event-loop.
*   [kprotty/zefi (⭐32)](https://github.com/kprotty/zefi) - Fiber library.
*   [rsepassi/zigcoro (⭐55)](https://github.com/rsepassi/zigcoro) - coroutine-friendly, based on libxev.
...
*   [InKryption/comath (⭐36)](https://github.com/InKryption/comath) - Calculate math expressions in comptime.

### Learning resources / Package managers

*   [zighelp/zighelp (⭐26)](https://github.com/zighelp/zighelp) - Get up to speed with Zig quickly (ziglearn fork).

### C/C++ libraries packaged for Zig / C

*   [andrewrk/libz (⭐13)](https://github.com/andrewrk/libz) - Zlib data compression.
*   [kassane/openssl-zig (⭐4)](https://github.com/kassane/openssl-zig) - crypto, providers & ssl libraries only.
...
*   [ggerganov/llama.cpp (⭐53k)](https://github.com/ggerganov/llama.cpp) - Port of Facebook's LLaMA model in C/C++.
...
*   [karlseguin/zuckdb.zig (⭐44)](https://github.com/karlseguin/zuckdb.zig) - DuckDB wrapper.
...
*   [zigzap/zap (⭐1.7k)](https://github.com/zigzap/zap) - blazingly fast, robust HTTP server.
...
*   [andrewrk/ffmpeg (⭐104)](https://github.com/andrewrk/ffmpeg) - library only.
*   [andrewrk/libgroove (⭐285)](https://github.com/andrewrk/libgroove) - streaming audio processing library.
...
*   [floscodes/zerve (⭐37)](https://github.com/floscodes/zerve) - Simple framework for writing web services and web apps.

## [Apr 17 - Apr 23, 2023](/content/2023/16/README.md)

### Audio

*   [orhun/linuxwave (⭐474)](https://github.com/orhun/linuxwave) - Generate music from the entropy of Linux.
...
*   [karlseguin/log.zig (⭐64)](https://github.com/karlseguin/log.zig) - Structured logging library.

### Network / HTTP

*   [karlseguin/http.zig (⭐294)](https://github.com/karlseguin/http.zig) - HTTP/1.1 server.
...
*   [MasterQ32/zig-network (⭐373)](https://github.com/MasterQ32/zig-network) - Small network abstraction layer around TCP & UDP.
...
*   [hexops/mach (⭐2.7k)](https://github.com/hexops/mach) - Game engine and graphics toolkit.

### GUI

*   [david-vanderson/gui (⭐154)](https://github.com/david-vanderson/gui) - Immediate mode GUI for Zig.
...
*   [korandoru/setup-zig (⭐13)](https://github.com/korandoru/setup-zig) - Set up a specific version of Zig environment on GitHub Actions.
...
*   [sam701/zig-cli (⭐128)](https://github.com/sam701/zig-cli) - Package for building command line apps.

## [Jul 11 - Jul 17, 2022](/content/2022/28/README.md)

### Compilers and interpreters

*   [oven-sh/bun (⭐69k)](https://github.com/oven-sh/bun) - Incredibly fast JavaScript runtime, bundler, transpiler and package manager – all in one.
*   [squeek502/zua (⭐137)](https://github.com/squeek502/zua) - An implementation of Lua 5.1 for learning purposes.
...
*   [fubark/cosmic (⭐314)](https://github.com/fubark/cosmic) - GUI toolkit.

### Misc libraries

*   [natecraddock/ziglua (⭐167)](https://github.com/natecraddock/ziglua) - Bindings for the Lua C API.

### Web / Messaging

*   [karlseguin/websocket.zig (⭐205)](https://github.com/karlseguin/websocket.zig) - A WebSocket implementation.
...
*   [JakubSzark/zig-string (⭐213)](https://github.com/JakubSzark/zig-string) - UTF-8 string data structure.
...
*   [Arwalk/zig-protobuf (⭐165)](https://github.com/Arwalk/zig-protobuf) - Implementation of Protocol Buffers v3 leveraging Zig's comptime.

## [Mar 07 - Mar 13, 2022](/content/2022/10/README.md)

### Algorithms and data structures

*   [ziglibs/s2s (⭐112)](https://github.com/ziglibs/s2s) - Binary serialization format and library.
...
*   [batiati/mustache-zig (⭐92)](https://github.com/batiati/mustache-zig) - Mustache implementation.
...
*   [Snektron/vulkan-zig (⭐366)](https://github.com/Snektron/vulkan-zig) - Vulkan binding generator.
...
*   [emekoi/deque.zig (⭐12)](https://github.com/emekoi/deque.zig) - A lock free chase-lev deque.
...
*   [hexops/xorfilter (⭐231)](https://github.com/hexops/xorfilter) - Xor Filters for checking if a key is part of a set.

### Allocators and memory

*   [fengb/zee\_alloc (⭐78)](https://github.com/fengb/zee_alloc) - Tiny allocator primarily targeting WebAssembly.
...
*   [AndreaOrru/zen (⭐378)](https://github.com/AndreaOrru/zen) - Experimental operating system.
*   [andrewrk/clashos (⭐206)](https://github.com/andrewrk/clashos) - Multiplayer arcade game for bare metal Raspberry Pi 3 B+.
*   [andrewrk/HellOS (⭐227)](https://github.com/andrewrk/HellOS) - "hello world" x86 kernel example.
...
*   [jzck/kernel-zig (⭐410)](https://github.com/jzck/kernel-zig) - Hobby x86 kernel.
...
*   [markfirmware/zig-bare-metal-raspberry-pi (⭐80)](https://github.com/markfirmware/zig-bare-metal-raspberry-pi) - Bare metal raspberry pi program.
...
*   [SamTebbs33/pluto (⭐466)](https://github.com/SamTebbs33/pluto) - An x86 kernel.
...
*   [Vexu/bog (⭐504)](https://github.com/Vexu/bog) - Small, strongly typed, embeddable language.
*   [LoLa Programming Language](https://lola.random-projects.net/) - ([GitHub (⭐182)](https://github.com/MasterQ32/LoLa)) An embeddable programming language for game scripting.
*   [dantecatalfamo/brainfuck-zig (⭐8)](https://github.com/dantecatalfamo/brainfuck-zig) - Brainfuck interpreter.

### Database

*   [coilhq/tigerbeetle (⭐6.2k)](https://github.com/coilhq/tigerbeetle) - A distributed financial accounting database designed for mission critical safety and performance.
...
*   [leroycep/sqlite-zig (⭐54)](https://github.com/leroycep/sqlite-zig) - SQLite bindings.
*   [vrischmann/zig-cassandra (⭐5)](https://github.com/vrischmann/zig-cassandra) - Client for Cassandra 2.1+.
*   [vrischmann/zig-sqlite (⭐305)](https://github.com/vrischmann/zig-sqlite) - SQLite wrapper.
...
*   [ziglang/sublime-zig-language (⭐72)](https://github.com/ziglang/sublime-zig-language) - Zig language support for Sublime Text.
*   [ziglang/vscode-zig (⭐459)](https://github.com/ziglang/vscode-zig) - Zig language support for VSCode.
*   [ziglang/zig-mode (⭐138)](https://github.com/ziglang/zig-mode) - Zig mode for Emacs.
*   [ziglang/zig.vim (⭐394)](https://github.com/ziglang/zig.vim) - Vim configuration for Zig.
...
*   [floooh/kc85.zig (⭐42)](https://github.com/floooh/kc85.zig) - A KC85 emulator.

### Game tools and libraries

*   [michal-z/zig-gamedev (⭐1.9k)](https://github.com/michal-z/zig-gamedev) - DirectX 12 game development ecosystem.
*   [floooh/sokol-zig (⭐263)](https://github.com/floooh/sokol-zig) - [Sokol (⭐5.6k)](https://github.com/floooh/sokol) bindings.
...
*   [andrewrk/tetris (⭐340)](https://github.com/andrewrk/tetris) - A simple tetris clone.
...
*   [kooparse/zalgebra (⭐199)](https://github.com/kooparse/zalgebra) - Linear algebra library for games and real-time computer graphics.
*   [floooh/pacman.zig (⭐195)](https://github.com/floooh/pacman.zig) - A Pacman clone.

### GUI

*   [batiati/IUPforZig (⭐108)](https://github.com/batiati/IUPforZig) - Zig idiomatic and type-checked bindings for IUP Portable User Interface Toolkit.
...
*   [kassane/QML-zig (⭐75)](https://github.com/kassane/qml_zig) - QML bindings.
*   [cshenton/learnopengl (⭐129)](https://github.com/cshenton/learnopengl) - [Learn OpenGL](https://learnopengl.com) tutorials ported to Zig.
*   [ifreund/river (⭐2.8k)](https://github.com/ifreund/river) - Dynamic wayland compositor that takes inspiration from dwm and bspwm.
*   [Nelarius/weekend-raytracer-zig (⭐86)](https://github.com/Nelarius/weekend-raytracer-zig) - An implementation of the "Ray Tracing in One Weekend" book.
...
*   [kprotty/zap (⭐378)](https://github.com/kprotty/zap) - A collection of libraries which provide interfaces over the system for writing high performance applications.
*   [mlarouche/zigimg (⭐372)](https://github.com/mlarouche/zigimg) - Zig library for reading and writing different image formats.
*   [ziglibs/known-folders (⭐195)](https://github.com/ziglibs/known-folders) - Provides access to well-known folders across several operating systems.
...
*   [frmdstryr/zhp (⭐345)](https://github.com/frmdstryr/zhp) - Featureful HTTP server.
...
*   [meheleventyone/zig-wasm-test (⭐46)](https://github.com/meheleventyone/zig-wasm-test) - A minimal WebAssembly example using Zig's build system.
*   [shritesh/zig-wasm-dom (⭐128)](https://github.com/shritesh/zig-wasm-dom) - Zig + WebAssembly + JS + DOM.
...
*   [marler8997/zigup (⭐472)](https://github.com/marler8997/zigup) - Download and manage zig compilers.

### Zig development tools / Package managers

*   [zigtools/zpm (⭐80)](https://github.com/zigtools/zpm) - Unofficial Zig package manager.
*   [mattnite/gyro (⭐576)](https://github.com/mattnite/gyro) - Package manager with an index, build runner, and build dependencies.
*   [nektro/zigmod (⭐681)](https://github.com/nektro/zigmod) - Zig package manager.
...
*   [chwayne/rem (⭐96)](https://github.com/chwayne/rem) - An HTML parsing library.
*   [Hejsil/zig-clap (⭐692)](https://github.com/Hejsil/zig-clap) - Simple command line argument parsing library.
...
*   [kubkon/zig-yaml (⭐103)](https://github.com/kubkon/zig-yaml) - YAML parser.
*   [tiehuis/zig-regex (⭐141)](https://github.com/tiehuis/zig-regex) - A regex implementation.
...
*   [Sobeston/ziglearn (⭐495)](https://github.com/Sobeston/ziglearn) - Zig learning resources.
...
*   [kubkon/zig-ios-example (⭐116)](https://github.com/kubkon/zig-ios-example) - Minimal `build.zig` for targeting iOS.