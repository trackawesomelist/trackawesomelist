...
*   [floscodes/zerve (⭐38)](https://github.com/floscodes/zerve) - Simple framework for writing web services and web apps.
...
*   [rafaelbreno/zig-os (⭐26)](https://github.com/rafaelbreno/zig-os) - A simple OS following Philipp Oppermann's posts "Writing an OS in Rust".
...
*   [ziglibs/s2s (⭐114)](https://github.com/ziglibs/s2s) - Binary serialization format and library.
