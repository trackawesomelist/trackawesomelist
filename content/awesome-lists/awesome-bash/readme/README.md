...
*   [learnyoubash (⭐690)](https://github.com/denysdovhan/learnyoubash) - An interactive workshopper which will teach you how to use the terminal and write your the first Bash script.
...
*   [aliases (⭐475)](https://github.com/sebglazebrook/aliases) - Contextual, dynamic, organized aliases for the bash shell
*   [bashhub (⭐1.1k)](https://github.com/rcaloras/bashhub-client) - :cloud: Bash history in the cloud. Indexed and searchable.
*   [bashhub-server (⭐275)](https://github.com/nicksherron/bashhub-server) - Privately hosted open source bashhub server.
*   [bashmarks (⭐1.8k)](https://github.com/huyng/bashmarks) - Directory bookmarks for the shell
*   [commacd (⭐345)](https://github.com/shyiko/commacd) - A faster way to move around in Bash
...
*   [sshrc (⭐143)](https://github.com/cdown/sshrc) - Bring your .bashrc, .vimrc, etc. with you when you SSH
...
*   [aphrodite-terminal-theme (⭐84)](https://github.com/win0err/aphrodite-terminal-theme) — Minimalistic theme (prompt) for sexy terminals.
*   [bash-git-prompt (⭐6.5k)](https://github.com/magicmonty/bash-git-prompt) - An informative and fancy Bash prompt for Git users
*   [bash-powerline (⭐861)](https://github.com/riobard/bash-powerline) - Powerline-style Bash prompt in pure Bash script
...
*   [progress-bar.sh (⭐217)](https://github.com/edouard-lopez/progress-bar.sh) - Simple & sexy progressbar for `bash`, give it a duration and it will do the rest ![progress-bar.sh in action](http://pix.toile-libre.org/upload/original/1476311497.gif).
...
*   [mkdkr (⭐334)](https://github.com/rosineygp/mkdkr) - Make + Docker + Shell = CI Pipeline

## Downloading and Serving

*Self-hosted, lightweight servers and networking tools written in shell scripts.*

*   [balls (⭐844)](https://github.com/jneen/balls) - Bash on Balls
...
*   [bash2048 (⭐868)](https://github.com/mydzor/bash2048) - Bash implementation of 2048 game
...
*   [Bash One-Liners](http://www.bashoneliners.com/) -  A collection of practical or just pure awesome bash one-liners ([repos (⭐199)](https://github.com/janosgyerik/bashoneliners) by @[janosgyerik](https://github.com/janosgyerik))
...
*   [async-bash (⭐122)](https://github.com/zombieleet/async-bash) - implementation of async functions in bash
...
*   [Bashmatic (⭐97)](https://github.com/kigster/bashmatic) - an easy to use DSL library for building BASH-based tooling & installers (900+ functions).
...
*   [bash-modules (⭐114)](https://github.com/vlisivka/bash-modules) - a collection of modules for [unofficial strict mode](http://redsymbol.net/articles/unofficial-bash-strict-mode/)
*   [bash\_unit (⭐539)](https://github.com/pgrange/bash_unit) -  bash unit testing enterprise edition framework for professionals
*   [mo (⭐495)](https://github.com/tests-always-included/mo) - Mustache templates in pure bash
...
*   [shfmt (⭐5.9k)](https://github.com/mvdan/sh) - Format bash programs
*   [shunit2 (⭐1.5k)](https://github.com/kward/shunit2) - A unit test framework for Bash scripts with a flavour of JUnit/PyUnit
*   [DevOps-Bash-tools (⭐1.3k)](https://github.com/HariSekhon/DevOps-Bash-tools) - 750+ DevOps Shell Scripts and Advanced Bash environment
