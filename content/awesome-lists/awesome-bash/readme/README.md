...
*Inspired by the [awesome (⭐266k)](https://github.com/sindresorhus/awesome) list thing.*

In addition to this list, you should read the list [awesome-shell (⭐28k)](https://github.com/alebcay/awesome-shell). It is a curated list of awesome command-line frameworks, toolkits, guides and gizmos. You may also want to check [awesome-zsh (⭐13k)](https://github.com/unixorn/awesome-zsh-plugins) or [awesome-fish (⭐3.6k)](https://github.com/bucaran/awesome-fish). If you are looking for more lists, check [sindresorhus/awesome (⭐266k)](https://github.com/sindresorhus/awesome).
...
*   [bash-handbook (⭐5.4k)](https://github.com/denysdovhan/bash-handbook) - A handbook for those who want to learn Bash without diving in too deeply
...
*   [learnyoubash (⭐695)](https://github.com/denysdovhan/learnyoubash) - An interactive workshopper which will teach you how to use the terminal and write your the first Bash script.
...
*   [aliases (⭐488)](https://github.com/sebglazebrook/aliases) - Contextual, dynamic, organized aliases for the bash shell
*   [bashhub (⭐1.2k)](https://github.com/rcaloras/bashhub-client) - :cloud: Bash history in the cloud. Indexed and searchable.
*   [bashhub-server (⭐283)](https://github.com/nicksherron/bashhub-server) - Privately hosted open source bashhub server.
*   [bashmarks (⭐1.8k)](https://github.com/huyng/bashmarks) - Directory bookmarks for the shell
*   [ble.sh (⭐1.5k)](https://github.com/akinomyoga/ble.sh) - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
*   [commacd (⭐353)](https://github.com/shyiko/commacd) - A faster way to move around in Bash
*   [has (⭐538)](https://github.com/kdabir/has) - `has` helps you check presence of various command line tools and their versions on path
*   [hstr (⭐3.7k)](https://github.com/dvorka/hstr) - Bash History Suggest Box
*   [qfc (⭐563)](https://github.com/pindexis/qfc) - File-completion widget for Bash and Zsh
*   [sshrc (⭐153)](https://github.com/cdown/sshrc) - Bring your .bashrc, .vimrc, etc. with you when you SSH
*   [zoxide (⭐11k)](https://github.com/ajeetdsouza/zoxide) - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.

## Customization

*Custom prompts, color themes, etc.*

*   [aphrodite-terminal-theme (⭐93)](https://github.com/win0err/aphrodite-terminal-theme) — Minimalistic theme (prompt) for sexy terminals.
*   [bash-git-prompt (⭐6.5k)](https://github.com/magicmonty/bash-git-prompt) - An informative and fancy Bash prompt for Git users
*   [bash-powerline (⭐865)](https://github.com/riobard/bash-powerline) - Powerline-style Bash prompt in pure Bash script
...
*   [gittify (⭐64)](https://github.com/momeni/gittify) - A colorful Bash prompt + customized Git aliases
*   [liquidprompt (⭐4.3k)](https://github.com/nojhan/liquidprompt) - A full-featured & carefully designed adaptive prompt for Bash & Zsh
*   [mysql-colorize (⭐96)](https://github.com/horosgrisa/mysql-colorize.bash) -  Colorization for mysql comand-line client
*   [oh-my-git (⭐3.6k)](https://github.com/arialdomartini/oh-my-git) - An opinionated git prompt for bash and zsh
*   [progress-bar.sh (⭐219)](https://github.com/edouard-lopez/progress-bar.sh) - Simple & sexy progressbar for `bash`, give it a duration and it will do the rest ![progress-bar.sh in action](http://pix.toile-libre.org/upload/original/1476311497.gif).
...
*   [BigBash (⭐278)](https://github.com/zalando/bigbash) - Open-source converter that generates a bash one-liner from an SQL Select query, no database necessary
...
*   [git-sh (⭐728)](https://github.com/rtomayko/git-sh) - A customized Bash environment suitable for Git work
*   [mkdkr (⭐339)](https://github.com/rosineygp/mkdkr) - Make + Docker + Shell = CI Pipeline
...
*   [ngincat (⭐167)](https://github.com/jaburns/ngincat) - Tiny Bash HTTP server using netcat
...
*   [bash2048 (⭐876)](https://github.com/mydzor/bash2048) - Bash implementation of 2048 game
*   [minesweeper (⭐53)](https://github.com/feherke/Bash-script/tree/master/minesweeper) - Bash implementation of minesweeper
...
*   [Bash One-Liners](http://www.bashoneliners.com/) -  A collection of practical or just pure awesome bash one-liners ([repos (⭐200)](https://github.com/janosgyerik/bashoneliners) by @[janosgyerik](https://github.com/janosgyerik))
...
*   [ansi (⭐518)](https://github.com/fidian/ansi) - ANSI escape codes in pure bash - change text color, position the cursor, much more
...
*   [async-bash (⭐127)](https://github.com/zombieleet/async-bash) - implementation of async functions in bash
...
*   [bashful (⭐582)](https://github.com/jmcantrell/bashful) - A collection of libraries to simplify writing Bash scripts
*   [bashify (⭐98)](https://github.com/zombieleet/bashify) - few helper functions in bash ( especially string manipulation functions)
*   [bashing (⭐72)](https://github.com/xsc/bashing) - Smashing Bash into Pieces - Bash framework for creating command line tools
...
*   [Bashmatic (⭐102)](https://github.com/kigster/bashmatic) - an easy to use DSL library for building BASH-based tooling & installers (900+ functions).
*   [BashScriptTestingLibrary (⭐191)](https://github.com/rafritts/BashScriptTestingLibrary) - A unit testing framework for Bash scripts
*   [Bash Infinity (⭐5.5k)](https://github.com/niieani/bash-oo-framework) - A modern boilerplate / framework / standard library for bash
*   [bash-modules (⭐116)](https://github.com/vlisivka/bash-modules) - a collection of modules for [unofficial strict mode](http://redsymbol.net/articles/unofficial-bash-strict-mode/)
*   [bash\_unit (⭐545)](https://github.com/pgrange/bash_unit) -  bash unit testing enterprise edition framework for professionals
*   [mo (⭐509)](https://github.com/tests-always-included/mo) - Mustache templates in pure bash
*   [semver\_bash (⭐234)](https://github.com/cloudflare/semver_bash) - Semantic Versioning in Bash
*   [shellcheck (⭐33k)](https://github.com/koalaman/shellcheck) - A static analysis tool for shell scripts
*   [shfmt (⭐6.1k)](https://github.com/mvdan/sh) - Format bash programs
*   [shunit2 (⭐1.5k)](https://github.com/kward/shunit2) - A unit test framework for Bash scripts with a flavour of JUnit/PyUnit
*   [DevOps-Bash-tools (⭐1.8k)](https://github.com/HariSekhon/DevOps-Bash-tools) - 750+ DevOps Shell Scripts and Advanced Bash environment

## Just for fun

*   [pokeget (⭐27)](https://github.com/talwat/pokeget) - Displays sprites of pokemon in the terminal
...
Other amazingly awesome lists can be found in [awesome-awesome (⭐2.5k)](https://github.com/emijrp/awesome-awesome) and [awesome-awesomeness (⭐30k)](https://github.com/bayandin/awesome-awesomeness).
