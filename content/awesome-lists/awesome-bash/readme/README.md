...
In addition to this list, you should read the list [awesome-shell (⭐30k)](https://github.com/alebcay/awesome-shell). It is a curated list of awesome command-line frameworks, toolkits, guides and gizmos. You may also want to check [awesome-zsh (⭐14k)](https://github.com/unixorn/awesome-zsh-plugins) or [awesome-fish (⭐3.7k)](https://github.com/bucaran/awesome-fish). If you are looking for more lists, check [sindresorhus/awesome (⭐283k)](https://github.com/sindresorhus/awesome).
