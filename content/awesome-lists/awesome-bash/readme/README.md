...
In addition to this list, you should read the list [awesome-shell (⭐29k)](https://github.com/alebcay/awesome-shell). It is a curated list of awesome command-line frameworks, toolkits, guides and gizmos. You may also want to check [awesome-zsh (⭐14k)](https://github.com/unixorn/awesome-zsh-plugins) or [awesome-fish (⭐3.6k)](https://github.com/bucaran/awesome-fish). If you are looking for more lists, check [sindresorhus/awesome (⭐272k)](https://github.com/sindresorhus/awesome).
...
*   [learnyoubash (⭐705)](https://github.com/denysdovhan/learnyoubash) - An interactive workshopper which will teach you how to use the terminal and write your the first Bash script.
...
*   [aliases (⭐491)](https://github.com/sebglazebrook/aliases) - Contextual, dynamic, organized aliases for the bash shell
*   [bashhub (⭐1.2k)](https://github.com/rcaloras/bashhub-client) - :cloud: Bash history in the cloud. Indexed and searchable.
*   [bashhub-server (⭐282)](https://github.com/nicksherron/bashhub-server) - Privately hosted open source bashhub server.
...
*   [has (⭐554)](https://github.com/kdabir/has) - `has` helps you check presence of various command line tools and their versions on path
*   [hstr (⭐3.7k)](https://github.com/dvorka/hstr) - Bash History Suggest Box
*   [qfc (⭐565)](https://github.com/pindexis/qfc) - File-completion widget for Bash and Zsh
*   [sshrc (⭐156)](https://github.com/cdown/sshrc) - Bring your .bashrc, .vimrc, etc. with you when you SSH
...
*   [bash-powerline (⭐867)](https://github.com/riobard/bash-powerline) - Powerline-style Bash prompt in pure Bash script
...
*   [progress-bar.sh (⭐222)](https://github.com/edouard-lopez/progress-bar.sh) - Simple & sexy progressbar for `bash`, give it a duration and it will do the rest ![progress-bar.sh in action](http://pix.toile-libre.org/upload/original/1476311497.gif).
...
*   [BigBash (⭐279)](https://github.com/zalando/bigbash) - Open-source converter that generates a bash one-liner from an SQL Select query, no database necessary
...
*   [mkdkr (⭐342)](https://github.com/rosineygp/mkdkr) - Make + Docker + Shell = CI Pipeline

## Downloading and Serving

*Self-hosted, lightweight servers and networking tools written in shell scripts.*

*   [balls (⭐843)](https://github.com/jneen/balls) - Bash on Balls
...
*   [ansi (⭐528)](https://github.com/fidian/ansi) - ANSI escape codes in pure bash - change text color, position the cursor, much more
...
*   [bashful (⭐585)](https://github.com/jmcantrell/bashful) - A collection of libraries to simplify writing Bash scripts
...
*   [Bashmatic (⭐104)](https://github.com/kigster/bashmatic) - an easy to use DSL library for building BASH-based tooling & installers (900+ functions).
...
*   [bash-modules (⭐117)](https://github.com/vlisivka/bash-modules) - a collection of modules for [unofficial strict mode](http://redsymbol.net/articles/unofficial-bash-strict-mode/)
...
*   [mo (⭐518)](https://github.com/tests-always-included/mo) - Mustache templates in pure bash
*   [semver\_bash (⭐237)](https://github.com/cloudflare/semver_bash) - Semantic Versioning in Bash
...
*   [pokeget (⭐28)](https://github.com/talwat/pokeget) - Displays sprites of pokemon in the terminal
...
Other amazingly awesome lists can be found in [awesome-awesome (⭐2.5k)](https://github.com/emijrp/awesome-awesome) and [awesome-awesomeness (⭐31k)](https://github.com/bayandin/awesome-awesomeness).
