...
*   [Flame (⭐312)](https://github.com/easafe/purescript-flame) - A library that provides The Elm Architecture in PureScript.
...
*   [Lustre (⭐1.9k)](https://github.com/lustre-labs/lustre) - A library that provides The Elm Architecture in Gleam.
*   [Miso (⭐2.3k)](https://github.com/dmjio/miso) - A library that provides The Elm Architecture in Haskell.
*   [Mobius (⭐1.3k)](https://github.com/spotify/mobius) - Elm-like abstractions for android apps, created by Spotify.
*   [React-tea-cup (⭐27)](https://github.com/vankeisb/react-tea-cup) - A thin library that provides The Elm Architecture in react, used by IBM.
...
*   [elm-starter (⭐88)](https://github.com/lucamug/elm-starter) - An experimental Elm-based bootstrapper that can also be plugged into already existing Elm applications.
...
*   [Regex Nodes (⭐38)](https://github.com/johannesvollmer/regex-nodes) - A [node-based visual editor for fiddling with regular expressions](https://johannesvollmer.com/regex-nodes/), built with Elm.
...
*   [Elm Bridge (⭐105)](https://github.com/agrafix/elm-bridge) - Generate Elm types from Haskell
*   [Elm CodeGen (⭐142)](https://github.com/mdgriffith/elm-codegen) - Generate Elm code
*   [elm-gql (⭐70)](https://github.com/vendrinc/elm-gql) - Generate GraphQl client code from GraphQL queries
*   [elm-graphql (⭐784)](https://github.com/dillonkearns/elm-graphql) - Generate GraphQl client code from GraphQL schemas
*   [HTML to Elm](http://mbylstra.github.io/html-to-elm/) - Convert HTML to Elm Html. Useful when porting an app to Elm.
*   [JSON Schema to Elm (⭐90)](https://github.com/dragonwasrobot/json-schema-to-elm) - Generates Elm types, JSON decoders, JSON encoders and fuzz tests from JSON schema specifications
*   [OpenApi Generator (⭐25k)](https://github.com/OpenAPITools/openapi-generator) - Generate OpenApi types for Elm.
...
*   [Spades (⭐300)](https://github.com/rogeriochaves/spades) - Start an Elm SPA ready to the real world.

### Compile and bundle / Outdated Boilerplates

*   [elm-compiler (⭐7.7k)](https://github.com/elm/compiler) - The official Elm compiler.
...
*   [vite-plugin-elm (⭐214)](https://github.com/hmsk/vite-plugin-elm) - Vite plugin for Elm.
...
*   [Elm Watch (⭐178)](https://github.com/lydell/elm-watch) - `elm make` in watch mode. Fast and reliable.
...
*   [elm-posix (⭐92)](https://github.com/albertdahlin/elm-posix) - Write CLI programs using Elm
...
*   [Elm TS Interop (⭐43)](https://github.com/dillonkearns/elm-ts-json) - Build up Encoders/Decoders between Elm and TypeScript.
...
*   [haskell-to-elm (⭐62)](https://github.com/folq/haskell-to-elm) - Generate Elm types, encoders, and decoders from Haskell types
...
*   [Elm Doc Preview (⭐133)](https://github.com/dmy/elm-doc-preview) - Elm offline documentation previewer.
...
*   [Litvis (⭐399)](https://github.com/gicentre/litvis) - Literate Visualization with Elm
...
*   [Elm Review (⭐274)](https://github.com/jfmengels/elm-review) - Code reviewer for the Elm programming language.
...
*   [emacs-elm-mode (⭐381)](https://github.com/jcollard/elm-mode) - Syntax highlighting, Elm REPL, Elm make and Elm format integration for the Emacs editor.

### Editor plugins / IntelliJ

*   [elm-plugin (⭐404)](https://github.com/klazuka/intellij-elm) - Elm plugin for IntelliJ IDEA.

### Editor plugins / Sublime Text

*   [LSP-elm (⭐8)](https://github.com/sublimelsp/LSP-elm) - Elm Language Server for Sublime (Recommended).
*   [Elm Language Server (⭐432)](https://github.com/elm-tooling/elm-language-server#sublime) - Language server implementation for Elm
...
*   [Elm Spec (⭐33)](https://github.com/brian-watkins/elm-spec) - Describe the behavior of Elm programs.
...
*   [Elm Batteries (⭐119)](https://github.com/cedricss/elm-batteries) - A project template and generator for Elm, Parcel, Cypress and Netlify
...
*   [Codings hints (⭐7.7k)](https://github.com/elm/compiler/tree/master/hints) - A list of README files by Evan.
...
*   [elm-games (⭐145)](https://github.com/rofrol/elm-games) - An excellent list of games made in Elm
...
*   [Kanban Board in Elm (⭐305)](https://github.com/huytd/kanelm) - A kanban board (trello-alike) built with Elm and HTML5 Drag & Drop API
...
*   [Elm Narrative Engine (⭐136)](https://github.com/jschomay/elm-narrative-engine) - A framework for building interactive fiction style stories in Elm. Detailed example [elmnarrativeengine.com](http://elmnarrativeengine.com) shows how to build a "chose your own adventure" game; perfect for beginners. **Elm v.0.19**
...
*   [Learn Elm (⭐488)](https://github.com/dwyl/learn-elm) - Discover the beautiful programming language that makes front-end web apps a joy to build and maintain!

### Community and Support / Games

*   [Companies using Elm (⭐489)](https://github.com/jah2488/elm-companies) - A list of companies using Elm in production.
...
*   [Iced (⭐28k)](https://github.com/hecrj/iced) - A cross-platform GUI library for Rust, inspired by Elm
...
*   [Elm test (⭐240)](https://github.com/elm-explorations/test) - Unit and fuzz tests
*   [Elm Program test (⭐94)](https://github.com/avh4/elm-program-test/tree/3.0.0) - Test complete Elm programs
...
*   [Elmish (⭐882)](https://github.com/elmish/elmish) - Elm-like abstractions for F# apps
...
*   [elm-serverless (⭐167)](https://github.com/ktonon/elm-serverless) Run Elm 0.18 on Cloud Functions using the Serverless Frameworks
...
*   [elm-webpack-4-starter (⭐113)](https://github.com/romariolopezc/elm-webpack-4-starter) - Elm webpack 4 starter template.
...
*   [elm-webpack-starter (⭐852)](https://github.com/moarwick/elm-webpack-starter) - A simple Webpack setup for writing Elm apps.
...
*   [elm-package (⭐212)](https://github.com/elm-lang/elm-package) - Command line tool to share Elm libraries.
