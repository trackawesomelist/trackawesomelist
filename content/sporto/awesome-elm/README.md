...
[🏠 Home](/README.md) · [🔍 Search](https://www.trackawesomelist.com/search/) · [🔥 Feed](https://www.trackawesomelist.com/sporto/awesome-elm/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [❤️  Sponsor](https://github.com/sponsors/theowenyoung) · [😺 sporto/awesome-elm](https://github.com/sporto/awesome-elm) · ⭐ 3.7K · 🏷️ Programming Languages
...
*   [Flame (⭐320)](https://github.com/easafe/purescript-flame) - A library that provides The Elm Architecture in PureScript.
*   [Hyperapp (⭐19k)](https://github.com/jorgebucaran/hyperapp) - A library that provide The Elm Architecture in JavaScript.
*   [Indigo](https://indigoengine.io/) - Indigo is an Elm-inspired game engine for Scala.js.
*   [Lustre (⭐2.4k)](https://github.com/lustre-labs/lustre) - A library that provides The Elm Architecture in Gleam.
*   [Miso (⭐2.4k)](https://github.com/dmjio/miso) - A library that provides The Elm Architecture in Haskell.
*   [Mobius (⭐1.3k)](https://github.com/spotify/mobius) - Elm-like abstractions for android apps, created by Spotify.
*   [React-tea-cup (⭐33)](https://github.com/vankeisb/react-tea-cup) - A thin library that provides The Elm Architecture in react, used by IBM.
*   [Roc (⭐5.9k)](https://github.com/roc-lang/roc) - A language that targets WebAssembly and machine code inspired by Elm.
...
*   [elm-starter (⭐90)](https://github.com/lucamug/elm-starter) - An experimental Elm-based bootstrapper that can also be plugged into already existing Elm applications.
...
*   [Regex Nodes (⭐41)](https://github.com/johannesvollmer/regex-nodes) - A [node-based visual editor for fiddling with regular expressions](https://johannesvollmer.com/regex-nodes/), built with Elm.
...
*   [Elm Bridge (⭐107)](https://github.com/agrafix/elm-bridge) - Generate Elm types from Haskell
*   [Elm CodeGen (⭐146)](https://github.com/mdgriffith/elm-codegen) - Generate Elm code
*   [elm-gql (⭐71)](https://github.com/vendrinc/elm-gql) - Generate GraphQl client code from GraphQL queries
*   [elm-graphql (⭐789)](https://github.com/dillonkearns/elm-graphql) - Generate GraphQl client code from GraphQL schemas
*   [JSON Schema to Elm (⭐92)](https://github.com/dragonwasrobot/json-schema-to-elm) - Generates Elm types, JSON decoders, JSON encoders and fuzz tests from JSON schema specifications
*   [OpenApi Generator (⭐26k)](https://github.com/OpenAPITools/openapi-generator) - Generate OpenApi types for Elm.
*   [Quicktype (⭐14k)](https://github.com/quicktype/quicktype) - Generate JSON decoders and encoders from JSON
*   [Travelm Agency (⭐50)](https://github.com/andreasewering/travelm-agency) - Generate typesafe Elm code from translation files
...
*   [elm-compiler (⭐7.8k)](https://github.com/elm/compiler) - The official Elm compiler.
...
*   [vite-plugin-elm (⭐217)](https://github.com/hmsk/vite-plugin-elm) - Vite plugin for Elm.
...
*   [Protoc Gen Elm (⭐19)](https://github.com/andreasewering/protoc-gen-elm) - Generate Protobuf En/Decoders from .proto files

### Examples / Games

*   [TheSpace App (⭐4)](https://github.com/thematters/thespace-app) - A reddit place like DApp with blockchain and canvas(through port) integration in Elm.

## [Sep 15, 2022](/content/2022/09/15/README.md)

### Run Elm / Outdated Boilerplates

*   [Elm Watch (⭐186)](https://github.com/lydell/elm-watch) - `elm make` in watch mode. Fast and reliable.
...
*   [elm-posix (⭐93)](https://github.com/albertdahlin/elm-posix) - Write CLI programs using Elm
...
*   [Elm TS Interop (⭐45)](https://github.com/dillonkearns/elm-ts-json) - Build up Encoders/Decoders between Elm and TypeScript.
...
*   [haskell-to-elm (⭐63)](https://github.com/folq/haskell-to-elm) - Generate Elm types, encoders, and decoders from Haskell types
...
*   [Elm Doc Preview (⭐137)](https://github.com/dmy/elm-doc-preview) - Elm offline documentation previewer.
*   [Elm Format (⭐1.3k)](https://github.com/avh4/elm-format) - Automatic Elm code formatter adhering to [Elm Style Guide](https://elm-lang.org/docs/style-guide).
*   [Elm JSON (⭐185)](https://github.com/zwilias/elm-json) - Install, upgrade and uninstall Elm dependencies
*   [Elm Oracle (⭐153)](https://github.com/ElmCast/elm-oracle) - Query for information about values in elm source files. Used by most editor plugins.
*   [type-o-rama (⭐247)](https://github.com/stereobooster/type-o-rama) - JS type systems interportability.
*   [Html to Elm](https://html-to-elm.com/) - Convert HTML to Elm.
*   [Litvis (⭐409)](https://github.com/gicentre/litvis) - Literate Visualization with Elm

### Static analysis / Outdated Boilerplates

*   [Elm Analyse (⭐416)](https://github.com/stil4m/elm-analyse) - Linter for the Elm programming language.
*   [Elm Review (⭐283)](https://github.com/jfmengels/elm-review) - Code reviewer for the Elm programming language.
...
*   [Elm UI Explorer (⭐218)](https://github.com/kalutheo/elm-ui-explorer) - Showcase your views and states.

### Run Elm / Outdated Boilerplates

*   [Ellie](https://ellie-app.com/) - The Elm Live Editor
*   [Elm Editor](https://elm-editor.com/) - Advanced Elm Live Editor
*   [run-elm (⭐53)](https://github.com/jfairbank/run-elm) — Run Elm code from the command line
...
*   [grunt-elm (⭐20)](https://github.com/rtfeldman/grunt-elm) - Grunt plugin that compiles Elm files to JavaScript.
...
*   [emacs-elm-mode (⭐380)](https://github.com/jcollard/elm-mode) - Syntax highlighting, Elm REPL, Elm make and Elm format integration for the Emacs editor.

### Editor plugins / IntelliJ

*   [elm-plugin (⭐407)](https://github.com/klazuka/intellij-elm) - Elm plugin for IntelliJ IDEA.

### Editor plugins / Sublime Text

*   [LSP-elm (⭐9)](https://github.com/sublimelsp/LSP-elm) - Elm Language Server for Sublime (Recommended).
*   [Elm Language Server (⭐443)](https://github.com/elm-tooling/elm-language-server#sublime) - Language server implementation for Elm
...
*   [Elm Format on Save (⭐22)](https://github.com/evancz/elm-format-on-save) - Sublime Text plugin to run elm-format on save.
...
*   [emmet-vim (⭐6.5k)](https://github.com/mattn/emmet-vim) - Markup expansion with elm support.
...
*   [elm-light-table (⭐132)](https://github.com/rundis/elm-light) - Syntax highlighting, REPL, autocompletion, package management and much more for Light Table.

## [Jul 05, 2021](/content/2021/07/05/README.md)

### Testing / Individual Podcast episodes

*   [Elm Spec (⭐34)](https://github.com/brian-watkins/elm-spec) - Describe the behavior of Elm programs.
...
*   [Elm Batteries (⭐118)](https://github.com/cedricss/elm-batteries) - A project template and generator for Elm, Parcel, Cypress and Netlify
...
*   [Codings hints (⭐7.8k)](https://github.com/elm/compiler/tree/master/hints) - A list of README files by Evan.
...
*   [elm-games (⭐146)](https://github.com/rofrol/elm-games) - An excellent list of games made in Elm
...
*   [Elm + Phoenix + Webpack (⭐57)](https://github.com/ronanyeah/elm-phoenix-example) - A minimal Elm + Phoenix setup, using webpack instead of Brunch.
...
*   [Elm Narrative Engine (⭐138)](https://github.com/jschomay/elm-narrative-engine) - A framework for building interactive fiction style stories in Elm. Detailed example [elmnarrativeengine.com](https://elmnarrativeengine.com) shows how to build a "chose your own adventure" game; perfect for beginners. **Elm v.0.19**
...
*   [Learn Elm (⭐495)](https://github.com/dwyl/learn-elm) - Discover the beautiful programming language that makes front-end web apps a joy to build and maintain!

### Community and Support / Games

*   [Companies using Elm (⭐493)](https://github.com/jah2488/elm-companies) - A list of companies using Elm in production.
...
*   [Iced (⭐31k)](https://github.com/hecrj/iced) - A cross-platform GUI library for Rust, inspired by Elm
...
*   [Elm test (⭐243)](https://github.com/elm-explorations/test) - Unit and fuzz tests
*   [Elm Program test (⭐95)](https://github.com/avh4/elm-program-test/tree/3.0.0) - Test complete Elm programs
...
*   [Haskell to Elm (⭐66)](https://github.com/eeue56/haskell-to-elm) - Collection of examples on places where Elm is different to Haskell, targeted at Elm beginners coming from Haskell backgrounds.

### Inspired by Elm / Games

*   [Elchemy (⭐1.1k)](https://github.com/wende/elchemy) - Write Elixir code using statically-typed Elm-like syntax
*   [Elmish (⭐902)](https://github.com/elmish/elmish) - Elm-like abstractions for F# apps
*   [Fabulous (⭐1.3k)](https://github.com/fsprojects/Fabulous) - F# Functional App Development, using declarative dynamic UI
*   [Redux](https://redux.js.org/introduction/prior-art) - A predictable state container for JavaScript apps.

### Beyond the DOM / Games

*   [iOS (⭐161)](https://github.com/pzp1997/elm-ios) A POC for using Elm 0.18 for native iOS Applications
*   [elmish-wasm (⭐18)](https://github.com/Chadtech/elmish-wasm) A POC for compiling elm to Web Assembly
*   [elm-serverless (⭐168)](https://github.com/ktonon/elm-serverless) Run Elm 0.18 on Cloud Functions using the Serverless Frameworks
...
*   [elm-webpack-4-starter (⭐114)](https://github.com/romariolopezc/elm-webpack-4-starter) - Elm webpack 4 starter template.
...
*   [Elm Koans (⭐238)](https://github.com/robertjlooby/elm-koans) - Practice exercises for learning Elm.
...
*   [Elm cheat sheet (⭐948)](https://github.com/izdi/elm-cheat-sheet) - Syntax and features overview.
...
*   [elm-webpack-starter (⭐851)](https://github.com/moarwick/elm-webpack-starter) - A simple Webpack setup for writing Elm apps.
...
*   [Writing native (⭐358)](https://github.com/NoRedInk/take-home/wiki/Writing-Native) - Learn how to create native JavaScript modules for Elm.
...
*   [Elm for Web Developers (⭐55)](https://github.com/eeue56/elm-for-web-developers) - A collection of notes for web developers looking into moving to Elm.
